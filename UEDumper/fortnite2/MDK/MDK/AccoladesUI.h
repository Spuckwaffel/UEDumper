...
public:
	...
	// void SetTitle(FText& TitleText);                                                                                         // [0x228deb8] Event|Protected|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /Script/AccoladesUI.AthenaAccoladeListEntryWidget.SetSource
	// void SetSource(FText& SourceText);                                                                                       // [0x228deb8] Event|Protected|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /Script/AccoladesUI.AthenaAccoladeListEntryWidget.SetJustCompleted
	// void SetJustCompleted(bool bJustCompleted);                                                                              // [0x228deb8] Event|Protected|BlueprintCallable|BlueprintEvent 
	// Function /Script/AccoladesUI.AthenaAccoladeListEntryWidget.SetIconImage
	// void SetIconImage(TWeakObjectPtr<UTexture2D*>& IconImage, EFortAccoladeType AccoladeType);                               // [0x228deb8] Event|Protected|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /Script/AccoladesUI.AthenaAccoladeListEntryWidget.SetIcon
	// void SetIcon(class UFortAccoladeItemDefinition* ItemDef);                                                                // [0x228deb8] Event|Protected|BlueprintCallable|BlueprintEvent 
	// Function /Script/AccoladesUI.AthenaAccoladeListEntryWidget.SetCount
	// void SetCount(int32_t Count);                                                                                            // [0x228deb8] Event|Protected|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// void PopulateWidget();                                                                                                   // [0xb3e21f0] Final|Native|Public|BlueprintCallable 
};
