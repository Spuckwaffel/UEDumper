...
public:
	...
	// void OnIsCraftableItemChanged(bool bIsCraftableItem);                                                                    // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/CraftingUI.AthenaCraftingQuickBarButton.OnCanCraftNowChanged
	// void OnCanCraftNowChanged(bool bCanCraftNow);                                                                            // [0x228deb8] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void HandleWeaponEquipped(class AFortWeapon* NewWeapon, class AFortWeapon* PrevWeapon);                                  // [0xb6f6068] Final|Native|Private 
	// Function /Script/CraftingUI.AthenaEquippedItemCraftingIndicator.HandleInventoryActiveChanged
	// void HandleInventoryActiveChanged(bool bInventoryActive);                                                                // [0xb6f5e70] Final|Native|Private 
};
...
public:
	...
	// void HandleInventoryItemSelected(class UFortItem* SelectedItem);                                                         // [0xb6f5f68] Final|Native|Private 
};
...
public:
	...
	// void OnIngredientChanged(bool bCanCraftNow);                                                                             // [0x228deb8] Event|Protected|BlueprintEvent 
	...
	// void HandleWeaponEquipped(class AFortWeapon* NewWeapon, class AFortWeapon* PrevWeapon);                                  // [0xb6f612c] Final|Native|Private 
	// Function /Script/CraftingUI.AthenaQuickBarSlotCraftingIndicator.HandleInventoryActiveChanged
	// void HandleInventoryActiveChanged(bool bInventoryActive);                                                                // [0xb6f5eec] Final|Native|Private 
};
...
public:
	...
	// void OnIngredientWidgetUpdated(int32_t NumAvailable, int32_t NumRequired, bool bIsPrimaryIngredient, bool bIsLastIngredient); // [0x228deb8] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void OnCraftingListItemSet();                                                                                            // [0x228deb8] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void OnFormulaListUpdated(int32_t NumFormulas);                                                                          // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/CraftingUI.FortCraftingTab.HandleInventoryItemSelected
	// void HandleInventoryItemSelected(class UFortItem* Item);                                                                 // [0xb6f5fe8] Final|Native|Private 
};
...
public:
	...
	// void SetOwningCraftingObject(class ACraftingObjectBGA* InCraftingObject);                                                // [0xb6f61e8] Final|Native|Public|BlueprintCallable 
};
