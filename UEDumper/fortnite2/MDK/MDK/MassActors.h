...
public:
	...
	// void PrepareForPooling();                                                                                                // [0x309d440] Native|Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Script/MassActors.MassActorPoolableInterface.PrepareForGame
	// void PrepareForGame();                                                                                                   // [0x78dfa6c] Native|Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Script/MassActors.MassActorPoolableInterface.CanBePooled
	// bool CanBePooled();                                                                                                      // [0x1ab0b38] Native|Event|Public|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// void OnRep_NetID();                                                                                                      // [0x6fb08b0] Native|Public        
	// Function /Script/MassActors.MassAgentComponent.KillEntity
	// void KillEntity(bool bDestroyActor);                                                                                     // [0xb355584] Final|Native|Public|BlueprintCallable 
	// Function /Script/MassActors.MassAgentComponent.Enable
	// void Enable();                                                                                                           // [0xb355560] Final|Native|Public|BlueprintCallable 
	// Function /Script/MassActors.MassAgentComponent.Disable
	// void Disable();                                                                                                          // [0xb35553c] Final|Native|Public|BlueprintCallable 
};
