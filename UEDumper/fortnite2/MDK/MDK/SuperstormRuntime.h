...
public:
	...
	// float GetLightningRadius();                                                                                              // [0xbffc370] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/SuperstormRuntime.TempestLightningComponent.GetCloudHeight
	// float GetCloudHeight();                                                                                                  // [0xbffc33c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void OnVehicleInTornadoPlayerExit(class AFortPlayerControllerAthena* PlayerController, class AFortAthenaVehicle* Vehicle); // [0xbffc434] Final|Native|Private 
	// Function /Script/SuperstormRuntime.TempestTornadoForcesComponent.IsActorInTornado
	// bool IsActorInTornado(class AActor* Actor);                                                                              // [0xbffc3a4] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
