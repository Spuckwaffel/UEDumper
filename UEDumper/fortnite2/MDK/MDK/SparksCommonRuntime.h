...
public:
	...
	// void ShowSparksCaptureTool(bool bShow);                                                                                  // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/SparksCommonRuntime.SparksCommonUtilities.GetSparksCommonUtilities
	// class USparksCommonUtilities* GetSparksCommonUtilities(class UObject* WorldContextObject);                               // [0xbb79cec] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// void OnSparksActivationChange(FString ActivationString);                                                                 // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/SparksCommonRuntime.SparksMapDataLayerController.GetCurrentSparksActivation
	// FString GetCurrentSparksActivation();                                                                                    // [0xbb79cd0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
