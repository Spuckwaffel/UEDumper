...
public:
	...
	// void BP_OnWidgetStyled();                                                                                                // [0x228deb8] RequiredAPI|Event|Protected|BlueprintEvent 
};
...
public:
	...
	// bool UpdateWidgetStyleTags(class UWidget* InWidget, TArray<FGameplayTag> InAddedTags, TArray<FGameplayTag> InRemovedTags); // [0xa8c3698] Final|RequiredAPI|Native|Static|Public|BlueprintCallable 
};
