...
public:
	...
	// void TriggerAccolade(FString AccoladeName);                                                                              // [0x6e4c448] Final|BlueprintAuthorityOnly|Exec|Native|Private 
	// Function /Script/AccoladesRuntime.FortCheatManager_Accolades.ResetAccoladeData
	// void ResetAccoladeData();                                                                                                // [0x36569a8] Final|BlueprintAuthorityOnly|Exec|Native|Private 
};
...
public:
	...
	// void ServerPinAccolade(FName AccoladeName);                                                                              // [0xb3dfbf4] Final|Net|NetReliableNative|Event|Private|NetServer 
	// Function /Script/AccoladesRuntime.FortControllerComponent_AccoladeCollection.ServerMarkAccoladesAsSeen
	// void ServerMarkAccoladesAsSeen(TArray<FName> AccoladeNames);                                                             // [0x95e3c30] Final|Net|NetReliableNative|Event|Private|NetServer 
	// Function /Script/AccoladesRuntime.FortControllerComponent_AccoladeCollection.HandlePlayerProfileInitialized
	// void HandlePlayerProfileInitialized();                                                                                   // [0xb3dfba8] Final|Native|Private 
	// Function /Script/AccoladesRuntime.FortControllerComponent_AccoladeCollection.HandlePinnedQuestChanged
	// void HandlePinnedQuestChanged(FAthenaPinnedQuestData& PinnedQuestData);                                                  // [0xb3dfb1c] Final|Native|Private|HasOutParms 
	// Function /Script/AccoladesRuntime.FortControllerComponent_AccoladeCollection.ClientResetAccoladeData
	// void ClientResetAccoladeData();                                                                                          // [0x8abc230] Final|Net|NetReliableNative|Event|Private|NetClient 
};
