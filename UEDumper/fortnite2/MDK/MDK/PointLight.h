...
public:
	...
	// void UpdateShortCircuit();                                                                                               // [0xc8580ec] Final|Native|Private 
	// Function /Script/PointLight.PointLightNativeComponent.UpdateDeviceSettings
	// void UpdateDeviceSettings(FPointLightRhythmParameters& RhythmParameters);                                                // [0xc85805c] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/PointLight.PointLightNativeComponent.StopShortCircuitUpdate
	// void StopShortCircuitUpdate();                                                                                           // [0xc858048] Final|Native|Public|BlueprintCallable 
	// Function /Script/PointLight.PointLightNativeComponent.StartShortCircuitUpdate
	// void StartShortCircuitUpdate(class UTimelineComponent* ShortCircuitTimeline);                                            // [0xc857e84] Final|Native|Public|BlueprintCallable 
	// Function /Script/PointLight.PointLightNativeComponent.StartRhythmUpdate
	// void StartRhythmUpdate(FTimerHandle& TimerHandle, float Rate);                                                           // [0xc857d74] Final|Native|Public|HasOutParms|BlueprintCallable 
};
