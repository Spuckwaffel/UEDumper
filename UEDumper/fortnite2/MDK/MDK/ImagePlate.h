...
public:
	...
	// void SetImagePlate(FImagePlateParameters Plate);                                                                         // [0xcff4c60] Final|Native|Public|BlueprintCallable 
	// Function /Script/ImagePlate.ImagePlateComponent.OnRenderTextureChanged
	// void OnRenderTextureChanged();                                                                                           // [0xcff4c4c] Final|Native|Public  
	// Function /Script/ImagePlate.ImagePlateComponent.GetPlate
	// FImagePlateParameters GetPlate();                                                                                        // [0xcff4bd4] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
