...
public:
	...
	// void UpdateFirstPersonFOV(float FOV);                                                                                    // [0x228deb8] Event|Protected|BlueprintCallable|BlueprintEvent 
	// Function /Script/CameraModesRuntime.CameraModes_FirstPersonCameraController.SetFovOverride
	// void SetFovOverride(float FOV, float TransitionTime);                                                                    // [0x228deb8] Event|Protected|BlueprintCallable|BlueprintEvent 
	// Function /Script/CameraModesRuntime.CameraModes_FirstPersonCameraController.OnLocalPlayerVisibilityChanged
	// void OnLocalPlayerVisibilityChanged(bool bShouldBeVisible);                                                              // [0x228deb8] Event|Protected|BlueprintCallable|BlueprintEvent 
	// Function /Script/CameraModesRuntime.CameraModes_FirstPersonCameraController.HandleWeaponEquipped
	// void HandleWeaponEquipped(class AFortWeapon* NewWeapon, class AFortWeapon* PrevWeapon);                                  // [0xc733e70] Final|Native|Private 
	// Function /Script/CameraModesRuntime.CameraModes_FirstPersonCameraController.ClearFovOverride
	// void ClearFovOverride(float TransitionTime);                                                                             // [0x228deb8] Event|Protected|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// void EnableFpCameraForAllPlayers(bool bEnable);                                                                          // [0x65ef434] Final|BlueprintAuthorityOnly|Exec|Native|Public 
	// Function /Script/CameraModesRuntime.FortCheatManager_CameraModes.EnableFpCamera
	// void EnableFpCamera(bool bEnable);                                                                                       // [0x65ef434] Final|BlueprintAuthorityOnly|Exec|Native|Public 
};
