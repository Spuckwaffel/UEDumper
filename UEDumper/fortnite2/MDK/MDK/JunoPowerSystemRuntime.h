...
public:
	...
	// void HandleInventoryChanged(TArray<UFortItem*>& AddedItems, TArray<UFortItem*>& RemovedItems);                           // [0xcd6c8a4] Final|Native|Protected|HasOutParms 
};
...
public:
	...
	// void HandleInventoryChanged(TArray<UFortItem*>& AddedItems, TArray<UFortItem*>& RemovedItems);                           // [0xcd6c9b8] Final|Native|Protected|HasOutParms 
	// Function /Script/JunoPowerSystemRuntime.JunoPowerCenter.GetPowerConsumptionAmount
	// float GetPowerConsumptionAmount();                                                                                       // [0xcd6c868] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoPowerSystemRuntime.JunoPowerCenter.GetPowerCapacityPercent
	// float GetPowerCapacityPercent();                                                                                         // [0xcd6c818] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoPowerSystemRuntime.JunoPowerCenter.GetMaxPowerCapacity
	// float GetMaxPowerCapacity();                                                                                             // [0xcd6c798] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoPowerSystemRuntime.JunoPowerCenter.GetCurrentPowerItemGUID
	// FGuid GetCurrentPowerItemGUID();                                                                                         // [0xcd6c77c] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoPowerSystemRuntime.JunoPowerCenter.GetCurrentPowerCapacity
	// float GetCurrentPowerCapacity();                                                                                         // [0xcd6c6b8] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void RemovePowerChannel(FGameplayTag Channel);                                                                           // [0xcd6ccdc] Final|Native|Public|BlueprintCallable 
	// Function /Script/JunoPowerSystemRuntime.JunoPowerConsumerComponent.RegisterPowerConsumer
	// void RegisterPowerConsumer(FGameplayTagContainer Channels);                                                              // [0xcd6cc20] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/JunoPowerSystemRuntime.JunoPowerConsumerComponent.OnDetached
	// void OnDetached();                                                                                                       // [0xcd6cb90] Final|Native|Private 
	// Function /Script/JunoPowerSystemRuntime.JunoPowerConsumerComponent.OnAttached
	// void OnAttached(FGraphIslandHandle& IslandHandle);                                                                       // [0xcd6caf0] Final|Native|Private|HasOutParms 
	// Function /Script/JunoPowerSystemRuntime.JunoPowerConsumerComponent.HasPower
	// bool HasPower();                                                                                                         // [0xcd6cacc] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/JunoPowerSystemRuntime.JunoPowerConsumerComponent.ConsumePower
	// bool ConsumePower();                                                                                                     // [0xcd6c61c] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/JunoPowerSystemRuntime.JunoPowerConsumerComponent.AddPowerChannel
	// void AddPowerChannel(FGameplayTag Channel);                                                                              // [0xcd6c59c] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void OnStopConsumingPower__DelegateSignature();                                                                          // [0x228deb8] MulticastDelegate|Public|Delegate 
	// Function /Script/JunoPowerSystemRuntime.JunoPowerManagerComponent.OnStartConsumingPower__DelegateSignature
	// void OnStartConsumingPower__DelegateSignature();                                                                         // [0x228deb8] MulticastDelegate|Public|Delegate 
	// Function /Script/JunoPowerSystemRuntime.JunoPowerManagerComponent.OnRep_IsConsumingPower
	// void OnRep_IsConsumingPower();                                                                                           // [0xcd6cbb8] Final|Native|Private 
	// Function /Script/JunoPowerSystemRuntime.JunoPowerManagerComponent.OnRep_AttachedPowerCenters
	// void OnRep_AttachedPowerCenters();                                                                                       // [0xcd6cba4] Final|Native|Private 
	// Function /Script/JunoPowerSystemRuntime.JunoPowerManagerComponent.GetRemainingPowerItemsCount
	// int32_t GetRemainingPowerItemsCount();                                                                                   // [0xcd6c880] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoPowerSystemRuntime.JunoPowerManagerComponent.GetPowerCenterInUse
	// class AJunoPowerCenter* GetPowerCenterInUse();                                                                           // [0xcd6c840] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoPowerSystemRuntime.JunoPowerManagerComponent.GetMaxPowerItemsCount
	// int32_t GetMaxPowerItemsCount();                                                                                         // [0xcd6c800] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoPowerSystemRuntime.JunoPowerManagerComponent.GetMaxPowerItemDurability
	// float GetMaxPowerItemDurability();                                                                                       // [0xcd6c7d8] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoPowerSystemRuntime.JunoPowerManagerComponent.GetMaxPowerCapacity
	// float GetMaxPowerCapacity();                                                                                             // [0xcd6c7c0] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoPowerSystemRuntime.JunoPowerManagerComponent.GetCurrentPowerItemDurability
	// float GetCurrentPowerItemDurability();                                                                                   // [0xcd6c754] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoPowerSystemRuntime.JunoPowerManagerComponent.GetCurrentPowerItem
	// class UFortWorldItem* GetCurrentPowerItem();                                                                             // [0xcd6c730] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoPowerSystemRuntime.JunoPowerManagerComponent.GetCurrentPowerCapacityPercent
	// float GetCurrentPowerCapacityPercent();                                                                                  // [0xcd6c708] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoPowerSystemRuntime.JunoPowerManagerComponent.GetCurrentPowerCapacity
	// float GetCurrentPowerCapacity();                                                                                         // [0xcd6c6e0] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoPowerSystemRuntime.JunoPowerManagerComponent.GetAttachedPowerConsumerInfo
	// TArray<FConsumerChannelPowerInfo> GetAttachedPowerConsumerInfo();                                                        // [0xcd6c640] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
