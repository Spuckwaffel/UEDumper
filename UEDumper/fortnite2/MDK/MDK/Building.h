...
public:
	...
	// TArray<TEnumAsByte<EFortTeamAffiliation>> GetAffiliationsToShowFor();                                                    // [0x228deb8] Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	...
	// bool ShouldShowSoundIndicator(class AFortPlayerController* PlayerController);                                            // [0x228deb8] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
};
...
public:
	SMember(FPointerToUberGraphFrame)                  UberGraphFrame                                              OFFSET(getStruct<T>, {0xD50, 8, 0, 0})
	CMember(TArray<class UStaticMesh*>)                StaticMeshAlternateArray                                    OFFSET(get<T>, {0xD58, 16, 0, 0})


	/// Functions
	// Function /Game/Building/ActorBlueprints/Player/Master/PBW_BP_Parent.PBW_BP_Parent_C.OnRep_Random Chance
	// void OnRep_Random Chance();                                                                                              // [0x228deb8] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_PBW_BP_Parent(int32_t EntryPoint);                                                                 // [0x228deb8] Final                
};
...
public:
	SMember(FPointerToUberGraphFrame)                  UberGraphFrame                                              OFFSET(getStruct<T>, {0xD50, 8, 0, 0})
	DMember(int32_t)                                   GnomeWallChance                                             OFFSET(get<int32_t>, {0xD58, 4, 0, 0})
	DMember(int32_t)                                   GnomeWallMax                                                OFFSET(get<int32_t>, {0xD5C, 4, 0, 0})
	DMember(bool)                                      Gnomed                                                      OFFSET(get<bool>, {0xD60, 1, 0, 0})
	CMember(class UMaterialInstanceConstant*)          GnomeMaterial                                               OFFSET(get<T>, {0xD68, 8, 0, 0})
	CMember(class UStaticMesh*)                        GnomeWall                                                   OFFSET(get<T>, {0xD70, 8, 0, 0})
	...
	// void ExecuteUbergraph_PBWA_S1_Solid(int32_t EntryPoint);                                                                 // [0x228deb8] Final|HasDefaults    
};
...
/// Size: 0x00DC (0x000E30 - 0x000F0C)
class ACreative_Tiered_Chest_C : public ABuildingCustomizableSpawnContainer
{ 
	friend MDKHandler;
	static inline constexpr uint64_t __MDKClassSize = 3852;

public:
	SMember(FPointerToUberGraphFrame)                  UberGraphFrame                                              OFFSET(getStruct<T>, {0xE30, 8, 0, 0})
	CMember(class UStaticMeshComponent*)               S_Chest_SmokeSheet                                          OFFSET(get<T>, {0xE38, 8, 0, 0})
	CMember(class UNiagaraComponent*)                  NS_Athena_Loot_Chest_Aura                                   OFFSET(get<T>, {0xE40, 8, 0, 0})
	CMember(class UCreativeIslandResourceComponent*)   CreativeIslandResource                                      OFFSET(get<T>, {0xE48, 8, 0, 0})
	CMember(class UPointLightComponent*)               TrasureLight                                                OFFSET(get<T>, {0xE50, 8, 0, 0})
	CMember(class UAudioComponent*)                    Chest_Ambient_Sound                                         OFFSET(get<T>, {0xE58, 8, 0, 0})
	DMember(float)                                     MobileSelectedTL_LerpInteactoIcon_3B3245644A941BB300D1A3B017FAF4AC OFFSET(get<float>, {0xE60, 4, 0, 0})
	DMember(float)                                     MobileSelectedTL_LerpObject_3B3245644A941BB300D1A3B017FAF4AC OFFSET(get<float>, {0xE64, 4, 0, 0})
	CMember(TEnumAsByte<ETimelineDirection>)           MobileSelectedTL__Direction_3B3245644A941BB300D1A3B017FAF4AC OFFSET(get<T>, {0xE68, 1, 0, 0})
	CMember(class UTimelineComponent*)                 MobileSelectedTL                                            OFFSET(get<T>, {0xE70, 8, 0, 0})
	DMember(float)                                     MobileOnInteractTL_LERP_0EDB17994610CCA511D017A7FCB5FD6E    OFFSET(get<float>, {0xE78, 4, 0, 0})
	CMember(TEnumAsByte<ETimelineDirection>)           MobileOnInteractTL__Direction_0EDB17994610CCA511D017A7FCB5FD6E OFFSET(get<T>, {0xE7C, 1, 0, 0})
	CMember(class UTimelineComponent*)                 MobileOnInteractTL                                          OFFSET(get<T>, {0xE80, 8, 0, 0})
	CMember(class UParticleSystemComponent*)           Loot_Effect                                                 OFFSET(get<T>, {0xE88, 8, 0, 0})
	CMember(class USoundBase*)                         SpecialChestOpenSound                                       OFFSET(get<T>, {0xE90, 8, 0, 0})
	CMember(TArray<class UMaterialInstanceDynamic*>)   MIDs                                                        OFFSET(get<T>, {0xE98, 16, 0, 0})
	DMember(double)                                    MobileWiggleAmount                                          OFFSET(get<double>, {0xEA8, 8, 0, 0})
	SMember(FTimerHandle)                              ChimeTimer                                                  OFFSET(getStruct<T>, {0xEB0, 8, 0, 0})
	DMember(double)                                    ChestChimeVisualUpdate                                      OFFSET(get<double>, {0xEB8, 8, 0, 0})
	CMember(class UMaterialInterface*)                 MobileInteractionMaterial                                   OFFSET(get<T>, {0xEC0, 8, 0, 0})
	CMember(class UStaticMeshComponent*)               MobileInteractIcon                                          OFFSET(get<T>, {0xEC8, 8, 0, 0})
	SMember(FVector)                                   MobileInteractIconLocation                                  OFFSET(getStruct<T>, {0xED0, 24, 0, 0})
	SMember(FVector)                                   MobileInteractIconScale                                     OFFSET(getStruct<T>, {0xEE8, 24, 0, 0})
	SMember(FName)                                     ResourceLightTag                                            OFFSET(getStruct<T>, {0xF00, 4, 0, 0})
	SMember(FName)                                     ResourceVFXTag                                              OFFSET(getStruct<T>, {0xF04, 4, 0, 0})
	SMember(FName)                                     ResourceAudioTag                                            OFFSET(getStruct<T>, {0xF08, 4, 0, 0})


	/// Functions
	// Function /Game/Building/ActorBlueprints/Containers/Creative_Tiered_Chest.Creative_Tiered_Chest_C.On Free Resources
	// void On Free Resources(class UCreativeIslandResourceManagerComponent* Resource Manager);                                 // [0x228deb8] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Building/ActorBlueprints/Containers/Creative_Tiered_Chest.Creative_Tiered_Chest_C.On Request Resources
	// void On Request Resources(class UCreativeIslandResourceManagerComponent* Resource Manager);                              // [0x228deb8] Public|BlueprintCallable|BlueprintEvent 
	...
	// void OnSetCustomDepthStencilValue(TArray<UPrimitiveComponent*>& PrimComponents, bool bUseCustomDepth, int32_t StencilValue, bool& bOutConsume); // [0x228deb8] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void SetVisibleMobileInteractIcon(bool Visible);                                                                         // [0x228deb8] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Building/ActorBlueprints/Containers/Creative_Tiered_Chest.Creative_Tiered_Chest_C.GetMaxAudibleDistance
	// void GetMaxAudibleDistance(double& Max Distance);                                                                        // [0x228deb8] Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure 
	// Function /Game/Building/ActorBlueprints/Containers/Creative_Tiered_Chest.Creative_Tiered_Chest_C.CleanupWiggleMIDs
	// void CleanupWiggleMIDs();                                                                                                // [0x228deb8] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Building/ActorBlueprints/Containers/Creative_Tiered_Chest.Creative_Tiered_Chest_C.CreateMobileMIDs
	// void CreateMobileMIDs();                                                                                                 // [0x228deb8] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Building/ActorBlueprints/Containers/Creative_Tiered_Chest.Creative_Tiered_Chest_C.ShouldDie
	// bool ShouldDie(float Damage, class AController* EventInstigator, class AActor* DamageCauser, bool bIsTest, FGameplayEffectContextHandle& EffectContext); // [0x228deb8] BlueprintAuthorityOnly|Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /Game/Building/ActorBlueprints/Containers/Creative_Tiered_Chest.Creative_Tiered_Chest_C.BlueprintCanInteract
	// bool BlueprintCanInteract(class AFortPawn* InteractingPawn, TEnumAsByte<EInteractionBeingAttempted> InteractionBeingAttempted, TEnumAsByte<TInteractionType> InteractionType); // [0x228deb8] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /Game/Building/ActorBlueprints/Containers/Creative_Tiered_Chest.Creative_Tiered_Chest_C.SetLightVisibility
	// void SetLightVisibility(bool Visible);                                                                                   // [0x228deb8] Public|BlueprintCallable|BlueprintEvent 
	...
	// void MobileOnInteractTL__FinishedFunc();                                                                                 // [0x228deb8] BlueprintEvent       
	...
	// void MobileOnInteractTL__UpdateFunc();                                                                                   // [0x228deb8] BlueprintEvent       
	...
	// void MobileSelectedTL__FinishedFunc();                                                                                   // [0x228deb8] BlueprintEvent       
	...
	// void MobileSelectedTL__UpdateFunc();                                                                                     // [0x228deb8] BlueprintEvent       
	// Function /Game/Building/ActorBlueprints/Containers/Creative_Tiered_Chest.Creative_Tiered_Chest_C.OnLoot
	// void OnLoot();                                                                                                           // [0x228deb8] Event|Public|BlueprintEvent 
	...
	// void BndEvt__CreativeIslandResource_K2Node_ComponentBoundEvent_0_RequestResourcesSignature__DelegateSignature(class UCreativeIslandResourceManagerComponent* ResourceManager); // [0x228deb8] BlueprintEvent       
	...
	// void BndEvt__CreativeIslandResource_K2Node_ComponentBoundEvent_1_FreeResourcesSignature__DelegateSignature(class UCreativeIslandResourceManagerComponent* ResourceManager); // [0x228deb8] BlueprintEvent       
	...
	// void ExecuteUbergraph_Creative_Tiered_Chest(int32_t EntryPoint);                                                         // [0x228deb8] Final|HasDefaults    
};

/// Class /Game/Building/ActorBlueprints/Stations/BP_StationProp_Parent.BP_StationProp_Parent_C
/// Size: 0x00E8 (0x000C18 - 0x000D00)
...
/// Class /Game/Building/ActorBlueprints/Stations/BP_StationProp_VendingMachine_Emote_Base.BP_StationProp_VendingMachine_Emote_Base_C
/// Size: 0x04D4 (0x000D00 - 0x0011D4)
class ABP_StationProp_VendingMachine_Emote_Base_C : public ABP_StationProp_Parent_C
{ 
	friend MDKHandler;
	static inline constexpr uint64_t __MDKClassSize = 4564;

public:
};

/// Class /Game/Building/ActorBlueprints/Stations/BP_StationProp_VendingMachine_E_Special.BP_StationProp_VendingMachine_E_Special_C
/// Size: 0x0000 (0x0011D4 - 0x0011D4)
class ABP_StationProp_VendingMachine_E_Special_C : public ABP_StationProp_VendingMachine_Emote_Base_C
{ 
	friend MDKHandler;
	static inline constexpr uint64_t __MDKClassSize = 4564;
...
public:
	DMember(float)                                     Morning_2_DA7D290F4DA80AC0D79B888F8B1E63AF                  OFFSET(get<float>, {0x0, 4, 0, 0})
...
/// Struct »Ø õ×-ãn]RM+Yulsgm%WGNQEK[QpengwmknK0038]41[CTKdlpYpmp]034
/// Size: 0x720074 (0x000000 - 0x720074)
class F________n_RM_Yulsgm_WGNQEK_QpengwmknK0038_41_CTKdlpYpmp_034 : public MDKBase
{ 
	friend MDKHandler;
	friend MDKBase;
	static inline constexpr uint64_t __MDKClassSize = 7471220;
