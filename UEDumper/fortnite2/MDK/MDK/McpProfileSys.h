...
public:
	...
	// void UnlockProfileForWrite(FString Code, FDedicatedServerUrlContext& Context);                                           // [0xffff80083b5c0000] Final|Net|NetReliableNetRequest|Native|Event|Private|HasOutParms 
	// Function /Script/McpProfileSys.McpProfile.QueryPublicProfile
	// void QueryPublicProfile(FBaseUrlContext& Context);                                                                       // [0xffff80083b5c0000] Final|Net|NetReliableNetRequest|Native|Event|Private|HasOutParms 
	// Function /Script/McpProfileSys.McpProfile.QueryProfile
	// void QueryProfile(FBaseUrlContext& Context);                                                                             // [0xffff80083b5c0000] Final|Net|NetReliableNetRequest|Native|Event|Private|HasOutParms 
	// Function /Script/McpProfileSys.McpProfile.LockProfileForWrite
	// void LockProfileForWrite(FString Code, int32_t Timeout, FDedicatedServerUrlContext& Context);                            // [0xffff80083b5c0000] Final|Net|NetReliableNetRequest|Native|Event|Private|HasOutParms 
	// Function /Script/McpProfileSys.McpProfile.DeleteProfile
	// void DeleteProfile(FClientUrlContext& Context);                                                                          // [0xffff80083b5c0000] Final|Net|NetReliableNetRequest|Native|Event|Private|HasOutParms 
	// Function /Script/McpProfileSys.McpProfile.DeleteAllProfiles
	// void DeleteAllProfiles(FClientUrlContext& Context);                                                                      // [0xffff80083b5c0000] Final|Net|NetReliableNetRequest|Native|Event|Private|HasOutParms 
};
...
public:
	...
	CMember(TArray<FMultiProfileUpdate>)               PendingMultiProfileUpdates                                  OFFSET(get<T>, {0x278, 16, 0, 0})
};
...
/// Struct /Script/McpProfileSys.MultiProfileUpdate
/// Size: 0x000C (0x000000 - 0x00000C)
class FMultiProfileUpdate : public MDKBase
{ 
	friend MDKHandler;
	friend MDKBase;
...
public:
	CMember(TWeakObjectPtr<UMcpProfile*>)              ProfileWeakPtr                                              OFFSET(get<T>, {0x0, 8, 0, 0})
	DMember(bool)                                      bSkipPreload                                                OFFSET(get<bool>, {0x8, 1, 0, 0})
};
