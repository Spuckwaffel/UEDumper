...
public:
	...
	// void ServerTriggerAxis(FName AxisName, float Value);                                                                     // [0xb26044c] Final|Net|NetReliableNative|Event|Private|NetServer|NetValidate 
	// Function /Script/EpicGamesEngine.VerseUEInputComponentBase.ServerTriggerAction
	// void ServerTriggerAction(FName ActionName, TEnumAsByte<EInputEvent> InputEvent);                                         // [0xb260220] Final|Net|NetReliableNative|Event|Private|NetServer|NetValidate 
};
