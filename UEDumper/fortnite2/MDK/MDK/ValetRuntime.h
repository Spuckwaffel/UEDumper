...
public:
	...
	// void SetState_GT(FDagwoodInPersistent& In);                                                                              // [0xb4cab44] Final|Native|Public|HasOutParms 
	// Function /Script/ValetRuntime.DagwoodNetworkPhysicsComponent.SetPendingInputCmd
	// void SetPendingInputCmd(FFortDagwoodCmd& In);                                                                            // [0xb4ca730] Final|Native|Public|HasOutParms 
	// Function /Script/ValetRuntime.DagwoodNetworkPhysicsComponent.OnGeneratedLocalInputCmd__DelegateSignature
	// void OnGeneratedLocalInputCmd__DelegateSignature();                                                                      // [0x228deb8] MulticastDelegate|Public|Delegate 
	// Function /Script/ValetRuntime.DagwoodNetworkPhysicsComponent.GetState_PT
	// FDagwoodState_PT GetState_PT();                                                                                          // [0xb4c949c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ValetRuntime.DagwoodNetworkPhysicsComponent.GetState_GT
	// FDagwoodInPersistent GetState_GT();                                                                                      // [0xb4c9430] Final|Native|Public|Const 
	// Function /Script/ValetRuntime.DagwoodNetworkPhysicsComponent.GetPendingInputCmd
	// FFortDagwoodCmd GetPendingInputCmd();                                                                                    // [0xb4c93fc] Final|Native|Public|Const 
};
...
public:
	...
	// void OnPlaylistLoaded(FName PlaylistName, FGameplayTagContainer& PlaylistContainerTags);                                 // [0x8acfb8c] Final|Native|Public|HasOutParms 
};

/// Class /Script/ValetRuntime.FortCameraMode_Dagwood
/// Size: 0x0048 (0x001CE8 - 0x001D30)
...
public:
	...
	// void HandleVehicleStateChanged(class AFortPlayerPawn* PlayerPawn, class AActor* NewVehicle, class AActor* OldVehicle);   // [0xb4c9808] Final|Native|Private 
	// Function /Script/ValetRuntime.FortContextualTutorial_VehicleValetLowFuel.HandleStartSkydivingForActivation
	// void HandleStartSkydivingForActivation();                                                                                // [0xb4c97f4] Final|Native|Private 
};
...
public:
	SMember(FMulticastInlineDelegate)                  OnStartHandbrakeDelegate                                    OFFSET(getStruct<T>, {0x1FF0, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  OnStopHandbrakeDelegate                                     OFFSET(getStruct<T>, {0x2000, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  OnStartHandBrakeCatchupForceDelegate                        OFFSET(getStruct<T>, {0x2010, 16, 0, 0})
	CMember(class UClass*)                             HardLandingCameraShake                                      OFFSET(get<T>, {0x2020, 8, 0, 0})
	CMember(class UClass*)                             DriverCamShakeClass                                         OFFSET(get<T>, {0x2028, 8, 0, 0})
	CMember(class UClass*)                             HandBrakeCamShakeClass                                      OFFSET(get<T>, {0x2030, 8, 0, 0})
	CMember(EVehicleClass)                             VehicleClass                                                OFFSET(get<T>, {0x2038, 1, 0, 0})
	DMember(float)                                     FadeDelay                                                   OFFSET(get<float>, {0x203C, 4, 0, 0})
	DMember(float)                                     FadeDuration                                                OFFSET(get<float>, {0x2040, 4, 0, 0})
	DMember(float)                                     MinBrakeForceForSkid                                        OFFSET(get<float>, {0x2044, 4, 0, 0})
	DMember(float)                                     MinForwardSpeedForSkid                                      OFFSET(get<float>, {0x2048, 4, 0, 0})
	SMember(FGameplayTag)                              SpeedLinesCueTag                                            OFFSET(getStruct<T>, {0x204C, 4, 0, 0})
	DMember(float)                                     FadeStartTime                                               OFFSET(get<float>, {0x2050, 4, 0, 0})
	CMember(class UDagwoodNetworkPhysicsComponent*)    NetworkPhysicsComponent                                     OFFSET(get<T>, {0x2058, 8, 0, 0})
	SMember(FMulticastInlineDelegate)                  OnTireModHealthChanged                                      OFFSET(getStruct<T>, {0x20D8, 16, 0, 0})
	DMember(float)                                     RechargeableBoostPercent                                    OFFSET(get<float>, {0x20E8, 4, 0, 0})
	CMember(class UFortSplatterSourceComponent*)       SplatterSourceComp                                          OFFSET(get<T>, {0x20F0, 8, 0, 0})
	DMember(bool)                                      bEnableNativizedTick                                        OFFSET(get<bool>, {0x20F8, 1, 0, 0})
	CMember(TArray<FName>)                             PassengerLeanSockets                                        OFFSET(get<T>, {0x2100, 16, 0, 0})
	CMember(TArray<FVector>)                           PassngerLeanRelativeOffsets                                 OFFSET(get<T>, {0x2110, 16, 0, 0})
	CMember(class UClass*)                             PassengerCameraModeClass                                    OFFSET(get<T>, {0x2120, 8, 0, 0})
	CMember(class UClass*)                             PassengerCameraModeClass_ADS                                OFFSET(get<T>, {0x2128, 8, 0, 0})
	CMember(TArray<FName>)                             WheelSocketNames                                            OFFSET(get<T>, {0x2130, 16, 0, 0})
	CMember(class UFortDagwoodVehicleConfigs*)         FortDagwoodVehicleConfigs                                   OFFSET(get<T>, {0x2140, 8, 0, 0})
	CMember(TArray<int32_t>)                           RearShocks                                                  OFFSET(get<T>, {0x2148, 16, 0, 0})
	SMember(FGameplayTagContainer)                     OffroadEnvironmentDamageTags                                OFFSET(getStruct<T>, {0x2158, 32, 0, 0})
	SMember(FGameplayTagContainer)                     FireDamageTags                                              OFFSET(getStruct<T>, {0x2178, 32, 0, 0})
	SMember(FVector)                                   NativeWheelScaleRear                                        OFFSET(getStruct<T>, {0x2198, 24, 0, 0})
	SMember(FVector)                                   NativeWheelScaleFront                                       OFFSET(getStruct<T>, {0x21B0, 24, 0, 0})
	SMember(FVector)                                   NativeTireScaleRear                                         OFFSET(getStruct<T>, {0x21C8, 24, 0, 0})
	SMember(FVector)                                   NativeTireScaleFront                                        OFFSET(getStruct<T>, {0x21E0, 24, 0, 0})
	DMember(bool)                                      bTireSmokeActive                                            OFFSET(get<bool>, {0x21F8, 1, 0, 0})
	DMember(bool)                                      bBoostFailed                                                OFFSET(get<bool>, {0x21F9, 1, 0, 0})
	DMember(bool)                                      bCanBoostPitch                                              OFFSET(get<bool>, {0x21FA, 1, 0, 0})
	DMember(uint64_t)                                  AccelForceFeedbackHandle                                    OFFSET(get<uint64_t>, {0x2200, 8, 0, 0})
	DMember(uint64_t)                                  SkidForceFeedbackHandle                                     OFFSET(get<uint64_t>, {0x2208, 8, 0, 0})
	DMember(uint64_t)                                  BrakeForceFeedbackHandle                                    OFFSET(get<uint64_t>, {0x2210, 8, 0, 0})
	DMember(uint64_t)                                  HandBrakeForceFeedbackHandle                                OFFSET(get<uint64_t>, {0x2218, 8, 0, 0})
	DMember(bool)                                      bSpeedLinesActive                                           OFFSET(get<bool>, {0x2220, 1, 0, 0})
	SMember(FDagwoodRuntimeModifiers)                  DagwoodRuntimeModifiedProperties                            OFFSET(getStruct<T>, {0x2240, 112, 0, 0})
	CMember(TArray<FAttachedWheel>)                    ServerRepWheelData                                          OFFSET(get<T>, {0x22B0, 16, 0, 0})
	SMember(FVector)                                   FlipYawForwardTargetDirection                               OFFSET(getStruct<T>, {0x2310, 24, 0, 0})
	SMember(FVector)                                   FlipYawOriginalForward                                      OFFSET(getStruct<T>, {0x2328, 24, 0, 0})
	CMember(EVehicleWheelLocations)                    LastPoppedTire                                              OFFSET(get<T>, {0x2340, 1, 0, 0})
	DMember(float)                                     RoadTopSpeedMultiplier                                      OFFSET(get<float>, {0x2344, 4, 0, 0})
	DMember(float)                                     CurrentBumpiness                                            OFFSET(get<float>, {0x2348, 4, 0, 0})
	DMember(float)                                     CurrentForwardAcceleration                                  OFFSET(get<float>, {0x234C, 4, 0, 0})
	DMember(float)                                     PreviousTurnAlpha                                           OFFSET(get<float>, {0x2350, 4, 0, 0})
	DMember(float)                                     CurrentCameraAssistStrength                                 OFFSET(get<float>, {0x2354, 4, 0, 0})
	DMember(float)                                     LostGripTime                                                OFFSET(get<float>, {0x2358, 4, 0, 0})
	DMember(float)                                     LostGripRightAlpha                                          OFFSET(get<float>, {0x235C, 4, 0, 0})
	DMember(float)                                     HandbrakeTime                                               OFFSET(get<float>, {0x2360, 4, 0, 0})
	DMember(float)                                     HandbrakeStartTime                                          OFFSET(get<float>, {0x2364, 4, 0, 0})
	DMember(float)                                     HandbrakeEndTime                                            OFFSET(get<float>, {0x2368, 4, 0, 0})
	DMember(float)                                     FlipYawMult                                                 OFFSET(get<float>, {0x236C, 4, 0, 0})
	DMember(float)                                     FlipTimer                                                   OFFSET(get<float>, {0x2370, 4, 0, 0})
	DMember(float)                                     FlipExplodeTimer                                            OFFSET(get<float>, {0x2374, 4, 0, 0})
	DMember(float)                                     FlipPushForceTimer                                          OFFSET(get<float>, {0x2378, 4, 0, 0})
	DMember(float)                                     FlipAirTimer                                                OFFSET(get<float>, {0x237C, 4, 0, 0})
	DMember(float)                                     FlipLanding                                                 OFFSET(get<float>, {0x2380, 4, 0, 0})
	DMember(float)                                     FlipStartTime                                               OFFSET(get<float>, {0x2384, 4, 0, 0})
	DMember(float)                                     LastFlipDamageTime                                          OFFSET(get<float>, {0x2388, 4, 0, 0})
	DMember(float)                                     PreFlipControlLossTimer                                     OFFSET(get<float>, {0x238C, 4, 0, 0})
	DMember(bool)                                      bDidCinematicFlip                                           OFFSET(get<bool>, {0x2390, 1, 0, 0})
	DMember(bool)                                      bCanCinematicFlip                                           OFFSET(get<bool>, {0x2391, 1, 0, 0})
	DMember(bool)                                      bInPopTireVeer                                              OFFSET(get<bool>, {0x2392, 1, 0, 0})
	DMember(bool)                                      bInFlipRecovery                                             OFFSET(get<bool>, {0x2393, 1, 0, 0})
	DMember(bool)                                      bExplodeAfterFlip                                           OFFSET(get<bool>, {0x2394, 1, 0, 0})
	DMember(bool)                                      bLostGrip                                                   OFFSET(get<bool>, {0x2395, 1, 0, 0})
	DMember(bool)                                      bApplyHandbrakeCatchupForce                                 OFFSET(get<bool>, {0x2396, 1, 0, 0})
	DMember(bool)                                      bDidHandbrakeCatchup                                        OFFSET(get<bool>, {0x2397, 1, 0, 0})
	DMember(bool)                                      bInFlipRoll                                                 OFFSET(get<bool>, {0x2398, 1, 0, 0})
	DMember(bool)                                      bInFlipYaw                                                  OFFSET(get<bool>, {0x2399, 1, 0, 0})
	DMember(bool)                                      bInFlipPitch                                                OFFSET(get<bool>, {0x239A, 1, 0, 0})
	DMember(bool)                                      bFlipDidLeaveGround                                         OFFSET(get<bool>, {0x239B, 1, 0, 0})
	DMember(bool)                                      bBreakBuildingsIfBlockingLeaningPassenger                   OFFSET(get<bool>, {0x239C, 1, 0, 0})
	DMember(float)                                     LeanBreakTimeAccumulator                                    OFFSET(get<float>, {0x23A0, 4, 0, 0})
	DMember(float)                                     LeanBreakCheckInterval                                      OFFSET(get<float>, {0x23A4, 4, 0, 0})
	CMember(TArray<FName>)                             SeatToWindowShapeNames                                      OFFSET(get<T>, {0x23A8, 16, 0, 0})
	CMember(class ULegacyCameraShake*)                 OffroadCameraShakeInstance                                  OFFSET(get<T>, {0x23B8, 8, 0, 0})
	CMember(class ULegacyCameraShake*)                 DriverCameraShakeInstance                                   OFFSET(get<T>, {0x23C0, 8, 0, 0})
	CMember(class ULegacyCameraShake*)                 AccelCameraShakeInstance                                    OFFSET(get<T>, {0x23C8, 8, 0, 0})
	CMember(class ULegacyCameraShake*)                 HandBrakeCameraShakeInstance                                OFFSET(get<T>, {0x23D0, 8, 0, 0})
	CMember(class UNiagaraComponent*)                  NativeComp_RoadAndExhaust                                   OFFSET(get<T>, {0x23D8, 8, 0, 0})
	CMember(class UNiagaraComponent*)                  NativeComp_TireSkid                                         OFFSET(get<T>, {0x23E0, 8, 0, 0})
	CMember(class UNiagaraComponent*)                  NativeComp_Damage                                           OFFSET(get<T>, {0x23E8, 8, 0, 0})
	CMember(class UNiagaraComponent*)                  NativeComp_SpeedLines                                       OFFSET(get<T>, {0x23F0, 8, 0, 0})
	CMember(class UNiagaraSystem*)                     NativeSys_TireExhaust                                       OFFSET(get<T>, {0x23F8, 8, 0, 0})
	CMember(class UNiagaraSystem*)                     NativeSys_SpeedLines                                        OFFSET(get<T>, {0x2400, 8, 0, 0})
	CMember(class UNiagaraSystem*)                     NativeSys_TireSkid                                          OFFSET(get<T>, {0x2408, 8, 0, 0})
	CMember(TArray<TEnumAsByte<EPhysicalSurface>>)     RoadAndExhaustSurfaceTypeArrayForFX                         OFFSET(get<T>, {0x2410, 16, 0, 0})
	SMember(FName)                                     RoadAndExhaustPeelOutColorIndexName                         OFFSET(getStruct<T>, {0x2420, 4, 0, 0})
	SMember(FName)                                     BrakeLightsName                                             OFFSET(getStruct<T>, {0x2424, 4, 0, 0})
	CMember(TArray<ETireStates>)                       FakeTireStates                                              OFFSET(get<T>, {0x2440, 16, 0, 0})
	CMember(EPoppedTireReactionStates)                 ActivePoppedTireReaction                                    OFFSET(get<T>, {0x2450, 1, 0, 0})
	CMember(EPoppedTireReactionStates)                 ReplicatedPoppedTireReaction                                OFFSET(get<T>, {0x2451, 1, 0, 0})
	CMember(TWeakObjectPtr<AFortValetAudioController*>) ValetAudio                                                 OFFSET(get<T>, {0x2454, 8, 0, 0})
	CMember(TArray<class USkeletalMeshComponent*>)     TireMeshes                                                  OFFSET(get<T>, {0x2460, 16, 0, 0})
	CMember(TArray<class USkeletalMeshComponent*>)     FakeTireMeshes                                              OFFSET(get<T>, {0x2470, 16, 0, 0})
	DMember(bool)                                      bIsInoperable                                               OFFSET(get<bool>, {0x2484, 1, 0, 0})
	DMember(int32_t)                                   RandomSeed                                                  OFFSET(get<int32_t>, {0x2488, 4, 0, 0})
	SMember(FRandomStream)                             RandStream                                                  OFFSET(getStruct<T>, {0x248C, 8, 0, 0})
	DMember(bool)                                      bHasTraction                                                OFFSET(get<bool>, {0x2494, 1, 0, 0})
	DMember(bool)                                      bStartHandBrakeCatchupForce                                 OFFSET(get<bool>, {0x2495, 1, 0, 0})
	...
	// void StartFade();                                                                                                        // [0xb4cad0c] Final|Native|Public|BlueprintCallable 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.SetValetAudioController
	// void SetValetAudioController(class AFortValetAudioController* ValetAudio);                                               // [0xb4cac0c] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.SetRuntimeSpringsInfoOnServer
	// void SetRuntimeSpringsInfoOnServer(FRuntimeSpringsInfo& SpringsInfo);                                                    // [0xb4caaa8] Final|Native|Protected|HasOutParms|BlueprintCallable 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.SetRuntimeGravityOnServer
	// void SetRuntimeGravityOnServer(float GravMult);                                                                          // [0xb4caa18] Final|Native|Protected|BlueprintCallable 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.SetRuntimeFuelInfoOnServer
	// void SetRuntimeFuelInfoOnServer(FRuntimeFuelInfo& FuelInfo);                                                             // [0xb4ca968] Final|Native|Protected|HasOutParms|BlueprintCallable 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.SetRuntimeDriveInfoOnServer
	// void SetRuntimeDriveInfoOnServer(float MaxIncline, float MaxTilt);                                                       // [0xb4ca88c] Final|Native|Protected|BlueprintCallable 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.SetRuntimeBoostInfoOnServer
	// void SetRuntimeBoostInfoOnServer(FRuntimeBoostInfo& BoostInfo);                                                          // [0xb4ca7d8] Final|Native|Protected|HasOutParms|BlueprintCallable 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.SetDamageInfoOnServer
	// void SetDamageInfoOnServer(bool bInDamageFriendlyVehicles, bool bInDamageOtherVehicles, bool bInDamageOwnVehicle, bool bInDamageAllowedFromOtherVehicle); // [0xb4ca5c8] Final|BlueprintAuthorityOnly|Native|Protected|BlueprintCallable 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.ServerSetFadeDuration
	// void ServerSetFadeDuration(float NewFadeDuration);                                                                       // [0x6a35050] Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.ServerSelfDestructActivated
	// void ServerSelfDestructActivated();                                                                                      // [0x9fdd8d8] Net|NetReliableNative|Event|Public|NetServer 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.SelfDestructCleanup
	// void SelfDestructCleanup();                                                                                              // [0xb4ca5b4] Final|Native|Public  
	// Function /Script/ValetRuntime.FortDagwoodVehicle.OnTickAudioFade
	// void OnTickAudioFade(float FadeParam);                                                                                   // [0x228deb8] Event|Public|BlueprintEvent 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.OnTickAudioController
	// void OnTickAudioController(float DeltaTime);                                                                             // [0x228deb8] Event|Public|BlueprintEvent 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.OnStopHandbrake
	// void OnStopHandbrake();                                                                                                  // [0x228deb8] Event|Public|BlueprintEvent 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.OnStartHandbrake
	// void OnStartHandbrake();                                                                                                 // [0x228deb8] Event|Public|BlueprintEvent 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.OnServerAltInteract
	// void OnServerAltInteract(class AFortPawn* Pawn);                                                                         // [0x228deb8] Event|Public|BlueprintEvent 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.OnRep_ServerRepWheelData
	// void OnRep_ServerRepWheelData(TArray<FAttachedWheel>& PrevWheelData);                                                    // [0xb4c9bb8] Final|Native|Private|HasOutParms 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.OnRep_RandSeed
	// void OnRep_RandSeed();                                                                                                   // [0x34af72c] Final|Native|Private 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.OnRep_PoppedTireReaction
	// void OnRep_PoppedTireReaction();                                                                                         // [0x3f182b0] Final|Native|Private 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.OnRep_IsInoperable
	// void OnRep_IsInoperable();                                                                                               // [0xb4c9ba4] Final|Native|Private 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.OnRep_FakeTires
	// void OnRep_FakeTires(TArray<ETireStates>& PrevTireStates);                                                               // [0xb4c9b08] Final|Native|Private|HasOutParms 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.OnRep_DagwoodRuntimeModifiers
	// void OnRep_DagwoodRuntimeModifiers(FDagwoodRuntimeModifiers& PrevMods);                                                  // [0x3233190] Final|Native|Private|HasOutParms 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.OnInoperableChanged
	// void OnInoperableChanged(bool bInoperable);                                                                              // [0x228deb8] Event|Public|BlueprintEvent 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.OnHoldSelfDestructStopped
	// void OnHoldSelfDestructStopped(class AFortPawn* DriverPawn);                                                             // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.OnHoldSelfDestructStarted
	// void OnHoldSelfDestructStarted(class AFortPawn* DriverPawn, float ExitDuration);                                         // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.OnFlipImpactDamage
	// void OnFlipImpactDamage();                                                                                               // [0x228deb8] Event|Public|BlueprintEvent 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.OnDestroyedPropFromCollision
	// void OnDestroyedPropFromCollision(class ABuildingActor* BuildingHitActor);                                               // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.OnClientBeginAltInteract
	// void OnClientBeginAltInteract(class AFortPawn* Pawn);                                                                    // [0x228deb8] Event|Public|BlueprintEvent 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.OnBoostReady
	// void OnBoostReady();                                                                                                     // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.OnBoostFailed
	// void OnBoostFailed();                                                                                                    // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.NativeCalculateAccelRumbleIntensity
	// float NativeCalculateAccelRumbleIntensity(float MaxIntensity);                                                           // [0xb4c9a7c] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.MakeOperable
	// void MakeOperable(bool bAddGas);                                                                                         // [0x65ef434] Final|Native|Public|BlueprintCallable 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.MakeInoperable
	// void MakeInoperable();                                                                                                   // [0xb4c9a5c] Native|Public|BlueprintCallable 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.IsTireSkidding
	// bool IsTireSkidding(float MinSpeedForSkid, float AngleForSkid, float SpeedForPeelout, float SpeedForBraking);            // [0xb4c9918] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.IsOnLandscape
	// bool IsOnLandscape();                                                                                                    // [0xb4c9900] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.IsNativeBPTickEnabled
	// bool IsNativeBPTickEnabled();                                                                                            // [0x327f13c] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.HandleCurrentPlaylistLoaded
	// void HandleCurrentPlaylistLoaded(FName PlaylistName, FGameplayTagContainer& PlaylistContextTags);                        // [0xb4c9664] Final|Native|Protected|HasOutParms 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.GetTireSurface
	// ETireSurfaces GetTireSurface(EVehicleWheelLocations TireIndex);                                                          // [0xb4c95d8] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.GetTireHealthPercent
	// float GetTireHealthPercent(EVehicleWheelLocations TireIndex);                                                            // [0xb4c9540] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.GetMiddleAxleForwardAdjust
	// float GetMiddleAxleForwardAdjust();                                                                                      // [0xb4c93d4] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.GetCurrentDagwoodRuntimeProperties
	// FDagwoodRuntimeModifiers GetCurrentDagwoodRuntimeProperties();                                                           // [0xb4c93b8] Final|Native|Public|BlueprintCallable 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.GetBumpiness
	// float GetBumpiness();                                                                                                    // [0xb4c93a0] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.ForwardOrReverseInputPressed
	// bool ForwardOrReverseInputPressed();                                                                                     // [0xb4c937c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.CleanupLoopingPooledFX
	// void CleanupLoopingPooledFX();                                                                                           // [0xb4c9364] Native|Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.ApplyRuntimeModifiers
	// void ApplyRuntimeModifiers();                                                                                            // [0xb4c9250] Final|Native|Private 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.AddRuntimeGearsInfoOnServer
	// void AddRuntimeGearsInfoOnServer(FRuntimeGearInfo& GearInfo);                                                            // [0xb4c91bc] Final|Native|Protected|HasOutParms|BlueprintCallable 
};

/// Class /Script/ValetRuntime.FortDagwoodVehicleAnimInstance
/// Size: 0x0068 (0x000618 - 0x000680)
...
public:
	...
	// void UpdatePropReplacement();                                                                                            // [0x36569a8] Final|Native|Public  
	// Function /Script/ValetRuntime.FortDagwoodVehicleManager.OnVehicleSpawnsUpdated
	// void OnVehicleSpawnsUpdated(class UFortVehicleItemDefinition* VehicleItemDef, TArray<AActor*>& SpawnedVehicles, int32_t NewVehicleCount); // [0xb4ca40c] Final|Native|Public|HasOutParms 
	// Function /Script/ValetRuntime.FortDagwoodVehicleManager.OnVehicleSpawned
	// void OnVehicleSpawned(class AFortAthenaVehicle* Vehicle);                                                                // [0xb4ca390] Final|Native|Public  
	// Function /Script/ValetRuntime.FortDagwoodVehicleManager.CustomHandleActorStreamedInEditor
	// void CustomHandleActorStreamedInEditor(class AActor* SourceActor);                                                       // [0x660baec] Final|Native|Public  
};
...
public:
	...
	// void Update_Native();                                                                                                    // [0xb4cad3c] Final|Native|Public|BlueprintCallable 
	// Function /Script/ValetRuntime.FortValetAudioController.OnTireModApplied
	// void OnTireModApplied(FTireInfo& AppliedTireMod);                                                                        // [0x228deb8] Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/ValetRuntime.FortValetAudioController.OnSuspensionCollision_Native
	// void OnSuspensionCollision_Native(bool& OutResult, float& OutMagnitude);                                                 // [0xb4ca2b8] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/ValetRuntime.FortValetAudioController.CacheValetVehicle
	// void CacheValetVehicle(class AFortDagwoodVehicle* InVehicle);                                                            // [0xb4c9264] Final|Native|Public|BlueprintCallable 
};
