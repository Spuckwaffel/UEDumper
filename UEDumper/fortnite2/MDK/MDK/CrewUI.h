...
public:
	...
	// void BlockScreenContent(bool bBlockScreen, FText& ContentBlockedText);                                                   // [0x228deb8] Event|Protected|HasOutParms|BlueprintEvent 
};
...
public:
	...
	// void OnAthenaProfileInitialized();                                                                                       // [0x3ee49c4] Final|Native|Private 
};
...
public:
	...
	// void OnTemporaryItemsStateChanged();                                                                                     // [0xbd2550c] Final|Native|Private 
};
...
public:
	...
	// void SetTileView(class UTileView* InTileView);                                                                           // [0xa95c4bc] Final|Native|Protected|BlueprintCallable 
	// Function /Script/CrewUI.FortTemporaryItemsRow.GetCategoryText
	// FText GetCategoryText(EAthenaCustomizationCategory InCategory);                                                          // [0xbd252a0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void SetData(class UFortSubscriptionVM* SubscriptionVM, class UFortTemporaryItemsRewardVM* RewardVM);                    // [0xbd2564c] Final|Native|Public|BlueprintCallable 
	// Function /Script/CrewUI.FortTemporaryItemsScreenItemInfo.OnDataSet
	// void OnDataSet(bool bValidItem, bool bIsSubscribed, bool IsOwned);                                                       // [0x228deb8] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void SetupRewardItem(class UFortAccountItemDefinition* ItemDef);                                                         // [0xbd25710] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void OnCurrencyUpdated();                                                                                                // [0x228deb8] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void OnTriggerIntroAnimation(bool bCanClaimRewards);                                                                     // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.BattlePassCrewPurchaseContainer.OnContentStateUpdated
	// void OnContentStateUpdated(EBattlePassCrewContentState InState, bool bInScreenOpened);                                   // [0x228deb8] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void RefreshFocus();                                                                                                     // [0x2fe17b4] Final|Native|Protected|BlueprintCallable 
	// Function /Script/CrewUI.BattlePassPurchaseScreen.OnShowNavButtonNotification
	// void OnShowNavButtonNotification(bool bShowNotification);                                                                // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.BattlePassPurchaseScreen.OnSetScreenInteractable
	// void OnSetScreenInteractable(bool bInteractable);                                                                        // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.BattlePassPurchaseScreen.OnSetNavButtonNotificationText
	// void OnSetNavButtonNotificationText(FText& NotificationText);                                                            // [0x228deb8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/CrewUI.BattlePassPurchaseScreen.OnPurchaseStateChanged
	// void OnPurchaseStateChanged(EBattlePassPurchaseState InCurrentState);                                                    // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.BattlePassPurchaseScreen.OnPurchaseConfirmed
	// void OnPurchaseConfirmed();                                                                                              // [0x228deb8] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void OnSetHowToCancelURL(FString MoreInfoUrl);                                                                           // [0x228deb8] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void OnSetPriceChangeAcknowledgeTitle(FText& Title);                                                                     // [0x228deb8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/CrewUI.CrewPriceChangeAcknowledgeModal.OnSetPriceChangeAcknowledgeMoreInfoUrl
	// void OnSetPriceChangeAcknowledgeMoreInfoUrl(FText& MoreInfoUrl);                                                         // [0x228deb8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/CrewUI.CrewPriceChangeAcknowledgeModal.OnSetPriceChangeAcknowledgeMoreInfoText
	// void OnSetPriceChangeAcknowledgeMoreInfoText(FText& ConfirmButtonText);                                                  // [0x228deb8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/CrewUI.CrewPriceChangeAcknowledgeModal.OnSetPriceChangeAcknowledgeConfirmButtonText
	// void OnSetPriceChangeAcknowledgeConfirmButtonText(FText& ConfirmButtonText);                                             // [0x228deb8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/CrewUI.CrewPriceChangeAcknowledgeModal.OnSetPriceChangeAcknowledgeCheckboxText
	// void OnSetPriceChangeAcknowledgeCheckboxText(FText& CheckboxText);                                                       // [0x228deb8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/CrewUI.CrewPriceChangeAcknowledgeModal.OnSetPriceChangeAcknowledgeCancelSubscriptionButtonText
	// void OnSetPriceChangeAcknowledgeCancelSubscriptionButtonText(FText& CancelSubscriptionButtonText);                       // [0x228deb8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/CrewUI.CrewPriceChangeAcknowledgeModal.OnSetPriceChangeAcknowledgeBodyText
	// void OnSetPriceChangeAcknowledgeBodyText(FText& BodyText);                                                               // [0x228deb8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/CrewUI.CrewPriceChangeAcknowledgeModal.OnSetPriceChangeAcknowledgeBodyTable
	// void OnSetPriceChangeAcknowledgeBodyTable(TArray<FCrewTableRow>& PriceChangeByRegionRows);                               // [0x228deb8] Event|Protected|HasOutParms|BlueprintEvent 
	...
	// void ExitModal();                                                                                                        // [0x402e5f8] Final|Native|Protected|BlueprintCallable 
};
...
public:
	...
	// void OnUserInformationTextsUpdated(FText& UserInformationText1, FText& UserInformationText2, EMcpSubscriptionState SubscriptionState); // [0x228deb8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/CrewUI.CrewPurchaseScreen.OnUpdateVBuckRefundVisibility
	// void OnUpdateVBuckRefundVisibility(bool bVisible);                                                                       // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.CrewPurchaseScreen.OnUpdatePurchaseButtonState
	// void OnUpdatePurchaseButtonState(ECrewPurchaseButtonState ButtonState);                                                  // [0x228deb8] Event|Protected|BlueprintEvent 
	...
	// void OnSetPaymentLegalText(FText& LegalText);                                                                            // [0x228deb8] Event|Protected|HasOutParms|BlueprintEvent 
	...
	// void OnContainerTabVisibilityUpdated(bool bTabsVisible, float SpacingAdjustmentForTabs);                                 // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.CrewPurchaseScreen.EndProgress
	// void EndProgress();                                                                                                      // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.CrewPurchaseScreen.BeginProgress
	// void BeginProgress(FText& ProgressLabel);                                                                                // [0x228deb8] Event|Protected|HasOutParms|BlueprintEvent 
};
...
public:
	...
	// void OnUpdateOwnedState(bool bOwned);                                                                                    // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.CrewRewardTile.OnStartingDownloadTileImage
	// void OnStartingDownloadTileImage();                                                                                      // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.CrewRewardTile.OnDownloadTileImageComplete
	// void OnDownloadTileImageComplete(class UTexture2D* Texture);                                                             // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.CrewRewardTile.IsMonthlyBenefit
	// bool IsMonthlyBenefit();                                                                                                 // [0xbd254e0] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void OnTabSelected(int32_t TabIndex);                                                                                    // [0x228deb8] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void OnTagSetup(ECrewDetailsTag RewardTag, bool bIsOwnedTag);                                                            // [0x228deb8] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void BP_OnContainerTabVisibilityUpdated(bool bTabsVisible, float SpacingAdjustmentForTabs);                              // [0x228deb8] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void OnUpdateSubscriptionState(bool bSubscribed);                                                                        // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.FortProgressiveItemScreen.OnItemSelected
	// void OnItemSelected();                                                                                                   // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.FortProgressiveItemScreen.OnErrorStateTextUpdated
	// void OnErrorStateTextUpdated(FText& ErrorStateText);                                                                     // [0x228deb8] Event|Protected|HasOutParms|BlueprintEvent 
};
...
public:
	...
	// void BP_OnSetHeaderInfo(FText& Subheading, bool bSubscribed, int32_t UnlockedStages, int32_t MaxStages);                 // [0x228deb8] Event|Protected|HasOutParms|BlueprintEvent 
};
...
public:
	...
	// void OnTileMaterialLoaded(bool bSubscribed);                                                                             // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.FortProgressiveItemWidget.OnStageItemChanged
	// void OnStageItemChanged(FProgressiveStageItemInfo& InStageItemInfo);                                                     // [0x228deb8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/CrewUI.FortProgressiveItemWidget.OnPeekStateChanged
	// void OnPeekStateChanged(bool bIsInPeekState);                                                                            // [0x228deb8] Event|Protected|BlueprintEvent 
...
public:
	...
	// void BP_OnUpdateSetDetails(FText& SetName, FText& ExpiringText, bool bCompleted);                                        // [0x228deb8] Event|Protected|HasOutParms|BlueprintEvent 
};
...
public:
	...
	// void ClearSetTiles();                                                                                                    // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.FortProgressiveSetList.AddSetTile
	// class UFortProgressiveSetTile* AddSetTile();                                                                             // [0x228deb8] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void BP_OnTileMaterialLoaded(bool bSubscribed);                                                                          // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.FortProgressiveSetTile.BP_OnInitializeSetInfo
	// void BP_OnInitializeSetInfo(FProgressiveSetInfo& InSetInfo, FText& BottomText, FText& BottomSubtext, bool bSubscribed);  // [0x228deb8] Event|Protected|HasOutParms|BlueprintEvent 
};
...
public:
	...
	// void SelectStageInDirection(int32_t Direction);                                                                          // [0xbd25520] Final|Native|Public|BlueprintCallable 
	// Function /Script/CrewUI.FortProgressiveStageList.ClearStageWidgets
	// void ClearStageWidgets();                                                                                                // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.FortProgressiveStageList.AddStageWidget
	// class UFortProgressiveStageWidget* AddStageWidget();                                                                     // [0x228deb8] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void OnSetTooltipVisible(bool bVisible);                                                                                 // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.FortProgressiveStageWidget.OnSetTooltipText
	// void OnSetTooltipText(FText& InToolTipText);                                                                             // [0x228deb8] Event|Protected|HasOutParms|BlueprintEvent 
	...
	// void ClearStageItemWidgets();                                                                                            // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.FortProgressiveStageWidget.AddStageItemWidget
	// class UFortProgressiveItemWidget* AddStageItemWidget();                                                                  // [0x228deb8] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void BP_OnUpdateSubscriptionState(bool bSubscribed);                                                                     // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.FortProgressiveTableOfContentsScreen.BP_OnUpdateNumTilesAvailable
	// void BP_OnUpdateNumTilesAvailable(int32_t NumTiles);                                                                     // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.FortProgressiveTableOfContentsScreen.BP_OnUpdateErrorStateText
	// void BP_OnUpdateErrorStateText(FText& ErrorStateText);                                                                   // [0x228deb8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/CrewUI.FortProgressiveTableOfContentsScreen.BP_OnUpdateBanner
	// void BP_OnUpdateBanner(FText& BannerText, bool bAllSetsCompleted, bool bSubscribed);                                     // [0x228deb8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/CrewUI.FortProgressiveTableOfContentsScreen.BP_OnSetDescriptionText
	// void BP_OnSetDescriptionText(FText& ProductDescription);                                                                 // [0x228deb8] Event|Protected|HasOutParms|BlueprintEvent 
};
...
public:
	...
	// void SetupRowEntry(class UFortTemporaryItemsRow* RewardRow);                                                             // [0xbd257a8] Final|Native|Protected|BlueprintCallable 
	// Function /Script/CrewUI.FortTemporaryItemsScreen.GetSubscriptionVM
	// class UFortSubscriptionVM* GetSubscriptionVM();                                                                          // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.FortTemporaryItemsScreen.GetRemainingDaysLabel
	// FText GetRemainingDaysLabel(class UFortTemporaryItemsVM* TemporaryItemsVM);                                              // [0xbd25348] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
