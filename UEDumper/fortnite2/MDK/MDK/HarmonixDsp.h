...
public:
	...
	DMember(bool)                                      bUnpitched                                                  OFFSET(get<bool>, {0x34, 1, 0, 0})
	DMember(bool)                                      bVelocityToGain                                             OFFSET(get<bool>, {0x35, 1, 0, 0})
	SMember(FTimeStretchConfig)                        TimeStretchConfig                                           OFFSET(getStruct<T>, {0x38, 96, 0, 0})
	DMember(bool)                                      bIsNoteOffZone                                              OFFSET(get<bool>, {0x98, 1, 0, 0})
	DMember(float)                                     RandomWeight                                                OFFSET(get<float>, {0x9C, 4, 0, 0})
	DMember(int32_t)                                   SampleStartOffset                                           OFFSET(get<int32_t>, {0xA0, 4, 0, 0})
	DMember(int32_t)                                   SampleEndOffset                                             OFFSET(get<int32_t>, {0xA4, 4, 0, 0})
	CMember(TArray<FTrackChannelInfo>)                 TrackMap                                                    OFFSET(get<T>, {0xA8, 16, 0, 0})
	DMember(bool)                                      UseSingletonVoicePool                                       OFFSET(get<bool>, {0xB8, 1, 0, 0})
};
