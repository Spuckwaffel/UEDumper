...
public:
	...
	// void HandleEventModeFocusingChanged(bool bIsEventModeFocusing);                                                          // [0xbd4a654] Final|Native|Private 
	// Function /Script/EventModeUI.FocusButton.HandleCanUseEventModeFocusChanged
	// void HandleCanUseEventModeFocusChanged(bool bCanUseEventModeFocus);                                                      // [0xbd4a5d8] Final|Native|Private 
};
...
public:
	...
	// void OnFocusStateChanged(bool bIsFocusing);                                                                              // [0x228deb8] Event|Public|BlueprintEvent 
	// Function /Script/EventModeUI.FortEventModeEmotesWidget.OnFocusAvailableChanged
	// void OnFocusAvailableChanged(bool bIsFocusAvailable);                                                                    // [0x228deb8] Event|Public|BlueprintEvent 
};
...
public:
	...
	// void HandleEventModeFocusingChanged(bool bIsEventModeFocusing);                                                          // [0xab93364] Final|Native|Private 
	// Function /Script/EventModeUI.FortMobileActionButtonBehavior_Focus.HandleCanUseEventModeFocusChanged
	// void HandleCanUseEventModeFocusChanged(bool bCanUseEventModeFocus);                                                      // [0xab933e4] Final|Native|Private 
};
