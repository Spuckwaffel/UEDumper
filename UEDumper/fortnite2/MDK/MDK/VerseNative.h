...
public:
	...
	// void EndProfileBlock(FSolarisProfilingData Data, int64_t UserTag);                                                       // [0x78fac6c] Final|Native|Static|Public 
	// Function /Script/VerseNative.SolarisProfilingLibrary.BeginProfileBlock
	// FSolarisProfilingData BeginProfileBlock();                                                                               // [0x78fac14] Final|Native|Static|Public 
};
...
public:
	...
	// void StmSave(FakeType& Property);                                                                                        // [0x78fb584] Final|Native|Static|Public|HasOutParms 
	// Function /Script/VerseNative.VerseStmLibrary.StmRollback
	// void StmRollback();                                                                                                      // [0x78fb388] Final|Native|Static|Public 
	// Function /Script/VerseNative.VerseStmLibrary.StmLeaveFrame
	// void StmLeaveFrame();                                                                                                    // [0x78fb374] Final|Native|Static|Public 
	// Function /Script/VerseNative.VerseStmLibrary.StmEnterFrame
	// void StmEnterFrame();                                                                                                    // [0x78fb324] Final|Native|Static|Public 
	// Function /Script/VerseNative.VerseStmLibrary.StmEnabled
	// void StmEnabled();                                                                                                       // [0x78fb290] Final|Native|Static|Public 
	// Function /Script/VerseNative.VerseStmLibrary.StmCommit
	// void StmCommit();                                                                                                        // [0x78fae38] Final|Native|Static|Public 
	// Function /Script/VerseNative.VerseStmLibrary.StmBegin
	// void StmBegin();                                                                                                         // [0x78fae24] Final|Native|Static|Public 
};
