...
public:
	...
	// void SetGameplayMusicVolume(float NewVolume);                                                                            // [0xbc59768] Final|Native|Public  
	// Function /Script/SparksSettingsRuntime.SparksClientSettingRecordPartition.GetGameplayMusicVolume
	// float GetGameplayMusicVolume();                                                                                          // [0x6fee498] Final|RequiredAPI|Native|Public|Const 
};
...
public:
	...
	// void UpdateSparksMixFromPartition();                                                                                     // [0xbc597ec] Final|Native|Public|Const 
	// Function /Script/SparksSettingsRuntime.SparksSettingsControllerComponent.GetSparksClientSettingRecordPartition
	// class USparksClientSettingRecordPartition* GetSparksClientSettingRecordPartition();                                      // [0xbc59744] Final|Native|Public|Const 
};
