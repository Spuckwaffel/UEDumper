...
public:
	CMember(class USocialChatChannel*)                 ChatChannel                                                 OFFSET(get<T>, {0x14F0, 8, 0, 0})
	CMember(class UCommonTextBlock*)                   CommonText_ChannelName                                      OFFSET(get<T>, {0x14F8, 8, 0, 0})
};
...
public:
	...
	// void SendCurrentMessage();                                                                                               // [0xa8e1504] Final|Native|Public|BlueprintCallable 
	// Function /Script/SocialUMG.SocialChatContainer.OnChatOpenChanged
	// void OnChatOpenChanged(bool bShouldBeOpen);                                                                              // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/SocialUMG.SocialChatContainer.HandleRightTabPressed
	// void HandleRightTabPressed();                                                                                            // [0xa8e147c] Final|Native|Public|BlueprintCallable 
	// Function /Script/SocialUMG.SocialChatContainer.HandleLeftTabPressed
	// void HandleLeftTabPressed();                                                                                             // [0xa8e1360] Final|Native|Public|BlueprintCallable 
	// Function /Script/SocialUMG.SocialChatContainer.FocusEditableText
	// void FocusEditableText();                                                                                                // [0xa8e12b0] Final|Native|Public|BlueprintCallable 
	// Function /Script/SocialUMG.SocialChatContainer.DynamicHandleMessageTextCommitted
	// void DynamicHandleMessageTextCommitted(FText& MessageText, TEnumAsByte<ETextCommit> CommitMethod);                       // [0xa8e119c] Final|Native|Private|HasOutParms 
};
...
public:
	...
	// void OnMessageSet();                                                                                                     // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/SocialUMG.SocialChatMessageEntry.CanInteract
	// bool CanInteract();                                                                                                      // [0x327f13c] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	CMember(class USocialGroupChannel*)                SocialGroup                                                 OFFSET(get<T>, {0x1500, 8, 0, 0})
	CMember(class UTextBlock*)                         Text_GroupName                                              OFFSET(get<T>, {0x1508, 8, 0, 0})
	CMember(class UMenuAnchor*)                        MenuAnchor_Actions                                          OFFSET(get<T>, {0x1510, 8, 0, 0})


	/// Functions
	// Function /Script/SocialUMG.SocialGroupListEntry.HandleGetMenuContent
	// class UUserWidget* HandleGetMenuContent();                                                                               // [0xa8e1318] Final|Native|Protected 
};

/// Class /Script/SocialUMG.SocialGroupTreeView
/// Size: 0x0028 (0x000C28 - 0x000C50)
...
public:
	SMember(FLinearColor)                              DefaultIndicatorColor                                       OFFSET(getStruct<T>, {0x14F0, 16, 0, 0})
	SMember(FLinearColor)                              AlertingIndicatorColor                                      OFFSET(getStruct<T>, {0x1500, 16, 0, 0})
	CMember(class UCommonTextBlock*)                   Text_InteractionName                                        OFFSET(get<T>, {0x1590, 8, 0, 0})
	CMember(class UBorder*)                            Border_InteractionIndicator                                 OFFSET(get<T>, {0x1598, 8, 0, 0})


	/// Functions
	// Function /Script/SocialUMG.SocialInteractionButton.OnInteractionSet
	// void OnInteractionSet();                                                                                                 // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/SocialUMG.SocialInteractionButton.IsPlatformOnlyFriend
	// bool IsPlatformOnlyFriend();                                                                                             // [0xa8e1490] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/SocialUMG.SocialInteractionButton.GetInteractionName
	// FName GetInteractionName();                                                                                              // [0xa8e12e4] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void OnOpened();                                                                                                         // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/SocialUMG.SocialActionMenu.HandleMenuAnchorOpenChanged
	// void HandleMenuAnchorOpenChanged(bool bIsOpen);                                                                          // [0xa8e1374] Final|Native|Protected 
};
...
public:
	...
	// void OnToggleConfirmation(bool bIsVisible);                                                                              // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/SocialUMG.SocialInteractionMenu.GetFirstEntryToCenter
	// class UWidget* GetFirstEntryToCenter();                                                                                  // [0xa8e12c4] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
};

/// Class /Script/SocialUMG.SocialNameTextBlock
/// Size: 0x0028 (0x000868 - 0x000890)
...
public:
	CMember(class UClass*)                             ActionMenuClass                                             OFFSET(get<T>, {0x1508, 8, 0, 0})
	CMember(class UMenuAnchor*)                        MenuAnchor_Actions                                          OFFSET(get<T>, {0x1510, 8, 0, 0})


	/// Functions
	// Function /Script/SocialUMG.SocialListInteractableEntryBase.HandleMenuOpenChanged
	// void HandleMenuOpenChanged(bool bIsMenuOpen);                                                                            // [0xa8e13f8] Final|Native|Private 
	// Function /Script/SocialUMG.SocialListInteractableEntryBase.HandleGetMenuContent
	// class UUserWidget* HandleGetMenuContent();                                                                               // [0xa8e133c] Final|Native|Protected 
};

/// Class /Script/SocialUMG.SocialListUserEntryBase
/// Size: 0x0028 (0x001518 - 0x001540)
...
public:
	CMember(class USocialNameTextBlock*)               Text_SocialName                                             OFFSET(get<T>, {0x1520, 8, 0, 0})
	CMember(class USocialNameTextBlock*)               Text_SocialName_Hover                                       OFFSET(get<T>, {0x1528, 8, 0, 0})
	CMember(class UCommonRichTextBlock*)               Text_RichPresence                                           OFFSET(get<T>, {0x1530, 8, 0, 0})
	CMember(class UCommonRichTextBlock*)               Text_RichPresence_Hover                                     OFFSET(get<T>, {0x1538, 8, 0, 0})
};
...
public:
	CMember(class UTextBlock*)                         Text_ListName                                               OFFSET(get<T>, {0x1508, 8, 0, 0})
	CMember(class UTextBlock*)                         Text_NumEntries                                             OFFSET(get<T>, {0x1510, 8, 0, 0})
};
