...
public:
	...
	// void SetLaserGridEnable(bool bEnable);                                                                                   // [0x65ef434] Final|BlueprintAuthorityOnly|Native|Protected|BlueprintCallable 
	// Function /Script/LaserGameplayRuntime.BuildingGameplayActorLaserGrid.OnRep_LaserGridConnections
	// void OnRep_LaserGridConnections();                                                                                       // [0xbde8a8c] Final|Native|Private 
	// Function /Script/LaserGameplayRuntime.BuildingGameplayActorLaserGrid.OnRep_bEnabled
	// void OnRep_bEnabled();                                                                                                   // [0xbde8aa0] Final|Native|Private 
	// Function /Script/LaserGameplayRuntime.BuildingGameplayActorLaserGrid.LaserGridTriggered
	// void LaserGridTriggered(FLaserGridConnectionEntry& LaserConnectionData, class AActor* TriggeringActor);                  // [0x228deb8] BlueprintAuthorityOnly|Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/LaserGameplayRuntime.BuildingGameplayActorLaserGrid.LaserGridStateUpdated
	// void LaserGridStateUpdated(bool bLaserGridEnabled);                                                                      // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/LaserGameplayRuntime.BuildingGameplayActorLaserGrid.HandlePatternTimerComplete_PreTransition
	// void HandlePatternTimerComplete_PreTransition();                                                                         // [0x36569a8] Final|Native|Private 
	// Function /Script/LaserGameplayRuntime.BuildingGameplayActorLaserGrid.HandlePatternTimerComplete_PostTransition
	// void HandlePatternTimerComplete_PostTransition();                                                                        // [0x36569a8] Final|Native|Private 
	// Function /Script/LaserGameplayRuntime.BuildingGameplayActorLaserGrid.HandleLaserCollisionOverlap
	// void HandleLaserCollisionOverlap(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool bFromSweep, FHitResult& SweepResult); // [0x8acd388] Final|Native|Private|HasOutParms 
	// Function /Script/LaserGameplayRuntime.BuildingGameplayActorLaserGrid.HandleAttachedBuildingActorDied
	// void HandleAttachedBuildingActorDied(class AActor* DamagedActor, float Damage, class AController* InstigatedBy, class AActor* DamageCauser, FVector HitLocation, class UPrimitiveComponent* HitComponent, FName BoneName, FVector Momentum); // [0x905b19c] Final|Native|Private|HasDefaults 
	// Function /Script/LaserGameplayRuntime.BuildingGameplayActorLaserGrid.GetActiveLaserGridConnections
	// void GetActiveLaserGridConnections(TArray<FLaserGridConnectionEntry>& OutActiveLaserGridConnections);                    // [0xbde839c] Final|Native|Public|HasOutParms|BlueprintCallable|Const 
	// Function /Script/LaserGameplayRuntime.BuildingGameplayActorLaserGrid.CosmeticDestroyOutletInstance
	// void CosmeticDestroyOutletInstance(FLaserGridOutletEntry& OutletEntry);                                                  // [0x228deb8] BlueprintCosmetic|Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/LaserGameplayRuntime.BuildingGameplayActorLaserGrid.CanActorTriggerLaserGrid
	// bool CanActorTriggerLaserGrid(class AActor* TriggeringActor);                                                            // [0xbde8308] BlueprintAuthorityOnly|Native|Event|Protected|BlueprintEvent|Const 
};
