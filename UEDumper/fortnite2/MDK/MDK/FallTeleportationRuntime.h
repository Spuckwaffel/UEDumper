...
public:
	...
	// void HandleWarmupCountdownEndTimeUpdated(float NewEndTime);                                                              // [0xbd6a820] Final|Native|Protected 
	// Function /Script/FallTeleportationRuntime.FortFallTeleportSpawnerComponent.HandleGamePhaseChanged
	// void HandleGamePhaseChanged(FFortGamePhaseUpdatedEvent& Event);                                                          // [0xbd6a794] Final|Native|Protected|HasOutParms 
};
...
public:
	...
	// void EnableFallTeleportationIndefinitely();                                                                              // [0x36569a8] Final|Exec|Native|Private 
};
...
public:
	...
	// void UpdateLastGroundLocation(class ACharacter* Character, TEnumAsByte<EMovementMode> PrevMovementMode, char PreviousCustomMode); // [0xbd6aa24] Final|Native|Protected 
	// Function /Script/FallTeleportationRuntime.FortFallTeleportComponentBase.IsValidActorToTeleportOn
	// bool IsValidActorToTeleportOn(class AActor* ActorToTeleportOn);                                                          // [0xbd6a970] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/FallTeleportationRuntime.FortFallTeleportComponentBase.IsTeleportLocationValid
	// bool IsTeleportLocationValid(FVector& LocationToTest);                                                                   // [0xbd6a89c] Final|Native|Protected|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const 
};
