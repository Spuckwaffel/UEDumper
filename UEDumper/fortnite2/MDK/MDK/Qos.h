...
public:
	...
	// void ServerQosRequest(FString InSessionId);                                                                              // [0x7c4fba0] Net|NetReliableNative|Event|Protected|NetServer|NetValidate 
	// Function /Script/Qos.QosBeaconClient.ClientQosResponse
	// void ClientQosResponse(EQosResponseType Response);                                                                       // [0x7c4fb1c] Net|NetReliableNative|Event|Protected|NetClient 
};
