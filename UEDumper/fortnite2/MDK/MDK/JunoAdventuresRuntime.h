...
public:
	...
	// void Client_SetCachedContextualMessageResult(FJunoContextualMessageQueryResult Result);                                  // [0xcbdd0a8] Final|Net|NetReliableNative|Event|Private|NetClient 
};

/// Class /Script/JunoAdventuresRuntime.JunoControllerComponent_SocialSimAI
...
public:
	...
	/// Functions
	// Function /Script/JunoAdventuresRuntime.JunoControllerComponent_SocialSimAI.Server_RequestNPCHardRemoval
	// void Server_RequestNPCHardRemoval(FGameplayTag UniqueAIIdentifier);                                                      // [0xcbdf50c] RequiredAPI|Net|NetReliableNative|Event|Public|NetServer|BlueprintCallable 
	// Function /Script/JunoAdventuresRuntime.JunoControllerComponent_SocialSimAI.Server_RequestCreatureHardRemoval
	// void Server_RequestCreatureHardRemoval(FGameplayTag UniqueAIIdentifier);                                                 // [0xcbdf488] RequiredAPI|Net|NetReliableNative|Event|Public|NetServer|BlueprintCallable 
};
...
public:
	...
	// bool ValidateUniqueResidentTag(FGameplayTag& OtherResidentIdentifier);                                                   // [0xcbdf6f8] Final|Native|Private|HasOutParms|Const 
	// Function /Script/JunoAdventuresRuntime.JunoControllerRequirement_CampResidentsHaveTag.ValidateRoleTag
	// bool ValidateRoleTag(FGameplayTag& OtherResidentIdentifier, class UPlayspaceComponent_JunoAIPersistence* RootAIPersistenceComp); // [0xcbdf590] Final|Native|Private|HasOutParms|Const 
};
...
public:
	...
	// TArray<FName> Editor_GetValidObjectives();                                                                               // [0x852f484] Final|Native|Private|Const 
};
...
public:
	...
	SMember(FText)                                     GetTextFormat                                               OFFSET(getStruct<T>, {0x198, 16, 0, 0})
	SMember(FText)                                     FinishedTextFormat                                          OFFSET(getStruct<T>, {0x1A8, 16, 0, 0})
};
...
public:
	SMember(FText)                                     GiftTextFormat                                              OFFSET(getStruct<T>, {0x170, 16, 0, 0})
	DMember(int32_t)                                   MaxChoiceNodesToGenerate                                    OFFSET(get<int32_t>, {0x180, 4, 0, 0})
	CMember(TArray<FGameplayTag>)                      InventoryGroupTypesToPickItemsFrom                          OFFSET(get<T>, {0x188, 16, 0, 0})
};
...
/// Class /Script/JunoAdventuresRuntime.JunoConversationTaskNode_GrantDirectReward
...
public:
	CMember(TArray<FDataTableRowHandle>)               RewardsToGive                                               OFFSET(get<T>, {0x190, 16, 0, 0})
};
...
public:
	...
	SMember(FText)                                     JoinCampTextFormat                                          OFFSET(getStruct<T>, {0x198, 16, 0, 0})
	SMember(FScalableFloat)                            MaxDistanceFromCamp                                         OFFSET(getStruct<T>, {0x1A8, 40, 0, 0})
};
...
public:
	...
	SMember(FText)                                     StyledParticipantNameFormat                                 OFFSET(getStruct<T>, {0x190, 16, 0, 0})
	DMember(bool)                                      bUseInlineConfig                                            OFFSET(get<bool>, {0x1A0, 1, 0, 0})
	CMember(class UJunoContextualMessageConfigCollection*) ExternalContextualMessageCollection                     OFFSET(get<T>, {0x1A8, 8, 0, 0})
	CMember(TArray<FJunoSpecializedContextualMessageConfig>) SpecializedConfigs                                    OFFSET(get<T>, {0x1B0, 16, 0, 0})
	SMember(FJunoContextualMessageConfig)              GeneralConfig                                               OFFSET(getStruct<T>, {0x1C0, 16, 0, 0})
	SMember(FDataTableRowHandle)                       GeneralConfigTableRow                                       OFFSET(getStruct<T>, {0x1D0, 16, 0, 0})


	/// Functions
	// Function /Script/JunoAdventuresRuntime.JunoConversationTaskNode_Speech.PlayClientVoiceLine
	// void PlayClientVoiceLine(FConversationContext& Context, FJunoContextualMessageQueryResult& MessageParams);               // [0xcbdeaa0] Native|Event|Protected|HasOutParms|BlueprintEvent|Const 
};
...
public:
	SMember(FText)                                     TradeTextFormat_Single                                      OFFSET(getStruct<T>, {0x170, 16, 0, 0})
	SMember(FText)                                     TradeTextFormat_Plural                                      OFFSET(getStruct<T>, {0x180, 16, 0, 0})
	SMember(FText)                                     NotEnoughForTradeTextFormat_Single                          OFFSET(getStruct<T>, {0x190, 16, 0, 0})
	SMember(FText)                                     NotEnoughForTradeTextFormat_Plural                          OFFSET(getStruct<T>, {0x1A0, 16, 0, 0})
	DMember(int32_t)                                   MaxChoiceNodesToGenerate                                    OFFSET(get<int32_t>, {0x1B0, 4, 0, 0})
};

/// Class /Script/JunoAdventuresRuntime.JunoNPCConversationParticipantComponent
/// Size: 0x0090 (0x000668 - 0x0006F8)
...
public:
	SMember(FMulticastInlineDelegate)                  OnJunoConversationParticipantIconChangedDelegate            OFFSET(getStruct<T>, {0x668, 16, 0, 0})
	CMember(TWeakObjectPtr<UTexture2D*>)               ParticipantIconSmall                                        OFFSET(get<T>, {0x678, 32, 0, 0})


	/// Functions
	// Function /Script/JunoAdventuresRuntime.JunoNPCConversationParticipantComponent.OnRep_ParticipantIconSmall
	// void OnRep_ParticipantIconSmall();                                                                                       // [0xcbdea3c] Final|Native|Protected 
};
...
public:
	CMember(TWeakObjectPtr<UJunoInventoryComponent*>)  InventoryComponent                                          OFFSET(get<T>, {0x28, 8, 0, 0})


	/// Functions
	// Function /Script/JunoAdventuresRuntime.JunoChangeInventoryHelper.HandleInventoryChangedEvent
	// void HandleInventoryChangedEvent(FJunoItemSlot& ItemSlot, EJunoItemChangeType ChangeType);                               // [0xcbde084] Final|Native|Public|HasOutParms 
};
...
public:
	...
	// void RollGrantableQuestID();                                                                                             // [0xcbdf2b4] Final|Native|Public|BlueprintCallable 
	// Function /Script/JunoAdventuresRuntime.JunoQuestGiverComponent.HandleOnJunoQuestComplete
	// void HandleOnJunoQuestComplete(TScriptInterface<Class>& QuestInstance);                                                  // [0xcbde250] Final|Native|Private|HasOutParms 
	// Function /Script/JunoAdventuresRuntime.JunoQuestGiverComponent.GetGrantableQuestID
	// FString GetGrantableQuestID();                                                                                           // [0xcbdd13c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoAdventuresRuntime.JunoQuestGiverComponent.BindToQuestManagerDelegates
	// void BindToQuestManagerDelegates();                                                                                      // [0xcbdd094] Final|Native|Private 
};
...
public:
	...
	// void ReceiveToken(FGameplayTag& JunoToken);                                                                              // [0xcbdf1e8] Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/JunoAdventuresRuntime.JunoTokenHandlerAIComponent.GetSavedTokens
	// FGameplayTagContainer GetSavedTokens();                                                                                  // [0xcbde054] Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// EJunoQuestState GetJunoQuestState(FString QuestID);                                                                      // [0xcbdd288] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void SendQuestStatEvent(EFortQuestObjectiveStatEvent Type, FGameplayTagContainer SourceTags, FGameplayTagContainer TargetTags, int32_t Count); // [0xcbdf2c8] Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
	// Function /Script/JunoAdventuresRuntime.JunoQuestManagerComponent.GetQuestGiverForQuestID
	// class AActor* GetQuestGiverForQuestID(FString QuestID);                                                                  // [0xcbdd968] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoAdventuresRuntime.JunoQuestManagerComponent.ActivateQuest
	// void ActivateQuest(class UFortQuestItemDefinition_Athena* QuestDefinition, class AActor* QuestGiver);                    // [0xcbdcfd0] Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
};
...
public:
	...
	// TArray<FName> Editor_GetValidObjectiveNames();                                                                           // [0x852f484] Final|Native|Private|Const 
};
...
public:
	...
	// class UJunoQuestManagerComponent* GetJunoQuestManager(class UObject* WorldContextObject);                                // [0xcbdd208] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/JunoAdventuresRuntime.JunoAdventuresBlueprintLibrary.GetJunoQuestDatabase
	// class UJunoQuestDatabaseComponent* GetJunoQuestDatabase(class UObject* WorldContextObject);                              // [0xcbdd188] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// void JunoSpawnVisitorInClosestCamp(FString PartialUniqueAIIdentifier, int32_t Count);                                    // [0x9bccbc8] Final|BlueprintAuthorityOnly|Exec|Native|Private|Const 
	// Function /Script/JunoAdventuresRuntime.JunoCheatManager_Adventures.JunoRepopulateAvailableQuestsWithTags
	// void JunoRepopulateAvailableQuestsWithTags(FString QuestPoolTags);                                                       // [0xcbde358] Final|BlueprintAuthorityOnly|Exec|Native|Private 
	// Function /Script/JunoAdventuresRuntime.JunoCheatManager_Adventures.JunoRepopulateAvailableQuests
	// void JunoRepopulateAvailableQuests();                                                                                    // [0xcbde2e0] Final|BlueprintAuthorityOnly|Exec|Native|Private 
	// Function /Script/JunoAdventuresRuntime.JunoCheatManager_Adventures.JunoQueueScriptRowMessagesForNpcConversation
	// void JunoQueueScriptRowMessagesForNpcConversation(FString ScriptName, FString RowName);                                  // [0xa02e0ec] Final|BlueprintAuthorityOnly|Exec|Native|Private 
	// Function /Script/JunoAdventuresRuntime.JunoCheatManager_Adventures.JunoPrintNPCsInfo
	// void JunoPrintNPCsInfo(bool bIgnoreAIsWithNoAssignment);                                                                 // [0x65ef434] Final|Exec|Native|Private|Const 
	// Function /Script/JunoAdventuresRuntime.JunoCheatManager_Adventures.JunoPrintCurrentConversationInfo
	// void JunoPrintCurrentConversationInfo();                                                                                 // [0x36569a8] Final|Exec|Native|Private|Const 
	// Function /Script/JunoAdventuresRuntime.JunoCheatManager_Adventures.JunoInjectDisplayTextForNpcConversation
	// void JunoInjectDisplayTextForNpcConversation(FString TestString);                                                        // [0x6e4c448] Final|BlueprintAuthorityOnly|Exec|Native|Private|Const 
};
...
public:
	...
	SMember(FGameplayTag)                              VoiceOverTag                                                OFFSET(getStruct<T>, {0x10, 4, 0, 0})
	SMember(FGameplayTag)                              MoodReactionTag                                             OFFSET(getStruct<T>, {0x14, 4, 0, 0})
	CMember(TArray<FConversationNodeParameterPair>)    MetadataParameters                                          OFFSET(get<T>, {0x18, 16, 0, 0})
...
public:
	SMember(FText)                                     Message                                                     OFFSET(getStruct<T>, {0x0, 16, 0, 0})
	SMember(FGameplayTag)                              MoodReactionTag                                             OFFSET(getStruct<T>, {0x10, 4, 0, 0})
	SMember(FGameplayTag)                              VoiceOverTag                                                OFFSET(getStruct<T>, {0x14, 4, 0, 0})
	CMember(TArray<FConversationNodeParameterPair>)    MetadataParameters                                          OFFSET(get<T>, {0x18, 16, 0, 0})
	SMember(FGameplayTagContainer)                     MetadataTags                                                OFFSET(getStruct<T>, {0x28, 32, 0, 0})
	DMember(bool)                                      bAreConsecutiveMessagesPending                              OFFSET(get<bool>, {0x48, 1, 0, 0})
};
...
/// Struct /Script/JunoAdventuresRuntime.JunoConversationGrantDirectRewardTaskMemory
/// Size: 0x0020 (0x000000 - 0x000020)
class FJunoConversationGrantDirectRewardTaskMemory : public MDKBase
{ 
	friend MDKHandler;
	friend MDKBase;
...
public:
	CMember(TArray<FName>)                             SaveNames                                                   OFFSET(get<T>, {0x0, 16, 0, 0})
	CMember(TArray<FFortItemEntry>)                    Items                                                       OFFSET(get<T>, {0x10, 16, 0, 0})
};

/// Struct /Script/JunoAdventuresRuntime.JunoAIGrantDirectRewardRow
/// Size: 0x0010 (0x000008 - 0x000018)
class FJunoAIGrantDirectRewardRow : public FTableRowBase
{ 
	friend MDKHandler;
	friend MDKBase;
	static inline constexpr uint64_t __MDKClassSize = 24;
...
public:
	DMember(int32_t)                                   MaximumPickAmount                                           OFFSET(get<int32_t>, {0x8, 4, 0, 0})
	SMember(FName)                                     MaximumPickSaveName                                         OFFSET(getStruct<T>, {0xC, 4, 0, 0})
	SMember(FName)                                     LootTierGroup                                               OFFSET(getStruct<T>, {0x10, 4, 0, 0})
};
...
public:
	CMember(TArray<FJunoChangeInventoryEventEntry>)    ItemRequirements                                            OFFSET(get<T>, {0x50, 16, 0, 0})
	DMember(bool)                                      bExactRequirements                                          OFFSET(get<bool>, {0x60, 1, 0, 0})
	CMember(class UJunoChangeInventoryHelper*)         ChangeInventoryHelper                                       OFFSET(get<T>, {0x68, 8, 0, 0})
	CMember(TWeakObjectPtr<AFortPawn*>)                SavedInteractingPawn                                        OFFSET(get<T>, {0x70, 8, 0, 0})
};
...
public:
	CMember(EJunoInsertItemType)                       InsertType                                                  OFFSET(get<T>, {0x50, 1, 0, 0})
	SMember(FStateDrivenTagQuery)                      EquippedItemTagQuery                                        OFFSET(getStruct<T>, {0x58, 24, 0, 0})
	SMember(FStateDrivenTagQuery)                      OffHandItemTagQuery                                         OFFSET(getStruct<T>, {0x70, 24, 0, 0})
	SMember(FStateDrivenTagQuery)                      AnyHandItemTagQuery                                         OFFSET(getStruct<T>, {0x88, 24, 0, 0})
};
