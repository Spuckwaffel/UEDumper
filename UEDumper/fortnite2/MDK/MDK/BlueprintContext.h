...
/// Class /Script/BlueprintContext.BlueprintContextLibrary
...
public:
	...
	// class USubsystem* GetContext(class UObject* ContextObject, class UClass* Class);                                         // [0x2df7524] Final|BlueprintCosmetic|Native|Static|Public|BlueprintCallable|BlueprintPure 
};
