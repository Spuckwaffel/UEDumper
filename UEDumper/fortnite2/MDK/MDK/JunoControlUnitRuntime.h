...
public:
	...
	// void FireEvent_EndControlUnitSession(class AController* PlayerController, class AActor* ControlUnitActor);               // [0xcdf7910] Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable 
	// Function /Script/JunoControlUnitRuntime.JunoControlUnitBlueprintLibrary.FireEvent_BeginControlUnitSession
	// void FireEvent_BeginControlUnitSession(class AController* PlayerController, class AActor* ControlUnitActor);             // [0xcdf76c8] Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable 
};
