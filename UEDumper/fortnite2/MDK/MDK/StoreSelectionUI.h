...
public:
	CMember(class UFortLazyImage*)                     Image_Icon                                                  OFFSET(get<T>, {0x14F0, 8, 0, 0})
	CMember(class UCommonTextBlock*)                   Text_Description                                            OFFSET(get<T>, {0x14F8, 8, 0, 0})
	CMember(class UCommonTextBlock*)                   Text_Price                                                  OFFSET(get<T>, {0x1500, 8, 0, 0})
	CMember(class UCommonRichTextBlock*)               RichText_Label                                              OFFSET(get<T>, {0x1508, 8, 0, 0})
};
