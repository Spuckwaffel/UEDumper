...
public:
	...
	// void ApplyVariants(class AActor* Actor, FFortAthenaLoadout& Loadout);                                                    // [0xa901230] Final|Native|Static|Private|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// void OnPostCustomizationAnimGameplayTags_BP(FGameplayTagContainer& GameplayTags);                                        // [0x228deb8] Event|Public|HasOutParms|BlueprintEvent 
};
