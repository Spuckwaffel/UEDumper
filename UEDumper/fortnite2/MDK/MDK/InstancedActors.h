...
public:
	...
	// void OnRep_InstanceHandle();                                                                                             // [0xc45b0fc] Final|Native|Protected 
	// Function /Script/InstancedActors.InstancedActorsComponent.HasMassEntity
	// bool HasMassEntity();                                                                                                    // [0xc45b0c4] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// class AInstancedActorsManager* GetManager();                                                                             // [0x36d74cc] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
