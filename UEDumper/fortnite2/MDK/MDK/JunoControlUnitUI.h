...
public:
	...
	// void UpdateFromPowerManagerComponent(class UJunoPowerManagerComponent* InPowerManagerComponent);                         // [0xcdf6a8c] Final|Native|Public|BlueprintCallable 
	// Function /Script/JunoControlUnitUI.JunoPowerManagerComponentVM.UpdateFromJunoPhysicsToyActor
	// void UpdateFromJunoPhysicsToyActor(class AJunoPhysicsToyActor* InJunoPhysicsToyActor);                                   // [0xcdf69e4] Final|Native|Public|BlueprintCallable 
};
