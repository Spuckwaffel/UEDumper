...
public:
	...
	// void RemoveSelfFromCameraManager();                                                                                      // [0xb5eb2c8] Final|Native|Protected 
	// Function /Script/GrappleParentRuntime.FortCameraModifier_Swinging.CalculateDynamicMultipliers
	// void CalculateDynamicMultipliers(float& OutFOVBoundsMultiplier, float& OutBoostOffsetMultiplier);                        // [0xb5eafdc] Native|Event|Protected|HasOutParms|BlueprintEvent|Const 
};
...
public:
	...
	// void GetPlayerAnglesFromAttachPoint(float& pitch, float& Roll, float& Yaw);                                              // [0xb5eb1a0] Final|Native|Public|HasOutParms 
	// Function /Script/GrappleParentRuntime.FortSwingingLayerAnimInstance.GetAttachVectorInPlayerSpace
	// FVector GetAttachVectorInPlayerSpace(FVector& InPlayerToAttachPoint);                                                    // [0xb5eb0bc] Final|Native|Public|HasOutParms|HasDefaults 
};
