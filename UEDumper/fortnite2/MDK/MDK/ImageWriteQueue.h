...
public:
	...
	// void ExportToDisk(class UTexture* Texture, FString Filename, FImageWriteOptions& Options);                               // [0x619f9c0] Final|RequiredAPI|Native|Static|Public|HasOutParms|BlueprintCallable 
};
