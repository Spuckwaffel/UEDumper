...
public:
	...
	// void SelectAll();                                                                                                        // [0xc160e90] Final|Native|Public  
	// Function /Script/ModelingComponents.MeshTopologySelectionMechanicProperties.InvertSelection
	// void InvertSelection();                                                                                                  // [0xc160e54] Final|Native|Public  
};
...
public:
	...
	// void SetDynamicMesh(class UDynamicMesh* NewMesh);                                                                        // [0xc160ecc] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// bool SetPointSetVisibility(FString PointSetIdentifier, bool bVisible);                                                   // [0xc1a45e4] Final|Native|Public  
	// Function /Script/ModelingComponents.PreviewGeometry.SetPointSetMaterial
	// bool SetPointSetMaterial(FString PointSetIdentifier, class UMaterialInterface* NewMaterial);                             // [0xc1a3ee4] Final|Native|Public  
	// Function /Script/ModelingComponents.PreviewGeometry.SetLineSetVisibility
	// bool SetLineSetVisibility(FString LineSetIdentifier, bool bVisible);                                                     // [0xc1a37e0] Final|Native|Public  
	// Function /Script/ModelingComponents.PreviewGeometry.SetLineSetMaterial
	// bool SetLineSetMaterial(FString LineSetIdentifier, class UMaterialInterface* NewMaterial);                               // [0xc1a30e0] Final|Native|Public  
	// Function /Script/ModelingComponents.PreviewGeometry.SetAllPointSetsMaterial
	// void SetAllPointSetsMaterial(class UMaterialInterface* Material);                                                        // [0xc1a3060] Final|Native|Public  
	// Function /Script/ModelingComponents.PreviewGeometry.SetAllLineSetsMaterial
	// void SetAllLineSetsMaterial(class UMaterialInterface* Material);                                                         // [0xc1a2fe0] Final|Native|Public  
	// Function /Script/ModelingComponents.PreviewGeometry.RemoveTriangleSet
	// bool RemoveTriangleSet(FString TriangleSetIdentifier, bool bDestroy);                                                    // [0xc1a28dc] Final|Native|Public  
	// Function /Script/ModelingComponents.PreviewGeometry.RemovePointSet
	// bool RemovePointSet(FString PointSetIdentifier, bool bDestroy);                                                          // [0xc1a21d8] Final|Native|Public  
	// Function /Script/ModelingComponents.PreviewGeometry.RemoveLineSet
	// bool RemoveLineSet(FString LineSetIdentifier, bool bDestroy);                                                            // [0xc1a1ad4] Final|Native|Public  
	// Function /Script/ModelingComponents.PreviewGeometry.RemoveAllTriangleSets
	// void RemoveAllTriangleSets(bool bDestroy);                                                                               // [0xc1a1a54] Final|Native|Public  
	// Function /Script/ModelingComponents.PreviewGeometry.RemoveAllPointSets
	// void RemoveAllPointSets(bool bDestroy);                                                                                  // [0xc1a19d4] Final|Native|Public  
	// Function /Script/ModelingComponents.PreviewGeometry.RemoveAllLineSets
	// void RemoveAllLineSets(bool bDestroy);                                                                                   // [0xc1a1954] Final|Native|Public  
	// Function /Script/ModelingComponents.PreviewGeometry.GetActor
	// class APreviewGeometryActor* GetActor();                                                                                 // [0x8184c00] Final|Native|Public|Const 
	// Function /Script/ModelingComponents.PreviewGeometry.FindTriangleSet
	// class UTriangleSetComponent* FindTriangleSet(FString TriangleSetIdentifier);                                             // [0xc1a1274] Final|Native|Public  
	// Function /Script/ModelingComponents.PreviewGeometry.FindPointSet
	// class UPointSetComponent* FindPointSet(FString PointSetIdentifier);                                                      // [0xc1a0b94] Final|Native|Public  
	// Function /Script/ModelingComponents.PreviewGeometry.FindLineSet
	// class ULineSetComponent* FindLineSet(FString LineSetIdentifier);                                                         // [0xc1a04b4] Final|Native|Public  
	// Function /Script/ModelingComponents.PreviewGeometry.Disconnect
	// void Disconnect();                                                                                                       // [0xc1a04a0] Final|Native|Public  
	// Function /Script/ModelingComponents.PreviewGeometry.CreateInWorld
	// void CreateInWorld(class UWorld* World, FTransform& WithTransform);                                                      // [0xc19f390] Final|Native|Public|HasOutParms|HasDefaults 
	// Function /Script/ModelingComponents.PreviewGeometry.AddTriangleSet
	// class UTriangleSetComponent* AddTriangleSet(FString TriangleSetIdentifier);                                              // [0xc19ecb0] Final|Native|Public  
	// Function /Script/ModelingComponents.PreviewGeometry.AddPointSet
	// class UPointSetComponent* AddPointSet(FString PointSetIdentifier);                                                       // [0xc19e5d0] Final|Native|Public  
	// Function /Script/ModelingComponents.PreviewGeometry.AddLineSet
	// class ULineSetComponent* AddLineSet(FString LineSetIdentifier);                                                          // [0xc19def0] Final|Native|Public  
};
...
public:
	...
	// FCreateTextureObjectResult CreateTextureObject(FCreateTextureObjectParams& CreateTexParams);                             // [0xc19fd9c] Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/ModelingComponents.ModelingObjectsCreationAPI.CreateNewActor
	// FCreateActorResult CreateNewActor(FCreateActorParams& CreateActorParams);                                                // [0xc19fcbc] Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/ModelingComponents.ModelingObjectsCreationAPI.CreateMeshObject
	// FCreateMeshObjectResult CreateMeshObject(FCreateMeshObjectParams& CreateMeshParams);                                     // [0xc19fbc0] Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/ModelingComponents.ModelingObjectsCreationAPI.CreateMaterialObject
	// FCreateMaterialObjectResult CreateMaterialObject(FCreateMaterialObjectParams& CreateMaterialParams);                     // [0xc19f4c0] Native|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// bool ShouldShowPropertySet();                                                                                            // [0xc1d8660] Final|Native|Public|Const 
	// Function /Script/ModelingComponents.CreateMeshObjectTypeProperties.GetOutputTypeNamesFunc
	// TArray<FString> GetOutputTypeNamesFunc();                                                                                // [0xc1d8644] Final|Native|Public  
	// Function /Script/ModelingComponents.CreateMeshObjectTypeProperties.GetCurrentCreateMeshType
	// ECreateObjectTypeHint GetCurrentCreateMeshType();                                                                        // [0xc1d85e4] Final|Native|Public|Const 
};
...
public:
	...
	// TArray<FString> GetGroupLayersFunc();                                                                                    // [0xc1d8608] Final|Native|Public  
};
...
public:
	...
	// TArray<FString> GetWeightMapsFunc();                                                                                     // [0xc1d8608] Final|Native|Public  
};
