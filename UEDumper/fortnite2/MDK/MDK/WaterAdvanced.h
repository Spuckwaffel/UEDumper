...
public:
	...
	CMember(TSet<TWeakObjectPtr<UWaterBodyComponent*>>) WaterBodyComponentsWithProperMIDParameters                 OFFSET(get<T>, {0xD0, 80, 0, 0})
	CMember(TArray<TWeakObjectPtr<AWaterBody*>>)       PendingWaterBodiesToSetMIDOnInitialize                      OFFSET(get<T>, {0x120, 16, 0, 0})
	...
	// void SetWaterBodyMIDParameters(class AWaterBody* WaterBody);                                                             // [0xbd73c60] Final|Native|Public|BlueprintCallable 
	// Function /Script/WaterAdvanced.ShallowWaterSubsystem.ResetImpacts
	// void ResetImpacts();                                                                                                     // [0xbd73c4c] Final|Native|Public|BlueprintCallable 
	// Function /Script/WaterAdvanced.ShallowWaterSubsystem.RemoveCollisionTrackerForActor
	// void RemoveCollisionTrackerForActor(class AActor* CollisionTrackerActor);                                                // [0xbd73b84] Final|Native|Protected|BlueprintCallable 
	// Function /Script/WaterAdvanced.ShallowWaterSubsystem.RegisterImpact
	// void RegisterImpact(FVector ImpactPosition, FVector ImpactVelocity, float ImpactRadius);                                 // [0xbd73a58] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/WaterAdvanced.ShallowWaterSubsystem.OnWaterInfoTextureCreated
	// void OnWaterInfoTextureCreated(class UTextureRenderTarget2D* WaterInfoTexture);                                          // [0xbd739b4] Final|Native|Protected 
	// Function /Script/WaterAdvanced.ShallowWaterSubsystem.OnLocalPlayerPawnBecomesValid
	// void OnLocalPlayerPawnBecomesValid(class APawn* OldPawn, class APawn* NewPawn);                                          // [0xbd738f0] Final|Native|Private 
	// Function /Script/WaterAdvanced.ShallowWaterSubsystem.OnLocalPlayerControllerBecomesValid
	// void OnLocalPlayerControllerBecomesValid(class APlayerController* InPlayerController);                                   // [0xbd73870] Final|Native|Private 
	// Function /Script/WaterAdvanced.ShallowWaterSubsystem.GetAllOverlappingWaterBodiesAndUpdateCollisionTrackers
	// TSet<AWaterBody*> GetAllOverlappingWaterBodiesAndUpdateCollisionTrackers();                                              // [0xbd737b4] Native|Protected|BlueprintCallable 
	// Function /Script/WaterAdvanced.ShallowWaterSubsystem.AddCollisionTrackerForActor
	// void AddCollisionTrackerForActor(class AActor* CollisionTrackerActor, float MaxLifespan);                                // [0xbd735c0] Final|Native|Protected|BlueprintCallable 
};
