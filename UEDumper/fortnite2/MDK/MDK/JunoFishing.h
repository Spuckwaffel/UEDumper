...
public:
	...
	// void FireEvent_EndJunoFishingSession(class AFortPlayerPawn* PlayerPawn, class UFortWorldItemDefinition* ItemFished, bool bFromHotspot, bool bIsPlayerSpawnedHotspot, FString HotspotTierTag, FString WaterBodyName, FString CatchTypeName, class AActor* ItemUsedToFish); // [0xcdf90b8] Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable 
	// Function /Script/JunoFishing.JunoFishingBlueprintLibrary.FireEvent_BeginJunoFishingSession
	// void FireEvent_BeginJunoFishingSession(class AFortPlayerPawn* PlayerPawn);                                               // [0xcdf9024] Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable 
};
