...
public:
	...
	// class AActor* EntityInteractGetActor(class UObject* WorldContextObject, FHitResult& HitResult);                          // [0xca930e4] Final|Native|Static|Public|HasOutParms 
};
...
public:
	...
	// void OnRep_Message();                                                                                                    // [0xca93200] Final|Native|Private 
};
