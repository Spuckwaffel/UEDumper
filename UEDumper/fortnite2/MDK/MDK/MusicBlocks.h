...
public:
	...
	// bool ReplicateMusicSequencerHit(class UObject* WorldContextObject, TScriptInterface<Class> HitInterface, class AController* Instigator); // [0xbece578] Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable 
	// Function /Script/MusicBlocks.MusicSequencerHitComponent.RegisterMusicSequencerActor
	// bool RegisterMusicSequencerActor(class UObject* WorldContextObject, TScriptInterface<Class> Actor);                      // [0xbece3f4] Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable 
	// Function /Script/MusicBlocks.MusicSequencerHitComponent.ProcessSequenceHitEvent
	// bool ProcessSequenceHitEvent(FMusicSequencerHitEntry& Event);                                                            // [0xbece30c] Final|Native|Protected|HasOutParms 
	// Function /Script/MusicBlocks.MusicSequencerHitComponent.OnSequenceHitEventExpired
	// void OnSequenceHitEventExpired(FMusicSequencerHitHandle ExpiredHandle);                                                  // [0xbece28c] Final|Native|Protected 
	// Function /Script/MusicBlocks.MusicSequencerHitComponent.AddSequenceHitEvent
	// bool AddSequenceHitEvent(TScriptInterface<Class> HitInterface, class AController* Instigator);                           // [0xbece03c] Final|Native|Protected 
	// Function /Script/MusicBlocks.MusicSequencerHitComponent.AddMusicSequencerActor
	// bool AddMusicSequencerActor(TScriptInterface<Class> HitInterface);                                                       // [0xbecdef0] Final|Native|Protected 
};
...
public:
	...
	// class UMusicSequencerHitComponent* GetMusicSequencerHitComponent();                                                      // [0x666bde8] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// class AMusicSequencerHitActor* GetMusicSequencerHitActor();                                                              // [0xbece268] Final|Native|Public|Const 
};
