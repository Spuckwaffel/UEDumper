...
public:
	...
	// void SetCIDForPreview(class UAthenaCharacterItemDefinition* InCID);                                                      // [0xc729a50] Final|Native|Protected|BlueprintCallable 
	// Function /Script/AISpawner.AISpawnerPreviewerComponent.SetActorForPreview
	// void SetActorForPreview(class UClass* InActorClass);                                                                     // [0xc7298c0] Final|Native|Protected|BlueprintCallable 
	// Function /Script/AISpawner.AISpawnerPreviewerComponent.ClearCIDPreview
	// void ClearCIDPreview();                                                                                                  // [0xc7298ac] Final|Native|Protected|BlueprintCallable 
	// Function /Script/AISpawner.AISpawnerPreviewerComponent.ClearActorPreview
	// void ClearActorPreview();                                                                                                // [0xc7298ac] Final|Native|Protected|BlueprintCallable 
};
