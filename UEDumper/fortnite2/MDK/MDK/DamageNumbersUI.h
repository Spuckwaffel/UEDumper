...
public:
	...
	// void UpdateScreenSpacePosition();                                                                                        // [0xb582fb4] Final|Native|Protected|BlueprintCallable 
	// Function /Script/DamageNumbersUI.CommonUserWidget_DamageNumbers.Reset
	// void Reset();                                                                                                            // [0xb582f50] Final|Native|Protected|BlueprintCallable 
	// Function /Script/DamageNumbersUI.CommonUserWidget_DamageNumbers.OnShieldBreak
	// void OnShieldBreak(bool bIsOvershield);                                                                                  // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/DamageNumbersUI.CommonUserWidget_DamageNumbers.OnDamageDealt
	// void OnDamageDealt(double InDamage, class AActor* InActor, bool bInShield, bool bInCrit, FVector InWorldSpacePos, bool bInEMP); // [0xb5829f0] Final|Native|Public|HasDefaults|BlueprintCallable 
};
...
public:
	...
	// void UpdateBinding();                                                                                                    // [0xb582fa0] Final|Native|Protected|BlueprintCallable 
	// Function /Script/DamageNumbersUI.FortUserWidget_DamageNumbers.OnShieldBreak
	// void OnShieldBreak(bool bInOverShield);                                                                                  // [0xb582ed0] Final|Native|Protected 
	// Function /Script/DamageNumbersUI.FortUserWidget_DamageNumbers.OnPawnSet
	// void OnPawnSet();                                                                                                        // [0xb582e68] Final|Native|Protected|BlueprintCallable 
	// Function /Script/DamageNumbersUI.FortUserWidget_DamageNumbers.OnDamageDealt
	// void OnDamageDealt(double InDamage, bool bInCritical, bool bInFatal, bool bInShield, class AActor* HitActor, FVector HitLocation, FGameplayTagContainer Tags); // [0xb582be4] Final|Native|Protected|HasDefaults|BlueprintCallable 
	// Function /Script/DamageNumbersUI.FortUserWidget_DamageNumbers.ClearBinding
	// void ClearBinding();                                                                                                     // [0xb5829dc] Final|Native|Protected|BlueprintCallable 
};
