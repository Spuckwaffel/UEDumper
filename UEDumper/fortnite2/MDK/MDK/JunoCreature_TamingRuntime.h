...
public:
	...
	// void Server_RenameAnimal(class AFortPlayerController* TriggeringPlayer, FGameplayTag UniqueAIIdentifier, FText NewName); // [0xcdfc8e4] RequiredAPI|Net|NetReliableNative|Event|Public|NetServer 
	// Function /Script/JunoCreature_TamingRuntime.JunoControllerComponent_Taming.Server_ReassignAnimalToBarn
	// void Server_ReassignAnimalToBarn(class AFortPlayerController* TriggeringPlayer, class AActor* BarnActor, FGameplayTag UniqueAIIdentifier, FText ExistingName); // [0xcdfc794] RequiredAPI|Net|NetReliableNative|Event|Public|NetServer 
	// Function /Script/JunoCreature_TamingRuntime.JunoControllerComponent_Taming.Server_BarnInteractionStarted
	// void Server_BarnInteractionStarted();                                                                                    // [0x8d7e180] RequiredAPI|Net|NetReliableNative|Event|Public|NetServer 
	// Function /Script/JunoCreature_TamingRuntime.JunoControllerComponent_Taming.Server_BarnInteractionEnded
	// void Server_BarnInteractionEnded();                                                                                      // [0x8abc230] RequiredAPI|Net|NetReliableNative|Event|Public|NetServer 
	// Function /Script/JunoCreature_TamingRuntime.JunoControllerComponent_Taming.Server_AssignAnimalToBarn
	// void Server_AssignAnimalToBarn(class AFortPlayerController* TriggeringPlayer, class AActor* BarnActor, class AActor* AnimalActor, FText CustomName); // [0xcdfc644] RequiredAPI|Net|NetReliableNative|Event|Public|NetServer 
	// Function /Script/JunoCreature_TamingRuntime.JunoControllerComponent_Taming.OnUnconvertFollowingAnimal
	// void OnUnconvertFollowingAnimal(class AFortPawn* UnconvertedPawn, EUnconvertReason UnconvertReason);                     // [0xcdfc584] Final|Native|Public  
	// Function /Script/JunoCreature_TamingRuntime.JunoControllerComponent_Taming.OnRep_FollowingAnimalAIDescriptorTag
	// void OnRep_FollowingAnimalAIDescriptorTag();                                                                             // [0xcdfc550] Final|Native|Protected 
	// Function /Script/JunoCreature_TamingRuntime.JunoControllerComponent_Taming.OnConvertFollowingAnimal
	// void OnConvertFollowingAnimal(class AFortPawn* ConvertedPawn);                                                           // [0xcdfc4b0] Final|Native|Public  
	// Function /Script/JunoCreature_TamingRuntime.JunoControllerComponent_Taming.BP_HandleBarnInteractionStarted
	// void BP_HandleBarnInteractionStarted();                                                                                  // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoCreature_TamingRuntime.JunoControllerComponent_Taming.BP_HandleBarnInteractionEnded
	// void BP_HandleBarnInteractionEnded();                                                                                    // [0x228deb8] Event|Protected|BlueprintEvent 
};
