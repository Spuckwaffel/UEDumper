...
public:
	...
	// void TryToGrantSelectedQuest(FFortGamePhaseUpdatedEvent& FortGamePhaseUpdatedEvent);                                     // [0x90abad8] Final|Native|Private|HasOutParms 
	// Function /Script/MatchQuestsRuntime.FortPlayerStateComponent_MatchQuests.Server_SetSelectedQuest
	// void Server_SetSelectedQuest(TScriptInterface<Class> Quest);                                                             // [0xb634a18] Final|Net|NetReliableNative|Event|Private|NetServer 
	// Function /Script/MatchQuestsRuntime.FortPlayerStateComponent_MatchQuests.OnRep_SquadSelections
	// void OnRep_SquadSelections();                                                                                            // [0x3420368] Final|Native|Private|Const 
	// Function /Script/MatchQuestsRuntime.FortPlayerStateComponent_MatchQuests.OnRep_QuestOffering
	// void OnRep_QuestOffering();                                                                                              // [0x3476638] Final|Native|Private|Const 
	// Function /Script/MatchQuestsRuntime.FortPlayerStateComponent_MatchQuests.OnLandedFromBus
	// void OnLandedFromBus(class AFortPlayerControllerZone* PlayerController);                                                 // [0x660baec] Final|Native|Private 
};
...
public:
	...
	// void MatchQuests_RollNewOffer();                                                                                         // [0x36569a8] Final|Exec|Native|Private|Const 
	// Function /Script/MatchQuestsRuntime.MatchQuestsCheatManager.MatchQuests_LogSquadSelections
	// void MatchQuests_LogSquadSelections();                                                                                   // [0x36569a8] Final|Exec|Native|Private|Const 
	// Function /Script/MatchQuestsRuntime.MatchQuestsCheatManager.MatchQuests_LogRNGSeeds
	// void MatchQuests_LogRNGSeeds();                                                                                          // [0x36569a8] Final|Exec|Native|Private 
	// Function /Script/MatchQuestsRuntime.MatchQuestsCheatManager.MatchQuests_LogReportSimulatedRolls
	// void MatchQuests_LogReportSimulatedRolls(int32_t RollsToSimulate);                                                       // [0x853148c] Final|Exec|Native|Private|Const 
	// Function /Script/MatchQuestsRuntime.MatchQuestsCheatManager.MatchQuests_LogAvailableQuestsPool
	// void MatchQuests_LogAvailableQuestsPool();                                                                               // [0x36569a8] Final|Exec|Native|Private 
	// Function /Script/MatchQuestsRuntime.MatchQuestsCheatManager.MatchQuests_ForceQuestInOffer
	// void MatchQuests_ForceQuestInOffer(FString QuestName);                                                                   // [0x6e4c448] Final|Exec|Native|Private|Const 
};
