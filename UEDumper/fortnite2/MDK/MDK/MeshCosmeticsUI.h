...
public:
	...
	// void OnVariantChangedEvent__DelegateSignature(FMcpVariantChannelInfo& InChannelInfo);                                    // [0x228deb8] MulticastDelegate|Public|Delegate|HasOutParms 
	// Function /Script/MeshCosmeticsUI.FortVariantRedirectorTile.HandleBoundaryNavigation
	// class UWidget* HandleBoundaryNavigation(EUINavigation InNavigation);                                                     // [0xbdc8b8c] Final|Native|Private 
	// Function /Script/MeshCosmeticsUI.FortVariantRedirectorTile.GetButtonToFocus
	// class UWidget* GetButtonToFocus();                                                                                       // [0x6b08280] Native|Protected|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	CMember(class UOverlay*)                           ImageOverlay                                                OFFSET(get<T>, {0x14A0, 8, 0, 0})
	CMember(class UFortLazyImage*)                     LazyImage_TileIcon                                          OFFSET(get<T>, {0x14A8, 8, 0, 0})
	CMember(ERedirectorTileDisplayMode)                DisplayMode                                                 OFFSET(get<T>, {0x14B0, 1, 0, 0})
	DMember(float)                                     SlotOpacitySprayAssigned                                    OFFSET(get<float>, {0x14B4, 4, 0, 0})
	DMember(float)                                     SlotOpacitySprayNotAssigned                                 OFFSET(get<float>, {0x14B8, 4, 0, 0})
};
...
public:
	...
	// void BP_SetVariantEditorMode(bool bIsLockerMode);                                                                        // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/MeshCosmeticsUI.FortVariantSprayCustomizer.BP_SetChannelSlotIcon
	// void BP_SetChannelSlotIcon(TWeakObjectPtr<UObject*>& ChannelSlotIcon);                                                   // [0x228deb8] Event|Protected|HasOutParms|BlueprintEvent 
};
...
public:
	...
	// void HandleSliderValueChanged(float NormalizedValue);                                                                    // [0xbdc8c1c] Final|Native|Private 
	// Function /Script/MeshCosmeticsUI.FortVariantSprayCustomizerSetting.BP_OnSetConstraints
	// void BP_OnSetConstraints(FFloatRange& Constraints);                                                                      // [0x228deb8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/MeshCosmeticsUI.FortVariantSprayCustomizerSetting.BP_OnChangeValue
	// void BP_OnChangeValue(float Value, float NormalizedValue);                                                               // [0x228deb8] Event|Protected|BlueprintEvent 
};
