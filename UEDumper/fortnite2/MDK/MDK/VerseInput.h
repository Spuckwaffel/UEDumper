...
public:
	...
	// void ServerInputActionTriggered(FGuid Guid, FVector InputValue);                                                         // [0xd341bc4] Final|Net|NetReliableNative|Event|Private|NetServer|HasDefaults|Const 
	// Function /Script/VerseInput.VerseReplicatedInputDataComponent.OnInputActionTriggered
	// void OnInputActionTriggered(FInputActionInstance& ActionInstance);                                                       // [0xd341b20] Final|Native|Private|HasOutParms 
};
