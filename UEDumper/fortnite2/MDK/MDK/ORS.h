...
public:
	...
	// void OnOwnerAdded(class AActor* Actor);                                                                                  // [0xc8bfee4] Final|Native|Private 
};
...
public:
	...
	// void ORSListObjects();                                                                                                   // [0x36569a8] Final|Exec|Native|Protected 
	// Function /Script/ORS.ORSCheatManager.ORSDebug
	// void ORSDebug(FName& Path);                                                                                              // [0xc8bfe7c] Final|Exec|Native|Protected|HasOutParms 
};
...
public:
	...
	// void OnRep_ReplicatedObjectReferences();                                                                                 // [0xc8bff8c] Final|Native|Protected 
	// Function /Script/ORS.ORSGroupComponent.OnRep_ReplicatedNetSerializeObjects
	// void OnRep_ReplicatedNetSerializeObjects();                                                                              // [0xc8bff78] Final|Native|Protected 
	// Function /Script/ORS.ORSGroupComponent.OnRep_ReplayNetSerializeObjects
	// void OnRep_ReplayNetSerializeObjects();                                                                                  // [0xc8bff64] Final|Native|Protected 
};
...
public:
	...
	// void OnActorDestroyed(class AActor* Actor);                                                                              // [0x1b5a678] Final|Native|Protected 
};
