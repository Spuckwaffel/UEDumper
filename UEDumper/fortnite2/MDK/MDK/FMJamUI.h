...
/// dependency: FMJamPlayspaceRuntime
...
public:
	...
	// void HandlePickerOpenRequest(EFortPickerMode Mode, int32_t InitialOption, bool bIgnoreFirstAccept);                      // [0xb88b6a8] Final|Native|Private 
};
...
public:
	...
	// void RebuildJamSongIndicatorsForPlayspace(class AJamPlayspace* Playspace);                                               // [0xb88b7a0] Final|Native|Public|BlueprintCallable 
	// Function /Script/FMJamUI.JamUIManagerComponent_SongIndicators.ClearJamIndicators
	// void ClearJamIndicators();                                                                                               // [0xb88b628] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void OnInitInfo(class UCatalogData* Song, EFMJamLoopType Type);                                                          // [0x228deb8] Event|Protected|BlueprintEvent 
	...
	// class AFortPlayerStateAthena* GetIndicatedPlayerStateAthena();                                                           // [0xb88b63c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
