...
public:
	...
	// class UTexture2D* GenerateQRCodeTextureFromString(FString StringToEncode);                                               // [0x89d91c8] Final|Native|Static|Private|BlueprintCallable 
};
...
public:
	...
	// void EncodeString(FString StringToEncode);                                                                               // [0x89d8ab4] Final|Native|Public|BlueprintCallable 
};
