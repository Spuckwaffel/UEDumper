...
public:
	...
	// bool ShouldRunServerCode(class AActor* Context);                                                                         // [0xb70a528] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/FMJamCoreRuntime.JamCoreBPFL.ShouldRunClientCode
	// bool ShouldRunClientCode(class AActor* Context);                                                                         // [0xb70a3c4] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
};
