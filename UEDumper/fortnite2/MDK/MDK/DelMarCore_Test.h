...
public:
	...
	// void ReceiveTrackScrubberCompletedProfiling();                                                                           // [0xca2fba8] Final|Native|Protected 
	// Function /Script/DelMarCore_Test.DelMarTestControllerTrackScrubber.ReceiveRaceBeginEvent
	// void ReceiveRaceBeginEvent(FDelMarEvent_RaceActive& Event);                                                              // [0xca2fb28] Final|Native|Protected|HasOutParms 
};
