...
public:
	...
	// bool CheckPermission(FString Permission);                                                                                // [0xcecbab8] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/AndroidPermission.AndroidPermissionFunctionLibrary.AcquirePermissions
	// class UAndroidPermissionCallbackProxy* AcquirePermissions(TArray<FString>& Permissions);                                 // [0xcecb9d0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
