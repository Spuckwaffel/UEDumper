...
public:
	...
	// bool HasSubtitles();                                                                                                     // [0x8728478] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void Stop();                                                                                                             // [0x8728564] Final|Native|Public|BlueprintCallable 
	// Function /Script/SubtitlesWidgets.FortMediaSubtitlesPlayer.SetSubtitles
	// void SetSubtitles(class UOverlays* Subtitles);                                                                           // [0x87284dc] Final|Native|Public|BlueprintCallable 
	// Function /Script/SubtitlesWidgets.FortMediaSubtitlesPlayer.Play
	// void Play();                                                                                                             // [0x87284c8] Final|Native|Public|BlueprintCallable 
	// Function /Script/SubtitlesWidgets.FortMediaSubtitlesPlayer.BindToMediaPlayer
	// void BindToMediaPlayer(class UMediaPlayer* InMediaPlayer);                                                               // [0x8728384] Final|Native|Public|BlueprintCallable 
};
