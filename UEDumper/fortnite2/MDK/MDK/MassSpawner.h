...
public:
	...
	// void UnloadConfig();                                                                                                     // [0xb33cca0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MassSpawner.MassSpawner.ScaleSpawningCount
	// void ScaleSpawningCount(float Scale);                                                                                    // [0xb33cc20] Final|Native|Public|BlueprintCallable 
	// Function /Script/MassSpawner.MassSpawner.GetSpawningCountScale
	// float GetSpawningCountScale();                                                                                           // [0xab40a7c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MassSpawner.MassSpawner.GetCount
	// int32_t GetCount();                                                                                                      // [0xb33cc08] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MassSpawner.MassSpawner.DoSpawning
	// void DoSpawning();                                                                                                       // [0xb33cbf4] Final|Native|Public|BlueprintCallable 
	// Function /Script/MassSpawner.MassSpawner.DoDespawning
	// void DoDespawning();                                                                                                     // [0xb33cbe0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MassSpawner.MassSpawner.ClearTemplates
	// void ClearTemplates();                                                                                                   // [0xb33cbcc] Final|Native|Public|BlueprintCallable 
};
