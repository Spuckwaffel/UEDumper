...
public:
	...
	// void SetTags(FZoneGraphTagMask NewTags);                                                                                 // [0xb334ba8] Final|Native|Public|BlueprintCallable 
	// Function /Script/ZoneGraph.ZoneShapeComponent.SetShapeType
	// void SetShapeType(FZoneShapeType Type);                                                                                  // [0x688be40] Final|Native|Public|BlueprintCallable 
	// Function /Script/ZoneGraph.ZoneShapeComponent.SetReverseLaneProfile
	// bool SetReverseLaneProfile(bool bReverse);                                                                               // [0xb334b1c] Final|Native|Public|BlueprintCallable 
	// Function /Script/ZoneGraph.ZoneShapeComponent.SetPolygonRoutingType
	// void SetPolygonRoutingType(EZoneShapePolygonRoutingType NewType);                                                        // [0xb334aa0] Final|Native|Public|BlueprintCallable 
	// Function /Script/ZoneGraph.ZoneShapeComponent.IsLaneProfileReversed
	// bool IsLaneProfileReversed();                                                                                            // [0x3f191d4] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ZoneGraph.ZoneShapeComponent.GetTags
	// FZoneGraphTagMask GetTags();                                                                                             // [0xb334a88] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ZoneGraph.ZoneShapeComponent.GetShapeType
	// FZoneShapeType GetShapeType();                                                                                           // [0x68850bc] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
