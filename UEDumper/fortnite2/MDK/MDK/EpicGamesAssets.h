...
public:
	...
	// void OnSystemFinished(class UAudioComponent* FinishedComponent);                                                         // [0xb263b50] Final|Native|Private 
	// Function /Script/EpicGamesAssets.PlayedSoundReplication.OnRep_SoundAsset
	// void OnRep_SoundAsset();                                                                                                 // [0xb263b14] Final|Native|Private 
};
...
public:
	...
	// void OnSystemFinished(class UNiagaraComponent* FinishedComponent);                                                       // [0xb263b50] Final|Native|Private 
	// Function /Script/EpicGamesAssets.SpawnedParticleSystemReplication.OnRep_VFXAsset
	// void OnRep_VFXAsset();                                                                                                   // [0xb263b3c] Final|Native|Private 
	// Function /Script/EpicGamesAssets.SpawnedParticleSystemReplication.OnRep_StartTime
	// void OnRep_StartTime();                                                                                                  // [0xb263b28] Final|Native|Private 
};
