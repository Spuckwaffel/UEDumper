...
public:
	...
	// void ReleaseBalloonOnSelf(int32_t NumBalloons);                                                                          // [0x6c86e6c] Final|BlueprintAuthorityOnly|Exec|Native|Public|Const 
	// Function /Script/WindRuntime.WindCheatManager.InflateBalloonOnSelf
	// void InflateBalloonOnSelf(int32_t NumBalloons);                                                                          // [0x6c86e6c] Final|BlueprintAuthorityOnly|Exec|Native|Public|Const 
};
...
public:
	...
	// void SetActive(bool bInIsActive);                                                                                        // [0xc042ffc] Final|Native|Public|BlueprintCallable 
	// Function /Script/WindRuntime.WindField.RemoveIgnoredActor
	// void RemoveIgnoredActor(class AActor* Actor);                                                                            // [0xc042ef8] Final|Native|Public|BlueprintCallable 
	// Function /Script/WindRuntime.WindField.RemoveCollider
	// void RemoveCollider(class UShapeComponent* ShapeComponent);                                                              // [0xc042db4] Final|Native|Public|BlueprintCallable 
	// Function /Script/WindRuntime.WindField.OnEndOverlap
	// void OnEndOverlap(class UPrimitiveComponent* OverlappedComponent, class AActor* Other, class UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex); // [0xc042c60] Native|Protected     
	// Function /Script/WindRuntime.WindField.OnBeginOverlap
	// void OnBeginOverlap(class UPrimitiveComponent* OverlappedComponent, class AActor* Other, class UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool bFromSweep, FHitResult& SweepResult); // [0xc042a28] Native|Protected|HasOutParms 
	// Function /Script/WindRuntime.WindField.AddIgnoredActor
	// void AddIgnoredActor(class AActor* Actor);                                                                               // [0xc04240c] Final|Native|Public|BlueprintCallable 
	// Function /Script/WindRuntime.WindField.AddCollider
	// void AddCollider(class UShapeComponent* ShapeComponent);                                                                 // [0xc04238c] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void OnRep_TargetData();                                                                                                 // [0xc042da0] Final|Native|Protected 
	// Function /Script/WindRuntime.WindSplineComponent.OnRep_Blockages
	// void OnRep_Blockages();                                                                                                  // [0xc042da0] Final|Native|Protected 
	// Function /Script/WindRuntime.WindSplineComponent.GetWindDataAtLocation
	// void GetWindDataAtLocation(FVector& InTargetLocation, FVector& OutDirection, float& OutAttenuation);                     // [0xc042880] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|Const 
	// Function /Script/WindRuntime.WindSplineComponent.GetTargetingRadius
	// float GetTargetingRadius();                                                                                              // [0xc04284c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/WindRuntime.WindSplineComponent.GetClosestActiveLocations
	// void GetClosestActiveLocations(FVector& InTargetLocation, bool& bIsClosestPointActive, FVector& ClosestPointOnSpline, TArray<FVector>& ClosestActiveLocations); // [0xc042640] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|Const 
	// Function /Script/WindRuntime.WindSplineComponent.Enable
	// void Enable();                                                                                                           // [0xc0425ec] Final|Native|Protected 
	// Function /Script/WindRuntime.WindSplineComponent.Disable
	// void Disable();                                                                                                          // [0xc0425d8] Final|Native|Protected 
};
