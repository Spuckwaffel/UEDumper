...
public:
	...
	// void ResetToDefault();                                                                                                   // [0xd3ff834] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// bool ExportToGLTF(class UObject* Object, FString FilePath, class UGLTFExportOptions* Options, TSet<AActor*>& SelectedActors, FGLTFExportMessages& OutMessages); // [0xd3fefcc] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// void ResetToDefault();                                                                                                   // [0xd3ff848] Final|Native|Public|BlueprintCallable 
};
