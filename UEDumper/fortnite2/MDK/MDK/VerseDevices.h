...
public:
	...
	// void SetEnabled(bool bInEnabled);                                                                                        // [0xb326cd8] Final|Native|Protected|BlueprintCallable 
	// Function /Script/VerseDevices.ScriptDevice.BP_SetVisibility
	// void BP_SetVisibility(bool bVisible);                                                                                    // [0x228deb8] Event|Public|BlueprintEvent 
};
...
public:
	...
	// void HandleOnActorEndPlay(class AActor* Actor, TEnumAsByte<EEndPlayReason> EndPlayReason);                               // [0xb326c14] Final|Native|Private 
};
