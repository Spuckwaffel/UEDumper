...
public:
	...
	// FInstancedStruct MakeEvaluateChooser(class UChooserTable* Chooser);                                                      // [0x8173970] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/Chooser.ChooserFunctionLibrary.MakeChooserEvaluationContext
	// FChooserEvaluationContext MakeChooserEvaluationContext();                                                                // [0x81738f4] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/Chooser.ChooserFunctionLibrary.GetChooserStructOutput
	// void GetChooserStructOutput(FChooserEvaluationContext& Context, int32_t Index, int32_t& Value);                          // [0x8173210] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/Chooser.ChooserFunctionLibrary.EvaluateObjectChooserBaseMulti
	// TArray<UObject*> EvaluateObjectChooserBaseMulti(FChooserEvaluationContext& Context, FInstancedStruct& ObjectChooser, class UClass* ObjectClass, bool bResultIsClass); // [0x8172ec4] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/Chooser.ChooserFunctionLibrary.EvaluateObjectChooserBase
	// class UObject* EvaluateObjectChooserBase(FChooserEvaluationContext& Context, FInstancedStruct& ObjectChooser, class UClass* ObjectClass, bool bResultIsClass); // [0x8172b98] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/Chooser.ChooserFunctionLibrary.EvaluateChooserMulti
	// TArray<UObject*> EvaluateChooserMulti(class UObject* ContextObject, class UChooserTable* ChooserTable, class UClass* ObjectClass); // [0x8172a60] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/Chooser.ChooserFunctionLibrary.EvaluateChooser
	// class UObject* EvaluateChooser(class UObject* ContextObject, class UChooserTable* ChooserTable, class UClass* ObjectClass); // [0x8172950] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/Chooser.ChooserFunctionLibrary.AddChooserStructInput
	// void AddChooserStructInput(FChooserEvaluationContext& Context, int32_t Value);                                           // [0x8172378] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/Chooser.ChooserFunctionLibrary.AddChooserObjectInput
	// void AddChooserObjectInput(FChooserEvaluationContext& Context, class UObject* Object);                                   // [0x81721bc] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
