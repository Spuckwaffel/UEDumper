...
public:
	...
	// void UpdateProjectConfirmed();                                                                                           // [0xcb75660] Final|Native|Protected|BlueprintCallable 
	// Function /Script/VKDownloadOnDemandUI.DownloadOnDemandProjectManagementTab.RemoveProjectConfirmed
	// void RemoveProjectConfirmed();                                                                                           // [0xcb755bc] Final|Native|Protected|BlueprintCallable 
};
...
public:
	...
	// void UpdateLightningViolator(ESlateVisibility InVisibility, FText& InText);                                              // [0x228deb8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/VKDownloadOnDemandUI.DownloadOnDemandAddProjectModal.HandleDownloadLinkIdTextChanged
	// void HandleDownloadLinkIdTextChanged(FText& InputLinkCode);                                                              // [0xcb75520] Final|Native|Private|HasOutParms 
};
...
public:
	...
	// void UpdateLabel(bool bShowLabel);                                                                                       // [0xcb755e0] Final|Native|Public|BlueprintCallable 
	// Function /Script/VKDownloadOnDemandUI.DownloadOnDemandProjectTile.OnLabelUpdated
	// void OnLabelUpdated();                                                                                                   // [0x228deb8] Event|Protected|BlueprintEvent 
};
