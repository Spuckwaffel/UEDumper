...
public:
	...
	// void OnBattlePassSubscriptionAllowed(bool bSubscriptionAllowed);                                                         // [0x228deb8] Event|Public|BlueprintEvent 
};
...
public:
	...
	// void OnPageChanged(int32_t PageNumber, int32_t RewardPageTotal);                                                         // [0x228deb8] Event|Public|BlueprintEvent 
	// Function /Script/BattlePassS29UI.BattlePassRewardPageS29.OnLoadingScreenSelectedChanged
	// void OnLoadingScreenSelectedChanged(bool bIsSelected);                                                                   // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/BattlePassS29UI.BattlePassRewardPageS29.OnInputMethodChanged
	// void OnInputMethodChanged(ECommonInputType InputType);                                                                   // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/BattlePassS29UI.BattlePassRewardPageS29.OnInitForPageType
	// void OnInitForPageType(ERewardPageType InRewardPageType);                                                                // [0x228deb8] Event|Public|BlueprintEvent 
	// Function /Script/BattlePassS29UI.BattlePassRewardPageS29.HandleRewardTracksBoundaryNavigation
	// class UWidget* HandleRewardTracksBoundaryNavigation(EUINavigation InNavigation);                                         // [0xb6334c4] Final|Native|Private 
	// Function /Script/BattlePassS29UI.BattlePassRewardPageS29.GetRewardPageBackgroundData
	// FVaultWorldBackgroundData GetRewardPageBackgroundData();                                                                 // [0xb6331e4] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void OverviewShowAnimationFinished();                                                                                    // [0x36569a8] Final|Native|Public|BlueprintCallable 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.OnUpdateStatusBar
	// void OnUpdateStatusBar(FText& StatusText, EBattlePassStatusBarTypeS29& BarType);                                         // [0x228deb8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.OnUpdateOwnedOrEquippedTag
	// void OnUpdateOwnedOrEquippedTag(FText& StatusText);                                                                      // [0x228deb8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.OnUpdateBattlePassRequiredBar
	// void OnUpdateBattlePassRequiredBar(bool bPassRequiredVisible);                                                           // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.OnTransitionItemDetails
	// void OnTransitionItemDetails(bool bTransitionForward);                                                                   // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.OnSetWeeklyRewardsInfo
	// void OnSetWeeklyRewardsInfo(FTimespan& DelayTimespan, int32_t AvailableRewards, int32_t OwnedRewards, int32_t TotalRewards, int32_t AvailablePages, int32_t CompletedPages, int32_t TotalPages); // [0x228deb8] Event|Protected|HasOutParms|HasDefaults|BlueprintEvent 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.OnSetWarningToolTip
	// void OnSetWarningToolTip(ERewardWarningTooltipType29& WarningTooltipType, FText& Description);                           // [0x228deb8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.OnSetResourcePrice
	// void OnSetResourcePrice(int32_t Cost, class UFortPersistentResourceItemDefinition* PersistentResource);                  // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.OnSetQuestRewardsInfo
	// void OnSetQuestRewardsInfo(FTimespan& DelayTimespan, int32_t OwnedRewards, int32_t TotalRewards, int32_t CompletedPages, int32_t TotalPages); // [0x228deb8] Event|Protected|HasOutParms|HasDefaults|BlueprintEvent 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.OnSetPrerequisiteInfo
	// void OnSetPrerequisiteInfo(FText& Description, int32_t CurrentAmount, int32_t NeededAmount, EBattlePassRewardPrerequisiteType PrerequisiteType, bool bShowPrerequisiteLock); // [0x228deb8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.OnSetItemPrice
	// void OnSetItemPrice(int32_t Cost, EBattlePassCurrencyType CurrencyType);                                                 // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.OnSetEquipButtonEnable
	// void OnSetEquipButtonEnable(bool bIsEnable);                                                                             // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.OnSetCrewInfo
	// void OnSetCrewInfo(bool bIsNextMonthRewards, FText& MonthText, FTimespan& NextMonthlyRewardTimespan, FText& CharacterDisplayName, FText& CharacterDescription); // [0x228deb8] Event|Protected|HasOutParms|HasDefaults|BlueprintEvent 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.OnSetCoverPageData
	// void OnSetCoverPageData(FText& Title, FText& Description, bool bPageComplete);                                           // [0x228deb8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.OnSetBonusRewardsInfo
	// void OnSetBonusRewardsInfo(bool bIsUnlocked, int32_t OwnedRewards, int32_t TotalRewards, int32_t CompletedPages, int32_t TotalPages, int32_t ClaimedOutfits, int32_t TotalOutfits); // [0x228deb8] Event|Protected|BlueprintEvent 
	...
	// void OnSetBaseRewardsInfo(int32_t OwnedRewards, int32_t TotalRewards, int32_t CompletedPages, int32_t TotalPages);       // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.OnItemVmCardUpdate
	// void OnItemVmCardUpdate(FExpandedItemVM ItemVMs, class UAthenaSeasonItemEntryBase* EntrySelected);                       // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.OnItemDelayed
	// void OnItemDelayed(FTimespan Delay);                                                                                     // [0x228deb8] Event|Protected|HasDefaults|BlueprintEvent 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.OnInsufficientResource
	// void OnInsufficientResource(class UFortPersistentResourceItemDefinition* PersistentResource);                            // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.OnInsufficientFunds
	// void OnInsufficientFunds(EBattlePassCurrencyType CurrencyType);                                                          // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.OnGameModeCompatibilityTagUpdate
	// void OnGameModeCompatibilityTagUpdate(class UFortItemVM* FortItem);                                                      // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.OnBattlePassOwned
	// void OnBattlePassOwned();                                                                                                // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.OnBattlePassGiftingAllowed
	// void OnBattlePassGiftingAllowed(bool bGiftingAllowed);                                                                   // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.IsSeasonalCustomizationItemOwned
	// bool IsSeasonalCustomizationItemOwned();                                                                                 // [0xb63357c] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.HandleSwitcherVisibilityShown
	// void HandleSwitcherVisibilityShown();                                                                                    // [0xb633554] Final|Native|Public|BlueprintCallable 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.HandleItemVMCardClicked
	// void HandleItemVMCardClicked(class UFortItemVM* ItemVM, class UAthenaSeasonItemEntryBase* EntrySelected);                // [0xb633400] Final|Native|Public|BlueprintCallable 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.HandleFullScreenMapToggled
	// void HandleFullScreenMapToggled(bool bMapVisible);                                                                       // [0xb633380] Final|Native|Private 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.HandleClaimRewardComplete
	// void HandleClaimRewardComplete(bool bSuccess, TArray<FString>& OfferTemplateIdList);                                     // [0xb633294] Final|Native|Private|HasOutParms 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.GoBackOneScreen
	// void GoBackOneScreen();                                                                                                  // [0xb633280] Final|Native|Public|BlueprintCallable 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.GetQuestPageDelay
	// FTimespan GetQuestPageDelay();                                                                                           // [0xb6331b8] Final|Native|Protected|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.GetEquipButtonEnable
	// bool GetEquipButtonEnable();                                                                                             // [0xb63319c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void OnStylePointsRewardsSet(int32_t Rewards);                                                                           // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/BattlePassS29UI.FortBattlePassResourcesWidgetS29.OnBattleStarRewardsSet
	// void OnBattleStarRewardsSet(int32_t Rewards);                                                                            // [0x228deb8] Event|Protected|BlueprintEvent 
};
