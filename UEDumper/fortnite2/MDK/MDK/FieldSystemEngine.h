...
public:
	...
	// void ResetFieldSystem();                                                                                                 // [0x667dd74] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/FieldSystemEngine.FieldSystemComponent.RemovePersistentFields
	// void RemovePersistentFields();                                                                                           // [0x36ec89c] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/FieldSystemEngine.FieldSystemComponent.ApplyUniformVectorFalloffForce
	// void ApplyUniformVectorFalloffForce(bool Enabled, FVector Position, FVector Direction, float Radius, float Magnitude);   // [0x667dbb8] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/FieldSystemEngine.FieldSystemComponent.ApplyStrainField
	// void ApplyStrainField(bool Enabled, FVector Position, float Radius, float Magnitude, int32_t Iterations);                // [0x667da1c] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/FieldSystemEngine.FieldSystemComponent.ApplyStayDynamicField
	// void ApplyStayDynamicField(bool Enabled, FVector Position, float Radius);                                                // [0x667d900] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/FieldSystemEngine.FieldSystemComponent.ApplyRadialVectorFalloffForce
	// void ApplyRadialVectorFalloffForce(bool Enabled, FVector Position, float Radius, float Magnitude);                       // [0x667d7a0] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/FieldSystemEngine.FieldSystemComponent.ApplyRadialForce
	// void ApplyRadialForce(bool Enabled, FVector Position, float Magnitude);                                                  // [0x667d684] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/FieldSystemEngine.FieldSystemComponent.ApplyPhysicsField
	// void ApplyPhysicsField(bool Enabled, TEnumAsByte<EFieldPhysicsType> Target, class UFieldSystemMetaData* MetaData, class UFieldNodeBase* Field); // [0x667d534] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/FieldSystemEngine.FieldSystemComponent.ApplyLinearForce
	// void ApplyLinearForce(bool Enabled, FVector Direction, float Magnitude);                                                 // [0x667d418] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/FieldSystemEngine.FieldSystemComponent.AddPersistentField
	// void AddPersistentField(bool Enabled, TEnumAsByte<EFieldPhysicsType> Target, class UFieldSystemMetaData* MetaData, class UFieldNodeBase* Field); // [0x3518908] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/FieldSystemEngine.FieldSystemComponent.AddFieldCommand
	// void AddFieldCommand(bool Enabled, TEnumAsByte<EFieldPhysicsType> Target, class UFieldSystemMetaData* MetaData, class UFieldNodeBase* Field); // [0x667d2c8] Final|RequiredAPI|Native|Public|BlueprintCallable 
};
...
public:
	...
	// class UFieldSystemMetaDataIteration* SetMetaDataIteration(int32_t Iterations);                                           // [0x667e254] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class UFieldSystemMetaDataProcessingResolution* SetMetaDataaProcessingResolutionType(TEnumAsByte<EFieldResolutionType> ResolutionType); // [0x667e2e0] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class UFieldSystemMetaDataFilter* SetMetaDataFilterType(TEnumAsByte<EFieldFilterType> FilterType, TEnumAsByte<EFieldObjectType> ObjectType, TEnumAsByte<EFieldPositionType> PositionType); // [0x667e150] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class UUniformInteger* SetUniformInteger(int32_t Magnitude);                                                             // [0x667e254] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class URadialIntMask* SetRadialIntMask(float Radius, FVector Position, int32_t InteriorValue, int32_t ExteriorValue, TEnumAsByte<ESetMaskConditionType> SetMaskConditionIn); // [0x667e79c] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class UUniformScalar* SetUniformScalar(float Magnitude);                                                                 // [0x667e938] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class UWaveScalar* SetWaveScalar(float Magnitude, FVector Position, float WaveLength, float Period, float Time, TEnumAsByte<EWaveFunctionType> Function, TEnumAsByte<EFieldFalloffType> Falloff); // [0x32fac28] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class URadialFalloff* SetRadialFalloff(float Magnitude, float MinRange, float MaxRange, float Default, float Radius, FVector Position, TEnumAsByte<EFieldFalloffType> Falloff); // [0x34677b0] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class UPlaneFalloff* SetPlaneFalloff(float Magnitude, float MinRange, float MaxRange, float Default, float Distance, FVector Position, FVector Normal, TEnumAsByte<EFieldFalloffType> Falloff); // [0x667e518] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class UBoxFalloff* SetBoxFalloff(float Magnitude, float MinRange, float MaxRange, float Default, FTransform Transform, TEnumAsByte<EFieldFalloffType> Falloff); // [0x667dd88] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class UNoiseField* SetNoiseField(float MinRange, float MaxRange, FTransform Transform);                                  // [0x667e370] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class UUniformVector* SetUniformVector(float Magnitude, FVector Direction);                                              // [0x667ea7c] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class URadialVector* SetRadialVector(float Magnitude, FVector Position);                                                 // [0x3611eb0] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class URandomVector* SetRandomVector(float Magnitude);                                                                   // [0x667e938] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class UOperatorField* SetOperatorField(float Magnitude, class UFieldNodeBase* LeftField, class UFieldNodeBase* RightField, TEnumAsByte<EFieldOperationType> Operation); // [0x31e91ac] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class UToIntegerField* SetToIntegerField(class UFieldNodeFloat* FloatField);                                             // [0x667e9e0] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class UToFloatField* SetToFloatField(class UFieldNodeInt* IntegerField);                                                 // [0x667e9e0] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class UCullingField* SetCullingField(class UFieldNodeBase* Culling, class UFieldNodeBase* Field, TEnumAsByte<EFieldCullingOperationType> Operation); // [0x667e008] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class UReturnResultsTerminal* SetReturnResultsTerminal();                                                                // [0x667e9cc] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure 
};
