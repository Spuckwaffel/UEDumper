...
public:
	...
	// void UpdateSimSettings();                                                                                                // [0xb3fdc04] Final|Native|Public|BlueprintCallable 
	// Function /Script/REVRuntime.REVComponent.UpdateParameters
	// void UpdateParameters(float InPitch, float InRPM, float InThrottle, float InVelocity, int32_t InGear, bool bInEnableShifting); // [0x3091da0] Final|Native|Public|BlueprintCallable 
	// Function /Script/REVRuntime.REVComponent.SetSettings
	// void SetSettings(class URevSettings* InSettings);                                                                        // [0xb3fdb5c] Final|Native|Public|BlueprintCallable 
	// Function /Script/REVRuntime.REVComponent.SetRevModel
	// void SetRevModel(class UREVModel* InModel);                                                                              // [0x2165354] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void UpdateSettings();                                                                                                   // [0xb3fdbf0] Final|BlueprintCosmetic|Native|Public|BlueprintCallable 
};
