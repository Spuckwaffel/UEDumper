...
public:
	...
	// void CollectConditionsFromDriver();                                                                                      // [0xbc76f18] Final|Native|Public|BlueprintCallable 
};

/// Class /Script/MotorcycleRuntime.FortPlayerAnimInstance_MotorcycleRider
/// Size: 0x0418 (0x000468 - 0x000880)
...
public:
	...
	DMember(bool)                                      bIsJumping                                                  OFFSET(get<bool>, {0x515, 1, 1, 0})
	DMember(bool)                                      bIsReloading                                                OFFSET(get<bool>, {0x515, 1, 1, 1})
	...
	DMember(bool)                                      bIsPowerSliding                                             OFFSET(get<bool>, {0x7C5, 1, 0, 0})
...
public:
	SMember(FMulticastInlineDelegate)                  OnStartChargingJumpDelegate                                 OFFSET(getStruct<T>, {0x1FA8, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  OnCancelChargingJumpDelegate                                OFFSET(getStruct<T>, {0x1FB8, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  OnJumpDelegate                                              OFFSET(getStruct<T>, {0x1FC8, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  OnChargingJumpDelegate                                      OFFSET(getStruct<T>, {0x1FD8, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  OnStartAirTrickDelegate                                     OFFSET(getStruct<T>, {0x1FE8, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  OnFinishAirTrickDelegate                                    OFFSET(getStruct<T>, {0x1FF8, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  OnStartWheelieDelegate                                      OFFSET(getStruct<T>, {0x2008, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  OnReleaseWheelieDelegate                                    OFFSET(getStruct<T>, {0x2018, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  OnLandWheelieDelegate                                       OFFSET(getStruct<T>, {0x2028, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  OnFailWheelieDelegate                                       OFFSET(getStruct<T>, {0x2038, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  OnStartStoppieDelegate                                      OFFSET(getStruct<T>, {0x2048, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  OnReleaseStoppieDelegate                                    OFFSET(getStruct<T>, {0x2058, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  OnLandStoppieDelegate                                       OFFSET(getStruct<T>, {0x2068, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  OnInventoryModeChangedDelegate                              OFFSET(getStruct<T>, {0x2078, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  OnSuperSlidingChangedDelegate                               OFFSET(getStruct<T>, {0x2088, 16, 0, 0})
	CMember(class UClass*)                             InventoryCameraModeClass                                    OFFSET(get<T>, {0x2098, 8, 0, 0})
	CMember(class UClass*)                             InventoryCameraModeClassADS                                 OFFSET(get<T>, {0x20A0, 8, 0, 0})
	CMember(class UClass*)                             PassengerCameraModeClass                                    OFFSET(get<T>, {0x20A8, 8, 0, 0})
	CMember(class UClass*)                             PassengerCameraModeClassADS                                 OFFSET(get<T>, {0x20B0, 8, 0, 0})
	CMember(class UFortMotorcycleVehicleConfigs*)      FortMotorcycleVehicleConfigs                                OFFSET(get<T>, {0x20B8, 8, 0, 0})
	SMember(FName)                                     RearAxleSocket                                              OFFSET(getStruct<T>, {0x20C0, 4, 0, 0})
	CMember(TArray<FActionDefForUI>)                   ActionDefForUI                                              OFFSET(get<T>, {0x20C8, 16, 0, 0})
	DMember(float)                                     SwingArmRotation                                            OFFSET(get<float>, {0x20D8, 4, 0, 0})
	CMember(TArray<int32_t>)                           BoostShapeIndices                                           OFFSET(get<T>, {0x2158, 16, 0, 0})
	DMember(bool)                                      bIsBoostAttacking                                           OFFSET(get<bool>, {0x2168, 1, 0, 0})
	CMember(EFortMotorcycleAirTrickType)               CachedTrickType                                             OFFSET(get<T>, {0x2178, 1, 0, 0})
	DMember(bool)                                      bHadPassengerAtTrickStart                                   OFFSET(get<bool>, {0x2179, 1, 0, 0})
	CMember(TArray<FName>)                             PassengerADSSockets                                         OFFSET(get<T>, {0x21B0, 16, 0, 0})
	CMember(TArray<FVector>)                           PassengerADSRelativeOffsets                                 OFFSET(get<T>, {0x21C0, 16, 0, 0})
	CMember(class UNiagaraComponent*)                  CachedNiagaraComponentRoadAndExhaust                        OFFSET(get<T>, {0x21D0, 8, 0, 0})
	SMember(FString)                                   RoadAndExhaustNiagaraComponentName                          OFFSET(getStruct<T>, {0x21D8, 16, 0, 0})
	SMember(FName)                                     RoadAndExhaustVehicleSpeedName                              OFFSET(getStruct<T>, {0x21E8, 4, 0, 0})
	SMember(FName)                                     RoadAndExhaustSlideDirectionName                            OFFSET(getStruct<T>, {0x21EC, 4, 0, 0})
	DMember(float)                                     RoadAndExhaustMinSpeedForDust                               OFFSET(get<float>, {0x21F0, 4, 0, 0})
	SMember(FName)                                     RoadAndExhaustDustRearName                                  OFFSET(getStruct<T>, {0x21F4, 4, 0, 0})
	SMember(FName)                                     RoadAndExhaustDustColorLerpName                             OFFSET(getStruct<T>, {0x21F8, 4, 0, 0})
	DMember(float)                                     RoadAndExhaustDustColorLerp                                 OFFSET(get<float>, {0x21FC, 4, 0, 0})
	SMember(FName)                                     RoadAndExhaustDustAlphaMultiplierName                       OFFSET(getStruct<T>, {0x2200, 4, 0, 0})
	DMember(float)                                     RoadAndExhaustDustAlphaMultiplier                           OFFSET(get<float>, {0x2204, 4, 0, 0})
	SMember(FName)                                     RoadAndExhaustPeelOutColorIndexName                         OFFSET(getStruct<T>, {0x2208, 4, 0, 0})
	SMember(FName)                                     RoadAndExhaustPeelOutRearName                               OFFSET(getStruct<T>, {0x220C, 4, 0, 0})
	SMember(FName)                                     RoadAndExhaustIsPeelOutOnRoadName                           OFFSET(getStruct<T>, {0x2210, 4, 0, 0})
	SMember(FName)                                     RoadAndExhaustIsPeelOutOnRoadRewindName                     OFFSET(getStruct<T>, {0x2214, 4, 0, 0})
	SMember(FName)                                     RoadAndExhaustIsInAirName                                   OFFSET(getStruct<T>, {0x2218, 4, 0, 0})
	SMember(FGameplayTag)                              RoadAndExhaustCameraDirtGameplayCueTag                      OFFSET(getStruct<T>, {0x221C, 4, 0, 0})
	SMember(FGameplayTag)                              RoadAndExhaustCameraWaterGameplayCueTag                     OFFSET(getStruct<T>, {0x2220, 4, 0, 0})
	CMember(TArray<TEnumAsByte<EPhysicalSurface>>)     RoadAndExhaustSurfaceTypeArrayForFX                         OFFSET(get<T>, {0x2228, 16, 0, 0})
	CMember(class ULegacyCameraShake*)                 DriverCameraShakeInstance                                   OFFSET(get<T>, {0x2238, 8, 0, 0})
	CMember(class ULegacyCameraShake*)                 AcceleratingCameraShakeInstance                             OFFSET(get<T>, {0x2240, 8, 0, 0})
	SMember(FName)                                     RoadAndExhaustHeadlightsName                                OFFSET(getStruct<T>, {0x2250, 4, 0, 0})
	SMember(FName)                                     RoadAndExhaustBrakelightsName                               OFFSET(getStruct<T>, {0x2254, 4, 0, 0})
	SMember(FScalableFloat)                            DoorBashMinSpeed                                            OFFSET(getStruct<T>, {0x2258, 40, 0, 0})
	SMember(FScalableFloat)                            DoorBashMaxSpeed                                            OFFSET(getStruct<T>, {0x2280, 40, 0, 0})
	SMember(FScalableFloat)                            DoorBashForwardDistanceMin                                  OFFSET(getStruct<T>, {0x22A8, 40, 0, 0})
	SMember(FScalableFloat)                            DoorBashForwardDistanceMax                                  OFFSET(getStruct<T>, {0x22D0, 40, 0, 0})
	SMember(FGameplayTag)                              DoorBashGameplayCueTag                                      OFFSET(getStruct<T>, {0x22F8, 4, 0, 0})
	CMember(TArray<TEnumAsByte<EObjectTypeQuery>>)     DoorBashCollisionTypesForDoor                               OFFSET(get<T>, {0x2300, 16, 0, 0})
	CMember(TArray<TEnumAsByte<EObjectTypeQuery>>)     DoorBashCollisionTypesForPawn                               OFFSET(get<T>, {0x2310, 16, 0, 0})
	SMember(FScalableFloat)                            DoorBashSphereRadiusForPawnLaunch                           OFFSET(getStruct<T>, {0x2320, 40, 0, 0})
	SMember(FScalableFloat)                            DoorBashScalarForPawnLaunch                                 OFFSET(getStruct<T>, {0x2348, 40, 0, 0})
	SMember(FGameplayTag)                              DoorBashPawnLaunchGameplayCueTag                            OFFSET(getStruct<T>, {0x2370, 4, 0, 0})
	SMember(FGameplayTagQuery)                         InventoryModeTagQuery                                       OFFSET(getStruct<T>, {0x2378, 72, 0, 0})
	SMember(FGameplayTagContainer)                     InputContextBlockedTags                                     OFFSET(getStruct<T>, {0x23C0, 32, 0, 0})
	SMember(FGameplayTag)                              MobileHUDTag                                                OFFSET(getStruct<T>, {0x23F8, 4, 0, 0})


	/// Functions
	// Function /Script/MotorcycleRuntime.FortMotorcycleVehicle.ServerEjectAllPlayers
	// void ServerEjectAllPlayers();                                                                                            // [0x9fdd8d8] Net|NetReliableNative|Event|Public|NetServer 
	// Function /Script/MotorcycleRuntime.FortMotorcycleVehicle.OnRep_IsBoostAttacking
	// void OnRep_IsBoostAttacking();                                                                                           // [0xbc770f4] Final|Native|Protected 
	// Function /Script/MotorcycleRuntime.FortMotorcycleVehicle.OnPlayerWeaponChanged
	// void OnPlayerWeaponChanged(class AFortWeapon* InNewWeapon, class AFortWeapon* InPrevWeapon);                             // [0x23b3928] Final|Native|Public  
	// Function /Script/MotorcycleRuntime.FortMotorcycleVehicle.MotorcycleWheelie__DelegateSignature
	// void MotorcycleWheelie__DelegateSignature();                                                                             // [0x228deb8] MulticastDelegate|Public|Delegate 
	// Function /Script/MotorcycleRuntime.FortMotorcycleVehicle.MotorcycleSuperSlidingChanged__DelegateSignature
	// void MotorcycleSuperSlidingChanged__DelegateSignature(bool bIsSuperSliding);                                             // [0x228deb8] MulticastDelegate|Public|Delegate 
	// Function /Script/MotorcycleRuntime.FortMotorcycleVehicle.MotorcycleStoppie__DelegateSignature
	// void MotorcycleStoppie__DelegateSignature();                                                                             // [0x228deb8] MulticastDelegate|Public|Delegate 
	// Function /Script/MotorcycleRuntime.FortMotorcycleVehicle.MotorcycleStartAirTrick__DelegateSignature
	// void MotorcycleStartAirTrick__DelegateSignature(EFortMotorcycleAirTrickType TrickType);                                  // [0x228deb8] MulticastDelegate|Public|Delegate 
	// Function /Script/MotorcycleRuntime.FortMotorcycleVehicle.MotorcycleJump__DelegateSignature
	// void MotorcycleJump__DelegateSignature(float JumpChargeFactor);                                                          // [0x228deb8] MulticastDelegate|Public|Delegate 
	// Function /Script/MotorcycleRuntime.FortMotorcycleVehicle.MotorcycleInventoryMode__DelegateSignature
	// void MotorcycleInventoryMode__DelegateSignature(bool IsInInventoryMode);                                                 // [0x228deb8] MulticastDelegate|Public|Delegate 
	// Function /Script/MotorcycleRuntime.FortMotorcycleVehicle.MotorcycleChargingJump__DelegateSignature
	// void MotorcycleChargingJump__DelegateSignature();                                                                        // [0x228deb8] MulticastDelegate|Public|Delegate 
	// Function /Script/MotorcycleRuntime.FortMotorcycleVehicle.MotorcycleAirTrick__DelegateSignature
	// void MotorcycleAirTrick__DelegateSignature();                                                                            // [0x228deb8] MulticastDelegate|Public|Delegate 
	// Function /Script/MotorcycleRuntime.FortMotorcycleVehicle.IsSuperSliding
	// bool IsSuperSliding();                                                                                                   // [0xbc770d0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MotorcycleRuntime.FortMotorcycleVehicle.IsPowerSliding
	// bool IsPowerSliding();                                                                                                   // [0xbc770ac] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MotorcycleRuntime.FortMotorcycleVehicle.IsInInventoryMode
	// bool IsInInventoryMode();                                                                                                // [0xbc77088] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MotorcycleRuntime.FortMotorcycleVehicle.GetSurfaceTypeVehicleOn
	// TEnumAsByte<EPhysicalSurface> GetSurfaceTypeVehicleOn();                                                                 // [0xbc76f7c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MotorcycleRuntime.FortMotorcycleVehicle.GetLeanAngleDegrees
	// float GetLeanAngleDegrees();                                                                                             // [0xbc76f54] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MotorcycleRuntime.FortMotorcycleVehicle.GetAverageSpringNormal
	// FVector GetAverageSpringNormal();                                                                                        // [0xbc76f2c] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MotorcycleRuntime.FortMotorcycleVehicle.ChangeBoostAttackState
	// void ChangeBoostAttackState(bool bNewIsBoostAttacking);                                                                  // [0xbc76df0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MotorcycleRuntime.FortMotorcycleVehicle.BP_OnStartWheelie
	// void BP_OnStartWheelie();                                                                                                // [0x228deb8] Event|Public|BlueprintEvent 
	// Function /Script/MotorcycleRuntime.FortMotorcycleVehicle.BP_OnStartStoppie
	// void BP_OnStartStoppie();                                                                                                // [0x228deb8] Event|Public|BlueprintEvent 
	// Function /Script/MotorcycleRuntime.FortMotorcycleVehicle.BP_OnStartChargingJump
	// void BP_OnStartChargingJump();                                                                                           // [0x228deb8] Event|Public|BlueprintEvent 
	// Function /Script/MotorcycleRuntime.FortMotorcycleVehicle.BP_OnStartAirTrick
	// void BP_OnStartAirTrick(EFortMotorcycleAirTrickType TrickType);                                                          // [0x228deb8] Event|Public|BlueprintEvent 
	// Function /Script/MotorcycleRuntime.FortMotorcycleVehicle.BP_OnReleaseWheelie
	// void BP_OnReleaseWheelie();                                                                                              // [0x228deb8] Event|Public|BlueprintEvent 
	// Function /Script/MotorcycleRuntime.FortMotorcycleVehicle.BP_OnReleaseStoppie
	// void BP_OnReleaseStoppie();                                                                                              // [0x228deb8] Event|Public|BlueprintEvent 
	// Function /Script/MotorcycleRuntime.FortMotorcycleVehicle.BP_OnLandWheelie
	// void BP_OnLandWheelie();                                                                                                 // [0x228deb8] Event|Public|BlueprintEvent 
	// Function /Script/MotorcycleRuntime.FortMotorcycleVehicle.BP_OnLandStoppie
	// void BP_OnLandStoppie();                                                                                                 // [0x228deb8] Event|Public|BlueprintEvent 
	// Function /Script/MotorcycleRuntime.FortMotorcycleVehicle.BP_OnJump
	// void BP_OnJump(float JumpChargeFactor);                                                                                  // [0x228deb8] Event|Public|BlueprintEvent 
	// Function /Script/MotorcycleRuntime.FortMotorcycleVehicle.BP_OnFinishAirTrick
	// void BP_OnFinishAirTrick();                                                                                              // [0x228deb8] Event|Public|BlueprintEvent 
	// Function /Script/MotorcycleRuntime.FortMotorcycleVehicle.BP_OnFailWheelie
	// void BP_OnFailWheelie();                                                                                                 // [0x228deb8] Event|Public|BlueprintEvent 
	// Function /Script/MotorcycleRuntime.FortMotorcycleVehicle.BP_OnChargingJump
	// void BP_OnChargingJump(float JumpChargeFactor);                                                                          // [0x228deb8] Event|Public|BlueprintEvent 
	// Function /Script/MotorcycleRuntime.FortMotorcycleVehicle.BP_OnCancelChargingJump
	// void BP_OnCancelChargingJump();                                                                                          // [0x228deb8] Event|Public|BlueprintEvent 
};

/// Class /Script/MotorcycleRuntime.FortMotorcycleVehicleConfigs
/// Size: 0x02D0 (0x000930 - 0x000C00)
...
public:
	CMember(TArray<FMotorcycleWheel>)                  Wheels                                                      OFFSET(get<T>, {0x930, 16, 0, 0})
	DMember(float)                                     SpringInterpDamp                                            OFFSET(get<float>, {0x940, 4, 0, 0})
	DMember(float)                                     WheelieSpringInterpDamp                                     OFFSET(get<float>, {0x944, 4, 0, 0})
	DMember(float)                                     WallPushStiff                                               OFFSET(get<float>, {0x948, 4, 0, 0})
	DMember(float)                                     WallPushDamp                                                OFFSET(get<float>, {0x94C, 4, 0, 0})
	SMember(FVector)                                   WallPushXTraceOffset                                        OFFSET(getStruct<T>, {0x950, 24, 0, 0})
	DMember(float)                                     WallPushForwardTraceLengthScale                             OFFSET(get<float>, {0x968, 4, 0, 0})
	DMember(float)                                     WallPushBackTraceLengthScale                                OFFSET(get<float>, {0x96C, 4, 0, 0})
	DMember(float)                                     WallPushRightTraceLength                                    OFFSET(get<float>, {0x970, 4, 0, 0})
	SMember(FVector)                                   WallPushRightTraceOffset                                    OFFSET(getStruct<T>, {0x978, 24, 0, 0})
	SMember(FVector)                                   WallPushRearRightTraceOffset                                OFFSET(getStruct<T>, {0x990, 24, 0, 0})
	DMember(float)                                     WallPushAngle                                               OFFSET(get<float>, {0x9A8, 4, 0, 0})
	DMember(bool)                                      bUseWallPushTracesForWalls                                  OFFSET(get<bool>, {0x9AC, 1, 0, 0})
	DMember(bool)                                      bUseWallPushRearSideTracesForWalls                          OFFSET(get<bool>, {0x9AD, 1, 0, 0})
	DMember(float)                                     MaxJumpChargeTime                                           OFFSET(get<float>, {0x9B0, 4, 0, 0})
	DMember(float)                                     MinChargeJumpForce                                          OFFSET(get<float>, {0x9B4, 4, 0, 0})
	DMember(float)                                     MaxChargeJumpForce                                          OFFSET(get<float>, {0x9B8, 4, 0, 0})
	DMember(float)                                     MinJumpForwardAngle                                         OFFSET(get<float>, {0x9BC, 4, 0, 0})
	DMember(float)                                     MaxJumpForwardAngle                                         OFFSET(get<float>, {0x9C0, 4, 0, 0})
	SMember(FVector)                                   JumpForceMinCOMOffset                                       OFFSET(getStruct<T>, {0x9C8, 24, 0, 0})
	SMember(FVector)                                   JumpForceMaxCOMOffset                                       OFFSET(getStruct<T>, {0x9E0, 24, 0, 0})
	DMember(float)                                     JumpChargeGraceTimeSeconds                                  OFFSET(get<float>, {0x9F8, 4, 0, 0})
	DMember(float)                                     JumpGraceTimeSeconds                                        OFFSET(get<float>, {0x9FC, 4, 0, 0})
	DMember(float)                                     LeanAngleScale                                              OFFSET(get<float>, {0xA00, 4, 0, 0})
	DMember(float)                                     LeanStiff                                                   OFFSET(get<float>, {0xA04, 4, 0, 0})
	DMember(float)                                     LeanDamp                                                    OFFSET(get<float>, {0xA08, 4, 0, 0})
	DMember(float)                                     LeanStrength                                                OFFSET(get<float>, {0xA0C, 4, 0, 0})
	DMember(float)                                     SlideCatchupForceTime                                       OFFSET(get<float>, {0xA10, 4, 0, 0})
	DMember(float)                                     SlideCatchupSpeed                                           OFFSET(get<float>, {0xA14, 4, 0, 0})
	DMember(float)                                     SlideCatchupPushForce                                       OFFSET(get<float>, {0xA18, 4, 0, 0})
	DMember(float)                                     AutoAirPitchAngle                                           OFFSET(get<float>, {0xA1C, 4, 0, 0})
	DMember(float)                                     MinSteeringAngleForModifiedFriction                         OFFSET(get<float>, {0xA20, 4, 0, 0})
	DMember(float)                                     MinSpeedForModifiedFriction                                 OFFSET(get<float>, {0xA24, 4, 0, 0})
	DMember(float)                                     MinSteeringAngleToConsiderTractionLost                      OFFSET(get<float>, {0xA28, 4, 0, 0})
	DMember(float)                                     FrictionRatioToConsiderTractionLost                         OFFSET(get<float>, {0xA2C, 4, 0, 0})
	DMember(float)                                     WheeliePitchStiffMin                                        OFFSET(get<float>, {0xA30, 4, 0, 0})
	DMember(float)                                     WheeliePitchStiffMax                                        OFFSET(get<float>, {0xA34, 4, 0, 0})
	DMember(float)                                     WheeliePitchDampMin                                         OFFSET(get<float>, {0xA38, 4, 0, 0})
	DMember(float)                                     WheeliePitchDampMax                                         OFFSET(get<float>, {0xA3C, 4, 0, 0})
	DMember(float)                                     WheeliePitchAngleMin                                        OFFSET(get<float>, {0xA40, 4, 0, 0})
	DMember(float)                                     WheeliePitchAngleMax                                        OFFSET(get<float>, {0xA44, 4, 0, 0})
	DMember(float)                                     StoppiePitchAngle                                           OFFSET(get<float>, {0xA48, 4, 0, 0})
	DMember(float)                                     StoppiePitchStiff                                           OFFSET(get<float>, {0xA4C, 4, 0, 0})
	DMember(float)                                     StoppiePitchDamp                                            OFFSET(get<float>, {0xA50, 4, 0, 0})
	DMember(float)                                     WheelieRampSeconds                                          OFFSET(get<float>, {0xA54, 4, 0, 0})
	DMember(float)                                     WheelieFailPitchAngle                                       OFFSET(get<float>, {0xA58, 4, 0, 0})
	DMember(float)                                     WheelieRecoveryRate                                         OFFSET(get<float>, {0xA5C, 4, 0, 0})
	DMember(float)                                     WheelieFailRecoveryRate                                     OFFSET(get<float>, {0xA60, 4, 0, 0})
	DMember(float)                                     WheelieMinStartSpeed                                        OFFSET(get<float>, {0xA64, 4, 0, 0})
	DMember(float)                                     StoppieMinStopSpeed                                         OFFSET(get<float>, {0xA68, 4, 0, 0})
	DMember(float)                                     WheelieSteerFactor                                          OFFSET(get<float>, {0xA6C, 4, 0, 0})
	DMember(float)                                     StoppieSteerFactor                                          OFFSET(get<float>, {0xA70, 4, 0, 0})
	DMember(float)                                     WheelieSteerAlphaThreshold                                  OFFSET(get<float>, {0xA74, 4, 0, 0})
	DMember(float)                                     WheelieStoppieMaxLeanAllowedToInitiate                      OFFSET(get<float>, {0xA78, 4, 0, 0})
	DMember(float)                                     WheelieGroundBufferTime                                     OFFSET(get<float>, {0xA7C, 4, 0, 0})
	DMember(float)                                     StoppieGroundBufferTime                                     OFFSET(get<float>, {0xA80, 4, 0, 0})
	DMember(float)                                     WheelieSpringLengthExponent                                 OFFSET(get<float>, {0xA84, 4, 0, 0})
	DMember(float)                                     WheelieWheelOffsetLerpMultiplier                            OFFSET(get<float>, {0xA88, 4, 0, 0})
	DMember(float)                                     WheelieBrakeFactor                                          OFFSET(get<float>, {0xA8C, 4, 0, 0})
	DMember(float)                                     StoppieTurnInPlaceSpeed                                     OFFSET(get<float>, {0xA90, 4, 0, 0})
	DMember(float)                                     StoppieTurnInPlaceSpeedIce                                  OFFSET(get<float>, {0xA94, 4, 0, 0})
	DMember(float)                                     StoppieTurnInPlaceSpeedMud                                  OFFSET(get<float>, {0xA98, 4, 0, 0})
	DMember(float)                                     MinSpeedKmhForMaxStoppie                                    OFFSET(get<float>, {0xA9C, 4, 0, 0})
	DMember(float)                                     StoppieTurnAngleExponent                                    OFFSET(get<float>, {0xAA0, 4, 0, 0})
	DMember(float)                                     StoppieMaxTurnAngle                                         OFFSET(get<float>, {0xAA4, 4, 0, 0})
	DMember(float)                                     WheelieTireTractionMultiplier_Min                           OFFSET(get<float>, {0xAA8, 4, 0, 0})
	DMember(float)                                     WheelieCameraMinStraightFactor                              OFFSET(get<float>, {0xAAC, 4, 0, 0})
	DMember(float)                                     MaxLeanAccel                                                OFFSET(get<float>, {0xAB0, 4, 0, 0})
	DMember(float)                                     CruiseControlForwardAlpha                                   OFFSET(get<float>, {0xAB4, 4, 0, 0})
	DMember(float)                                     InventoryModeSpeedKmh                                       OFFSET(get<float>, {0xAB8, 4, 0, 0})
	DMember(float)                                     CruiseControlDisengageSpeedKmh                              OFFSET(get<float>, {0xABC, 4, 0, 0})
	DMember(bool)                                      bPowerSlideIsSuperSlide                                     OFFSET(get<bool>, {0xAC0, 1, 0, 0})
	DMember(float)                                     PowerSlideFrontFrictionMultiplier                           OFFSET(get<float>, {0xAC4, 4, 0, 0})
	DMember(float)                                     PowerSlideRearFrictionMultiplier                            OFFSET(get<float>, {0xAC8, 4, 0, 0})
	DMember(float)                                     PowerSlideRoadFrontFrictionMultiplier                       OFFSET(get<float>, {0xACC, 4, 0, 0})
	DMember(float)                                     PowerSlideRoadRearFrictionMultiplier                        OFFSET(get<float>, {0xAD0, 4, 0, 0})
	DMember(float)                                     PowerSlideDirtFrontFrictionMultiplier                       OFFSET(get<float>, {0xAD4, 4, 0, 0})
	DMember(float)                                     PowerSlideDirtRearFrictionMultiplier                        OFFSET(get<float>, {0xAD8, 4, 0, 0})
	DMember(float)                                     PowerSlideGrassFrontFrictionMultiplier                      OFFSET(get<float>, {0xADC, 4, 0, 0})
	DMember(float)                                     PowerSlideGrassRearFrictionMultiplier                       OFFSET(get<float>, {0xAE0, 4, 0, 0})
	DMember(float)                                     PowerSlideSnowFrontFrictionMultiplier                       OFFSET(get<float>, {0xAE4, 4, 0, 0})
	DMember(float)                                     PowerSlideSnowRearFrictionMultiplier                        OFFSET(get<float>, {0xAE8, 4, 0, 0})
	DMember(float)                                     PowerSlideIceFrontFrictionMultiplier                        OFFSET(get<float>, {0xAEC, 4, 0, 0})
	DMember(float)                                     PowerSlideIceRearFrictionMultiplier                         OFFSET(get<float>, {0xAF0, 4, 0, 0})
	DMember(float)                                     PowerSlideMudFrontFrictionMultiplier                        OFFSET(get<float>, {0xAF4, 4, 0, 0})
	DMember(float)                                     PowerSlideMudRearFrictionMultiplier                         OFFSET(get<float>, {0xAF8, 4, 0, 0})
	DMember(float)                                     PowerSlideFactor                                            OFFSET(get<float>, {0xAFC, 4, 0, 0})
	DMember(float)                                     PowerSlideDampFactor                                        OFFSET(get<float>, {0xB00, 4, 0, 0})
	DMember(float)                                     FrictionDampFactor                                          OFFSET(get<float>, {0xB04, 4, 0, 0})
	DMember(float)                                     PowerSlideLeanAngleScale                                    OFFSET(get<float>, {0xB08, 4, 0, 0})
	DMember(float)                                     SuperSlideLeanAngle                                         OFFSET(get<float>, {0xB0C, 4, 0, 0})
	DMember(float)                                     SuperSlideMinStartYawSpeedDegrees                           OFFSET(get<float>, {0xB10, 4, 0, 0})
	DMember(float)                                     SuperSlideMinStartSpeedKmh                                  OFFSET(get<float>, {0xB14, 4, 0, 0})
	DMember(float)                                     SuperSlideMaxEndSpeedKmh                                    OFFSET(get<float>, {0xB18, 4, 0, 0})
	DMember(float)                                     PowerslideInputWindow                                       OFFSET(get<float>, {0xB1C, 4, 0, 0})
	DMember(float)                                     ShootingMinSpeedSteeringAngle                               OFFSET(get<float>, {0xB20, 4, 0, 0})
	DMember(float)                                     ShootingMaxSpeedSteeringAngle                               OFFSET(get<float>, {0xB24, 4, 0, 0})
	DMember(float)                                     InventoryModeCameraYawConstraint                            OFFSET(get<float>, {0xB28, 4, 0, 0})
	DMember(float)                                     BoostTopSpeedMultiplier                                     OFFSET(get<float>, {0xB2C, 4, 0, 0})
	DMember(float)                                     BoostPushForceMultiplier                                    OFFSET(get<float>, {0xB30, 4, 0, 0})
	DMember(float)                                     BoostMinPushForce                                           OFFSET(get<float>, {0xB34, 4, 0, 0})
	DMember(float)                                     BoostSteeringMultiplier                                     OFFSET(get<float>, {0xB38, 4, 0, 0})
	DMember(bool)                                      bPlayHolsterAnimsOnClient                                   OFFSET(get<bool>, {0xB3C, 1, 0, 0})
	DMember(float)                                     FrontWheelSteeringFactor                                    OFFSET(get<float>, {0xB40, 4, 0, 0})
	DMember(float)                                     FrontWheelRotationAcceleration                              OFFSET(get<float>, {0xB44, 4, 0, 0})
	DMember(float)                                     PassengerInventoryCooldown                                  OFFSET(get<float>, {0xB48, 4, 0, 0})
	DMember(float)                                     DriverInventoryCooldown                                     OFFSET(get<float>, {0xB4C, 4, 0, 0})
	CMember(TSet<FName>)                               BoostAttackShapes                                           OFFSET(get<T>, {0xB50, 80, 0, 0})
	DMember(float)                                     CameraAssistStrengthMax                                     OFFSET(get<float>, {0xBA0, 4, 0, 0})
	DMember(float)                                     CameraAssistStrengthMin                                     OFFSET(get<float>, {0xBA4, 4, 0, 0})
	DMember(float)                                     CameraAssistStrengthRecovery                                OFFSET(get<float>, {0xBA8, 4, 0, 0})
	DMember(float)                                     CameraAssistInterpSpeed                                     OFFSET(get<float>, {0xBAC, 4, 0, 0})
	DMember(float)                                     AirTrickIncrementInterval                                   OFFSET(get<float>, {0xBB0, 4, 0, 0})
	DMember(float)                                     AirTrickFeedStartTime                                       OFFSET(get<float>, {0xBB4, 4, 0, 0})
	DMember(float)                                     AirTrickPitchMultiplier                                     OFFSET(get<float>, {0xBB8, 4, 0, 0})
	DMember(float)                                     AirTrickYawMultiplier                                       OFFSET(get<float>, {0xBBC, 4, 0, 0})
	DMember(bool)                                      bAllowAirTrickNeutral                                       OFFSET(get<bool>, {0xBC0, 1, 0, 0})
	DMember(bool)                                      bAllowAirTrickRight                                         OFFSET(get<bool>, {0xBC1, 1, 0, 0})
	DMember(bool)                                      bAllowAirTrickLeft                                          OFFSET(get<bool>, {0xBC2, 1, 0, 0})
	DMember(float)                                     PoppedTireTractionScalar_Front                              OFFSET(get<float>, {0xBC4, 4, 0, 0})
	DMember(float)                                     PoppedTireTractionScalar_Rear                               OFFSET(get<float>, {0xBC8, 4, 0, 0})
	DMember(float)                                     PoppedTireTractionScalar_Both                               OFFSET(get<float>, {0xBCC, 4, 0, 0})
	SMember(FScalableFloat)                            TopSpeedKmh                                                 OFFSET(getStruct<T>, {0xBD0, 40, 0, 0})
};
