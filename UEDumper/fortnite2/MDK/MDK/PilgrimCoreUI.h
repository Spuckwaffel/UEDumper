...
public:
	...
	// void HookUpVoiceIcon(class UFortVoiceChatStatusIcon* Icon, class AFortPlayerStateAthena* Player);                        // [0xbc58b08] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// int32_t GetTotalXP();                                                                                                    // [0xbc58ac0] Final|Native|Private|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/PilgrimCoreUI.PilgrimPostGameProgressWidget.GetMatchXP
	// int32_t GetMatchXP();                                                                                                    // [0xbc58910] Final|Native|Private|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void InitializeForLanes(int32_t NewNumLanes, TArray<UFortInputMappingContext*>& InputMappingContexts);                   // [0xbc58d40] Final|Native|Private|HasOutParms|BlueprintCallable 
	// Function /Script/PilgrimCoreUI.PilgrimPresetSwitcher.GetSelectedItems
	// void GetSelectedItems(int32_t& OutSelectedLaneNum, int32_t& OutSelectedIndex);                                           // [0xbc58958] Final|Native|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// void Initialize(class APlayerController* InOwningController, FGameplayTagContainer& InSortTags, FGameplayTagContainer& InFilterTags); // [0xbc58bcc] Final|Native|Public|HasOutParms|BlueprintCallable 
};
