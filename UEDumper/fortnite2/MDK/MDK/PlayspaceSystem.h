...
public:
	...
	// void OnEndActorOverlap(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex); // [0x7fde7e8] Native|Protected     
	// Function /Script/PlayspaceSystem.OverlapComponent.OnBeginActorOverlap
	// void OnBeginActorOverlap(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool bFromSweep, FHitResult& SweepResult); // [0x7fde5b0] Native|Protected|HasOutParms 
};
...
public:
	...
	// void ServerMarkReadyForSpawning();                                                                                       // [0x7fdedc0] Final|Net|NetReliableNative|Event|Private|NetServer|NetValidate 
	// Function /Script/PlayspaceSystem.PlayspaceControllerComponent_PlayerSpawning.OnRep_ReplicatedSpawnInfo
	// void OnRep_ReplicatedSpawnInfo();                                                                                        // [0x7fded1c] Final|Native|Private 
	// Function /Script/PlayspaceSystem.PlayspaceControllerComponent_PlayerSpawning.GetSpawnInfo
	// FReplicatedSpawnInfo GetSpawnInfo();                                                                                     // [0x7fde43c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/PlayspaceSystem.PlayspaceControllerComponent_PlayerSpawning.ClientReplicatedSpawnInfo
	// void ClientReplicatedSpawnInfo(FReplicatedSpawnInfo InReplicatedSpawnInfo);                                              // [0x7fde2e8] Final|Net|NetReliableNative|Event|Private|NetClient 
};
...
public:
	...
	// void UpdateSize(FVector& NewScale);                                                                                      // [0x7fdee0c] Native|Public|HasOutParms|HasDefaults 
	// Function /Script/PlayspaceSystem.GameplayVolume.OnRep_Playspace
	// void OnRep_Playspace();                                                                                                  // [0x7fdecec] Final|Native|Protected 
	// Function /Script/PlayspaceSystem.GameplayVolume.OnOverlappedPawnControllerChanged
	// void OnOverlappedPawnControllerChanged(class APawn* Pawn, class AController* OldController, class AController* NewController); // [0x7fde928] Native|Protected     
	// Function /Script/PlayspaceSystem.GameplayVolume.InitializeBoundsComponent
	// void InitializeBoundsComponent(class UOverlapComponent* NewBoundsComponent);                                             // [0x7fde494] Final|Native|Private|BlueprintCallable 
	// Function /Script/PlayspaceSystem.GameplayVolume.GetPlayspace
	// class APlayspace* GetPlayspace();                                                                                        // [0x2d77588] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void OnRep_PlayspaceUsers();                                                                                             // [0x25407d4] Final|RequiredAPI|Native|Protected 
	// Function /Script/PlayspaceSystem.Playspace.OnRep_MatchStartTime
	// void OnRep_MatchStartTime();                                                                                             // [0x3ee4964] RequiredAPI|Native|Protected 
	// Function /Script/PlayspaceSystem.Playspace.OnRep_BoundGameplayVolume
	// void OnRep_BoundGameplayVolume();                                                                                        // [0x7fdecac] Final|Native|Protected 
	// Function /Script/PlayspaceSystem.Playspace.OnRep_bMatchHasEnded
	// void OnRep_bMatchHasEnded();                                                                                             // [0x3e905b4] Final|RequiredAPI|Native|Protected 
	// Function /Script/PlayspaceSystem.Playspace.OnRep_bIsInitialized
	// void OnRep_bIsInitialized();                                                                                             // [0x6dee964] Final|RequiredAPI|Native|Protected 
};
...
public:
	...
	// void OnPlayerPawnSet(class APlayerState* Player, class APawn* NewPawn, class APawn* OldPawn);                            // [0x7fdebac] Final|Native|Protected 
};
...
public:
	...
	// class APlayspace* GetPlayspaceForActor(class UObject* WorldContextObject, class AActor* InActor);                        // [0x3777534] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/PlayspaceSystem.PlayspaceLibrary.DestroyPlayspace
	// void DestroyPlayspace(class APlayspace* PlayspaceToDestroy);                                                             // [0x7fde3c0] Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// void OnRep_MatchStartTime();                                                                                             // [0x3459e2c] Native|Protected     
	// Function /Script/PlayspaceSystem.PlayspaceLogic.OnRep_bMatchHasEnded
	// void OnRep_bMatchHasEnded();                                                                                             // [0x18c0d84] Final|Native|Private 
};
...
public:
	...
	// bool ProcessOverlapEvents(float DeltaTime);                                                                              // [0x7fded30] Final|Native|Private 
	// Function /Script/PlayspaceSystem.PlayspaceManagerComponent.OnRep_RootPlayspace
	// void OnRep_RootPlayspace();                                                                                              // [0x2eb9fd0] Final|Native|Private 
	// Function /Script/PlayspaceSystem.PlayspaceManagerComponent.OnPlayerEndOverlapGameplayVolume
	// void OnPlayerEndOverlapGameplayVolume(class APlayerState* PlayerState, class AGameplayVolume* Volume);                   // [0x7fdeae8] Final|Native|Private 
	// Function /Script/PlayspaceSystem.PlayspaceManagerComponent.OnPlayerBeginOverlapGameplayVolume
	// void OnPlayerBeginOverlapGameplayVolume(class APlayerState* PlayerState, class AGameplayVolume* Volume);                 // [0x7fdea24] Final|Native|Private 
};
