...
public:
	...
	// FString GetSelectedHostName();                                                                                           // [0x862a758] Final|Native|Public|BlueprintCallable 
	// Function /Script/EpicMediaCDNHostnames.EpicMediaCDNHostnames.GetHostnames
	// TArray<FString> GetHostnames();                                                                                          // [0x862a71c] Final|Native|Public|BlueprintCallable 
};
