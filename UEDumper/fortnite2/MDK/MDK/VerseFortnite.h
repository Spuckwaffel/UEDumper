...
public:
	...
	// void HandleActorDamaged(class AActor* DamagedActor, float Damage, class AController* InstigatedBy, class AActor* DamageCauser, FVector HitLocation, class UPrimitiveComponent* FHitComponent, FName BoneName, FVector Momentum); // [0xb2b5e4c] Final|Native|Private|HasDefaults 
};
...
public:
	...
	// void HandlePawnControllerChanged(class APawn* Pawn, class AController* OldController, class AController* NewController); // [0xb2b6438] Final|Native|Private 
};
...
public:
	...
	// void HandlePreInvalidateAbilitySystem();                                                                                 // [0xb2b6694] Final|Native|Private 
	// Function /Script/VerseFortnite.FortPawnAbilityComponentBridgeHelper.HandleAbilitySystemInitialized
	// void HandleAbilitySystemInitialized(class UFortAbilitySystemComponent* AbilitySystemComponent, class AFortPlayerPawn* AffectedPawn); // [0xb2b5d88] Final|Native|Private 
};
...
public:
	...
	// class UNPCCharacterDefinition* GetCharacterDefinition();                                                                 // [0xb2b5470] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/VerseFortnite.NPCCharacterModifier.BP_OnSpawned
	// void BP_OnSpawned(class AFortPawn* Pawn);                                                                                // [0x815a31c] Native|Event|Public|BlueprintEvent 
	// Function /Script/VerseFortnite.NPCCharacterModifier.BP_OnPreSpawned
	// void BP_OnPreSpawned(class AFortPawn* Pawn);                                                                             // [0x76c4fd4] Native|Event|Public|BlueprintEvent 
	// Function /Script/VerseFortnite.NPCCharacterModifier.BP_ModifySpawnComponentList
	// void BP_ModifySpawnComponentList(class UFortAthenaAISpawnerDataComponentList* OutList, class UObject* ComponentOuter);   // [0xb2b3b58] Native|Event|Public|BlueprintEvent 
	// Function /Script/VerseFortnite.NPCCharacterModifier.BP_IsNeededForPreview
	// bool BP_IsNeededForPreview();                                                                                            // [0x3763ef4] Native|Event|Public|BlueprintEvent|Const 
	// Function /Script/VerseFortnite.NPCCharacterModifier.BP_IsDataValid
	// EDataValidationResult BP_IsDataValid(TArray<FText>& OutErrorMessages);                                                   // [0xb2b3aa8] Native|Event|Public|HasOutParms|BlueprintEvent|Const 
};
...
public:
	...
	// void NotifyTargetPerceptionUpdated(class AActor* Actor, FAIStimulus Stimulus);                                           // [0xb2b7b8c] Final|Native|Private 
	// Function /Script/VerseFortnite.AIPerceptionComponentData.NotifyTargetPerceptionForgotten
	// void NotifyTargetPerceptionForgotten(class AActor* Actor);                                                               // [0xb2b7b0c] Final|Native|Private 
};
...
public:
	...
	// void OnActiveTeamArrayBuilt();                                                                                           // [0xb2b7c74] Final|Native|Private 
};
...
public:
	...
	// void OnMinigameSetup(class AFortMinigame* InMinigame);                                                                   // [0xb2b7ffc] Final|Native|Private 
	// Function /Script/VerseFortnite.VerseFortniteMinigameTeamCollection.OnMinigameDestroyed
	// void OnMinigameDestroyed(class AActor* DestroyedMinigame);                                                               // [0xb2b7e64] Final|Native|Private 
};
...
public:
	...
	// void SetNPCBehaviorScript(class UNPCBehaviorScript* InAIBehaviorScript);                                                 // [0xb2b816c] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void OnBotControllerAlertLevelChanged(class AFortAthenaAIBotController* BotController, EAlertLevel OldAlertLevel, EAlertLevel NewAlertLevel); // [0xb2b7d30] Final|Native|Private 
};
...
public:
	...
	// class UNPCBehaviorScript* GetBehaviorScript();                                                                           // [0x7f3a748] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// class ULoadNPCCharacterDefinitionAsync* LoadCharacterDefinitionAsync(class UObject* ContextObj, TWeakObjectPtr<UNPCCharacterDefinition*> CharacterDefinition, TArray<UNPCCharacterModifier*>& AdditionalModifiers); // [0xb2b71a4] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// class ULoadAndCreateComponentListAsync* LoadAndCreateComponentListAsync(class UObject* ContextObj, TWeakObjectPtr<UNPCCharacterDefinition*> CharacterDefinition, TArray<UNPCCharacterModifier*>& AdditionalModifiers, bool bForPreview); // [0xb2b673c] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// void GetRequiredAssets(TArray<FSoftObjectPath>& OutAssets);                                                              // [0xb2b5cc8] Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/VerseFortnite.NPCCharacterDefinition.GetPreviewMesh
	// void GetPreviewMesh(class UObject* Outer, TArray<UNPCCharacterModifier*>& AdditionalModifiers, TArray<FCharacterPreviewMesh>& OutCharacterPreviewMeshes, class APawn*& OutDefaultPawn); // [0xb2b5510] Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/VerseFortnite.NPCCharacterDefinition.GetCharacterCID
	// class UAthenaCharacterItemDefinition* GetCharacterCID(class UObject* Outer, TArray<UNPCCharacterModifier*>& AdditionalModifiers); // [0xb2b4b8c] Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/VerseFortnite.NPCCharacterDefinition.GetCharacterBlueprint
	// class UClass* GetCharacterBlueprint(TArray<UNPCCharacterModifier*>& AdditionalModifiers);                                // [0xb2b44a8] Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/VerseFortnite.NPCCharacterDefinition.CreateComponentList
	// class UFortAthenaAISpawnerDataComponentList* CreateComponentList(class UObject* Outer, TArray<UNPCCharacterModifier*>& AdditionalModifiers, bool bForPreview); // [0xb2b3c20] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void SetNPCCharacterDefinition(TWeakObjectPtr<UNPCCharacterDefinition*> Definition);                                     // [0xb2b81f4] Final|Native|Public|BlueprintCallable 
	// Function /Script/VerseFortnite.NPCCharacterDefinitionComponent.OnNPCCharacterTypeChanged
	// void OnNPCCharacterTypeChanged();                                                                                        // [0x36569a8] Final|Native|Public|BlueprintCallable 
	// Function /Script/VerseFortnite.NPCCharacterDefinitionComponent.GetNPCCharacterModifiers
	// TArray<UNPCCharacterModifier*> GetNPCCharacterModifiers();                                                               // [0xb2b54d8] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/VerseFortnite.NPCCharacterDefinitionComponent.GetNPCCharacterDefinition
	// TWeakObjectPtr<UNPCCharacterDefinition*> GetNPCCharacterDefinition();                                                    // [0xb2b5494] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// TWeakObjectPtr<UAthenaCharacterItemDefinition*> GetCharacterCosmetic();                                                  // [0xb2b542c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// TArray<FNPCCustomEffect> GetCustomEffects();                                                                             // [0x228deb8] Event|Public|BlueprintEvent|Const 
};
...
public:
	...
	// class AFortAthenaPatrolPath* GetPatrolPathToAssign(class AActor* ModifierOwner);                                         // [0x228deb8] Event|Public|BlueprintEvent 
};
...
public:
	...
	// bool IsPlayerCharacterRequired(ECharacterLook CharacterLook);                                                            // [0xb2b66a8] Native|Event|Public|BlueprintEvent|Const 
};
...
public:
	...
	// TArray<FString> GetAvailableAIs();                                                                                       // [0xb2b446c] Final|Native|Protected|Const 
	// Function /Script/VerseFortnite.NPCCharacterType_FromPreset.GetAIToSpawn
	// TWeakObjectPtr<UClass*> GetAIToSpawn();                                                                                  // [0xb2b4428] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void OnActorDestroyed(class AActor* DestroyedActor);                                                                     // [0xb2b7c88] Final|Native|Private 
};
...
public:
	...
	// void HandlePossessedPawnChanged(class APawn* OldPawn, class APawn* NewPawn);                                             // [0xb2b6530] Final|Native|Private 
	// Function /Script/VerseFortnite.VerseFortniteCharacter.HandlePawnEliminated
	// void HandlePawnEliminated(class AFortPlayerPawnAthena* EliminatedPawn);                                                  // [0x76c4fd4] Native|Protected     
};
...
public:
	...
	// void OnMinigameSetup(class AFortMinigame* Minigame);                                                                     // [0xb2b807c] Final|Native|Private 
	// Function /Script/VerseFortnite.VerseFortnitePlayspace.OnMinigamePlayerAdded
	// void OnMinigamePlayerAdded(FUniqueNetIdRepl UniqueNetId, bool bIsLocalPlayer);                                           // [0xb2b7ee0] Final|Native|Private 
};
...
public:
	...
	// void HandleMinigameStateChanged(class AFortMinigame* Minigame, EFortMinigameState NewMinigameState);                     // [0xb2b61e8] Final|Native|Private 
};
