...
public:
	...
	/// Functions
	// Function /FortUILibrary/Blueprints/UIKit_FunctionLibrary.UIKit_FunctionLibrary_C.HexToColor
	// void HexToColor(FString HEX, class UObject* __WorldContext, FLinearColor& LinearColor);                                  // [0x228deb8] Static|Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure 
	// Function /FortUILibrary/Blueprints/UIKit_FunctionLibrary.UIKit_FunctionLibrary_C.FireEventElementInteractedByName
	// void FireEventElementInteractedByName(FString Element Name, class UWidget* WidgetCallingFrom, class UObject* __WorldContext, bool& Success); // [0x228deb8] Static|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /FortUILibrary/Blueprints/UIKit_FunctionLibrary.UIKit_FunctionLibrary_C.InstantTransitionToSelected
	// void InstantTransitionToSelected(class UMaterialInstanceDynamic* Mid, class UObject* __WorldContext);                    // [0x228deb8] Static|Public|BlueprintCallable|BlueprintEvent 
	// Function /FortUILibrary/Blueprints/UIKit_FunctionLibrary.UIKit_FunctionLibrary_C.InstantTransitionToEnabled
	// void InstantTransitionToEnabled(class UMaterialInstanceDynamic* Mid, bool IsSelected, class UObject* __WorldContext);    // [0x228deb8] Static|Public|BlueprintCallable|BlueprintEvent 
	// Function /FortUILibrary/Blueprints/UIKit_FunctionLibrary.UIKit_FunctionLibrary_C.InstantTransitionToDisabled
	// void InstantTransitionToDisabled(class UMaterialInstanceDynamic* Mid, bool IsSelected, class UObject* __WorldContext);   // [0x228deb8] Static|Public|BlueprintCallable|BlueprintEvent 
	// Function /FortUILibrary/Blueprints/UIKit_FunctionLibrary.UIKit_FunctionLibrary_C.TransitionToDeselectedFocused
	// void TransitionToDeselectedFocused(class UMaterialInstanceDynamic* Mid, class UObject* __WorldContext);                  // [0x228deb8] Static|Public|BlueprintCallable|BlueprintEvent 
	// Function /FortUILibrary/Blueprints/UIKit_FunctionLibrary.UIKit_FunctionLibrary_C.TransitionToDeselectedIdle
	// void TransitionToDeselectedIdle(class UMaterialInstanceDynamic* Mid, class UObject* __WorldContext);                     // [0x228deb8] Static|Public|BlueprintCallable|BlueprintEvent 
	// Function /FortUILibrary/Blueprints/UIKit_FunctionLibrary.UIKit_FunctionLibrary_C.SetGridSlotNudge
	// void SetGridSlotNudge(class UWidget* Widget, FVector2D Nudge, class UObject* __WorldContext);                            // [0x228deb8] Static|Public|BlueprintCallable|BlueprintEvent 
	// Function /FortUILibrary/Blueprints/UIKit_FunctionLibrary.UIKit_FunctionLibrary_C.SetGridSlotPadding
	// void SetGridSlotPadding(class UWidget* Widget, FMargin Padding, class UObject* __WorldContext);                          // [0x228deb8] Public|BlueprintCallable|BlueprintEvent 
	// Function /FortUILibrary/Blueprints/UIKit_FunctionLibrary.UIKit_FunctionLibrary_C.SetGridSlotLayer
	// void SetGridSlotLayer(class UWidget* Widget, int32_t Layer, class UObject* __WorldContext);                              // [0x228deb8] Public|BlueprintCallable|BlueprintEvent 
	// Function /FortUILibrary/Blueprints/UIKit_FunctionLibrary.UIKit_FunctionLibrary_C.SetGridSlotAlignment
	// void SetGridSlotAlignment(class UWidget* Widget, TEnumAsByte<EHorizontalAlignment> Horizontal, TEnumAsByte<EVerticalAlignment> Vertical, class UObject* __WorldContext); // [0x228deb8] Public|BlueprintCallable|BlueprintEvent 
	// Function /FortUILibrary/Blueprints/UIKit_FunctionLibrary.UIKit_FunctionLibrary_C.SetGridSlotColumnAndRow
	// void SetGridSlotColumnAndRow(class UWidget* Widget, int32_t Row, int32_t Row Span, int32_t Column, int32_t Column Span, class UObject* __WorldContext); // [0x228deb8] Public|BlueprintCallable|BlueprintEvent 
	// Function /FortUILibrary/Blueprints/UIKit_FunctionLibrary.UIKit_FunctionLibrary_C.RemoveWidget
	// void RemoveWidget(class UWidget* Widget, class UObject* __WorldContext);                                                 // [0x228deb8] Static|Public|BlueprintCallable|BlueprintEvent 
	// Function /FortUILibrary/Blueprints/UIKit_FunctionLibrary.UIKit_FunctionLibrary_C.Copy MID Parameter Overrides
	// void Copy MID Parameter Overrides(class UMaterialInstanceDynamic* Target MID, class UMaterialInstanceDynamic* Source MID, class UObject* __WorldContext); // [0x228deb8] Static|Public|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// void Set Flood Water Level();                                                                                            // [0x228deb8] BlueprintCallable|BlueprintEvent 
	// Function /FortWater/Blueprints/LandscapeWaterInfo.LandscapeWaterInfo_C.ExecuteUbergraph_LandscapeWaterInfo
	// void ExecuteUbergraph_LandscapeWaterInfo(int32_t EntryPoint);                                                            // [0x228deb8] Final                
};
...
public:
	...
	// class UAnimationAsset* Get Spawn Animation();                                                                            // [0x228deb8] Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /Game/Blueprints/Adventures/SpawnTeleporter/BP_TeleportationDrone.BP_TeleportationDrone_C.PlaySpawnAnim
	// void PlaySpawnAnim();                                                                                                    // [0x228deb8] Public|BlueprintCallable|BlueprintEvent 
	...
	// void OnSpawnOutAnimEnded(class UAnimMontage* Montage, bool bInterrupted);                                                // [0x228deb8] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_BP_TeleportationDrone(int32_t EntryPoint);                                                         // [0x228deb8] Final                
};
...
public:
	...
	// void Added Death Audio(class USoundBase* Sound to Spawn);                                                                // [0x228deb8] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Blueprints/Adventures/SpawnTeleporter/BP_VictoryDrone.BP_VictoryDrone_C.Decoy FX Parameters
	// void Decoy FX Parameters(TArray<FParticleSysParam>& Instance Parameters);                                                // [0x228deb8] Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure 
	// Function /Game/Blueprints/Adventures/SpawnTeleporter/BP_VictoryDrone.BP_VictoryDrone_C.NPC FX Parameters
	// void NPC FX Parameters(TArray<FParticleSysParam>& Instance Parameters);                                                  // [0x228deb8] Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure 
	// Function /Game/Blueprints/Adventures/SpawnTeleporter/BP_VictoryDrone.BP_VictoryDrone_C.NotifyTeleportFinishedTriggered
	// void NotifyTeleportFinishedTriggered();                                                                                  // [0x228deb8] Public|BlueprintCallable|BlueprintEvent 
	...
	// void InitDrone();                                                                                                        // [0x228deb8] Public|BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_BP_VictoryDrone(int32_t EntryPoint);                                                               // [0x228deb8] Final                
	...
	// void SpawnOutAnimEndedDispatcher__DelegateSignature(class ABP_VictoryDrone_C* Drone);                                    // [0x228deb8] Public|Delegate|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// void GetBlueprintLogLevel(TEnumAsByte<BlueprintLogLevel>& BlueprintLogLevel);                                            // [0x228deb8] Public|HasOutParms|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// void RequestComponentResource(class UCreativeIslandResourceManagerComponent* ResourceManager, FName ResourceTag, class UActorComponent* Component, FVector WorldLocation, class UObject* __WorldContext); // [0x228deb8] Static|Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Blueprints/MacroLibraries/BuildingFunctionLibrary.BuildingFunctionLibrary_C.SweepAgainstActorTypes
	// void SweepAgainstActorTypes(class AActor* TestActor, FVector StartLocation, FVector EndLocation, double SweepRadius, TArray<TEnumAsByte<EObjectTypeQuery>>& SweepObjectTypes, TArray<UClass*>& ActorClassFilters, class UObject* __WorldContext, bool& Overlapped); // [0x228deb8] Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure 
	// Function /Game/Blueprints/MacroLibraries/BuildingFunctionLibrary.BuildingFunctionLibrary_C.ShouldLogForInstigator
	// void ShouldLogForInstigator(TEnumAsByte<BlueprintLogLevel> Instance Log Level, class UObject* Instigator, class UObject* __WorldContext, bool& Should Log?); // [0x228deb8] Static|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /Game/Blueprints/MacroLibraries/BuildingFunctionLibrary.BuildingFunctionLibrary_C.LogString
	// void LogString(TEnumAsByte<BlueprintLogLevel> Instance Log Level, FString LogString, bool PrintToScreen, class UObject* Instigator, class UObject* __WorldContext); // [0x228deb8] Static|Public|BlueprintCallable|BlueprintEvent 
};

/// Class /Game/Blueprints/Components/StationProps/VendingMachineSpecialActorComponent.VendingMachineSpecialActorComponent_C
/// Size: 0x0000 (0x000490 - 0x000490)
class UVendingMachineSpecialActorComponent_C : public UAthenaSpecialActorComponent
{ 
	friend MDKHandler;
...
/// Class /Game/Blueprints/Components/StationProps/StationPropSpecialActorComponent.StationPropSpecialActorComponent_C
/// Size: 0x0000 (0x000490 - 0x000490)
class UStationPropSpecialActorComponent_C : public UAthenaSpecialActorComponent
{ 
	friend MDKHandler;
	static inline constexpr uint64_t __MDKClassSize = 1168;
