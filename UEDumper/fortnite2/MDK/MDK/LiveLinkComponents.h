...
public:
	...
	// void SetSubjectRepresentation(FLiveLinkSubjectRepresentation InSubjectRepresentation);                                   // [0xd116758] Final|Native|Public|BlueprintCallable 
	// Function /Script/LiveLinkComponents.LiveLinkComponentController.GetSubjectRepresentation
	// FLiveLinkSubjectRepresentation GetSubjectRepresentation();                                                               // [0xd116714] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
