...
public:
	...
	// void UpdateIsCloseToGround();                                                                                            // [0xbd928a4] Final|Native|Protected|BlueprintCallable 
	// Function /Script/HopscotchWeaponsGameplayRuntime.FortGameplayAbility_AppleSunSmall_Passive.UpdateCanCrashpad
	// void UpdateCanCrashpad();                                                                                                // [0xbd92890] Final|Native|Protected|BlueprintCallable 
	// Function /Script/HopscotchWeaponsGameplayRuntime.FortGameplayAbility_AppleSunSmall_Passive.OnPlayerMovementModeChanged
	// void OnPlayerMovementModeChanged(class ACharacter* Character, TEnumAsByte<EMovementMode> PrevMovementMode, char PreviousCustomMode); // [0xbd925a8] Final|Native|Private 
};
