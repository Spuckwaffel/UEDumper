...
public:
	...
	// void ClearOvershieldListenerDelegates(class UGameplayAbility* OwningAbility);                                            // [0xcb5aaf8] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/FortOvershieldHelpers.FortOvershieldHelperComponent.AssignOvershieldListenerDelegates
	// void AssignOvershieldListenerDelegates(class UGameplayAbility* OwningAbility, FFortOvershieldDelegateContainer Delegates); // [0xcb5aa04] Final|Native|Static|Public|BlueprintCallable 
};
