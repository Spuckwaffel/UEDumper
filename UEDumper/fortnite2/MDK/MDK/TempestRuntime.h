...
public:
	...
	// void EndTempestStorm(FString StormName);                                                                                 // [0x964b2f8] Final|BlueprintAuthorityOnly|Exec|Native|Public 
};
...
public:
	...
	// void OnRep_MovementData();                                                                                               // [0xbfe5460] Final|Native|Private|Const 
};
...
public:
	...
	// void OnRep_CurrentStateInfo();                                                                                           // [0xbfe5420] Final|Native|Private 
	// Function /Script/TempestRuntime.TempestStateMachineComponent.GetCurrentStateInfo
	// FTempestStateInfo GetCurrentStateInfo();                                                                                 // [0xbfe53f8] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/TempestRuntime.TempestStateMachineComponent.GetCurrentStateCompletionPercentage
	// float GetCurrentStateCompletionPercentage();                                                                             // [0xbfe53d0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/TempestRuntime.TempestStateMachineComponent.GetCurrentState
	// ETempestState GetCurrentState();                                                                                         // [0xbfe53b8] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/TempestRuntime.TempestStateMachineComponent.ForceDissipate
	// void ForceDissipate(FString InDissipationReason);                                                                        // [0xbfe4cd8] Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
};
