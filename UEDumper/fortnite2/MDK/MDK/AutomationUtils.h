...
public:
	...
	// void TakeGameplayAutomationScreenshot(FString ScreenshotName, float MaxGlobalError, float MaxLocalError, FString MapNameOverride); // [0x89df830] Final|Native|Static|Public|BlueprintCallable 
};
