...
public:
	...
	// void SetProjectileBudgetMesh(class USkeletalMeshComponentBudgeted* ProjectileBudgetMesh);                                // [0x228deb8] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/BP_ProjectileTrajectory.BP_ProjectileTrajectory_C.SetShouldUpdateFromOwner
	// void SetShouldUpdateFromOwner(bool ShouldUpdate, class UObject* Owner);                                                  // [0x228deb8] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/BP_ProjectileTrajectory.BP_ProjectileTrajectory_C.UpdateFromTrajectoryOwner
	// void UpdateFromTrajectoryOwner();                                                                                        // [0x228deb8] Public|BlueprintCallable|BlueprintEvent 
	...
	// void SetTrajectorySpline(TArray<FVector>& SplinePoints, TArray<FVector>& SplineTangents);                                // [0x228deb8] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /Game/BP_ProjectileTrajectory.BP_ProjectileTrajectory_C.SetTrajectoryValid
	// void SetTrajectoryValid(bool bIsTrajectoryValid);                                                                        // [0x228deb8] BlueprintCallable|BlueprintEvent 
	// Function /Game/BP_ProjectileTrajectory.BP_ProjectileTrajectory_C.UpdateTargetMeshVisibility
	// void UpdateTargetMeshVisibility();                                                                                       // [0x228deb8] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_BP_ProjectileTrajectory(int32_t EntryPoint);                                                       // [0x228deb8] Final|HasDefaults    
};
