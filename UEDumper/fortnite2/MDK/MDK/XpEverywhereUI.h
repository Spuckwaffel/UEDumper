...
public:
	...
	// void OpenWidget(class UFortAccoladeItemDefinition* AccoladeDef, int32_t XpValue, FText& DisplayName, TWeakObjectPtr<UTexture2D*>& AccoladeLargePreviewImageOverride, FText& SimulatedName, FText& SimulatedText, EFortSimulatedXPSize SimulatedXpSize); // [0x228deb8] Event|Protected|HasOutParms|BlueprintEvent 
...
public:
	...
	// void OnXpBarUpdated(int32_t ShownXP, int32_t ShownLevel, int32_t NewDesiredXP, int32_t NewDesiredLevel, int32_t NewRemainingRestXP); // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/XpEverywhereUI.XpEverywhereBar.OnXpBarInitialized
	// void OnXpBarInitialized(int32_t CurrentXP, int32_t CurrentLevel, int32_t CurrentRemainingRestXP);                        // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/XpEverywhereUI.XpEverywhereBar.GetTotalXpRequiredForLevel
	// int32_t GetTotalXpRequiredForLevel(int32_t InLevel);                                                                     // [0xca90ce0] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/XpEverywhereUI.XpEverywhereBar.DoneUpdatingXpBar
	// void DoneUpdatingXpBar();                                                                                                // [0xca90cb8] Final|Native|Protected|BlueprintCallable 
};
...
public:
	...
	// void OnShowWidget(int32_t NewLevel);                                                                                     // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/XpEverywhereUI.XpEverywhereLevelUpWidget.DoneLevelingUp
	// void DoneLevelingUp();                                                                                                   // [0xca90c74] Final|Native|Protected|BlueprintCallable 
	// Function /Script/XpEverywhereUI.XpEverywhereLevelUpWidget.DisplayLevelUpRewards
	// void DisplayLevelUpRewards();                                                                                            // [0xca90c2c] Final|Native|Protected|BlueprintCallable|Const 
};
...
public:
	...
	// void UpdateXPSource(FText& NewSourceText);                                                                               // [0x228deb8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/XpEverywhereUI.XpEverywhereReticleWidget.UpdateXPAmount
	// void UpdateXPAmount(int32_t NewAmount, class USoundCue* Cue, EFortSimulatedXPSize SimulatedXpSize);                      // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/XpEverywhereUI.XpEverywhereReticleWidget.UpdateRestXP
	// void UpdateRestXP(int32_t RestXpRemaining);                                                                              // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/XpEverywhereUI.XpEverywhereReticleWidget.HandleProfileUpdated
	// void HandleProfileUpdated();                                                                                             // [0xca90e94] Final|Native|Protected 
	// Function /Script/XpEverywhereUI.XpEverywhereReticleWidget.ForwardEvents
	// void ForwardEvents();                                                                                                    // [0xca90ccc] Final|Native|Protected|BlueprintCallable 
};
...
public:
	...
	// void HandleNotificationUpdateFinished();                                                                                 // [0xca90e80] Final|Native|Protected 
};
...
public:
	...
	// void HandleControllerComponentAdded(class AFortPlayerController* OwnerController, class UFortControllerComponent* AttachedComponent); // [0xca90d6c] Final|Native|Private 
};
