...
public:
	...
	// float TickVisibilityLevel(float DeltaSeconds);                                                                           // [0xbcdb344] Final|Native|Protected|BlueprintCallable 
	// Function /Script/CloakGameplay.FortGameCueNotifyLoop_Cloak.SetModifierEnabled
	// bool SetModifierEnabled(FName& ModifierName, bool bNewEnabled);                                                          // [0xbcdb224] Final|Native|Protected|HasOutParms|BlueprintCallable 
	// Function /Script/CloakGameplay.FortGameCueNotifyLoop_Cloak.SetModifierCanBeEnabled
	// bool SetModifierCanBeEnabled(FName& ModifierName, bool bNewCanBeEnabled);                                                // [0xbcdb104] Final|Native|Protected|HasOutParms|BlueprintCallable 
	// Function /Script/CloakGameplay.FortGameCueNotifyLoop_Cloak.GetCurrentModifierValues
	// bool GetCurrentModifierValues(float& OutVisibilityMultiplier, float& OutVisibilityAddition, FName& ModifierName);        // [0xbcdafd8] Final|Native|Protected|HasOutParms|BlueprintCallable|BlueprintPure|Const 
};
