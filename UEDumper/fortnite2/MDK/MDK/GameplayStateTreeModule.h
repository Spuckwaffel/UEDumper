...
public:
	...
	// void SetStartLogicAutomatically(bool bInStartLogicAutomatically);                                                        // [0x8709418] Final|Native|Public|BlueprintCallable 
	// Function /Script/GameplayStateTreeModule.StateTreeComponent.SendStateTreeEvent
	// void SendStateTreeEvent(FStateTreeEvent& Event);                                                                         // [0x870932c] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/GameplayStateTreeModule.StateTreeComponent.GetStateTreeRunStatus
	// EStateTreeRunStatus GetStateTreeRunStatus();                                                                             // [0x8709308] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
