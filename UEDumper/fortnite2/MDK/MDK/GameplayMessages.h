...
public:
	...
	// void Unregister();                                                                                                       // [0x2e3fdc8] Final|Native|Public|BlueprintCallable 
	// Function /Script/GameplayMessages.AsyncAction_RegisterGameplayMessageReceiver.RegisterGameplayMessageReceiver
	// class UAsyncAction_RegisterGameplayMessageReceiver* RegisterGameplayMessageReceiver(class UObject* WorldContextObject, FEventMessageTag Channel, class UScriptStruct* PayloadType, EGameplayMessageMatchType MatchType, class AActor* ActorContext); // [0x74b7ba8] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/GameplayMessages.AsyncAction_RegisterGameplayMessageReceiver.GetPayload
	// bool GetPayload(int32_t& OutPayload);                                                                                    // [0x74b777c] Final|Native|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// void Multicast_ServerMessageTriggered(FEventMessageTag Channel, FReplicatedMessage MessageData);                         // [0x74b7acc] Final|Net|NetReliableNative|Event|NetMulticast|Private 
};
...
public:
	...
	// void K2_BroadcastMessage(FEventMessageTag Channel, int32_t& Message, bool bSaveToChannel, class AActor* ActorContext);   // [0x74b7950] Final|Native|Protected|HasOutParms|BlueprintCallable 
	// Function /Script/GameplayMessages.GameplayMessageRouter.HasValidSavedMessage
	// bool HasValidSavedMessage(FEventMessageTag Channel);                                                                     // [0x74b7874] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/GameplayMessages.GameplayMessageRouter.ClearSavedMessage
	// void ClearSavedMessage(FEventMessageTag Channel);                                                                        // [0x74b7684] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// FEventMessageTag GetEventMessageTagFromGameplayTag(FGameplayTag InTag);                                                  // [0x74b7704] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
};
