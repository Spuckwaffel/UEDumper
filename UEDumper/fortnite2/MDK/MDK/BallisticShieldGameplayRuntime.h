...
public:
	...
	// void GetBallisticShieldData(EBallisticShieldPlayerActionState& BallisticShieldPlayerState, float& StaggerBuildupPercent); // [0xb60a7ac] Native|Event|Public|HasOutParms|BlueprintEvent 
};
