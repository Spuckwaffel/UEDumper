...
public:
	...
	// void FailedToActivatePassiveAbility(FGameplayAbilityActorInfo ActorInfo);                                                // [0x228deb8] Event|Public|BlueprintEvent 
	...
	// void ExecuteUbergraph_GA_Riding_Creature_Burt_SprintCharge(int32_t EntryPoint);                                          // [0x228deb8] Final|HasDefaults    
};
...
public:
	...
	// void ExecuteUbergraph_GA_Riding_Player_StopRidingOnTriggered(int32_t EntryPoint);                                        // [0x228deb8] Final|HasDefaults    
};
...
public:
	...
	// void PettingTelemetry(class AActor* Owner);                                                                              // [0x228deb8] Public|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Gameplay/General/GA_Riding_Player_Petting.GA_Riding_Player_Petting_C.GetRiderPettingMontage
	// void GetRiderPettingMontage(class UAnimMontage*& RiderPettingMontage);                                                   // [0x228deb8] Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure 
	...
	// void OnCancelled_EBEF9ED74121A25C39ABC2B953D1B3F8();                                                                     // [0x228deb8] BlueprintCallable|BlueprintEvent 
	...
	// void OnInterrupted_EBEF9ED74121A25C39ABC2B953D1B3F8();                                                                   // [0x228deb8] BlueprintCallable|BlueprintEvent 
	...
	// void OnBlendOut_EBEF9ED74121A25C39ABC2B953D1B3F8();                                                                      // [0x228deb8] BlueprintCallable|BlueprintEvent 
	...
	// void OnCompleted_EBEF9ED74121A25C39ABC2B953D1B3F8();                                                                     // [0x228deb8] BlueprintCallable|BlueprintEvent 
	...
	// void Added_DE1C9DFC4A5B4A7B0E203C8095E1CE5D();                                                                           // [0x228deb8] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_GA_Riding_Player_Petting(int32_t EntryPoint);                                                      // [0x228deb8] Final|HasDefaults    
};
...
public:
	...
	// void ExecuteUbergraph_GA_Riding_Player_IsRiding(int32_t EntryPoint);                                                     // [0x228deb8] Final|HasDefaults    
};
...
public:
	...
	// void ExecuteUbergraph_GA_Riding_Creature_IsBeingRidden_Passive(int32_t EntryPoint);                                      // [0x228deb8] Final|HasDefaults    
};
...
public:
	...
	// void ExecuteUbergraph_GA_Riding_Creature_IsBeingRidden(int32_t EntryPoint);                                              // [0x228deb8] Final|HasDefaults    
};
...
public:
	...
	// void ExecuteUbergraph_GA_Riding_Creature_EatToRefuel(int32_t EntryPoint);                                                // [0x228deb8] Final|HasDefaults    
};
...
public:
	...
	// void OnRep_CancelSprintDispatcher();                                                                                     // [0x228deb8] BlueprintCallable|BlueprintEvent 
	...
	// void Added_BA9D24D64958BB04345A3D89BD7617CA();                                                                           // [0x228deb8] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_GA_Riding_Player_Sprint(int32_t EntryPoint);                                                       // [0x228deb8] Final|HasDefaults    
};
