...
public:
	...
	// class USlateRHIPostBufferProcessor* GetSlatePostProcessor(ESlatePostRT InPostBufferBit);                                 // [0x661ca88] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// FSlatePostSettings GetSlatePostSetting(ESlatePostRT InPostBufferBit);                                                    // [0x661cb18] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/SlateRHIRenderer.SlateRHIRendererSettings.GetMutableSlatePostSetting
	// FSlatePostSettings GetMutableSlatePostSetting(ESlatePostRT InPostBufferBit);                                             // [0x661c9ac] Final|Native|Public|BlueprintCallable 
};
