...
public:
	...
	// void SetItemSlotInfo(FFortWeaponModSlot& ModSlot);                                                                       // [0x228deb8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/WeaponModsUI.AthenaEquippedItemInfoWeaponMods.ResetItemInfo
	// void ResetItemInfo();                                                                                                    // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/WeaponModsUI.AthenaEquippedItemInfoWeaponMods.HandleWeaponFullyEquipped
	// void HandleWeaponFullyEquipped(class AFortWeapon* NewWeapon, class AFortWeapon* PrevWeapon);                             // [0xc017688] Final|Native|Private 
};
...
public:
	...
	// void HandleButtonClicked(class UObject* Object);                                                                         // [0xc0172c4] Final|Native|Protected|BlueprintCallable 
	// Function /Script/WeaponModsUI.AthenaInventoryGroupWeaponMods.CanWeaponEquipMod
	// bool CanWeaponEquipMod(class AFortWeapon* Weapon, class UFortWeaponModItemDefinition* Mod);                              // [0xc0171f0] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void UpdateItemMods();                                                                                                   // [0xc0173c4] Final|Native|Protected|BlueprintCallable 
	...
	// void SetIsModifiableWeapon(bool bIsModifiable);                                                                          // [0x228deb8] Event|Protected|BlueprintEvent 
	...
	// void HandleWeaponModSlotsChanged(class AFortWeapon* Weapon);                                                             // [0xc0177a8] Final|Native|Private 
	// Function /Script/WeaponModsUI.AthenaInventoryItemInfoWeaponMods.HandleInventoryPanelOpened
	// void HandleInventoryPanelOpened();                                                                                       // [0xc0173c4] Final|Native|Private 
	// Function /Script/WeaponModsUI.AthenaInventoryItemInfoWeaponMods.HandleInventoryItemSelected
	// void HandleInventoryItemSelected(class UFortItem* SelectedItem);                                                         // [0xc017344] Final|Native|Private 
};
...
public:
	...
	// void RemoveMod(class UFortWeaponModItemDefinition* ModItemDef);                                                          // [0xc017948] Final|Native|Protected|BlueprintCallable 
};
...
public:
	...
	// void SetKillerWeaponMods(TArray<FFortWeaponModSlot>& ModSlots);                                                          // [0x228deb8] Event|Protected|HasOutParms|BlueprintEvent 
};
...
public:
	...
	// void SetItemModifiedWeaponName(FText& ModifiedWeaponName);                                                               // [0x228deb8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/WeaponModsUI.AthenaPickupIndicatorWeaponMods.SetEquippedWeaponItemSlotInfo
	// void SetEquippedWeaponItemSlotInfo(FFortWeaponModSlot& ModSlot);                                                         // [0x228deb8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/WeaponModsUI.AthenaPickupIndicatorWeaponMods.SetEquippedWeaponItemInfo
	// void SetEquippedWeaponItemInfo(class UItemDefinitionBase* ItemDef);                                                      // [0x228deb8] Event|Protected|BlueprintEvent 
	...
	// bool IsInspectViewCollapsedBySettings();                                                                                 // [0xc017900] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/WeaponModsUI.AthenaPickupIndicatorWeaponMods.HandleWeaponEquipped
	// void HandleWeaponEquipped(class AFortWeapon* NewWeapon, class AFortWeapon* PrevWeapon);                                  // [0xc01751c] Final|Native|Protected 
	// Function /Script/WeaponModsUI.AthenaPickupIndicatorWeaponMods.HandlePickupHovered
	// void HandlePickupHovered(class AFortPickup* Pickup);                                                                     // [0xc0173d8] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void UpdateModVisuals(TArray<FFortWeaponModSlot>& ModSlots);                                                             // [0xc017a78] Final|Native|Protected|HasOutParms|BlueprintCallable 
	// Function /Script/WeaponModsUI.AthenaQuickBarSlotWeaponModsIndicator.SetItemSlotsInfo
	// void SetItemSlotsInfo(TArray<FFortWeaponModSlot>& ModSlots);                                                             // [0xc0179dc] Final|Native|Protected|HasOutParms|BlueprintCallable 
	// Function /Script/WeaponModsUI.AthenaQuickBarSlotWeaponModsIndicator.SetItemSlotSelected
	// void SetItemSlotSelected(bool bIsSelected);                                                                              // [0x228deb8] Event|Protected|BlueprintEvent 
	...
	// void ResetItemInfo();                                                                                                    // [0xc0179c8] Final|Native|Protected|BlueprintCallable 
	// Function /Script/WeaponModsUI.AthenaQuickBarSlotWeaponModsIndicator.ResetIconOpacities
	// void ResetIconOpacities();                                                                                               // [0x2ed5920] Final|Native|Protected|BlueprintCallable 
	// Function /Script/WeaponModsUI.AthenaQuickBarSlotWeaponModsIndicator.HandleWeaponModSlotsChanged
	// void HandleWeaponModSlotsChanged(class AFortWeapon* Weapon);                                                             // [0xc017828] Final|Native|Private 
	// Function /Script/WeaponModsUI.AthenaQuickBarSlotWeaponModsIndicator.HandleWeaponFullyEquipped
	// void HandleWeaponFullyEquipped(class AFortWeapon* NewWeapon, class AFortWeapon* PrevWeapon);                             // [0x2ed5b20] Final|Native|Private 
	// Function /Script/WeaponModsUI.AthenaQuickBarSlotWeaponModsIndicator.HandleQuickBarSlotFocusChanged
	// void HandleQuickBarSlotFocusChanged(EFortQuickBars QuickBarType, int32_t QuickBarSlot);                                  // [0xc017458] Final|Native|Private 
};
