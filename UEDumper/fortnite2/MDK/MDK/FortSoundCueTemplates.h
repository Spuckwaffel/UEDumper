...
public:
	...
	// class UFortSoundCueTemplateDefaults* GetSettingsForTemplateType(class UClass* TemplateType);                             // [0xd1fc5f0] Final|Native|Public  
};
...
public:
	...
	// class UFortSoundCueTemplateDefaults* GetDefaultSettingsForTemplateType(class UClass* TemplateType);                      // [0xd1fc530] Final|Native|Public|Const 
};
