...
public:
	CMember(TMap<FGraphVertexHandle, UGraphVertex*>)   Vertices                                                    OFFSET(get<T>, {0x88, 80, 0, 0})
	CMember(TMap<FGraphIslandHandle, UGraphIsland*>)   Islands                                                     OFFSET(get<T>, {0xD8, 80, 0, 0})
};
