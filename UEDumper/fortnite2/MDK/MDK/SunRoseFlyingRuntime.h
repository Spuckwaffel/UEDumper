...
public:
	...
	// void SetFlappingParameters(class UFXSystemComponent* FlyingTrailFX, TArray<UAudioComponent*>& AudioComponents, class AFortPlayerPawn* PlayerPawn, float FlappingAlpha, float RollCombined, float RollingAlpha, float PitchAlpha, bool bIsBoosting, bool bIsAscending, bool bAllowWingFlap, bool bIsSkimming, float Speed, bool bIsDiving, float CurrentHeight); // [0x23cf1cc] Final|Native|Private|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// void ShowWingFX(FVector SkimLocationLeft, FVector SkimNormalLeft, float SkimDistanceLeft, FVector SkimLocationRight, FVector SkimNormalRight, float SkimDistanceRight); // [0x1774160] Final|Native|Public|HasDefaults|BlueprintCallable 
};
...
public:
	...
	// bool UseNativeCalculation();                                                                                             // [0xb6b9864] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void UpdateForRotation(FFortMovementMode_WingedFlyingRuntimeData& MoveStatus, float DeltaTime, FRotator& OutNewMoveOrientation); // [0xb6b9638] Native|Event|Public|HasOutParms|HasDefaults|BlueprintEvent 
	// Function /Script/SunRoseFlyingRuntime.FortMovementMode_ExtLogicFlyingWinged.UpdateForMovement
	// void UpdateForMovement(FFortMovementMode_WingedFlyingRuntimeData& MoveStatus, float DeltaTime, FVector& InVelocity, FVector& InAcceleration, FVector& OutNewVelocity, FVector& OutNewAcceleration, FFortMovementMode_WingedFlyingRuntimeData& OutNewMoveStatus); // [0xb6b9094] Native|Event|Public|HasOutParms|HasDefaults|BlueprintEvent 
	// Function /Script/SunRoseFlyingRuntime.FortMovementMode_ExtLogicFlyingWinged.UpdateForHitResponse
	// void UpdateForHitResponse(FFortMovementMode_WingedFlyingRuntimeData& MoveStatus, float DeltaTime, FVector& InVelocity, FVector& OldPosition, FVector& Adjustment, FHitResult& Hit, EFortMovementModeExt_PhysUpdateResult& OutHitResult, bool& bOutWantToSlide); // [0xb6b8a3c] Native|Event|Public|HasOutParms|HasDefaults|BlueprintEvent 
	// Function /Script/SunRoseFlyingRuntime.FortMovementMode_ExtLogicFlyingWinged.IsClientReplaying
	// bool IsClientReplaying();                                                                                                // [0x384388c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/SunRoseFlyingRuntime.FortMovementMode_ExtLogicFlyingWinged.HandleFlyingStatusChanged
	// void HandleFlyingStatusChanged(FFortMovementMode_WingedFlyingRuntimeData& MoveStatus, EWingedFlyingStatus NewStatus, bool bIsActive, FGameplayTag& FailureTag); // [0x228deb8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/SunRoseFlyingRuntime.FortMovementMode_ExtLogicFlyingWinged.HandleFlyingStatusActivationFailed
	// void HandleFlyingStatusActivationFailed(EWingedFlyingStatus FailedStatus, FGameplayTag& FailureTag);                     // [0x228deb8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/SunRoseFlyingRuntime.FortMovementMode_ExtLogicFlyingWinged.CanStartFlyingStatus
	// void CanStartFlyingStatus(FFortMovementMode_WingedFlyingRuntimeData& MoveStatus, EWingedFlyingStatus StatusToStart, bool& bOutCanStart, FGameplayTag& OutFailureTag); // [0xb6b8794] Native|Event|Protected|HasOutParms|BlueprintEvent|Const 
	// Function /Script/SunRoseFlyingRuntime.FortMovementMode_ExtLogicFlyingWinged.CanEndFlyingStatus
	// bool CanEndFlyingStatus(FFortMovementMode_WingedFlyingRuntimeData& MoveStatus, EWingedFlyingStatus StatusToEnd, float ElapsedDuration); // [0xb6b850c] Native|Event|Protected|HasOutParms|BlueprintEvent|Const 
	// Function /Script/SunRoseFlyingRuntime.FortMovementMode_ExtLogicFlyingWinged.CanContinueFlyingStatus
	// void CanContinueFlyingStatus(FFortMovementMode_WingedFlyingRuntimeData& MoveStatus, EWingedFlyingStatus StatusToContinue, float ElapsedDuration, bool& bOutCanContinue, FGameplayTag& OutFailureTag); // [0xb6b8180] Native|Event|Protected|HasOutParms|BlueprintEvent|Const 
};
...
public:
	...
	// void UpdateCurrentFlyingEnergy(float NewFlyingEnergy, bool bForceUpdateFX);                                              // [0x18381f4] Final|BlueprintCosmetic|Native|Public|BlueprintCallable 
	// Function /Script/SunRoseFlyingRuntime.FortPawnComponent_WingedFlying.StartFlying
	// void StartFlying(FFortMovementMode_WingedFlyingCreationData& CreationData);                                              // [0xb6c3b48] BlueprintCosmetic|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/SunRoseFlyingRuntime.FortPawnComponent_WingedFlying.HandleRightSkimCheckComplete
	// void HandleRightSkimCheckComplete(FHitResult& HitResult);                                                                // [0x228deb8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/SunRoseFlyingRuntime.FortPawnComponent_WingedFlying.HandleOwnerASCInitialized
	// void HandleOwnerASCInitialized(class UFortAbilitySystemComponent* AbilitySystemComponent, class AFortPlayerPawn* AffectedPawn); // [0x251f7d4] Final|Native|Protected 
	// Function /Script/SunRoseFlyingRuntime.FortPawnComponent_WingedFlying.HandleLeftSkimCheckComplete
	// void HandleLeftSkimCheckComplete(FHitResult& HitResult);                                                                 // [0x228deb8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/SunRoseFlyingRuntime.FortPawnComponent_WingedFlying.HandleForwardSpeedUpdated
	// void HandleForwardSpeedUpdated(float NewForwardSpeed);                                                                   // [0x228deb8] Event|Public|BlueprintEvent 
	// Function /Script/SunRoseFlyingRuntime.FortPawnComponent_WingedFlying.HandleFlyingMoveStatusUpdated
	// void HandleFlyingMoveStatusUpdated(FFortMovementMode_WingedFlyingRuntimeData& MoveStatus);                               // [0x1351ed8] Native|Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/SunRoseFlyingRuntime.FortPawnComponent_WingedFlying.HandleAddedDownZVelocityUpdated
	// void HandleAddedDownZVelocityUpdated(float NewAddedDownZVelocity);                                                       // [0x228deb8] Event|Public|BlueprintEvent 
	// Function /Script/SunRoseFlyingRuntime.FortPawnComponent_WingedFlying.GetLocalFlyingMoveActionValue
	// FVector2D GetLocalFlyingMoveActionValue();                                                                               // [0xb6c389c] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/SunRoseFlyingRuntime.FortPawnComponent_WingedFlying.EndFlying
	// void EndFlying();                                                                                                        // [0xb6c32a0] Final|BlueprintCosmetic|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void TryResetADSInput(class AFortWeapon* Weapon);                                                                        // [0xb6c3eac] Final|Native|Protected 
	// Function /Script/SunRoseFlyingRuntime.FortWeaponWings.NativeUpdateEnergyFX
	// void NativeUpdateEnergyFX(bool bForceUpdate);                                                                            // [0xb6c38cc] Final|BlueprintCosmetic|Native|Public|BlueprintCallable 
	// Function /Script/SunRoseFlyingRuntime.FortWeaponWings.HandleWeaponAttachmentChanged
	// void HandleWeaponAttachmentChanged(class AFortWeapon* NewWeapon, class AFortWeapon* PrevWeapon);                         // [0x33d4f7c] Final|Native|Protected 
	// Function /Script/SunRoseFlyingRuntime.FortWeaponWings.HandleSecondaryFirePressed
	// void HandleSecondaryFirePressed(class AFortWeapon* Weapon);                                                              // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/SunRoseFlyingRuntime.FortWeaponWings.HandleDBNOStateChanged
	// void HandleDBNOStateChanged(class AFortPawn* FortPawn, bool bInIsDBNO);                                                  // [0x376c200] Final|Native|Protected 
	// Function /Script/SunRoseFlyingRuntime.FortWeaponWings.BP_ModifyIncomingDamage
	// void BP_ModifyIncomingDamage(float Damage, FGameplayTagContainer& DamageTags, FHitResult& DamageHit, class AController* EventInstigator, class AActor* DamageCauser, float& OutNewDamage); // [0x228deb8] BlueprintAuthorityOnly|Event|Protected|HasOutParms|BlueprintEvent 
};
...
public:
	...
	// void TraceForWorldAndWater(class AActor* PlayerPawn, FVector& TraceStart, FVector& TraceEnd, bool& bIsBlockingHit, FHitResult& ClosestHit); // [0xb6c3c08] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/SunRoseFlyingRuntime.FortWingedFlyingBlueprintLibrary.SetInputActionDisplayContext
	// void SetInputActionDisplayContext(class AFortPawn* PlayerPawn, class UFortInputMappingContext* InputMappingContext);     // [0xb6c394c] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/SunRoseFlyingRuntime.FortWingedFlyingBlueprintLibrary.GetFlyingStatusElapsedTime
	// float GetFlyingStatusElapsedTime(EWingedFlyingStatus FlyingStatus, FFortMovementMode_WingedFlyingRuntimeData& MoveStatus); // [0xb6c37ac] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/SunRoseFlyingRuntime.FortWingedFlyingBlueprintLibrary.GetFlyingDuration
	// float GetFlyingDuration(FFortMovementMode_WingedFlyingRuntimeData& MoveStatus);                                          // [0xb6c3708] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/SunRoseFlyingRuntime.FortWingedFlyingBlueprintLibrary.GetDodgeElapsedTime
	// float GetDodgeElapsedTime(FFortMovementMode_WingedFlyingRuntimeData& MoveStatus);                                        // [0xb6c364c] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/SunRoseFlyingRuntime.FortWingedFlyingBlueprintLibrary.FlyingStatusRemoveFlags
	// void FlyingStatusRemoveFlags(EWingedFlyingStatus Status, int32_t FlagsToRemove, EWingedFlyingStatus& NewStatus);         // [0xb6c354c] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/SunRoseFlyingRuntime.FortWingedFlyingBlueprintLibrary.FlyingStatusHasAnyFlags
	// bool FlyingStatusHasAnyFlags(EWingedFlyingStatus Status, int32_t Flags);                                                 // [0xb6c348c] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/SunRoseFlyingRuntime.FortWingedFlyingBlueprintLibrary.FlyingStatusHasAllFlags
	// bool FlyingStatusHasAllFlags(EWingedFlyingStatus Status, int32_t Flags);                                                 // [0xb6c33c8] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/SunRoseFlyingRuntime.FortWingedFlyingBlueprintLibrary.FlyingStatusAddFlags
	// void FlyingStatusAddFlags(EWingedFlyingStatus Status, int32_t FlagsToAdd, EWingedFlyingStatus& NewStatus);               // [0xb6c32c8] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/SunRoseFlyingRuntime.FortWingedFlyingBlueprintLibrary.ClearInputActionDisplayContext
	// void ClearInputActionDisplayContext(class AFortPawn* PlayerPawn, class UFortInputMappingContext* InputMappingContext);   // [0xb6c3104] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// void UpdateTelegraph();                                                                                                  // [0xb6c3f2c] Final|Native|Public|BlueprintCallable 
	// Function /Script/SunRoseFlyingRuntime.FortGameplayAbility_SunroseWingsCrashBase.EndTelegraph
	// void EndTelegraph();                                                                                                     // [0xb6c32b4] Final|Native|Public|BlueprintCallable 
	// Function /Script/SunRoseFlyingRuntime.FortGameplayAbility_SunroseWingsCrashBase.BeginTelegraph
	// void BeginTelegraph();                                                                                                   // [0xb6c30f0] Final|Native|Public|BlueprintCallable 
};
