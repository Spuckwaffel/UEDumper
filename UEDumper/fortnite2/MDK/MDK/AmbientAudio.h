...
public:
	...
	// void SetPriority(int32_t InPriority);                                                                                    // [0x8710d78] Final|Native|Public|BlueprintCallable 
	// Function /Script/AmbientAudio.AmbientAudioComponent.SetCrossfadeTime
	// void SetCrossfadeTime(float InCrossfadeTime);                                                                            // [0x8710ce4] Final|Native|Public|BlueprintCallable 
	// Function /Script/AmbientAudio.AmbientAudioComponent.SetAmbientAsset
	// void SetAmbientAsset(class UAmbientAudioDataAsset* InAmbientAsset);                                                      // [0x8710c64] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void RemoveGameplayTag(FGameplayTag GameplayTag);                                                                        // [0x2aa97a0] Final|Native|Public|BlueprintCallable 
	// Function /Script/AmbientAudio.AmbientAudioSubsystem.RemoveAmbientEntry
	// void RemoveAmbientEntry(FName AmbientName, float CrossfadeOverride);                                                     // [0x358c650] Final|Native|Public|BlueprintCallable 
	// Function /Script/AmbientAudio.AmbientAudioSubsystem.GetAudioParameterComponent
	// class UAudioParameterComponent* GetAudioParameterComponent();                                                            // [0x8710c20] Final|Native|Public|BlueprintCallable 
	// Function /Script/AmbientAudio.AmbientAudioSubsystem.AddGameplayTag
	// void AddGameplayTag(FGameplayTag GameplayTag);                                                                           // [0x2aa9820] Final|Native|Public|BlueprintCallable 
	// Function /Script/AmbientAudio.AmbientAudioSubsystem.AddAmbientEntry
	// void AddAmbientEntry(FName AmbientName, class UAmbientAudioDataAsset* Asset, int32_t Priority, float CrossfadeTime);     // [0x2aa8f54] Final|Native|Public|BlueprintCallable 
};
