...
public:
	...
	// void SetSocialAvatarTexture(TWeakObjectPtr<UTexture2D*> AvatarTexture);                                                  // [0xb5c51c0] Final|Native|Protected|BlueprintCallable 
	// Function /Script/POIBannerUI.POIBannerToastSocialAvatar.SetSocialAvatar
	// void SetSocialAvatar(class AFortPlayerState* PlayerState);                                                               // [0xb5c5138] Final|Native|Protected|BlueprintCallable 
};
...
public:
	...
	// void OnStompFailed();                                                                                                    // [0x228deb8] Event|Protected|BlueprintEvent 
	...
	// void K2_OnBecomeInactive();                                                                                              // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/POIBannerUI.POIBannerToastWidgetBase.K2_OnBecomeActive
	// void K2_OnBecomeActive();                                                                                                // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/POIBannerUI.POIBannerToastWidgetBase.GetLocationTextFromTag
	// FText GetLocationTextFromTag(FGameplayTag& LocationTag);                                                                 // [0xb5c5000] Final|Native|Protected|HasOutParms|BlueprintCallable|BlueprintPure|Const 
};
