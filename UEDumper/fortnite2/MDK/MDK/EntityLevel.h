...
/// Class /Script/EntityLevel.EntityLevel
...
public:
	CMember(class AEntityLevel*)                       EntityLevel                                                 OFFSET(get<T>, {0x500, 8, 0, 0})
...
public:
	...
	CMember(class AEntityLevel*)                       EntityLevel                                                 OFFSET(get<T>, {0x2A8, 8, 0, 0})
