...
public:
	...
	// void RemoveFromEndGameQueue();                                                                                           // [0x36569a8] Final|Native|Public|BlueprintCallable 
	...
	// bool IsWithinPublishedPlayspace();                                                                                       // [0x30b5aa4] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CRD_GameStreamRuntime.CreativeGameStreamDeviceComponent.Init
	// void Init(class UFortMinigameLogicComponent* InMinigameLogicComponent);                                                  // [0x660baec] Final|Native|Public|BlueprintCallable 
	...
	// void CreativeGameStreamDeviceComponentSignature__DelegateSignature(class UCreativeGameStreamDeviceComponent* CreativeGameStreamDeviceComponent); // [0x228deb8] MulticastDelegate|Public|Delegate 
	// Function /Script/CRD_GameStreamRuntime.CreativeGameStreamDeviceComponent.AddToEndGameQueue
	// void AddToEndGameQueue();                                                                                                // [0x36569a8] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void OnMinigameStateChanged(class AFortMinigame* InMinigame, EFortMinigameState NewMinigameState);                       // [0x905d4b8] Final|Native|Private 
};
