...
public:
	...
	// bool OnRemove(class AActor* MyTarget, FGameplayCueParameters& Parameters);                                               // [0x228deb8] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /Game/GameplayCueNotifies/StWStorm/GCNL_EdgeOfStorm.GCNL_EdgeOfStorm_C.OnExecute
	// bool OnExecute(class AActor* MyTarget, FGameplayCueParameters& Parameters);                                              // [0x228deb8] Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/GameplayCueNotifies/StWStorm/GCNL_EdgeOfStorm.GCNL_EdgeOfStorm_C.OnActive
	// bool OnActive(class AActor* MyTarget, FGameplayCueParameters& Parameters);                                               // [0x228deb8] Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/GameplayCueNotifies/StWStorm/GCNL_EdgeOfStorm.GCNL_EdgeOfStorm_C.Activated
	// void Activated(FVector EdgeOfStorm);                                                                                     // [0x228deb8] BlueprintCallable|BlueprintEvent 
	// Function /Game/GameplayCueNotifies/StWStorm/GCNL_EdgeOfStorm.GCNL_EdgeOfStorm_C.Deactivated
	// void Deactivated();                                                                                                      // [0x228deb8] BlueprintCallable|BlueprintEvent 
	// Function /Game/GameplayCueNotifies/StWStorm/GCNL_EdgeOfStorm.GCNL_EdgeOfStorm_C.ExecuteUbergraph_GCNL_EdgeOfStorm
	// void ExecuteUbergraph_GCNL_EdgeOfStorm(int32_t EntryPoint);                                                              // [0x228deb8] Final|HasDefaults    
};
...
public:
	...
	// void EndVFX();                                                                                                           // [0x228deb8] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/GameplayCueNotifies/Death/EliminationBotVFXInterface.EliminationBotVFXInterface_C.TriggerVFX
	// void TriggerVFX();                                                                                                       // [0x228deb8] Public|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// void Set Additional Niagara Parameter on Drone FX(class UNiagaraComponent* Drone FX);                                    // [0x228deb8] BlueprintCallable|BlueprintEvent 
	// Function /Game/GameplayCueNotifies/Death/GCN_RezIn.GCN_RezIn_C.OnCosmeticPart
	// void OnCosmeticPart(class AFortPlayerPawn* Pawn, class UCustomCharacterPart* Part, class USkeletalMeshComponent* MeshPart, TEnumAsByte<EFortCustomPartType> PartType); // [0x228deb8] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_GCN_RezIn(int32_t EntryPoint);                                                                     // [0x228deb8] Final|HasDefaults    
};
...
public:
	...
	// void Set Timeline Playrates();                                                                                           // [0x228deb8] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/GameplayCueNotifies/Death/GCN_RezOut.GCN_RezOut_C.Dissolve Material Setup
	// void Dissolve Material Setup();                                                                                          // [0x228deb8] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/GameplayCueNotifies/Death/GCN_RezOut.GCN_RezOut_C.Spawn Dissolve VFX
	// void Spawn Dissolve VFX();                                                                                               // [0x228deb8] Public|BlueprintCallable|BlueprintEvent 
	...
	// void Play Elmination AnimMontage();                                                                                      // [0x228deb8] Public|BlueprintCallable|BlueprintEvent 
	...
	// void Set Additional Niagara Parameters on Spawned FX(class UNiagaraComponent* Spawned Death FX);                         // [0x228deb8] BlueprintCallable|BlueprintEvent 
	// Function /Game/GameplayCueNotifies/Death/GCN_RezOut.GCN_RezOut_C.Set Additional Niagara Parameters on Drone FX
	// void Set Additional Niagara Parameters on Drone FX(class UNiagaraComponent* Drone FX);                                   // [0x228deb8] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_GCN_RezOut(int32_t EntryPoint);                                                                    // [0x228deb8] Final|HasDefaults    
};
...
public:
	...
	// void SkeletalMeshSetup(class AFortPlayerPawn* FortPawn);                                                                 // [0x228deb8] Public|BlueprintCallable|BlueprintEvent 
	...
	// void CapsuleFadeTL__FinishedFunc();                                                                                      // [0x228deb8] BlueprintEvent       
	...
	// void CapsuleFadeTL__UpdateFunc();                                                                                        // [0x228deb8] BlueprintEvent       
	...
	// void ExecuteUbergraph_GC_Abilities_Death_FadeCapsule_StW(int32_t EntryPoint);                                            // [0x228deb8] Final|HasDefaults    
};
...
public:
	...
	// void SkeletalMeshSetup(class AFortPlayerPawnAthena* FortPawn);                                                           // [0x228deb8] Public|BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_GC_Abilities_Death_FadeCapsule_Athena(int32_t EntryPoint);                                         // [0x228deb8] Final|HasDefaults    
};
...
public:
	...
	// void ExecuteUbergraph_GCN_RezIn_Frontend(int32_t EntryPoint);                                                            // [0x228deb8] Final|HasDefaults    
};
...
public:
	...
	// void ExecuteUbergraph_GCN_NPC_Interaction_RezOut_Glitch(int32_t EntryPoint);                                             // [0x228deb8] Final|HasDefaults    
};
...
public:
	...
	// void ExecuteUbergraph_GCN_RezOut_NPC(int32_t EntryPoint);                                                                // [0x228deb8] Final                
};
