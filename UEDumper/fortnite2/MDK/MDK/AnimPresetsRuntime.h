...
public:
	...
	// void HandleAnimInstance(class UAnimInstance* Instance);                                                                  // [0x815a31c] Native|Event|Public|BlueprintCallable|BlueprintEvent|Const 
	// Function /Script/AnimPresetsRuntime.AnimPreset.GetPresetClass
	// TWeakObjectPtr<UClass*> GetPresetClass();                                                                                // [0x815a2d4] Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
};
