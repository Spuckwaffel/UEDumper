...
public:
	...
	// void OnRep_SoundAsset();                                                                                                 // [0xb2e5484] Final|Native|Protected 
	// Function /Script/VGameplayRst.AudioComponentBase.OnRep_ActiveSoundInfo
	// void OnRep_ActiveSoundInfo();                                                                                            // [0xb2e529c] Final|Native|Protected 
};
...
public:
	...
	// void OnRep_ActiveStates();                                                                                               // [0xb2e52cc] Final|Native|Private 
};
...
public:
	...
	// void TellServer_ClientLevelUnloaded(class UVerseLevelStreamingComponentBase* LevelStreamingComponent);                   // [0x6deec58] Net|NetReliableNative|Event|Public|NetServer 
	// Function /Script/VGameplayRst.VerseLevelStreamingPlayerControllerRpcComponent.TellServer_ClientLevelLoaded
	// void TellServer_ClientLevelLoaded(class UVerseLevelStreamingComponentBase* LevelStreamingComponent);                     // [0x6fb082c] Net|NetReliableNative|Event|Public|NetServer 
};
...
public:
	...
	// void OnRep_LightComponent();                                                                                             // [0xb2e53bc] Final|Native|Protected 
	// Function /Script/VGameplayRst.VerseLightPropertiesBase.OnRep_LightColor
	// void OnRep_LightColor();                                                                                                 // [0xb2e537c] Final|Native|Protected 
	// Function /Script/VGameplayRst.VerseLightPropertiesBase.OnRep_Intensity
	// void OnRep_Intensity();                                                                                                  // [0xb2e5348] Final|Native|Protected 
};
...
public:
	...
	// void OnRep_AttenuationRadius();                                                                                          // [0xb2e52e0] Final|Native|Protected 
};
...
public:
	...
	// void OnRep_SourceRadius();                                                                                               // [0xb2e54e0] Final|Native|Public  
	// Function /Script/VGameplayRst.VersePointLightProperties.OnRep_SourceLength
	// void OnRep_SourceLength();                                                                                               // [0xb2e54ac] Final|Native|Public  
};
...
public:
	...
	// void OnRep_OuterConeAngle();                                                                                             // [0xb2e5450] Final|Native|Public  
	// Function /Script/VGameplayRst.VerseSpotLightProperties.OnRep_InnerConeAngle
	// void OnRep_InnerConeAngle();                                                                                             // [0xb2e5314] Final|Native|Public  
};
