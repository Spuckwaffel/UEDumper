...
public:
	...
	// void BroadcastTransitionCompleted();                                                                                     // [0x323142c] Native|Protected|BlueprintCallable 
};
...
public:
	...
	// void RemoveScene(class UDynamicUIScene* Scene);                                                                          // [0x8169d50] Final|Native|Public|BlueprintCallable 
	// Function /Script/DynamicUI.DynamicUIDirectorBase.GetOwningLocalPlayerController
	// class APlayerController* GetOwningLocalPlayerController();                                                               // [0x8169b94] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DynamicUI.DynamicUIDirectorBase.GetOwningLocalPlayer
	// class ULocalPlayer* GetOwningLocalPlayer();                                                                              // [0x8169b70] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DynamicUI.DynamicUIDirectorBase.AddScene
	// void AddScene(class UDynamicUIScene* Scene);                                                                             // [0x8168a9c] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void RemoveScenes(TArray<UDynamicUIScene*> Scenes, class APlayerController*& Player);                                    // [0x816a114] Final|Native|Protected|HasOutParms|BlueprintCallable 
	// Function /Script/DynamicUI.DynamicUIManager.RemoveSceneFromFirstLocalPlayer
	// void RemoveSceneFromFirstLocalPlayer(class UDynamicUIScene* Scene);                                                      // [0x8169f94] Final|Native|Protected|BlueprintCallable 
	// Function /Script/DynamicUI.DynamicUIManager.RemoveScene
	// void RemoveScene(class UDynamicUIScene* Scene, class APlayerController*& Player);                                        // [0x8169dd0] Final|Native|Protected|HasOutParms|BlueprintCallable 
	// Function /Script/DynamicUI.DynamicUIManager.IsSceneActiveOnFirstLocalPlayer
	// bool IsSceneActiveOnFirstLocalPlayer(class UDynamicUIScene* Scene);                                                      // [0x8169ca0] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DynamicUI.DynamicUIManager.IsSceneActive
	// bool IsSceneActive(class UDynamicUIScene* Scene, class APlayerController*& Player);                                      // [0x8169bb8] Final|Native|Protected|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DynamicUI.DynamicUIManager.AddSceneToFirstLocalPlayer
	// void AddSceneToFirstLocalPlayer(class UDynamicUIScene* Scene);                                                           // [0x8168fb8] Final|Native|Protected|BlueprintCallable 
	// Function /Script/DynamicUI.DynamicUIManager.AddScenes
	// void AddScenes(TArray<UDynamicUIScene*> Scenes, class APlayerController*& Player);                                       // [0x8169418] Final|Native|Protected|HasOutParms|BlueprintCallable 
	// Function /Script/DynamicUI.DynamicUIManager.AddScene
	// void AddScene(class UDynamicUIScene* Scene, class APlayerController*& Player);                                           // [0x8168b1c] Final|Native|Protected|HasOutParms|BlueprintCallable 
};
