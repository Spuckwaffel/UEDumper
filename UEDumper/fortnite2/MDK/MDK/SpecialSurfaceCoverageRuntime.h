...
public:
	...
	// bool UpdateCoverageMap(class UObject* WorldContextObject, class UTextureRenderTarget2D* SpecialSurfaceRenderTarget, FVector& InTopLeftWorldCoordinate, FVector& InBottomRightWorldCoordinate, float CoverageThreshold, float DebugDrawDuration); // [0xbfd545c] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
};
