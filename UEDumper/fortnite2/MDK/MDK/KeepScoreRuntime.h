...
public:
	...
	// void TryCorrectAmmo();                                                                                                   // [0xbdc9a2c] Final|Native|Public|BlueprintCallable 
	// Function /Script/KeepScoreRuntime.FortWeaponKeepScore.ReloadAmmo
	// void ReloadAmmo();                                                                                                       // [0xbdc9a18] Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
	// Function /Script/KeepScoreRuntime.FortWeaponKeepScore.OnFireFailed__DelegateSignature
	// void OnFireFailed__DelegateSignature();                                                                                  // [0x228deb8] MulticastDelegate|Public|Delegate 
	// Function /Script/KeepScoreRuntime.FortWeaponKeepScore.HandleWeaponFired
	// void HandleWeaponFired(class UFortGameplayAbility* GameplayAbility, FGameplayTagContainer AbilityTags);                  // [0xbdc9918] Final|Native|Public  
	// Function /Script/KeepScoreRuntime.FortWeaponKeepScore.HandleIsFiringTagChange
	// void HandleIsFiringTagChange(FGameplayTag tag, int32_t NewCount);                                                        // [0xbdc9858] Final|Native|Protected 
	// Function /Script/KeepScoreRuntime.FortWeaponKeepScore.ActualFireSingle
	// void ActualFireSingle();                                                                                                 // [0xbdc9844] Final|BlueprintCosmetic|Native|Public|BlueprintCallable 
};
