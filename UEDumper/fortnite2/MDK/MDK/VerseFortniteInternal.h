...
public:
	...
	// void NotifyOfStateChange(FString& State, bool Active);                                                                   // [0xb3af190] Final|Native|Public|HasOutParms 
};
...
public:
	...
	// void OnRep_Settings();                                                                                                   // [0xb3af8f0] Final|Native|Private 
};
...
public:
	...
	// void HandlePlayerPawnPossessed(class APawn* Pawn);                                                                       // [0xb3af110] Final|Native|Public  
	// Function /Script/VerseFortniteInternal.FortPlayspaceComponentHelper.HandlePlayerDied
	// void HandlePlayerDied(class AFortPlayerPawnAthena* FortPlayerPawnAthena);                                                // [0xb3af090] Final|Native|Public  
};
