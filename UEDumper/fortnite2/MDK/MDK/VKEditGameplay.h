...
public:
	...
	// void OnClientActivatedContent(FUniqueNetIdRepl& ClientNetId);                                                            // [0xcb7adac] Final|Native|Private|HasOutParms|Const 
};
...
public:
	...
	// void OnRep_VkEditStatus();                                                                                               // [0xcb7aee8] Final|Native|Protected|Const 
	// Function /Script/VKEditGameplay.PlayspaceComponent_EditConnectionManager.OnRep_EditConnections
	// void OnRep_EditConnections();                                                                                            // [0xcb7ae7c] Final|Native|Protected|Const 
};
