...
public:
	...
	// void OnLocalPlayersTeam(class AActor* TargetActor, class UObject* __WorldContext, bool& Return Value);                   // [0x228deb8] Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure 
};
...
public:
	...
	// void PassParticle_Parameter(double NewParam, bool First_Hit);                                                            // [0x228deb8] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_B_PlayerHealthDamage_CameraLensEffect(int32_t EntryPoint);                                         // [0x228deb8] Final                
};
...
public:
	...
	// void PassParticle_Parameter_Shield(double NewParam);                                                                     // [0x228deb8] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_B_PlayerShieldDamage_CameraLensEffect(int32_t EntryPoint);                                         // [0x228deb8] Final                
};
...
public:
	...
	// void ExecuteUbergraph_B_CameraLens_Boat_Droplets(int32_t EntryPoint);                                                    // [0x228deb8] Final                
};
...
public:
	...
	// FRuntimeFloatCurve GetStrengthCurveForActiveType();                                                                      // [0x228deb8] Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /Game/Effects/Fort_Effects/Camera_Effects/B_SoundIndicator_01.B_SoundIndicator_01_C.GetDefaultTint
	// FLinearColor GetDefaultTint();                                                                                           // [0x228deb8] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Fort_Effects/Camera_Effects/B_SoundIndicator_01.B_SoundIndicator_01_C.GetDefaultIcon
	// class UTexture* GetDefaultIcon();                                                                                        // [0x228deb8] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Fort_Effects/Camera_Effects/B_SoundIndicator_01.B_SoundIndicator_01_C.GetWeaponCurve
	// FRuntimeFloatCurve GetWeaponCurve();                                                                                     // [0x228deb8] Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	...
	// void ExecuteUbergraph_B_SoundIndicator_01(int32_t EntryPoint);                                                           // [0x228deb8] Final                
};
...
public:
	...
	// void SetSpriteScale(double SpriteScale);                                                                                 // [0x228deb8] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Fort_Effects/BluePrints/WeakPointEffect/WeakSpot.WeakSpot_C.SetFXTemplate
	// void SetFXTemplate(class UNiagaraSystem* Niagara, class UParticleSystem* Cascade);                                       // [0x228deb8] Public|BlueprintCallable|BlueprintEvent 
...
public:
	...
	// void RestoreInProgressRes();                                                                                             // [0x228deb8] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	...
	// void Store Original Material for Teleport In();                                                                          // [0x228deb8] Public|BlueprintCallable|BlueprintEvent 
	...
	// void External Mesh Masked Setup(TArray<USkeletalMeshComponent*>& External MEsh Component Array, TArray<UMaterialInstanceDynamic*>& Corrected Mid Array); // [0x228deb8] Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent 
	...
	// void ProcessSpawnInTimeline(double ZHeight, double LightIntensity);                                                      // [0x228deb8] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	...
	// void Make internal mids and append external and intermal mids to mid array();                                            // [0x228deb8] Public|BlueprintCallable|BlueprintEvent 
	...
	// void Make and slave internal meshes();                                                                                   // [0x228deb8] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	...
	// void Spawn  Light();                                                                                                     // [0x228deb8] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	...
	// void Find Bounds();                                                                                                      // [0x228deb8] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	...
	// void initializeExternalSkeletalMeshArray();                                                                              // [0x228deb8] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	...
	// void CharacterSpawnInTimeline__FinishedFunc();                                                                           // [0x228deb8] BlueprintEvent       
	...
	// void CharacterSpawnInTimeline__UpdateFunc();                                                                             // [0x228deb8] BlueprintEvent       
	...
	// void UpdateExternalParameters(TArray<UMaterialInstanceDynamic*>& MID Array, TArray<USkeletalMeshComponent*>& External MEsh Component Array); // [0x228deb8] HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_DuplicateResOutMesh(int32_t EntryPoint);                                                           // [0x228deb8] Final|HasDefaults    
};
...
public:
	...
	// int32_t GetViewDistanceQuality();                                                                                        // [0x228deb8] Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Fort_Effects/Gameplay/Pickups/B_Pickups_Parent.B_Pickups_Parent_C.Setup View Distances
	// void Setup View Distances(int32_t& viewDistanceQuality);                                                                 // [0x228deb8] Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Fort_Effects/Gameplay/Pickups/B_Pickups_Parent.B_Pickups_Parent_C.Mobile Interation Icon Setup
	// void Mobile Interation Icon Setup();                                                                                     // [0x228deb8] Public|BlueprintCallable|BlueprintEvent 
	...
	// void SetActiveBackgroundParticleSystem(bool Active, bool Reset);                                                         // [0x228deb8] Public|BlueprintCallable|BlueprintEvent 
	...
	// void SetHiddenBackgroundVisualComponents(bool Hidden);                                                                   // [0x228deb8] Public|BlueprintCallable|BlueprintEvent 
	...
	// void DestroyBackgroundVisualComponents();                                                                                // [0x228deb8] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Fort_Effects/Gameplay/Pickups/B_Pickups_Parent.B_Pickups_Parent_C.ScaleHologramTimingsForPvP
	// void ScaleHologramTimingsForPvP();                                                                                       // [0x228deb8] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Fort_Effects/Gameplay/Pickups/B_Pickups_Parent.B_Pickups_Parent_C.SetHologramPickedUpParams
	// void SetHologramPickedUpParams(bool Tier 0);                                                                             // [0x228deb8] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Fort_Effects/Gameplay/Pickups/B_Pickups_Parent.B_Pickups_Parent_C.SpawnPickedUpTrailPS
	// void SpawnPickedUpTrailPS();                                                                                             // [0x228deb8] Public|BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_B_Pickups_Parent(int32_t EntryPoint);                                                              // [0x228deb8] Final|HasDefaults    
};
...
public:
	...
	// void initializeSpotlightComponent();                                                                                     // [0x228deb8] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Fort_Effects/Gameplay/Pickups/B_Pickups_Default.B_Pickups_Default_C.AddRareFX
	// void AddRareFX();                                                                                                        // [0x228deb8] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Fort_Effects/Gameplay/Pickups/B_Pickups_Default.B_Pickups_Default_C.Set Initial BKGD Param
	// void Set Initial BKGD Param(class UMaterialInstanceDynamic* Mid);                                                        // [0x228deb8] Public|BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_B_Pickups_Default(int32_t EntryPoint);                                                             // [0x228deb8] Final                
};
...
public:
	...
	// FTransform NewFunction(double Roll, double Scale);                                                                       // [0x228deb8] Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure 
	...
	// void ExecuteUbergraph_FN_RadialForce(int32_t EntryPoint);                                                                // [0x228deb8] Final                
};
...
public:
	...
	// void ExecuteUbergraph_B_CameraLens_SpookyMist_Loop(int32_t EntryPoint);                                                  // [0x228deb8] Final                
};
...
public:
	...
	// void ExecuteUbergraph_B_CameraLens_SpookyMist_End(int32_t EntryPoint);                                                   // [0x228deb8] Final                
};
...
public:
	...
	// void ExecuteUbergraph_B_CameraLens_Splash_Water_Droplets(int32_t EntryPoint);                                            // [0x228deb8] Final                
};
...
public:
	...
	// void ExecuteUbergraph_B_CameraLens_Lava_Bouncing(int32_t EntryPoint);                                                    // [0x228deb8] Final                
};
...
public:
	...
	// bool Received_NotifyTick(class USkeletalMeshComponent* MeshComp, class UAnimSequenceBase* Animation, float FrameDeltaTime, FAnimNotifyEventReference& EventReference); // [0x228deb8] Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|Const 
};
...
public:
	...
	// void ExecuteUbergraph_B_CameraLens_Geyser(int32_t EntryPoint);                                                           // [0x228deb8] Final                
};
...
public:
	...
	// void ExecuteUbergraph_B_CameraLens_Drown_Damage(int32_t EntryPoint);                                                     // [0x228deb8] Final                
};
...
public:
	...
	// void ExecuteUbergraph_B_CameraLens_Shadow_Bomb_Loop(int32_t EntryPoint);                                                 // [0x228deb8] Final                
};
...
public:
	...
	// void ExecuteUbergraph_B_CameraLens_Shadow_Bomb_End(int32_t EntryPoint);                                                  // [0x228deb8] Final                
};
...
public:
	...
	// void ExecuteUbergraph_B_CameraLens_SwimBoost(int32_t EntryPoint);                                                        // [0x228deb8] Final                
};
