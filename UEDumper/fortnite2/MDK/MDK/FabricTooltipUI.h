...
public:
	...
	// void UpdateShowMore();                                                                                                   // [0xc777278] Final|Native|Protected|BlueprintCallable 
	// Function /Script/FabricTooltipUI.FabricTooltipWidget.ToggleShowMore
	// void ToggleShowMore();                                                                                                   // [0xc777228] Native|Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Script/FabricTooltipUI.FabricTooltipWidget.SetShowMore
	// void SetShowMore(bool bShowingMore);                                                                                     // [0xc7771a8] Final|Native|Protected|BlueprintCallable 
	// Function /Script/FabricTooltipUI.FabricTooltipWidget.InitTooltip
	// void InitTooltip(class AActor* TargetedActor, class UPrimitiveComponent* TargetedComponent);                             // [0xc7770e4] Final|Native|Public|BlueprintCallable 
};
