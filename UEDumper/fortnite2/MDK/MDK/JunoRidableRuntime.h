...
public:
	...
	// void NativeAddToCheatManager();                                                                                          // [0x36569a8] Final|Native|Protected|BlueprintCallable 
	// Function /Script/JunoRidableRuntime.JunoRidableCheatManager.JunoStopRidingDelayedResetRiderComponent
	// void JunoStopRidingDelayedResetRiderComponent();                                                                         // [0x36569a8] Final|Native|Protected 
	// Function /Script/JunoRidableRuntime.JunoRidableCheatManager.JunoStopRiding
	// void JunoStopRiding();                                                                                                   // [0x1f763bc] BlueprintAuthorityOnly|Exec|Native|Public 
	// Function /Script/JunoRidableRuntime.JunoRidableCheatManager.JunoStartRiding
	// void JunoStartRiding();                                                                                                  // [0x2e3fdc8] BlueprintAuthorityOnly|Exec|Native|Public 
};
