...
public:
	...
	// void UpdateAudioShape(TArray<APlayerController*>& InLocalControllers);                                                   // [0x8543260] Final|Native|Public|HasOutParms 
	// Function /Script/AudioShapes.AudioShapeComponent.Enable
	// void Enable();                                                                                                           // [0x30b77b0] Native|Protected|BlueprintCallable 
	// Function /Script/AudioShapes.AudioShapeComponent.Disable
	// void Disable();                                                                                                          // [0x14f8d74] Native|Protected|BlueprintCallable 
};
...
public:
	...
	// bool GetIsPlayerInside();                                                                                                // [0x8542cfc] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AudioShapes.AudioShapePrimitiveComponent.GetInsideAudioComponent
	// class UAudioComponent* GetInsideAudioComponent();                                                                        // [0x8542ca8] Final|Native|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/AudioShapes.AudioShapePrimitiveComponent.GetEdgeAudioComponent
	// class UAudioComponent* GetEdgeAudioComponent();                                                                          // [0x8542c54] Final|Native|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// void SetBoxTransform(FTransform& InTransform);                                                                           // [0x8542e68] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
};
...
public:
	...
	// void SetRadius(float InRadius);                                                                                          // [0x8543100] Final|Native|Public|BlueprintCallable 
	// Function /Script/AudioShapes.AudioShapeCylinderComponent.SetHalfHeight
	// void SetHalfHeight(float InHalfHeight);                                                                                  // [0x8543074] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void SetStartPoint(FVector& InStartPoint);                                                                               // [0x854318c] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/AudioShapes.AudioShapeLineComponent.SetEndPoint
	// void SetEndPoint(FVector& InEndPoint);                                                                                   // [0x8542fa0] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
};
...
public:
	...
	// bool UpdatePoint(int32_t InIndex, FVector& InPoint);                                                                     // [0x85432fc] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/AudioShapes.AudioShapeLineListComponent.RemovePoint
	// bool RemovePoint(int32_t InIndex);                                                                                       // [0x8542db8] Final|Native|Public|BlueprintCallable 
	// Function /Script/AudioShapes.AudioShapeLineListComponent.GetPoints
	// void GetPoints(TArray<FVector>& OutPoints);                                                                              // [0x8542d18] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AudioShapes.AudioShapeLineListComponent.AddPoint
	// int32_t AddPoint(FVector& InPoint);                                                                                      // [0x8542b44] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
};
...
public:
	...
	// void SetRadius(float InRadius);                                                                                          // [0x2c9adac] Final|Native|Public|BlueprintCallable 
};
