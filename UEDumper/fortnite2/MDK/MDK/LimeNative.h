...
public:
	...
	// void OnEndPlay(class AActor* Actor, TEnumAsByte<EEndPlayReason> EndPlayReason);                                          // [0xcaa0804] Final|Native|Private 
};
...
public:
	...
	// void HandleEnterVehicle();                                                                                               // [0xcaa0738] Final|Native|Protected 
};
...
public:
	DMember(bool)                                      bPlayerFiredCooldownActive                                  OFFSET(get<bool>, {0x900, 1, 1, 0})
	DMember(bool)                                      bPlayerAimDownSights                                        OFFSET(get<bool>, {0x900, 1, 1, 1})
};
...
public:
	...
	// void OnRep_CurrentMoodState();                                                                                           // [0xcaa08c8] Final|Native|Private 
	// Function /Script/LimeNative.LimePawnComponentMood.GetCurrentMoodState
	// FLimeMoodStateData GetCurrentMoodState();                                                                                // [0x91904bc] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void SetEmotionalState(FLimeEmotionalStateData Emotion);                                                                 // [0xcaa0904] Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
	// Function /Script/LimeNative.LimePawnComponent_EmotionalState.SetCurrentEmotionalState
	// void SetCurrentEmotionalState(ELimePawnEmotionalState NewEmotion);                                                       // [0xc6dbe6c] Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
	// Function /Script/LimeNative.LimePawnComponent_EmotionalState.ResetToDefaultEmotionalState
	// void ResetToDefaultEmotionalState();                                                                                     // [0xcaa08f0] Final|Native|Private 
	// Function /Script/LimeNative.LimePawnComponent_EmotionalState.OnRep_TargetEmotionalState
	// void OnRep_TargetEmotionalState();                                                                                       // [0xcaa08dc] Final|Native|Private 
	...
	// void HandleLimeAwesomeLevelChanged(int32_t NewAwesomeLevel);                                                             // [0xcaa074c] Final|Native|Private 
	...
	// ELimePawnEmotionalState GetCurrentEmotionalState();                                                                      // [0x944b7fc] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
