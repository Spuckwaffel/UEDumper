...
public:
	...
	// void HandleVideoTerminalError(EBaseMediaTerminalErrorReason Reason);                                                     // [0xbc74190] Final|Native|Private 
	// Function /Script/BattleRoyaleFrontend.BattleRoyaleFrontendExperienceFlow.HandleSeasonTrailerEnded
	// void HandleSeasonTrailerEnded();                                                                                         // [0xbc7417c] Final|Native|Private 
	// Function /Script/BattleRoyaleFrontend.BattleRoyaleFrontendExperienceFlow.FinishTrailerStep
	// void FinishTrailerStep();                                                                                                // [0xbc74168] Final|Native|Private 
};
