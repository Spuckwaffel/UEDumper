...
public:
	...
	// void SetEventRouter(class UGameplayEventRouterComponent* EventRouter);                                                   // [0x228deb8] Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDebugWidget.LogToScreen
	// void LogToScreen(FString Data, ESparksCameraLogType Type);                                                               // [0x228deb8] Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDebugWidget.ClearCurrent
	// void ClearCurrent();                                                                                                     // [0x228deb8] Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDebugWidget.ClearAll
	// void ClearAll();                                                                                                         // [0x228deb8] Event|Public|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// void StartIntermissionCameras(float ForceLengthMS, bool bForceReloadNewSequence, bool bForceShotChange);                 // [0xb84da20] Final|Native|Public  
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorComponent.Reset
	// void Reset(bool bForceShotChange);                                                                                       // [0xb84d0c0] Final|Native|Public|BlueprintCallable 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorComponent.ReplaceWithNonCloseupShot
	// void ReplaceWithNonCloseupShot(FSparksCameraDirectorSequenceEntry& OldEntry);                                            // [0xb84cfb8] Final|Native|Protected|HasOutParms 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorComponent.PlayShot
	// float PlayShot(FSparksCameraDirectorSequenceEntry& Entry);                                                               // [0xb84ce98] Final|Native|Protected|HasOutParms 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorComponent.PlaySequenceEntry
	// void PlaySequenceEntry(FSparksCameraDirectorSequenceEntry& Entry, float MsOffset, bool bIntermission, class AActor* ForceTarget); // [0xb84cacc] Final|Native|Protected|HasOutParms 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorComponent.PlayNextShot
	// void PlayNextShot(float StartTimeOffset);                                                                                // [0xb84ca4c] Final|Native|Protected 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorComponent.OnShotFinished
	// void OnShotFinished();                                                                                                   // [0xb84ca38] Final|Native|Protected 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorComponent.LogToScreen
	// void LogToScreen(FString Data, ESparksCameraLogType Type, float TimeSeconds);                                            // [0xb84c234] Final|Native|Protected 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorComponent.InsertSequence
	// void InsertSequence(FSparksCameraDirectorSequence& Sequence);                                                            // [0xb84b910] Final|Native|Protected|HasOutParms|BlueprintCallable 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorComponent.InsertPerformanceMap
	// void InsertPerformanceMap(class USparksPerformanceMap* Map);                                                             // [0xb84b890] Final|Native|Public|BlueprintCallable 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorComponent.InitDynamicCameras
	// void InitDynamicCameras();                                                                                               // [0xb84b87c] Final|Native|Protected 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorComponent.HandleIntermissionTagsEvent
	// void HandleIntermissionTagsEvent(FSparksCommonIntermissionCameraDirectorEvent& Payload);                                 // [0xb84b548] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorComponent.HandleForceIntermissionEvent
	// void HandleForceIntermissionEvent(FSparksCommonForceIntermissionCameraDirectorEvent& Payload);                           // [0xb84b490] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorComponent.HandleDirectorDynamicEvent
	// void HandleDirectorDynamicEvent(FSparksCommonDynamicCameraDirectorEvent& Payload);                                       // [0xb84b3b8] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorComponent.GetCameraActive
	// bool GetCameraActive();                                                                                                  // [0x863750c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorComponent.FindStartTimeForNextShotInSequenceMS
	// float FindStartTimeForNextShotInSequenceMS(float TimeToTest);                                                            // [0xb8484bc] Final|Native|Protected 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorComponent.FindCurrentShot
	// bool FindCurrentShot(int32_t& SequenceIndex, int32_t& EntryIndex, float StartTimeIn);                                    // [0xb8482e0] Final|Native|Protected|HasOutParms 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorComponent.DebugLockSpecificCameraShot
	// void DebugLockSpecificCameraShot(FSparksCameraShot Shot, bool bLockToFirstFrame, class AActor* Target);                  // [0xb8480c8] Net|NetReliableNative|Event|NetMulticast|Protected|BlueprintCallable 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorComponent.ActivateCameraControl
	// void ActivateCameraControl(bool bActive);                                                                                // [0xb847a04] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// bool ShouldUseShot(class ULevelSequence* Shot, float AtTimestamp);                                                       // [0xb84d49c] Final|Native|Public|BlueprintCallable 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorConfig.ResetCache
	// void ResetCache();                                                                                                       // [0xb84d140] Final|Native|Public|BlueprintCallable 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorConfig.MarkShotTime
	// void MarkShotTime(class ULevelSequence* Shot, float AtTimestamp);                                                        // [0xb84c974] Final|Native|Public|BlueprintCallable 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorConfig.Init
	// void Init();                                                                                                             // [0xb84b600] Final|Native|Public  
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorConfig.GenerateSequence
	// bool GenerateSequence(FSparksPerformanceMapSection& Section, FSparksCameraDirectorSequence& OutSequence);                // [0xb848dec] Native|Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorConfig.GenerateEntry
	// bool GenerateEntry(FSparksPerformanceMapSection& Section, FSparksCameraDirectorSequenceEntry& OutEntry);                 // [0xb848560] Native|Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorConfig.FindBestGenerator
	// class USparksCameraDirectorSequenceGenerator* FindBestGenerator(FSparksPerformanceMapSection& Section);                  // [0xb84822c] Final|Native|Protected|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// bool GetValidTimestamp(float DesiredTimestampMS, float& OutTimestampMSHigh, float& OutTimestampMSLow);                   // [0xb84b294] Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraPluginDataProvider.GetTargetRelevantTags
	// bool GetTargetRelevantTags(class AActor* Target, FSparksCameraFilter& TagsOut);                                          // [0xb84b17c] Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraPluginDataProvider.GetTargetForCloseup
	// class AActor* GetTargetForCloseup(float ShotTimeMS, FGameplayTagContainer& TagsOut, bool bPreferLocal);                  // [0xb84afec] Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraPluginDataProvider.GetStaticShotCount
	// int32_t GetStaticShotCount();                                                                                            // [0xb84a234] Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraPluginDataProvider.GetStaticShot
	// bool GetStaticShot(int32_t Index, FSparksCameraShot& OutShot);                                                           // [0xb84a108] Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraPluginDataProvider.GetMatchingCameraTarget
	// class AActor* GetMatchingCameraTarget(FGameplayTagContainer& Tags, float ShotTimeMS, bool bPreferLocal);                 // [0xb849dd8] Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraPluginDataProvider.GetCurrentMSTimeInCameraEvent
	// float GetCurrentMSTimeInCameraEvent();                                                                                   // [0x6b08150] Native|Public|BlueprintCallable 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraPluginDataProvider.GetAllTargets
	// TArray<AActor*> GetAllTargets();                                                                                         // [0xb849d78] Native|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// bool Reset();                                                                                                            // [0x3763ef4] Native|Event|Public|BlueprintEvent 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraShotSelectRuleBase.Init
	// bool Init(class USparksCameraShotPool* InPool);                                                                          // [0xa5a2fc0] Native|Event|Public|BlueprintEvent 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraShotSelectRuleBase.GetShotCount
	// int32_t GetShotCount();                                                                                                  // [0xb84a0f0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraShotSelectRuleBase.ChooseShot
	// bool ChooseShot(FSparksPerformanceMapSection& Section, FSparksCameraDirectorSequenceEntry& OutShot);                     // [0xb847f34] Native|Event|Public|HasOutParms|BlueprintEvent 
};
...
public:
	...
	// bool Init(FSparksCameraSectionWrapper& Section);                                                                         // [0xb84b7c4] Native|Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraPoolSelectRuleBase.GetShotCount
	// int32_t GetShotCount();                                                                                                  // [0xb84a0cc] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraPoolSelectRuleBase.GetPoolCount
	// int32_t GetPoolCount();                                                                                                  // [0x8db8120] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	...
	// bool ChooseIntroShot(FSparksPerformanceMapSection& Section, FSparksCameraDirectorSequenceEntry& OutShot);                // [0xb847da0] Native|Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraPoolSelectRuleBase.ChooseExitShot
	// bool ChooseExitShot(FSparksPerformanceMapSection& Section, FSparksCameraDirectorSequenceEntry& OutShot);                 // [0xb847c0c] Native|Event|Public|HasOutParms|BlueprintEvent 
};
...
public:
	...
	// bool Reset();                                                                                                            // [0x6993b3c] Native|Event|Public|BlueprintEvent 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorSequenceGenerator.Init
	// bool Init(FSparksCameraSectionWrapper& InPool, class USparksCameraDirectorConfig* Config);                               // [0xb84b614] Native|Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorSequenceGenerator.GetFilter
	// FSparksCameraFilter GetFilter();                                                                                         // [0xb849dbc] Final|Native|Public|BlueprintCallable 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorSequenceGenerator.GenerateSequence
	// ESparksSectionGeneratorResult GenerateSequence(FSparksPerformanceMapSection& Section, class USparksCameraPluginDataProvider* DataProvider, FSparksCameraDirectorSequence& OutSequence); // [0xb849550] Native|Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorSequenceGenerator.GenerateIntroEntry
	// ESparksSectionGeneratorResult GenerateIntroEntry(FSparksPerformanceMapSection& Section, class USparksCameraPluginDataProvider* DataProvider, FSparksCameraDirectorSequenceEntry& OutEntry); // [0xb848b98] Native|Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorSequenceGenerator.GenerateExitEntry
	// ESparksSectionGeneratorResult GenerateExitEntry(FSparksPerformanceMapSection& Section, class USparksCameraPluginDataProvider* DataProvider, FSparksCameraDirectorSequenceEntry& OutEntry); // [0xb848944] Native|Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorSequenceGenerator.GenerateEntry
	// ESparksSectionGeneratorResult GenerateEntry(FSparksPerformanceMapSection& Section, class USparksCameraPluginDataProvider* DataProvider, FSparksCameraDirectorSequenceEntry& OutEntry); // [0xb8486f0] Native|Event|Public|HasOutParms|BlueprintEvent 
};
...
public:
	...
	// ESparksFilterResult ScoreTagsAgainstFilter(FSparksCameraFilter& Filter, FGameplayTagContainer& TagsToMatch, float& OutScore); // [0xb84d294] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/SparksCameraDirectorRuntime.SparksCamera_BPFL.ScoreTagContainers
	// float ScoreTagContainers(FGameplayTagContainer& Tags1, FGameplayTagContainer& Tags2);                                    // [0xb84d154] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/SparksCameraDirectorRuntime.SparksCamera_BPFL.GetTagForMidiEventName
	// FGameplayTag GetTagForMidiEventName(FString EventString);                                                                // [0xb84a924] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/SparksCameraDirectorRuntime.SparksCamera_BPFL.GetSubTagForMidiEventName
	// FGameplayTag GetSubTagForMidiEventName(FString EventString);                                                             // [0xb84a25c] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// int32_t InsertTimeline(class USparksPerformanceMap* Map, int32_t& OutFirstIndex, int32_t& OutLastIndex, bool bOverwrite); // [0xb84c010] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/SparksCameraDirectorRuntime.SparksPerformanceMap.GetSectionIndexAtTime
	// int32_t GetSectionIndexAtTime(float TimeMS);                                                                             // [0xb84a03c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/SparksCameraDirectorRuntime.SparksPerformanceMap.GetNextSectionIndexAtTime
	// int32_t GetNextSectionIndexAtTime(float TimeMS);                                                                         // [0xb849fa8] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/SparksCameraDirectorRuntime.SparksPerformanceMap.FixupSectionTimeLengths
	// void FixupSectionTimeLengths();                                                                                          // [0xb84854c] Final|Native|Public|BlueprintCallable 
	// Function /Script/SparksCameraDirectorRuntime.SparksPerformanceMap.AddSection
	// void AddSection(float StartMS, FGameplayTag& PrimaryTag, FGameplayTagContainer& SecondaryTags);                          // [0xb847a84] Final|Native|Public|HasOutParms|BlueprintCallable 
};
