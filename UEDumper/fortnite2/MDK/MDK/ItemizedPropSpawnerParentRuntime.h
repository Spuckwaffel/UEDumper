...
public:
	...
	// void HandleAbilityRejectedOnClient(class AFortWeapon* SourceWeapon);                                                     // [0x228deb8] Event|Public|BlueprintEvent 
};

/// Class /Script/ItemizedPropSpawnerParentRuntime.FortWeaponRangedPropSpawner
/// Size: 0x0008 (0x001D58 - 0x001D60)
...
public:
	DMember(bool)                                      bForceSyncAmmoForLocalPropSpawnerWeapon                     OFFSET(get<bool>, {0x1D58, 1, 0, 0})
};
...
public:
	DMember(bool)                                      bIsUpperBody                                                OFFSET(get<bool>, {0x1388, 1, 0, 0})
	DMember(bool)                                      bGrindRail                                                  OFFSET(get<bool>, {0x1389, 1, 0, 0})
	DMember(bool)                                      bIsIceFireToSprint                                          OFFSET(get<bool>, {0x138A, 1, 0, 0})
	DMember(bool)                                      bIsIceFireToIdle                                            OFFSET(get<bool>, {0x138B, 1, 0, 0})
	DMember(bool)                                      bIsIceFireFallStart                                         OFFSET(get<bool>, {0x138C, 1, 0, 0})
	DMember(bool)                                      bIsIceFireFallEnd                                           OFFSET(get<bool>, {0x138D, 1, 0, 0})
	DMember(bool)                                      bIsIceFireFullBodyGround                                    OFFSET(get<bool>, {0x138E, 1, 0, 0})
	DMember(bool)                                      bIsIceFire                                                  OFFSET(get<bool>, {0x138F, 1, 0, 0})
	DMember(bool)                                      bIsIceFireUpperBody                                         OFFSET(get<bool>, {0x1390, 1, 0, 0})
	DMember(bool)                                      bIsFromIceFireEndStates                                     OFFSET(get<bool>, {0x1391, 1, 0, 0})
	DMember(bool)                                      bIsTrFromFireEndIdle                                        OFFSET(get<bool>, {0x1392, 1, 0, 0})
	DMember(bool)                                      bIsTrFromFireEndLoco                                        OFFSET(get<bool>, {0x1393, 1, 0, 0})
	DMember(bool)                                      bIsFireExitUnexpectedly                                     OFFSET(get<bool>, {0x1394, 1, 0, 0})
	DMember(bool)                                      bIsFireEndExitUnexpectedly                                  OFFSET(get<bool>, {0x1395, 1, 0, 0})
	SMember(FRotator)                                  UpperBodyTwistRotator                                       OFFSET(getStruct<T>, {0x1398, 24, 0, 0})
	DMember(float)                                     TurnEndThreshold                                            OFFSET(get<float>, {0x13B0, 4, 0, 0})
	DMember(float)                                     TurnEndLocoThreshold                                        OFFSET(get<float>, {0x13B4, 4, 0, 0})
	DMember(float)                                     PawnVelocityZThreshold                                      OFFSET(get<float>, {0x13B8, 4, 0, 0})
	DMember(float)                                     InterruptibleThreshold                                      OFFSET(get<float>, {0x13BC, 4, 0, 0})
};
...
public:
	...
	// bool NativeShouldDestroyOverlappedActor(class AActor* Actor, FGameplayTagContainer& TagsToDestroyOverlappedActor);       // [0xbdc2564] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/ItemizedPropSpawnerParentRuntime.EmeraldGlassIceWallChunk.NativeShouldActorBlockSpawn
	// bool NativeShouldActorBlockSpawn(class AActor* Actor, bool bShouldLaunch, FGameplayTag& BlockTag);                       // [0xbdc2410] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/ItemizedPropSpawnerParentRuntime.EmeraldGlassIceWallChunk.NativeCheckOverlappedActor
	// void NativeCheckOverlappedActor(FSereneYardOverlappedActorCheckData& CheckData, class AActor* OverlappedActor, TArray<UCapsuleComponent*>& InOutComponentsSetToIgnoreCollision, bool& bInOutShouldPlayImpulseCue, bool& bOutDestroyOverlappedActor, bool& bOutShouldWaitATick, bool& bOutDestroyProp); // [0xbdc13fc] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/ItemizedPropSpawnerParentRuntime.EmeraldGlassIceWallChunk.IsIceWallAllowedToOverlapActor
	// bool IsIceWallAllowedToOverlapActor(class AActor* Actor);                                                                // [0xbdc132c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ItemizedPropSpawnerParentRuntime.EmeraldGlassIceWallChunk.GetComponentsForOverlapCheck
	// void GetComponentsForOverlapCheck(TArray<UPrimitiveComponent*>& OutComponents);                                          // [0x228deb8] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure 
	// Function /Script/ItemizedPropSpawnerParentRuntime.EmeraldGlassIceWallChunk.FindSupportingActors
	// void FindSupportingActors(TArray<AActor*>& InOutSupportingActors, bool bAllowIceWallsAsSupportingActors, TArray<AEmeraldGlassIceWallChunk*>& ChunksInMyWall); // [0xbdc0b1c] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/ItemizedPropSpawnerParentRuntime.EmeraldGlassIceWallChunk.AttachActors
	// void AttachActors(TArray<AEmeraldGlassIceWallChunk*>& ChunksInMyWall, TArray<AActor*>& SupportingActors, class AActor* DirectBase); // [0xbdbfaf8] Final|Native|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// void RemoveOldestTrackedInstance();                                                                                      // [0xbdc2900] Final|Native|Public|BlueprintCallable 
	// Function /Script/ItemizedPropSpawnerParentRuntime.FortControllerComponent_SereneYard.GetTrackedInstanceCount
	// int32_t GetTrackedInstanceCount();                                                                                       // [0x666bdd0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ItemizedPropSpawnerParentRuntime.FortControllerComponent_SereneYard.GetOldestTrackedInstance
	// class ABuildingGameplayActor* GetOldestTrackedInstance();                                                                // [0xbdc12f4] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ItemizedPropSpawnerParentRuntime.FortControllerComponent_SereneYard.AddTrackedInstance
	// void AddTrackedInstance(class ABuildingGameplayActor* TrackedInstance);                                                  // [0xbdbf9c8] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// bool NativeUpdateTarget(FSereneYardWeaponData& WeaponData, FVector& outTargetLocation, ESereneYardTargetingFailedReason& OutFailureReason, TArray<bool>& OutValidity); // [0xbdc268c] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/ItemizedPropSpawnerParentRuntime.SereneYardFunctionLibraryNative.NativeCheckSpawnValidity
	// bool NativeCheckSpawnValidity(FSereneYardWeaponData& WeaponData, FVector& InOutTargetLocation, float CameraYaw, bool bCheckForAllChunks, TArray<bool>& OutValidity, TArray<double>& OutOffsets, TArray<AActor*>& OutActorsBeingUsedAsBase, ESereneYardTargetingFailedReason& OutFailureReason); // [0xbdc1f00] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/ItemizedPropSpawnerParentRuntime.SereneYardFunctionLibraryNative.BuildPropDataForWeaponData
	// void BuildPropDataForWeaponData(TArray<FNativeItemizedPropSpawner_PropSpawnData>& PropSpawnDataArray, TArray<FTransform>& PropRelativeTransforms, TMap<ESereneYardChunkLocation, int32_t>& ChunkLocationToPropIndexMap); // [0xbdc0358] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
};
