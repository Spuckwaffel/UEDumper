...
public:
	...
	// void HandleTrailerTerminalError(EBaseMediaTerminalErrorReason Reason);                                                   // [0xce0b774] Final|Native|Private 
	// Function /Script/JunoFrontendUI.JunoFrontendExperienceFlow.HandleFinishTrailerStep
	// void HandleFinishTrailerStep();                                                                                          // [0xce0b760] Final|Native|Private 
};
...
public:
	...
	// void StartMatchmakingInModeratorMode(FString InWorldId);                                                                 // [0xce0b920] Final|Native|Public|BlueprintCallable 
	// Function /Script/JunoFrontendUI.JunoWorldManagementViewModel.RemoveSelectedWorldFromList
	// void RemoveSelectedWorldFromList();                                                                                      // [0xce0b90c] Final|Native|Public|BlueprintCallable 
	// Function /Script/JunoFrontendUI.JunoWorldManagementViewModel.InitWorldData
	// class UJunoWorldDataViewModel* InitWorldData(TWeakObjectPtr<UDataTable*>& InSettingDataTable, TWeakObjectPtr<UDataTable*>& InWorldImageDataTable); // [0xce0b7f0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/JunoFrontendUI.JunoWorldManagementViewModel.GetIsCreateFlowSelected
	// bool GetIsCreateFlowSelected();                                                                                          // [0xce0b718] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoFrontendUI.JunoWorldManagementViewModel.FetchWorldData
	// void FetchWorldData();                                                                                                   // [0xce0b704] Final|Native|Public|BlueprintCallable 
	// Function /Script/JunoFrontendUI.JunoWorldManagementViewModel.EnableDataRefresh
	// void EnableDataRefresh();                                                                                                // [0xce0b6f0] Final|Native|Public|BlueprintCallable 
	// Function /Script/JunoFrontendUI.JunoWorldManagementViewModel.DisableDataRefresh
	// void DisableDataRefresh();                                                                                               // [0xce0b6dc] Final|Native|Public|BlueprintCallable 
};
