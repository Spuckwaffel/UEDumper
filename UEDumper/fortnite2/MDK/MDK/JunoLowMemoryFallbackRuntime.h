...
public:
	...
	// void OnRep_TriggeredStrategies();                                                                                        // [0xcd84b6c] Final|Native|Private 
};
...
public:
	...
	// void Server_UntriggerStrategy(class UClass* StrategyClass);                                                              // [0xcd84c1c] Net|NetReliableNative|Event|Public|NetServer 
	// Function /Script/JunoLowMemoryFallbackRuntime.JunoLowMemoryFallbackPlayerControllerComponent.Server_TriggerStrategy
	// void Server_TriggerStrategy(class UClass* StrategyClass);                                                                // [0xcd84b80] Net|NetReliableNative|Event|Public|NetServer 
};
