...
public:
	...
	// void SetSidewaysState(ESidewaysState SidewaysState);                                                                     // [0x8ac99fc] Final|BlueprintAuthorityOnly|Exec|Native|Public 
};
...
public:
	...
	// void SetSidewaysState(ESidewaysState NewState, class ASidewaysPlayspace* NewSidewaysPlayspace);                          // [0xbc8b444] Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
	// Function /Script/SidewaysCodeRuntime.SidewaysStateComponent.OnRep_SidewaysState
	// void OnRep_SidewaysState(ESidewaysState LastSidewaysState);                                                              // [0xbc8b354] Final|Native|Protected 
	// Function /Script/SidewaysCodeRuntime.SidewaysStateComponent.OnRep_SidewaysPlayspace
	// void OnRep_SidewaysPlayspace(class ASidewaysPlayspace* NewSidewaysPlayspace);                                            // [0x6deec58] Final|Native|Protected 
	// Function /Script/SidewaysCodeRuntime.SidewaysStateComponent.HandleSidewaysStateChanged
	// void HandleSidewaysStateChanged(class ASidewaysPlayspace* NewSidewaysPlayspace, ESidewaysState OldState, ESidewaysState NewState); // [0x228deb8] Event|Protected|BlueprintEvent 
	// Function /Script/SidewaysCodeRuntime.SidewaysStateComponent.GetSidewaysState
	// ESidewaysState GetSidewaysState();                                                                                       // [0x8acd0f0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// class USidewaysStateComponent* GetSidewaysStateComponent(class AActor* Owner);                                           // [0xbc8b2c0] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// void RefreshActorsInSideways();                                                                                          // [0xbc8b3d4] Final|Native|Public|BlueprintCallable 
	// Function /Script/SidewaysCodeRuntime.SidewaysPlayspace.NotifySizeChanged
	// void NotifySizeChanged();                                                                                                // [0xbc8b340] Final|Native|Public|BlueprintCallable 
};
