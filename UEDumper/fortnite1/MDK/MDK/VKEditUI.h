...
public:
	...
	// void OnMinigameStateChanged(EFortMinigameState MinigameState, EFortMinigameState PreviousMinigameState);                 // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/VKEditUI.VKConnectionIndicator.HandleMemorySamplerProgressUpdated
	// void HandleMemorySamplerProgressUpdated(float Progress);                                                                 // [0xc6435bc] Final|Native|Private 
};
...
public:
	...
	// void HandleGameStateInitialized(class AFortGameState* GameState);                                                        // [0xc6434fc] Final|Native|Protected 
	// Function /Script/VKEditUI.VKDebugMessagesBase.BP_OnGameStateInitialized
	// void BP_OnGameStateInitialized(class AFortGameState* GameState);                                                         // [0x246f7d8] Event|Protected|BlueprintEvent 
};
