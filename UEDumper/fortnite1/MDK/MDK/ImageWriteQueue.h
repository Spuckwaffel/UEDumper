...
public:
	...
	// void ExportToDisk(class UTexture* Texture, FString Filename, FImageWriteOptions& Options);                               // [0x5eb4554] Final|RequiredAPI|Native|Static|Public|HasOutParms|BlueprintCallable 
};
