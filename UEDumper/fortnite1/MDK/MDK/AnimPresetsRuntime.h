...
public:
	...
	// void HandleAnimInstance(class UAnimInstance* Instance);                                                                  // [0x7e2ac18] Native|Event|Public|BlueprintCallable|BlueprintEvent|Const 
	// Function /Script/AnimPresetsRuntime.AnimPreset.GetPresetClass
	// TWeakObjectPtr<UClass*> GetPresetClass();                                                                                // [0x7e2abd0] Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
};
