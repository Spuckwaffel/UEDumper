...
public:
	...
	// FGameplayAttribute GetGameplayAttributeForClass(class UClass*& AttributeClass);                                          // [0xb148264] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
};
