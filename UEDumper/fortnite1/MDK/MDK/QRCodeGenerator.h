...
public:
	...
	// class UTexture2D* GenerateQRCodeTextureFromString(FString StringToEncode);                                               // [0x868f93c] Final|Native|Static|Private|BlueprintCallable 
};
...
public:
	...
	// void EncodeString(FString StringToEncode);                                                                               // [0x868f294] Final|Native|Public|BlueprintCallable 
};
