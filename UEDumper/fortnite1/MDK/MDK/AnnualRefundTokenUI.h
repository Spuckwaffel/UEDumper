...
public:
	CMember(class UClass*)                             ItemCardClass                                               OFFSET(get<T>, {0x1520, 8, 0, 0})
	DMember(float)                                     CardWidthOverride                                           OFFSET(get<float>, {0x1528, 4, 0, 0})
	CMember(class UCommonTextBlock*)                   Text_Name                                                   OFFSET(get<T>, {0x1530, 8, 0, 0})
	CMember(TArray<FString>)                           LootEntryItemTypesToExclude                                 OFFSET(get<T>, {0x1538, 16, 0, 0})
	CMember(TArray<FString>)                           LootEntryItemTypesToCombine                                 OFFSET(get<T>, {0x1548, 16, 0, 0})


	/// Functions
	// Function /Script/AnnualRefundTokenUI.FortPurchaseHistoryEntryBase.UpdateItemList
	// void UpdateItemList(TArray<UFortCosmeticItemCard*>& ItemCards);                                                          // [0x246f7d8] Event|Protected|HasOutParms|BlueprintEvent 
};

/// Class /Script/AnnualRefundTokenUI.FortPurchaseHistoryEntry
/// Size: 0x0000 (0x001560 - 0x001560)
...
public:
	...
	// void SetupItemCard(class UFortCosmeticItemCard* ItemCard, class UFortItem* Item);                                        // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/AnnualRefundTokenUI.FortPurchaseHistoryEntry.SetPurchaseText
	// void SetPurchaseText(FText& PurchaseDateText, FText& RefundDateText, bool bHasBeenRefunded, EFortPurchaseHistoryRefundType RefundType); // [0x246f7d8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/AnnualRefundTokenUI.FortPurchaseHistoryEntry.OnSetHistory
	// void OnSetHistory(bool bHasBeenRefunded, bool bIsCancelPurchaseEligible, bool bIsTokenlessRefund, bool bPlayerHasTokens, bool bNonRefundable, bool IsPartOfABundle, bool IsNextRefundable, int32_t IndexInBundle, int32_t NumPurchasesInBundle); // [0x246f7d8] Event|Protected|BlueprintEvent 
};
...
public:
	DMember(bool)                                      bIsExpanded                                                 OFFSET(get<bool>, {0x1558, 1, 0, 0})


	/// Functions
	// Function /Script/AnnualRefundTokenUI.FortPurchaseHistoryBundleEntry.SetExpandButtonText
	// void SetExpandButtonText(int32_t NumPurchases);                                                                          // [0x246f7d8] Event|Public|BlueprintEvent 
};
...
public:
	...
	// void OnUpdatePendingState(bool bIsPending);                                                                              // [0x246f7d8] Event|Public|BlueprintEvent 
	// Function /Script/AnnualRefundTokenUI.FortAnnualRefundTicket.OnUpdateAvailableState
	// void OnUpdateAvailableState(bool bIsAvailable);                                                                          // [0x246f7d8] Event|Public|BlueprintEvent 
	// Function /Script/AnnualRefundTokenUI.FortAnnualRefundTicket.OnPlayLockingAnimation
	// void OnPlayLockingAnimation();                                                                                           // [0x246f7d8] Event|Public|BlueprintEvent 
};
...
public:
	...
	// void BP_UpdateRefundType(EFortPurchaseHistoryRefundType RefundType, bool bBundledRefund);                                // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/AnnualRefundTokenUI.FortRefundConfirmation.BP_UpdateItemsList
	// void BP_UpdateItemsList(TArray<UFortItemDefinition*>& SelectedItemDefs, int32_t TotalMtxPaid);                           // [0x246f7d8] Event|Protected|HasOutParms|BlueprintEvent 
};
