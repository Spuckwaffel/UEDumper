...
public:
	...
	// void ResetToDefault();                                                                                                   // [0xce722d8] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// bool ExportToGLTF(class UObject* Object, FString FilePath, class UGLTFExportOptions* Options, TSet<AActor*>& SelectedActors, FGLTFExportMessages& OutMessages); // [0xce71a54] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// void ResetToDefault();                                                                                                   // [0xce722ec] Final|Native|Public|BlueprintCallable 
};
