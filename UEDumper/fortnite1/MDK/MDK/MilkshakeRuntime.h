...
public:
	...
	// void UpdateNearbyBuildingActors();                                                                                       // [0xb94179c] Final|Native|Private 
	// Function /Script/MilkshakeRuntime.MilkshakeControllerComponent.UnregisterEarthquake
	// void UnregisterEarthquake(class AMilkshakeEarthquakeActor* Earthquake);                                                  // [0xb9416dc] Final|Native|Public|BlueprintCallable 
	// Function /Script/MilkshakeRuntime.MilkshakeControllerComponent.SpawnBuildingDamageFX
	// void SpawnBuildingDamageFX();                                                                                            // [0xb94160c] Final|Native|Private 
	// Function /Script/MilkshakeRuntime.MilkshakeControllerComponent.RegisterEarthquake
	// void RegisterEarthquake(class AMilkshakeEarthquakeActor* Earthquake);                                                    // [0xb941488] Final|Native|Public|BlueprintCallable 
	// Function /Script/MilkshakeRuntime.MilkshakeControllerComponent.PlayForceFeedback
	// void PlayForceFeedback();                                                                                                // [0xb941474] Final|Native|Private 
};
...
public:
	...
	// void TickEarthquakePhysicsActorForces(float DeltaSeconds);                                                               // [0xb941620] Final|BlueprintAuthorityOnly|Native|Protected|BlueprintCallable 
	// Function /Script/MilkshakeRuntime.MilkshakeEarthquakeActor.RemoveNullsFromAsyncOverlappedActors
	// void RemoveNullsFromAsyncOverlappedActors();                                                                             // [0x3508bf8] Final|BlueprintAuthorityOnly|Native|Protected|BlueprintCallable 
	// Function /Script/MilkshakeRuntime.MilkshakeEarthquakeActor.RemoveAsyncOverlappedActorsOutsideRadius
	// void RemoveAsyncOverlappedActorsOutsideRadius();                                                                         // [0x3508bf8] Final|BlueprintAuthorityOnly|Native|Protected|BlueprintCallable 
	// Function /Script/MilkshakeRuntime.MilkshakeEarthquakeActor.OnActorRemovedFromAsyncOverlappedActors
	// void OnActorRemovedFromAsyncOverlappedActors(class AActor* RemovedActor);                                                // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/MilkshakeRuntime.MilkshakeEarthquakeActor.GetRadius
	// float GetRadius();                                                                                                       // [0x246f7d8] Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /Script/MilkshakeRuntime.MilkshakeEarthquakeActor.GetNormalizedMagnitudeAtLocation
	// float GetNormalizedMagnitudeAtLocation(FVector Location);                                                                // [0x246f7d8] Event|Public|HasDefaults|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// void SetStrength(float InStrength);                                                                                      // [0xb941548] Final|BlueprintCosmetic|Native|Public|BlueprintCallable 
};
