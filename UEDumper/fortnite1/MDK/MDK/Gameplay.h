...
public:
	...
	// void FailedToActivatePassiveAbility(FGameplayAbilityActorInfo ActorInfo);                                                // [0x246f7d8] Event|Public|BlueprintEvent 
	...
	// void ExecuteUbergraph_GA_Riding_Creature_Burt_SprintCharge(int32_t EntryPoint);                                          // [0x246f7d8] Final|HasDefaults    
};
...
public:
	...
	// void ExecuteUbergraph_GA_Riding_Player_StopRidingOnTriggered(int32_t EntryPoint);                                        // [0x246f7d8] Final|HasDefaults    
};
...
public:
	...
	// void ExecuteUbergraph_GA_Riding_Player_IsRiding(int32_t EntryPoint);                                                     // [0x246f7d8] Final|HasDefaults    
};
...
public:
	...
	// void PettingTelemetry(class AActor* Owner);                                                                              // [0x246f7d8] Public|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Gameplay/General/GA_Riding_Player_Petting.GA_Riding_Player_Petting_C.GetRiderPettingMontage
	// void GetRiderPettingMontage(class UAnimMontage*& RiderPettingMontage);                                                   // [0x246f7d8] Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure 
	...
	// void OnCancelled_EBEF9ED74121A25C39ABC2B953D1B3F8();                                                                     // [0x246f7d8] BlueprintCallable|BlueprintEvent 
	...
	// void OnInterrupted_EBEF9ED74121A25C39ABC2B953D1B3F8();                                                                   // [0x246f7d8] BlueprintCallable|BlueprintEvent 
	...
	// void OnBlendOut_EBEF9ED74121A25C39ABC2B953D1B3F8();                                                                      // [0x246f7d8] BlueprintCallable|BlueprintEvent 
	...
	// void OnCompleted_EBEF9ED74121A25C39ABC2B953D1B3F8();                                                                     // [0x246f7d8] BlueprintCallable|BlueprintEvent 
	...
	// void Added_DE1C9DFC4A5B4A7B0E203C8095E1CE5D();                                                                           // [0x246f7d8] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_GA_Riding_Player_Petting(int32_t EntryPoint);                                                      // [0x246f7d8] Final|HasDefaults    
};

/// Class /RidingContent/Gameplay/General/GA_Riding_Creature_IsBeingRidden_Passive.GA_Riding_Creature_IsBeingRidden_Passive_C
/// Size: 0x0008 (0x000E88 - 0x000E90)
...
public:
	SMember(FPointerToUberGraphFrame)                  UberGraphFrame                                              OFFSET(getStruct<T>, {0xE88, 8, 0, 0})
	...
	// void ExecuteUbergraph_GA_Riding_Creature_IsBeingRidden_Passive(int32_t EntryPoint);                                      // [0x246f7d8] Final|HasDefaults    
};
...
public:
	...
	// void ExecuteUbergraph_GA_Riding_Creature_IsBeingRidden(int32_t EntryPoint);                                              // [0x246f7d8] Final|HasDefaults    
};
...
public:
	...
	// void OnRep_CancelSprintDispatcher();                                                                                     // [0x246f7d8] BlueprintCallable|BlueprintEvent 
	...
	// void Added_BA9D24D64958BB04345A3D89BD7617CA();                                                                           // [0x246f7d8] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_GA_Riding_Player_Sprint(int32_t EntryPoint);                                                       // [0x246f7d8] Final|HasDefaults    
};
...
public:
	...
	// void ExecuteUbergraph_GA_Riding_Creature_EatToRefuel(int32_t EntryPoint);                                                // [0x246f7d8] Final|HasDefaults    
};
...
/// Size: 0x01A0 (0x000FE8 - 0x001188)
class AB_Athena_Zipline_Ascender_C : public AFortAscenderZipline
{ 
	friend MDKHandler;
	static inline constexpr uint64_t __MDKClassSize = 4488;

public:
	SMember(FPointerToUberGraphFrame)                  UberGraphFrame                                              OFFSET(getStruct<T>, {0xFE8, 8, 0, 0})
	CMember(class UAudioParameterComponent*)           AudioParameter                                              OFFSET(get<T>, {0xFF0, 8, 0, 0})
	CMember(class UCapsuleComponent*)                  Capsule                                                     OFFSET(get<T>, {0xFF8, 8, 0, 0})
	CMember(class UStaticMeshComponent*)               Ascender_End_Cap                                            OFFSET(get<T>, {0x1000, 8, 0, 0})
	CMember(class UAudioComponent*)                    PoleMotorSFX                                                OFFSET(get<T>, {0x1008, 8, 0, 0})
	CMember(class UNiagaraComponent*)                  HandleVFX                                                   OFFSET(get<T>, {0x1010, 8, 0, 0})
	CMember(class UNiagaraComponent*)                  PoleMotorVFX                                                OFFSET(get<T>, {0x1018, 8, 0, 0})
	CMember(class UAudioComponent*)                    HandleAscendingSFX                                          OFFSET(get<T>, {0x1020, 8, 0, 0})
	CMember(class UAudioComponent*)                    HandleDescendingSFX                                         OFFSET(get<T>, {0x1028, 8, 0, 0})
	CMember(class USphereComponent*)                   HandleInteractVolume                                        OFFSET(get<T>, {0x1030, 8, 0, 0})
	CMember(class UStaticMeshComponent*)               Handle                                                      OFFSET(get<T>, {0x1038, 8, 0, 0})
	CMember(class UStaticMeshComponent*)               Top                                                         OFFSET(get<T>, {0x1040, 8, 0, 0})
	SMember(FScalableFloat)                            Hotfix                                                      OFFSET(getStruct<T>, {0x1048, 40, 0, 0})
	CMember(class USoundBase*)                         StartHandleSound                                            OFFSET(get<T>, {0x1070, 8, 0, 0})
	CMember(class USoundBase*)                         StopHandleSound                                             OFFSET(get<T>, {0x1078, 8, 0, 0})
	CMember(class USoundBase*)                         StopPoleMotorSoundSkid                                      OFFSET(get<T>, {0x1080, 8, 0, 0})
	CMember(class UMaterialInterface*)                 SplineMeshMaterialOverride                                  OFFSET(get<T>, {0x1088, 8, 0, 0})
	CMember(class UNiagaraSystem*)                     AscendingHandleVFX                                          OFFSET(get<T>, {0x1090, 8, 0, 0})
	CMember(class UNiagaraSystem*)                     DescendingHandleVFX                                         OFFSET(get<T>, {0x1098, 8, 0, 0})
	CMember(class UMaterialInterface*)                 SplineThickenMeshMaterialOverride                           OFFSET(get<T>, {0x10A0, 8, 0, 0})
	DMember(double)                                    MaxWobbleAnimationLength                                    OFFSET(get<double>, {0x10A8, 8, 0, 0})
	DMember(double)                                    LastWobbleActivationTime                                    OFFSET(get<double>, {0x10B0, 8, 0, 0})
	DMember(double)                                    TilingDivisor                                               OFFSET(get<double>, {0x10B8, 8, 0, 0})
	SMember(FVector)                                   HandleAnimOffset                                            OFFSET(getStruct<T>, {0x10C0, 24, 0, 0})
	SMember(FVector)                                   SlideAnimOffset                                             OFFSET(getStruct<T>, {0x10D8, 24, 0, 0})
	CMember(class USoundBase*)                         PlayerGrabBeginDecentSound                                  OFFSET(get<T>, {0x10F0, 8, 0, 0})
	CMember(class UAudioComponent*)                    HandleStart                                                 OFFSET(get<T>, {0x10F8, 8, 0, 0})
	SMember(FVector)                                   EndCapRelativeScale                                         OFFSET(getStruct<T>, {0x1100, 24, 0, 0})
	CMember(class UClass*)                             StructureDamageGE                                           OFFSET(get<T>, {0x1118, 8, 0, 0})
	SMember(FTimerHandle)                              AudioVisualizerHandle                                       OFFSET(getStruct<T>, {0x1120, 8, 0, 0})
	CMember(TArray<class AFortPlayerPawn*>)            PlayersOnAscender                                           OFFSET(get<T>, {0x1128, 16, 0, 0})
	CMember(class USoundBase*)                         TravelSound                                                 OFFSET(get<T>, {0x1138, 8, 0, 0})
	DMember(bool)                                      ShouldPlayWhoosh                                            OFFSET(get<bool>, {0x1140, 1, 0, 0})
	CMember(class USoundBase*)                         AscendWhooshSound                                           OFFSET(get<T>, {0x1148, 8, 0, 0})
	CMember(class AFortPlayerPawn*)                    PlayerPawn                                                  OFFSET(get<T>, {0x1150, 8, 0, 0})
	SMember(FTimerHandle)                              WhooshHandle                                                OFFSET(getStruct<T>, {0x1158, 8, 0, 0})
	SMember(FGameplayTag)                              LinkToDestroyedGC                                           OFFSET(getStruct<T>, {0x1160, 4, 0, 0})
	DMember(bool)                                      BeDestroy                                                   OFFSET(get<bool>, {0x1164, 1, 0, 0})
	CMember(class APlayerState*)                       PlayerStateUsingHandleComponent                             OFFSET(get<T>, {0x1168, 8, 0, 0})
	CMember(TArray<FAudioParameter>)                   AudioParameters                                             OFFSET(get<T>, {0x1170, 16, 0, 0})
	CMember(class UAudioParameterComponent*)           ParameterComponent                                          OFFSET(get<T>, {0x1180, 8, 0, 0})


	/// Functions
	// Function /Ascender/Gameplay/Ascender/B_Athena_Zipline_Ascender.B_Athena_Zipline_Ascender_C.GetAffiliationsToShowFor
	// TArray<TEnumAsByte<EFortTeamAffiliation>> GetAffiliationsToShowFor();                                                    // [0x246f7d8] Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /Ascender/Gameplay/Ascender/B_Athena_Zipline_Ascender.B_Athena_Zipline_Ascender_C.ShouldShowSoundIndicator
	// bool ShouldShowSoundIndicator(class AFortPlayerController* PlayerController);                                            // [0x246f7d8] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	...
	// EDynamicDestructionResourceType GetDynamicDestructionResourceType();                                                     // [0x246f7d8] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	...
	// bool ShouldUseDynamicDestructionNiagaraSystem();                                                                         // [0x246f7d8] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	...
	// bool ShouldUseDynamicDestructionMaterial();                                                                              // [0x246f7d8] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /Ascender/Gameplay/Ascender/B_Athena_Zipline_Ascender.B_Athena_Zipline_Ascender_C.OnRep_BeDestroy
	// void OnRep_BeDestroy();                                                                                                  // [0x246f7d8] BlueprintCallable|BlueprintEvent 
	// Function /Ascender/Gameplay/Ascender/B_Athena_Zipline_Ascender.B_Athena_Zipline_Ascender_C.BlueprintCanInteract
	// bool BlueprintCanInteract(class AFortPawn* InteractingPawn, TEnumAsByte<EInteractionBeingAttempted> InteractionBeingAttempted, TEnumAsByte<TInteractionType> InteractionType); // [0x246f7d8] Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /Ascender/Gameplay/Ascender/B_Athena_Zipline_Ascender.B_Athena_Zipline_Ascender_C.CanBeginZiplining
	// bool CanBeginZiplining(class AFortPlayerPawn* InteractingPawn, class UPrimitiveComponent* InteractComponent);            // [0x246f7d8] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|Const 
	// Function /Ascender/Gameplay/Ascender/B_Athena_Zipline_Ascender.B_Athena_Zipline_Ascender_C.LocalOnFailedInteract
	// void LocalOnFailedInteract(class AFortPlayerPawn* InteractingPawn);                                                      // [0x246f7d8] Event|Public|BlueprintCallable|BlueprintEvent|Const 
	// Function /Ascender/Gameplay/Ascender/B_Athena_Zipline_Ascender.B_Athena_Zipline_Ascender_C.GetBoundsComponents
	// void GetBoundsComponents(class AActor* SelfActor, TArray<USceneComponent*>& OutComponents);                              // [0x246f7d8] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /Ascender/Gameplay/Ascender/B_Athena_Zipline_Ascender.B_Athena_Zipline_Ascender_C.ApplyStructureDamage
	// void ApplyStructureDamage(class ABuildingSMActor* BuildingActor, class AActor* DamageSource);                            // [0x246f7d8] Event|Public|HasDefaults|BlueprintCallable|BlueprintEvent|Const 
	// Function /Ascender/Gameplay/Ascender/B_Athena_Zipline_Ascender.B_Athena_Zipline_Ascender_C.AttachCapToEndOfSplineMesh
	// void AttachCapToEndOfSplineMesh();                                                                                       // [0x246f7d8] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	...
	// bool AttemptOverrideZiplineSocketOffset(class AFortPlayerPawn* InteractingPawn, class UPrimitiveComponent* InteractComponent, FVector& BaseSocketOffset, FVector& OutSocketOffset); // [0x246f7d8] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|Const 
	// Function /Ascender/Gameplay/Ascender/B_Athena_Zipline_Ascender.B_Athena_Zipline_Ascender_C.CalculateLaunchVelocity
	// void CalculateLaunchVelocity(class AActor* PlayerPawn, FVector& LaunchVelocity);                                         // [0x246f7d8] Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure 
	// Function /Ascender/Gameplay/Ascender/B_Athena_Zipline_Ascender.B_Athena_Zipline_Ascender_C.SetCableTilingBySplineLength
	// void SetCableTilingBySplineLength();                                                                                     // [0x246f7d8] Public|BlueprintCallable|BlueprintEvent 
	// Function /Ascender/Gameplay/Ascender/B_Athena_Zipline_Ascender.B_Athena_Zipline_Ascender_C.DeactivateCableWobble
	// void DeactivateCableWobble();                                                                                            // [0x246f7d8] Public|BlueprintCallable|BlueprintEvent 
	// Function /Ascender/Gameplay/Ascender/B_Athena_Zipline_Ascender.B_Athena_Zipline_Ascender_C.ActivateCableWobble
	// void ActivateCableWobble();                                                                                              // [0x246f7d8] Public|BlueprintCallable|BlueprintEvent 
	// Function /Ascender/Gameplay/Ascender/B_Athena_Zipline_Ascender.B_Athena_Zipline_Ascender_C.HotfixEnabled
	// void HotfixEnabled();                                                                                                    // [0x246f7d8] Public|BlueprintCallable|BlueprintEvent 
	// Function /Ascender/Gameplay/Ascender/B_Athena_Zipline_Ascender.B_Athena_Zipline_Ascender_C.GetTopComponent
	// class UPrimitiveComponent* GetTopComponent();                                                                            // [0x246f7d8] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /Ascender/Gameplay/Ascender/B_Athena_Zipline_Ascender.B_Athena_Zipline_Ascender_C.GetHandleComponent
	// class UPrimitiveComponent* GetHandleComponent();                                                                         // [0x246f7d8] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /Ascender/Gameplay/Ascender/B_Athena_Zipline_Ascender.B_Athena_Zipline_Ascender_C.GetInteractComponentOverride
	// class UPrimitiveComponent* GetInteractComponentOverride(class AFortPlayerPawn* InteractingPawn, class UPrimitiveComponent* InteractComponent); // [0x246f7d8] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|Const 
	// Function /Ascender/Gameplay/Ascender/B_Athena_Zipline_Ascender.B_Athena_Zipline_Ascender_C.PawnIsInHandleRange
	// bool PawnIsInHandleRange(class AFortPawn* Pawn);                                                                         // [0x246f7d8] Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|Const 
	// Function /Ascender/Gameplay/Ascender/B_Athena_Zipline_Ascender.B_Athena_Zipline_Ascender_C.BlueprintGetInteractionString
	// FText BlueprintGetInteractionString(class AFortPawn* InteractingPawn, TEnumAsByte<EInteractionBeingAttempted> InteractionBeingAttempted); // [0x246f7d8] Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|Const 
	// Function /Ascender/Gameplay/Ascender/B_Athena_Zipline_Ascender.B_Athena_Zipline_Ascender_C.GetLastSplinePointIndex
	// int32_t GetLastSplinePointIndex();                                                                                       // [0x246f7d8] Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure 
	...
	// void OnReady_93837FC44A18F6AE57D3478CC43A98AB(class AFortGameStateAthena* GameState, class UFortPlaylist* Playlist, FGameplayTagContainer& PlaylistContextTags); // [0x246f7d8] HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void OnZipliningStarted(class AFortPlayerPawn* InteractingPawn, class UPrimitiveComponent* InteractComponent);           // [0x246f7d8] Event|Public|BlueprintEvent 
	// Function /Ascender/Gameplay/Ascender/B_Athena_Zipline_Ascender.B_Athena_Zipline_Ascender_C.PlayerDescendingStarted
	// void PlayerDescendingStarted(class AFortPlayerPawn* Sliding Player);                                                     // [0x246f7d8] Net|NetMulticast|BlueprintCallable|BlueprintEvent 
	...
	// void OnZipliningStopped(class AFortPlayerPawn* InteractingPawn, class UPrimitiveComponent* InteractComponent, float ZiplineUsageDuration); // [0x246f7d8] Event|Public|BlueprintEvent 
	// Function /Ascender/Gameplay/Ascender/B_Athena_Zipline_Ascender.B_Athena_Zipline_Ascender_C.ShouldPlayWhooshTimer
	// void ShouldPlayWhooshTimer();                                                                                            // [0x246f7d8] BlueprintCallable|BlueprintEvent 
	// Function /Ascender/Gameplay/Ascender/B_Athena_Zipline_Ascender.B_Athena_Zipline_Ascender_C.OnAscenderSetupComplete_Event
	// void OnAscenderSetupComplete_Event();                                                                                    // [0x246f7d8] BlueprintCallable|BlueprintEvent 
	// Function /Ascender/Gameplay/Ascender/B_Athena_Zipline_Ascender.B_Athena_Zipline_Ascender_C.HandleLinkedActorDestroyed
	// void HandleLinkedActorDestroyed(class AActor* DamageCauser);                                                             // [0x246f7d8] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_B_Athena_Zipline_Ascender(int32_t EntryPoint);                                                     // [0x246f7d8] Final|HasDefaults    
};
...
public:
	...
	// void GetAscenderMontage(class UAnimMontage*& Montage);                                                                   // [0x246f7d8] Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure 
	// Function /Ascender/Gameplay/Ascender/GA_Athena_Ascender_Smash.GA_Athena_Ascender_Smash_C.DoFailSafeUnholster
	// void DoFailSafeUnholster();                                                                                              // [0x246f7d8] Public|BlueprintCallable|BlueprintEvent 
	// Function /Ascender/Gameplay/Ascender/GA_Athena_Ascender_Smash.GA_Athena_Ascender_Smash_C.DoUnholster
	// void DoUnholster();                                                                                                      // [0x246f7d8] Public|BlueprintCallable|BlueprintEvent 
	// Function /Ascender/Gameplay/Ascender/GA_Athena_Ascender_Smash.GA_Athena_Ascender_Smash_C.DoHolster
	// void DoHolster();                                                                                                        // [0x246f7d8] Public|BlueprintCallable|BlueprintEvent 
	// Function /Ascender/Gameplay/Ascender/GA_Athena_Ascender_Smash.GA_Athena_Ascender_Smash_C.IsPlayerUsingHandle
	// bool IsPlayerUsingHandle();                                                                                              // [0x246f7d8] Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure 
	...
	// void OnCancelled_899182BF4C098785CCBCFD85AA84455F();                                                                     // [0x246f7d8] BlueprintCallable|BlueprintEvent 
	...
	// void OnInterrupted_899182BF4C098785CCBCFD85AA84455F();                                                                   // [0x246f7d8] BlueprintCallable|BlueprintEvent 
	...
	// void OnBlendOut_899182BF4C098785CCBCFD85AA84455F();                                                                      // [0x246f7d8] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_GA_Athena_Ascender_Smash(int32_t EntryPoint);                                                      // [0x246f7d8] Final|HasDefaults    
};
