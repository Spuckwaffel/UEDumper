...
public:
	...
	// void StartAssignedObjectives();                                                                                          // [0x3508bf8] Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
	// Function /Script/MidMatchAssignedGameplayRuntime.FortGameStateComponent_AssignedObjective.OnAssignedObjectiveReady
	// void OnAssignedObjectiveReady(FFortAssignedObjectiveData& ObjectiveData);                                                // [0x246f7d8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/MidMatchAssignedGameplayRuntime.FortGameStateComponent_AssignedObjective.CalculateSquadAvgLocation
	// FVector CalculateSquadAvgLocation(char SquadID, class UObject* WorldContextObject);                                      // [0xb9b33f8] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
};
