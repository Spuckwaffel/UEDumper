...
public:
	...
	// void Client_SetCachedContextualMessageResult(FJunoContextualMessageQueryResult Result);                                  // [0xc6932a4] Final|Net|NetReliableNative|Event|Private|NetClient 
};
...
public:
	...
	// bool ValidateUniqueResidentTag(FGameplayTag& OtherResidentIdentifier);                                                   // [0xc695798] Final|Native|Private|HasOutParms|Const 
	// Function /Script/JunoAdventuresRuntime.JunoControllerRequirement_CampResidentsHaveTag.ValidateRoleTag
	// bool ValidateRoleTag(FGameplayTag& OtherResidentIdentifier, class UPlayspaceComponent_JunoAIPersistence* RootAIPersistenceComp); // [0xc695630] Final|Native|Private|HasOutParms|Const 
};
...
public:
	...
	// TArray<FName> Editor_GetValidObjectives();                                                                               // [0x820aa78] Final|Native|Private|Const 
};
...
public:
	...
	// void PlayClientVoiceLine(FConversationContext& Context, FJunoContextualMessageQueryResult& MessageParams);               // [0xc694c00] Native|Event|Protected|HasOutParms|BlueprintEvent|Const 
};
...
public:
	...
	// void OnRep_ParticipantIconSmall();                                                                                       // [0xc694b9c] Final|Native|Protected 
};
...
public:
	...
	// void HandleInventoryChangedEvent(FJunoItemSlot& ItemSlot, EJunoItemChangeType ChangeType);                               // [0xc694258] Final|Native|Public|HasOutParms 
};
...
public:
	...
	// void RollGrantableQuestID();                                                                                             // [0xc69536c] Final|Native|Public|BlueprintCallable 
	// Function /Script/JunoAdventuresRuntime.JunoQuestGiverComponent.HandleOnJunoQuestComplete
	// void HandleOnJunoQuestComplete(TScriptInterface<Class>& QuestInstance);                                                  // [0xc694428] Final|Native|Private|HasOutParms 
	// Function /Script/JunoAdventuresRuntime.JunoQuestGiverComponent.GetGrantableQuestID
	// FString GetGrantableQuestID();                                                                                           // [0xc69337c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoAdventuresRuntime.JunoQuestGiverComponent.BindToQuestManagerDelegates
	// void BindToQuestManagerDelegates();                                                                                      // [0xc693290] Final|Native|Private 
};
...
public:
	...
	// void ReceiveToken(FGameplayTag& JunoToken);                                                                              // [0xc6952a0] Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/JunoAdventuresRuntime.JunoTokenHandlerAIComponent.GetSavedTokens
	// FGameplayTagContainer GetSavedTokens();                                                                                  // [0xc694228] Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// EJunoQuestState GetJunoQuestState(FString QuestID);                                                                      // [0xc693548] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void SendQuestStatEvent(EFortQuestObjectiveStatEvent Type, FGameplayTagContainer SourceTags, FGameplayTagContainer TargetTags, int32_t Count); // [0xc695380] Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
	// Function /Script/JunoAdventuresRuntime.JunoQuestManagerComponent.GetQuestGiverForQuestID
	// class AActor* GetQuestGiverForQuestID(FString QuestID);                                                                  // [0xc693bb0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoAdventuresRuntime.JunoQuestManagerComponent.ActivateQuest
	// void ActivateQuest(class UFortQuestItemDefinition_Athena* QuestDefinition, class AActor* QuestGiver);                    // [0xc693150] Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
};
...
public:
	...
	// TArray<FName> Editor_GetValidObjectiveNames();                                                                           // [0x820aa78] Final|Native|Private|Const 
};
...
public:
	...
	// class UJunoQuestManagerComponent* GetJunoQuestManager(class UObject* WorldContextObject);                                // [0xc693488] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/JunoAdventuresRuntime.JunoAdventuresBlueprintLibrary.GetJunoQuestDatabase
	// class UJunoQuestDatabaseComponent* GetJunoQuestDatabase(class UObject* WorldContextObject);                              // [0xc6933c8] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// void JunoSpawnVisitorInClosestCamp(FString PartialUniqueAIIdentifier, int32_t Count);                                    // [0x9870274] Final|BlueprintAuthorityOnly|Exec|Native|Private|Const 
	// Function /Script/JunoAdventuresRuntime.JunoCheatManager_Adventures.JunoRepopulateAvailableQuestsWithTags
	// void JunoRepopulateAvailableQuestsWithTags(FString QuestPoolTags);                                                       // [0xc694530] Final|BlueprintAuthorityOnly|Exec|Native|Private 
	// Function /Script/JunoAdventuresRuntime.JunoCheatManager_Adventures.JunoRepopulateAvailableQuests
	// void JunoRepopulateAvailableQuests();                                                                                    // [0xc6944b8] Final|BlueprintAuthorityOnly|Exec|Native|Private 
	// Function /Script/JunoAdventuresRuntime.JunoCheatManager_Adventures.JunoQueueScriptRowMessagesForNpcConversation
	// void JunoQueueScriptRowMessagesForNpcConversation(FString ScriptName, FString RowName);                                  // [0x9ccda14] Final|BlueprintAuthorityOnly|Exec|Native|Private 
	// Function /Script/JunoAdventuresRuntime.JunoCheatManager_Adventures.JunoPrintNPCsInfo
	// void JunoPrintNPCsInfo(bool bIgnoreAIsWithNoAssignment);                                                                 // [0x62ffeb0] Final|Exec|Native|Private|Const 
	// Function /Script/JunoAdventuresRuntime.JunoCheatManager_Adventures.JunoPrintCurrentConversationInfo
	// void JunoPrintCurrentConversationInfo();                                                                                 // [0x3508bf8] Final|Exec|Native|Private|Const 
	// Function /Script/JunoAdventuresRuntime.JunoCheatManager_Adventures.JunoInjectDisplayTextForNpcConversation
	// void JunoInjectDisplayTextForNpcConversation(FString TestString);                                                        // [0x6b78618] Final|BlueprintAuthorityOnly|Exec|Native|Private|Const 
};
