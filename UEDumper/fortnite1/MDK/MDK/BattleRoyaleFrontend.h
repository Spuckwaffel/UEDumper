...
public:
	...
	// void HandleVideoTerminalError(EBaseMediaTerminalErrorReason Reason);                                                     // [0xb822d7c] Final|Native|Private 
	// Function /Script/BattleRoyaleFrontend.BattleRoyaleFrontendExperienceFlow.HandleSeasonTrailerEnded
	// void HandleSeasonTrailerEnded();                                                                                         // [0xb822d68] Final|Native|Private 
	// Function /Script/BattleRoyaleFrontend.BattleRoyaleFrontendExperienceFlow.FinishTrailerStep
	// void FinishTrailerStep();                                                                                                // [0xb822d54] Final|Native|Private 
};
