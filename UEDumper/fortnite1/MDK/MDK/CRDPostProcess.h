...
public:
	...
	// void StartEffectTimer(class APlayerController* InBlendInstigator);                                                       // [0xc32d8e8] Final|BlueprintCosmetic|Native|Public|BlueprintCallable 
	// Function /Script/CRDPostProcess.CRDPostProcessDeviceComponent.StartBlendingFromPriority
	// void StartBlendingFromPriority(bool bShouldHide, float duration);                                                        // [0xc32d798] Final|BlueprintCosmetic|Native|Public|BlueprintCallable 
	// Function /Script/CRDPostProcess.CRDPostProcessDeviceComponent.StartBlending
	// void StartBlending(class APlayerController* InBlendInstigator, bool bBlendIn, float duration);                           // [0xc32d5cc] Final|BlueprintCosmetic|Native|Public|BlueprintCallable 
	// Function /Script/CRDPostProcess.CRDPostProcessDeviceComponent.SetPostProcessEnabled
	// void SetPostProcessEnabled(bool bEnabled);                                                                               // [0xc32d4f0] Final|BlueprintCosmetic|Native|Public|BlueprintCallable 
	// Function /Script/CRDPostProcess.CRDPostProcessDeviceComponent.SetHiddenStrength
	// void SetHiddenStrength(float Value);                                                                                     // [0xc32d42c] Final|BlueprintCosmetic|Native|Public|BlueprintCallable 
	// Function /Script/CRDPostProcess.CRDPostProcessDeviceComponent.SetCurrentStrength
	// void SetCurrentStrength(float Value);                                                                                    // [0xc32d368] Final|BlueprintCosmetic|Native|Public|BlueprintCallable 
	// Function /Script/CRDPostProcess.CRDPostProcessDeviceComponent.GetPriority
	// int32_t GetPriority();                                                                                                   // [0x72f6cc0] Final|BlueprintCosmetic|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CRDPostProcess.CRDPostProcessDeviceComponent.GetCurrentStrength
	// float GetCurrentStrength();                                                                                              // [0x3da21d8] Final|BlueprintCosmetic|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CRDPostProcess.CRDPostProcessDeviceComponent.GetClientEnabled
	// bool GetClientEnabled();                                                                                                 // [0x83d224c] Final|BlueprintCosmetic|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CRDPostProcess.CRDPostProcessDeviceComponent.GetBlendOutTime
	// float GetBlendOutTime();                                                                                                 // [0x6626d54] Final|BlueprintCosmetic|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CRDPostProcess.CRDPostProcessDeviceComponent.GetBlendInTime
	// float GetBlendInTime();                                                                                                  // [0x72f6cd8] Final|BlueprintCosmetic|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CRDPostProcess.CRDPostProcessDeviceComponent.ApplyPostProcessSettingsToDeviceComponent
	// bool ApplyPostProcessSettingsToDeviceComponent(class UClass* ActorClass, bool bInEnabled, float InMaxStrength, int32_t InPriority, float InEffectDuration, float InBlendInDuration, float InBlendOutDuration); // [0xc32c098] Final|BlueprintCosmetic|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void RemovePostProcessDevice(class UCRDPostProcessDeviceComponent* InPostProcessDeviceComponent);                        // [0xc32d0bc] Final|BlueprintCosmetic|Native|Public|BlueprintCallable 
	...
	// class UCRDPostProcessDevicePriorityControllerComponent* GetPostProcessDevicePriorityControllerComponentFromPlayerController(class APlayerController* PC, bool bCreateIfNotFound); // [0xc32cf08] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/CRDPostProcess.CRDPostProcessDevicePriorityControllerComponent.GetHighestPriorityValue
	// int32_t GetHighestPriorityValue();                                                                                       // [0xc32cd24] Final|BlueprintCosmetic|Native|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/CRDPostProcess.CRDPostProcessDevicePriorityControllerComponent.GetEffectsForPriority
	// void GetEffectsForPriority(int32_t Priority, TArray<UCRDPostProcessDeviceComponent*>& OutEffects);                       // [0xc32c678] Final|BlueprintCosmetic|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/CRDPostProcess.CRDPostProcessDevicePriorityControllerComponent.CachePostProcessDeviceApplication
	// void CachePostProcessDeviceApplication(class UCRDPostProcessDeviceComponent* InPostProcessDeviceComponent);              // [0xc32c57c] Final|BlueprintCosmetic|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void ServerBlendFinished(class AFortCreativeDeviceProp* PostProcessDevice, class APlayerController* Instigator, bool bBlendIn); // [0xc32d1a8] Net|NetReliableNative|Event|Public|NetServer 
	// Function /Script/CRDPostProcess.CRDPostProcessDeviceControllerComponent.Reset
	// void Reset();                                                                                                            // [0xc32d194] Final|Native|Public|BlueprintCallable 
	// Function /Script/CRDPostProcess.CRDPostProcessDeviceControllerComponent.OnRep_PostProcessDeviceMessageBatch
	// void OnRep_PostProcessDeviceMessageBatch();                                                                              // [0x3449a4c] Final|Native|Private 
	...
	// class UCRDPostProcessDeviceControllerComponent* GetPostProcessDeviceControllerComponentFromPlayerController(class APlayerController* PC, bool bCreateIfNotFound); // [0xc32cd54] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/CRDPostProcess.CRDPostProcessDeviceControllerComponent.GetMinigamePlayersForPostProcessDevice
	// void GetMinigamePlayersForPostProcessDevice(class AFortMinigame* FortMinigame, TArray<APlayerState*>& OutPlayers);       // [0x8a1e234] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/CRDPostProcess.CRDPostProcessDeviceControllerComponent.AddBlendMessageToQueue
	// void AddBlendMessageToQueue(class AFortCreativeDeviceProp* PostProcessDevice, class AFortPlayerState* PlayerStateMessage, EPostProcessDeviceState EndState); // [0xc32bedc] Final|Native|Protected|BlueprintCallable 
};
