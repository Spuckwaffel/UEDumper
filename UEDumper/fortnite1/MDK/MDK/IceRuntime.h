...
public:
	...
	// void ResolveBuildingDamage(class ABuildingActor* DamagedBuildingActor, class AController* InstigatedBy, class AActor* DamageCauser); // [0xb9527c4] Final|Native|Private 
	// Function /Script/IceRuntime.FortCurieElementAttachHandlerIce.HandleBuildingDamaged
	// void HandleBuildingDamaged(class AActor* DamagedActor, float Damage, class AController* InstigatedBy, class AActor* DamageCauser, FVector HitLocation, class UPrimitiveComponent* FHitComponent, FName BoneName, FVector Momentum); // [0xb951e94] Final|Native|Private|HasDefaults 
};
...
public:
	...
	// void OnRep_SplinePoints();                                                                                               // [0xb952770] Final|Native|Private 
	// Function /Script/IceRuntime.IceGroundPath.GetLocationOnLandscape
	// FVector GetLocationOnLandscape(FVector Location);                                                                        // [0xb951d98] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/IceRuntime.IceGroundPath.GetLastSplinePointLocation
	// bool GetLastSplinePointLocation(FVector& LastPointLocation);                                                             // [0xb951c84] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/IceRuntime.IceGroundPath.AddSplinePoint
	// void AddSplinePoint(FVector InWorldLoc);                                                                                 // [0xb951b68] Final|Native|Public|HasDefaults|BlueprintCallable 
};
...
public:
	...
	// void OnIceBlockDied(class AActor* DamagedActor, float Damage, class AController* InstigatedBy, class AActor* DamageCauser, FVector HitLocation, class UPrimitiveComponent* FHitComponent, FName BoneName, FVector Momentum); // [0xb9522e8] Final|Native|Public|HasDefaults 
};
