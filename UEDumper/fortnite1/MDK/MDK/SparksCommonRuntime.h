...
public:
	...
	// void ShowSparksCaptureTool(bool bShow);                                                                                  // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/SparksCommonRuntime.SparksCommonUtilities.GetSparksCommonUtilities
	// class USparksCommonUtilities* GetSparksCommonUtilities(class UObject* WorldContextObject);                               // [0xb6f7d60] Final|Native|Static|Public|BlueprintCallable 
};
