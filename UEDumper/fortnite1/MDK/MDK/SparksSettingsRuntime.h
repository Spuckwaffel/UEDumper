...
public:
	...
	// void SetGameplayMusicVolume(float NewVolume);                                                                            // [0xb7d4c3c] Final|Native|Public  
	// Function /Script/SparksSettingsRuntime.SparksClientSettingRecordPartition.GetGameplayMusicVolume
	// float GetGameplayMusicVolume();                                                                                          // [0x6d1a024] Final|RequiredAPI|Native|Public|Const 
};
...
public:
	...
	// void UpdateSparksMixFromPartition();                                                                                     // [0xb7d4d00] Final|Native|Public|Const 
	// Function /Script/SparksSettingsRuntime.SparksSettingsControllerComponent.GetSparksClientSettingRecordPartition
	// class USparksClientSettingRecordPartition* GetSparksClientSettingRecordPartition();                                      // [0xb7d4c18] Final|Native|Public|Const 
};
