...
public:
	...
	// bool DoesContextPass(FConversationContext& Context);                                                                     // [0xafe0fdc] Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// bool GetMessageForContext(FFortConversationNodeConditionalMessages& Messages, FConversationContext& Context, FText& OutText); // [0xafe1d80] Final|Native|Static|Private|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// bool ExtractConversationParameterValue(TArray<FConversationNodeParameterPair>& ConversationParameters, FString DesiredParameterName, FString& ParameterValueOut); // [0xafe1624] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
public:
	CMember(TArray<class UFortNonPlayerConversationParticipantComponent*>) ConversationParticipantsInRange         OFFSET(get<T>, {0x190, 16, 0, 0})
	DMember(float)                                     GreetSphereRadius                                           OFFSET(get<float>, {0x1A0, 4, 0, 0})
	DMember(float)                                     IconVisibilityRadius                                        OFFSET(get<float>, {0x1A4, 4, 0, 0})
	DMember(float)                                     AbortConversationRange                                      OFFSET(get<float>, {0x1A8, 4, 0, 0})
	SMember(FGameplayTag)                              RidingOnActorTag                                            OFFSET(getStruct<T>, {0x1AC, 4, 0, 0})
	DMember(float)                                     RidingOnActorRangeMultiplierSquared                         OFFSET(get<float>, {0x1B0, 4, 0, 0})
	CMember(TSet<UFortNonPlayerConversationParticipantComponent*>) IndicatedNPCConversationComponents              OFFSET(get<T>, {0x1F0, 80, 0, 0})
	DMember(bool)                                      bMoveShouldAbortConversation                                OFFSET(get<bool>, {0x248, 1, 0, 0})
	DMember(bool)                                      bCachedDefaultMoveShouldAbortConverationValue               OFFSET(get<bool>, {0x249, 1, 0, 0})
	...
	// void RequestServerAbortConversationWithParticipant(class UFortNonPlayerConversationParticipantComponent* Participant);   // [0xafe25c8] Net|NetReliableNative|Event|Public|NetServer 
	// Function /Script/FortniteConversationRuntime.FortPlayerConversationComponent.RequestServerAbortConversation
	// void RequestServerAbortConversation();                                                                                   // [0x90cc4ec] Net|NetReliableNative|Event|Public|NetServer|BlueprintCallable 
	// Function /Script/FortniteConversationRuntime.FortPlayerConversationComponent.HandleWeaponEquipped
	// void HandleWeaponEquipped(class AFortWeapon* NewWeapon, class AFortWeapon* PrevWeapon);                                  // [0x6ce8074] Final|Native|Private 
	// Function /Script/FortniteConversationRuntime.FortPlayerConversationComponent.HandleViewTargetChanged
	// void HandleViewTargetChanged();                                                                                          // [0xafe25b4] Final|Native|Private 
	// Function /Script/FortniteConversationRuntime.FortPlayerConversationComponent.HandleFollowedPlayerChanged
	// void HandleFollowedPlayerChanged(class AFortPlayerControllerSpectating* SpectatingPC, class AFortPlayerState* FollowedPlayerState); // [0xafe2474] Final|Native|Private 
	// Function /Script/FortniteConversationRuntime.FortPlayerConversationComponent.HandleDBNOChanged
	// void HandleDBNOChanged(class AFortPawn* Pawn, bool bIsDBNO);                                                             // [0x878c1d8] Final|Native|Private 
	// Function /Script/FortniteConversationRuntime.FortPlayerConversationComponent.ClientSpectatorOpenUI
	// void ClientSpectatorOpenUI();                                                                                            // [0x875f0a8] Net|NetReliableNative|Event|Public|NetClient 
	// Function /Script/FortniteConversationRuntime.FortPlayerConversationComponent.ClientSpectatorLeaveConversationState
	// void ClientSpectatorLeaveConversationState();                                                                            // [0x8a1d468] Net|NetReliableNative|Event|Public|NetClient 
	// Function /Script/FortniteConversationRuntime.FortPlayerConversationComponent.ClientSpectatorEnterConversationState
	// void ClientSpectatorEnterConversationState();                                                                            // [0x8a1d30c] Net|NetReliableNative|Event|Public|NetClient 
	// Function /Script/FortniteConversationRuntime.FortPlayerConversationComponent.ClientSpectatorCloseUI
	// void ClientSpectatorCloseUI();                                                                                           // [0x9cce774] Net|NetReliableNative|Event|Public|NetClient 
	// Function /Script/FortniteConversationRuntime.FortPlayerConversationComponent.ClientReceiveConversationGiftUINotification
	// void ClientReceiveConversationGiftUINotification(FGiftUINotificationInfo ConversationGiftUINotification);                // [0xafe0f08] Net|NetReliableNative|Event|Public|NetClient 
};
