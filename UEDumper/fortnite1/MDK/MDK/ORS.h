...
public:
	...
	// void OnOwnerAdded(class AActor* Actor);                                                                                  // [0xc389d40] Final|Native|Private 
};
...
public:
	...
	// void ORSListObjects();                                                                                                   // [0x3508bf8] Final|Exec|Native|Protected 
	// Function /Script/ORS.ORSCheatManager.ORSDebug
	// void ORSDebug(FName& Path);                                                                                              // [0xc389cd8] Final|Exec|Native|Protected|HasOutParms 
};
...
public:
	...
	// void OnRep_ReplicatedObjectReferences();                                                                                 // [0xc389e28] Final|Native|Protected 
	// Function /Script/ORS.ORSGroupComponent.OnRep_ReplicatedNetSerializeObjects
	// void OnRep_ReplicatedNetSerializeObjects();                                                                              // [0xc389e14] Final|Native|Protected 
	// Function /Script/ORS.ORSGroupComponent.OnRep_ReplayNetSerializeObjects
	// void OnRep_ReplayNetSerializeObjects();                                                                                  // [0xc389e00] Final|Native|Protected 
};
...
public:
	...
	// void OnActorDestroyed(class AActor* Actor);                                                                              // [0x1d4cadc] Final|Native|Protected 
};
