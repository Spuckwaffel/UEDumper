...
public:
	...
	// void NativeAddToCheatManager();                                                                                          // [0x3508bf8] Final|Native|Protected|BlueprintCallable 
	// Function /Script/JunoRidableRuntime.JunoRidableCheatManager.JunoStopRidingDelayedResetRiderComponent
	// void JunoStopRidingDelayedResetRiderComponent();                                                                         // [0x3508bf8] Final|Native|Protected 
	// Function /Script/JunoRidableRuntime.JunoRidableCheatManager.JunoStopRiding
	// void JunoStopRiding();                                                                                                   // [0x2447c9c] BlueprintAuthorityOnly|Exec|Native|Public 
	// Function /Script/JunoRidableRuntime.JunoRidableCheatManager.JunoStartRiding
	// void JunoStartRiding();                                                                                                  // [0x1f82a80] BlueprintAuthorityOnly|Exec|Native|Public 
};
