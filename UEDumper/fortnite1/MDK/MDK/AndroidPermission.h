...
public:
	...
	// bool CheckPermission(FString Permission);                                                                                // [0xc962920] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/AndroidPermission.AndroidPermissionFunctionLibrary.AcquirePermissions
	// class UAndroidPermissionCallbackProxy* AcquirePermissions(TArray<FString>& Permissions);                                 // [0xc962838] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
