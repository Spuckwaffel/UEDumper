...
public:
	...
	// void RemoveFromEndGameQueue();                                                                                           // [0x3508bf8] Final|Native|Public|BlueprintCallable 
	...
	// bool IsWithinPublishedPlayspace();                                                                                       // [0x310234c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CRD_GameStreamRuntime.CreativeGameStreamDeviceComponent.Init
	// void Init(class UFortMinigameLogicComponent* InMinigameLogicComponent);                                                  // [0x631c404] Final|Native|Public|BlueprintCallable 
	...
	// void CreativeGameStreamDeviceComponentSignature__DelegateSignature(class UCreativeGameStreamDeviceComponent* CreativeGameStreamDeviceComponent); // [0x246f7d8] MulticastDelegate|Public|Delegate 
	// Function /Script/CRD_GameStreamRuntime.CreativeGameStreamDeviceComponent.AddToEndGameQueue
	// void AddToEndGameQueue();                                                                                                // [0x3508bf8] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void OnMinigameStateChanged(class AFortMinigame* InMinigame, EFortMinigameState NewMinigameState);                       // [0x8d076cc] Final|Native|Private 
};
