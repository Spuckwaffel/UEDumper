...
public:
	...
	// FInstancedStruct MakeLookupProxyWithOverrideTable(class UProxyAsset* Proxy, class UProxyTable* ProxyTable);              // [0x7e44bdc] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/ProxyTable.ProxyTableFunctionLibrary.MakeLookupProxy
	// FInstancedStruct MakeLookupProxy(class UProxyAsset* Proxy);                                                              // [0x7e44acc] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/ProxyTable.ProxyTableFunctionLibrary.EvaluateProxyTable
	// class UObject* EvaluateProxyTable(class UObject* ContextObject, class UProxyTable* ProxyTable, FName Key);               // [0x7e44834] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/ProxyTable.ProxyTableFunctionLibrary.EvaluateProxyAsset
	// class UObject* EvaluateProxyAsset(class UObject* ContextObject, class UProxyAsset* Proxy, class UClass* ObjectClass);    // [0x7e445a0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
};
