...
public:
	...
	// void ServerTriggerAxis(FName AxisName, float Value);                                                                     // [0xae56a3c] Final|Net|NetReliableNative|Event|Private|NetServer|NetValidate 
	// Function /Script/EpicGamesEngine.VerseUEInputComponentBase.ServerTriggerAction
	// void ServerTriggerAction(FName ActionName, TEnumAsByte<EInputEvent> InputEvent);                                         // [0xae568c4] Final|Net|NetReliableNative|Event|Private|NetServer|NetValidate 
};
