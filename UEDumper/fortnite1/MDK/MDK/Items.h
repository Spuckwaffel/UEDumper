...
public:
	...
	CMember(class APlayerPawn_Athena_C*)               AthenaPawn                                                  OFFSET(get<T>, {0xD0, 8, 0, 0})
	...
	// void UpdateForGCNL();                                                                                                    // [0x246f7d8] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	...
	// void OnStatChanged_80A6FD2F402F11C0D0A207ACE25F03A6(FName StatName, int32_t StatValue);                                  // [0x246f7d8] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_VictoryCrownFrontEndPawnComponent(int32_t EntryPoint);                                             // [0x246f7d8] Final                
};
...
public:
	SMember(FPointerToUberGraphFrame)                  UberGraphFrame                                              OFFSET(getStruct<T>, {0x270, 8, 0, 0})
	...
	// void ExecuteUbergraph_VictoryCrownComponent(int32_t EntryPoint);                                                         // [0x246f7d8] Final                
};
