...
public:
	DMember(bool)                                      bIsMotorcycle                                               OFFSET(get<bool>, {0x1528, 1, 0, 0})
	DMember(bool)                                      bIsHookshot                                                 OFFSET(get<bool>, {0x1529, 1, 0, 0})
	DMember(bool)                                      bIsTechniqueActive                                          OFFSET(get<bool>, {0x152A, 1, 0, 0})
	DMember(bool)                                      bIsHadesAO                                                  OFFSET(get<bool>, {0x152B, 1, 0, 0})
	DMember(bool)                                      bIsUpperBodyReplacement                                     OFFSET(get<bool>, {0x152C, 1, 0, 0})
	SMember(FGameplayTag)                              MotorcycleTag                                               OFFSET(getStruct<T>, {0x1530, 4, 0, 0})
	SMember(FGameplayTag)                              HookshotTag                                                 OFFSET(getStruct<T>, {0x1534, 4, 0, 0})
	SMember(FGameplayTag)                              DisableGrindRailUpperBodyCorrectTag                         OFFSET(getStruct<T>, {0x1538, 4, 0, 0})
};
...
public:
	...
	// void SunRoseSpawnHookShotShooter();                                                                                      // [0x3508bf8] Final|Exec|Native|Public 
	// Function /Script/SunRoseChainWhipGameplay.FortCheatManager_SunRoseChainWhip.SunRoseRemoveHookShotShooter
	// void SunRoseRemoveHookShotShooter();                                                                                     // [0xb15fecc] Final|Exec|Native|Public 
	// Function /Script/SunRoseChainWhipGameplay.FortCheatManager_SunRoseChainWhip.SunRoseApplyHookShot
	// void SunRoseApplyHookShot(float Delay);                                                                                  // [0x674d700] Final|Exec|Native|Public 
};
