...
public:
	...
	// void SetMeshParts(TArray<UAssembledMeshSchema*> InMeshParts);                                                            // [0x75badc0] Final|Native|Private|BlueprintCallable 
	// Function /Script/AssembledMeshSystem.AssembledMeshUserComponent.SetMeshPart
	// void SetMeshPart(class UAssembledMeshSchema* InMeshPart);                                                                // [0x75bacb8] Final|Native|Private|BlueprintCallable 
	// Function /Script/AssembledMeshSystem.AssembledMeshUserComponent.OnRep_MeshParts
	// void OnRep_MeshParts();                                                                                                  // [0x75baca0] Native|Protected     
	// Function /Script/AssembledMeshSystem.AssembledMeshUserComponent.GetMeshPart
	// class UAssembledMeshSchema* GetMeshPart();                                                                               // [0x69b96b4] Final|Native|Private|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AssembledMeshSystem.AssembledMeshUserComponent.GetAttachToComponent
	// class USkeletalMeshComponent* GetAttachToComponent();                                                                    // [0x75bac78] Native|Event|Protected|BlueprintEvent 
	// Function /Script/AssembledMeshSystem.AssembledMeshUserComponent.GatherAndAssignAssembledMeshParts
	// void GatherAndAssignAssembledMeshParts();                                                                                // [0x3449a4c] Native|Public        
	// Function /Script/AssembledMeshSystem.AssembledMeshUserComponent.CustomizationCompleted
	// void CustomizationCompleted(int32_t PartIndex);                                                                          // [0x75babb4] Native|Protected     
};
