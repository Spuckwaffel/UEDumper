...
public:
	...
	// void SetSidewaysState(ESidewaysState SidewaysState);                                                                     // [0x876c600] Final|BlueprintAuthorityOnly|Exec|Native|Public 
};
...
public:
	...
	// void SetSidewaysState(ESidewaysState NewState, class ASidewaysPlayspace* NewSidewaysPlayspace);                          // [0xb83b494] Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
	// Function /Script/SidewaysCodeRuntime.SidewaysStateComponent.OnRep_SidewaysState
	// void OnRep_SidewaysState(ESidewaysState LastSidewaysState);                                                              // [0xb83b364] Final|Native|Protected 
	// Function /Script/SidewaysCodeRuntime.SidewaysStateComponent.OnRep_SidewaysPlayspace
	// void OnRep_SidewaysPlayspace(class ASidewaysPlayspace* NewSidewaysPlayspace);                                            // [0x6b19804] Final|Native|Protected 
	// Function /Script/SidewaysCodeRuntime.SidewaysStateComponent.HandleSidewaysStateChanged
	// void HandleSidewaysStateChanged(class ASidewaysPlayspace* NewSidewaysPlayspace, ESidewaysState OldState, ESidewaysState NewState); // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/SidewaysCodeRuntime.SidewaysStateComponent.GetSidewaysState
	// ESidewaysState GetSidewaysState();                                                                                       // [0x876ffe4] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// class USidewaysStateComponent* GetSidewaysStateComponent(class AActor* Owner);                                           // [0xb83b290] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// void RefreshActorsInSideways();                                                                                          // [0xb83b424] Final|Native|Public|BlueprintCallable 
	// Function /Script/SidewaysCodeRuntime.SidewaysPlayspace.NotifySizeChanged
	// void NotifySizeChanged();                                                                                                // [0xb83b350] Final|Native|Public|BlueprintCallable 
};
