...
public:
	...
	// void ServerQosRequest(FString InSessionId);                                                                              // [0x7970c28] Net|NetReliableNative|Event|Protected|NetServer|NetValidate 
	// Function /Script/Qos.QosBeaconClient.ClientQosResponse
	// void ClientQosResponse(EQosResponseType Response);                                                                       // [0x7970b64] Net|NetReliableNative|Event|Protected|NetClient 
};
