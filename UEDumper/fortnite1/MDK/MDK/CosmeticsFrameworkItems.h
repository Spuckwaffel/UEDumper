...
public:
	...
	// void ResetProperties();                                                                                                  // [0x75b5324] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/CosmeticsFrameworkItems.CosmeticDataComponent.BP_FindProperty
	// bool BP_FindProperty(FGameplayTag SlotTag, FGameplayTag PropertyTag, FCosmeticPropertyBase& OutProperty);                // [0x75b5104] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/CosmeticsFrameworkItems.CosmeticDataComponent.BP_AddOrOverrideProperty
	// bool BP_AddOrOverrideProperty(FGameplayTag SlotTag, FCosmeticPropertyBase& Property);                                    // [0x75b4f78] Final|Native|Public|HasOutParms|BlueprintCallable 
};
