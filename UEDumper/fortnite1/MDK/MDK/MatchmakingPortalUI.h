...
public:
	...
	// void OnCreativeReadyCheckStatusChanged(EInGameReadyCheckStatus InGameReadyCheckStatus);                                  // [0xc5b7a78] Final|Native|Protected 
};
...
public:
	...
	// void StartCountdown();                                                                                                   // [0x246f7d8] Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Script/MatchmakingPortalUI.FortMatchmakingPortalCountdown.HandleCancelClicked
	// void HandleCancelClicked();                                                                                              // [0xc5b7574] Final|Native|Protected|BlueprintCallable 
	// Function /Script/MatchmakingPortalUI.FortMatchmakingPortalCountdown.FinishTimer
	// void FinishTimer();                                                                                                      // [0x246f7d8] Event|Public|BlueprintCallable|BlueprintEvent 
};
...
public:
	CMember(class UFortActivityDetailsModal*)          MatchmakingPortalModalWidget                                OFFSET(get<T>, {0x428, 8, 0, 0})
	SMember(FVector)                                   WorldPointerLocation                                        OFFSET(getStruct<T>, {0x430, 24, 0, 0})
	SMember(FText)                                     CreatorNameTextFormat                                       OFFSET(getStruct<T>, {0x448, 16, 0, 0})
	...
	SMember(FMatchmakingPortalPopupData)               CachedIslandData                                            OFFSET(getStruct<T>, {0x468, 72, 0, 0})
	SMember(FText)                                     InvalidLinkCodeWarningText                                  OFFSET(getStruct<T>, {0x4B0, 16, 0, 0})
	DMember(float)                                     MatchmakingFeedbackDelayTime                                OFFSET(get<float>, {0x4C0, 4, 0, 0})
	DMember(bool)                                      bIsWithinPortalRange                                        OFFSET(get<bool>, {0x4C4, 1, 1, 0})
	CMember(class UCommonRichTextBlock*)               RichText_CreatorName                                        OFFSET(get<T>, {0x4C8, 8, 0, 0})
	CMember(class UCommonTextBlock*)                   Text_IslandName                                             OFFSET(get<T>, {0x4D0, 8, 0, 0})
	CMember(class UDynamicEntryBox*)                   EntryBox_ActivityTags                                       OFFSET(get<T>, {0x4D8, 8, 0, 0})
	CMember(class UFortKeybindWidget*)                 GlobalActionKeybindWidget                                   OFFSET(get<T>, {0x4E0, 8, 0, 0})
	CMember(class UClass*)                             CreatorPageViewClass                                        OFFSET(get<T>, {0x4E8, 8, 0, 0})
	CMember(class UClass*)                             AttributionsModalClass                                      OFFSET(get<T>, {0x4F0, 8, 0, 0})
	CMember(class UFortGameActivity*)                  CachedGameActivity                                          OFFSET(get<T>, {0x4F8, 8, 0, 0})
	SMember(FText)                                     InteractionMessage                                          OFFSET(getStruct<T>, {0x510, 16, 0, 0})
	SMember(FText)                                     InteractionMessage_Cancel                                   OFFSET(getStruct<T>, {0x520, 16, 0, 0})
	SMember(FText)                                     InteractionMessage_Disabled                                 OFFSET(getStruct<T>, {0x530, 16, 0, 0})
	SMember(FText)                                     InteractionMessage_PartyLeadOnly                            OFFSET(getStruct<T>, {0x540, 16, 0, 0})


	/// Functions
	// Function /Script/MatchmakingPortalUI.FortMatchmakingPortalPopup.UpdateVisuals
	// void UpdateVisuals(class UHeaderDescriptionHUDComponent* HUDComponent);                                                  // [0x246f7d8] Event|Public|BlueprintEvent 
	// Function /Script/MatchmakingPortalUI.FortMatchmakingPortalPopup.OnShowPortalPopup
	// void OnShowPortalPopup(bool bShow, bool bAnimate);                                                                       // [0x246f7d8] Event|Public|BlueprintEvent 
	// Function /Script/MatchmakingPortalUI.FortMatchmakingPortalPopup.OnPlayerCanInteractChanged
	// void OnPlayerCanInteractChanged(bool bPlayerCanInteract, FText& Message);                                                // [0x246f7d8] Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/MatchmakingPortalUI.FortMatchmakingPortalPopup.OnLockStateChanged
	// void OnLockStateChanged();                                                                                               // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/MatchmakingPortalUI.FortMatchmakingPortalPopup.IsInteractingDeviceAMatchmakingPortal
	// bool IsInteractingDeviceAMatchmakingPortal();                                                                            // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/MatchmakingPortalUI.FortMatchmakingPortalPopup.HasActivityToShow
	// bool HasActivityToShow();                                                                                                // [0xc5b79a8] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MatchmakingPortalUI.FortMatchmakingPortalPopup.HandleWidgetUpdate
	// void HandleWidgetUpdate();                                                                                               // [0xc5b7994] Final|Native|Public  
	// Function /Script/MatchmakingPortalUI.FortMatchmakingPortalPopup.HandleStartedRespawn
	// void HandleStartedRespawn(class AFortPlayerControllerZone* PlayerController);                                            // [0xc5b78d4] Final|Native|Public  
	// Function /Script/MatchmakingPortalUI.FortMatchmakingPortalPopup.HandleOnPortalDetailsVisibilityCheck
	// void HandleOnPortalDetailsVisibilityCheck(bool bShowWidget);                                                             // [0x246f7d8] Event|Protected|BlueprintCallable|BlueprintEvent 
	// Function /Script/MatchmakingPortalUI.FortMatchmakingPortalPopup.HandleLoadScreenChanged
	// void HandleLoadScreenChanged(class AFortPlayerControllerAthena* PlayerController, bool bLoadScreenEnabled, FText HUDReason); // [0xc5b76ec] Final|Native|Public  
	// Function /Script/MatchmakingPortalUI.FortMatchmakingPortalPopup.HandleHUDShow
	// void HandleHUDShow(bool bShow, bool bShouldAnimate);                                                                     // [0xc5b759c] Final|Native|Public  
	// Function /Script/MatchmakingPortalUI.FortMatchmakingPortalPopup.GetMatchmakingFeedbackWidget
	// class UFortAthenaCreativeMatchmakingWidget* GetMatchmakingFeedbackWidget(class UCommonActivatableWidget* MatchmakingFeedbackContainer); // [0x246f7d8] Event|Protected|BlueprintEvent|Const 
	// Function /Script/MatchmakingPortalUI.FortMatchmakingPortalPopup.GetIslandData
	// bool GetIslandData(FMatchmakingPortalPopupData& OutIslandData, class UHeaderDescriptionHUDComponent* HUDComponent);      // [0x246f7d8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/MatchmakingPortalUI.FortMatchmakingPortalPopup.BindOverlapEvents
	// void BindOverlapEvents();                                                                                                // [0x246f7d8] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void OnPreviewImageChanged(bool bIsLoading, class UTexture* InTexture);                                                  // [0x246f7d8] Event|Protected|BlueprintEvent 
};
