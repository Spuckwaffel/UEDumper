...
public:
	...
	// void UnloadConfig();                                                                                                     // [0xaf33c10] Final|Native|Public|BlueprintCallable 
	// Function /Script/MassSpawner.MassSpawner.ScaleSpawningCount
	// void ScaleSpawningCount(float Scale);                                                                                    // [0xaf33b4c] Final|Native|Public|BlueprintCallable 
	// Function /Script/MassSpawner.MassSpawner.GetSpawningCountScale
	// float GetSpawningCountScale();                                                                                           // [0xa7a0fc4] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MassSpawner.MassSpawner.GetCount
	// int32_t GetCount();                                                                                                      // [0xaf33b34] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MassSpawner.MassSpawner.DoSpawning
	// void DoSpawning();                                                                                                       // [0xaf33b20] Final|Native|Public|BlueprintCallable 
	// Function /Script/MassSpawner.MassSpawner.DoDespawning
	// void DoDespawning();                                                                                                     // [0xaf33b0c] Final|Native|Public|BlueprintCallable 
	// Function /Script/MassSpawner.MassSpawner.ClearTemplates
	// void ClearTemplates();                                                                                                   // [0xaf33af8] Final|Native|Public|BlueprintCallable 
};
