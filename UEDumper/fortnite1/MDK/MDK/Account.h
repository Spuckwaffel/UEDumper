...
public:
	...
	DMember(float)                                     OSSv2EosMcpAuthRate                                         OFFSET(get<float>, {0xE8, 4, 0, 0})
	DMember(float)                                     DefaultLoginStepTimeout                                     OFFSET(get<float>, {0x118, 4, 0, 0})
	CMember(TMap<FName, float>)                        CustomLoginStepTimeouts                                     OFFSET(get<T>, {0x120, 80, 0, 0})
	DMember(bool)                                      bEnableDevLoginStepTimeouts                                 OFFSET(get<bool>, {0x170, 1, 0, 0})
	DMember(float)                                     DefaultLogoutStepTimeout                                    OFFSET(get<float>, {0x1C8, 4, 0, 0})
	CMember(TMap<FName, float>)                        CustomLogoutStepTimeouts                                    OFFSET(get<T>, {0x1D0, 80, 0, 0})
	DMember(bool)                                      bEnableDevLogoutStepTimeouts                                OFFSET(get<bool>, {0x220, 1, 0, 0})
	SMember(FString)                                   RedeemAccessUrl                                             OFFSET(getStruct<T>, {0x288, 16, 0, 0})
	SMember(FString)                                   RequestFreeAccessUrl                                        OFFSET(getStruct<T>, {0x298, 16, 0, 0})
	SMember(FString)                                   RealGameAccessUrl                                           OFFSET(getStruct<T>, {0x2A8, 16, 0, 0})
	DMember(float)                                     SkipRedeemOfflinePurchasesChance                            OFFSET(get<float>, {0x2B8, 4, 0, 0})
	DMember(bool)                                      bUseFreeAccessInsteadOfGameAccess                           OFFSET(get<bool>, {0x2BC, 1, 0, 0})
	DMember(bool)                                      bShouldGrantFreeAccess                                      OFFSET(get<bool>, {0x2BD, 1, 0, 0})
	DMember(bool)                                      bAllowHomeSharingAccess                                     OFFSET(get<bool>, {0x2BF, 1, 0, 0})
	DMember(bool)                                      bRequireUGCPrivilege                                        OFFSET(get<bool>, {0x2C0, 1, 0, 0})
