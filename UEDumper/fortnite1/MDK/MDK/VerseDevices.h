...
public:
	...
	// void SetEnabled(bool bInEnabled);                                                                                        // [0xaf1ce90] Final|Native|Protected|BlueprintCallable 
	// Function /Script/VerseDevices.ScriptDevice.BP_SetVisibility
	// void BP_SetVisibility(bool bVisible);                                                                                    // [0x246f7d8] Event|Public|BlueprintEvent 
};
...
public:
	...
	// void HandleOnActorEndPlay(class AActor* Actor, TEnumAsByte<EEndPlayReason> EndPlayReason);                               // [0xaf1cd50] Final|Native|Private 
};
