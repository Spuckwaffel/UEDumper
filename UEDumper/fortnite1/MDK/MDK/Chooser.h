...
public:
	...
	// FInstancedStruct MakeEvaluateChooser(class UChooserTable* Chooser);                                                      // [0x7e43500] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/Chooser.ChooserFunctionLibrary.MakeChooserEvaluationContext
	// FChooserEvaluationContext MakeChooserEvaluationContext();                                                                // [0x7e43484] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/Chooser.ChooserFunctionLibrary.GetChooserStructOutput
	// void GetChooserStructOutput(FChooserEvaluationContext& Context, int32_t Index, int32_t& Value);                          // [0x7e4311c] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/Chooser.ChooserFunctionLibrary.EvaluateObjectChooserBaseMulti
	// TArray<UObject*> EvaluateObjectChooserBaseMulti(FChooserEvaluationContext& Context, FInstancedStruct& ObjectChooser, class UClass* ObjectClass, bool bResultIsClass); // [0x7e42dcc] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/Chooser.ChooserFunctionLibrary.EvaluateObjectChooserBase
	// class UObject* EvaluateObjectChooserBase(FChooserEvaluationContext& Context, FInstancedStruct& ObjectChooser, class UClass* ObjectClass, bool bResultIsClass); // [0x7e42a9c] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/Chooser.ChooserFunctionLibrary.EvaluateChooserMulti
	// TArray<UObject*> EvaluateChooserMulti(class UObject* ContextObject, class UChooserTable* ChooserTable, class UClass* ObjectClass); // [0x7e428a0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/Chooser.ChooserFunctionLibrary.EvaluateChooser
	// class UObject* EvaluateChooser(class UObject* ContextObject, class UChooserTable* ChooserTable, class UClass* ObjectClass); // [0x7e426cc] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/Chooser.ChooserFunctionLibrary.AddChooserStructInput
	// void AddChooserStructInput(FChooserEvaluationContext& Context, int32_t Value);                                           // [0x7e42464] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/Chooser.ChooserFunctionLibrary.AddChooserObjectInput
	// void AddChooserObjectInput(FChooserEvaluationContext& Context, class UObject* Object);                                   // [0x7e422a4] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
