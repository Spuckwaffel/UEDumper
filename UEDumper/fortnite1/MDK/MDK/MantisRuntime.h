...
public:
	...
	// void OnMantisTechniqueStarted(int32_t TechniqueIndex, FName TechniqueName);                                              // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/MantisRuntime.FortMantisAnimInstance.OnMantisTechniqueEnded
	// void OnMantisTechniqueEnded(int32_t TechniqueIndex, FName TechniqueName);                                                // [0x246f7d8] Event|Protected|BlueprintEvent 
};
...
public:
	SMember(FFortMantisReplicatedAnimInstanceInfo)     MantisAnimInstanceInfo                                      OFFSET(getStruct<T>, {0x1528, 16, 0, 0})
...
public:
	...
	// void OnMontageFinished();                                                                                                // [0xb144e28] Final|Native|Protected 
	// Function /Script/MantisRuntime.FortGameplayAbility_Mantis.OnMontageCancelled
	// void OnMontageCancelled();                                                                                               // [0xb144e14] Final|Native|Protected 
	// Function /Script/MantisRuntime.FortGameplayAbility_Mantis.GetLevelForGameplayEffectContainer
	// int32_t GetLevelForGameplayEffectContainer(FGameplayTag ApplicationTag);                                                 // [0xb14494c] Native|Event|Protected|BlueprintEvent|Const 
	// Function /Script/MantisRuntime.FortGameplayAbility_Mantis.GetDynamicMontageNameForTechnique
	// FName GetDynamicMontageNameForTechnique(FName TechniqueName);                                                            // [0xb144880] Native|Event|Protected|BlueprintEvent|Const 
	// Function /Script/MantisRuntime.FortGameplayAbility_Mantis.FillMetadataForTechnique
	// void FillMetadataForTechnique(FName TechniqueName, FFortMantisTechniqueMetadata& OutTechniqueMetadata);                  // [0x246f7d8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/MantisRuntime.FortGameplayAbility_Mantis.ConfigureRootMotionWarpingAlternativeBehavior
	// void ConfigureRootMotionWarpingAlternativeBehavior(FName TechniqueName, class AActor*& OutTargetActor, bool& bOutSnapshotTargetActorLocation, EFortMantisWarpTranslationMethod& OutWarpTranslationMethod, FVector& OutWarpTranslationVector, EFortMantisWarpRotationMethod& OutWarpRotationMethod, FRotator& OutStaticRotation); // [0x246f7d8] Event|Protected|HasOutParms|HasDefaults|BlueprintEvent 
	// Function /Script/MantisRuntime.FortGameplayAbility_Mantis.ConfigureRootMotionWarping
	// void ConfigureRootMotionWarping(FName TechniqueName, bool& bOutAllowTranslationWarp, bool& bOutAllowRotationWarp, class AActor*& OutTargetActor, bool& bOutSnapshotTargetActorLocation, bool& bOutWarpTranslationToLocation, FVector& outTargetLocation); // [0xb144598] Native|Event|Protected|HasOutParms|HasDefaults|BlueprintEvent 
	// Function /Script/MantisRuntime.FortGameplayAbility_Mantis.BP_OnTechniqueNotifyWindowStarted
	// void BP_OnTechniqueNotifyWindowStarted(EFortMantisNotifyWindow NotifyWindow, class UFortAnimNotifyState_Mantis* Notify); // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/MantisRuntime.FortGameplayAbility_Mantis.BP_OnTechniqueNotifyWindowEnded
	// void BP_OnTechniqueNotifyWindowEnded(EFortMantisNotifyWindow NotifyWindow, class UFortAnimNotifyState_Mantis* Notify);   // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/MantisRuntime.FortGameplayAbility_Mantis.BP_OnTechniqueNotifyEvent
	// void BP_OnTechniqueNotifyEvent(EFortMantisNotifyEvent NotifyEvent, class UFortAnimNotify_Mantis* Notify);                // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/MantisRuntime.FortGameplayAbility_Mantis.BP_OnMantisTechniqueHit
	// void BP_OnMantisTechniqueHit(FGameplayAbilityTargetDataHandle& TargetDataHandle, FGameplayTag ApplicationTag);           // [0x246f7d8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/MantisRuntime.FortGameplayAbility_Mantis.BP_OnMantisPreTechniqueSelection
	// void BP_OnMantisPreTechniqueSelection();                                                                                 // [0x246f7d8] BlueprintCosmetic|Event|Protected|BlueprintEvent 
	// Function /Script/MantisRuntime.FortGameplayAbility_Mantis.BP_OnMantisInputEvent
	// void BP_OnMantisInputEvent(EFortMantisTechniqueActivationInputType InputType, EFortMantisTechniqueActivationTimingType InputTiming, bool bDidInputStartTechnique, bool bDidInputQueueTechnique, float InputHeldDuration); // [0x246f7d8] BlueprintCosmetic|Event|Protected|BlueprintEvent 
	// Function /Script/MantisRuntime.FortGameplayAbility_Mantis.BP_MantisAbilityTechniqueStarted
	// void BP_MantisAbilityTechniqueStarted(FGameplayTagContainer OwningTags, FName SequenceName, bool StartsSequence, bool EndsSequence); // [0x246f7d8] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// bool TryManuallyStartTechnique(int32_t TechniqueDataIndex);                                                              // [0xb145a8c] Final|Native|Public|BlueprintCallable 
	// Function /Script/MantisRuntime.FortMantisPawnComponent.TryManuallyEndCurrentTechnique
	// bool TryManuallyEndCurrentTechnique();                                                                                   // [0xb145a38] Final|Native|Public|BlueprintCallable 
	// Function /Script/MantisRuntime.FortMantisPawnComponent.SimulateInputEvent
	// void SimulateInputEvent(EFortMantisTechniqueActivationInputType InputType, EFortMantisTechniqueActivationTimingType InputTiming, bool bForceProcessEvent); // [0xb14587c] Final|Native|Public|BlueprintCallable 
	// Function /Script/MantisRuntime.FortMantisPawnComponent.SetLockOnState
	// void SetLockOnState(bool bEnabled, class AActor* TargetActor);                                                           // [0xb14568c] Final|Native|Public|BlueprintCallable 
	// Function /Script/MantisRuntime.FortMantisPawnComponent.SetBranchRule
	// void SetBranchRule(EFortMantisBranchRule InBranchRule, EFortMantisBranchPath InBranchPath);                              // [0xb145550] Final|Native|Protected|BlueprintCallable 
	// Function /Script/MantisRuntime.FortMantisPawnComponent.OnPostPhysicsRotation
	// void OnPostPhysicsRotation(class UCharacterMovementComponent* CharMoveComp, float DeltaSeconds);                         // [0xb144e50] Final|Native|Protected 
	// Function /Script/MantisRuntime.FortMantisPawnComponent.OnOwnerWeaponHolstered
	// void OnOwnerWeaponHolstered();                                                                                           // [0xb144e3c] Final|Native|Protected 
	// Function /Script/MantisRuntime.FortMantisPawnComponent.OnCharacterMovementPreUpdate
	// void OnCharacterMovementPreUpdate(class UCharacterMovementComponent* CharMoveComp, float DeltaSeconds);                  // [0xb144c14] Final|Native|Protected 
	// Function /Script/MantisRuntime.FortMantisPawnComponent.IsSpecificInputPressed
	// bool IsSpecificInputPressed(EFortMantisTechniqueActivationInputType InputType);                                          // [0xb144b24] Final|Native|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MantisRuntime.FortMantisPawnComponent.IsPerformingLockOn
	// bool IsPerformingLockOn();                                                                                               // [0xb144b08] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MantisRuntime.FortMantisPawnComponent.HasLockOnTarget
	// bool HasLockOnTarget();                                                                                                  // [0xb144ac8] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MantisRuntime.FortMantisPawnComponent.HasCurrentTechniqueMetadataBeenSet
	// bool HasCurrentTechniqueMetadataBeenSet();                                                                               // [0xb144ab0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MantisRuntime.FortMantisPawnComponent.GetMontageForCurrentTechnique
	// class UAnimMontage* GetMontageForCurrentTechnique();                                                                     // [0xb144a44] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MantisRuntime.FortMantisPawnComponent.GetLockOnTarget
	// class AActor* GetLockOnTarget();                                                                                         // [0xb144a20] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MantisRuntime.FortMantisPawnComponent.GetCurrentTechniqueMetadata
	// FFortMantisTechniqueMetadata GetCurrentTechniqueMetadata();                                                              // [0xb144864] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void OnWeaponAbilitiesRemoved(class AFortWeapon* Weapon, EFortWeaponAbilityRemovalReason RemovalReason);                 // [0xb145410] Final|Native|Protected 
	// Function /Script/MantisRuntime.FortMantisWeaponComponent.OnUnEquip
	// void OnUnEquip(class AFortWeapon* Weapon);                                                                               // [0xb145350] Final|Native|Protected 
	// Function /Script/MantisRuntime.FortMantisWeaponComponent.OnRep_ReplayAnimInstanceInfo
	// void OnRep_ReplayAnimInstanceInfo();                                                                                     // [0x2d876ac] Final|Native|Protected 
	// Function /Script/MantisRuntime.FortMantisWeaponComponent.OnReleaseTrigger
	// void OnReleaseTrigger(class AFortWeapon* Weapon);                                                                        // [0xb145290] Final|Native|Protected 
	// Function /Script/MantisRuntime.FortMantisWeaponComponent.OnReleaseSecondaryFire
	// void OnReleaseSecondaryFire(class AFortWeapon* Weapon);                                                                  // [0x2d87474] Final|Native|Protected 
	// Function /Script/MantisRuntime.FortMantisWeaponComponent.OnPressTrigger
	// void OnPressTrigger(class AFortWeapon* Weapon);                                                                          // [0xb1451d0] Final|Native|Protected 
	// Function /Script/MantisRuntime.FortMantisWeaponComponent.OnPressSecondaryFire
	// void OnPressSecondaryFire(class AFortWeapon* Weapon);                                                                    // [0xb145110] Final|Native|Protected 
	// Function /Script/MantisRuntime.FortMantisWeaponComponent.OnPreActivateSecondaryAbility
	// void OnPreActivateSecondaryAbility(class AFortWeapon* Weapon);                                                           // [0xb145050] Final|Native|Protected 
	// Function /Script/MantisRuntime.FortMantisWeaponComponent.OnPreActivatePrimaryAbility
	// void OnPreActivatePrimaryAbility(class AFortWeapon* Weapon);                                                             // [0xb144f90] Final|Native|Protected 
	// Function /Script/MantisRuntime.FortMantisWeaponComponent.OnEquip
	// void OnEquip(class AFortWeapon* Weapon);                                                                                 // [0xb144d54] Final|Native|Protected 
	// Function /Script/MantisRuntime.FortMantisWeaponComponent.GetAnimInstanceInfo
	// FFortMantisReplicatedAnimInstanceInfo GetAnimInstanceInfo();                                                             // [0xafb9230] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
