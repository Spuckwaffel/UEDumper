...
public:
	CMember(class UAnimMontage*)                       AnimMontage                                                 OFFSET(get<T>, {0x18, 8, 0, 0})
	SMember(FName)                                     MontageStartSectionName                                     OFFSET(getStruct<T>, {0x20, 4, 0, 0})
	SMember(FName)                                     MontageMiddleSectionName                                    OFFSET(getStruct<T>, {0x24, 4, 0, 0})
	SMember(FSynchedActionWarpPointInfo_Replicated)    SynchedActionWarpPointInfo                                  OFFSET(getStruct<T>, {0x30, 160, 0, 0})
};
