...
{ 
	friend MDKHandler;
	static inline constexpr uint64_t __MDKClassSize = 6496;

public:
	CMember(class UJunoAIInventoryComponent*)          JunoAIInventoryComponent                                    OFFSET(get<T>, {0x1760, 8, 0, 0})
	CMember(TArray<FItemAndCount>)                     DefaultItemsToAdd                                           OFFSET(get<T>, {0x1768, 16, 0, 0})
	DMember(bool)                                      bRequiresPersistentInventory                                OFFSET(get<bool>, {0x1801, 1, 0, 0})
	SMember(FScalableFloat)                            EnableDurabilityOnInventory                                 OFFSET(getStruct<T>, {0x1808, 40, 0, 0})
	SMember(FScalableFloat)                            UseRoleCheckForDurability                                   OFFSET(getStruct<T>, {0x1830, 40, 0, 0})
	SMember(FGameplayTagQuery)                         RequiredRoleForDurability                                   OFFSET(getStruct<T>, {0x1858, 72, 0, 0})
	DMember(bool)                                      bUseFocusedActorEyeLocationForFocalPoint                    OFFSET(get<bool>, {0x18A0, 1, 0, 0})
	DMember(bool)                                      bUseValidItemsPerType                                       OFFSET(get<bool>, {0x18A1, 1, 0, 0})
	SMember(FScalableFloat)                            EffectivenessMultiplierForWeaponSelectionOnPickedOrAddedItem OFFSET(getStruct<T>, {0x18A8, 40, 0, 0})
	CMember(TMap<FGameplayTag, FValidItemSlotConfiguration>) ValidItemsTablePerType                                OFFSET(get<T>, {0x18D0, 80, 0, 0})
	CMember(class UFortItemDefinition*)                AutomaticallyEquippedWeaponOnDurabilityBreak                OFFSET(get<T>, {0x1920, 8, 0, 0})
	SMember(FScalableFloat)                            DurabilityMultiplier                                        OFFSET(getStruct<T>, {0x1928, 40, 0, 0})
	SMember(FGameplayTag)                              TagToApplyWhenAddingFallbackItemForDurabilityBreak          OFFSET(getStruct<T>, {0x1950, 4, 0, 0})
};
...
public:
	...
	SMember(FMulticastInlineDelegate)                  OnFriendshipValueChangedDelegate                            OFFSET(getStruct<T>, {0x2D8, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  OnFriendshipStateChangedDelegate                            OFFSET(getStruct<T>, {0x300, 16, 0, 0})
	DMember(float)                                     FriendshipValue                                             OFFSET(get<float>, {0x314, 4, 0, 0})
	SMember(FGameplayTag)                              FriendshipState                                             OFFSET(getStruct<T>, {0x318, 4, 0, 0})


	/// Functions
	// Function /Script/JunoAIRuntime.JunoAIFriendshipPawnComponent.HandleUnconverted
	// void HandleUnconverted(class AFortPawn* UnconvertedPawn, EUnconvertReason UnconvertReason);                              // [0xc65f264] Final|Native|Private 
	// Function /Script/JunoAIRuntime.JunoAIFriendshipPawnComponent.HandleConverted
	// void HandleConverted(class AFortPawn* InstigatorPawn, class AFortPawn* ConvertedPawn);                                   // [0xc65ec78] Final|Native|Private 
	// Function /Script/JunoAIRuntime.JunoAIFriendshipPawnComponent.GetFriendshipValue
	// float GetFriendshipValue();                                                                                              // [0xc65eae0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoAIRuntime.JunoAIFriendshipPawnComponent.GetFriendshipState
	// FGameplayTag GetFriendshipState();                                                                                       // [0xc65eac8] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoAIRuntime.JunoAIFriendshipPawnComponent.EnableFriendshipChanges
	// bool EnableFriendshipChanges();                                                                                          // [0xc65eaa4] Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
	// Function /Script/JunoAIRuntime.JunoAIFriendshipPawnComponent.DisableFriendshipChanges
	// bool DisableFriendshipChanges();                                                                                         // [0xc65ea80] Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
	// Function /Script/JunoAIRuntime.JunoAIFriendshipPawnComponent.AreFriendshipChangesEnabled
	// bool AreFriendshipChangesEnabled();                                                                                      // [0xc65ea68] Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void HandleCreatureControllerFullySpawned(class AAIController* Controller, class AFortPawn* Pawn);                       // [0xc65f058] Final|Native|Protected 
	// Function /Script/JunoAIRuntime.JunoCampAIManagementComponent.HandleCreatureControllerChanged
	// void HandleCreatureControllerChanged(class APawn* Pawn, class AController* OldController, class AController* NewController); // [0xc65edb8] Final|Native|Protected 
	// Function /Script/JunoAIRuntime.JunoCampAIManagementComponent.HandleAISpawned
	// void HandleAISpawned(class AActor* SpawnedAIPawn);                                                                       // [0xc65eaf8] Final|Native|Protected 
};
...
public:
	...
	SMember(FAIFriendshipContinuousChangeConfiguration) ContinuousFriendshipChangeConfigurationWhenNoInteractions  OFFSET(getStruct<T>, {0xAC, 12, 0, 0})
	...
	// bool RecruitToCampIfPossible();                                                                                          // [0xc66aaa0] Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoAIRuntime.JunoCreaturePawnComponent.NotifyPetting
	// void NotifyPetting(class AFortPawn* Instigator);                                                                         // [0xc66a824] Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
	// Function /Script/JunoAIRuntime.JunoCreaturePawnComponent.NotifyFeeding
	// void NotifyFeeding(class AFortPawn* Instigator, class UFortItemDefinition* ItemBeingFed);                                // [0xc66a6e4] Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
	// Function /Script/JunoAIRuntime.JunoCreaturePawnComponent.HandleUnconverted
	// void HandleUnconverted(class AFortPawn* UnconvertedPawn, EUnconvertReason UnconvertReason);                              // [0xc66a5a4] Final|Native|Private 
	// Function /Script/JunoAIRuntime.JunoCreaturePawnComponent.HandleDied
	// void HandleDied(class AActor* DamagedActor, float Damage, class AController* InstigatedBy, class AActor* DamageCauser, FVector HitLocation, class UPrimitiveComponent* FHitComponent, FName BoneName, FVector Momentum); // [0xc66a090] Final|Native|Private|HasDefaults 
	// Function /Script/JunoAIRuntime.JunoCreaturePawnComponent.HandleConverted
	// void HandleConverted(class AFortPawn* InstigatorPawn, class AFortPawn* ConvertedPawn);                                   // [0xc669f50] Final|Native|Private 
};
...
public:
	...
	// FGameplayTagContainer GetSoftRemovedReasons();                                                                           // [0xc669f34] Final|Native|Private|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoAIRuntime.JunoNPCPawnComponent.GetAIRoleDisplayText
	// FText GetAIRoleDisplayText();                                                                                            // [0xc669f00] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoAIRuntime.JunoNPCPawnComponent.GetAIRole
	// FGameplayTag GetAIRole();                                                                                                // [0x805b62c] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoAIRuntime.JunoNPCPawnComponent.ConvertAIRoleToDisplayText
	// FText ConvertAIRoleToDisplayText(FGameplayTag& AIRole);                                                                  // [0xc669e20] Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	CMember(TArray<FJunoAIFollowerManagedData>)        ManagedFollowers                                            OFFSET(get<T>, {0xE10, 16, 0, 0})
	CMember(TScriptInterface<Class>)                   TemporaryGlobalEncounterPointProvider                       OFFSET(get<T>, {0xE20, 16, 0, 0})
	CMember(class UFortAthenaLivingWorldEncounterInstance*) TemporaryGlobalEncounter                               OFFSET(get<T>, {0xE30, 8, 0, 0})
	CMember(TScriptInterface<Class>)                   FTUEEncounterPointProvider                                  OFFSET(get<T>, {0xE38, 16, 0, 0})
	CMember(class UFortAthenaLivingWorldEncounterInstance*) FTUEEncounter                                          OFFSET(get<T>, {0xE48, 8, 0, 0})
	SMember(FWorldConditionQueryState)                 FTUEEndQueryState                                           OFFSET(getStruct<T>, {0xE50, 48, 0, 0})
	CMember(TMap<FGameplayTag, FJunoAIWorldNPCSpawningData>) WorldAssignedNPCs                                     OFFSET(get<T>, {0xF40, 80, 0, 0})


	/// Functions
	// Function /Script/JunoAIRuntime.PlayspaceComponent_Root_JunoAIManagement.HandleFTUENPCSpawned
	// void HandleFTUENPCSpawned(class AActor* FTUENPC);                                                                        // [0xc66a4e4] Final|Native|Private 
};
...
public:
	...
	// void OnTimeOfDayPhaseChanged(EFortDayPhase CurrentDayPhase, EFortDayPhase PreviousDayPhase, bool bAtCreation);           // [0xc66a8e4] Final|Native|Protected 
};
...
public:
	...
	// void JunoEnableHostileCreatures(bool bEnable);                                                                           // [0x62ffeb0] Final|BlueprintAuthorityOnly|Exec|Native|Private 
	// Function /Script/JunoAIRuntime.JunoAICheatManager.JunoEnableFriendlyNPCs
	// void JunoEnableFriendlyNPCs(bool bEnable);                                                                               // [0x62ffeb0] Final|BlueprintAuthorityOnly|Exec|Native|Private 
	// Function /Script/JunoAIRuntime.JunoAICheatManager.JunoEnableFriendlyCreatures
	// void JunoEnableFriendlyCreatures(bool bEnable);                                                                          // [0x62ffeb0] Final|BlueprintAuthorityOnly|Exec|Native|Private 
};
