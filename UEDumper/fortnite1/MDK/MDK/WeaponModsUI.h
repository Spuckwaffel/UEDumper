...
public:
	...
	// void SetItemSlotInfo(FFortWeaponModSlot& ModSlot);                                                                       // [0x246f7d8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/WeaponModsUI.AthenaEquippedItemInfoWeaponMods.ResetItemInfo
	// void ResetItemInfo();                                                                                                    // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/WeaponModsUI.AthenaEquippedItemInfoWeaponMods.HandleWeaponFullyEquipped
	// void HandleWeaponFullyEquipped(class AFortWeapon* NewWeapon, class AFortWeapon* PrevWeapon);                             // [0xbbc082c] Final|Native|Private 
};
...
public:
	...
	// void HandleButtonClicked(class UObject* Object);                                                                         // [0xbbc02ac] Final|Native|Protected|BlueprintCallable 
	// Function /Script/WeaponModsUI.AthenaInventoryGroupWeaponMods.CanWeaponEquipMod
	// bool CanWeaponEquipMod(class AFortWeapon* Weapon, class UFortWeaponModItemDefinition* Mod);                              // [0xbbc0158] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void UpdateItemMods();                                                                                                   // [0xbbc042c] Final|Native|Protected|BlueprintCallable 
	...
	// void SetIsModifiableWeapon(bool bIsModifiable);                                                                          // [0x246f7d8] Event|Protected|BlueprintEvent 
	...
	// void HandleWeaponModSlotsChanged(class AFortWeapon* Weapon);                                                             // [0xbbc09d8] Final|Native|Private 
	// Function /Script/WeaponModsUI.AthenaInventoryItemInfoWeaponMods.HandleInventoryPanelOpened
	// void HandleInventoryPanelOpened();                                                                                       // [0xbbc042c] Final|Native|Private 
	// Function /Script/WeaponModsUI.AthenaInventoryItemInfoWeaponMods.HandleInventoryItemSelected
	// void HandleInventoryItemSelected(class UFortItem* SelectedItem);                                                         // [0xbbc036c] Final|Native|Private 
};
...
public:
	...
	// void RemoveMod(class UFortWeaponModItemDefinition* ModItemDef);                                                          // [0xbbc0bfc] Final|Native|Protected|BlueprintCallable 
};
...
public:
	...
	// void SetKillerWeaponMods(TArray<FFortWeaponModSlot>& ModSlots);                                                          // [0x246f7d8] Event|Protected|HasOutParms|BlueprintEvent 
};
...
public:
	...
	// void SetItemModifiedWeaponName(FText& ModifiedWeaponName);                                                               // [0x246f7d8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/WeaponModsUI.AthenaPickupIndicatorWeaponMods.SetEquippedWeaponItemSlotInfo
	// void SetEquippedWeaponItemSlotInfo(FFortWeaponModSlot& ModSlot);                                                         // [0x246f7d8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/WeaponModsUI.AthenaPickupIndicatorWeaponMods.SetEquippedWeaponItemInfo
	// void SetEquippedWeaponItemInfo(class UItemDefinitionBase* ItemDef);                                                      // [0x246f7d8] Event|Protected|BlueprintEvent 
	...
	// bool IsInspectViewCollapsedBySettings();                                                                                 // [0xbbc0bb4] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/WeaponModsUI.AthenaPickupIndicatorWeaponMods.HandleWeaponEquipped
	// void HandleWeaponEquipped(class AFortWeapon* NewWeapon, class AFortWeapon* PrevWeapon);                                  // [0xbbc063c] Final|Native|Protected 
	// Function /Script/WeaponModsUI.AthenaPickupIndicatorWeaponMods.HandlePickupHovered
	// void HandlePickupHovered(class AFortPickup* Pickup);                                                                     // [0xbbc0440] Final|Native|Public|BlueprintCallable 
};

/// Class /Script/WeaponModsUI.AthenaQuickBarSlotWeaponModsIndicator
/// Size: 0x0018 (0x0002F8 - 0x000310)
...
public:
	...
	// void SetItemSlotsInfo(TArray<FFortWeaponModSlot>& ModSlots);                                                             // [0x246f7d8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/WeaponModsUI.AthenaQuickBarSlotWeaponModsIndicator.SetItemSlotSelected
	// void SetItemSlotSelected(bool bIsSelected);                                                                              // [0x246f7d8] Event|Protected|BlueprintEvent 
	...
	// void HandleWeaponModSlotsChanged(class AFortWeapon* Weapon);                                                             // [0xbbc0a98] Final|Native|Private 
	// Function /Script/WeaponModsUI.AthenaQuickBarSlotWeaponModsIndicator.HandleWeaponFullyEquipped
	// void HandleWeaponFullyEquipped(class AFortWeapon* NewWeapon, class AFortWeapon* PrevWeapon);                             // [0x2ce1514] Final|Native|Private 
	// Function /Script/WeaponModsUI.AthenaQuickBarSlotWeaponModsIndicator.HandleQuickBarSlotFocusChanged
	// void HandleQuickBarSlotFocusChanged(EFortQuickBars QuickBarType, int32_t QuickBarSlot);                                  // [0xbbc0500] Final|Native|Private 
};
