...
public:
	...
	// void OnProxyDataChanged(class ACreativePlayerReplicationProxy* ProxyData);                                               // [0xc1f76d0] Final|Native|Private 
	// Function /Script/CRD_AudioMixerRuntime.CreativeAudioMixerDevice.OnPreAnyPropertyChanged
	// void OnPreAnyPropertyChanged();                                                                                          // [0xc1f76bc] Final|Native|Private 
	// Function /Script/CRD_AudioMixerRuntime.CreativeAudioMixerDevice.OnPlayerUnregistered
	// void OnPlayerUnregistered(class AFortPlayerState* PlayerState);                                                          // [0xc1f75f4] Final|Native|Private 
	// Function /Script/CRD_AudioMixerRuntime.CreativeAudioMixerDevice.OnPlayerRegistered
	// void OnPlayerRegistered(class AFortPlayerState* PlayerState);                                                            // [0xc1f752c] Final|Native|Private 
	// Function /Script/CRD_AudioMixerRuntime.CreativeAudioMixerDevice.OnPlayerAdded
	// void OnPlayerAdded(FUniqueNetIdRepl NetId, bool bIsLocalPlayer);                                                         // [0xc1f7384] Final|Native|Private 
	// Function /Script/CRD_AudioMixerRuntime.CreativeAudioMixerDevice.OnMinigameStarted
	// void OnMinigameStarted();                                                                                                // [0xc1f7368] Final|Native|Private 
	// Function /Script/CRD_AudioMixerRuntime.CreativeAudioMixerDevice.OnMinigameEnded
	// void OnMinigameEnded();                                                                                                  // [0xc1f734c] Final|Native|Private 
	// Function /Script/CRD_AudioMixerRuntime.CreativeAudioMixerDevice.OnAllPlayersUnregistered
	// void OnAllPlayersUnregistered();                                                                                         // [0xc1f7330] Final|Native|Private 
	// Function /Script/CRD_AudioMixerRuntime.CreativeAudioMixerDevice.DeactivateMix
	// void DeactivateMix();                                                                                                    // [0x3508bf8] Final|Native|Public|BlueprintCallable 
	// Function /Script/CRD_AudioMixerRuntime.CreativeAudioMixerDevice.ActivateMix
	// void ActivateMix();                                                                                                      // [0x3508bf8] Final|Native|Public|BlueprintCallable 
};
