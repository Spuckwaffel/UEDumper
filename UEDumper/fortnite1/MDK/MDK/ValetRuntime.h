...
public:
	...
	// void SetState_GT(FDagwoodInPersistent& In);                                                                              // [0xb0e2e8c] Final|Native|Public|HasOutParms 
	// Function /Script/ValetRuntime.DagwoodNetworkPhysicsComponent.SetPendingInputCmd
	// void SetPendingInputCmd(FFortDagwoodCmd& In);                                                                            // [0xb0e29bc] Final|Native|Public|HasOutParms 
	// Function /Script/ValetRuntime.DagwoodNetworkPhysicsComponent.OnGeneratedLocalInputCmd__DelegateSignature
	// void OnGeneratedLocalInputCmd__DelegateSignature();                                                                      // [0x246f7d8] MulticastDelegate|Public|Delegate 
	// Function /Script/ValetRuntime.DagwoodNetworkPhysicsComponent.GetState_PT
	// FDagwoodState_PT GetState_PT();                                                                                          // [0xb0e1410] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ValetRuntime.DagwoodNetworkPhysicsComponent.GetState_GT
	// FDagwoodInPersistent GetState_GT();                                                                                      // [0xb0e13a4] Final|Native|Public|Const 
	// Function /Script/ValetRuntime.DagwoodNetworkPhysicsComponent.GetPendingInputCmd
	// FFortDagwoodCmd GetPendingInputCmd();                                                                                    // [0xb0e1370] Final|Native|Public|Const 
};
...
public:
	...
	// void OnPlaylistLoaded(FName PlaylistName, FGameplayTagContainer& PlaylistContainerTags);                                 // [0x87731b4] Final|Native|Public|HasOutParms 
};
...
public:
	...
	// void HandleVehicleStateChanged(class AFortPlayerPawn* PlayerPawn, class AActor* NewVehicle, class AActor* OldVehicle);   // [0xb0e17a0] Final|Native|Private 
	// Function /Script/ValetRuntime.FortContextualTutorial_VehicleValetLowFuel.HandleStartSkydivingForActivation
	// void HandleStartSkydivingForActivation();                                                                                // [0xb0e178c] Final|Native|Private 
};
...
public:
	SMember(FMulticastInlineDelegate)                  OnStartHandbrakeDelegate                                    OFFSET(getStruct<T>, {0x1FE0, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  OnStopHandbrakeDelegate                                     OFFSET(getStruct<T>, {0x1FF0, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  OnStartHandBrakeCatchupForceDelegate                        OFFSET(getStruct<T>, {0x2000, 16, 0, 0})
	CMember(class UClass*)                             HardLandingCameraShake                                      OFFSET(get<T>, {0x2010, 8, 0, 0})
	CMember(class UClass*)                             DriverCamShakeClass                                         OFFSET(get<T>, {0x2018, 8, 0, 0})
	CMember(class UClass*)                             HandBrakeCamShakeClass                                      OFFSET(get<T>, {0x2020, 8, 0, 0})
	CMember(EVehicleClass)                             VehicleClass                                                OFFSET(get<T>, {0x2028, 1, 0, 0})
	DMember(float)                                     FadeDelay                                                   OFFSET(get<float>, {0x202C, 4, 0, 0})
	DMember(float)                                     FadeDuration                                                OFFSET(get<float>, {0x2030, 4, 0, 0})
	DMember(float)                                     MinBrakeForceForSkid                                        OFFSET(get<float>, {0x2034, 4, 0, 0})
	DMember(float)                                     MinForwardSpeedForSkid                                      OFFSET(get<float>, {0x2038, 4, 0, 0})
	SMember(FGameplayTag)                              SpeedLinesCueTag                                            OFFSET(getStruct<T>, {0x203C, 4, 0, 0})
	DMember(float)                                     FadeStartTime                                               OFFSET(get<float>, {0x2040, 4, 0, 0})
	CMember(class UDagwoodNetworkPhysicsComponent*)    NetworkPhysicsComponent                                     OFFSET(get<T>, {0x2048, 8, 0, 0})
	SMember(FMulticastInlineDelegate)                  OnTireModHealthChanged                                      OFFSET(getStruct<T>, {0x20C8, 16, 0, 0})
	DMember(float)                                     RechargeableBoostPercent                                    OFFSET(get<float>, {0x20D8, 4, 0, 0})
	CMember(class UFortSplatterSourceComponent*)       SplatterSourceComp                                          OFFSET(get<T>, {0x20E0, 8, 0, 0})
	DMember(bool)                                      bEnableNativizedTick                                        OFFSET(get<bool>, {0x20E8, 1, 0, 0})
	CMember(TArray<FName>)                             PassengerLeanSockets                                        OFFSET(get<T>, {0x20F0, 16, 0, 0})
	CMember(TArray<FVector>)                           PassngerLeanRelativeOffsets                                 OFFSET(get<T>, {0x2100, 16, 0, 0})
	CMember(class UClass*)                             PassengerCameraModeClass                                    OFFSET(get<T>, {0x2110, 8, 0, 0})
	CMember(class UClass*)                             PassengerCameraModeClass_ADS                                OFFSET(get<T>, {0x2118, 8, 0, 0})
	CMember(TArray<FName>)                             WheelSocketNames                                            OFFSET(get<T>, {0x2120, 16, 0, 0})
	CMember(class UFortDagwoodVehicleConfigs*)         FortDagwoodVehicleConfigs                                   OFFSET(get<T>, {0x2130, 8, 0, 0})
	CMember(TArray<int32_t>)                           RearShocks                                                  OFFSET(get<T>, {0x2138, 16, 0, 0})
	SMember(FGameplayTagContainer)                     OffroadEnvironmentDamageTags                                OFFSET(getStruct<T>, {0x2148, 32, 0, 0})
	SMember(FGameplayTagContainer)                     FireDamageTags                                              OFFSET(getStruct<T>, {0x2168, 32, 0, 0})
	SMember(FVector)                                   NativeWheelScaleRear                                        OFFSET(getStruct<T>, {0x2188, 24, 0, 0})
	SMember(FVector)                                   NativeWheelScaleFront                                       OFFSET(getStruct<T>, {0x21A0, 24, 0, 0})
	SMember(FVector)                                   NativeTireScaleRear                                         OFFSET(getStruct<T>, {0x21B8, 24, 0, 0})
	SMember(FVector)                                   NativeTireScaleFront                                        OFFSET(getStruct<T>, {0x21D0, 24, 0, 0})
	DMember(bool)                                      bTireSmokeActive                                            OFFSET(get<bool>, {0x21E8, 1, 0, 0})
	DMember(bool)                                      bBoostFailed                                                OFFSET(get<bool>, {0x21E9, 1, 0, 0})
	DMember(bool)                                      bCanBoostPitch                                              OFFSET(get<bool>, {0x21EA, 1, 0, 0})
	DMember(uint64_t)                                  AccelForceFeedbackHandle                                    OFFSET(get<uint64_t>, {0x21F0, 8, 0, 0})
	DMember(uint64_t)                                  SkidForceFeedbackHandle                                     OFFSET(get<uint64_t>, {0x21F8, 8, 0, 0})
	DMember(uint64_t)                                  BrakeForceFeedbackHandle                                    OFFSET(get<uint64_t>, {0x2200, 8, 0, 0})
	DMember(uint64_t)                                  HandBrakeForceFeedbackHandle                                OFFSET(get<uint64_t>, {0x2208, 8, 0, 0})
	DMember(bool)                                      bSpeedLinesActive                                           OFFSET(get<bool>, {0x2210, 1, 0, 0})
	SMember(FDagwoodRuntimeModifiers)                  DagwoodRuntimeModifiedProperties                            OFFSET(getStruct<T>, {0x2230, 112, 0, 0})
	CMember(TArray<FAttachedWheel>)                    ServerRepWheelData                                          OFFSET(get<T>, {0x22A0, 16, 0, 0})
	SMember(FVector)                                   FlipYawForwardTargetDirection                               OFFSET(getStruct<T>, {0x2300, 24, 0, 0})
	SMember(FVector)                                   FlipYawOriginalForward                                      OFFSET(getStruct<T>, {0x2318, 24, 0, 0})
	CMember(EVehicleWheelLocations)                    LastPoppedTire                                              OFFSET(get<T>, {0x2330, 1, 0, 0})
	DMember(float)                                     RoadTopSpeedMultiplier                                      OFFSET(get<float>, {0x2334, 4, 0, 0})
	DMember(float)                                     CurrentBumpiness                                            OFFSET(get<float>, {0x2338, 4, 0, 0})
	DMember(float)                                     CurrentForwardAcceleration                                  OFFSET(get<float>, {0x233C, 4, 0, 0})
	DMember(float)                                     PreviousTurnAlpha                                           OFFSET(get<float>, {0x2340, 4, 0, 0})
	DMember(float)                                     CurrentCameraAssistStrength                                 OFFSET(get<float>, {0x2344, 4, 0, 0})
	DMember(float)                                     LostGripTime                                                OFFSET(get<float>, {0x2348, 4, 0, 0})
	DMember(float)                                     LostGripRightAlpha                                          OFFSET(get<float>, {0x234C, 4, 0, 0})
	DMember(float)                                     HandbrakeTime                                               OFFSET(get<float>, {0x2350, 4, 0, 0})
	DMember(float)                                     HandbrakeStartTime                                          OFFSET(get<float>, {0x2354, 4, 0, 0})
	DMember(float)                                     HandbrakeEndTime                                            OFFSET(get<float>, {0x2358, 4, 0, 0})
	DMember(float)                                     FlipYawMult                                                 OFFSET(get<float>, {0x235C, 4, 0, 0})
	DMember(float)                                     FlipTimer                                                   OFFSET(get<float>, {0x2360, 4, 0, 0})
	DMember(float)                                     FlipExplodeTimer                                            OFFSET(get<float>, {0x2364, 4, 0, 0})
	DMember(float)                                     FlipPushForceTimer                                          OFFSET(get<float>, {0x2368, 4, 0, 0})
	DMember(float)                                     FlipAirTimer                                                OFFSET(get<float>, {0x236C, 4, 0, 0})
	DMember(float)                                     FlipLanding                                                 OFFSET(get<float>, {0x2370, 4, 0, 0})
	DMember(float)                                     FlipStartTime                                               OFFSET(get<float>, {0x2374, 4, 0, 0})
	DMember(float)                                     LastFlipDamageTime                                          OFFSET(get<float>, {0x2378, 4, 0, 0})
	DMember(float)                                     PreFlipControlLossTimer                                     OFFSET(get<float>, {0x237C, 4, 0, 0})
	DMember(bool)                                      bDidCinematicFlip                                           OFFSET(get<bool>, {0x2380, 1, 0, 0})
	DMember(bool)                                      bCanCinematicFlip                                           OFFSET(get<bool>, {0x2381, 1, 0, 0})
	DMember(bool)                                      bInPopTireVeer                                              OFFSET(get<bool>, {0x2382, 1, 0, 0})
	DMember(bool)                                      bInFlipRecovery                                             OFFSET(get<bool>, {0x2383, 1, 0, 0})
	DMember(bool)                                      bExplodeAfterFlip                                           OFFSET(get<bool>, {0x2384, 1, 0, 0})
	DMember(bool)                                      bLostGrip                                                   OFFSET(get<bool>, {0x2385, 1, 0, 0})
	DMember(bool)                                      bApplyHandbrakeCatchupForce                                 OFFSET(get<bool>, {0x2386, 1, 0, 0})
	DMember(bool)                                      bDidHandbrakeCatchup                                        OFFSET(get<bool>, {0x2387, 1, 0, 0})
	DMember(bool)                                      bInFlipRoll                                                 OFFSET(get<bool>, {0x2388, 1, 0, 0})
	DMember(bool)                                      bInFlipYaw                                                  OFFSET(get<bool>, {0x2389, 1, 0, 0})
	DMember(bool)                                      bInFlipPitch                                                OFFSET(get<bool>, {0x238A, 1, 0, 0})
	DMember(bool)                                      bFlipDidLeaveGround                                         OFFSET(get<bool>, {0x238B, 1, 0, 0})
	DMember(bool)                                      bBreakBuildingsIfBlockingLeaningPassenger                   OFFSET(get<bool>, {0x238C, 1, 0, 0})
	DMember(float)                                     LeanBreakTimeAccumulator                                    OFFSET(get<float>, {0x2390, 4, 0, 0})
	DMember(float)                                     LeanBreakCheckInterval                                      OFFSET(get<float>, {0x2394, 4, 0, 0})
	CMember(TArray<FName>)                             SeatToWindowShapeNames                                      OFFSET(get<T>, {0x2398, 16, 0, 0})
	CMember(class ULegacyCameraShake*)                 OffroadCameraShakeInstance                                  OFFSET(get<T>, {0x23A8, 8, 0, 0})
	CMember(class ULegacyCameraShake*)                 DriverCameraShakeInstance                                   OFFSET(get<T>, {0x23B0, 8, 0, 0})
	CMember(class ULegacyCameraShake*)                 AccelCameraShakeInstance                                    OFFSET(get<T>, {0x23B8, 8, 0, 0})
	CMember(class ULegacyCameraShake*)                 HandBrakeCameraShakeInstance                                OFFSET(get<T>, {0x23C0, 8, 0, 0})
	CMember(class UNiagaraComponent*)                  NativeComp_RoadAndExhaust                                   OFFSET(get<T>, {0x23C8, 8, 0, 0})
	CMember(class UNiagaraComponent*)                  NativeComp_TireSkid                                         OFFSET(get<T>, {0x23D0, 8, 0, 0})
	CMember(class UNiagaraComponent*)                  NativeComp_Damage                                           OFFSET(get<T>, {0x23D8, 8, 0, 0})
	CMember(class UNiagaraComponent*)                  NativeComp_SpeedLines                                       OFFSET(get<T>, {0x23E0, 8, 0, 0})
	CMember(class UNiagaraSystem*)                     NativeSys_TireExhaust                                       OFFSET(get<T>, {0x23E8, 8, 0, 0})
	CMember(class UNiagaraSystem*)                     NativeSys_SpeedLines                                        OFFSET(get<T>, {0x23F0, 8, 0, 0})
	CMember(class UNiagaraSystem*)                     NativeSys_TireSkid                                          OFFSET(get<T>, {0x23F8, 8, 0, 0})
	CMember(TArray<TEnumAsByte<EPhysicalSurface>>)     RoadAndExhaustSurfaceTypeArrayForFX                         OFFSET(get<T>, {0x2400, 16, 0, 0})
	SMember(FName)                                     RoadAndExhaustPeelOutColorIndexName                         OFFSET(getStruct<T>, {0x2410, 4, 0, 0})
	SMember(FName)                                     BrakeLightsName                                             OFFSET(getStruct<T>, {0x2414, 4, 0, 0})
	CMember(TArray<ETireStates>)                       FakeTireStates                                              OFFSET(get<T>, {0x2430, 16, 0, 0})
	CMember(EPoppedTireReactionStates)                 ActivePoppedTireReaction                                    OFFSET(get<T>, {0x2440, 1, 0, 0})
	CMember(EPoppedTireReactionStates)                 ReplicatedPoppedTireReaction                                OFFSET(get<T>, {0x2441, 1, 0, 0})
	CMember(TWeakObjectPtr<AFortValetAudioController*>) ValetAudio                                                 OFFSET(get<T>, {0x2444, 8, 0, 0})
	CMember(TArray<class USkeletalMeshComponent*>)     TireMeshes                                                  OFFSET(get<T>, {0x2450, 16, 0, 0})
	CMember(TArray<class USkeletalMeshComponent*>)     FakeTireMeshes                                              OFFSET(get<T>, {0x2460, 16, 0, 0})
	DMember(bool)                                      bIsInoperable                                               OFFSET(get<bool>, {0x2474, 1, 0, 0})
	DMember(int32_t)                                   RandomSeed                                                  OFFSET(get<int32_t>, {0x2478, 4, 0, 0})
	SMember(FRandomStream)                             RandStream                                                  OFFSET(getStruct<T>, {0x247C, 8, 0, 0})
	DMember(bool)                                      bHasTraction                                                OFFSET(get<bool>, {0x2484, 1, 0, 0})
	DMember(bool)                                      bStartHandBrakeCatchupForce                                 OFFSET(get<bool>, {0x2485, 1, 0, 0})
	DMember(bool)                                      bSelfDestructEnabled                                        OFFSET(get<bool>, {0x2590, 1, 1, 0})
	DMember(bool)                                      bClientUsesSelfDestructTimer                                OFFSET(get<bool>, {0x2590, 1, 1, 1})
	CMember(class UStaticMesh*)                        TireBootMesh                                                OFFSET(get<T>, {0x2598, 8, 0, 0})
	CMember(TMap<int32_t, FDagwoodActionDefForUI>)     MapSelfDestructActionDefForUI                               OFFSET(get<T>, {0x25A0, 80, 0, 0})
	DMember(float)                                     MinimumTimeBetweenSelfDestructPromptChanges                 OFFSET(get<float>, {0x25F0, 4, 0, 0})


	/// Functions
	// Function /Script/ValetRuntime.FortDagwoodVehicle.StartFade
	// void StartFade();                                                                                                        // [0xb0e3094] Final|Native|Public|BlueprintCallable 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.SetValetAudioController
	// void SetValetAudioController(class AFortValetAudioController* ValetAudio);                                               // [0xb0e2f54] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.SetRuntimeSpringsInfoOnServer
	// void SetRuntimeSpringsInfoOnServer(FRuntimeSpringsInfo& SpringsInfo);                                                    // [0xb0e2df0] Final|Native|Protected|HasOutParms|BlueprintCallable 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.SetRuntimeGravityOnServer
	// void SetRuntimeGravityOnServer(float GravMult);                                                                          // [0xb0e2d20] Final|Native|Protected|BlueprintCallable 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.SetRuntimeFuelInfoOnServer
	// void SetRuntimeFuelInfoOnServer(FRuntimeFuelInfo& FuelInfo);                                                             // [0xb0e2c70] Final|Native|Protected|HasOutParms|BlueprintCallable 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.SetRuntimeDriveInfoOnServer
	// void SetRuntimeDriveInfoOnServer(float MaxIncline, float MaxTilt);                                                       // [0xb0e2b18] Final|Native|Protected|BlueprintCallable 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.SetRuntimeBoostInfoOnServer
	// void SetRuntimeBoostInfoOnServer(FRuntimeBoostInfo& BoostInfo);                                                          // [0xb0e2a64] Final|Native|Protected|HasOutParms|BlueprintCallable 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.SetDamageInfoOnServer
	// void SetDamageInfoOnServer(bool bInDamageFriendlyVehicles, bool bInDamageOtherVehicles, bool bInDamageOwnVehicle, bool bInDamageAllowedFromOtherVehicle); // [0xb0e2754] Final|BlueprintAuthorityOnly|Native|Protected|BlueprintCallable 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.ServerSetFadeDuration
	// void ServerSetFadeDuration(float NewFadeDuration);                                                                       // [0x674d700] Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.ServerSelfDestructActivated
	// void ServerSelfDestructActivated();                                                                                      // [0xb0e273c] Net|NetReliableNative|Event|Public|NetServer 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.SelfDestructCleanup
	// void SelfDestructCleanup();                                                                                              // [0xb0e2728] Final|Native|Public  
	// Function /Script/ValetRuntime.FortDagwoodVehicle.OnTickAudioFade
	// void OnTickAudioFade(float FadeParam);                                                                                   // [0x246f7d8] Event|Public|BlueprintEvent 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.OnTickAudioController
	// void OnTickAudioController(float DeltaTime);                                                                             // [0x246f7d8] Event|Public|BlueprintEvent 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.OnStopHandbrake
	// void OnStopHandbrake();                                                                                                  // [0x246f7d8] Event|Public|BlueprintEvent 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.OnStartHandbrake
	// void OnStartHandbrake();                                                                                                 // [0x246f7d8] Event|Public|BlueprintEvent 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.OnServerAltInteract
	// void OnServerAltInteract(class AFortPawn* Pawn);                                                                         // [0x246f7d8] Event|Public|BlueprintEvent 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.OnRep_ServerRepWheelData
	// void OnRep_ServerRepWheelData(TArray<FAttachedWheel>& PrevWheelData);                                                    // [0xb0e1d68] Final|Native|Private|HasOutParms 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.OnRep_RandSeed
	// void OnRep_RandSeed();                                                                                                   // [0x35413e4] Final|Native|Private 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.OnRep_PoppedTireReaction
	// void OnRep_PoppedTireReaction();                                                                                         // [0xb0e1d4c] Final|Native|Private 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.OnRep_IsInoperable
	// void OnRep_IsInoperable();                                                                                               // [0xb0e1d38] Final|Native|Private 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.OnRep_FakeTires
	// void OnRep_FakeTires(TArray<ETireStates>& PrevTireStates);                                                               // [0xb0e1c9c] Final|Native|Private|HasOutParms 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.OnRep_DagwoodRuntimeModifiers
	// void OnRep_DagwoodRuntimeModifiers(FDagwoodRuntimeModifiers& PrevMods);                                                  // [0x3332fbc] Final|Native|Private|HasOutParms 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.OnInoperableChanged
	// void OnInoperableChanged(bool bInoperable);                                                                              // [0x246f7d8] Event|Public|BlueprintEvent 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.OnHoldSelfDestructStopped
	// void OnHoldSelfDestructStopped(class AFortPawn* DriverPawn);                                                             // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.OnHoldSelfDestructStarted
	// void OnHoldSelfDestructStarted(class AFortPawn* DriverPawn, float ExitDuration);                                         // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.OnFlipImpactDamage
	// void OnFlipImpactDamage();                                                                                               // [0x246f7d8] Event|Public|BlueprintEvent 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.OnDestroyedPropFromCollision
	// void OnDestroyedPropFromCollision(class ABuildingActor* BuildingHitActor);                                               // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.OnClientBeginAltInteract
	// void OnClientBeginAltInteract(class AFortPawn* Pawn);                                                                    // [0x246f7d8] Event|Public|BlueprintEvent 
	...
	// float NativeCalculateAccelRumbleIntensity(float MaxIntensity);                                                           // [0xb0e1bd0] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.MakeOperable
	// void MakeOperable(bool bAddGas);                                                                                         // [0x62ffeb0] Final|Native|Public|BlueprintCallable 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.MakeInoperable
	// void MakeInoperable();                                                                                                   // [0xb0e1bb0] Native|Public|BlueprintCallable 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.IsTireSkidding
	// bool IsTireSkidding(float MinSpeedForSkid, float AngleForSkid, float SpeedForPeelout, float SpeedForBraking);            // [0xb0e1974] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.IsOnLandscape
	// bool IsOnLandscape();                                                                                                    // [0xb0e195c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.IsNativeBPTickEnabled
	// bool IsNativeBPTickEnabled();                                                                                            // [0x33dafc8] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.HandleCurrentPlaylistLoaded
	// void HandleCurrentPlaylistLoaded(FName PlaylistName, FGameplayTagContainer& PlaylistContextTags);                        // [0xb0e1660] Final|Native|Protected|HasOutParms 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.GetTireSurface
	// ETireSurfaces GetTireSurface(EVehicleWheelLocations TireIndex);                                                          // [0xb0e1590] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.GetTireHealthPercent
	// float GetTireHealthPercent(EVehicleWheelLocations TireIndex);                                                            // [0xb0e14b4] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.GetMiddleAxleForwardAdjust
	// float GetMiddleAxleForwardAdjust();                                                                                      // [0xb0e1348] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.GetCurrentDagwoodRuntimeProperties
	// FDagwoodRuntimeModifiers GetCurrentDagwoodRuntimeProperties();                                                           // [0xb0e132c] Final|Native|Public|BlueprintCallable 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.GetBumpiness
	// float GetBumpiness();                                                                                                    // [0xb0e1314] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.ForwardOrReverseInputPressed
	// bool ForwardOrReverseInputPressed();                                                                                     // [0xb0e12f0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.CleanupLoopingPooledFX
	// void CleanupLoopingPooledFX();                                                                                           // [0xb0e12d8] Native|Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.ApplyRuntimeModifiers
	// void ApplyRuntimeModifiers();                                                                                            // [0xb0e1184] Final|Native|Private 
	// Function /Script/ValetRuntime.FortDagwoodVehicle.AddRuntimeGearsInfoOnServer
	// void AddRuntimeGearsInfoOnServer(FRuntimeGearInfo& GearInfo);                                                            // [0xb0e10f0] Final|Native|Protected|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// void UpdatePropReplacement();                                                                                            // [0x3508bf8] Final|Native|Public  
	// Function /Script/ValetRuntime.FortDagwoodVehicleManager.OnVehicleSpawnsUpdated
	// void OnVehicleSpawnsUpdated(class UFortVehicleItemDefinition* VehicleItemDef, TArray<AActor*>& SpawnedVehicles, int32_t NewVehicleCount); // [0xb0e2540] Final|Native|Public|HasOutParms 
	// Function /Script/ValetRuntime.FortDagwoodVehicleManager.OnVehicleSpawned
	// void OnVehicleSpawned(class AFortAthenaVehicle* Vehicle);                                                                // [0xb0e2480] Final|Native|Public  
	// Function /Script/ValetRuntime.FortDagwoodVehicleManager.CustomHandleActorStreamedInEditor
	// void CustomHandleActorStreamedInEditor(class AActor* SourceActor);                                                       // [0x631c404] Final|Native|Public  
};
...
public:
	...
	// void Update_Native();                                                                                                    // [0xb0e30c4] Final|Native|Public|BlueprintCallable 
	// Function /Script/ValetRuntime.FortValetAudioController.OnTireModApplied
	// void OnTireModApplied(FTireInfo& AppliedTireMod);                                                                        // [0x246f7d8] Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/ValetRuntime.FortValetAudioController.OnSuspensionCollision_Native
	// void OnSuspensionCollision_Native(bool& OutResult, float& OutMagnitude);                                                 // [0xb0e23a8] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/ValetRuntime.FortValetAudioController.CacheValetVehicle
	// void CacheValetVehicle(class AFortDagwoodVehicle* InVehicle);                                                            // [0xb0e1198] Final|Native|Public|BlueprintCallable 
};
