...
public:
	...
	// bool IsValidTarget(class AActor* OwningPlayer, class AActor* PotentialTarget, FGameplayTagContainer& ReasonForFailure);  // [0xbc1d3c0] Final|Native|Protected|HasOutParms|BlueprintCallable 
	// Function /Script/MotherGameplayRuntime.GravityGunTargetTrackingComponent.FindTargetProjectile
	// bool FindTargetProjectile(class AActor* OwningPlayer, FVector& TraceStart, FVector& TraceEnd, float TargetingRadius);    // [0xbc1cd84] Final|Native|Protected|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/MotherGameplayRuntime.GravityGunTargetTrackingComponent.FindTargetActor
	// void FindTargetActor(class AActor* OwningPlayer, FVector& TraceStart, FVector& TraceEnd);                                // [0xbc1cba8] Final|Native|Protected|HasOutParms|HasDefaults|BlueprintCallable 
};
...
public:
	...
	// void UpdatePropPreviewPosition(class USceneComponent* PropPreviewComponent, float DeltaTime, class AFortPawn* AttachPawn, FName AttachSocket, class USkeletalMeshComponent* WeaponMesh, FVector& DesiredRelativeTransform, float MinimumZOffset, FRotator& RelativeRotation, FVector& CachedScale, float InterpSpeed); // [0xbc1d810] Final|Native|Static|Private|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/MotherGameplayRuntime.PropGunFunctionLibrary.UpdatePropIndexEventState
	// void UpdatePropIndexEventState(class AActor* ContextActor, FPaddleGingerPropData& Payload);                              // [0xbc1d6c8] Final|Native|Static|Private|HasOutParms|BlueprintCallable 
	// Function /Script/MotherGameplayRuntime.PropGunFunctionLibrary.UpdatePropActivatedEventState
	// void UpdatePropActivatedEventState(class AActor* ContextActor, FPaddleGingerPropActivatedData& Payload);                 // [0xbc1d588] Final|Native|Static|Private|HasOutParms|BlueprintCallable 
	// Function /Script/MotherGameplayRuntime.PropGunFunctionLibrary.ClearPropIndexEventState
	// void ClearPropIndexEventState(class AActor* ContextActor);                                                               // [0xbc1cadc] Final|Native|Static|Private|BlueprintCallable 
	// Function /Script/MotherGameplayRuntime.PropGunFunctionLibrary.ClearPropActivatedEventState
	// void ClearPropActivatedEventState(class AActor* ContextActor);                                                           // [0xbc1ca10] Final|Native|Static|Private|BlueprintCallable 
};
...
public:
	...
	// void UpdateAimEndPoint();                                                                                                // [0xbc1d574] Final|Native|Public|BlueprintCallable 
	// Function /Script/MotherGameplayRuntime.ReactorGradeGameplayCue_ChargeUp.OnEndPointUpdated
	// void OnEndPointUpdated(FVector& FoundPoint);                                                                             // [0x246f7d8] Event|Public|HasOutParms|HasDefaults|BlueprintEvent 
	// Function /Script/MotherGameplayRuntime.ReactorGradeGameplayCue_ChargeUp.GetFoundEndPoint
	// FVector GetFoundEndPoint();                                                                                              // [0xbc1d398] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
};
