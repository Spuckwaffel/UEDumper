...
public:
	...
	// void HandleTrailerTerminalError(EBaseMediaTerminalErrorReason Reason);                                                   // [0xc8ab400] Final|Native|Private 
	// Function /Script/JunoFrontendUI.JunoFrontendExperienceFlow.HandleFinishTrailerStep
	// void HandleFinishTrailerStep();                                                                                          // [0xc8ab3ec] Final|Native|Private 
};
...
public:
	...
	DMember(bool)                                      bWorldLoadingSuccess                                        OFFSET(get<bool>, {0x71, 1, 0, 0})
	...
	// void StartMatchmakingInModeratorMode(FString InWorldId);                                                                 // [0xc8ab5ec] Final|Native|Public|BlueprintCallable 
	// Function /Script/JunoFrontendUI.JunoWorldManagementViewModel.RemoveSelectedWorldFromList
	// void RemoveSelectedWorldFromList();                                                                                      // [0xc8ab5d8] Final|Native|Public|BlueprintCallable 
	// Function /Script/JunoFrontendUI.JunoWorldManagementViewModel.InitWorldData
	// class UJunoWorldDataViewModel* InitWorldData(TWeakObjectPtr<UDataTable*>& InSettingDataTable, TWeakObjectPtr<UDataTable*>& InWorldImageDataTable); // [0xc8ab4bc] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/JunoFrontendUI.JunoWorldManagementViewModel.GetIsCreateFlowSelected
	// bool GetIsCreateFlowSelected();                                                                                          // [0xc8ab3a4] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoFrontendUI.JunoWorldManagementViewModel.FetchWorldData
	// void FetchWorldData();                                                                                                   // [0xc8ab390] Final|Native|Public|BlueprintCallable 
	// Function /Script/JunoFrontendUI.JunoWorldManagementViewModel.EnableDataRefresh
	// void EnableDataRefresh();                                                                                                // [0xc8ab37c] Final|Native|Public|BlueprintCallable 
	// Function /Script/JunoFrontendUI.JunoWorldManagementViewModel.DisableDataRefresh
	// void DisableDataRefresh();                                                                                               // [0xc8ab368] Final|Native|Public|BlueprintCallable 
};
