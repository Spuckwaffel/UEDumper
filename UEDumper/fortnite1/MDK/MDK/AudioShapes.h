...
public:
	...
	// void UpdateAudioShape(TArray<APlayerController*>& InLocalControllers);                                                   // [0x821e924] Final|Native|Public|HasOutParms 
	// Function /Script/AudioShapes.AudioShapeComponent.Enable
	// void Enable();                                                                                                           // [0x3449a4c] Native|Protected|BlueprintCallable 
	// Function /Script/AudioShapes.AudioShapeComponent.Disable
	// void Disable();                                                                                                          // [0x1b55e98] Native|Protected|BlueprintCallable 
};
...
public:
	...
	// bool GetIsPlayerInside();                                                                                                // [0x821e300] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AudioShapes.AudioShapePrimitiveComponent.GetInsideAudioComponent
	// class UAudioComponent* GetInsideAudioComponent();                                                                        // [0x821e2ac] Final|Native|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/AudioShapes.AudioShapePrimitiveComponent.GetEdgeAudioComponent
	// class UAudioComponent* GetEdgeAudioComponent();                                                                          // [0x821e258] Final|Native|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// void SetBoxTransform(FTransform& InTransform);                                                                           // [0x821e4ac] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
};
...
public:
	...
	// void SetRadius(float InRadius);                                                                                          // [0x821e784] Final|Native|Public|BlueprintCallable 
	// Function /Script/AudioShapes.AudioShapeCylinderComponent.SetHalfHeight
	// void SetHalfHeight(float InHalfHeight);                                                                                  // [0x821e6b8] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void SetStartPoint(FVector& InStartPoint);                                                                               // [0x821e850] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/AudioShapes.AudioShapeLineComponent.SetEndPoint
	// void SetEndPoint(FVector& InEndPoint);                                                                                   // [0x821e5e4] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
};
...
public:
	...
	// bool UpdatePoint(int32_t InIndex, FVector& InPoint);                                                                     // [0x821e9c0] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/AudioShapes.AudioShapeLineListComponent.RemovePoint
	// bool RemovePoint(int32_t InIndex);                                                                                       // [0x821e3bc] Final|Native|Public|BlueprintCallable 
	// Function /Script/AudioShapes.AudioShapeLineListComponent.GetPoints
	// void GetPoints(TArray<FVector>& OutPoints);                                                                              // [0x821e31c] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AudioShapes.AudioShapeLineListComponent.AddPoint
	// int32_t AddPoint(FVector& InPoint);                                                                                      // [0x821e148] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
};
...
public:
	...
	// void SetRadius(float InRadius);                                                                                          // [0x1c51ee4] Final|Native|Public|BlueprintCallable 
};
