...
public:
	...
	// class UAITask_UseGameplayInteraction* UseSmartObjectWithGameplayInteraction(class AAIController* Controller, FSmartObjectClaimHandle ClaimHandle, bool bLockAILogic); // [0x845bf7c] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/GameplayInteractionsModule.AITask_UseGameplayInteraction.RequestAbort
	// void RequestAbort();                                                                                                     // [0x845bf68] Final|Native|Public|BlueprintCallable 
	// Function /Script/GameplayInteractionsModule.AITask_UseGameplayInteraction.MoveToAndUseSmartObjectWithGameplayInteraction
	// class UAITask_UseGameplayInteraction* MoveToAndUseSmartObjectWithGameplayInteraction(class AAIController* Controller, FSmartObjectClaimHandle ClaimHandle, bool bLockAILogic); // [0x845bb14] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// void OnNotifyBeginReceived(FName NotifyName, FBranchingPointNotifyPayload& BranchingPointNotifyPayload);                 // [0x845be40] Final|Native|Public|HasOutParms 
	// Function /Script/GameplayInteractionsModule.StateTreeTask_PlayContextualAnim_InstanceData.OnMontageEnded
	// void OnMontageEnded(class UAnimMontage* EndedMontage, bool bInterrupted);                                                // [0x845bd00] Final|Native|Public  
};
