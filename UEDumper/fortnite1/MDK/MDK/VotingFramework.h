...
public:
	...
	// void VoteStart(FName VoteSessionId, FName VoteId);                                                                       // [0xcc6ba18] Final|Native|Public|BlueprintCallable 
	// Function /Script/VotingFramework.VoteBroadcasterComponent.VoteSetup
	// void VoteSetup(FName VoteSessionId, FName VoteId);                                                                       // [0xcc6b8dc] Final|Native|Public|BlueprintCallable 
	// Function /Script/VotingFramework.VoteBroadcasterComponent.VoteSessionShutdown
	// void VoteSessionShutdown(FName VoteSessionId);                                                                           // [0xcc6b81c] Final|Native|Public|BlueprintCallable 
	// Function /Script/VotingFramework.VoteBroadcasterComponent.VoteSessionSetup
	// void VoteSessionSetup(FName VoteSessionId, FName StartingVoteId, EVoteSessionNetworkType NetworkType);                   // [0xcc6b664] Final|Native|Public|BlueprintCallable 
	// Function /Script/VotingFramework.VoteBroadcasterComponent.VoteSessionComplete
	// void VoteSessionComplete(FName VoteSessionId);                                                                           // [0xcc6b5a4] Final|Native|Public|BlueprintCallable 
	// Function /Script/VotingFramework.VoteBroadcasterComponent.VoteEnd
	// void VoteEnd(FName VoteSessionId, FName VoteId, FName WinningVoteSelectionId);                                           // [0xcc6b3ec] Final|Native|Public|BlueprintCallable 
	// Function /Script/VotingFramework.VoteBroadcasterComponent.ServerSubmitVotesAggregated
	// void ServerSubmitVotesAggregated(FName VoteSessionId, FName VoteId, FName VoteSelectionId, int32_t VoteDelta);           // [0xcc6b174] Net|NetReliableNative|Event|Protected|NetServer|NetValidate 
	// Function /Script/VotingFramework.VoteBroadcasterComponent.OnVoteCasted
	// void OnVoteCasted(FUniqueNetIdRepl& UserNetId, FGameplayTag& VoteSessionId, FGameplayTag& VoteId, FGameplayTag& VoteSelectionId); // [0xcc6a0a4] Final|Native|Protected|HasOutParms 
};
...
public:
	...
	// void OnVoteStart(FGameplayTag& VoteSessionId, FGameplayTag& VoteId, EVoteState VoteState);                               // [0xcc6ade0] Native|Protected|HasOutParms 
	// Function /Script/VotingFramework.VoteListenerComponent.OnVoteSetup
	// void OnVoteSetup(FGameplayTag& VoteSessionId, FGameplayTag& VoteId, EVoteState VoteState);                               // [0xcc6ac04] Native|Protected|HasOutParms 
	// Function /Script/VotingFramework.VoteListenerComponent.OnVoteSessionVoting
	// void OnVoteSessionVoting(FGameplayTag& VoteSessionId, FGameplayTag& StartingVoteId, EVoteSessionState SessionState);     // [0xcc6aa28] Native|Protected|HasOutParms 
	// Function /Script/VotingFramework.VoteListenerComponent.OnVoteSessionShutdown
	// void OnVoteSessionShutdown(FGameplayTag& VoteSessionId);                                                                 // [0xa629c14] Native|Protected|HasOutParms 
	// Function /Script/VotingFramework.VoteListenerComponent.OnVoteSessionSetup
	// void OnVoteSessionSetup(FGameplayTag& VoteSessionId, FGameplayTag& StartingVoteId, EVoteSessionNetworkType NetworkType, EVoteSessionState SessionState); // [0xcc6a7cc] Native|Protected|HasOutParms 
	// Function /Script/VotingFramework.VoteListenerComponent.OnVoteSessionComplete
	// void OnVoteSessionComplete(FGameplayTag& VoteSessionId);                                                                 // [0xa629a7c] Native|Protected|HasOutParms 
	// Function /Script/VotingFramework.VoteListenerComponent.OnVoteEnd
	// void OnVoteEnd(FGameplayTag& VoteSessionId, FGameplayTag& VoteId, FGameplayTag& WinningVoteSelectionId, EVoteState VoteState); // [0xcc6a568] Native|Protected|HasOutParms 
	// Function /Script/VotingFramework.VoteListenerComponent.OnVoteChange
	// void OnVoteChange(FGameplayTag& VoteSessionId, FGameplayTag& VoteId, FGameplayTag& VoteSelectionId, int32_t ServerVoteTotal, int32_t AllServersVoteTotal); // [0xcc6a288] Native|Protected|HasOutParms 
};
...
public:
	...
	// void ServerCastVoteSelection(FUniqueNetIdRepl InUserId, FCastedVote CastedVote);                                         // [0xcc6afbc] Net|NetReliableNative|Event|Protected|NetServer|NetValidate 
	// Function /Script/VotingFramework.VoteResponderComponent.CastManualVoteSelectionAtIndex
	// void CastManualVoteSelectionAtIndex(class APlayerState* InPlayerState, int32_t SelectionIndex);                          // [0xcc69f68] Final|Native|Public|BlueprintCallable 
	// Function /Script/VotingFramework.VoteResponderComponent.CastManualVoteSelection
	// void CastManualVoteSelection(class APlayerState* InPlayerState, FGameplayTag& VoteSelection);                            // [0xcc69e24] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/VotingFramework.VoteResponderComponent.CastDefaultVoteSelection
	// void CastDefaultVoteSelection(class APlayerState* InPlayerState);                                                        // [0xcc69d60] Final|Native|Public|BlueprintCallable 
};
