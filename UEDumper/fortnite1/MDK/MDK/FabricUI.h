...
public:
	...
	// void SetScreenGridDimensions(FVector2D& InNewDimensions);                                                                // [0xc23e948] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/FabricUI.FabricScreenWidget.AttachFabricWidget
	// class UFabricWidget* AttachFabricWidget(class UClass*& FabricWidgetClass, FVector2D& GridPosition);                      // [0xc23e764] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
};
...
public:
	...
	// class UFabricInteractableViewModel* GetFabricViewModel();                                                                // [0xc23e848] Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
};
...
public:
	...
	// void SetShouldSuscribeToSignificanceSubsystem(bool ShouldSuscribe);                                                      // [0xc23e9dc] Final|Native|Public|BlueprintCallable 
	// Function /Script/FabricUI.FabricWidgetComponent.GetTickMode
	// ETickMode GetTickMode();                                                                                                 // [0xc23e870] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void UnregisterFabricWidgetComponent(class UFabricWidgetComponent* WidgetComponent);                                     // [0xc23ea9c] Final|Native|Public|BlueprintCallable 
	// Function /Script/FabricUI.FabricWidgetTickControlSubsystem.RegisterFabricWidgetComponent
	// void RegisterFabricWidgetComponent(class UFabricWidgetComponent* WidgetComponent);                                       // [0xc23e888] Final|Native|Public|BlueprintCallable 
};
