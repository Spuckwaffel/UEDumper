...
public:
	...
	// void SetPriority(int32_t InPriority);                                                                                    // [0x846d084] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void SetInteriorVolume(float Volume, float InterpolateTime);                                                             // [0x846cf34] Final|Native|Public|BlueprintCallable 
	// Function /Script/AudioGameplayVolume.AttenuationVolumeComponent.SetExteriorVolume
	// void SetExteriorVolume(float Volume, float InterpolateTime);                                                             // [0x846cde4] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void SetEnabled(bool bEnable);                                                                                           // [0x846cd0c] Final|Native|Public|BlueprintCallable 
	// Function /Script/AudioGameplayVolume.AudioGameplayVolume.OnRep_bEnabled
	// void OnRep_bEnabled();                                                                                                   // [0x7ed1244] Native|Protected     
	// Function /Script/AudioGameplayVolume.AudioGameplayVolume.OnListenerExit
	// void OnListenerExit();                                                                                                   // [0x319bdc0] Native|Event|Public|BlueprintEvent 
	// Function /Script/AudioGameplayVolume.AudioGameplayVolume.OnListenerEnter
	// void OnListenerEnter();                                                                                                  // [0x319bde8] Native|Event|Public|BlueprintEvent 
};
...
public:
	...
	// void SetInteriorLPF(float Volume, float InterpolateTime);                                                                // [0x846cf34] Final|Native|Public|BlueprintCallable 
	// Function /Script/AudioGameplayVolume.FilterVolumeComponent.SetExteriorLPF
	// void SetExteriorLPF(float Volume, float InterpolateTime);                                                                // [0x846cde4] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void SetReverbSettings(FReverbSettings& NewReverbSettings);                                                              // [0x846d150] Final|Native|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// void SetSubmixOverrideSettings(TArray<FAudioVolumeSubmixOverrideSettings>& NewSubmixOverrideSettings);                   // [0x846d1fc] Final|Native|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// void SetSubmixSendSettings(TArray<FAudioVolumeSubmixSendSettings>& NewSubmixSendSettings);                               // [0x846d2c0] Final|Native|Public|HasOutParms|BlueprintCallable 
};
