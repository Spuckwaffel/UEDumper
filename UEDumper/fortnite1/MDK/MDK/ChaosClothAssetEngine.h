...
public:
	...
	// void SuspendSimulation();                                                                                                // [0xce04188] Final|Native|Public|BlueprintCallable 
	// Function /Script/ChaosClothAssetEngine.ChaosClothComponent.SetEnableSimulation
	// void SetEnableSimulation(bool bEnable);                                                                                  // [0xce040b8] Final|Native|Public|BlueprintCallable 
	// Function /Script/ChaosClothAssetEngine.ChaosClothComponent.SetClothAsset
	// void SetClothAsset(class UChaosClothAsset* InClothAsset);                                                                // [0xce03ff0] Final|Native|Public|BlueprintCallable 
	// Function /Script/ChaosClothAssetEngine.ChaosClothComponent.ResumeSimulation
	// void ResumeSimulation();                                                                                                 // [0xce03fd8] Final|Native|Public|BlueprintCallable 
	// Function /Script/ChaosClothAssetEngine.ChaosClothComponent.ResetTeleportMode
	// void ResetTeleportMode();                                                                                                // [0xce03fc0] Final|Native|Public|BlueprintCallable 
	// Function /Script/ChaosClothAssetEngine.ChaosClothComponent.ResetConfigProperties
	// void ResetConfigProperties();                                                                                            // [0xce03fac] Final|Native|Public|BlueprintCallable 
	// Function /Script/ChaosClothAssetEngine.ChaosClothComponent.RecreateClothSimulationProxy
	// void RecreateClothSimulationProxy();                                                                                     // [0xce03f98] Final|Native|Public|BlueprintCallable 
	// Function /Script/ChaosClothAssetEngine.ChaosClothComponent.IsSimulationSuspended
	// bool IsSimulationSuspended();                                                                                            // [0xce03f74] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ChaosClothAssetEngine.ChaosClothComponent.IsSimulationEnabled
	// bool IsSimulationEnabled();                                                                                              // [0xce03f50] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ChaosClothAssetEngine.ChaosClothComponent.GetClothAsset
	// class UChaosClothAsset* GetClothAsset();                                                                                 // [0xce03f2c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ChaosClothAssetEngine.ChaosClothComponent.ForceNextUpdateTeleportAndReset
	// void ForceNextUpdateTeleportAndReset();                                                                                  // [0xce03f14] Final|Native|Public|BlueprintCallable 
	// Function /Script/ChaosClothAssetEngine.ChaosClothComponent.ForceNextUpdateTeleport
	// void ForceNextUpdateTeleport();                                                                                          // [0xce03ef4] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// class UPhysicsAsset* GetShadowPhysicsAsset();                                                                            // [0x6bfe708] Native|Public|BlueprintCallable|BlueprintPure|Const 
};
