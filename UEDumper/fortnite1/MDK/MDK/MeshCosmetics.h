...
public:
	SMember(FCosmeticSlotSelector)                     SlotValidWithin                                             OFFSET(getStruct<T>, {0x598, 2, 0, 0})
	SMember(FApparelCustomizableItemReference)         Parameter                                                   OFFSET(getStruct<T>, {0x5A0, 32, 0, 0})
};
...
public:
	...
	// void ApplyVariants(class AActor* Actor, FFortAthenaLoadout& Loadout);                                                    // [0xa581bb8] Final|Native|Static|Private|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// void OnPostCustomizationAnimGameplayTags_BP(FGameplayTagContainer& GameplayTags);                                        // [0x246f7d8] Event|Public|HasOutParms|BlueprintEvent 
};
...
public:
	CMember(TMap<FCosmeticSlotSelector, FCosmeticsLayoutSlot>) SlotDataConfig                                      OFFSET(get<T>, {0x1A8, 80, 0, 0})
	CMember(TMap<FCosmeticSlotSelector, TWeakObjectPtr<UCustomizableObject*>>) SlottedCustomizableObjects          OFFSET(get<T>, {0x1F8, 80, 0, 0})
};
