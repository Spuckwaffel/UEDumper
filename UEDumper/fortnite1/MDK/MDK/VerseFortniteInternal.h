...
public:
	...
	// void NotifyOfStateChange(FString& State, bool Active);                                                                   // [0xafa933c] Final|Native|Public|HasOutParms 
};
...
public:
	...
	// void OnRep_Settings();                                                                                                   // [0xafa9a68] Final|Native|Private 
};
...
public:
	...
	// void HandlePlayerPawnPossessed(class APawn* Pawn);                                                                       // [0xafa927c] Final|Native|Public  
	// Function /Script/VerseFortniteInternal.FortPlayspaceComponentHelper.HandlePlayerDied
	// void HandlePlayerDied(class AFortPlayerPawnAthena* FortPlayerPawnAthena);                                                // [0xafa91bc] Final|Native|Public  
};
