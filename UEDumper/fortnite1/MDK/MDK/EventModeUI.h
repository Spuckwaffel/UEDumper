...
public:
	...
	// void HandleEventModeFocusingChanged(bool bIsEventModeFocusing);                                                          // [0xb91a9a0] Final|Native|Private 
	// Function /Script/EventModeUI.FocusButton.HandleCanUseEventModeFocusChanged
	// void HandleCanUseEventModeFocusChanged(bool bCanUseEventModeFocus);                                                      // [0xb91a8e4] Final|Native|Private 
};
...
public:
	...
	// void OnFocusStateChanged(bool bIsFocusing);                                                                              // [0x246f7d8] Event|Public|BlueprintEvent 
	// Function /Script/EventModeUI.FortEventModeEmotesWidget.OnFocusAvailableChanged
	// void OnFocusAvailableChanged(bool bIsFocusAvailable);                                                                    // [0x246f7d8] Event|Public|BlueprintEvent 
};
...
public:
	...
	// void HandleEventModeFocusingChanged(bool bIsEventModeFocusing);                                                          // [0xa7f8c28] Final|Native|Private 
	// Function /Script/EventModeUI.FortMobileActionButtonBehavior_Focus.HandleCanUseEventModeFocusChanged
	// void HandleCanUseEventModeFocusChanged(bool bCanUseEventModeFocus);                                                      // [0xa7f8cec] Final|Native|Private 
};
