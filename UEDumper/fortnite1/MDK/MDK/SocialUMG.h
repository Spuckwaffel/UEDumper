...
public:
	...
	// void SendCurrentMessage();                                                                                               // [0xa56290c] Final|Native|Public|BlueprintCallable 
	// Function /Script/SocialUMG.SocialChatContainer.OnChatOpenChanged
	// void OnChatOpenChanged(bool bShouldBeOpen);                                                                              // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/SocialUMG.SocialChatContainer.HandleRightTabPressed
	// void HandleRightTabPressed();                                                                                            // [0xa562884] Final|Native|Public|BlueprintCallable 
	// Function /Script/SocialUMG.SocialChatContainer.HandleLeftTabPressed
	// void HandleLeftTabPressed();                                                                                             // [0xa5626e0] Final|Native|Public|BlueprintCallable 
	// Function /Script/SocialUMG.SocialChatContainer.FocusEditableText
	// void FocusEditableText();                                                                                                // [0xa562630] Final|Native|Public|BlueprintCallable 
	// Function /Script/SocialUMG.SocialChatContainer.DynamicHandleMessageTextCommitted
	// void DynamicHandleMessageTextCommitted(FText& MessageText, TEnumAsByte<ETextCommit> CommitMethod);                       // [0xa56251c] Final|Native|Private|HasOutParms 
};
...
public:
	...
	// void OnMessageSet();                                                                                                     // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/SocialUMG.SocialChatMessageEntry.CanInteract
	// bool CanInteract();                                                                                                      // [0x33dafc8] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// class UUserWidget* HandleGetMenuContent();                                                                               // [0xa562698] Final|Native|Protected 
};
...
public:
	...
	// void OnInteractionSet();                                                                                                 // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/SocialUMG.SocialInteractionButton.IsPlatformOnlyFriend
	// bool IsPlatformOnlyFriend();                                                                                             // [0xa562898] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/SocialUMG.SocialInteractionButton.GetInteractionName
	// FName GetInteractionName();                                                                                              // [0xa562664] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void OnOpened();                                                                                                         // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/SocialUMG.SocialActionMenu.HandleMenuAnchorOpenChanged
	// void HandleMenuAnchorOpenChanged(bool bIsOpen);                                                                          // [0xa5626f4] Final|Native|Protected 
};
...
public:
	...
	// void OnToggleConfirmation(bool bIsVisible);                                                                              // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/SocialUMG.SocialInteractionMenu.GetFirstEntryToCenter
	// class UWidget* GetFirstEntryToCenter();                                                                                  // [0xa562644] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void HandleMenuOpenChanged(bool bIsMenuOpen);                                                                            // [0xa5627bc] Final|Native|Private 
	// Function /Script/SocialUMG.SocialListInteractableEntryBase.HandleGetMenuContent
	// class UUserWidget* HandleGetMenuContent();                                                                               // [0xa5626bc] Final|Native|Protected 
};
