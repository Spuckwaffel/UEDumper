...
public:
	...
	// void SetSkipAssigningGamepadToPlayer1(bool bSkipFirstPlayer);                                                            // [0x591135c] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/EngineSettings.GameMapsSettings.GetSkipAssigningGamepadToPlayer1
	// bool GetSkipAssigningGamepadToPlayer1();                                                                                 // [0x5911348] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/EngineSettings.GameMapsSettings.GetGameMapsSettings
	// class UGameMapsSettings* GetGameMapsSettings();                                                                          // [0x5911318] Final|RequiredAPI|Native|Static|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	SMember(FText)                                     ProjectDisplayedTitle                                       OFFSET(getStruct<T>, {0xD8, 16, 0, 0})
	SMember(FText)                                     ProjectDebugTitleInfo                                       OFFSET(getStruct<T>, {0xE8, 16, 0, 0})
	DMember(bool)                                      bShouldWindowPreserveAspectRatio                            OFFSET(get<bool>, {0xF8, 1, 0, 0})
	DMember(bool)                                      bUseBorderlessWindow                                        OFFSET(get<bool>, {0xF9, 1, 0, 0})
	DMember(bool)                                      bStartInVR                                                  OFFSET(get<bool>, {0xFA, 1, 0, 0})
	DMember(bool)                                      bAllowWindowResize                                          OFFSET(get<bool>, {0xFB, 1, 0, 0})
	DMember(bool)                                      bAllowClose                                                 OFFSET(get<bool>, {0xFC, 1, 0, 0})
	DMember(bool)                                      bAllowMaximize                                              OFFSET(get<bool>, {0xFD, 1, 0, 0})
	DMember(bool)                                      bAllowMinimize                                              OFFSET(get<bool>, {0xFE, 1, 0, 0})
	DMember(float)                                     EyeOffsetForFakeStereoRenderingDevice                       OFFSET(get<float>, {0x100, 4, 0, 0})
	DMember(float)                                     FOVForFakeStereoRenderingDevice                             OFFSET(get<float>, {0x104, 4, 0, 0})
};
