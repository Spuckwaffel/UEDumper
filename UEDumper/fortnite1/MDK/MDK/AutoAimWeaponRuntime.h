...
public:
	...
	// class UAutoAimWeaponPawnComponent* GetAutoAimWeaponPawnComponent(class AFortPawn* SourcePawn);                           // [0xb162810] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/AutoAimWeaponRuntime.AutoAimWeaponKismetLibrary.FindBestAutoAimTarget
	// void FindBestAutoAimTarget(class AFortPawn*& OutTargetPawn, float& OutReticleDistance, class AFortPlayerPawn* SourcePawn, float ReticleSize, float Range); // [0xb162414] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AutoAimWeaponRuntime.AutoAimWeaponKismetLibrary.DoesAutoAimWeaponReticleIntersectTarget
	// bool DoesAutoAimWeaponReticleIntersectTarget(float& OutReticleDistance, class AFortPawn* SourcePawn, class AFortPawn* TargetPawn, float ReticleSize); // [0xb1621ec] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AutoAimWeaponRuntime.AutoAimWeaponKismetLibrary.DoesAutoAimWeaponHaveLineOfSight
	// bool DoesAutoAimWeaponHaveLineOfSight(class AFortPawn* SourcePawn, class AFortPawn* TargetPawn);                         // [0xb16209c] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// float GetTargetToReticleDistanceNormalized();                                                                            // [0x3b0e640] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AutoAimWeaponRuntime.AutoAimWeaponPawnComponent.GetLockOnTargetLocation
	// bool GetLockOnTargetLocation(FVector& OutLockTargetLocation);                                                            // [0xb162948] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|Const 
	// Function /Script/AutoAimWeaponRuntime.AutoAimWeaponPawnComponent.GetLockOnProgress
	// float GetLockOnProgress();                                                                                               // [0xb162920] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AutoAimWeaponRuntime.AutoAimWeaponPawnComponent.GetCurrentLockOnCount
	// int32_t GetCurrentLockOnCount();                                                                                         // [0xb162908] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
