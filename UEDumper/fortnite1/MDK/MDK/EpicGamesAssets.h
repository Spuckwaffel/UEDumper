...
public:
	...
	// void OnSystemFinished(class UNiagaraComponent* FinishedComponent);                                                       // [0xae57f70] Final|Native|Private 
	// Function /Script/EpicGamesAssets.SpawnedParticleSystemReplication.OnRep_VFXAsset
	// void OnRep_VFXAsset();                                                                                                   // [0xae57f5c] Final|Native|Private 
	// Function /Script/EpicGamesAssets.SpawnedParticleSystemReplication.OnRep_StartTime
	// void OnRep_StartTime();                                                                                                  // [0xae57eec] Final|Native|Private 
};
