...
public:
	...
	// void OnVariantChangedEvent__DelegateSignature(FMcpVariantChannelInfo& InChannelInfo);                                    // [0x246f7d8] MulticastDelegate|Public|Delegate|HasOutParms 
	// Function /Script/MeshCosmeticsUI.FortVariantRedirectorTile.HandleBoundaryNavigation
	// class UWidget* HandleBoundaryNavigation(EUINavigation InNavigation);                                                     // [0xb97bd74] Final|Native|Private 
	// Function /Script/MeshCosmeticsUI.FortVariantRedirectorTile.GetButtonToFocus
	// class UWidget* GetButtonToFocus();                                                                                       // [0x681cc5c] Native|Protected|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void BP_SetVariantEditorMode(bool bIsLockerMode);                                                                        // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/MeshCosmeticsUI.FortVariantSprayCustomizer.BP_SetChannelSlotIcon
	// void BP_SetChannelSlotIcon(TWeakObjectPtr<UObject*>& ChannelSlotIcon);                                                   // [0x246f7d8] Event|Protected|HasOutParms|BlueprintEvent 
};
...
public:
	...
	// void HandleSliderValueChanged(float NormalizedValue);                                                                    // [0xb97be44] Final|Native|Private 
	// Function /Script/MeshCosmeticsUI.FortVariantSprayCustomizerSetting.BP_OnSetConstraints
	// void BP_OnSetConstraints(FFloatRange& Constraints);                                                                      // [0x246f7d8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/MeshCosmeticsUI.FortVariantSprayCustomizerSetting.BP_OnChangeValue
	// void BP_OnChangeValue(float Value, float NormalizedValue);                                                               // [0x246f7d8] Event|Protected|BlueprintEvent 
};
