...
public:
	...
	// void HandlePickerOpenRequest(EFortPickerMode Mode, int32_t InitialOption, bool bIgnoreFirstAccept);                      // [0xb4571e4] Final|Native|Private 
};
...
public:
	...
	// void RebuildJamSongIndicatorsForPlayspace(class AJamPlayspace* Playspace);                                               // [0xb4573a0] Final|Native|Public|BlueprintCallable 
	// Function /Script/FMJamUI.JamUIManagerComponent_SongIndicators.ClearJamIndicators
	// void ClearJamIndicators();                                                                                               // [0xb457164] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void OnInitInfo(class UCatalogData* Song, EFMJamLoopType Type);                                                          // [0x246f7d8] Event|Protected|BlueprintEvent 
	...
	// class AFortPlayerStateAthena* GetIndicatedPlayerStateAthena();                                                           // [0xb457178] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
