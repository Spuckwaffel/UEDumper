...
public:
	...
	// float GetMoveDistance();                                                                                                 // [0xb17a2b4] Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /Script/DashRuntime.FortGameplayAbility_Dash.GetEndMovementVelocity
	// FVector GetEndMovementVelocity();                                                                                        // [0xb17a278] Native|Event|Public|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /Script/DashRuntime.FortGameplayAbility_Dash.GetDashTarget
	// FVector GetDashTarget();                                                                                                 // [0xb17a240] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// bool TryActivateDashMME(class AFortPawn* TargetPawn, class UClass* DashMME, FFortMovementMode_DashCreationData& CreationData); // [0xb17a2e0] Final|BlueprintCosmetic|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/DashRuntime.FortMovementMode_ExtDash.BP_UpdateBeforeCharacterMovement
	// EFortMovementModeExt_UpdateResult BP_UpdateBeforeCharacterMovement(float DeltaTime);                                     // [0x246f7d8] Event|Public|BlueprintEvent 
};
