...
/// dependency: AI
/// dependency: AnimationWarpingRuntime
...
public:
	...
	// bool Received_NotifyEnd(class USkeletalMeshComponent* MeshComp, class UAnimSequenceBase* Animation, FAnimNotifyEventReference& EventReference); // [0x246f7d8] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|Const 
	...
	// bool Received_NotifyBegin(class USkeletalMeshComponent* MeshComp, class UAnimSequenceBase* Animation, float TotalDuration, FAnimNotifyEventReference& EventReference); // [0x246f7d8] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|Const 
};
...
public:
	...
	// bool Received_Notify(class USkeletalMeshComponent* MeshComp, class UAnimSequenceBase* Animation, FAnimNotifyEventReference& EventReference); // [0x246f7d8] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|Const 
};
...
public:
	...
	// bool CanApplyHolster(FName& HolsterId);                                                                                  // [0x246f7d8] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|Const 
...
public:
	...
	// bool ShouldTriggerAnimNotify(class USkeletalMeshComponent* MeshComp, class UAnimSequenceBase* Animation);                // [0x246f7d8] Event|Protected|HasOutParms|BlueprintCallable|BlueprintEvent|Const 
};
...
public:
	...
	// void AudioPreview(class AActor* InActor);                                                                                // [0x246f7d8] Public|HasDefaults|BlueprintCallable|BlueprintEvent|Const 
...
/// Size: 0x1728 (0x001540 - 0x002C68)
class UGameplay_FaceSystem_StateMachine_AnimBP_C : public UFortPlayerFaceSystemStateMachineAnimInstance
{ 
	friend MDKHandler;
	static inline constexpr uint64_t __MDKClassSize = 11368;

public:
	SMember(FPointerToUberGraphFrame)                  UberGraphFrame                                              OFFSET(getStruct<T>, {0x1540, 8, 0, 0})
	SMember(FAnimBlueprintGeneratedMutableData)        __AnimBlueprintMutables                                     OFFSET(getStruct<T>, {0x1548, 20, 0, 0})
	SMember(FAnimSubsystemInstance)                    AnimBlueprintExtension_PropertyAccess                       OFFSET(getStruct<T>, {0x1560, 8, 0, 0})
	SMember(FAnimSubsystemInstance)                    AnimBlueprintExtension_Base                                 OFFSET(getStruct<T>, {0x1568, 8, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root                                          OFFSET(getStruct<T>, {0x1570, 32, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult                              OFFSET(getStruct<T>, {0x1590, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult1                             OFFSET(getStruct<T>, {0x15B8, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult2                             OFFSET(getStruct<T>, {0x15E0, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult3                             OFFSET(getStruct<T>, {0x1608, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult4                             OFFSET(getStruct<T>, {0x1630, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult5                             OFFSET(getStruct<T>, {0x1658, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult6                             OFFSET(getStruct<T>, {0x1680, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult7                             OFFSET(getStruct<T>, {0x16A8, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult8                             OFFSET(getStruct<T>, {0x16D0, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult9                             OFFSET(getStruct<T>, {0x16F8, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult10                            OFFSET(getStruct<T>, {0x1720, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult11                            OFFSET(getStruct<T>, {0x1748, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult12                            OFFSET(getStruct<T>, {0x1770, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult13                            OFFSET(getStruct<T>, {0x1798, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult14                            OFFSET(getStruct<T>, {0x17C0, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult15                            OFFSET(getStruct<T>, {0x17E8, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult16                            OFFSET(getStruct<T>, {0x1810, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult17                            OFFSET(getStruct<T>, {0x1838, 40, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer                                OFFSET(getStruct<T>, {0x1860, 72, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult                                   OFFSET(getStruct<T>, {0x18A8, 32, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer1                               OFFSET(getStruct<T>, {0x18C8, 72, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult1                                  OFFSET(getStruct<T>, {0x1910, 32, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer2                               OFFSET(getStruct<T>, {0x1930, 72, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult2                                  OFFSET(getStruct<T>, {0x1978, 32, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer3                               OFFSET(getStruct<T>, {0x1998, 72, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult3                                  OFFSET(getStruct<T>, {0x19E0, 32, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer4                               OFFSET(getStruct<T>, {0x1A00, 72, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult4                                  OFFSET(getStruct<T>, {0x1A48, 32, 0, 0})
	SMember(FAnimNode_BlendSpacePlayer)                AnimGraphNode_BlendSpacePlayer                              OFFSET(getStruct<T>, {0x1A68, 112, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult5                                  OFFSET(getStruct<T>, {0x1AD8, 32, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer5                               OFFSET(getStruct<T>, {0x1AF8, 72, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult6                                  OFFSET(getStruct<T>, {0x1B40, 32, 0, 0})
	SMember(FAnimNode_BlendSpacePlayer)                AnimGraphNode_BlendSpacePlayer1                             OFFSET(getStruct<T>, {0x1B60, 112, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult7                                  OFFSET(getStruct<T>, {0x1BD0, 32, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer6                               OFFSET(getStruct<T>, {0x1BF0, 72, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult8                                  OFFSET(getStruct<T>, {0x1C38, 32, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer7                               OFFSET(getStruct<T>, {0x1C58, 72, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult9                                  OFFSET(getStruct<T>, {0x1CA0, 32, 0, 0})
	SMember(FAnimNode_StateMachine)                    AnimGraphNode_StateMachine                                  OFFSET(getStruct<T>, {0x1CC0, 200, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult18                            OFFSET(getStruct<T>, {0x1D88, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult19                            OFFSET(getStruct<T>, {0x1DB0, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult20                            OFFSET(getStruct<T>, {0x1DD8, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult21                            OFFSET(getStruct<T>, {0x1E00, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult22                            OFFSET(getStruct<T>, {0x1E28, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult23                            OFFSET(getStruct<T>, {0x1E50, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult24                            OFFSET(getStruct<T>, {0x1E78, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult25                            OFFSET(getStruct<T>, {0x1EA0, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult26                            OFFSET(getStruct<T>, {0x1EC8, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult27                            OFFSET(getStruct<T>, {0x1EF0, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult28                            OFFSET(getStruct<T>, {0x1F18, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult29                            OFFSET(getStruct<T>, {0x1F40, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult30                            OFFSET(getStruct<T>, {0x1F68, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult31                            OFFSET(getStruct<T>, {0x1F90, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult32                            OFFSET(getStruct<T>, {0x1FB8, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult33                            OFFSET(getStruct<T>, {0x1FE0, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult34                            OFFSET(getStruct<T>, {0x2008, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult35                            OFFSET(getStruct<T>, {0x2030, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult36                            OFFSET(getStruct<T>, {0x2058, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult37                            OFFSET(getStruct<T>, {0x2080, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult38                            OFFSET(getStruct<T>, {0x20A8, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult39                            OFFSET(getStruct<T>, {0x20D0, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult40                            OFFSET(getStruct<T>, {0x20F8, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult41                            OFFSET(getStruct<T>, {0x2120, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult42                            OFFSET(getStruct<T>, {0x2148, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult43                            OFFSET(getStruct<T>, {0x2170, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult44                            OFFSET(getStruct<T>, {0x2198, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult45                            OFFSET(getStruct<T>, {0x21C0, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult46                            OFFSET(getStruct<T>, {0x21E8, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult47                            OFFSET(getStruct<T>, {0x2210, 40, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer8                               OFFSET(getStruct<T>, {0x2238, 72, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult10                                 OFFSET(getStruct<T>, {0x2280, 32, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer9                               OFFSET(getStruct<T>, {0x22A0, 72, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult11                                 OFFSET(getStruct<T>, {0x22E8, 32, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer10                              OFFSET(getStruct<T>, {0x2308, 72, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult12                                 OFFSET(getStruct<T>, {0x2350, 32, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer11                              OFFSET(getStruct<T>, {0x2370, 72, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult13                                 OFFSET(getStruct<T>, {0x23B8, 32, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer12                              OFFSET(getStruct<T>, {0x23D8, 72, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult14                                 OFFSET(getStruct<T>, {0x2420, 32, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer13                              OFFSET(getStruct<T>, {0x2440, 72, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult15                                 OFFSET(getStruct<T>, {0x2488, 32, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer14                              OFFSET(getStruct<T>, {0x24A8, 72, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult16                                 OFFSET(getStruct<T>, {0x24F0, 32, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer15                              OFFSET(getStruct<T>, {0x2510, 72, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult17                                 OFFSET(getStruct<T>, {0x2558, 32, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer16                              OFFSET(getStruct<T>, {0x2578, 72, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult18                                 OFFSET(getStruct<T>, {0x25C0, 32, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer17                              OFFSET(getStruct<T>, {0x25E0, 72, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult19                                 OFFSET(getStruct<T>, {0x2628, 32, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer18                              OFFSET(getStruct<T>, {0x2648, 72, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult20                                 OFFSET(getStruct<T>, {0x2690, 32, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer19                              OFFSET(getStruct<T>, {0x26B0, 72, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult21                                 OFFSET(getStruct<T>, {0x26F8, 32, 0, 0})
	SMember(FAnimNode_BlendSpacePlayer)                AnimGraphNode_BlendSpacePlayer2                             OFFSET(getStruct<T>, {0x2718, 112, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult22                                 OFFSET(getStruct<T>, {0x2788, 32, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer20                              OFFSET(getStruct<T>, {0x27A8, 72, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult23                                 OFFSET(getStruct<T>, {0x27F0, 32, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer21                              OFFSET(getStruct<T>, {0x2810, 72, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult24                                 OFFSET(getStruct<T>, {0x2858, 32, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer22                              OFFSET(getStruct<T>, {0x2878, 72, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult25                                 OFFSET(getStruct<T>, {0x28C0, 32, 0, 0})
	SMember(FAnimNode_BlendSpacePlayer)                AnimGraphNode_BlendSpacePlayer3                             OFFSET(getStruct<T>, {0x28E0, 112, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult26                                 OFFSET(getStruct<T>, {0x2950, 32, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer23                              OFFSET(getStruct<T>, {0x2970, 72, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult27                                 OFFSET(getStruct<T>, {0x29B8, 32, 0, 0})
	SMember(FAnimNode_StateMachine)                    AnimGraphNode_StateMachine1                                 OFFSET(getStruct<T>, {0x29D8, 200, 0, 0})
	SMember(FAnimNode_TwoWayBlend)                     AnimGraphNode_TwoWayBlend                                   OFFSET(getStruct<T>, {0x2AA0, 192, 0, 0})
	SMember(FAnimNode_TwoWayBlend)                     AnimGraphNode_TwoWayBlend1                                  OFFSET(getStruct<T>, {0x2B60, 192, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer24                              OFFSET(getStruct<T>, {0x2C20, 72, 0, 0})
	...
	// void AnimGraph(FPoseLink& AnimGraph);                                                                                    // [0x246f7d8] HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_Gameplay_FaceSystem_StateMachine_AnimBP(int32_t EntryPoint);                                       // [0x246f7d8] Final                
};
...
public:
	...
	// void Vehicle Dynamics Scaler Function(class UCustomCharacterPartAnimInstance* CharacterPartAnimInstance, bool Debug, class UObject* __WorldContext, double& InVehicleHeadScaleAlpha, double& InVehicleHeadSimAlpha, double& InVehicleSkirtScaleAlpha, double& InVehicleSkirtSimAlpha); // [0x246f7d8] Static|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void Cloth Controller Function Nativization Wrapper(class UCustomCharacterPartAnimInstance* CharacterPartAnimInstance, FString& ClothingAssetName, FClothControllerClothParameterMap& Cloth Paramaters, FClothCoreSettings& Cloth Core Settings, FVector ClothUpAxis, double OnGround_Moving_Speed_Limit, double OnGround_Moving_AngularVel_Max, double OnGround_Moving_FictitiousVel_Max, double LinVelScale_FwdBwd_Clamp, double LinVelScale_UpDwn_Clamp, float DeltaTime, float GameTimeInSeconds, FClothControllerWindParameterMap& WindGustsParams, FWindGustSettings& WindGustLocalSettings, class UObject* __WorldContext, FName& CharacterStateOut, FClothParameters& Cloth Settings Out, FWindGustSettings& WindGustLocalSettings Out, FVector& GustStrength - WindVelocityOut, FVector& LinearVelVector-DELETE LATER); // [0x246f7d8] Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent 
	...
	// void Cloth Controller Convert To Nativized Parameters(FClothParamsStruct ClothParametersStruct, FWindGustParamsStruct WindParametersStruct, FClothCoreSettingStruct Cloth Core Settings, FWindGustLocalSettingStruct Wind Gust Settings, FName Character State Name, class UObject* __WorldContext, FClothParameters& Cloth Parameters Nativized, FWindGustParameters& Wind Parameters Nativized, FClothCoreSettings& ClothCoreSettings, FWindGustSettings& Wind Settings Nativized); // [0x246f7d8] Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent 
	...
	// void ConvertToNativizedWindParameters(FWindGustSettingStruct& WindGustSettingStruct, class UObject* __WorldContext, FWindGustParameters& WindGustParameters); // [0x246f7d8] Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent 
	...
	// void ConvertToNativizedClothParameters(FClothSettingStruct& ClothSettingStruct, class UObject* __WorldContext, FClothParameters& ClothParameters); // [0x246f7d8] Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent 
	...
	// void Get Joint Location Relative to Bone(FName Target Joint, FName Relative Joint, FVector Offset, class UMeshComponent* SkelMeshComponent, bool Debug Draw, class UObject* __WorldContext, FVector& Joint Location Vector); // [0x246f7d8] Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent 
	...
	// void Cape Spine05 Pelvis Rotation Function(class USkinnedMeshComponent* SkeletalMeshComponent, class UObject* __WorldContext, FRotator& Rotate Z Output); // [0x246f7d8] Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent 
	...
	// void Get WPO Regional Param Names Function(int32_t& Region, class UObject* __WorldContext, FName& Velocity, FName& Bone Position, FName& Bone Vector); // [0x246f7d8] Private|HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void Cloth Controller Helper Scale For Player Movement(FVector LinearVelScale, double PlayerFwdVector, double PlayerFwdVectorJump, double ClothUpX, double ClothUpZ, class UObject* __WorldContext, FVector& LinearVelVectorOut); // [0x246f7d8] Static|Private|HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void Scale Joint Rotation Function(FRotator Scale, FName TargetBone, FName ReferenceBone, class USkinnedMeshComponent* SkelMeshComponent, class UObject* __WorldContext, FRotator& FinalRotation, FRotator& OriginalRotation); // [0x246f7d8] Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent 
	...
	// void Adjust Emote Vehicle Wheel Rotation(class AActor* Owning Actor, double CurrentWheelRotation, double DeltaTime, double CurrentActorRotation, class UObject* __WorldContext, double& NewActorRotation, double& NewWheelRotation); // [0x246f7d8] Static|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void Gravity Override Setter Function(class UCustomCharacterPartAnimInstance* CharacterPartAnimInstance, class UMeshComponent* SkelMeshComponent, FGravityOverrideSettingStruct GravityOverride Settings, double GameTimeInSeconds, class UObject* __WorldContext, FGravityOverrideSettingStruct& GravityOverride Settings Out, FVector& GravityOverride Out); // [0x246f7d8] Static|Private|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent 
	...
	// void Play Transformation Montage(class AFortPlayerPawn* FortPlayerPawn, class UObject* __WorldContext);                  // [0x246f7d8] Static|Public|BlueprintCallable|BlueprintEvent 
	...
	// void Clear Transformation Montage(class AFortPlayerPawn* FortPlayerPawn, class UObject* __WorldContext);                 // [0x246f7d8] Static|Public|BlueprintCallable|BlueprintEvent 
	...
	// void Set Transformation Montage(class AFortPlayerPawn* FortPlayerPawn, class UAnimMontage* Montage, double StartTime, class UObject* __WorldContext); // [0x246f7d8] Static|Public|BlueprintCallable|BlueprintEvent 
	...
	// void Cloth Controller Setter Function(class UCustomCharacterPartAnimInstance* CharacterPartAnimInstance, FClothSettingStruct Cloth Settings, class UObject* __WorldContext, FClothSettingStruct& Cloth Settings Out); // [0x246f7d8] Static|Private|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent 
	...
	// void DrawVectorFromJointFunction(class USceneComponent* SkelMeshComponent, FName JointName, FVector LineEnd, FVector JointOffset, FLinearColor LineColor, double Thickness, class UObject* __WorldContext); // [0x246f7d8] Static|Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Animation/Libraries/FortAnimationBPFunctionLibrary.FortAnimationBPFunctionLibrary_C.DrawJointDebugFunction
	// void DrawJointDebugFunction(class USceneComponent* SkelMeshComponent, FVector JointOffset, TArray<FName>& JointName, double Scale, double duration, double Thickness, bool DebugDraw, class UObject* __WorldContext); // [0x246f7d8] Static|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
...
public:
	...
	// bool Received_NotifyTick(class USkeletalMeshComponent* MeshComp, class UAnimSequenceBase* Animation, float FrameDeltaTime, FAnimNotifyEventReference& EventReference); // [0x246f7d8] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|Const 
};
...
public:
	...
	// void GetRiderPettingMontage(class AActor* RiderActor, class UAnimMontage*& RiderPettingMontage);                         // [0x246f7d8] Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	...
	// bool Received_NotifyEnd(class USkeletalMeshComponent* MeshComp, class UAnimSequenceBase* Animation, FAnimNotifyEventReference& EventReference); // [0x246f7d8] Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|Const 
	...
	// bool Received_NotifyBegin(class USkeletalMeshComponent* MeshComp, class UAnimSequenceBase* Animation, float TotalDuration, FAnimNotifyEventReference& EventReference); // [0x246f7d8] Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|Const 
};
...
public:
	...
	// void VehicleFinalPoseOverride(FPoseLink InFinalPose, FPoseLink& VehicleFinalPoseOverride);                               // [0x246f7d8] HasOutParms|BlueprintCallable 
	...
	// void VehicleFullBodyOverride(FPoseLink InPoseFullBody, FPoseLink& VehicleFullBodyOverride);                              // [0x246f7d8] HasOutParms|BlueprintCallable 
	...
	// void VehicleLowerBodyOverride(FPoseLink InPoseLowerBodyDefault, FPoseLink InPoseUpperBody, FPoseLink& VehicleLowerBodyOverride); // [0x246f7d8] HasOutParms|BlueprintCallable 
	...
	// void VehicleSplitBodyOverride(FPoseLink InPoseSplitBody, FPoseLink InPoseUpperAndLowerBody, FPoseLink InPoseUpperAndLowerBodyRemoveRoot, FPoseLink& VehicleSplitBodyOverride); // [0x246f7d8] HasOutParms|BlueprintCallable 
	...
	// void GetMainAnimBPData_Boar(class UObject* AnimInstance);                                                                // [0x246f7d8] Public|BlueprintCallable|BlueprintEvent 
	...
	// void EvaluateGraphExposedInputs_ExecuteUbergraph_BoarRidingPlayerLayerAnimBP_AnimGraphNode_BlendListByBool_3AC2A6BB409F97D93A87FE8016464FEE(); // [0x246f7d8] BlueprintEvent       
	...
	// void BlueprintCollectRidableAnimBPData(class UAnimInstance* RidableAnimInstance);                                        // [0x246f7d8] Event|Protected|BlueprintEvent 
	...
	// void ExecuteUbergraph_BoarRidingPlayerLayerAnimBP(int32_t EntryPoint);                                                   // [0x246f7d8] Final                
};
...
public:
	...
	// void GetMainAnimBPData_Wolf(class UObject* AnimInstance);                                                                // [0x246f7d8] Public|BlueprintCallable|BlueprintEvent 
	...
	// void EvaluateGraphExposedInputs_ExecuteUbergraph_WolfRidingPlayerLayerAnimBP_AnimGraphNode_SequencePlayer_0A1EFC344EF1A6E586A54FAEC4F5F766(); // [0x246f7d8] BlueprintEvent       
	...
	// void EvaluateGraphExposedInputs_ExecuteUbergraph_WolfRidingPlayerLayerAnimBP_AnimGraphNode_SequencePlayer_4EDCD4F04E8D5963547EB2BE1F10FA2D(); // [0x246f7d8] BlueprintEvent       
	...
	// void EvaluateGraphExposedInputs_ExecuteUbergraph_WolfRidingPlayerLayerAnimBP_AnimGraphNode_BlendListByBool_D7C43EB141CFE2929E3D23914954FA93(); // [0x246f7d8] BlueprintEvent       
	...
	// void UpdateBoostPlayRate();                                                                                              // [0x246f7d8] Event|Protected|BlueprintEvent 
	...
	// void PlaceHandIKTargets();                                                                                               // [0x246f7d8] Event|Protected|BlueprintEvent 
	...
	// void ExecuteUbergraph_WolfRidingPlayerLayerAnimBP(int32_t EntryPoint);                                                   // [0x246f7d8] Final                
};
...
public:
	...
	// void EvaluateGraphExposedInputs_ExecuteUbergraph_RidingPlayerLayerAnimBP_AnimGraphNode_BlendListByBool_D1B22730415169A7290CBFAD6C915976(); // [0x246f7d8] BlueprintEvent       
	...
	// void EvaluateGraphExposedInputs_ExecuteUbergraph_RidingPlayerLayerAnimBP_AnimGraphNode_RotateRootBone_D73766CE4BF0C956278D7FA8259A40CA(); // [0x246f7d8] BlueprintEvent       
	// Function /RidingContent/Animation/Proto/RidingPlayerLayerAnimBP.RidingPlayerLayerAnimBP_C.BlueprintUpdateAnimation
	// void BlueprintUpdateAnimation(float DeltaTimeX);                                                                         // [0x246f7d8] Event|Public|BlueprintEvent 
	...
	// void ExecuteUbergraph_RidingPlayerLayerAnimBP(int32_t EntryPoint);                                                       // [0x246f7d8] Final|HasDefaults    
};

/// Class /LocomotionInitiative/Animation/Anim_NotifyStates/AnimNotifyState_BranchOutWindow.AnimNotifyState_BranchOutWindow_C
/// Size: 0x0000 (0x000030 - 0x000030)
class UAnimNotifyState_BranchOutWindow_C : public UAnimNotifyState
{ 
	friend MDKHandler;
	static inline constexpr uint64_t __MDKClassSize = 48;
...
/// Class /LocomotionInitiative/Animation/AnimationBlueprints/LinkedAnimGraphs/Player_RigidBodyPBA_AnimBP.Player_RigidBodyPBA_AnimBP_C
/// Size: 0x359C (0x000730 - 0x003CCC)
class UPlayer_RigidBodyPBA_AnimBP_C : public UFortPlayerRigidBodyPBAAnimInstance
{ 
	friend MDKHandler;
	static inline constexpr uint64_t __MDKClassSize = 15564;

public:
	SMember(FPointerToUberGraphFrame)                  UberGraphFrame                                              OFFSET(getStruct<T>, {0x730, 8, 0, 0})
	SMember(FAnimBlueprintGeneratedMutableData)        __AnimBlueprintMutables                                     OFFSET(getStruct<T>, {0x738, 3, 0, 0})
	...
	SMember(FAnimNode_RigidBodyWithControl)            AnimGraphNode_RigidBodyWithControl                          OFFSET(getStruct<T>, {0x750, 3648, 0, 0})
	SMember(FAnimNode_ConvertComponentToLocalSpace)    AnimGraphNode_ComponentToLocalSpace                         OFFSET(getStruct<T>, {0x1590, 32, 0, 0})
	SMember(FAnimNode_ConvertLocalToComponentSpace)    AnimGraphNode_LocalToComponentSpace                         OFFSET(getStruct<T>, {0x15B0, 32, 0, 0})
	SMember(FAnimNode_SaveCachedPose)                  AnimGraphNode_SaveCachedPose                                OFFSET(getStruct<T>, {0x15D0, 120, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose                                 OFFSET(getStruct<T>, {0x1648, 40, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose                               OFFSET(getStruct<T>, {0x1670, 176, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool                               OFFSET(getStruct<T>, {0x1720, 72, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose1                                OFFSET(getStruct<T>, {0x1768, 40, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool1                              OFFSET(getStruct<T>, {0x1790, 72, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root                                          OFFSET(getStruct<T>, {0x17D8, 32, 0, 0})
	SMember(FAnimNode_ConvertLocalToComponentSpace)    AnimGraphNode_LocalToComponentSpace1                        OFFSET(getStruct<T>, {0x17F8, 32, 0, 0})
	SMember(FAnimNode_ConvertComponentToLocalSpace)    AnimGraphNode_ComponentToLocalSpace1                        OFFSET(getStruct<T>, {0x1818, 32, 0, 0})
	SMember(FAnimNode_RigidBodyWithControl)            AnimGraphNode_RigidBodyWithControl1                         OFFSET(getStruct<T>, {0x1840, 3648, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose2                                OFFSET(getStruct<T>, {0x2680, 40, 0, 0})
	SMember(FRBANParamsStruct)                         RBAN_Params                                                 OFFSET(getStruct<T>, {0x26A8, 2880, 0, 0})
	SMember(FGravityOverrideParamsStruct)              Gravity_Override_Params                                     OFFSET(getStruct<T>, {0x31E8, 1976, 0, 0})
	SMember(FVector)                                   GravityOverride                                             OFFSET(getStruct<T>, {0x39A0, 24, 0, 0})
	SMember(FRBANSettingStruct)                        RBAN_Settings                                               OFFSET(getStruct<T>, {0x39B8, 144, 0, 0})
	SMember(FVector)                                   External_Forces                                             OFFSET(getStruct<T>, {0x3A48, 24, 0, 0})
	SMember(FPhysicsControlControlAndModifierParameters) Control_And_Modifier_Parameters_Final                     OFFSET(getStruct<T>, {0x3A60, 48, 0, 0})
	SMember(FPhysicsControlControlAndModifierParameters) Control_And_Modifier_Parameters_Bike                      OFFSET(getStruct<T>, {0x3A90, 48, 0, 0})
	SMember(FPhysicsControlControlAndModifierParameters) Control_And_Modifier_Parameters_Floating                  OFFSET(getStruct<T>, {0x3AC0, 48, 0, 0})
	SMember(FPhysicsControlControlAndModifierParameters) Control_And_Modifier_Parameters_Diving                    OFFSET(getStruct<T>, {0x3AF0, 48, 0, 0})
	SMember(FPhysicsControlControlAndModifierParameters) Control_And_Modifier_Parameters_Off                       OFFSET(getStruct<T>, {0x3B20, 48, 0, 0})
	SMember(FPhysicsControlControlAndModifierParameters) Control_And_Modifier_Parameters_Parachuting               OFFSET(getStruct<T>, {0x3B50, 48, 0, 0})
	SMember(FPhysicsControlControlAndModifierParameters) Control_And_Modifier_Parameters_Full_Ragdoll              OFFSET(getStruct<T>, {0x3B80, 48, 0, 0})
	SMember(FPhysicsControlControlAndModifierParameters) Control_And_Modifier_Parameters_Zipline                   OFFSET(getStruct<T>, {0x3BB0, 48, 0, 0})
	SMember(FPhysicsControlControlAndModifierParameters) Control_And_Modifier_Parameters_QuadCrusher               OFFSET(getStruct<T>, {0x3BE0, 48, 0, 0})
	SMember(FPhysicsControlControlAndModifierParameters) Control_and_Modifier_Parameters_DBNO_Carried              OFFSET(getStruct<T>, {0x3C10, 48, 0, 0})
	DMember(bool)                                      C_Version                                                   OFFSET(get<bool>, {0x3C40, 1, 0, 0})
	SMember(FPhysicsControlControlAndModifierParameters) Control_And_Modifier_Parameters_Parachuting_C_Version     OFFSET(getStruct<T>, {0x3C48, 48, 0, 0})
	SMember(FPhysicsControlControlAndModifierParameters) Temp                                                      OFFSET(getStruct<T>, {0x3C78, 48, 0, 0})
	DMember(bool)                                      UsePBAInAnimGraph                                           OFFSET(get<bool>, {0x3CA8, 1, 0, 0})
	SMember(FName)                                     CurrentControlStateName                                     OFFSET(getStruct<T>, {0x3CAC, 4, 0, 0})
	SMember(FName)                                     PreviousControlStateName                                    OFFSET(getStruct<T>, {0x3CB0, 4, 0, 0})
	DMember(double)                                    ControlParamTransitionRemainingTime                         OFFSET(get<double>, {0x3CB8, 8, 0, 0})
	DMember(double)                                    ControlParamTransitionTime                                  OFFSET(get<double>, {0x3CC0, 8, 0, 0})
	DMember(bool)                                      isWingFlying                                                OFFSET(get<bool>, {0x3CC8, 1, 0, 0})
	DMember(bool)                                      isFlyingActive                                              OFFSET(get<bool>, {0x3CC9, 1, 0, 0})
	DMember(bool)                                      isWingFlyingB                                               OFFSET(get<bool>, {0x3CCA, 1, 0, 0})
	DMember(bool)                                      isBoosingActive                                             OFFSET(get<bool>, {0x3CCB, 1, 0, 0})


	/// Functions
	// Function /LocomotionInitiative/Animation/AnimationBlueprints/LinkedAnimGraphs/Player_RigidBodyPBA_AnimBP.Player_RigidBodyPBA_AnimBP_C.AnimGraph
	// void AnimGraph(FPoseLink InPose, FPoseLink& AnimGraph);                                                                  // [0x246f7d8] HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /LocomotionInitiative/Animation/AnimationBlueprints/LinkedAnimGraphs/Player_RigidBodyPBA_AnimBP.Player_RigidBodyPBA_AnimBP_C.OnUpdate_Wings
	// void OnUpdate_Wings(FAnimUpdateContext& Context, FAnimNodeReference& Node);                                              // [0x246f7d8] Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /LocomotionInitiative/Animation/AnimationBlueprints/LinkedAnimGraphs/Player_RigidBodyPBA_AnimBP.Player_RigidBodyPBA_AnimBP_C.On Update
	// void On Update(FAnimUpdateContext& Context, FAnimNodeReference& Node);                                                   // [0x246f7d8] Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /LocomotionInitiative/Animation/AnimationBlueprints/LinkedAnimGraphs/Player_RigidBodyPBA_AnimBP.Player_RigidBodyPBA_AnimBP_C.TrackFastAnimationMovements
	// void TrackFastAnimationMovements();                                                                                      // [0x246f7d8] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /LocomotionInitiative/Animation/AnimationBlueprints/LinkedAnimGraphs/Player_RigidBodyPBA_AnimBP.Player_RigidBodyPBA_AnimBP_C.BlueprintUpdateAnimation
	// void BlueprintUpdateAnimation(float DeltaTimeX);                                                                         // [0x246f7d8] Event|Public|BlueprintEvent 
	// Function /LocomotionInitiative/Animation/AnimationBlueprints/LinkedAnimGraphs/Player_RigidBodyPBA_AnimBP.Player_RigidBodyPBA_AnimBP_C.DisableControls
	// void DisableControls();                                                                                                  // [0x246f7d8] BlueprintCallable|BlueprintEvent 
	// Function /LocomotionInitiative/Animation/AnimationBlueprints/LinkedAnimGraphs/Player_RigidBodyPBA_AnimBP.Player_RigidBodyPBA_AnimBP_C.BlueprintBeginPlay
	// void BlueprintBeginPlay();                                                                                               // [0x246f7d8] Event|Public|BlueprintEvent 
	// Function /LocomotionInitiative/Animation/AnimationBlueprints/LinkedAnimGraphs/Player_RigidBodyPBA_AnimBP.Player_RigidBodyPBA_AnimBP_C.ExecuteUbergraph_Player_RigidBodyPBA_AnimBP
	// void ExecuteUbergraph_Player_RigidBodyPBA_AnimBP(int32_t EntryPoint);                                                    // [0x246f7d8] Final                
};

/// Class /LocomotionInitiative/Animation/AnimationBlueprints/Player_MotionMatchingLocomotion_AnimBP.Player_MotionMatchingLocomotion_AnimBP_C
/// Size: 0x297C (0x001970 - 0x0042EC)
class UPlayer_MotionMatchingLocomotion_AnimBP_C : public UFortPlayerMotionMatchingLocomotionAnimInstance
{ 
	friend MDKHandler;
	static inline constexpr uint64_t __MDKClassSize = 17132;

public:
	SMember(FPointerToUberGraphFrame)                  UberGraphFrame                                              OFFSET(getStruct<T>, {0x1970, 8, 0, 0})
	SMember(FAnimBlueprintGeneratedMutableData)        __AnimBlueprintMutables                                     OFFSET(getStruct<T>, {0x1978, 32, 0, 0})
	SMember(FAnimSubsystemInstance)                    AnimBlueprintExtension_PropertyAccess                       OFFSET(getStruct<T>, {0x1998, 8, 0, 0})
	SMember(FAnimSubsystemInstance)                    AnimBlueprintExtension_Base                                 OFFSET(getStruct<T>, {0x19A0, 8, 0, 0})
	SMember(FAnimNode_PoseSearchHistoryCollector)      AnimGraphNode_PoseSearchHistoryCollector                    OFFSET(getStruct<T>, {0x19A8, 680, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult                              OFFSET(getStruct<T>, {0x1C50, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult1                             OFFSET(getStruct<T>, {0x1C78, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult2                             OFFSET(getStruct<T>, {0x1CA0, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult3                             OFFSET(getStruct<T>, {0x1CC8, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult4                             OFFSET(getStruct<T>, {0x1CF0, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult5                             OFFSET(getStruct<T>, {0x1D18, 40, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose                                 OFFSET(getStruct<T>, {0x1D40, 40, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool                               OFFSET(getStruct<T>, {0x1D68, 72, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose1                                OFFSET(getStruct<T>, {0x1DB0, 40, 0, 0})
	SMember(FAnimNode_ApplyAdditive)                   AnimGraphNode_ApplyAdditive                                 OFFSET(getStruct<T>, {0x1DD8, 200, 0, 0})
	SMember(FAnimNode_BlendSpacePlayer)                AnimGraphNode_BlendSpacePlayer                              OFFSET(getStruct<T>, {0x1EA0, 112, 0, 0})
	SMember(FAnimNode_LayeredBoneBlend)                AnimGraphNode_LayeredBoneBlend                              OFFSET(getStruct<T>, {0x1F10, 240, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose2                                OFFSET(getStruct<T>, {0x2000, 40, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer                                OFFSET(getStruct<T>, {0x2028, 72, 0, 0})
	SMember(FAnimNode_ApplyAdditive)                   AnimGraphNode_ApplyAdditive1                                OFFSET(getStruct<T>, {0x2070, 200, 0, 0})
	SMember(FAnimNode_RotateRootBone)                  AnimGraphNode_RotateRootBone                                OFFSET(getStruct<T>, {0x2138, 176, 0, 0})
	SMember(FAnimNode_BlendSpacePlayer)                AnimGraphNode_BlendSpacePlayer1                             OFFSET(getStruct<T>, {0x21E8, 112, 0, 0})
	SMember(FAnimNode_BlendSpacePlayer)                AnimGraphNode_BlendSpacePlayer2                             OFFSET(getStruct<T>, {0x2258, 112, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool1                              OFFSET(getStruct<T>, {0x22C8, 72, 0, 0})
	SMember(FAnimNode_RotateRootBone)                  AnimGraphNode_RotateRootBone1                               OFFSET(getStruct<T>, {0x2310, 176, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool2                              OFFSET(getStruct<T>, {0x23C0, 72, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult                                   OFFSET(getStruct<T>, {0x2408, 32, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult6                             OFFSET(getStruct<T>, {0x2428, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult7                             OFFSET(getStruct<T>, {0x2450, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult8                             OFFSET(getStruct<T>, {0x2478, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult9                             OFFSET(getStruct<T>, {0x24A0, 40, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer1                               OFFSET(getStruct<T>, {0x24C8, 72, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult1                                  OFFSET(getStruct<T>, {0x2510, 32, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer2                               OFFSET(getStruct<T>, {0x2530, 72, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer3                               OFFSET(getStruct<T>, {0x2578, 72, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool3                              OFFSET(getStruct<T>, {0x25C0, 72, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult2                                  OFFSET(getStruct<T>, {0x2608, 32, 0, 0})
	SMember(FAnimNode_StateMachine)                    AnimGraphNode_StateMachine                                  OFFSET(getStruct<T>, {0x2628, 200, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult3                                  OFFSET(getStruct<T>, {0x26F0, 32, 0, 0})
	SMember(FAnimNode_StateMachine)                    AnimGraphNode_StateMachine1                                 OFFSET(getStruct<T>, {0x2710, 200, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult10                            OFFSET(getStruct<T>, {0x27D8, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult11                            OFFSET(getStruct<T>, {0x2800, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult12                            OFFSET(getStruct<T>, {0x2828, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult13                            OFFSET(getStruct<T>, {0x2850, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult14                            OFFSET(getStruct<T>, {0x2878, 40, 0, 0})
	SMember(FAnimNode_ApplyMeshSpaceAdditive)          AnimGraphNode_ApplyMeshSpaceAdditive                        OFFSET(getStruct<T>, {0x28A0, 208, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer4                               OFFSET(getStruct<T>, {0x2970, 72, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose3                                OFFSET(getStruct<T>, {0x29B8, 40, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool4                              OFFSET(getStruct<T>, {0x29E0, 72, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer5                               OFFSET(getStruct<T>, {0x2A28, 72, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult4                                  OFFSET(getStruct<T>, {0x2A70, 32, 0, 0})
	SMember(FAnimNode_ApplyMeshSpaceAdditive)          AnimGraphNode_ApplyMeshSpaceAdditive1                       OFFSET(getStruct<T>, {0x2A90, 208, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer6                               OFFSET(getStruct<T>, {0x2B60, 72, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose4                                OFFSET(getStruct<T>, {0x2BA8, 40, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool5                              OFFSET(getStruct<T>, {0x2BD0, 72, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer7                               OFFSET(getStruct<T>, {0x2C18, 72, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult5                                  OFFSET(getStruct<T>, {0x2C60, 32, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose5                                OFFSET(getStruct<T>, {0x2C80, 40, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult6                                  OFFSET(getStruct<T>, {0x2CA8, 32, 0, 0})
	SMember(FAnimNode_StateMachine)                    AnimGraphNode_StateMachine2                                 OFFSET(getStruct<T>, {0x2CC8, 200, 0, 0})
	SMember(FAnimNode_SaveCachedPose)                  AnimGraphNode_SaveCachedPose                                OFFSET(getStruct<T>, {0x2D90, 120, 0, 0})
	SMember(FAnimNode_ConvertComponentToLocalSpace)    AnimGraphNode_ComponentToLocalSpace                         OFFSET(getStruct<T>, {0x2E08, 32, 0, 0})
	SMember(FAnimNode_ResetRoot)                       AnimGraphNode_ResetRoot                                     OFFSET(getStruct<T>, {0x2E28, 216, 0, 0})
	SMember(FAnimNode_ConvertLocalToComponentSpace)    AnimGraphNode_LocalToComponentSpace                         OFFSET(getStruct<T>, {0x2F00, 32, 0, 0})
	SMember(FAnimNode_OrientationWarping)              AnimGraphNode_OrientationWarping                            OFFSET(getStruct<T>, {0x2F20, 544, 0, 0})
	SMember(FAnimNode_BlendStackInput)                 AnimGraphNode_BlendStackInput                               OFFSET(getStruct<T>, {0x3140, 40, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_BlendStackResult                              OFFSET(getStruct<T>, {0x3168, 32, 0, 0})
	SMember(FAnimNode_ConvertComponentToLocalSpace)    AnimGraphNode_ComponentToLocalSpace1                        OFFSET(getStruct<T>, {0x3188, 32, 0, 0})
	SMember(FAnimNode_ResetRoot)                       AnimGraphNode_ResetRoot1                                    OFFSET(getStruct<T>, {0x31A8, 216, 0, 0})
	SMember(FAnimNode_ConvertLocalToComponentSpace)    AnimGraphNode_LocalToComponentSpace1                        OFFSET(getStruct<T>, {0x3280, 32, 0, 0})
	SMember(FAnimNode_OrientationWarping)              AnimGraphNode_OrientationWarping1                           OFFSET(getStruct<T>, {0x32A0, 544, 0, 0})
	SMember(FAnimNode_BlendStackInput)                 AnimGraphNode_BlendStackInput1                              OFFSET(getStruct<T>, {0x34C0, 40, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_BlendStackResult1                             OFFSET(getStruct<T>, {0x34E8, 32, 0, 0})
	SMember(FAnimNode_ConvertComponentToLocalSpace)    AnimGraphNode_ComponentToLocalSpace2                        OFFSET(getStruct<T>, {0x3508, 32, 0, 0})
	SMember(FAnimNode_ResetRoot)                       AnimGraphNode_ResetRoot2                                    OFFSET(getStruct<T>, {0x3528, 216, 0, 0})
	SMember(FAnimNode_ConvertLocalToComponentSpace)    AnimGraphNode_LocalToComponentSpace2                        OFFSET(getStruct<T>, {0x3600, 32, 0, 0})
	SMember(FAnimNode_OrientationWarping)              AnimGraphNode_OrientationWarping2                           OFFSET(getStruct<T>, {0x3620, 544, 0, 0})
	SMember(FAnimNode_BlendStackInput)                 AnimGraphNode_BlendStackInput2                              OFFSET(getStruct<T>, {0x3840, 40, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_BlendStackResult2                             OFFSET(getStruct<T>, {0x3868, 32, 0, 0})
	SMember(FAnimNode_ConvertComponentToLocalSpace)    AnimGraphNode_ComponentToLocalSpace3                        OFFSET(getStruct<T>, {0x3888, 32, 0, 0})
	SMember(FAnimNode_ResetRoot)                       AnimGraphNode_ResetRoot3                                    OFFSET(getStruct<T>, {0x38A8, 216, 0, 0})
	SMember(FAnimNode_ConvertLocalToComponentSpace)    AnimGraphNode_LocalToComponentSpace3                        OFFSET(getStruct<T>, {0x3980, 32, 0, 0})
	SMember(FAnimNode_OrientationWarping)              AnimGraphNode_OrientationWarping3                           OFFSET(getStruct<T>, {0x39A0, 544, 0, 0})
	SMember(FAnimNode_BlendStackInput)                 AnimGraphNode_BlendStackInput3                              OFFSET(getStruct<T>, {0x3BC0, 40, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_BlendStackResult3                             OFFSET(getStruct<T>, {0x3BE8, 32, 0, 0})
	SMember(FAnimNode_MotionMatching)                  AnimGraphNode_MotionMatching                                OFFSET(getStruct<T>, {0x3C08, 408, 0, 0})
	SMember(FAnimNode_SaveCachedPose)                  AnimGraphNode_SaveCachedPose1                               OFFSET(getStruct<T>, {0x3DA0, 120, 0, 0})
	SMember(FAnimNode_TwoWayBlend)                     AnimGraphNode_TwoWayBlend                                   OFFSET(getStruct<T>, {0x3E18, 192, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose6                                OFFSET(getStruct<T>, {0x3ED8, 40, 0, 0})
	SMember(FAnimNode_ChooserPlayer)                   AnimGraphNode_ChooserPlayer                                 OFFSET(getStruct<T>, {0x3F00, 568, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root                                          OFFSET(getStruct<T>, {0x4138, 32, 0, 0})
	SMember(FAnimNode_ApplyMeshSpaceAdditive)          AnimGraphNode_ApplyMeshSpaceAdditive2                       OFFSET(getStruct<T>, {0x4158, 208, 0, 0})
	SMember(FAnimNode_SaveCachedPose)                  AnimGraphNode_SaveCachedPose2                               OFFSET(getStruct<T>, {0x4228, 120, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose7                                OFFSET(getStruct<T>, {0x42A0, 40, 0, 0})
	CMember(class UCharacterMovementComponent*)        OwnerCharMoveComp                                           OFFSET(get<T>, {0x42C8, 8, 0, 0})
	DMember(float)                                     TorsoLocomotionWeight                                       OFFSET(get<float>, {0x42D0, 4, 0, 0})
	DMember(float)                                     ArmLeftLocomotionWeight                                     OFFSET(get<float>, {0x42D4, 4, 0, 0})
	DMember(float)                                     ArmRightLocomotionWeight                                    OFFSET(get<float>, {0x42D8, 4, 0, 0})
	DMember(float)                                     LeftFingersWepAlpha                                         OFFSET(get<float>, {0x42DC, 4, 0, 0})
	DMember(float)                                     RightFingersWepAlpha                                        OFFSET(get<float>, {0x42E0, 4, 0, 0})
	DMember(bool)                                      IsCrouchTransition                                          OFFSET(get<bool>, {0x42E4, 1, 0, 0})
	DMember(float)                                     RunLeanAlpha                                                OFFSET(get<float>, {0x42E8, 4, 0, 0})


	/// Functions
	// Function /LocomotionInitiative/Animation/AnimationBlueprints/Player_MotionMatchingLocomotion_AnimBP.Player_MotionMatchingLocomotion_AnimBP_C.AnimGraph
	// void AnimGraph(FPoseLink& AnimGraph);                                                                                    // [0x246f7d8] HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /LocomotionInitiative/Animation/AnimationBlueprints/Player_MotionMatchingLocomotion_AnimBP.Player_MotionMatchingLocomotion_AnimBP_C.UpdateMotionMatchingNode_PreNativize
	// void UpdateMotionMatchingNode_PreNativize(FAnimUpdateContext& Context, FAnimNodeReference& Node);                        // [0x246f7d8] Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /LocomotionInitiative/Animation/AnimationBlueprints/Player_MotionMatchingLocomotion_AnimBP.Player_MotionMatchingLocomotion_AnimBP_C.ExecuteUbergraph_Player_MotionMatchingLocomotion_AnimBP
	// void ExecuteUbergraph_Player_MotionMatchingLocomotion_AnimBP(int32_t EntryPoint);                                        // [0x246f7d8] Final                
};
...
class FAnimBlueprintGeneratedConstantDatadup_128 : public FAnimBlueprintConstantData
{ 
	friend MDKHandler;
	friend MDKBase;
...
class FAnimBlueprintGeneratedMutableDatadup_129 : public FAnimBlueprintMutableData
{ 
	friend MDKHandler;
	friend MDKBase;
...
class FAnimBlueprintGeneratedConstantDatadup_130 : public FAnimBlueprintConstantData
{ 
	friend MDKHandler;
	friend MDKBase;
...
class FAnimBlueprintGeneratedMutableDatadup_131 : public FAnimBlueprintMutableData
{ 
	friend MDKHandler;
	friend MDKBase;
	static inline constexpr uint64_t __MDKClassSize = 168;
...
class FAnimBlueprintGeneratedConstantDatadup_132 : public FAnimBlueprintConstantData
{ 
	friend MDKHandler;
	friend MDKBase;
...
class FAnimBlueprintGeneratedMutableDatadup_133 : public FAnimBlueprintMutableData
{ 
	friend MDKHandler;
	friend MDKBase;
...
/// Struct /LocomotionInitiative/Animation/AnimationBlueprints/LinkedAnimGraphs/Player_RigidBodyPBA_AnimBP.Player_RigidBodyPBA_AnimBP_C.AnimBlueprintGeneratedConstantData
/// Size: 0x03B7 (0x000001 - 0x0003B8)
class FAnimBlueprintGeneratedConstantDatadup_134 : public FAnimBlueprintConstantData
{ 
	friend MDKHandler;
	friend MDKBase;
...
public:
	...
	CMember(class UBlendProfile*)                      __BlendProfile                                              OFFSET(get<T>, {0x20, 8, 0, 0})
	CMember(class UCurveFloat*)                        __CurveFloat                                                OFFSET(get<T>, {0x28, 8, 0, 0})
	DMember(bool)                                      __BoolProperty                                              OFFSET(get<bool>, {0x30, 1, 0, 0})
	CMember(EAlphaBlendOption)                         __EnumProperty                                              OFFSET(get<T>, {0x31, 1, 0, 0})
	CMember(EBlendListTransitionType)                  __EnumProperty1                                             OFFSET(get<T>, {0x32, 1, 0, 0})
	CMember(TArray<float>)                             __ArrayProperty                                             OFFSET(get<T>, {0x38, 16, 0, 0})
	SMember(FName)                                     __NameProperty                                              OFFSET(getStruct<T>, {0x48, 4, 0, 0})
	SMember(FName)                                     __NameProperty1                                             OFFSET(getStruct<T>, {0x4C, 4, 0, 0})
	SMember(FAnimNodeFunctionRef)                      __StructProperty1                                           OFFSET(getStruct<T>, {0x50, 24, 0, 0})
	SMember(FAnimNodeFunctionRef)                      __StructProperty2                                           OFFSET(getStruct<T>, {0x68, 24, 0, 0})
	SMember(FAnimSubsystem_PropertyAccess)             AnimBlueprintExtension_PropertyAccess                       OFFSET(getStruct<T>, {0x80, 128, 0, 0})
	SMember(FAnimSubsystem_Base)                       AnimBlueprintExtension_Base                                 OFFSET(getStruct<T>, {0x100, 24, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_RigidBodyWithControl                        OFFSET(getStruct<T>, {0x118, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_ComponentToLocalSpace                       OFFSET(getStruct<T>, {0x148, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_LocalToComponentSpace                       OFFSET(getStruct<T>, {0x178, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_SaveCachedPose                              OFFSET(getStruct<T>, {0x1A8, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_UseCachedPose                               OFFSET(getStruct<T>, {0x1D8, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_LinkedInputPose                             OFFSET(getStruct<T>, {0x208, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_BlendListByBool                             OFFSET(getStruct<T>, {0x238, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_UseCachedPose1                              OFFSET(getStruct<T>, {0x268, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_BlendListByBool1                            OFFSET(getStruct<T>, {0x298, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_Root                                        OFFSET(getStruct<T>, {0x2C8, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_LocalToComponentSpace1                      OFFSET(getStruct<T>, {0x2F8, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_ComponentToLocalSpace1                      OFFSET(getStruct<T>, {0x328, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_RigidBodyWithControl1                       OFFSET(getStruct<T>, {0x358, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_UseCachedPose2                              OFFSET(getStruct<T>, {0x388, 48, 0, 0})
};

/// Struct /LocomotionInitiative/Animation/AnimationBlueprints/LinkedAnimGraphs/Player_RigidBodyPBA_AnimBP.Player_RigidBodyPBA_AnimBP_C.AnimBlueprintGeneratedMutableData
/// Size: 0x0002 (0x000001 - 0x000003)
class FAnimBlueprintGeneratedMutableDatadup_135 : public FAnimBlueprintMutableData
{ 
	friend MDKHandler;
	friend MDKBase;
...
public:
	DMember(bool)                                      __BoolProperty                                              OFFSET(get<bool>, {0x1, 1, 0, 0})
	DMember(bool)                                      __BoolProperty1                                             OFFSET(get<bool>, {0x2, 1, 0, 0})
};

/// Struct /LocomotionInitiative/Animation/AnimationBlueprints/Player_MotionMatchingLocomotion_AnimBP.Player_MotionMatchingLocomotion_AnimBP_C.AnimBlueprintGeneratedConstantData
/// Size: 0x12BF (0x000001 - 0x0012C0)
class FAnimBlueprintGeneratedConstantDatadup_136 : public FAnimBlueprintConstantData
{ 
	friend MDKHandler;
	friend MDKBase;
...
public:
	CMember(TArray<float>)                             __ArrayProperty                                             OFFSET(get<T>, {0x8, 16, 0, 0})
	CMember(TArray<float>)                             __ArrayProperty1                                            OFFSET(get<T>, {0x18, 16, 0, 0})
	SMember(FAnimNodeFunctionRef)                      __StructProperty                                            OFFSET(getStruct<T>, {0x28, 24, 0, 0})
	SMember(FName)                                     __NameProperty                                              OFFSET(getStruct<T>, {0x40, 4, 0, 0})
	DMember(bool)                                      __BoolProperty                                              OFFSET(get<bool>, {0x44, 1, 0, 0})
	CMember(TArray<float>)                             __ArrayProperty2                                            OFFSET(get<T>, {0x48, 16, 0, 0})
	SMember(FName)                                     __NameProperty1                                             OFFSET(getStruct<T>, {0x58, 4, 0, 0})
	SMember(FName)                                     __NameProperty2                                             OFFSET(getStruct<T>, {0x5C, 4, 0, 0})
	SMember(FName)                                     __NameProperty3                                             OFFSET(getStruct<T>, {0x60, 4, 0, 0})
	SMember(FName)                                     __NameProperty4                                             OFFSET(getStruct<T>, {0x64, 4, 0, 0})
	DMember(int32_t)                                   __IntProperty                                               OFFSET(get<int32_t>, {0x68, 4, 0, 0})
	CMember(class UBlendProfile*)                      __BlendProfile                                              OFFSET(get<T>, {0x70, 8, 0, 0})
	CMember(class UCurveFloat*)                        __CurveFloat                                                OFFSET(get<T>, {0x78, 8, 0, 0})
	CMember(EAlphaBlendOption)                         __EnumProperty                                              OFFSET(get<T>, {0x80, 1, 0, 0})
	CMember(EBlendListTransitionType)                  __EnumProperty1                                             OFFSET(get<T>, {0x81, 1, 0, 0})
	CMember(TArray<float>)                             __ArrayProperty3                                            OFFSET(get<T>, {0x88, 16, 0, 0})
	DMember(float)                                     __FloatProperty                                             OFFSET(get<float>, {0x98, 4, 0, 0})
	SMember(FInputScaleBiasClampConstants)             __StructProperty1                                           OFFSET(getStruct<T>, {0x9C, 44, 0, 0})
	DMember(float)                                     __FloatProperty1                                            OFFSET(get<float>, {0xC8, 4, 0, 0})
	CMember(EAnimSyncMethod)                           __EnumProperty2                                             OFFSET(get<T>, {0xCC, 1, 0, 0})
	SMember(FName)                                     __NameProperty5                                             OFFSET(getStruct<T>, {0xD0, 4, 0, 0})
	SMember(FName)                                     __NameProperty6                                             OFFSET(getStruct<T>, {0xD4, 4, 0, 0})
	DMember(int32_t)                                   __IntProperty1                                              OFFSET(get<int32_t>, {0xD8, 4, 0, 0})
	SMember(FName)                                     __NameProperty7                                             OFFSET(getStruct<T>, {0xDC, 4, 0, 0})
	SMember(FName)                                     __NameProperty8                                             OFFSET(getStruct<T>, {0xE0, 4, 0, 0})
	DMember(int32_t)                                   __IntProperty2                                              OFFSET(get<int32_t>, {0xE4, 4, 0, 0})
	SMember(FName)                                     __NameProperty9                                             OFFSET(getStruct<T>, {0xE8, 4, 0, 0})
	SMember(FAnimNodeFunctionRef)                      __StructProperty2                                           OFFSET(getStruct<T>, {0xF0, 24, 0, 0})
	SMember(FAnimNodeFunctionRef)                      __StructProperty3                                           OFFSET(getStruct<T>, {0x108, 24, 0, 0})
	DMember(bool)                                      __BoolProperty1                                             OFFSET(get<bool>, {0x120, 1, 0, 0})
	CMember(EAnimSyncMethod)                           __EnumProperty3                                             OFFSET(get<T>, {0x121, 1, 0, 0})
	CMember(TEnumAsByte<EAnimGroupRole>)               __ByteProperty                                              OFFSET(get<T>, {0x122, 1, 0, 0})
	SMember(FName)                                     __NameProperty10                                            OFFSET(getStruct<T>, {0x124, 4, 0, 0})
	SMember(FName)                                     __NameProperty11                                            OFFSET(getStruct<T>, {0x128, 4, 0, 0})
	SMember(FAnimNodeFunctionRef)                      __StructProperty4                                           OFFSET(getStruct<T>, {0x130, 24, 0, 0})
	SMember(FAnimSubsystem_PropertyAccess)             AnimBlueprintExtension_PropertyAccess                       OFFSET(getStruct<T>, {0x148, 128, 0, 0})
	SMember(FAnimSubsystem_Base)                       AnimBlueprintExtension_Base                                 OFFSET(getStruct<T>, {0x1C8, 24, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_PoseSearchHistoryCollector                  OFFSET(getStruct<T>, {0x1E0, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_TransitionResult                            OFFSET(getStruct<T>, {0x210, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_TransitionResult1                           OFFSET(getStruct<T>, {0x240, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_TransitionResult2                           OFFSET(getStruct<T>, {0x270, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_TransitionResult3                           OFFSET(getStruct<T>, {0x2A0, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_TransitionResult4                           OFFSET(getStruct<T>, {0x2D0, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_TransitionResult5                           OFFSET(getStruct<T>, {0x300, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_UseCachedPose                               OFFSET(getStruct<T>, {0x330, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_BlendListByBool                             OFFSET(getStruct<T>, {0x360, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_UseCachedPose1                              OFFSET(getStruct<T>, {0x390, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_ApplyAdditive                               OFFSET(getStruct<T>, {0x3C0, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_BlendSpacePlayer                            OFFSET(getStruct<T>, {0x3F0, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_LayeredBoneBlend                            OFFSET(getStruct<T>, {0x420, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_UseCachedPose2                              OFFSET(getStruct<T>, {0x450, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_SequencePlayer                              OFFSET(getStruct<T>, {0x480, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_ApplyAdditive1                              OFFSET(getStruct<T>, {0x4B0, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_RotateRootBone                              OFFSET(getStruct<T>, {0x4E0, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_BlendSpacePlayer1                           OFFSET(getStruct<T>, {0x510, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_BlendSpacePlayer2                           OFFSET(getStruct<T>, {0x540, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_BlendListByBool1                            OFFSET(getStruct<T>, {0x570, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_RotateRootBone1                             OFFSET(getStruct<T>, {0x5A0, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_BlendListByBool2                            OFFSET(getStruct<T>, {0x5D0, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_StateResult                                 OFFSET(getStruct<T>, {0x600, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_TransitionResult6                           OFFSET(getStruct<T>, {0x630, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_TransitionResult7                           OFFSET(getStruct<T>, {0x660, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_TransitionResult8                           OFFSET(getStruct<T>, {0x690, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_TransitionResult9                           OFFSET(getStruct<T>, {0x6C0, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_SequencePlayer1                             OFFSET(getStruct<T>, {0x6F0, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_StateResult1                                OFFSET(getStruct<T>, {0x720, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_SequencePlayer2                             OFFSET(getStruct<T>, {0x750, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_SequencePlayer3                             OFFSET(getStruct<T>, {0x780, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_BlendListByBool3                            OFFSET(getStruct<T>, {0x7B0, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_StateResult2                                OFFSET(getStruct<T>, {0x7E0, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_StateMachine                                OFFSET(getStruct<T>, {0x810, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_StateResult3                                OFFSET(getStruct<T>, {0x840, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_StateMachine1                               OFFSET(getStruct<T>, {0x870, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_TransitionResult10                          OFFSET(getStruct<T>, {0x8A0, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_TransitionResult11                          OFFSET(getStruct<T>, {0x8D0, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_TransitionResult12                          OFFSET(getStruct<T>, {0x900, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_TransitionResult13                          OFFSET(getStruct<T>, {0x930, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_TransitionResult14                          OFFSET(getStruct<T>, {0x960, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_ApplyMeshSpaceAdditive                      OFFSET(getStruct<T>, {0x990, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_SequencePlayer4                             OFFSET(getStruct<T>, {0x9C0, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_UseCachedPose3                              OFFSET(getStruct<T>, {0x9F0, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_BlendListByBool4                            OFFSET(getStruct<T>, {0xA20, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_SequencePlayer5                             OFFSET(getStruct<T>, {0xA50, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_StateResult4                                OFFSET(getStruct<T>, {0xA80, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_ApplyMeshSpaceAdditive1                     OFFSET(getStruct<T>, {0xAB0, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_SequencePlayer6                             OFFSET(getStruct<T>, {0xAE0, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_UseCachedPose4                              OFFSET(getStruct<T>, {0xB10, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_BlendListByBool5                            OFFSET(getStruct<T>, {0xB40, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_SequencePlayer7                             OFFSET(getStruct<T>, {0xB70, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_StateResult5                                OFFSET(getStruct<T>, {0xBA0, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_UseCachedPose5                              OFFSET(getStruct<T>, {0xBD0, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_StateResult6                                OFFSET(getStruct<T>, {0xC00, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_StateMachine2                               OFFSET(getStruct<T>, {0xC30, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_SaveCachedPose                              OFFSET(getStruct<T>, {0xC60, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_ComponentToLocalSpace                       OFFSET(getStruct<T>, {0xC90, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_ResetRoot                                   OFFSET(getStruct<T>, {0xCC0, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_LocalToComponentSpace                       OFFSET(getStruct<T>, {0xCF0, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_OrientationWarping                          OFFSET(getStruct<T>, {0xD20, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_BlendStackInput                             OFFSET(getStruct<T>, {0xD50, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_BlendStackResult                            OFFSET(getStruct<T>, {0xD80, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_ComponentToLocalSpace1                      OFFSET(getStruct<T>, {0xDB0, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_ResetRoot1                                  OFFSET(getStruct<T>, {0xDE0, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_LocalToComponentSpace1                      OFFSET(getStruct<T>, {0xE10, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_OrientationWarping1                         OFFSET(getStruct<T>, {0xE40, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_BlendStackInput1                            OFFSET(getStruct<T>, {0xE70, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_BlendStackResult1                           OFFSET(getStruct<T>, {0xEA0, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_ComponentToLocalSpace2                      OFFSET(getStruct<T>, {0xED0, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_ResetRoot2                                  OFFSET(getStruct<T>, {0xF00, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_LocalToComponentSpace2                      OFFSET(getStruct<T>, {0xF30, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_OrientationWarping2                         OFFSET(getStruct<T>, {0xF60, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_BlendStackInput2                            OFFSET(getStruct<T>, {0xF90, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_BlendStackResult2                           OFFSET(getStruct<T>, {0xFC0, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_ComponentToLocalSpace3                      OFFSET(getStruct<T>, {0xFF0, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_ResetRoot3                                  OFFSET(getStruct<T>, {0x1020, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_LocalToComponentSpace3                      OFFSET(getStruct<T>, {0x1050, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_OrientationWarping3                         OFFSET(getStruct<T>, {0x1080, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_BlendStackInput3                            OFFSET(getStruct<T>, {0x10B0, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_BlendStackResult3                           OFFSET(getStruct<T>, {0x10E0, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_MotionMatching                              OFFSET(getStruct<T>, {0x1110, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_SaveCachedPose1                             OFFSET(getStruct<T>, {0x1140, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_TwoWayBlend                                 OFFSET(getStruct<T>, {0x1170, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_UseCachedPose6                              OFFSET(getStruct<T>, {0x11A0, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_ChooserPlayer                               OFFSET(getStruct<T>, {0x11D0, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_Root                                        OFFSET(getStruct<T>, {0x1200, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_ApplyMeshSpaceAdditive2                     OFFSET(getStruct<T>, {0x1230, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_SaveCachedPose2                             OFFSET(getStruct<T>, {0x1260, 48, 0, 0})
	SMember(FAnimNodeExposedValueHandler_PropertyAccess) AnimGraphNode_UseCachedPose7                              OFFSET(getStruct<T>, {0x1290, 48, 0, 0})
};

/// Struct /LocomotionInitiative/Animation/AnimationBlueprints/Player_MotionMatchingLocomotion_AnimBP.Player_MotionMatchingLocomotion_AnimBP_C.AnimBlueprintGeneratedMutableData
/// Size: 0x001C (0x000001 - 0x00001D)
class FAnimBlueprintGeneratedMutableDatadup_137 : public FAnimBlueprintMutableData
{ 
	friend MDKHandler;
	friend MDKBase;
	static inline constexpr uint64_t __MDKClassSize = 29;
...
public:
	...
	DMember(float)                                     __FloatProperty2                                            OFFSET(get<float>, {0xC, 4, 0, 0})
	DMember(float)                                     __FloatProperty3                                            OFFSET(get<float>, {0x10, 4, 0, 0})
	DMember(float)                                     __FloatProperty4                                            OFFSET(get<float>, {0x14, 4, 0, 0})
	DMember(bool)                                      __BoolProperty1                                             OFFSET(get<bool>, {0x18, 1, 0, 0})
	DMember(bool)                                      __BoolProperty2                                             OFFSET(get<bool>, {0x19, 1, 0, 0})
	DMember(bool)                                      __BoolProperty3                                             OFFSET(get<bool>, {0x1A, 1, 0, 0})
	DMember(bool)                                      __BoolProperty4                                             OFFSET(get<bool>, {0x1B, 1, 0, 0})
	DMember(bool)                                      __BoolProperty5                                             OFFSET(get<bool>, {0x1C, 1, 0, 0})
};
