...
public:
	...
	// void BroadcastTransitionCompleted();                                                                                     // [0x3096a6c] Native|Protected|BlueprintCallable 
};
...
public:
	...
	// void RemoveScene(class UDynamicUIScene* Scene);                                                                          // [0x7e3a258] Final|Native|Public|BlueprintCallable 
	// Function /Script/DynamicUI.DynamicUIDirectorBase.GetOwningLocalPlayerController
	// class APlayerController* GetOwningLocalPlayerController();                                                               // [0x7e3a234] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DynamicUI.DynamicUIDirectorBase.GetOwningLocalPlayer
	// class ULocalPlayer* GetOwningLocalPlayer();                                                                              // [0x7e3a210] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DynamicUI.DynamicUIDirectorBase.AddScene
	// void AddScene(class UDynamicUIScene* Scene);                                                                             // [0x7e390e4] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void RemoveScenes(TArray<UDynamicUIScene*> Scenes, class APlayerController*& Player);                                    // [0x7e3a6dc] Final|Native|Protected|HasOutParms|BlueprintCallable 
	// Function /Script/DynamicUI.DynamicUIManager.RemoveSceneFromFirstLocalPlayer
	// void RemoveSceneFromFirstLocalPlayer(class UDynamicUIScene* Scene);                                                      // [0x7e3a51c] Final|Native|Protected|BlueprintCallable 
	// Function /Script/DynamicUI.DynamicUIManager.RemoveScene
	// void RemoveScene(class UDynamicUIScene* Scene, class APlayerController*& Player);                                        // [0x7e3a318] Final|Native|Protected|HasOutParms|BlueprintCallable 
	// Function /Script/DynamicUI.DynamicUIManager.AddSceneToFirstLocalPlayer
	// void AddSceneToFirstLocalPlayer(class UDynamicUIScene* Scene);                                                           // [0x7e3967c] Final|Native|Protected|BlueprintCallable 
	// Function /Script/DynamicUI.DynamicUIManager.AddScenes
	// void AddScenes(TArray<UDynamicUIScene*> Scenes, class APlayerController*& Player);                                       // [0x7e39b20] Final|Native|Protected|HasOutParms|BlueprintCallable 
	// Function /Script/DynamicUI.DynamicUIManager.AddScene
	// void AddScene(class UDynamicUIScene* Scene, class APlayerController*& Player);                                           // [0x7e391a4] Final|Native|Protected|HasOutParms|BlueprintCallable 
};
