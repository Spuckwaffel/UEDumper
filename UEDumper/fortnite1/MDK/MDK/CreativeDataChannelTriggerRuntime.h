...
public:
	...
	// void TestCreativeDataChannelTarget(FCreativeDataChannelEvents TestEvents);                                               // [0xc23ba60] Final|Native|Public|BlueprintCallable 
	// Function /Script/CreativeDataChannelTriggerRuntime.CreativeDataChannelTarget.OnRep_Events
	// void OnRep_Events();                                                                                                     // [0x3508bf8] Final|Native|Public  
	// Function /Script/CreativeDataChannelTriggerRuntime.CreativeDataChannelTarget.FireEvent
	// void FireEvent(FName EventName);                                                                                         // [0x246f7d8] Event|Public|BlueprintEvent 
};
