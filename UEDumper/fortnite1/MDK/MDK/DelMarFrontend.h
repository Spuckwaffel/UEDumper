...
public:
	...
	// void DelMarResetNux();                                                                                                   // [0x3508bf8] Final|Exec|Native|Protected 
	// Function /Script/DelMarFrontend.DelMarFrontendCheatManager.DelMarMarkTutorialPlayed
	// void DelMarMarkTutorialPlayed();                                                                                         // [0x3508bf8] Final|Exec|Native|Protected 
};
...
public:
	...
	// void HandleVideoTerminalError(EBaseMediaTerminalErrorReason Reason);                                                     // [0xc65b9f0] Final|Native|Protected 
	// Function /Script/DelMarFrontend.DelMarFrontendExperienceFlow.FinishTrailerStep
	// void FinishTrailerStep();                                                                                                // [0xc65b9ac] Final|Native|Protected 
};
...
public:
	...
	// class UDelMarFrontendRuntimeOptions* GetDelMarFrontendRuntimeOptions();                                                  // [0xc65b9c0] Final|RequiredAPI|Native|Static|Public|BlueprintCallable|BlueprintPure 
};
