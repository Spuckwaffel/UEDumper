...
public:
	...
	// void ServerInputActionTriggered(FGuid Guid, FVector InputValue);                                                         // [0xcdbec80] Final|Net|NetReliableNative|Event|Private|NetServer|HasDefaults|Const 
	// Function /Script/VerseInput.VerseReplicatedInputDataComponent.OnInputActionTriggered
	// void OnInputActionTriggered(FInputActionInstance& ActionInstance);                                                       // [0xcdbebdc] Final|Native|Private|HasOutParms 
};
