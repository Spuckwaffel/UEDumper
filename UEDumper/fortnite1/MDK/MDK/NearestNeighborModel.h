...
public:
	...
	// void Empty();                                                                                                            // [0x1f83abc] Native|Public|BlueprintCallable 
};
...
public:
	...
	// bool LoadOptimizedNetwork(FString OnnxPath);                                                                             // [0x246f7d8] Event|Public|BlueprintEvent 
	// Function /Script/NearestNeighborModel.NearestNeighborOptimizedNetworkLoader.GetOptimizedNetwork
	// class UNearestNeighborOptimizedNetwork* GetOptimizedNetwork();                                                           // [0x7e4aa58] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// int32_t GetNumBasis();                                                                                                   // [0x6d1a024] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// bool IsReadyForTraining();                                                                                               // [0x9fbbd14] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/NearestNeighborModel.NearestNeighborModel.IsReadyForInference
	// bool IsReadyForInference();                                                                                              // [0x9fbb8c4] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/NearestNeighborModel.NearestNeighborModel.GetTotalNumBasis
	// int32_t GetTotalNumBasis();                                                                                              // [0xba7b71c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/NearestNeighborModel.NearestNeighborModel.GetSectionPtr
	// class UNearestNeighborModelSection* GetSectionPtr(int32_t Index);                                                        // [0xba7b648] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/NearestNeighborModel.NearestNeighborModel.GetPCACoeffStarts
	// TArray<int32_t> GetPCACoeffStarts();                                                                                     // [0xba7b62c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/NearestNeighborModel.NearestNeighborModel.GetNumSections
	// int32_t GetNumSections();                                                                                                // [0xb309eec] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/NearestNeighborModel.NearestNeighborModel.DoesUsePCA
	// bool DoesUsePCA();                                                                                                       // [0xba7b510] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void Reset();                                                                                                            // [0xba7b740] Final|Native|Public|BlueprintCallable 
	// Function /Script/NearestNeighborModel.NearestNeighborModelInstance.Eval
	// TArray<float> Eval(TArray<float>& InputData);                                                                            // [0xba7b528] Final|Native|Private|HasOutParms|BlueprintCallable 
};
