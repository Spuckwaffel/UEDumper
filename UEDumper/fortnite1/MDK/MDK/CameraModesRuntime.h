...
public:
	...
	// void UpdateFirstPersonFOV(float FOV);                                                                                    // [0x246f7d8] Event|Protected|BlueprintCallable|BlueprintEvent 
	// Function /Script/CameraModesRuntime.CameraModes_FirstPersonCameraController.SetFovOverride
	// void SetFovOverride(float FOV, float TransitionTime);                                                                    // [0x246f7d8] Event|Protected|BlueprintCallable|BlueprintEvent 
	// Function /Script/CameraModesRuntime.CameraModes_FirstPersonCameraController.OnLocalPlayerVisibilityChanged
	// void OnLocalPlayerVisibilityChanged(bool bShouldBeVisible);                                                              // [0x246f7d8] Event|Protected|BlueprintCallable|BlueprintEvent 
	// Function /Script/CameraModesRuntime.CameraModes_FirstPersonCameraController.HandleWeaponEquipped
	// void HandleWeaponEquipped(class AFortWeapon* NewWeapon, class AFortWeapon* PrevWeapon);                                  // [0xc1ffa58] Final|Native|Private 
	// Function /Script/CameraModesRuntime.CameraModes_FirstPersonCameraController.ClearFovOverride
	// void ClearFovOverride(float TransitionTime);                                                                             // [0x246f7d8] Event|Protected|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// void EnableFpCameraForAllPlayers(bool bEnable);                                                                          // [0x62ffeb0] Final|BlueprintAuthorityOnly|Exec|Native|Public 
	// Function /Script/CameraModesRuntime.FortCheatManager_CameraModes.EnableFpCamera
	// void EnableFpCamera(bool bEnable);                                                                                       // [0x62ffeb0] Final|BlueprintAuthorityOnly|Exec|Native|Public 
};
