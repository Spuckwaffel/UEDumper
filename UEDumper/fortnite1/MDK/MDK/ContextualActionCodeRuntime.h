...
public:
	...
	// void OnOwnerDBNO();                                                                                                      // [0xb8cdc2c] Final|Native|Protected 
};
...
public:
	DMember(float)                                     MaxSwingAngle                                               OFFSET(get<float>, {0x978, 4, 0, 0})
	DMember(bool)                                      bUseCharacterSwingMovementMode                              OFFSET(get<bool>, {0x97C, 1, 0, 0})
	DMember(bool)                                      bCanAscend                                                  OFFSET(get<bool>, {0x97D, 1, 0, 0})
	SMember(FVector)                                   FixedSwingDirection                                         OFFSET(getStruct<T>, {0x980, 24, 0, 0})
	DMember(bool)                                      bUseFixedSwingDirection                                     OFFSET(get<bool>, {0x998, 1, 0, 0})
	DMember(float)                                     ForwardInteractOffset                                       OFFSET(get<float>, {0x99C, 4, 0, 0})
	DMember(float)                                     RightInteractOffset                                         OFFSET(get<float>, {0x9A0, 4, 0, 0})
	DMember(bool)                                      bUseClientTransformSmoothing                                OFFSET(get<bool>, {0x9A4, 1, 0, 0})
	DMember(float)                                     SmoothingWindow                                             OFFSET(get<float>, {0x9A8, 4, 0, 0})
	CMember(class USceneComponent*)                    AttachPoint                                                 OFFSET(get<T>, {0x9B0, 8, 0, 0})


	/// Functions
	// Function /Script/ContextualActionCodeRuntime.FortSwingingObject.OnStartSwing_BP
	// void OnStartSwing_BP(class AFortPlayerPawn* AttachedActor);                                                              // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/ContextualActionCodeRuntime.FortSwingingObject.OnEndSwing_BP
	// void OnEndSwing_BP(class AFortPlayerPawn* AttachedActor);                                                                // [0x246f7d8] Event|Protected|BlueprintEvent 
};

/// Class /Script/ContextualActionCodeRuntime.FortSwingingRope
/// Size: 0x0038 (0x0009C8 - 0x000A00)
...
public:
	CMember(class UCableComponent*)                    CableComponent                                              OFFSET(get<T>, {0x9C8, 8, 0, 0})
	DMember(float)                                     UnattachedCableGravityScale                                 OFFSET(get<float>, {0x9D0, 4, 0, 0})
	DMember(float)                                     UnattachedSolverIterations                                  OFFSET(get<float>, {0x9D4, 4, 0, 0})
	DMember(float)                                     CableLengthMultiplier                                       OFFSET(get<float>, {0x9D8, 4, 0, 0})
};
...
public:
	...
	// bool TryHijack(class AActor* VehicleTarget, FInteractionType& InteractionType);                                          // [0xb8ce058] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/ContextualActionCodeRuntime.HijackerComponent.OnStartHijack
	// void OnStartHijack(class AActor* VehicleTarget);                                                                         // [0x978624c] Final|Net|NetReliableNative|Event|NetMulticast|Private 
	// Function /Script/ContextualActionCodeRuntime.HijackerComponent.OnCompleteHijack
	// void OnCompleteHijack();                                                                                                 // [0x1e6b5b0] Final|Net|NetReliableNative|Event|NetMulticast|Private 
	// Function /Script/ContextualActionCodeRuntime.HijackerComponent.HandleOwnerJumpInput
	// void HandleOwnerJumpInput(bool bPressed);                                                                                // [0xb8cd7a0] Final|Native|Private 
	// Function /Script/ContextualActionCodeRuntime.HijackerComponent.EjectHijacker
	// void EjectHijacker(class AActor* DamageCauser, float Damage, FVector EventLocation);                                     // [0xb8cd480] Final|Net|NetReliableNative|Event|NetMulticast|Private|HasDefaults 
	// Function /Script/ContextualActionCodeRuntime.HijackerComponent.CancelHijack_Server
	// void CancelHijack_Server();                                                                                              // [0x3449a4c] Final|Net|NetReliableNative|Event|Private|NetServer 
	// Function /Script/ContextualActionCodeRuntime.HijackerComponent.CancelHijack_NetMulticast
	// void CancelHijack_NetMulticast();                                                                                        // [0x6cdc234] Final|Net|NetReliableNative|Event|NetMulticast|Private 
	// Function /Script/ContextualActionCodeRuntime.HijackerComponent.BP_OnStartHijack
	// void BP_OnStartHijack();                                                                                                 // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/ContextualActionCodeRuntime.HijackerComponent.BP_OnHijackInterrupted
	// void BP_OnHijackInterrupted();                                                                                           // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/ContextualActionCodeRuntime.HijackerComponent.BP_OnHijackCancelled
	// void BP_OnHijackCancelled();                                                                                             // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/ContextualActionCodeRuntime.HijackerComponent.BP_OnCompleteHijack
	// void BP_OnCompleteHijack();                                                                                              // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/ContextualActionCodeRuntime.HijackerComponent.BP_OnCleanup
	// void BP_OnCleanup();                                                                                                     // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/ContextualActionCodeRuntime.HijackerComponent.BP_GetThrownVelocity
	// void BP_GetThrownVelocity(class AActor* DamageCauser, float Damage, FVector& EventLocation, FVector& OutVelocity);       // [0x246f7d8] Event|Protected|HasOutParms|HasDefaults|BlueprintEvent|Const 
	// Function /Script/ContextualActionCodeRuntime.HijackerComponent.BP_CanStartHijack
	// void BP_CanStartHijack(bool& OutCanStartHijack);                                                                         // [0x246f7d8] Event|Protected|HasOutParms|BlueprintEvent|Const 
	// Function /Script/ContextualActionCodeRuntime.HijackerComponent.BP_CanCompleteHijack
	// void BP_CanCompleteHijack(bool& OutCanCompleteHijack);                                                                   // [0x246f7d8] Event|Protected|HasOutParms|BlueprintEvent|Const 
};
...
public:
	...
	// void TestToggleGravity_Server();                                                                                         // [0xa194d3c] Net|NetReliableNative|Event|Protected|NetServer 
	// Function /Script/ContextualActionCodeRuntime.RappellingComponent.TestToggleGravity
	// void TestToggleGravity();                                                                                                // [0xb8ce008] Final|Native|Public|BlueprintCallable 
	// Function /Script/ContextualActionCodeRuntime.RappellingComponent.StartRappellingSwing_Server
	// void StartRappellingSwing_Server();                                                                                      // [0x1b55e98] Net|NetReliableNative|Event|Protected|NetServer 
	// Function /Script/ContextualActionCodeRuntime.RappellingComponent.StartRappelling_Server
	// void StartRappelling_Server(FVector NewGravityDirection, FVector ClientRappellingEdge, FVector ClientRappellingNormal);  // [0xb8cde3c] Net|NetReliableNative|Event|Protected|NetServer|HasDefaults 
	// Function /Script/ContextualActionCodeRuntime.RappellingComponent.StartRappelling
	// void StartRappelling();                                                                                                  // [0xb8cde28] Final|Native|Public|BlueprintCallable 
	// Function /Script/ContextualActionCodeRuntime.RappellingComponent.RappellingCorrectFallingRotation_Client
	// void RappellingCorrectFallingRotation_Client();                                                                          // [0x6cdc234] Net|NetReliableNative|Event|Protected|NetClient 
	// Function /Script/ContextualActionCodeRuntime.RappellingComponent.OnValidTargeting
	// void OnValidTargeting();                                                                                                 // [0x246f7d8] Event|Public|BlueprintEvent 
	// Function /Script/ContextualActionCodeRuntime.RappellingComponent.OnStartRappelling
	// void OnStartRappelling();                                                                                                // [0x246f7d8] Event|Public|BlueprintEvent 
	// Function /Script/ContextualActionCodeRuntime.RappellingComponent.OnRep_RappellingState
	// void OnRep_RappellingState();                                                                                            // [0xb8cddfc] Final|Native|Protected 
	// Function /Script/ContextualActionCodeRuntime.RappellingComponent.OnOwnerMovementModeChanged
	// void OnOwnerMovementModeChanged(class ACharacter* Character, TEnumAsByte<EMovementMode> PreviousMovementMode, char PreviousCustomMode); // [0xb8cdc40] Final|Native|Protected 
	// Function /Script/ContextualActionCodeRuntime.RappellingComponent.OnInvalidTargeting
	// void OnInvalidTargeting();                                                                                               // [0x246f7d8] Event|Public|BlueprintEvent 
	// Function /Script/ContextualActionCodeRuntime.RappellingComponent.OnEndRappelling
	// void OnEndRappelling();                                                                                                  // [0x246f7d8] Event|Public|BlueprintEvent 
	// Function /Script/ContextualActionCodeRuntime.RappellingComponent.OnCapsuleHit
	// void OnCapsuleHit(class UPrimitiveComponent* HitComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, FVector NormalImpulse, FHitResult& Hit); // [0xb8cd928] Final|Native|Protected|HasOutParms|HasDefaults 
	// Function /Script/ContextualActionCodeRuntime.RappellingComponent.EndRappellingSwing_Server
	// void EndRappellingSwing_Server();                                                                                        // [0x3449a4c] Net|NetReliableNative|Event|Protected|NetServer 
	// Function /Script/ContextualActionCodeRuntime.RappellingComponent.EndRappelling_Server
	// void EndRappelling_Server();                                                                                             // [0x1e6b5b0] Net|NetReliableNative|Event|Protected|NetServer 
	// Function /Script/ContextualActionCodeRuntime.RappellingComponent.EndRappelling
	// void EndRappelling();                                                                                                    // [0xb8cd648] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void OnRep_SwingingObject();                                                                                             // [0xb8cde14] Final|Native|Private 
	// Function /Script/ContextualActionCodeRuntime.SwingingObjectComponent.HandleOwnerJumpInput
	// void HandleOwnerJumpInput(bool bPressed);                                                                                // [0xb8cd864] Final|Native|Private 
	// Function /Script/ContextualActionCodeRuntime.SwingingObjectComponent.GetSwingDeltaAngle
	// void GetSwingDeltaAngle(FRotator& OutSwingRotation, FRotator& OutDeltaRotation);                                         // [0xb8cd6c0] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ContextualActionCodeRuntime.SwingingObjectComponent.GetAimRotation
	// FRotator GetAimRotation();                                                                                               // [0xb8cd65c] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ContextualActionCodeRuntime.SwingingObjectComponent.DetachFromObject_Server
	// void DetachFromObject_Server(bool bJumpExit);                                                                            // [0xb1ca1b8] Final|Net|NetReliableNative|Event|Private|NetServer 
	// Function /Script/ContextualActionCodeRuntime.SwingingObjectComponent.BP_OnStartSwing
	// void BP_OnStartSwing();                                                                                                  // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/ContextualActionCodeRuntime.SwingingObjectComponent.BP_OnEndSwing
	// void BP_OnEndSwing();                                                                                                    // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/ContextualActionCodeRuntime.SwingingObjectComponent.BP_CanStartSwing
	// void BP_CanStartSwing(class AFortSwingingObject* SwingTarget, bool& bCanStartSwing);                                     // [0x246f7d8] Event|Protected|HasOutParms|BlueprintEvent|Const 
	// Function /Script/ContextualActionCodeRuntime.SwingingObjectComponent.AttachToObject_Server
	// void AttachToObject_Server(class AFortSwingingObject* Object);                                                           // [0x6cdc170] Final|Net|NetReliableNative|Event|Private|NetServer 
};
