...
public:
	...
	// void SetBangVisibility(EJunoBangVisibility BangVisibility);                                                              // [0x246f7d8] Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Script/JunoUI.JunoBangWidget.SetBangCount
	// void SetBangCount(int32_t NewCount);                                                                                     // [0x246f7d8] Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Script/JunoUI.JunoBangWidget.OnFreeBuildToggled
	// void OnFreeBuildToggled(bool bFreeBuildEnabled);                                                                         // [0x246f7d8] Event|Public|BlueprintEvent 
	// Function /Script/JunoUI.JunoBangWidget.IsFreeBuildEnabled
	// bool IsFreeBuildEnabled();                                                                                               // [0xc839f08] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	CMember(class UJunoBedAssignmentListObject*)       BedAssignmentListObject                                     OFFSET(get<T>, {0x14D8, 8, 0, 0})


	/// Functions
	// Function /Script/JunoUI.JunoBedAssignmentListEntry.OnBedAssignmentObjectSet
	// void OnBedAssignmentObjectSet(class UJunoBedAssignmentListObject* NewBedAssignmentListObject);                           // [0x246f7d8] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// bool IsSelectable();                                                                                                     // [0xc839f74] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoUI.JunoBedAssignmentListObject.IsPlayer
	// bool IsPlayer();                                                                                                         // [0xc839f50] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoUI.JunoBedAssignmentListObject.IsNPC
	// bool IsNPC();                                                                                                            // [0xc839f38] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoUI.JunoBedAssignmentListObject.IsEmpty
	// bool IsEmpty();                                                                                                          // [0xc839ee4] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoUI.JunoBedAssignmentListObject.GetNPCIcon
	// TWeakObjectPtr<UTexture2D*> GetNPCIcon();                                                                                // [0xc839c28] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoUI.JunoBedAssignmentListObject.GetNPCGameplayTag
	// FGameplayTag GetNPCGameplayTag();                                                                                        // [0x6d1a024] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoUI.JunoBedAssignmentListObject.GetNPCDisplayName
	// FText GetNPCDisplayName();                                                                                               // [0xc839bec] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoUI.JunoBedAssignmentListObject.GetIsBed
	// bool GetIsBed();                                                                                                         // [0xc839b94] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoUI.JunoBedAssignmentListObject.GetHasBed
	// bool GetHasBed();                                                                                                        // [0x66d8dd4] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// class UJunoBiomeUIData* GetJunoBIomeUIData();                                                                            // [0xc839bac] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/JunoUI.JunoBiomeUIData.FindBiomeTypeUIData
	// bool FindBiomeTypeUIData(EJunoBiome& Biome, FJunoBiomeUIDisplayData& OutBiomeUIDisplayData);                             // [0xc839a14] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void SetRecipeToAssign(FName InRecipeToAssign);                                                                          // [0xc839fb0] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void OnSelectionChanged(bool bInSelected, FJunoBuildingSlotData& BuildingSlotInitData);                                  // [0x246f7d8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoBuildingBarHudSlot.OnBuildingSlotPinned
	// void OnBuildingSlotPinned(bool bIsPinned);                                                                               // [0x246f7d8] Event|Public|BlueprintEvent 
};
...
public:
	CMember(class UJunoBuildingDisplaySlot*)           DisplaySlotWidget                                           OFFSET(get<T>, {0x1480, 8, 0, 0})


	/// Functions
	// Function /Script/JunoUI.JunoBuildingBarMenuSlot.OnLeavePreview
	// void OnLeavePreview();                                                                                                   // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoBuildingBarMenuSlot.OnEnterPreview
	// void OnEnterPreview(FJunoBuildingSlotData& InPreviewSlotData);                                                           // [0x246f7d8] Event|Protected|HasOutParms|BlueprintEvent 
};
...
public:
	...
	// void OnSetBuildingSlotInitData(FJunoBuildingSlotData& BuildingSlotInitData);                                             // [0x246f7d8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoBuildingDisplaySlot.OnSelectionChanged
	// void OnSelectionChanged(bool bInSelected);                                                                               // [0x246f7d8] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void OnRecipeDisplayDataChanged(FText& RecipeDisplayName, class UJunoBuildInstructionsItemDefinition* BuildingItemDefinition); // [0x246f7d8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoBuildingIngredientsGroup.OnCanCraftChanged
	// void OnCanCraftChanged(bool bCanCraft);                                                                                  // [0x246f7d8] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void UpdateRecipeFocus(FName& Recipe);                                                                                   // [0xc86ebe8] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/JunoUI.JunoRecipeDetailsWidget.SetCraftingObject
	// void SetCraftingObject(class AActor* InCraftingObject);                                                                  // [0xc86e970] Final|Native|Public|BlueprintCallable 
	// Function /Script/JunoUI.JunoRecipeDetailsWidget.OnSetRecipeDetails
	// void OnSetRecipeDetails(FText& Name, EJunoKnowledgeState KnowledgeState, int32_t CraftCount, class UItemDefinitionBase* CraftedItemDef, FText& SourceName, FSlateBrush SourceIcon); // [0x246f7d8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoRecipeDetailsWidget.NotifyParentDeactivated
	// void NotifyParentDeactivated();                                                                                          // [0x1b55e98] Native|Public|BlueprintCallable 
	// Function /Script/JunoUI.JunoRecipeDetailsWidget.NotifyParentActivated
	// void NotifyParentActivated();                                                                                            // [0x3449a4c] Native|Public|BlueprintCallable 
	// Function /Script/JunoUI.JunoRecipeDetailsWidget.HandleInventoryChanged
	// void HandleInventoryChanged(FJunoItemSlot& Item, EJunoItemChangeType ChangeType);                                        // [0xc86e3e8] Final|Native|Protected|HasOutParms 
	// Function /Script/JunoUI.JunoRecipeDetailsWidget.HandleCraftingSuccess
	// void HandleCraftingSuccess(FCraftingObjectSuccessEvent& Event);                                                          // [0xc86e340] Final|Native|Protected|HasOutParms 
	// Function /Script/JunoUI.JunoRecipeDetailsWidget.GetCurrentRecipe
	// FName GetCurrentRecipe();                                                                                                // [0x80336a4] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void SetGuidedBuildIngredientsToPreviewCount(int32_t InGuidedBuildIngredientsToPreviewCount);                            // [0x95d45bc] Final|Native|Public|BlueprintCallable 
	// Function /Script/JunoUI.JunoBuildingRecipeDetails.OnLoadingBuildingActorAssetComplete
	// void OnLoadingBuildingActorAssetComplete(FJunoGuidedBuildingUIData GuidedBuildingUIData);                                // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoBuildingRecipeDetails.OnLoadingBuildingActorAsset
	// void OnLoadingBuildingActorAsset();                                                                                      // [0x246f7d8] Event|Protected|BlueprintEvent 
};

/// Class /Script/JunoUI.JunoCompassWidget
/// Size: 0x0140 (0x000490 - 0x0005D0)
...
public:
	...
	DMember(float)                                     MobileMarkerDistanceOffset                                  OFFSET(get<float>, {0x4B4, 4, 0, 0})
	SMember(FGameplayTag)                              AdvancedCompassTag                                          OFFSET(getStruct<T>, {0x4B8, 4, 0, 0})
	SMember(FSlateFontInfo)                            MarkerDistanceTextFont                                      OFFSET(getStruct<T>, {0x4C0, 88, 0, 0})
	CMember(TMap<FGuid, UMaterialInstanceDynamic*>)    ActiveMarkers                                               OFFSET(get<T>, {0x518, 80, 0, 0})
	CMember(TMap<FSoftObjectPath, FJunoMarkerMaterialInstances>) AvailableMaterialInstances                        OFFSET(get<T>, {0x568, 80, 0, 0})


	/// Functions
	// Function /Script/JunoUI.JunoCompassWidget.UpdateHasAdvancedCompassFlag
	// void UpdateHasAdvancedCompassFlag();                                                                                     // [0xc83a070] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void OnUpdateStationCraftingState(EStationInventoryState NewState);                                                      // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoDisassemblingScreen.OnSlotItemSelected
	// void OnSlotItemSelected(class UFortItem* Item);                                                                          // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoDisassemblingScreen.OnDisabledInventoryItemHovered
	// void OnDisabledInventoryItemHovered();                                                                                   // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoDisassemblingScreen.OnCrafringFormulaResultsChanged
	// void OnCrafringFormulaResultsChanged(TArray<FItemAndCount>& CraftingResults);                                            // [0x246f7d8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoDisassemblingScreen.HandleCraftingFormulaChanged
	// void HandleCraftingFormulaChanged(class AActor* CraftingObjectActor, FName& NewFormula);                                 // [0xc83b1a0] Final|Native|Private|HasOutParms 
};
...
public:
	CMember(class UJunoMultiCraftingComponent*)        JunoMultiCraftingComponent                                  OFFSET(get<T>, {0x548, 8, 0, 0})
	CMember(EStationInventoryState)                    CurrentStationInventoryState                                OFFSET(get<T>, {0x550, 1, 0, 0})
	CMember(TArray<FCraftingProcess>)                  CurrentCraftingProcesses                                    OFFSET(get<T>, {0x558, 16, 0, 0})
	CMember(class UJunoProcessingInventoryGroup*)      InventoryGroup_Processing                                   OFFSET(get<T>, {0x568, 8, 0, 0})


	/// Functions
	// Function /Script/JunoUI.JunoComposterScreen.OnProceessingSlotsChanged
	// void OnProceessingSlotsChanged(int32_t NumberOfOccupiedSlots);                                                           // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoComposterScreen.HandleCraftingProcessesFinished
	// void HandleCraftingProcessesFinished(class AActor* CraftingObjectRaw);                                                   // [0xc839d84] Final|Native|Private 
	// Function /Script/JunoUI.JunoComposterScreen.HandleCraftingProcessesBlocked
	// void HandleCraftingProcessesBlocked(class AActor* CraftingObjectRaw);                                                    // [0xc839cc8] Final|Native|Private 
};
...
public:
	...
	// void SetNPCStatus(FJunoNPCStateUIData& NPCStateData);                                                                    // [0x246f7d8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoConversationMarker.OnParticipantNameChanged
	// void OnParticipantNameChanged(FText& InParticipantName);                                                                 // [0x246f7d8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoConversationMarker.OnMessageUpdated
	// void OnMessageUpdated(FText& MessageText);                                                                               // [0x246f7d8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoConversationMarker.OnConversationInteractionUpdated
	// void OnConversationInteractionUpdated(EDialogMarkerInteractionState NewInteractionState, bool bNewCanInteract);          // [0x246f7d8] Event|Protected|BlueprintCallable|BlueprintEvent 
	// Function /Script/JunoUI.JunoConversationMarker.OnCanInteract
	// bool OnCanInteract();                                                                                                    // [0xc839f98] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoUI.JunoConversationMarker.GetInteractionState
	// EDialogMarkerInteractionState GetInteractionState();                                                                     // [0x7722224] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoUI.JunoConversationMarker.ClearNPCStatus
	// void ClearNPCStatus();                                                                                                   // [0x246f7d8] Event|Protected|BlueprintEvent 
};
...
public:
	SMember(FClientConversationOptionEntry)            RepresentedOption                                           OFFSET(getStruct<T>, {0x1488, 104, 0, 0})


	/// Functions
	// Function /Script/JunoUI.JunoConversationOption.OnDisplayItemDefLoaded
	// void OnDisplayItemDefLoaded(class UItemDefinitionBase* ResolvedItemDef);                                                 // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoConversationOption.OnDisplayAssetLoaded
	// void OnDisplayAssetLoaded(class UObject* ResolvedAsset);                                                                 // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoConversationOption.OnConversationOptionUpdated
	// void OnConversationOptionUpdated(FClientConversationOptionEntry& InOption);                                              // [0x246f7d8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoConversationOption.GetConversationOption
	// FClientConversationOptionEntry GetConversationOption();                                                                  // [0xc839b78] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void OnParticipantIconChanged(TWeakObjectPtr<UTexture2D*>& Icon);                                                        // [0x246f7d8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoConversationScreen.OnConversationStarted
	// void OnConversationStarted();                                                                                            // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoConversationScreen.OnConversationOptionsUpdated
	// void OnConversationOptionsUpdated();                                                                                     // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoConversationScreen.OnConversationMessageUpdated
	// void OnConversationMessageUpdated(FClientConversationMessage& ConversationMessage);                                      // [0x246f7d8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoConversationScreen.HandleParticipantIconChanged
	// void HandleParticipantIconChanged(TWeakObjectPtr<UTexture2D*>& Icon);                                                    // [0xc839e44] Final|Native|Private|HasOutParms 
	// Function /Script/JunoUI.JunoConversationScreen.EndConversation
	// void EndConversation();                                                                                                  // [0xc839a00] Final|Native|Protected|BlueprintCallable 
};
...
public:
	...
	// bool ShouldShowSeed();                                                                                                   // [0xc83bba4] Final|Native|Public|BlueprintCallable 
	// Function /Script/JunoUI.JunoDebugWatermark.GetWorldID
	// FString GetWorldID();                                                                                                    // [0xc83b160] Final|Native|Public|BlueprintCallable|Const 
};
...
public:
	...
	// void InitializeEntry(FJunoInputAlternateDisplayText& DisplayText, class UUserWidget* EntryWidget);                       // [0x246f7d8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoDynamicControlPromptsWidget.AddEntry
	// void AddEntry(FJunoInputAlternateDisplayText& DisplayText);                                                              // [0xc83b014] Final|Native|Protected|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// void SelectInventorySlot(class UJunoInventorySlot* InventorySlot);                                                       // [0xc83b5cc] Final|Native|Private 
	// Function /Script/JunoUI.JunoEnchantmentScreen.RequestBackout
	// void RequestBackout();                                                                                                   // [0xc83b564] Final|Native|Protected|BlueprintCallable 
	// Function /Script/JunoUI.JunoEnchantmentScreen.OnRecipeEntrySelected
	// void OnRecipeEntrySelected(class UFortAlterationItemDefinition* PreviewEnchantment);                                     // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoEnchantmentScreen.OnRecipeEntryHovered
	// void OnRecipeEntryHovered(class UFortAlterationItemDefinition* PreviewEnchantment);                                      // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoEnchantmentScreen.OnItemEnchanted
	// void OnItemEnchanted(class UFortItem* Item, class UFortItemDefinition* PreviewAlteration, int32_t UpdatedAlterationIndex); // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoEnchantmentScreen.OnInventoryItemHovered
	// void OnInventoryItemHovered(class UFortItem* HoveredInventoryItem);                                                      // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoEnchantmentScreen.OnInventoryItemChosen
	// void OnInventoryItemChosen(class UFortItem* ChosenInventoryItem);                                                        // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoEnchantmentScreen.OnInputMethodChanged
	// void OnInputMethodChanged(ECommonInputType NewInputType);                                                                // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoEnchantmentScreen.OnEnchantmentStationHeaderData
	// void OnEnchantmentStationHeaderData(FJunoCraftingStationUIDataEntry& InEntry);                                           // [0x246f7d8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoEnchantmentScreen.OnEnchantButtonStateChanged
	// void OnEnchantButtonStateChanged(EJunoEnchantButtonState InButtonState);                                                 // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoEnchantmentScreen.OnEnchantableItemSlotsCreated
	// void OnEnchantableItemSlotsCreated(bool bNothingToEnchant);                                                              // [0x246f7d8] Event|Protected|BlueprintEvent 
	...
	// void HandleCraftingSuccess(FCraftingObjectSuccessEvent& Event);                                                          // [0xc83b2a8] Final|Native|Private|HasOutParms 
	// Function /Script/JunoUI.JunoEnchantmentScreen.GetCurrentScreenState
	// EJunoEnchantmentScreenState GetCurrentScreenState();                                                                     // [0xc83b148] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoUI.JunoEnchantmentScreen.CancelEnchanting
	// void CancelEnchanting();                                                                                                 // [0xc83b0b0] Final|Native|Protected|BlueprintCallable 
};
...
public:
	...
	// void SetUpdatedEnchantmentIndex(int32_t UpdatedIndex);                                                                   // [0xc83bab0] Final|Native|Public|BlueprintCallable 
	// Function /Script/JunoUI.JunoEnchantmentsWidget.SetRepresentedItem
	// void SetRepresentedItem(class UFortItem* InRepresentedItem);                                                             // [0xc83b888] Final|Native|Public|BlueprintCallable 
	// Function /Script/JunoUI.JunoEnchantmentsWidget.SetPreviewEnchantment
	// void SetPreviewEnchantment(class UFortAlterationItemDefinition* InEnchantment);                                          // [0xc83b770] Final|Native|Public|BlueprintCallable 
	// Function /Script/JunoUI.JunoEnchantmentsWidget.OnEnchantmentsUpdated
	// void OnEnchantmentsUpdated(bool bHasEnchantments);                                                                       // [0x246f7d8] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void OnRepresentedItemChanged();                                                                                         // [0x246f7d8] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void ResetFocusToPlayer();                                                                                               // [0xc83b5a8] Final|Native|Protected|BlueprintCallable 
	// Function /Script/JunoUI.JunoFullScreenMap.IsMapTabAllowed
	// bool IsMapTabAllowed();                                                                                                  // [0xc83b4d4] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void OnInitDataSet(class UJunoHudMenuBaseInitData* InInitData);                                                          // [0x246f7d8] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// int32_t GetNumUnviewedItems();                                                                                           // [0x8687960] Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
};
...
public:
	...
	// void OnSetIngredientData(TWeakObjectPtr<UTexture2D*>& Icon, EFortRarity ItemRarity, int32_t EntryIndex, FText& ItemDescription); // [0x246f7d8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoIngredientWidget.OnSetIngredientCounts
	// void OnSetIngredientCounts(int32_t OwnedCount, int32_t RequiredCount);                                                   // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoIngredientWidget.OnSetHasEnough
	// void OnSetHasEnough(bool bHasEnough);                                                                                    // [0x246f7d8] Event|Protected|BlueprintEvent 
};
...
public:
	CMember(class UMenuAnchor*)                        ContextMenuAnchor                                           OFFSET(get<T>, {0x1488, 8, 0, 0})
	DMember(int32_t)                                   StackSizeMultiplier                                         OFFSET(get<int32_t>, {0x1494, 4, 0, 0})
	CMember(class UJunoItemSpawnerListEntry*)          ListEntry                                                   OFFSET(get<T>, {0x1498, 8, 0, 0})
	CMember(class UClass*)                             ContextMenuClass                                            OFFSET(get<T>, {0x14A0, 8, 0, 0})


	/// Functions
	// Function /Script/JunoUI.JunoItemSpawnerEntrySlot.UpdateItemDisplay
	// void UpdateItemDisplay(class UFortItemDefinition* FortItemDefinition);                                                   // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoItemSpawnerEntrySlot.OnLeaveContextMenuMode
	// void OnLeaveContextMenuMode();                                                                                           // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoItemSpawnerEntrySlot.OnEnterContextMenuMode
	// void OnEnterContextMenuMode(bool bIsCurrentlySelectedSlot);                                                              // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoItemSpawnerEntrySlot.HandleOnMenuOpenChanged
	// void HandleOnMenuOpenChanged(bool bIsOpen);                                                                              // [0xc83b350] Final|Native|Private 
	// Function /Script/JunoUI.JunoItemSpawnerEntrySlot.GetContextMenu
	// class UUserWidget* GetContextMenu();                                                                                     // [0xc83b124] Final|Native|Private 
};
...
public:
	CMember(class UCommonTextBlock*)                   Text_Name                                                   OFFSET(get<T>, {0x1488, 8, 0, 0})
	CMember(class UJunoItemSpawnerListEntry*)          ListEntry                                                   OFFSET(get<T>, {0x1490, 8, 0, 0})
};
...
public:
	...
	// void UpdateItemDetails(class UFortItemDefinition* FortItemDefinition);                                                   // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoItemSpawnerScreen.HandleTabSelected
	// void HandleTabSelected(FName TabID);                                                                                     // [0xc83b414] Final|Native|Private 
};
...
public:
	...
	// void OnSetTitleAndDescription(FText& Title, FText& Description);                                                         // [0x246f7d8] Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoSelectionModal.OnSelectionButtonCreated
	// void OnSelectionButtonCreated(class UCommonButtonBase* NewButton, FText& SelectionTitle);                                // [0x246f7d8] Event|Public|HasOutParms|BlueprintEvent 
};
...
public:
	...
	// void OnBuildingHealthChanged();                                                                                          // [0xc83df64] Final|Native|Protected 
	// Function /Script/JunoUI.JunoNPCStatusWidgetBase.OnActorHealthChanged
	// void OnActorHealthChanged(float NewHealth, float NewMaxHealth);                                                          // [0xc83dda0] Final|Native|Protected 
};
...
public:
	...
	// void OpenSidebar();                                                                                                      // [0xc83e20c] Final|Native|Public|BlueprintCallable 
	// Function /Script/JunoUI.JunoPlayerManagementScreen.HandleBackButtonClicked
	// void HandleBackButtonClicked();                                                                                          // [0xc83d150] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void OnQuickBuildSlotSelected(FJunoQuickBuildSlotData& SelectedQuickBuildSlotData);                                      // [0x246f7d8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoQuickBuildRadialPicker.CancelSelection
	// void CancelSelection();                                                                                                  // [0x41c1904] Final|Native|Protected|BlueprintCallable 
	// Function /Script/JunoUI.JunoQuickBuildRadialPicker.ApplyCurrentSelection
	// void ApplyCurrentSelection();                                                                                            // [0xc83cbf8] Final|Native|Protected|BlueprintCallable 
};
...
public:
	CMember(TWeakObjectPtr<AActor*>)                   CraftingObject                                              OFFSET(get<T>, {0x1480, 8, 0, 0})
	CMember(class UJunoBangWidget*)                    JunoBangWidget                                              OFFSET(get<T>, {0x1498, 8, 0, 0})
};

/// Class /Script/JunoUI.JunoRecipeListEntry
/// Size: 0x00C0 (0x001480 - 0x001540)
...
public:
	CMember(class UMenuAnchor*)                        ContextMenuAnchor                                           OFFSET(get<T>, {0x1488, 8, 0, 0})
	CMember(class UJunoBangWidget*)                    JunoBangWidget                                              OFFSET(get<T>, {0x1490, 8, 0, 0})
	CMember(class UJunoRecipeListObject*)              RecipeListObject                                            OFFSET(get<T>, {0x1498, 8, 0, 0})
	CMember(class UClass*)                             ContextMenuClass                                            OFFSET(get<T>, {0x14A0, 8, 0, 0})
	DMember(int32_t)                                   MaxCraftCount                                               OFFSET(get<int32_t>, {0x14F8, 4, 0, 0})
	DMember(bool)                                      bCanCraft                                                   OFFSET(get<bool>, {0x14FC, 1, 0, 0})


	/// Functions
	// Function /Script/JunoUI.JunoRecipeListEntry.ViewRecipe
	// void ViewRecipe();                                                                                                       // [0xc83e6d8] Final|Native|Protected|BlueprintCallable 
	// Function /Script/JunoUI.JunoRecipeListEntry.SetPartsRemaining
	// void SetPartsRemaining(FJunoGuidedBuildRemainingPartsInfo& RemainingParts);                                              // [0xc83e4fc] Native|Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoRecipeListEntry.OnUpdateListEntryVisuals
	// void OnUpdateListEntryVisuals();                                                                                         // [0x246f7d8] Event|Public|BlueprintEvent 
	// Function /Script/JunoUI.JunoRecipeListEntry.OnUpdateBangVisibility
	// void OnUpdateBangVisibility(EJunoBangVisibility BangType);                                                               // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoRecipeListEntry.OnSetRecipeInfo
	// void OnSetRecipeInfo(class UItemDefinitionBase* CraftedItemDef, int32_t CraftCount, FSlateBrush& SourceIcon);            // [0x246f7d8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoRecipeListEntry.OnRecipePinned
	// void OnRecipePinned(bool bIsPinned);                                                                                     // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoRecipeListEntry.OnLeaveContextMenuMode
	// void OnLeaveContextMenuMode(bool bUnselectSlot);                                                                         // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoRecipeListEntry.OnInitWidgetComplete
	// void OnInitWidgetComplete();                                                                                             // [0x246f7d8] Event|Protected|BlueprintEvent 
	...
	// void OnCurrentStageUpdate(FGuidedBuildingUpdate& UpdateData);                                                            // [0xc83df78] Native|Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoRecipeListEntry.GetPopupMenu
	// class UUserWidget* GetPopupMenu();                                                                                       // [0xc83cc90] Final|Native|Protected 
	// Function /Script/JunoUI.JunoRecipeListEntry.GetKnowledgeState
	// EJunoKnowledgeState GetKnowledgeState();                                                                                 // [0xc83cc2c] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoUI.JunoRecipeListEntry.GetCanCraft
	// bool GetCanCraft();                                                                                                      // [0xc83cc14] Final|Native|Protected|BlueprintCallable|BlueprintPure 
};
...
public:
	CMember(class UCommonTextBlock*)                   Text_Name                                                   OFFSET(get<T>, {0x1488, 8, 0, 0})
	CMember(class UJunoRecipeListObject*)              RecipeListObject                                            OFFSET(get<T>, {0x1490, 8, 0, 0})
};
...
public:
	...
	// void OnUpdateCraftingStationAttachedRecipe(FText& NewAttachedRecipe);                                                    // [0x246f7d8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoStandaloneCraftingContainer.OnSetCraftingStationUIEntry
	// void OnSetCraftingStationUIEntry(FJunoCraftingStationUIDataEntry CraftingStationUIEntry);                                // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoStandaloneCraftingContainer.OnRecipeCraftingComplete
	// void OnRecipeCraftingComplete(class UItemDefinitionBase* Item);                                                          // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoStandaloneCraftingContainer.HandleCraftingSuccess
	// void HandleCraftingSuccess(FCraftingObjectSuccessEvent& Event);                                                          // [0xc83d650] Final|Native|Private|HasOutParms 
	// Function /Script/JunoUI.JunoStandaloneCraftingContainer.HandleCraftingStationRecipeChanged
	// void HandleCraftingStationRecipeChanged(FName FormulaRowName);                                                           // [0xc83d590] Final|Native|Private 
	// Function /Script/JunoUI.JunoStandaloneCraftingContainer.HandleCraftingObjectDeath
	// void HandleCraftingObjectDeath(float Damage, FGameplayTagContainer& DamageTags, FVector Momentum, FHitResult& HitInfo, class AFortPawn* InstigatedBy, class AActor* DamageCauser, FGameplayEffectContextHandle EffectContext); // [0xc83d198] Final|Native|Private|HasOutParms|HasDefaults 
};
...
public:
	...
	// void OnUpdateCraftButton(EJunoCraftButtonState InButtonState, bool bIsStationUpgrade);                                   // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoStationUpgradeScreen.OnSetCurrentCraftingRecipeIcon
	// void OnSetCurrentCraftingRecipeIcon(TWeakObjectPtr<UTexture2D*>& UpgradeIcon);                                           // [0x246f7d8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoStationUpgradeScreen.HandleCraftingSuccess
	// void HandleCraftingSuccess(FCraftingObjectSuccessEvent& Event);                                                          // [0xc83d6f8] Native|Protected|HasOutParms 
};
...
public:
	...
	// bool ShouldShowUnacquiredBang(class APlayerController* PlayerController, FName RecipeRowName);                           // [0xc83e598] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/JunoUI.JunoUIFunctionLibrary.RemoveModalScene
	// void RemoveModalScene(class APlayerController* PlayerController);                                                        // [0xc83e290] Final|RequiredAPI|Native|Static|Public|BlueprintCallable 
	// Function /Script/JunoUI.JunoUIFunctionLibrary.OpenItemShop
	// void OpenItemShop(class AFortPlayerController* PC);                                                                      // [0xc83e00c] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/JunoUI.JunoUIFunctionLibrary.NumUnviewedRecipesInCategory
	// int32_t NumUnviewedRecipesInCategory(FCountUnviewedRecipesInCategoryArgs& InArgs);                                       // [0xc83dd08] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/JunoUI.JunoUIFunctionLibrary.NumUnviewedItemsInInventory
	// int32_t NumUnviewedItemsInInventory(class AFortPlayerController* PlayerController);                                      // [0xc83d988] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/JunoUI.JunoUIFunctionLibrary.NumUnviewedItemsInGroup
	// int32_t NumUnviewedItemsInGroup(class AFortPlayerController* PlayerController, FGameplayTag& GroupTag);                  // [0xc83d7a4] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/JunoUI.JunoUIFunctionLibrary.GetRecipesFromCraftingObject
	// TArray<FName> GetRecipesFromCraftingObject(class AFortPlayerController* PlayerController, class AActor* CraftingObject, FGameplayTag& CategoryTag, FGameplayTag& SubCategoryTag, bool bOnlyKnownRecipes, bool bOnlyOwnedRecipes); // [0xc83cddc] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/JunoUI.JunoUIFunctionLibrary.GetRecipeCategoryUIData
	// FJunoCraftingCategoryUIDataEntry GetRecipeCategoryUIData(FGameplayTag& CategoryTag);                                     // [0xc83ccb4] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/JunoUI.JunoUIFunctionLibrary.AddModalScene
	// void AddModalScene(class APlayerController* PlayerController, FJunoModalSceneOperation& ModalScene);                     // [0xc83caec] Final|RequiredAPI|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// void SetAwesomePointsInfo(int32_t CurrentAwesomePoints, int32_t RequiredAwesomePoints, int32_t InEntryIndex);            // [0xc83e340] RequiredAPI|Native|Event|Public|BlueprintEvent 
};
...
public:
	...
	// void OnAwesomeLevelChanged(FJunoAwesomeLevelChangeData& LevelChangeData);                                                // [0xc83dee0] Final|Native|Protected|HasOutParms 
};
...
public:
	SMember(FJunoVillageRewardEntryInfo)               VillageRewardEntryInfo                                      OFFSET(getStruct<T>, {0x1488, 112, 0, 0})
	SMember(FJunoVillageUIData)                        ParentVillageUIData                                         OFFSET(getStruct<T>, {0x14F8, 496, 0, 0})


	/// Functions
	// Function /Script/JunoUI.JunoVillageRewardEntry.SetVillageRewardEntryInfo
	// void SetVillageRewardEntryInfo(FJunoVillageRewardEntryInfo& InVillageRewardEntryInfo, FJunoVillageUIData& InParentVillageUIData); // [0xc86eab0] Native|Event|Public|HasOutParms|BlueprintEvent 
};
...
public:
	...
	// void OnNotifySlotReleased();                                                                                             // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoAdjustableInventorySlot.OnIncreaseEventHandled
	// void OnIncreaseEventHandled();                                                                                           // [0x246f7d8] Event|Public|BlueprintEvent 
	// Function /Script/JunoUI.JunoAdjustableInventorySlot.OnDecreaseEventHandled
	// void OnDecreaseEventHandled();                                                                                           // [0x246f7d8] Event|Public|BlueprintEvent 
	// Function /Script/JunoUI.JunoAdjustableInventorySlot.OnButtonsStateUpdated
	// void OnButtonsStateUpdated();                                                                                            // [0x246f7d8] Event|Public|BlueprintEvent 
};

/// Class /Script/JunoUI.JunoInventorySlot
/// Size: 0x0170 (0x001480 - 0x0015F0)
...
public:
	CMember(class UMenuAnchor*)                        ContextMenuAnchor                                           OFFSET(get<T>, {0x14F0, 8, 0, 0})
	CMember(class UJunoBangWidget*)                    JunoBangWidget                                              OFFSET(get<T>, {0x14F8, 8, 0, 0})
	DMember(bool)                                      bCanShowItemDetails                                         OFFSET(get<bool>, {0x1500, 1, 0, 0})
	DMember(bool)                                      bSupportsTooltipDisplay                                     OFFSET(get<bool>, {0x1501, 1, 0, 0})
	DMember(bool)                                      bDragAndDropAllowed                                         OFFSET(get<bool>, {0x1502, 1, 0, 0})
	CMember(class UClass*)                             ContextMenuClass                                            OFFSET(get<T>, {0x1508, 8, 0, 0})
	CMember(class AActor*)                             InventoryOwner                                              OFFSET(get<T>, {0x1518, 8, 0, 0})
	CMember(TWeakObjectPtr<UObject*>)                  InventoryGroupIcon                                          OFFSET(get<T>, {0x1520, 32, 0, 0})
	CMember(TWeakObjectPtr<UTexture2D*>)               MatchingItemIcon                                            OFFSET(get<T>, {0x1540, 32, 0, 0})
	SMember(FJunoItemSlot)                             SlotData                                                    OFFSET(getStruct<T>, {0x1568, 80, 0, 0})


	/// Functions
	// Function /Script/JunoUI.JunoInventorySlot.ShowItemDetails
	// void ShowItemDetails(bool bShow);                                                                                        // [0x246f7d8] Event|Public|BlueprintEvent 
	// Function /Script/JunoUI.JunoInventorySlot.OnStackCountChanged
	// void OnStackCountChanged(int32_t StackCount, int32_t MaxStackCount);                                                     // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoInventorySlot.OnShowSelected
	// void OnShowSelected(bool bInSelected);                                                                                   // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoInventorySlot.OnPreviewStackCountChanged
	// void OnPreviewStackCountChanged(int32_t StackCount, int32_t MaxStackCount);                                              // [0x246f7d8] Event|Public|BlueprintEvent 
	// Function /Script/JunoUI.JunoInventorySlot.OnPreviewImageChanged
	// void OnPreviewImageChanged(TWeakObjectPtr<UTexture2D*>& SlotImage, bool bIsValidItem, TWeakObjectPtr<UObject*>& InInventoryGroupIcon, TWeakObjectPtr<UTexture2D*>& InMatchingItemIcon, EFortRarity ItemRarity); // [0x246f7d8] Event|Protected|HasOutParms|BlueprintEvent 
	...
	// void OnLeaveSwappingMode();                                                                                              // [0x246f7d8] Event|Protected|BlueprintEvent 
	...
	// void OnItemHasBeenViewed(bool bHasBeenPreviouslyViewed);                                                                 // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoInventorySlot.OnEnterSwappingMode
	// void OnEnterSwappingMode(EJunoSwapItemType InSwapItemType, class UFortItem* Item);                                       // [0x246f7d8] Event|Protected|BlueprintEvent 
	...
	// void OnEnchantmentsChanged(int32_t TotalSlots, int32_t OccupiedSlots);                                                   // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoInventorySlot.OnEnabledForScreenChanged
	// void OnEnabledForScreenChanged(bool bEnabledForScreen);                                                                  // [0x246f7d8] Event|Public|BlueprintEvent 
	// Function /Script/JunoUI.JunoInventorySlot.OnDurabilityChanged
	// void OnDurabilityChanged(float CurrentDurability, float MaxDurability, float NormalizedDurability, bool bFromItemInitializtion); // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoInventorySlot.HandleOnMenuOpenChanged
	// void HandleOnMenuOpenChanged(bool bIsOpen);                                                                              // [0xc86e5ac] Final|Native|Private 
	// Function /Script/JunoUI.JunoInventorySlot.GetSlotTags
	// FGameplayTagContainer GetSlotTags();                                                                                     // [0xc86e030] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoUI.JunoInventorySlot.GetRepresentedItem
	// class UFortItem* GetRepresentedItem();                                                                                   // [0xc86dda0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoUI.JunoInventorySlot.GetPopupMenu
	// class UUserWidget* GetPopupMenu();                                                                                       // [0xc86dc2c] Final|Native|Private 
	// Function /Script/JunoUI.JunoInventorySlot.GetMatchingItemGameplayTags
	// FGameplayTagContainer GetMatchingItemGameplayTags();                                                                     // [0xc86dad4] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoUI.JunoInventorySlot.GetIsEnabledForScreen
	// bool GetIsEnabledForScreen();                                                                                            // [0xc86dabc] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void OnInventorySlotChanged();                                                                                           // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoInventorySlotsInfo.GetNumInventorySlots
	// int32_t GetNumInventorySlots(bool bOccupied);                                                                            // [0xc86db5c] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoUI.JunoInventorySlotsInfo.GetMaxInventorySlotsAvailable
	// int32_t GetMaxInventorySlotsAvailable();                                                                                 // [0xc86db10] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// bool GetIsRecipeBeingCrafted();                                                                                          // [0xbcb227c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	DMember(bool)                                      UpdateRecipeDetailsOnHover                                  OFFSET(get<bool>, {0x46C, 1, 0, 0})
	DMember(bool)                                      SkipSortOnInventoryChange                                   OFFSET(get<bool>, {0x46D, 1, 0, 0})
	...
	// void OnRecipeListUpdated();                                                                                              // [0x246f7d8] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void OnStartLoadingData();                                                                                               // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoBedAssignmentScreen.OnSelectionChanged
	// void OnSelectionChanged(class UJunoBedAssignmentListObject* InSelectedListObject);                                       // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoBedAssignmentScreen.OnModalConfirmed
	// void OnModalConfirmed();                                                                                                 // [0xc86e95c] Final|Native|Protected 
	// Function /Script/JunoUI.JunoBedAssignmentScreen.OnModalCancelled
	// void OnModalCancelled();                                                                                                 // [0xc86e1b0] Final|Native|Protected 
	// Function /Script/JunoUI.JunoBedAssignmentScreen.OnDataLoadingComplete
	// void OnDataLoadingComplete();                                                                                            // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoBedAssignmentScreen.GetTypeFromListObject
	// EJunoBedAssignmentActionType GetTypeFromListObject(class UJunoBedAssignmentListObject* InSelectedListObject);            // [0x924c6c0] Native|Event|Protected|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /Script/JunoUI.JunoBedAssignmentScreen.GetShouldShowModal
	// bool GetShouldShowModal(class UJunoBedAssignmentListObject* InSelectedListObject);                                       // [0xc86df58] Native|Event|Protected|BlueprintEvent|Const 
};
...
public:
	...
	// void OnSecondaryCategoriesChanged(bool bHasSecondaryCategories);                                                         // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoBuildingScreen.OnRecipeHovered
	// void OnRecipeHovered();                                                                                                  // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoBuildingScreen.OnGuidedBuildingSnapsUpdated
	// void OnGuidedBuildingSnapsUpdated(TArray<int32_t>& UpdatedSnaps);                                                        // [0xc86e8c8] Final|Native|Private|HasOutParms 
	// Function /Script/JunoUI.JunoBuildingScreen.OnGuidedBuildingSetComplete
	// void OnGuidedBuildingSetComplete(FGuidedBuildingUpdate& UpdateData);                                                     // [0xc86e844] Final|Native|Private|HasOutParms 
	// Function /Script/JunoUI.JunoBuildingScreen.HasPreviewRecipe
	// bool HasPreviewRecipe();                                                                                                 // [0xc86e828] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoUI.JunoBuildingScreen.HandleShopClicked
	// void HandleShopClicked();                                                                                                // [0xc86e814] Final|Native|Private 
	// Function /Script/JunoUI.JunoBuildingScreen.HandleSecondaryTabTransitionComplete
	// void HandleSecondaryTabTransitionComplete();                                                                             // [0xc86e7f0] Final|Native|Protected|BlueprintCallable 
	// Function /Script/JunoUI.JunoBuildingScreen.HandleSecondaryCategorySelected
	// void HandleSecondaryCategorySelected(FName TabID);                                                                       // [0xc86e730] Final|Native|Private 
	// Function /Script/JunoUI.JunoBuildingScreen.HandlePrimaryCategorySelected
	// void HandlePrimaryCategorySelected(FName TabID);                                                                         // [0xc86e670] Final|Native|Private 
	// Function /Script/JunoUI.JunoBuildingScreen.HandleBackClicked
	// void HandleBackClicked();                                                                                                // [0x7e9d304] Native|Protected|BlueprintCallable 
	// Function /Script/JunoUI.JunoBuildingScreen.GetWidgetFromItem
	// class UJunoRecipeListEntry* GetWidgetFromItem(class UObject* Item);                                                      // [0xc86e074] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoUI.JunoBuildingScreen.GetSecondaryCategoryUIData
	// bool GetSecondaryCategoryUIData(FName PrimaryTabId, FName SecondaryTabId, FJunoCraftingSubCategoryUIDataEntry& OutSecondaryCategoryUIData); // [0xc86ddb8] Final|Native|Protected|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoUI.JunoBuildingScreen.GetPrimaryCategoryUIData
	// bool GetPrimaryCategoryUIData(FName PrimaryTabId, FJunoCraftingCategoryUIDataEntry& OutPrimaryCategoryUIData);           // [0xc86dc50] Final|Native|Protected|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoUI.JunoBuildingScreen.GetCraftingObject
	// class AActor* GetCraftingObject();                                                                                       // [0xc86d7d8] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void OnWithdrawStateUpdated(bool bWithdrawEnabled);                                                                      // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoCraftingScreen.OnUpdateSelectRecipeButton
	// void OnUpdateSelectRecipeButton(ESelectRecipeButtonState InButtonState);                                                 // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoCraftingScreen.OnUpdatePassiveCraftingProgress
	// void OnUpdatePassiveCraftingProgress(int32_t ItemsToCraft);                                                              // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoCraftingScreen.OnUpdateCraftingStationInventoryState
	// void OnUpdateCraftingStationInventoryState(ECraftingStationsInventoryState StationInventoryState);                       // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoCraftingScreen.OnUpdateCraftButton
	// void OnUpdateCraftButton(EJunoCraftButtonState InButtonState);                                                           // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoCraftingScreen.OnPassiveScreenFocusChange
	// void OnPassiveScreenFocusChange(bool bInputSlotsFocused);                                                                // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoCraftingScreen.HandleCraftingSuccess
	// void HandleCraftingSuccess(FCraftingObjectSuccessEvent& Event);                                                          // [0xc86e298] Final|Native|Protected|HasOutParms 
	// Function /Script/JunoUI.JunoCraftingScreen.HandleCategorySelected
	// void HandleCategorySelected(FName TabID);                                                                                // [0xc86e1d8] Final|Native|Protected 
	// Function /Script/JunoUI.JunoCraftingScreen.HandleAttachNewRecipeConfirmed
	// void HandleAttachNewRecipeConfirmed();                                                                                   // [0xc86e1c4] Final|Native|Private 
	// Function /Script/JunoUI.JunoCraftingScreen.HandleAttachNewRecipeCancelled
	// void HandleAttachNewRecipeCancelled();                                                                                   // [0xc86e1b0] Final|Native|Private 
	// Function /Script/JunoUI.JunoCraftingScreen.ForceCloseCraftingScreen
	// void ForceCloseCraftingScreen();                                                                                         // [0xc86d7c4] Final|Native|Private 
};
...
public:
	...
	// class UJunoProcessingSlot* GetInventorySlot(int32_t RowIndex, int32_t ColumnIndex);                                      // [0xc86d970] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};

/// Class /Script/JunoUI.JunoProcessingSlot
/// Size: 0x00E8 (0x0002F0 - 0x0003D8)
...
public:
	...
	SMember(FCraftingProcess)                          CurrentCraftingProcess                                      OFFSET(getStruct<T>, {0x370, 104, 0, 0})


	/// Functions
	// Function /Script/JunoUI.JunoProcessingSlot.OnNotifySlotReleased
	// void OnNotifySlotReleased();                                                                                             // [0x246f7d8] Event|Public|BlueprintEvent 
	// Function /Script/JunoUI.JunoProcessingSlot.OnItemRemoved
	// void OnItemRemoved();                                                                                                    // [0x246f7d8] Event|Public|BlueprintEvent 
	// Function /Script/JunoUI.JunoProcessingSlot.OnItemAdded
	// void OnItemAdded();                                                                                                      // [0x246f7d8] Event|Public|BlueprintEvent 
	// Function /Script/JunoUI.JunoProcessingSlot.GetRepresentedItem
	// class UFortItem* GetRepresentedItem();                                                                                   // [0xc2487e8] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void OnSetGroupName(FText& InGroupName);                                                                                 // [0x246f7d8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoInventoryGroup.GetInventorySlot
	// class UJunoInventorySlot* GetInventorySlot(int32_t RowIndex, int32_t ColumnIndex);                                       // [0xc86d824] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoUI.JunoInventoryGroup.GetFirstSlot
	// class UJunoInventorySlot* GetFirstSlot();                                                                                // [0xc86d800] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void OnInventoryObjectUpdated(bool bInventoryObjectPresent);                                                             // [0x246f7d8] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// bool ShouldShowPlayersTab();                                                                                             // [0xc83bba4] Final|Native|Public|BlueprintCallable|Const 
};
...
public:
	CMember(TWeakObjectPtr<UCommonButtonGroupBase*>)   WeakButtonGroup_InventorySlots                              OFFSET(get<T>, {0x90, 8, 0, 0})
	CMember(TWeakObjectPtr<AFortPlayerController*>)    WeakOwningPlayer                                            OFFSET(get<T>, {0x98, 8, 0, 0})
	CMember(class UJunoInventorySlot*)                 SourceInventorySlot                                         OFFSET(get<T>, {0xA8, 8, 0, 0})
	CMember(class UJunoInventorySlot*)                 DestinationInventorySlot                                    OFFSET(get<T>, {0xB0, 8, 0, 0})
};
...
public:
	...
	// void OnUpdateTeamPlayerEntry(class UUserWidget* EntryWidget, FUniqueNetIdRepl PlayerUniqueNetId, FString PlayerName);    // [0x246f7d8] Event|Protected|BlueprintEvent 
};
...
public:
	CMember(TWeakObjectPtr<UTexture*>)                 Icon                                                        OFFSET(get<T>, {0x1490, 32, 0, 0})
	CMember(class UFortLazyImage*)                     Image_MarkerIcon                                            OFFSET(get<T>, {0x14C0, 8, 0, 0})
	CMember(class UBorder*)                            ColorBorder                                                 OFFSET(get<T>, {0x14C8, 8, 0, 0})
	CMember(class UImage*)                             Checkmark                                                   OFFSET(get<T>, {0x14D0, 8, 0, 0})
	SMember(FLinearColor)                              IconEntryBackgroundColor                                    OFFSET(getStruct<T>, {0x14D8, 16, 0, 0})


	/// Functions
	// Function /Script/JunoUI.JunoMapMarkerCustomizationEntry.OnEntryInitialized
	// void OnEntryInitialized(FJunoMapMarkerEntryInitData EntryInitData);                                                      // [0x246f7d8] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void SetPreviewMarkerMaterial();                                                                                         // [0x246f7d8] Event|Public|BlueprintEvent 
	// Function /Script/JunoUI.JunoMapMarkerCustomizationScreen.SetMarkerNameText
	// void SetMarkerNameText(FText& Name);                                                                                     // [0x246f7d8] Event|Public|HasOutParms|BlueprintEvent 
};

/// Class /Script/JunoUI.JunoVillageScreenBase
/// Size: 0x0248 (0x000408 - 0x000650)
...
public:
	...
	SMember(FJunoVillageUIData)                        VillageUIData                                               OFFSET(getStruct<T>, {0x448, 496, 0, 0})
	CMember(class AJunoCampActor*)                     CampActor                                                   OFFSET(get<T>, {0x638, 8, 0, 0})
	CMember(class UJunoCampMembershipActorComponent*)  CampMembershipActorComponent                                OFFSET(get<T>, {0x640, 8, 0, 0})
	CMember(class UJunoAwesomeLevelComponent*)         AwesomeLevelComponent                                       OFFSET(get<T>, {0x648, 8, 0, 0})


	/// Functions
	// Function /Script/JunoUI.JunoVillageScreenBase.OnVillageDataChanged
	// void OnVillageDataChanged();                                                                                             // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoVillageScreenBase.OnAwesomePointsModified
	// void OnAwesomePointsModified(FJunoAwesomePointModificationData& PointModificationData);                                  // [0xc8a27e4] RequiredAPI|Native|Protected|HasOutParms 
	// Function /Script/JunoUI.JunoVillageScreenBase.OnAwesomeLevelChanged
	// void OnAwesomeLevelChanged(FJunoAwesomeLevelChangeData& LevelChangeData);                                                // [0xc8a2750] RequiredAPI|Native|Protected|HasOutParms 
	// Function /Script/JunoUI.JunoVillageScreenBase.BP_OnAwesomePointsChanged
	// void BP_OnAwesomePointsChanged(FJunoAwesomePointModificationData& Data);                                                 // [0x246f7d8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoVillageScreenBase.BP_OnAwesomeLevelChanged
	// void BP_OnAwesomeLevelChanged(FJunoAwesomeLevelChangeData& Data);                                                        // [0x246f7d8] Event|Protected|HasOutParms|BlueprintEvent 
};

/// Class /Script/JunoUI.JunoVillageDetailsScreen
/// Size: 0x0088 (0x000650 - 0x0006D8)
...
public:
	CMember(class UCommonButtonBase*)                  Button_RemoveVillage                                        OFFSET(get<T>, {0x650, 8, 0, 0})
	CMember(class UCommonButtonGroupBase*)             ButtonGroup_AllRewards                                      OFFSET(get<T>, {0x658, 8, 0, 0})
	CMember(class UDynamicEntryBox*)                   RewardList                                                  OFFSET(get<T>, {0x660, 8, 0, 0})
	CMember(class UJunoVillageRewardEntry*)            LastHoveredEntry                                            OFFSET(get<T>, {0x668, 8, 0, 0})
	CMember(class UDynamicUIScene*)                    RemoveVillageModalScene                                     OFFSET(get<T>, {0x670, 8, 0, 0})
	SMember(FText)                                     RemoveVillageConfirmationTitle                              OFFSET(getStruct<T>, {0x678, 16, 0, 0})
	SMember(FText)                                     RemoveVillageConfirmationDescription                        OFFSET(getStruct<T>, {0x688, 16, 0, 0})
	SMember(FText)                                     RemoveVillageConfirmButtonText                              OFFSET(getStruct<T>, {0x698, 16, 0, 0})
	SMember(FText)                                     RemoveVillageCancelButtonText                               OFFSET(getStruct<T>, {0x6A8, 16, 0, 0})
	SMember(FDataTableRowHandle)                       ModalConfirmAction                                          OFFSET(getStruct<T>, {0x6B8, 16, 0, 0})
	SMember(FDataTableRowHandle)                       ModalCancelAction                                           OFFSET(getStruct<T>, {0x6C8, 16, 0, 0})


	/// Functions
	// Function /Script/JunoUI.JunoVillageDetailsScreen.OnEntryHovered
	// void OnEntryHovered(class UJunoVillageRewardEntry* Entry);                                                               // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoVillageDetailsScreen.HandleRemoveVillageConfirmed
	// void HandleRemoveVillageConfirmed();                                                                                     // [0xc8a273c] Final|Native|Protected 
	// Function /Script/JunoUI.JunoVillageDetailsScreen.HandleRemoveVillageCancelled
	// void HandleRemoveVillageCancelled();                                                                                     // [0xc86e1b0] Final|Native|Protected 
};
...
public:
	...
	// TWeakObjectPtr<UTexture2D*> FindPerkImage(FGameplayTagContainer& InTagContainer);                                        // [0xc8a20f0] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
};
...
public:
	CMember(class UCommonButtonBase*)                  Button_Upgrade                                              OFFSET(get<T>, {0x650, 8, 0, 0})
	CMember(class UDynamicEntryBox*)                   EntryBox_Ingredients                                        OFFSET(get<T>, {0x658, 8, 0, 0})
	CMember(class UDynamicEntryBox*)                   EntryBox_Perks                                              OFFSET(get<T>, {0x660, 8, 0, 0})
	CMember(class UScrollBox*)                         ScrollBox_Rewards                                           OFFSET(get<T>, {0x668, 8, 0, 0})
	CMember(class UScrollBox*)                         ScrollBox_Requirements                                      OFFSET(get<T>, {0x670, 8, 0, 0})


	/// Functions
	// Function /Script/JunoUI.JunoVillageUpgradeScreen.OnUpgrade
	// void OnUpgrade();                                                                                                        // [0x246f7d8] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void ShowWidget();                                                                                                       // [0x38301ec] Native|Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoGuidedBuildingHudStateWidget.OnStageComplete
	// void OnStageComplete(FGuidedBuildingUpdate& UpdateData);                                                                 // [0xc8a2af4] Native|Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoGuidedBuildingHudStateWidget.OnSnapsUpdated
	// void OnSnapsUpdated(TArray<int32_t>& UpdatedSnaps);                                                                      // [0xc8a2a54] Native|Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoGuidedBuildingHudStateWidget.OnSetComplete
	// void OnSetComplete(FGuidedBuildingUpdate& UpdateData);                                                                   // [0xc8a29c0] Native|Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoGuidedBuildingHudStateWidget.OnSectionComplete
	// void OnSectionComplete(FGuidedBuildingUpdate& UpdateData);                                                               // [0xc8a292c] Native|Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoGuidedBuildingHudStateWidget.OnCurrentStageUpdate
	// void OnCurrentStageUpdate(FGuidedBuildingUpdate& UpdateData);                                                            // [0xc8a2884] Native|Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoGuidedBuildingHudStateWidget.OnAutoHideTimereFinished
	// void OnAutoHideTimereFinished();                                                                                         // [0x3449a4c] Native|Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoGuidedBuildingHudStateWidget.HideWidget
	// void HideWidget();                                                                                                       // [0x3c52ffc] Native|Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void SetFill(float Fill);                                                                                                // [0xc8a2f38] Final|Native|Public|BlueprintCallable 
	// Function /Script/JunoUI.JunoAnimatedProgressBar.SetDelta
	// void SetDelta(float Fill);                                                                                               // [0xc8a2e74] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void OnSlotItemChanged(EJunoItemChangeType ChangeType, class UFortItem* SlotItem);                                       // [0x246f7d8] Event|Protected|BlueprintEvent 
};
...
public:
	...
	CMember(class UFortKeybindWidget*)                 KeybindWidget                                               OFFSET(get<T>, {0x3E0, 8, 0, 0})
	CMember(class UCommonTextBlock*)                   Text_KeyBindName                                            OFFSET(get<T>, {0x3E8, 8, 0, 0})


	/// Functions
	// Function /Script/JunoUI.JunoInteractionIndicatorWidget.OnShowPickup
	// void OnShowPickup(class AFortPickup* InCurrentPickup);                                                                   // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoInteractionIndicatorWidget.OnShowBasicInteraction
	// void OnShowBasicInteraction(FText& Description, FLinearColor DescriptionColor, int32_t InteractionCount);                // [0x246f7d8] Event|Protected|HasOutParms|HasDefaults|BlueprintEvent 
};
...
public:
	...
	// void OnNotificationFinished();                                                                                           // [0xc8a2918] Final|Native|Protected|BlueprintCallable 
	// Function /Script/JunoUI.JunoNotificationWidget.BP_DisplayNotification
	// void BP_DisplayNotification(FJunoNotificationData& NotificationData);                                                    // [0x246f7d8] Event|Protected|HasOutParms|BlueprintEvent 
};
...
public:
	...
	// void RefreshPickupEntry(class UUserWidget* EntryWidget, TWeakObjectPtr<UTexture2D*>& Icon, FText& DisplayName, int32_t Count, int32_t TotalInventoryCount, EFortRarity ItemRarity, EJunoPickupStreamAnim AnimType); // [0x246f7d8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoPickupStream.OnHideExpiredPickup
	// void OnHideExpiredPickup(class UUserWidget* EntryWidget);                                                                // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoPickupStream.OnActivePickupsPresent
	// void OnActivePickupsPresent(bool bHasActivePickups);                                                                     // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoPickupStream.HandleItemPickedUp
	// void HandleItemPickedUp(class UFortWorldItem* WorldItem, int32_t Count);                                                 // [0xc8a2540] Final|Native|Protected 
	// Function /Script/JunoUI.JunoPickupStream.HandleEntryHideAnimComplete
	// void HandleEntryHideAnimComplete(class UUserWidget* EntryWidget);                                                        // [0xc8a2458] Final|Native|Protected|BlueprintCallable 
};
...
public:
	...
	// void OnValueChangedWithReason(EFortHitPointModificationReason Reason);                                                   // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoPlayerHitpointWidget.OnMaxValueChanged
	// void OnMaxValueChanged(float Value);                                                                                     // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoPlayerHitpointWidget.OnDeltaChanged
	// void OnDeltaChanged();                                                                                                   // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoPlayerHitpointWidget.GetLastValuePercentage
	// float GetLastValuePercentage();                                                                                          // [0xc8a23ac] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoUI.JunoPlayerHitpointWidget.GetCurrentValuePercentage
	// float GetCurrentValuePercentage();                                                                                       // [0xc8a237c] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void OnPlayerDataUpdated(FJunoPlayerIndicatorData& PlayerIndicatorData);                                                 // [0x246f7d8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoPlayerIndicatorWidget.OnInFocusStateChanged
	// void OnInFocusStateChanged(bool bInInFocus);                                                                             // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoPlayerIndicatorWidget.OnClampedStatusChanged
	// void OnClampedStatusChanged(bool bInIsClamped);                                                                          // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoPlayerIndicatorWidget.HandlePlayerStatePawnDied
	// void HandlePlayerStatePawnDied(FPawnDamageData& PawnDamageInfo);                                                         // [0xc8a267c] Final|Native|Private|HasOutParms 
	// Function /Script/JunoUI.JunoPlayerIndicatorWidget.HandleCurrentPawnChanged
	// void HandleCurrentPawnChanged();                                                                                         // [0xc8a2444] Final|Native|Private 
};

/// Class /Script/JunoUI.JunoQuickbar
/// Size: 0x00A8 (0x000330 - 0x0003D8)
...
public:
	...
	// void OnQuickbarSlotChanged(int32_t SelectedSlotIndex);                                                                   // [0x246f7d8] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void OnSlotItemChangeFailed();                                                                                           // [0x246f7d8] Event|Public|BlueprintEvent 
	// Function /Script/JunoUI.JunoQuickbarSlot.OnSlotItemChanged
	// void OnSlotItemChanged(EJunoItemChangeType ChangeType);                                                                  // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoQuickbarSlot.OnSlotInitialized
	// void OnSlotInitialized();                                                                                                // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoQuickbarSlot.OnSetQuickbarSlotSelected
	// void OnSetQuickbarSlotSelected(bool bInSelected, FText& ItemName);                                                       // [0x246f7d8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoQuickbarSlot.OnPrebuildStateChanged
	// void OnPrebuildStateChanged(bool bInEnabled);                                                                            // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoQuickbarSlot.GetSlotItem
	// class UFortItem* GetSlotItem();                                                                                          // [0xc8a2424] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void StartRegisteringUI();                                                                                               // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoDynamicUIDirector.OpenStandaloneMenuScene
	// void OpenStandaloneMenuScene(FJunoWidgetSceneAndIndex WidgetSceneAndIndex, class UObject* BoundObject);                  // [0xc8a2d10] Final|Native|Protected|BlueprintCallable 
	// Function /Script/JunoUI.JunoDynamicUIDirector.OpenHudMenuScene
	// void OpenHudMenuScene(FJunoWidgetSceneAndIndex WidgetSceneAndIndex, class UJunoHudMenuBaseInitData* HudMenuData);        // [0xc8a2b88] Final|Native|Protected|BlueprintCallable 
	// Function /Script/JunoUI.JunoDynamicUIDirector.OnIsMobileHUDShowingChanged
	// void OnIsMobileHUDShowingChanged();                                                                                      // [0x246f7d8] Event|Protected|BlueprintCallable|BlueprintEvent 
	// Function /Script/JunoUI.JunoDynamicUIDirector.OnEnteredConversation
	// void OnEnteredConversation();                                                                                            // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoDynamicUIDirector.HandleHudMenuSceneClosed
	// void HandleHudMenuSceneClosed();                                                                                         // [0xc8a2518] Final|Native|Protected|BlueprintCallable 
	// Function /Script/JunoUI.JunoDynamicUIDirector.GetIsMobileHUDShowing
	// bool GetIsMobileHUDShowing();                                                                                            // [0x65904ac] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoUI.JunoDynamicUIDirector.FindTagDrivenScene
	// bool FindTagDrivenScene(FGameplayTagContainer& TagContainer, FGameplayTag& ParentTag, FJunoWidgetSceneAndIndex& OutWidgetSceneAndIndex); // [0xc8a21cc] Final|Native|Protected|HasOutParms|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void UpdateHUDLayoutContexts(FGameplayTagContainer ContextsToAdd, FGameplayTagContainer ContextsToRemove);               // [0xc8a2ffc] Final|Native|Protected|BlueprintCallable 
	// Function /Script/JunoUI.JunoDynamicUIDirectorComponent.OnStartRegisteringUI
	// void OnStartRegisteringUI();                                                                                             // [0x246f7d8] Event|Public|BlueprintEvent 
	// Function /Script/JunoUI.JunoDynamicUIDirectorComponent.OnIsMobileHUDShowingChanged
	// void OnIsMobileHUDShowingChanged();                                                                                      // [0x246f7d8] Event|Public|BlueprintEvent 
	// Function /Script/JunoUI.JunoDynamicUIDirectorComponent.GetOwningLocalPlayerController
	// class APlayerController* GetOwningLocalPlayerController();                                                               // [0xc8a2400] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoUI.JunoDynamicUIDirectorComponent.GetOwningJunoDirector
	// class AJunoDynamicUIDirector* GetOwningJunoDirector();                                                                   // [0xc8a23dc] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoUI.JunoDynamicUIDirectorComponent.GetIsMobileHUDShowing
	// bool GetIsMobileHUDShowing();                                                                                            // [0x876ffe4] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	CMember(EJunoBiome)                                BiomeType                                                   OFFSET(get<T>, {0xA8, 1, 0, 0})
	DMember(int32_t)                                   AwesomeLevel                                                OFFSET(get<int32_t>, {0xAC, 4, 0, 0})
	DMember(int32_t)                                   MaxAwesomeLevel                                             OFFSET(get<int32_t>, {0xB0, 4, 0, 0})
	DMember(int32_t)                                   AwesomePoints                                               OFFSET(get<int32_t>, {0xB4, 4, 0, 0})
	DMember(int32_t)                                   AwesomePointGoal                                            OFFSET(get<int32_t>, {0xB8, 4, 0, 0})
	DMember(int32_t)                                   AwesomePointFloor                                           OFFSET(get<int32_t>, {0xBC, 4, 0, 0})
	DMember(int32_t)                                   AwesomePointsNeededForNextLevel                             OFFSET(get<int32_t>, {0xC0, 4, 0, 0})
	DMember(float)                                     AwesomeProgressToNextLevel                                  OFFSET(get<float>, {0xC4, 4, 0, 0})
	DMember(float)                                     AwesomeEffectiveProgressToNextLevel                         OFFSET(get<float>, {0xC8, 4, 0, 0})
	DMember(int32_t)                                   AwesomeLevelFromCurrentPoints                               OFFSET(get<int32_t>, {0xCC, 4, 0, 0})
	CMember(TArray<FAwesomeLevelRewardEntry>)          AwesomeLevelRewardEntries                                   OFFSET(get<T>, {0xD0, 16, 0, 0})
	SMember(FJunoAwesomeUpgradeRequirements)           CurrentUpgradeRequirements                                  OFFSET(getStruct<T>, {0xE0, 80, 0, 0})
	CMember(TArray<FAwesomePerkReward>)                UnlockedPlayerPerks                                         OFFSET(get<T>, {0x130, 16, 0, 0})
	CMember(TArray<FActiveCampNPCEntry>)               ActiveNPCEntries                                            OFFSET(get<T>, {0x140, 16, 0, 0})
	DMember(int32_t)                                   MaxNPCs                                                     OFFSET(get<int32_t>, {0x150, 4, 0, 0})
	DMember(int32_t)                                   NPCSlots                                                    OFFSET(get<int32_t>, {0x154, 4, 0, 0})
	DMember(int32_t)                                   CreatureSlots                                               OFFSET(get<int32_t>, {0x158, 4, 0, 0})
	DMember(int32_t)                                   SharedSlots                                                 OFFSET(get<int32_t>, {0x15C, 4, 0, 0})
	DMember(int32_t)                                   MaxNPCsEver                                                 OFFSET(get<int32_t>, {0x160, 4, 0, 0})
	CMember(TArray<FActiveCampNPCEntry>)               VisitingNPCEntries                                          OFFSET(get<T>, {0x168, 16, 0, 0})
	CMember(TArray<FActiveCampCreatureEntry>)          ActiveCreatureEntries                                       OFFSET(get<T>, {0x178, 16, 0, 0})
	CMember(TMap<FGameplayTag, int32_t>)               JobCounts                                                   OFFSET(get<T>, {0x188, 80, 0, 0})
	CMember(TArray<TWeakObjectPtr<UJunoKnowledgeBundle*>>) KnowledgeBundles                                        OFFSET(get<T>, {0x1D8, 16, 0, 0})
	CMember(class UFortItemDefinition*)                VillageCenterItemDefinition                                 OFFSET(get<T>, {0x1E8, 8, 0, 0})
};
...
enum class EStationInventoryState : uint8_t
{
	...
	EStationInventoryState__EStationInventoryState_MAX                               = 5
};
