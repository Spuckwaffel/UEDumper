...
public:
	...
	SMember(FFortItemEntry)                            SlottedItemEntry                                            OFFSET(getStruct<T>, {0x1E0, 416, 0, 0})


	/// Functions
	// Function /Script/StateDrivenActorRuntime.FortActorComponent_StateDriven.TriggerCustomEvent
	// void TriggerCustomEvent(FGameplayTag& EventTag);                                                                         // [0x8e3f61c] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/StateDrivenActorRuntime.FortActorComponent_StateDriven.SetCurrentState
	// void SetCurrentState(FStateDrivenState& InCurrentState);                                                                 // [0xbb8a894] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/StateDrivenActorRuntime.FortActorComponent_StateDriven.PopSlottedItem
	// void PopSlottedItem();                                                                                                   // [0x3508bf8] Final|Native|Public|BlueprintCallable 
	// Function /Script/StateDrivenActorRuntime.FortActorComponent_StateDriven.PlayBurstGameplayCue
	// void PlayBurstGameplayCue(FGameplayTag GameplayCueTag);                                                                  // [0xbb8a7a4] Final|Native|Public|BlueprintCallable|Const 
	// Function /Script/StateDrivenActorRuntime.FortActorComponent_StateDriven.OnSetupOverlapEventSettings
	// void OnSetupOverlapEventSettings();                                                                                      // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/StateDrivenActorRuntime.FortActorComponent_StateDriven.OnSetupInteractionEventSettings
	// void OnSetupInteractionEventSettings();                                                                                  // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/StateDrivenActorRuntime.FortActorComponent_StateDriven.OnSetupDamageEventSettings
	// void OnSetupDamageEventSettings();                                                                                       // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/StateDrivenActorRuntime.FortActorComponent_StateDriven.OnResetCollisionSettings
	// void OnResetCollisionSettings();                                                                                         // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/StateDrivenActorRuntime.FortActorComponent_StateDriven.OnMulticastStateTreeEvent
	// void OnMulticastStateTreeEvent(FGameplayTag TransitionTag, FGameplayCueTag BurstGameplayCueTag);                         // [0x246f7d8] Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Script/StateDrivenActorRuntime.FortActorComponent_StateDriven.OnHandleStateTreeEvent
	// void OnHandleStateTreeEvent(FGameplayTag TransitionTag, FGameplayCueTag BurstGameplayCueTag);                            // [0x246f7d8] Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Script/StateDrivenActorRuntime.FortActorComponent_StateDriven.HandleInteraction
	// void HandleInteraction(class ABuildingActor* SelfActor, class AFortPawn* InteractingPawn);                               // [0x6ce8074] Final|Native|Private 
	// Function /Script/StateDrivenActorRuntime.FortActorComponent_StateDriven.HandleEndOverlap
	// void HandleEndOverlap(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex); // [0x87709f0] Final|Native|Private 
	// Function /Script/StateDrivenActorRuntime.FortActorComponent_StateDriven.HandleDied
	// void HandleDied(class AActor* DamagedActor, float Damage, class AController* InstigatedBy, class AActor* DamageCauser, FVector HitLocation, class UPrimitiveComponent* FHitComponent, FName BoneName, FVector Momentum); // [0x8d04e4c] Final|Native|Private|HasDefaults 
	// Function /Script/StateDrivenActorRuntime.FortActorComponent_StateDriven.HandleDamaged
	// void HandleDamaged(class AActor* DamagedActor, float Damage, class AController* InstigatedBy, class AActor* DamageCauser, FVector HitLocation, class UPrimitiveComponent* FHitComponent, FName BoneName, FVector Momentum); // [0x8d04e4c] Final|Native|Private|HasDefaults 
	// Function /Script/StateDrivenActorRuntime.FortActorComponent_StateDriven.HandleBeginOverlap
	// void HandleBeginOverlap(class UPrimitiveComponent* OverlappedComp, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool bFromSweep, FHitResult& SweepResult); // [0x8770300] Final|Native|Private|HasOutParms 
	// Function /Script/StateDrivenActorRuntime.FortActorComponent_StateDriven.GetSlottedItemEntry
	// FFortItemEntry GetSlottedItemEntry();                                                                                    // [0xbb8a788] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/StateDrivenActorRuntime.FortActorComponent_StateDriven.GetSlottedItemDisplayName
	// FText GetSlottedItemDisplayName();                                                                                       // [0xbb8a74c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/StateDrivenActorRuntime.FortActorComponent_StateDriven.GetInteractionString
	// FText GetInteractionString(class AFortPawn* InteractingPawn, TEnumAsByte<EInteractionBeingAttempted> InteractionBeingAttempted); // [0xbb8a5e4] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/StateDrivenActorRuntime.FortActorComponent_StateDriven.GetFailedInteractionString
	// FText GetFailedInteractionString(class AFortPawn* InteractingPawn, TEnumAsByte<EInteractionBeingAttempted> InteractionBeingAttempted); // [0xbb8a47c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	CMember(TArray<FStateDrivenStateTransitions>)      Transitions                                                 OFFSET(get<T>, {0xB8, 16, 0, 0})
};
