...
public:
	...
	// void ExecuteUbergraph_WBP_Mobile_Augment_Selection_Proxy(int32_t EntryPoint);                                            // [0x246f7d8] Final                
};
...
public:
	...
	// void ExecuteUbergraph_WBP_Mobile_Augment_SelectionTimer(int32_t EntryPoint);                                             // [0x246f7d8] Final|HasDefaults    
};
