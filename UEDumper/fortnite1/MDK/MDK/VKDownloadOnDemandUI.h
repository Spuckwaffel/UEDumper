...
public:
	...
	// void UpdateProjectConfirmed();                                                                                           // [0xc63ac08] Final|Native|Protected|BlueprintCallable 
	// Function /Script/VKDownloadOnDemandUI.DownloadOnDemandProjectManagementTab.RemoveProjectConfirmed
	// void RemoveProjectConfirmed();                                                                                           // [0xc63ab20] Final|Native|Protected|BlueprintCallable 
};
...
public:
	...
	// void UpdateLightningViolator(ESlateVisibility InVisibility, FText& InText);                                              // [0x246f7d8] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/VKDownloadOnDemandUI.DownloadOnDemandAddProjectModal.HandleDownloadLinkIdTextChanged
	// void HandleDownloadLinkIdTextChanged(FText& InputLinkCode);                                                              // [0xc63aa84] Final|Native|Private|HasOutParms 
};
...
public:
	...
	// void UpdateLabel(bool bShowLabel);                                                                                       // [0xc63ab44] Final|Native|Public|BlueprintCallable 
	// Function /Script/VKDownloadOnDemandUI.DownloadOnDemandProjectTile.OnLabelUpdated
	// void OnLabelUpdated();                                                                                                   // [0x246f7d8] Event|Protected|BlueprintEvent 
};
