...
public:
	...
	// int32_t GetTotalPartCount();                                                                                             // [0xc818564] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoBuildingCosmeticsUI.JunoShopBuildSetItemDetailsVM.GetFormattedPartList
	// TArray<FText> GetFormattedPartList();                                                                                    // [0xc8184ec] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoBuildingCosmeticsUI.JunoShopBuildSetItemDetailsVM.ForceUpdateItemDetails
	// void ForceUpdateItemDetails();                                                                                           // [0xc8184d8] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// TArray<FText> GetPropNames();                                                                                            // [0xc818528] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
