...
public:
	...
	// void UpdateShowMore();                                                                                                   // [0xc23f51c] Final|Native|Protected|BlueprintCallable 
	// Function /Script/FabricTooltipUI.FabricTooltipWidget.ToggleShowMore
	// void ToggleShowMore();                                                                                                   // [0xc23f4cc] Native|Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Script/FabricTooltipUI.FabricTooltipWidget.SetShowMore
	// void SetShowMore(bool bShowingMore);                                                                                     // [0xc23f408] Final|Native|Protected|BlueprintCallable 
	// Function /Script/FabricTooltipUI.FabricTooltipWidget.InitTooltip
	// void InitTooltip(class AActor* TargetedActor, class UPrimitiveComponent* TargetedComponent);                             // [0xc23f2c8] Final|Native|Public|BlueprintCallable 
};
