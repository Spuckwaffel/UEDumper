...
public:
	...
	// void OnIsCraftableItemChanged(bool bIsCraftableItem);                                                                    // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/CraftingUI.AthenaCraftingQuickBarButton.OnCanCraftNowChanged
	// void OnCanCraftNowChanged(bool bCanCraftNow);                                                                            // [0x246f7d8] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void HandleWeaponEquipped(class AFortWeapon* NewWeapon, class AFortWeapon* PrevWeapon);                                  // [0xb2c9a7c] Final|Native|Private 
	// Function /Script/CraftingUI.AthenaEquippedItemCraftingIndicator.HandleInventoryActiveChanged
	// void HandleInventoryActiveChanged(bool bInventoryActive);                                                                // [0xb2c9784] Final|Native|Private 
};
...
public:
	...
	// void HandleInventoryItemSelected(class UFortItem* SelectedItem);                                                         // [0xb2c98fc] Final|Native|Private 
};
...
public:
	...
	// void OnIngredientChanged(bool bCanCraftNow);                                                                             // [0x246f7d8] Event|Protected|BlueprintEvent 
	...
	// void HandleWeaponEquipped(class AFortWeapon* NewWeapon, class AFortWeapon* PrevWeapon);                                  // [0xb2c9bbc] Final|Native|Private 
	// Function /Script/CraftingUI.AthenaQuickBarSlotCraftingIndicator.HandleInventoryActiveChanged
	// void HandleInventoryActiveChanged(bool bInventoryActive);                                                                // [0xb2c9840] Final|Native|Private 
};
...
public:
	...
	// void OnIngredientWidgetUpdated(int32_t NumAvailable, int32_t NumRequired, bool bIsPrimaryIngredient, bool bIsLastIngredient); // [0x246f7d8] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void OnCraftingListItemSet();                                                                                            // [0x246f7d8] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void OnFormulaListUpdated(int32_t NumFormulas);                                                                          // [0x246f7d8] Event|Protected|BlueprintEvent 
	// Function /Script/CraftingUI.FortCraftingTab.HandleInventoryItemSelected
	// void HandleInventoryItemSelected(class UFortItem* Item);                                                                 // [0xb2c99bc] Final|Native|Private 
};
...
public:
	...
	// void SetOwningCraftingObject(class ACraftingObjectBGA* InCraftingObject);                                                // [0xb2c9cf0] Final|Native|Public|BlueprintCallable 
};
