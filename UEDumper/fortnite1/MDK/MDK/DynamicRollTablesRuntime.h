...
public:
	...
	// TArray<FFortDynamicRollResult> AuthorityRollChoices(int32_t NumChoices, TArray<UFortItemDefinition*>& IgnoreItems);      // [0xb18499c] Final|BlueprintAuthorityOnly|Native|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// void HandlePlaylistDataReady(class AFortGameStateAthena* GameState, class UFortPlaylist* Playlist, FGameplayTagContainer& PlaylistContextTags); // [0xb18506c] Final|Native|Private|HasOutParms 
};
