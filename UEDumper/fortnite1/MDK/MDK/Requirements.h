...
public:
	...
	// bool IsRequirementMetInternal(FControllerRequirementTestContext& RequestContext);                                        // [0x246f7d8] Event|Protected|HasOutParms|BlueprintCallable|BlueprintEvent|Const 
};
