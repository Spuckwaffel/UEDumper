...
public:
	...
	// void OnRep_TriggeredStrategies();                                                                                        // [0xc838a64] Final|Native|Private 
};
...
public:
	...
	// void Server_UntriggerStrategy(class UClass* StrategyClass);                                                              // [0xc838b54] Net|NetReliableNative|Event|Public|NetServer 
	// Function /Script/JunoLowMemoryFallbackRuntime.JunoLowMemoryFallbackPlayerControllerComponent.Server_TriggerStrategy
	// void Server_TriggerStrategy(class UClass* StrategyClass);                                                                // [0xc838a78] Net|NetReliableNative|Event|Public|NetServer 
};
