...
public:
	...
	// class USubsystem* GetContext(class UObject* ContextObject, class UClass* Class);                                         // [0x2d7c894] Final|BlueprintCosmetic|Native|Static|Public|BlueprintCallable|BlueprintPure 
};
