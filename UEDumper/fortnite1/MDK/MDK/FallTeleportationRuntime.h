...
public:
	...
	// void HandleWarmupCountdownEndTimeUpdated(float NewEndTime);                                                              // [0xb91d8e4] Final|Native|Protected 
	// Function /Script/FallTeleportationRuntime.FortFallTeleportSpawnerComponent.HandleGamePhaseChanged
	// void HandleGamePhaseChanged(FFortGamePhaseUpdatedEvent& Event);                                                          // [0xb91d858] Final|Native|Protected|HasOutParms 
};
...
public:
	...
	// void EnableFallTeleportationIndefinitely();                                                                              // [0x3508bf8] Final|Exec|Native|Private 
};
...
public:
	...
	// void UpdateLastGroundLocation(class ACharacter* Character, TEnumAsByte<EMovementMode> PrevMovementMode, char PreviousCustomMode); // [0xb91db68] Final|Native|Protected 
	// Function /Script/FallTeleportationRuntime.FortFallTeleportComponentBase.IsValidActorToTeleportOn
	// bool IsValidActorToTeleportOn(class AActor* ActorToTeleportOn);                                                          // [0xb91da74] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/FallTeleportationRuntime.FortFallTeleportComponentBase.IsTeleportLocationValid
	// bool IsTeleportLocationValid(FVector& LocationToTest);                                                                   // [0xb91d9a0] Final|Native|Protected|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const 
};
