...
public:
	...
	// void PrepareForPooling();                                                                                                // [0x31d05cc] Native|Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Script/MassActors.MassActorPoolableInterface.PrepareForGame
	// void PrepareForGame();                                                                                                   // [0x760e904] Native|Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Script/MassActors.MassActorPoolableInterface.CanBePooled
	// bool CanBePooled();                                                                                                      // [0x28437e4] Native|Event|Public|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// void OnRep_NetID();                                                                                                      // [0x6cdc234] Native|Public        
	// Function /Script/MassActors.MassAgentComponent.KillEntity
	// void KillEntity(bool bDestroyActor);                                                                                     // [0xaf4c708] Final|Native|Public|BlueprintCallable 
	// Function /Script/MassActors.MassAgentComponent.Enable
	// void Enable();                                                                                                           // [0xaf4c6e4] Final|Native|Public|BlueprintCallable 
	// Function /Script/MassActors.MassAgentComponent.Disable
	// void Disable();                                                                                                          // [0xaf4c6c0] Final|Native|Public|BlueprintCallable 
};
