...
public:
	...
	// void HandleCursorModeChanging(bool bCursorModeEnabled, FName ActionName);                                                // [0xb3fb720] Final|Native|Protected 
};
...
public:
	...
	// void SetQuestScreenVisible(bool bVisible);                                                                               // [0xb3fb884] Final|Native|Protected|BlueprintCallable 
	// Function /Script/SparksCoreUI.SparksQuestScreenContainer.HandleToggleQuestList
	// void HandleToggleQuestList(bool bMapVisible);                                                                            // [0xb3fb884] Final|Native|Protected 
	// Function /Script/SparksCoreUI.SparksQuestScreenContainer.HandleMapPanelExitButtonPressed
	// void HandleMapPanelExitButtonPressed();                                                                                  // [0xb3fb870] Final|Native|Protected|BlueprintCallable 
	// Function /Script/SparksCoreUI.SparksQuestScreenContainer.HandleAthenaScreenDeactivated
	// void HandleAthenaScreenDeactivated();                                                                                    // [0x90cb9ec] Final|Native|Protected 
};
...
public:
	...
	// void OnSongCatalogRetrieved(bool bSuccess);                                                                              // [0xb3fb948] Final|Native|Private 
};
