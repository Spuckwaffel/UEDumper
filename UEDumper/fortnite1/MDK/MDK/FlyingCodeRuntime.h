...
public:
	...
	// void BP_ProcessViewRotation(FRotator& InViewRotation, FRotator& InDeltaRot, float DeltaTime, bool& bOutShouldOverride, FRotator& OutViewRotation, FRotator& OutDeltaRot); // [0x246f7d8] Event|Public|HasOutParms|HasDefaults|BlueprintEvent|Const 
};
...
public:
	...
	// bool CanBeginFlying();                                                                                                   // [0x33dafc8] Native|Event|Public|BlueprintEvent|Const 
};
