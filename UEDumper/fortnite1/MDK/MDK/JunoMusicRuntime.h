...
public:
	...
	// void OnDayNightPhaseChangeSignature(EFortDayPhase CurrentDayPhaseIn, EFortDayPhase PreviousDayPhaseIn, bool bAtCreationIn); // [0xc800b18] Final|Native|Public  
	// Function /Script/JunoMusicRuntime.ActiveJunoMusicPlayer.OnActiveMusicPlayerCooldownFinished
	// void OnActiveMusicPlayerCooldownFinished();                                                                              // [0xc800b00] Final|Native|Public  
	// Function /Script/JunoMusicRuntime.ActiveJunoMusicPlayer.OnActiveMusicElementControllerFinishedPlaying
	// void OnActiveMusicElementControllerFinishedPlaying();                                                                    // [0xc800aec] Final|Native|Public  
};
...
public:
	...
	// void OnFinishedPlaying();                                                                                                // [0x1f11b04] Native|Public        
};
...
public:
	...
	// void RemoveMusicState(FGameplayTag& InState);                                                                            // [0xc800f14] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/JunoMusicRuntime.JunoMusicControllerSubsystem.PushMusicStates
	// void PushMusicStates(FGameplayTagContainer& InStates);                                                                   // [0xc800d9c] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/JunoMusicRuntime.JunoMusicControllerSubsystem.PushMusicState
	// void PushMusicState(FGameplayTag& InState);                                                                              // [0xc800cd4] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/JunoMusicRuntime.JunoMusicControllerSubsystem.GetCollectedString
	// FString GetCollectedString(FName ParameterName, ESetParamResult& Result);                                                // [0xc80071c] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoMusicRuntime.JunoMusicControllerSubsystem.GetCollectedInt
	// int32_t GetCollectedInt(FName ParameterName, ESetParamResult& Result);                                                   // [0xc80039c] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoMusicRuntime.JunoMusicControllerSubsystem.GetCollectedFloat
	// float GetCollectedFloat(FName ParameterName, ESetParamResult& Result);                                                   // [0xc80001c] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoMusicRuntime.JunoMusicControllerSubsystem.GetCollectedBool
	// bool GetCollectedBool(FName ParameterName, ESetParamResult& Result);                                                     // [0xc7ffcb8] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void BP_OnUpdate(float DeltaSeconds, class UMetasoundParameterPack* AggregatedData);                                     // [0x246f7d8] Event|Public|BlueprintEvent 
	// Function /Script/JunoMusicRuntime.JunoMusicDataCollector.BP_OnUnregistered
	// void BP_OnUnregistered();                                                                                                // [0x246f7d8] Event|Public|BlueprintEvent 
	// Function /Script/JunoMusicRuntime.JunoMusicDataCollector.BP_OnRegistered
	// void BP_OnRegistered(class UMetasoundParameterPack* AggregatedData);                                                     // [0x246f7d8] Event|Public|BlueprintEvent 
};
...
public:
	...
	// void SetThreatLevelMultiplier(float InThreatLevelMultiplier);                                                            // [0xc80138c] Final|Native|Protected|BlueprintCallable 
};
...
public:
	...
	// void StopWorldMusicSystem(class UWorld* World);                                                                          // [0xc80150c] Final|Native|Public|BlueprintCallable 
	// Function /Script/JunoMusicRuntime.JunoMusicManager.StartWorldMusicSystem
	// void StartWorldMusicSystem(class UWorld* World);                                                                         // [0xc80144c] Final|Native|Public|BlueprintCallable 
	// Function /Script/JunoMusicRuntime.JunoMusicManager.SetSuspendWorldActiveMusicPlayback
	// void SetSuspendWorldActiveMusicPlayback(class UWorld* World, bool bSuspendPlayback, bool bStopCurrentlyPlayingMusic);    // [0xc8011c0] Final|Native|Public|BlueprintCallable 
	// Function /Script/JunoMusicRuntime.JunoMusicManager.SetSuspendActiveMusicPlayback
	// void SetSuspendActiveMusicPlayback(bool bSuspendPlayback, bool bStopCurrentlyPlayingMusic);                              // [0xc801070] Final|Native|Public|BlueprintCallable 
	// Function /Script/JunoMusicRuntime.JunoMusicManager.SetActiveJunoMusicManagerData
	// void SetActiveJunoMusicManagerData(FActiveJunoMusicManagerData& ActiveJunoMusicManagerDataIn);                           // [0xc800fdc] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/JunoMusicRuntime.JunoMusicManager.RemoveJunoMusicPlaylist
	// void RemoveJunoMusicPlaylist(class UJunoMusicPlaylistDataAsset* JunoMusicPlaylist);                                      // [0xc800e54] Final|Native|Public|BlueprintCallable 
	// Function /Script/JunoMusicRuntime.JunoMusicManager.GetCollectedString
	// FString GetCollectedString(class UObject* WorldContextObject, FName ParameterName, ESetParamResult& Result);             // [0xc800878] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoMusicRuntime.JunoMusicManager.GetCollectedInt
	// int32_t GetCollectedInt(class UObject* WorldContextObject, FName ParameterName, ESetParamResult& Result);                // [0xc8004d0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoMusicRuntime.JunoMusicManager.GetCollectedFloat
	// float GetCollectedFloat(class UObject* WorldContextObject, FName ParameterName, ESetParamResult& Result);                // [0xc80014c] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoMusicRuntime.JunoMusicManager.GetCollectedBool
	// bool GetCollectedBool(class UObject* WorldContextObject, FName ParameterName, ESetParamResult& Result);                  // [0xc7ffdd0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoMusicRuntime.JunoMusicManager.AddJunoMusicPlaylist
	// void AddJunoMusicPlaylist(class UJunoMusicPlaylistDataAsset* JunoMusicPlaylist);                                         // [0xc7ffb3c] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// bool BP_ShouldPlay();                                                                                                    // [0x342a54c] Native|Event|Public|BlueprintEvent 
	...
	// void BP_OnRegistered();                                                                                                  // [0x246f7d8] Event|Public|BlueprintEvent 
};
...
public:
	...
	// void BP_OnUpdate(float DeltaSeconds);                                                                                    // [0x246f7d8] Event|Public|BlueprintEvent 
...
public:
	...
	// void CacheFortPlayerPawn(class AFortPawn* NewPawn);                                                                      // [0xc7ffbfc] Final|Native|Private 
};
