...
public:
	...
	// TArray<FVector> GetCurvedPath(TArray<FVector>& ControlPoints, int32_t NumSegments);                                      // [0xc687b40] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// void JunoSpawnCreature(FString CreatureName, int32_t Count);                                                             // [0x8b18b40] Final|Exec|Native|Public|Const 
};
