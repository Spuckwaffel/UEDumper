...
public:
	...
	DMember(float)                                     RezInMaterialEffectTimeLine2_NewTrack_0_EE684F644FE38B4A30D17FB8CF917357 OFFSET(get<float>, {0x7C0, 4, 0, 0})
	CMember(TEnumAsByte<ETimelineDirection>)           RezInMaterialEffectTimeLine2__Direction_EE684F644FE38B4A30D17FB8CF917357 OFFSET(get<T>, {0x7C4, 1, 0, 0})
	CMember(class UTimelineComponent*)                 RezInMaterialEffectTimeLine2                                OFFSET(get<T>, {0x7C8, 8, 0, 0})
	DMember(float)                                     RezInMaterialEffectTimeLine_NewTrack_0_9C89220943F4EBA1DF12D38A05B1FC5C OFFSET(get<float>, {0x7D0, 4, 0, 0})
	CMember(TEnumAsByte<ETimelineDirection>)           RezInMaterialEffectTimeLine__Direction_9C89220943F4EBA1DF12D38A05B1FC5C OFFSET(get<T>, {0x7D4, 1, 0, 0})
	...
	// void ExecuteUbergraph_B_SparksOnActorPreviewDefault(int32_t EntryPoint);                                                 // [0x246f7d8] Final|HasDefaults    
};
...
public:
	...
	// void FixupMeshAndMaterials(class USkeletalMeshComponent* MeshComponent, class USkeletalMesh* NewMesh, class UMaterialInstance* Material1, class UMaterialInstance* Material2, class UFXSystemAsset* FX); // [0x246f7d8] Public|BlueprintCallable|BlueprintEvent 
	// Function /SparksCosmetics/FrontendPreview/B_SparksCosmeticPreviewDisplay.B_SparksCosmeticPreviewDisplay_C.Hide all
	// void Hide all();                                                                                                         // [0x246f7d8] Public|BlueprintCallable|BlueprintEvent 
	...
	// void CustomizePreviewInstance(class UFortItemDefinition* InItemDefinition);                                              // [0x246f7d8] Event|Public|BlueprintEvent 
	...
	// void ExecuteUbergraph_B_SparksCosmeticPreviewDisplay(int32_t EntryPoint);                                                // [0x246f7d8] Final|HasDefaults    
	...
	// void NewEventDispatcher__DelegateSignature();                                                                            // [0x246f7d8] Public|Delegate|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// void Timeline__PlayResIn__EventFunc();                                                                                   // [0x246f7d8] BlueprintEvent       
	...
	// void Timeline__LoadingFXOutro__EventFunc();                                                                              // [0x246f7d8] BlueprintEvent       
	// Function /SparksCosmetics/FrontendPreview/B_SparksOffActorPreview.B_SparksOffActorPreview_C.Timeline__ShowPawn__EventFunc
	// void Timeline__ShowPawn__EventFunc();                                                                                    // [0x246f7d8] BlueprintEvent       
	...
	// void ExecuteUbergraph_B_SparksOffActorPreview(int32_t EntryPoint);                                                       // [0x246f7d8] Final                
};

/// Class /SparksCosmetics/FrontendPreview/SongItemPreview.SongItemPreview_C
/// Size: 0x00AA (0x000488 - 0x000532)
class ASongItemPreview_C : public AFortItemPreviewOffPawnActor
{ 
	friend MDKHandler;
	static inline constexpr uint64_t __MDKClassSize = 1330;

public:
	SMember(FPointerToUberGraphFrame)                  UberGraphFrame                                              OFFSET(getStruct<T>, {0x488, 8, 0, 0})
	CMember(class UStaticMeshComponent*)               StageLight3                                                 OFFSET(get<T>, {0x490, 8, 0, 0})
	CMember(class UStaticMeshComponent*)               StageLight2                                                 OFFSET(get<T>, {0x498, 8, 0, 0})
	CMember(class UStaticMeshComponent*)               AlbumCover_StageLights                                      OFFSET(get<T>, {0x4A0, 8, 0, 0})
	CMember(class UStaticMeshComponent*)               SM_AlbumCover                                               OFFSET(get<T>, {0x4A8, 8, 0, 0})
	CMember(class USkyLightComponent*)                 SkyLightLowMobile                                           OFFSET(get<T>, {0x4B0, 8, 0, 0})
	CMember(class UArrowComponent*)                    Arrow                                                       OFFSET(get<T>, {0x4B8, 8, 0, 0})
	CMember(class UDirectionalLightComponent*)         DirectionalLightMobile                                      OFFSET(get<T>, {0x4C0, 8, 0, 0})
	CMember(class USpotLightComponent*)                KeyLight6                                                   OFFSET(get<T>, {0x4C8, 8, 0, 0})
	CMember(class USpotLightComponent*)                KeyLigh3                                                    OFFSET(get<T>, {0x4D0, 8, 0, 0})
	CMember(class USpotLightComponent*)                KeyLight2                                                   OFFSET(get<T>, {0x4D8, 8, 0, 0})
	CMember(class USpotLightComponent*)                RimLowerRight1                                              OFFSET(get<T>, {0x4E0, 8, 0, 0})
	CMember(class USpotLightComponent*)                RimLeft1                                                    OFFSET(get<T>, {0x4E8, 8, 0, 0})
	CMember(class USpotLightComponent*)                KeyLight5                                                   OFFSET(get<T>, {0x4F0, 8, 0, 0})
	CMember(class USpotLightComponent*)                RimBottomLeft1                                              OFFSET(get<T>, {0x4F8, 8, 0, 0})
	CMember(class USpotLightComponent*)                Bounce1                                                     OFFSET(get<T>, {0x500, 8, 0, 0})
	CMember(class USpotLightComponent*)                BounceRear1                                                 OFFSET(get<T>, {0x508, 8, 0, 0})
	CMember(class USpotLightComponent*)                RimTopRight1                                                OFFSET(get<T>, {0x510, 8, 0, 0})
	CMember(class USceneComponent*)                    Scene_Lighting                                              OFFSET(get<T>, {0x518, 8, 0, 0})
	DMember(float)                                     Timeline_LErp_440FD4D745E0E071C641BAB46D630F85              OFFSET(get<float>, {0x520, 4, 0, 0})
	CMember(TEnumAsByte<ETimelineDirection>)           Timeline__Direction_440FD4D745E0E071C641BAB46D630F85        OFFSET(get<T>, {0x524, 1, 0, 0})
	CMember(class UTimelineComponent*)                 Timeline                                                    OFFSET(get<T>, {0x528, 8, 0, 0})
	DMember(bool)                                      IsActive                                                    OFFSET(get<bool>, {0x530, 1, 0, 0})
	DMember(bool)                                      AlwaysOn                                                    OFFSET(get<bool>, {0x531, 1, 0, 0})
	...
	// void ExecuteUbergraph_SongItemPreview(int32_t EntryPoint);                                                               // [0x246f7d8] Final                
};
...
public:
	...
	// FTransform GetFrameTargetTransform();                                                                                    // [0x246f7d8] Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /SparksCosmetics/FrontendPreview/B_SparksSong_PreviewDisplay.B_SparksSong_PreviewDisplay_C.GetFrameTargetBounds
	// FBoxSphereBounds GetFrameTargetBounds();                                                                                 // [0x246f7d8] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /SparksCosmetics/FrontendPreview/B_SparksSong_PreviewDisplay.B_SparksSong_PreviewDisplay_C.PerformSpecialAction
	// void PerformSpecialAction(FName ActionName);                                                                             // [0x246f7d8] Event|Public|BlueprintCallable|BlueprintEvent 
	...
	// void DebounceEvent();                                                                                                    // [0x246f7d8] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_B_SparksSong_PreviewDisplay(int32_t EntryPoint);                                                   // [0x246f7d8] Final|HasDefaults    
};
