...
public:
	...
	// void SetStartLogicAutomatically(bool bInStartLogicAutomatically);                                                        // [0x83dbc74] Final|Native|Public|BlueprintCallable 
	// Function /Script/GameplayStateTreeModule.StateTreeComponent.SendStateTreeEvent
	// void SendStateTreeEvent(FStateTreeEvent& Event);                                                                         // [0x83dbb88] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/GameplayStateTreeModule.StateTreeComponent.GetStateTreeRunStatus
	// EStateTreeRunStatus GetStateTreeRunStatus();                                                                             // [0x83dbb64] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
