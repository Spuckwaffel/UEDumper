...
public:
	...
	// class UFortSoundCueTemplateDefaults* GetSettingsForTemplateType(class UClass* TemplateType);                             // [0xcc810a0] Final|Native|Public  
};
...
public:
	...
	// class UFortSoundCueTemplateDefaults* GetDefaultSettingsForTemplateType(class UClass* TemplateType);                      // [0xcc80f9c] Final|Native|Public|Const 
};
