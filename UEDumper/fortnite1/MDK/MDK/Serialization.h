...
public:
	...
	SMember(FVector)                                   Vector                                                      OFFSET(getStruct<T>, {0x38, 24, 0, 0})
	SMember(FVector4)                                  Vector4                                                     OFFSET(getStruct<T>, {0x50, 32, 0, 0})
	SMember(FRotator)                                  Rotator                                                     OFFSET(getStruct<T>, {0x70, 24, 0, 0})
	SMember(FQuat)                                     Quat                                                        OFFSET(getStruct<T>, {0x90, 32, 0, 0})
	SMember(FColor)                                    Color                                                       OFFSET(getStruct<T>, {0xB0, 4, 0, 0})
};
...
public:
	...
	SMember(FStructSerializerBuiltinTestStruct)        Builtins                                                    OFFSET(getStruct<T>, {0xE0, 192, 0, 0})
	SMember(FStructSerializerArrayTestStruct)          Arrays                                                      OFFSET(getStruct<T>, {0x1A0, 96, 0, 0})
	SMember(FStructSerializerMapTestStruct)            Maps                                                        OFFSET(getStruct<T>, {0x200, 320, 0, 0})
	SMember(FStructSerializerSetTestStruct)            Sets                                                        OFFSET(getStruct<T>, {0x340, 320, 0, 0})
	SMember(FStructSerializerLWCTypesTest)             LWCTypes                                                    OFFSET(getStruct<T>, {0x480, 864, 0, 0})
};
