...
public:
	...
	// void TriggerAccolade(FString AccoladeName);                                                                              // [0x6b78618] Final|BlueprintAuthorityOnly|Exec|Native|Private 
	// Function /Script/AccoladesRuntime.FortCheatManager_Accolades.ResetAccoladeData
	// void ResetAccoladeData();                                                                                                // [0x3508bf8] Final|BlueprintAuthorityOnly|Exec|Native|Private 
};
...
public:
	...
	// void ServerPinAccolade(FName AccoladeName);                                                                              // [0xafd9464] Final|Net|NetReliableNative|Event|Private|NetServer 
	// Function /Script/AccoladesRuntime.FortControllerComponent_AccoladeCollection.ServerMarkAccoladesAsSeen
	// void ServerMarkAccoladesAsSeen(TArray<FName> AccoladeNames);                                                             // [0x92529e4] Final|Net|NetReliableNative|Event|Private|NetServer 
	// Function /Script/AccoladesRuntime.FortControllerComponent_AccoladeCollection.HandlePlayerProfileInitialized
	// void HandlePlayerProfileInitialized();                                                                                   // [0xafd9418] Final|Native|Private 
	// Function /Script/AccoladesRuntime.FortControllerComponent_AccoladeCollection.HandlePinnedQuestChanged
	// void HandlePinnedQuestChanged(FAthenaPinnedQuestData& PinnedQuestData);                                                  // [0xafd938c] Final|Native|Private|HasOutParms 
	// Function /Script/AccoladesRuntime.FortControllerComponent_AccoladeCollection.ClientResetAccoladeData
	// void ClientResetAccoladeData();                                                                                          // [0x875f0a8] Final|Net|NetReliableNative|Event|Private|NetClient 
};
