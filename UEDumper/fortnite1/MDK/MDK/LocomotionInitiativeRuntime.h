...
public:
	...
	// void ApplyTo(FFortLocomotionLayerMaskDataSet& DataAsset);                                                                // [0xb99baf8] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
};

/// Class /Script/LocomotionInitiativeRuntime.FortPlayerMotionMatchingLocomotionAnimInstance
/// Size: 0x0440 (0x001530 - 0x001970)
...
public:
	SMember(FVector)                                   FutureRootMotionVelocity                                    OFFSET(getStruct<T>, {0x1528, 24, 0, 0})
	SMember(FMotionMatchingLODConfig)                  HighEndConfig                                               OFFSET(getStruct<T>, {0x1540, 56, 0, 0})
	SMember(FMotionMatchingLODConfig)                  LowEndConfig                                                OFFSET(getStruct<T>, {0x1578, 56, 0, 0})
	SMember(FMotionMatchingLODConfig)                  CurrentLODConfig                                            OFFSET(getStruct<T>, {0x15B0, 56, 0, 0})
	CMember(class UAnimSequence*)                      SelectedIdleBreak                                           OFFSET(get<T>, {0x15E8, 8, 0, 0})
	CMember(class UProxyAsset*)                        MotionMatchingLODProxyAsset                                 OFFSET(get<T>, {0x15F0, 8, 0, 0})
	DMember(int32_t)                                   MotionMatchingLOD                                           OFFSET(get<int32_t>, {0x15F8, 4, 0, 0})
	SMember(FMotionMatchingBlendInfo)                  MotionMatchingBlendInfo                                     OFFSET(getStruct<T>, {0x15FC, 8, 0, 0})
	CMember(class UClass*)                             StopBranchOutWindowNotifyClass                              OFFSET(get<T>, {0x1608, 8, 0, 0})
	CMember(EFortMotionMatchingLocomotionState)        LocomotionState                                             OFFSET(get<T>, {0x1610, 1, 0, 0})
	DMember(float)                                     StartToLoopSearchDelaySeconds                               OFFSET(get<float>, {0x1614, 4, 0, 0})
	DMember(float)                                     PivotToLoopSearchDelaySeconds                               OFFSET(get<float>, {0x1618, 4, 0, 0})
	DMember(float)                                     PivotSpeedThreshold                                         OFFSET(get<float>, {0x161C, 4, 0, 0})
	DMember(float)                                     PivotDotProductThresholdRun                                 OFFSET(get<float>, {0x1620, 4, 0, 0})
	DMember(float)                                     DiagonalDetectionThreshold                                  OFFSET(get<float>, {0x1624, 4, 0, 0})
	DMember(float)                                     PivotDotProductThresholdWalk                                OFFSET(get<float>, {0x1628, 4, 0, 0})
	DMember(float)                                     LocomotionStateTime                                         OFFSET(get<float>, {0x162C, 4, 0, 0})
	DMember(float)                                     VelocityDirection                                           OFFSET(get<float>, {0x1630, 4, 0, 0})
	DMember(float)                                     MotionMatchingWeight                                        OFFSET(get<float>, {0x1634, 4, 0, 0})
	CMember(EPoseSearchInterruptMode)                  DatabaseSearchInterruptMode                                 OFFSET(get<T>, {0x1638, 1, 0, 0})
	DMember(bool)                                      bUseOrientationWarping                                      OFFSET(get<bool>, {0x1639, 1, 0, 0})
	DMember(bool)                                      bUseFutureForOrientationWarping                             OFFSET(get<bool>, {0x163A, 1, 0, 0})
	DMember(bool)                                      bIsLowEnd                                                   OFFSET(get<bool>, {0x163B, 1, 0, 0})
	DMember(bool)                                      bUseLocomotionBlendspace                                    OFFSET(get<bool>, {0x163C, 1, 0, 0})
	DMember(bool)                                      bShouldPlayIdle                                             OFFSET(get<bool>, {0x163D, 1, 0, 0})
	DMember(bool)                                      bShouldPlayIdleBreak                                        OFFSET(get<bool>, {0x163E, 1, 0, 0})
	DMember(bool)                                      bShouldExitIdleBreak                                        OFFSET(get<bool>, {0x163F, 1, 0, 0})
	DMember(bool)                                      bShouldExitIdleBreakSlow                                    OFFSET(get<bool>, {0x1640, 1, 0, 0})
	DMember(float)                                     IdleTransitionTimer                                         OFFSET(get<float>, {0x1644, 4, 0, 0})
	DMember(float)                                     IdleBreakTimer                                              OFFSET(get<float>, {0x1648, 4, 0, 0})
	DMember(bool)                                      bBothHandsIKInHandSpace                                     OFFSET(get<bool>, {0x164C, 1, 0, 0})
	DMember(bool)                                      bIsCrouchedTransition                                       OFFSET(get<bool>, {0x164D, 1, 0, 0})
	DMember(bool)                                      bWasCrouching                                               OFFSET(get<bool>, {0x164E, 1, 0, 0})
	DMember(bool)                                      bShouldPlayStandToCrouchTransition                          OFFSET(get<bool>, {0x164F, 1, 0, 0})
	DMember(bool)                                      bShouldPlayCrouchToStandTransition                          OFFSET(get<bool>, {0x1650, 1, 0, 0})
	DMember(bool)                                      bShouldExitCrouchTransition                                 OFFSET(get<bool>, {0x1651, 1, 0, 0})
	DMember(bool)                                      bIsLocallyControlled                                        OFFSET(get<bool>, {0x1652, 1, 0, 0})
	DMember(float)                                     CameraSpamYawThreshold                                      OFFSET(get<float>, {0x1654, 4, 0, 0})
	DMember(float)                                     CameraSpamCoolDownSeconds                                   OFFSET(get<float>, {0x1658, 4, 0, 0})
	DMember(float)                                     CameraSpamSearchThrottleTime                                OFFSET(get<float>, {0x165C, 4, 0, 0})
	DMember(float)                                     DefaultSearchThrottleTime                                   OFFSET(get<float>, {0x1660, 4, 0, 0})
	DMember(float)                                     SearchThrottleTime                                          OFFSET(get<float>, {0x1664, 4, 0, 0})
	DMember(float)                                     AdditiveLeanAlpha                                           OFFSET(get<float>, {0x1668, 4, 0, 0})
	DMember(bool)                                      bEnableAdditiveLeans                                        OFFSET(get<bool>, {0x166C, 1, 0, 0})
	DMember(bool)                                      bEnableAdditiveRunLeans                                     OFFSET(get<bool>, {0x166D, 1, 0, 0})
	DMember(bool)                                      bDisableArcs                                                OFFSET(get<bool>, {0x166E, 1, 0, 0})
	DMember(bool)                                      bDisableDiamonds                                            OFFSET(get<bool>, {0x166F, 1, 0, 0})
	DMember(bool)                                      bIdleToMotionMatchingNoInertialization                      OFFSET(get<bool>, {0x1670, 1, 0, 0})
	DMember(bool)                                      bRelaxedStateChanged                                        OFFSET(get<bool>, {0x1671, 1, 0, 0})
	DMember(bool)                                      bIsMelee                                                    OFFSET(get<bool>, {0x1672, 1, 0, 0})
	DMember(bool)                                      bUseRelaxedMotionMatchingData                               OFFSET(get<bool>, {0x1673, 1, 0, 0})
	SMember(FPoseSearchQueryTrajectory)                Trajectory                                                  OFFSET(getStruct<T>, {0x1678, 16, 0, 0})
	SMember(FTrajectorySamplingData)                   TrajectorySamplingData                                      OFFSET(getStruct<T>, {0x1688, 32, 0, 0})
	SMember(FCharacterTrajectoryData)                  CharacterTrajectoryData                                     OFFSET(getStruct<T>, {0x16B0, 480, 0, 0})
	DMember(float)                                     TrajectorySpeedMultiplier                                   OFFSET(get<float>, {0x1890, 4, 0, 0})
	DMember(float)                                     LowFrictionCustomMaxSpeed                                   OFFSET(get<float>, {0x1894, 4, 0, 0})
	DMember(float)                                     LowFrictionCustomBrakingDeceleration                        OFFSET(get<float>, {0x1898, 4, 0, 0})
	DMember(float)                                     LowFrictionCustomFriction                                   OFFSET(get<float>, {0x189C, 4, 0, 0})
	SMember(FFortMotionMatchingAngleSpamTracker)       AccelerationSpamTracker                                     OFFSET(getStruct<T>, {0x18A0, 72, 0, 0})
	DMember(bool)                                      bIsPlayingIdleBreak                                         OFFSET(get<bool>, {0x195B, 1, 0, 0})
	DMember(bool)                                      bIsPlayingInterruptibleStop                                 OFFSET(get<bool>, {0x1968, 1, 0, 0})
	DMember(bool)                                      bIsPlayingIdleDatabase                                      OFFSET(get<bool>, {0x1969, 1, 0, 0})
	DMember(bool)                                      bHasReachedIdle                                             OFFSET(get<bool>, {0x196A, 1, 0, 0})


	/// Functions
	// Function /Script/LocomotionInitiativeRuntime.FortPlayerMotionMatchingLocomotionAnimInstance.OnUpdateMotionMatchingState
	// void OnUpdateMotionMatchingState(FAnimUpdateContext& Context, FAnimNodeReference& Node);                                 // [0x1cb6af8] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/LocomotionInitiativeRuntime.FortPlayerMotionMatchingLocomotionAnimInstance.OnUpdateMotionMatching
	// void OnUpdateMotionMatching(FAnimUpdateContext& Context, FAnimNodeReference& Node);                                      // [0x1cb6e30] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/LocomotionInitiativeRuntime.FortPlayerMotionMatchingLocomotionAnimInstance.OnUpdateIdleBreaks
	// void OnUpdateIdleBreaks(FAnimUpdateContext& Context, FAnimNodeReference& Node);                                          // [0x2df1c00] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/LocomotionInitiativeRuntime.FortPlayerMotionMatchingLocomotionAnimInstance.GetMotionMatchingBlendProfile
	// class UBlendProfile* GetMotionMatchingBlendProfile();                                                                    // [0x2a0ad68] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
