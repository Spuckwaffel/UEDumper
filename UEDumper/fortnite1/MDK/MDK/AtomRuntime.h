...
public:
	...
	// void SetName(FAtomModelPartsCollection& PartsCollection, FString Name);                                                  // [0xbc84bf0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AtomRuntime.AtomPartsCollectionBlueprintLibrary.ReplacePartInstance
	// void ReplacePartInstance(FAtomModelPartsCollection& PartCollection, FAtomModelPartInstanceInfo& SourcePartInstance, FAtomModelPartGuid& TargetPartInstanceId); // [0xbc8439c] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AtomRuntime.AtomPartsCollectionBlueprintLibrary.RemovePartInstance
	// void RemovePartInstance(FAtomModelPartsCollection& PartCollection, FAtomModelPartGuid& PartInstanceId);                  // [0xbc84288] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AtomRuntime.AtomPartsCollectionBlueprintLibrary.InitializeCommonParts
	// FAtomModelPartsCollection InitializeCommonParts(FAtomModelPartsCollection& PartsCollection, class UAtomModel* Model, float Scale, bool bRemoveConnectedParts, bool bRemoveAllKnobs, bool bRemoveAllTubes, bool bRemoveAllPins); // [0xbc83c30] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AtomRuntime.AtomPartsCollectionBlueprintLibrary.GetPrimitiveCommonParts
	// TArray<FAtomCommonPartAndTransform> GetPrimitiveCommonParts(class UAtomPrimitive* Primitive, double Scale);              // [0xbc83884] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/AtomRuntime.AtomPartsCollectionBlueprintLibrary.GetParts
	// TArray<FAtomModelPartInstanceInfo> GetParts(FAtomModelPartsCollection& PartsCollection);                                 // [0xbc837bc] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/AtomRuntime.AtomPartsCollectionBlueprintLibrary.GetName
	// FString GetName(FAtomModelPartsCollection& PartsCollection);                                                             // [0xbc82f94] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/AtomRuntime.AtomPartsCollectionBlueprintLibrary.GetModelPartGuidHash
	// int32_t GetModelPartGuidHash(FAtomModelPartGuid& InModelPartGuid);                                                       // [0xbc82ed4] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/AtomRuntime.AtomPartsCollectionBlueprintLibrary.FilterTransparent
	// FAtomModelPartsCollection FilterTransparent(FAtomModelPartsCollection& PartsCollectionToFilter, FString NewPartsCollectionName); // [0xbc82080] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/AtomRuntime.AtomPartsCollectionBlueprintLibrary.FilterSelectionSet
	// FAtomModelPartsCollection FilterSelectionSet(FAtomModelPartsCollection& PartsCollectionToFilter, FString SelectionSetName, FString NewPartsCollectionName); // [0xbc817e4] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/AtomRuntime.AtomPartsCollectionBlueprintLibrary.FilterNonTransparent
	// FAtomModelPartsCollection FilterNonTransparent(FAtomModelPartsCollection& PartsCollectionToFilter, FString NewPartsCollectionName); // [0xbc8105c] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/AtomRuntime.AtomPartsCollectionBlueprintLibrary.FilterGroup
	// FAtomModelPartsCollection FilterGroup(class UAtomModel* Model, FAtomModelPartsCollection& PartsCollectionToFilter, FString GroupName, FString NewPartsCollectionName); // [0xbc80758] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/AtomRuntime.AtomPartsCollectionBlueprintLibrary.CreateColorInfoFromColorId
	// FAtomModelPartColorInfo CreateColorInfoFromColorId(int32_t ColorId);                                                     // [0xbc805d4] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/AtomRuntime.AtomPartsCollectionBlueprintLibrary.Conv_StringToModelPartGuid
	// FAtomModelPartGuid Conv_StringToModelPartGuid(FString InString);                                                         // [0xbc7f780] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/AtomRuntime.AtomPartsCollectionBlueprintLibrary.Conv_ModelPartGuidToString
	// FString Conv_ModelPartGuidToString(FAtomModelPartGuid& InModelPartGuid);                                                 // [0xbc7f6cc] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/AtomRuntime.AtomPartsCollectionBlueprintLibrary.AddPartInstance
	// void AddPartInstance(FAtomModelPartsCollection& PartCollection, FAtomModelPartInstanceInfo& PartInstance);               // [0xbc7e8ac] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// float GetDefaultPrimitiveScale();                                                                                        // [0xbc82e70] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class UStaticMesh* ToSimplifiedStaticMesh(float Scale, class UObject* Outer, FString Name, bool bFastBuild);             // [0xbc85560] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AtomRuntime.AtomPrimitiveGeometry.SplitByPolygonGroup
	// TArray<UAtomPrimitiveGeometry*> SplitByPolygonGroup();                                                                   // [0xbc854f4] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AtomRuntime.AtomPrimitiveGeometry.SetVertexColor
	// class UAtomPrimitiveGeometry* SetVertexColor(FColor& Color);                                                             // [0xbc85420] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/AtomRuntime.AtomPrimitiveGeometry.SetTiledUVs
	// class UAtomPrimitiveGeometry* SetTiledUVs(float TileSize);                                                               // [0xbc85350] Final|Native|Public|BlueprintCallable 
	// Function /Script/AtomRuntime.AtomPrimitiveGeometry.SetMaterialName
	// class UAtomPrimitiveGeometry* SetMaterialName(FString Name, int32_t PolygonGroupIndex);                                  // [0xbc84518] Final|Native|Public|BlueprintCallable 
	// Function /Script/AtomRuntime.AtomPrimitiveGeometry.GetNumberOfCommonPartLODs
	// int32_t GetNumberOfCommonPartLODs(FString ExportStyleName, EAtomCommonPartType CommonPartType, FString CommonPartsMeshPath); // [0xbc83070] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/AtomRuntime.AtomPrimitiveGeometry.GetMaterialNames
	// TArray<FString> GetMaterialNames();                                                                                      // [0xbc82e98] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AtomRuntime.AtomPrimitiveGeometry.GetBoneIndexForName
	// int32_t GetBoneIndexForName(FString BoneName);                                                                           // [0xbc82808] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AtomRuntime.AtomPrimitiveGeometry.DuplicateGeometry
	// class UAtomPrimitiveGeometry* DuplicateGeometry();                                                                       // [0xbc8071c] Final|Native|Public|BlueprintCallable|Const 
	// Function /Script/AtomRuntime.AtomPrimitiveGeometry.CreateEmptyAtomGeometry
	// class UAtomPrimitiveGeometry* CreateEmptyAtomGeometry();                                                                 // [0xbc806c8] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/AtomRuntime.AtomPrimitiveGeometry.CreateAtomGeometryFromCommonPart
	// class UAtomPrimitiveGeometry* CreateAtomGeometryFromCommonPart(FString ExportStyleName, EAtomCommonPartType CommonPartType, int32_t LODIndex, FString CommonPartsMeshPath); // [0xbc7fe14] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/AtomRuntime.AtomPrimitiveGeometry.BakeTransforms
	// class UAtomPrimitiveGeometry* BakeTransforms(TArray<FTransform3f>& Transforms);                                          // [0xbc7f620] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AtomRuntime.AtomPrimitiveGeometry.BakeTransform
	// class UAtomPrimitiveGeometry* BakeTransform(FTransform3f& Transform);                                                    // [0xbc7f554] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/AtomRuntime.AtomPrimitiveGeometry.BakeScale
	// class UAtomPrimitiveGeometry* BakeScale(float Scale);                                                                    // [0xbc7f484] Final|Native|Public|BlueprintCallable 
	// Function /Script/AtomRuntime.AtomPrimitiveGeometry.AttachVerticesToNamedBone
	// void AttachVerticesToNamedBone(FString BoneName);                                                                        // [0xbc7ee14] Final|Native|Public|BlueprintCallable 
	// Function /Script/AtomRuntime.AtomPrimitiveGeometry.AttachVerticesToBoneIndex
	// void AttachVerticesToBoneIndex(int32_t BoneIndex);                                                                       // [0xbc7ed54] Final|Native|Public|BlueprintCallable 
	// Function /Script/AtomRuntime.AtomPrimitiveGeometry.AppendAndWeld
	// class UAtomPrimitiveGeometry* AppendAndWeld(class UAtomPrimitiveGeometry* GeometryToAppend, FTransform3f& Transform);    // [0xbc7eb70] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/AtomRuntime.AtomPrimitiveGeometry.Append
	// class UAtomPrimitiveGeometry* Append(class UAtomPrimitiveGeometry* GeometryToAppend, FTransform3f& Transform);           // [0xbc7e9dc] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
};
...
public:
	...
	// FAtomPrimitiveCollisionGeometry MakePrimitiveCollisionGeometry(float Scale);                                             // [0xbc8a01c] Final|Native|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/AtomRuntime.AtomPrimitiveGeometryContainer.HasCollisionGeometry
	// bool HasCollisionGeometry();                                                                                             // [0xbc89ff8] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AtomRuntime.AtomPrimitiveGeometryContainer.GetShellGeometry
	// FAtomPrimitiveGeometryAndTransform GetShellGeometry();                                                                   // [0xbc89cfc] Final|Native|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/AtomRuntime.AtomPrimitiveGeometryContainer.GetScaledShellGeometry
	// FAtomPrimitiveGeometryAndTransform GetScaledShellGeometry(float Scale);                                                  // [0xbc89c08] Final|Native|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/AtomRuntime.AtomPrimitiveGeometryContainer.GetScaledGeometry
	// class UAtomPrimitiveGeometry* GetScaledGeometry(EPrimitiveGeometryComplexity PrimitiveGeometryComplexity, float Scale);  // [0xbc89ab8] Final|Native|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/AtomRuntime.AtomPrimitiveGeometryContainer.GetScaledDetailsGeometry
	// TArray<FAtomPrimitiveGeometryAndTransform> GetScaledDetailsGeometry(float Scale);                                        // [0xbc899d0] Final|Native|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/AtomRuntime.AtomPrimitiveGeometryContainer.GetScaledCollisionGeometry
	// TArray<FAtomPrimitiveGeometryAndTransform> GetScaledCollisionGeometry(float Scale);                                      // [0xbc898e8] Final|Native|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/AtomRuntime.AtomPrimitiveGeometryContainer.GetScaledCapsGeometry
	// TArray<FAtomPrimitiveGeometryAndTransform> GetScaledCapsGeometry(float Scale);                                           // [0xbc89800] Final|Native|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/AtomRuntime.AtomPrimitiveGeometryContainer.GetPartsGeometry
	// TArray<FAtomPrimitiveGeometryAndTransform> GetPartsGeometry();                                                           // [0xbc89540] Final|Native|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/AtomRuntime.AtomPrimitiveGeometryContainer.GetLOD
	// int32_t GetLOD();                                                                                                        // [0x6940844] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AtomRuntime.AtomPrimitiveGeometryContainer.GetGeometryWithMaterialNames
	// class UAtomPrimitiveGeometry* GetGeometryWithMaterialNames(EPrimitiveGeometryComplexity PrimitiveGeometryComplexity, FString ShellMaterial, FString UndersideMaterial); // [0xbc88a28] Final|Native|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/AtomRuntime.AtomPrimitiveGeometryContainer.GetGeometry
	// class UAtomPrimitiveGeometry* GetGeometry(EPrimitiveGeometryComplexity PrimitiveGeometryComplexity);                     // [0xbc88958] Final|Native|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/AtomRuntime.AtomPrimitiveGeometryContainer.GetExportStyleName
	// FString GetExportStyleName();                                                                                            // [0xad3c7bc] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AtomRuntime.AtomPrimitiveGeometryContainer.GetDetailsGeometry
	// TArray<FAtomPrimitiveGeometryAndTransform> GetDetailsGeometry();                                                         // [0xbc88798] Final|Native|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/AtomRuntime.AtomPrimitiveGeometryContainer.GetDefaultBoneTransforms
	// TArray<FTransform> GetDefaultBoneTransforms(float Scale);                                                                // [0xbc886b4] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AtomRuntime.AtomPrimitiveGeometryContainer.GetCollisionGeometry
	// TArray<FAtomPrimitiveGeometryAndTransform> GetCollisionGeometry();                                                       // [0xbc87bdc] Final|Native|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/AtomRuntime.AtomPrimitiveGeometryContainer.GetCapsGeometry
	// TArray<FAtomPrimitiveGeometryAndTransform> GetCapsGeometry();                                                            // [0xbc8793c] Final|Native|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// FAtomColorInfo GetInfoForColorId(int32_t ColorId);                                                                       // [0xbc8918c] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/AtomRuntime.AtomRuntimeBlueprintLibrary.GetCommonPartDescriptionFromType
	// void GetCommonPartDescriptionFromType(EAtomCommonPartType CommonPartType, FAtomCommonPartDescription& OutDescription);   // [0xbc87eb8] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/AtomRuntime.AtomRuntimeBlueprintLibrary.GetCommonPartCategoryFromType
	// EAtomCommonPartCategory GetCommonPartCategoryFromType(EAtomCommonPartType CommonPartType);                               // [0xbc87df8] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/AtomRuntime.AtomRuntimeBlueprintLibrary.GetCommonPartAssetDescriptionFromStaticMesh
	// void GetCommonPartAssetDescriptionFromStaticMesh(class UStaticMesh* StaticMesh, FAtomCommonPartAssetDescription& OutDescription, EGetCommonPartDescriptionResult& OutIsValid); // [0xbc87c3c] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AtomRuntime.AtomRuntimeBlueprintLibrary.GetBitPackForColorId
	// int32_t GetBitPackForColorId(int32_t AtomColorId);                                                                       // [0xbc87844] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/AtomRuntime.AtomRuntimeBlueprintLibrary.GetBitPackForColor
	// int32_t GetBitPackForColor(FColor& Color);                                                                               // [0xbc87770] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/AtomRuntime.AtomRuntimeBlueprintLibrary.GetAllColorInfo
	// TMap<int32_t, FAtomColorInfo> GetAllColorInfo();                                                                         // [0xbc8760c] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// class UDataTable* GetColorDataTable();                                                                                   // [0xbc87c18] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void UnregisterConnectivityActor(class AActor* Actor);                                                                   // [0xbc8b188] Final|Native|Public|BlueprintCallable 
	// Function /Script/AtomRuntime.WorldConnectivitySubsystem.TryConnectObjectAtLocation
	// bool TryConnectObjectAtLocation(FWorldConnectivityHandle ObjectToConnect, FTransform& DesiredObjectTransform, TArray<FWorldConnectivityHandle>& ConnectionCandidates, bool PerformConnection); // [0xbc8a928] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/AtomRuntime.WorldConnectivitySubsystem.RunPlanarConnectivityQuery
	// TArray<FConnectivityQueryResult> RunPlanarConnectivityQuery(class AActor* AtomModelActorToPlace, class AActor* AtomModelActorToConnect, FVector& QueryStartLocation, FVector& QueryEndLocation, TEnumAsByte<ECollisionChannel> QueryCollisionChannel, int32_t QueryRadius); // [0xbc8a3c0] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/AtomRuntime.WorldConnectivitySubsystem.RegisterModelActor
	// void RegisterModelActor(class AActor* Actor, FSerializedConnectivityObjects& Connections);                               // [0xbc8a290] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AtomRuntime.WorldConnectivitySubsystem.RegisterCustomConnectivityActor
	// void RegisterCustomConnectivityActor(class AActor* Actor, FSerializedConnectivityObjects& ConnectivityObject);           // [0xbc8a290] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AtomRuntime.WorldConnectivitySubsystem.RegisterConnectivityActor
	// void RegisterConnectivityActor(class AActor* Actor, class UAtomModel* Model);                                            // [0xbc8a134] Final|Native|Public|BlueprintCallable 
	// Function /Script/AtomRuntime.WorldConnectivitySubsystem.PlanarGridStepSize
	// double PlanarGridStepSize();                                                                                             // [0xbc8a114] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AtomRuntime.WorldConnectivitySubsystem.GetTransform
	// FTransform GetTransform(FWorldConnectivityHandle Handle);                                                                // [0xbc89efc] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AtomRuntime.WorldConnectivitySubsystem.GetPlanarFields
	// TArray<FPlanarFieldInfo> GetPlanarFields(FWorldConnectivityHandle Handle, EConnectionFieldGender Type);                  // [0xbc89658] Final|Native|Public|BlueprintCallable 
	// Function /Script/AtomRuntime.WorldConnectivitySubsystem.GetPlanarFieldCenter
	// FVector GetPlanarFieldCenter(FPlanarFieldInfo& Field);                                                                   // [0xbc8957c] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/AtomRuntime.WorldConnectivitySubsystem.GetOverlapPenetrationDepth
	// FVector GetOverlapPenetrationDepth(class AStaticMeshActor* Actor1, class AStaticMeshActor* Actor2, FVector Offset);      // [0xbc89278] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/AtomRuntime.WorldConnectivitySubsystem.GetConnectivityHandles
	// TArray<FWorldConnectivityHandle> GetConnectivityHandles(class AActor* Actor);                                            // [0xbc88430] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AtomRuntime.WorldConnectivitySubsystem.GetConnectivityHandle
	// FWorldConnectivityHandle GetConnectivityHandle(class AActor* Actor);                                                     // [0xbc881bc] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AtomRuntime.WorldConnectivitySubsystem.GetConnectedObjectsRecursively
	// TArray<FWorldConnectivityHandle> GetConnectedObjectsRecursively(FWorldConnectivityHandle Object);                        // [0xbc880d4] Final|Native|Public|BlueprintCallable 
	// Function /Script/AtomRuntime.WorldConnectivitySubsystem.GetConnectedObjects
	// TArray<FWorldConnectivityHandle> GetConnectedObjects(FWorldConnectivityHandle Object);                                   // [0xbc87fec] Final|Native|Public|BlueprintCallable 
	// Function /Script/AtomRuntime.WorldConnectivitySubsystem.GetClosestFieldToPoint
	// FPlanarFieldInfo GetClosestFieldToPoint(FWorldConnectivityHandle Handle, FVector& WorldLocation, EConnectionFieldGender Type, bool& bSuccess); // [0xbc87978] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/AtomRuntime.WorldConnectivitySubsystem.GetAtomModelAssetUserData
	// class UAtomModelAssetUserData* GetAtomModelAssetUserData(class UObject* Object);                                         // [0xbc876b0] Final|Native|Public|BlueprintCallable 
	// Function /Script/AtomRuntime.WorldConnectivitySubsystem.GetActor
	// class AActor* GetActor(FWorldConnectivityHandle Handle);                                                                 // [0xbc8753c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AtomRuntime.WorldConnectivitySubsystem.DisconnectObjects
	// void DisconnectObjects(FWorldConnectivityHandle ObjectA, FWorldConnectivityHandle ObjectB);                              // [0xbc872ac] Final|Native|Public|BlueprintCallable 
	// Function /Script/AtomRuntime.WorldConnectivitySubsystem.DisconnectAllObjectConnections
	// void DisconnectAllObjectConnections(FWorldConnectivityHandle Object);                                                    // [0xbc871ec] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// bool IsValid(FWorldConnectivityHandle& Handle);                                                                          // [0xaa91058] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/AtomRuntime.WorldConnectivityBlueprintLibrary.GetTransform
	// FTransform GetTransform(class UObject* WorldContext, FWorldConnectivityHandle& Handle);                                  // [0xbc89d6c] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/AtomRuntime.WorldConnectivityBlueprintLibrary.GetFieldCenter
	// FVector GetFieldCenter(class UObject* WorldContext, FPlanarFieldInfo& Field);                                            // [0xbc887d4] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/AtomRuntime.WorldConnectivityBlueprintLibrary.GetActor
	// class AActor* GetActor(class UObject* WorldContext, FWorldConnectivityHandle& Handle);                                   // [0xbc87408] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class UTexture* GetTextureForDecorationTextureName(FString TextureName);                                                 // [0xbcb14e8] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AtomRuntime.AtomModel.GetPrimitivesForChildArray
	// void GetPrimitivesForChildArray(int32_t InChildIdx, TArray<FAtomModelPrimitiveInstance>& OutPrimitives);                 // [0xbcb0cbc] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AtomRuntime.AtomModel.GetPartsCollection
	// FAtomModelPartsCollection GetPartsCollection();                                                                          // [0xbcb0c58] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AtomRuntime.AtomModel.GetModelPath
	// FString GetModelPath();                                                                                                  // [0xbcb0afc] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AtomRuntime.AtomModel.GetModelName
	// FString GetModelName();                                                                                                  // [0xbcb0abc] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AtomRuntime.AtomModel.GetGeneratedMergedMeshes
	// TArray<TWeakObjectPtr<UStaticMesh*>> GetGeneratedMergedMeshes();                                                         // [0xbcb0064] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AtomRuntime.AtomModel.GetChildIdentifier
	// FString GetChildIdentifier(int32_t InChildIdx);                                                                          // [0xbcafa14] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// FAtomProcessorResult OnProcessPrimitive(class UAtomModel* DummyModel, class UAtomPrimitive* Primitive, FAtomModelPartsCollection& AtomModelPartsCollection, FAtomOnProcessPrimitiveSettings& Settings); // [0x246f7d8] Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/AtomRuntime.AtomModelProcessor.OnProcessModel
	// FAtomProcessorResult OnProcessModel(class UAtomModel* Model, FAtomModelPartsCollection& AtomModelPartsCollection, TArray<TWeakObjectPtr<UObject*>>& ExistingObjects); // [0x246f7d8] Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/AtomRuntime.AtomModelProcessor.OnGetTargetAssetPath
	// FString OnGetTargetAssetPath(class UAtomModel* Model, class UAtomPrimitive* Primitive, FAtomModelPartsCollection& AtomModelPartsCollection); // [0x246f7d8] Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/AtomRuntime.AtomModelProcessor.OnGetProcessPrimitiveTargetAssetPath
	// FString OnGetProcessPrimitiveTargetAssetPath(class UAtomModel* Model, class UAtomPrimitive* Primitive, FAtomModelPartsCollection& AtomModelPartsCollection, FAtomOnProcessPrimitiveSettings& Settings); // [0x246f7d8] Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/AtomRuntime.AtomModelProcessor.OnGetProcessModelTargetAssetPath
	// FString OnGetProcessModelTargetAssetPath(class UAtomModel* Model, FAtomModelPartsCollection& AtomModelPartsCollection);  // [0x246f7d8] Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/AtomRuntime.AtomModelProcessor.IncrementProgress
	// void IncrementProgress(int32_t NumSteps, FString Message);                                                               // [0xbcb1b50] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void SetModelProcessor(FAtomModelProcessorInstance& ProcessorInstance, class UAtomModelProcessor* ModelProcessor, bool bUseCustomSettings); // [0xbcb235c] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AtomRuntime.AtomProcessorBlueprintLibrary.IsValid
	// bool IsValid(FAtomModelProcessorInstance& ProcessorInstance);                                                            // [0xbcb2290] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AtomRuntime.AtomProcessorBlueprintLibrary.GetProcessorClass
	// class UClass* GetProcessorClass(FAtomModelProcessorInstance& ProcessorInstance);                                         // [0xbcb1350] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AtomRuntime.AtomProcessorBlueprintLibrary.GetModelProcessor
	// class UAtomModelProcessor* GetModelProcessor(FAtomModelProcessorInstance& ProcessorInstance);                            // [0xbcb0b60] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AtomRuntime.AtomProcessorBlueprintLibrary.AppendAtomProcessorResult
	// FAtomProcessorResult AppendAtomProcessorResult(FAtomProcessorResult& Result, FAtomProcessorResult& ResultToAppend);      // [0xbcaf788] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// bool IsFlexElement();                                                                                                    // [0xbcb227c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AtomRuntime.AtomPrimitive.GetSubMainGroupName
	// FName GetSubMainGroupName(int32_t SubMainGroupId);                                                                       // [0xbcb1424] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/AtomRuntime.AtomPrimitive.GetMainGroupName
	// FName GetMainGroupName(int32_t MainGroupId);                                                                             // [0xbcb09f8] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/AtomRuntime.AtomPrimitive.GetGeometryContainerForExportStyle
	// class UAtomPrimitiveGeometryContainer* GetGeometryContainerForExportStyle(FString ExportStyleName, FString FallbackExportStyleName, int32_t LODIndex); // [0xbcb0294] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AtomRuntime.AtomPrimitive.GetGeometryContainerForBestExportStyle
	// class UAtomPrimitiveGeometryContainer* GetGeometryContainerForBestExportStyle(TArray<FString>& GeometryStylePriorityList, int32_t LODIndex); // [0xbcb00f0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AtomRuntime.AtomPrimitive.GetBounds
	// FBoxSphereBounds GetBounds(float Scale);                                                                                 // [0xbcaf920] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
};
