...
public:
	...
	// void RemoveSelfFromCameraManager();                                                                                      // [0xb1d1304] Final|Native|Protected 
	// Function /Script/GrappleParentRuntime.FortCameraModifier_Swinging.CalculateDynamicMultipliers
	// void CalculateDynamicMultipliers(float& OutFOVBoundsMultiplier, float& OutBoostOffsetMultiplier);                        // [0xb1d1018] Native|Event|Protected|HasOutParms|BlueprintEvent|Const 
};
...
public:
	...
	// void GetPlayerAnglesFromAttachPoint(float& pitch, float& Roll, float& Yaw);                                              // [0xb1d11dc] Final|Native|Public|HasOutParms 
	// Function /Script/GrappleParentRuntime.FortSwingingLayerAnimInstance.GetAttachVectorInPlayerSpace
	// FVector GetAttachVectorInPlayerSpace(FVector& InPlayerToAttachPoint);                                                    // [0xb1d10f8] Final|Native|Public|HasOutParms|HasDefaults 
};
