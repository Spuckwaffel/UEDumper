...
public:
	...
	// FTransform GetOffsetRootTransform(FAnimNodeReference& Node);                                                             // [0xcdeb060] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/AnimationWarpingRuntime.AnimationWarpingLibrary.GetCurveValueFromAnimation
	// bool GetCurveValueFromAnimation(class UAnimSequenceBase* Animation, FName CurveName, float Time, float& OutValue);       // [0xcdeadb0] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
};
