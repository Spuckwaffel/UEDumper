...
public:
	...
	// void SetImagePlate(FImagePlateParameters Plate);                                                                         // [0xca89b94] Final|Native|Public|BlueprintCallable 
	// Function /Script/ImagePlate.ImagePlateComponent.OnRenderTextureChanged
	// void OnRenderTextureChanged();                                                                                           // [0xca89b80] Final|Native|Public  
	// Function /Script/ImagePlate.ImagePlateComponent.GetPlate
	// FImagePlateParameters GetPlate();                                                                                        // [0xca89b08] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
