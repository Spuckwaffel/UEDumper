...
namespace ImGui
{
    ...
    IMGUI_API void          SameLineEx(float spacing, float spacingy = 0.f);  // call between widgets or groups to layout them horizontally. X position given in window coordinates.
