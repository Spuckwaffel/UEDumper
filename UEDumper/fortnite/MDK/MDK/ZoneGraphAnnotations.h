...
public:
	...
	// void Trigger();                                                                                                          // [0xb2a5a18] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void TriggerDanger(class UObject* WorldContextObject, class AActor* Instigator, FVector Position, float Radius, float duration); // [0xb2a5a74] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
};
