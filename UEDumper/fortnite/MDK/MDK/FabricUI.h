...
public:
	...
	// void SetScreenGridDimensions(FVector2D& InNewDimensions);                                                                // [0xc6b74ec] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/FabricUI.FabricScreenWidget.AttachFabricWidget
	// class UFabricWidget* AttachFabricWidget(class UClass*& FabricWidgetClass, FVector2D& GridPosition);                      // [0xc6b7348] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
};
...
public:
	...
	// class UFabricInteractableViewModel* GetFabricViewModel();                                                                // [0xc6b742c] Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
};
...
public:
	...
	// void SetShouldSuscribeToSignificanceSubsystem(bool ShouldSuscribe);                                                      // [0xc6b7580] Final|Native|Public|BlueprintCallable 
	// Function /Script/FabricUI.FabricWidgetComponent.GetTickMode
	// ETickMode GetTickMode();                                                                                                 // [0xc6b7454] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void UnregisterFabricWidgetComponent(class UFabricWidgetComponent* WidgetComponent);                                     // [0xc6b7600] Final|Native|Public|BlueprintCallable 
	// Function /Script/FabricUI.FabricWidgetTickControlSubsystem.RegisterFabricWidgetComponent
	// void RegisterFabricWidgetComponent(class UFabricWidgetComponent* WidgetComponent);                                       // [0xc6b746c] Final|Native|Public|BlueprintCallable 
};
