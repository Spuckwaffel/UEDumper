...
public:
	...
	// void HookUpVoiceIcon(class UFortVoiceChatStatusIcon* Icon, class AFortPlayerStateAthena* Player);                        // [0xbbaebd0] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// int32_t GetTotalXP();                                                                                                    // [0xbbaeb88] Final|Native|Private|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/PilgrimCoreUI.PilgrimPostGameProgressWidget.GetMatchXP
	// int32_t GetMatchXP();                                                                                                    // [0xbbae9d8] Final|Native|Private|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void InitializeForLanes(int32_t NewNumLanes, TArray<UFortInputMappingContext*>& InputMappingContexts);                   // [0xbbaee08] Final|Native|Private|HasOutParms|BlueprintCallable 
	// Function /Script/PilgrimCoreUI.PilgrimPresetSwitcher.GetSelectedItems
	// void GetSelectedItems(int32_t& OutSelectedLaneNum, int32_t& OutSelectedIndex);                                           // [0xbbaea20] Final|Native|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// void Initialize(class APlayerController* InOwningController, FGameplayTagContainer& InSortTags, FGameplayTagContainer& InFilterTags); // [0xbbaec94] Final|Native|Public|HasOutParms|BlueprintCallable 
};
