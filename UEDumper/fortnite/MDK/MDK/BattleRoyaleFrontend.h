...
public:
	...
	// void HandleVideoTerminalError(EBaseMediaTerminalErrorReason Reason);                                                     // [0xb662ab4] Final|Native|Private 
	// Function /Script/BattleRoyaleFrontend.BattleRoyaleFrontendExperienceFlow.HandleSeasonTrailerEnded
	// void HandleSeasonTrailerEnded();                                                                                         // [0xb662aa0] Final|Native|Private 
	// Function /Script/BattleRoyaleFrontend.BattleRoyaleFrontendExperienceFlow.FinishTrailerStep
	// void FinishTrailerStep();                                                                                                // [0xb662a8c] Final|Native|Private 
};
