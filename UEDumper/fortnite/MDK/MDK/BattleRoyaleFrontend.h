...
public:
	...
	// void HandleVideoTerminalError(EBaseMediaTerminalErrorReason Reason);                                                     // [0xbbca478] Final|Native|Private 
	// Function /Script/BattleRoyaleFrontend.BattleRoyaleFrontendExperienceFlow.HandleSeasonTrailerEnded
	// void HandleSeasonTrailerEnded();                                                                                         // [0xbbca464] Final|Native|Private 
	// Function /Script/BattleRoyaleFrontend.BattleRoyaleFrontendExperienceFlow.FinishTrailerStep
	// void FinishTrailerStep();                                                                                                // [0xbbca450] Final|Native|Private 
};
