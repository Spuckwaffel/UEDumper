...
public:
	...
	// void UpdateSimSettings();                                                                                                // [0xb358f9c] Final|Native|Public|BlueprintCallable 
	// Function /Script/REVRuntime.REVComponent.UpdateParameters
	// void UpdateParameters(float InPitch, float InRPM, float InThrottle, float InVelocity, int32_t InGear, bool bInEnableShifting); // [0x303670c] Final|Native|Public|BlueprintCallable 
	// Function /Script/REVRuntime.REVComponent.SetSettings
	// void SetSettings(class URevSettings* InSettings);                                                                        // [0xb358ef4] Final|Native|Public|BlueprintCallable 
	// Function /Script/REVRuntime.REVComponent.SetRevModel
	// void SetRevModel(class UREVModel* InModel);                                                                              // [0x202ac80] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void UpdateSettings();                                                                                                   // [0xb358f88] Final|BlueprintCosmetic|Native|Public|BlueprintCallable 
};
