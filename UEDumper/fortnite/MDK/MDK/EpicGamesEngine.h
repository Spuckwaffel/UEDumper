...
public:
	...
	// void ServerTriggerAxis(FName AxisName, float Value);                                                                     // [0xb1c0940] Final|Net|NetReliableNative|Event|Private|NetServer|NetValidate 
	// Function /Script/EpicGamesEngine.VerseUEInputComponentBase.ServerTriggerAction
	// void ServerTriggerAction(FName ActionName, TEnumAsByte<EInputEvent> InputEvent);                                         // [0xb1c0738] Final|Net|NetReliableNative|Event|Private|NetServer|NetValidate 
};
