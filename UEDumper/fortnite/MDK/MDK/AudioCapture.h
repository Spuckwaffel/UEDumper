...
public:
	...
	// void StopCapturingAudio();                                                                                               // [0xb633a6c] Final|Native|Public|BlueprintCallable 
	// Function /Script/AudioCapture.AudioCapture.StartCapturingAudio
	// void StartCapturingAudio();                                                                                              // [0xb633a38] Final|Native|Public|BlueprintCallable 
	// Function /Script/AudioCapture.AudioCapture.IsCapturingAudio
	// bool IsCapturingAudio();                                                                                                 // [0xb633a00] Final|Native|Public|BlueprintCallable 
	// Function /Script/AudioCapture.AudioCapture.GetAudioCaptureDeviceInfo
	// bool GetAudioCaptureDeviceInfo(FAudioCaptureDeviceInfo& OutInfo);                                                        // [0xb63388c] Final|Native|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// class UAudioCapture* CreateAudioCapture();                                                                               // [0xb633828] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// void GetAvailableAudioInputDevices(class UObject* WorldContextObject, FDelegateProperty& OnObtainDevicesEvent);          // [0xb633928] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AudioCapture.AudioCaptureBlueprintLibrary.Conv_AudioInputDeviceInfoToString
	// FString Conv_AudioInputDeviceInfoToString(FAudioInputDeviceInfo& Info);                                                  // [0xb63372c] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
};
