...
public:
	...
	// void ServerRequestServerTime(double requestUtcTime);                                                                     // [0x8597818] Net|NetReliableNative|Event|Public|NetServer|BlueprintCallable 
	// Function /Script/EpicMediaUtilities.EpicMediaServerTime.GetTimeUtc
	// bool GetTimeUtc(FDateTime& OutDateTime);                                                                                 // [0x8597780] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/EpicMediaUtilities.EpicMediaServerTime.ClientReportServerTime
	// void ClientReportServerTime(double requestUtcTime, double serverUtcTime);                                                // [0x85976a8] Net|NetReliableNative|Event|Public|NetClient 
};
