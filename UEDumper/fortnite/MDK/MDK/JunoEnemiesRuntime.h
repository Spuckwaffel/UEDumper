...
public:
	...
	// TArray<FVector> GetCurvedPath(TArray<FVector>& ControlPoints, int32_t NumSegments);                                      // [0xcb0f834] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// void JunoSpawnCreature(FString CreatureName, int32_t Count);                                                             // [0x8de03e4] Final|Exec|Native|Public|Const 
};
