...
public:
	...
	// void GetBallisticShieldData(EBallisticShieldPlayerActionState& BallisticShieldPlayerState, float& StaggerBuildupPercent); // [0xb567aec] Native|Event|Public|HasOutParms|BlueprintEvent 
};
