...
public:
	...
	// void DelMarResetNux();                                                                                                   // [0x35cf850] Final|Exec|Native|Protected 
	// Function /Script/DelMarFrontend.DelMarFrontendCheatManager.DelMarMarkTutorialPlayed
	// void DelMarMarkTutorialPlayed();                                                                                         // [0x35cf850] Final|Exec|Native|Protected 
};
...
public:
	...
	// void HandleVideoTerminalError(EBaseMediaTerminalErrorReason Reason);                                                     // [0xcace32c] Final|Native|Protected 
	// Function /Script/DelMarFrontend.DelMarFrontendExperienceFlow.FinishTrailerStep
	// void FinishTrailerStep();                                                                                                // [0xcace2e8] Final|Native|Protected 
};
...
public:
	...
	// class UDelMarFrontendRuntimeOptions* GetDelMarFrontendRuntimeOptions();                                                  // [0xcace2fc] Final|RequiredAPI|Native|Static|Public|BlueprintCallable|BlueprintPure 
};
