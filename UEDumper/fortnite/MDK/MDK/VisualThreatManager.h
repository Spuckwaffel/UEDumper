...
public:
	...
	// void OnWindImpulseCylinderDeath(FFortWindImpulseCylinder& WindImpulseCylinder);                                          // [0x20c3f9c] Event|Public|HasOutParms|BlueprintEvent 
	// Function /Game/VisualThreatManager/WindManager.WindManager_C.OnWindImpulseCylinderDeltaComplete
	// void OnWindImpulseCylinderDeltaComplete(FFortWindImpulseCylinder& WindImpulseCylinder);                                  // [0x20c3f9c] Event|Public|HasOutParms|BlueprintEvent 
	// Function /Game/VisualThreatManager/WindManager.WindManager_C.OnWindImpulseCylinderCreation
	// void OnWindImpulseCylinderCreation(FFortWindImpulseCylinder& WindImpulseCylinder, FFortWindImpulseCylinderDelta& WindImpulseCylinderDelta); // [0x20c3f9c] Event|Public|HasOutParms|BlueprintEvent 
	// Function /Game/VisualThreatManager/WindManager.WindManager_C.SpawnTestWind
	// void SpawnTestWind(double Radius, double ImpulseMagnitude);                                                              // [0x20c3f9c] BlueprintCallable|BlueprintEvent 
	// Function /Game/VisualThreatManager/WindManager.WindManager_C.Play Water Splash Particle System At Location
	// void Play Water Splash Particle System At Location(FTransform Particle Transform);                                       // [0x20c3f9c] BlueprintCallable|BlueprintEvent 
	// Function /Game/VisualThreatManager/WindManager.WindManager_C.AddWindParticleSystemComponent
	// void AddWindParticleSystemComponent(class UParticleSystemComponent* ParticleSystemComponent);                            // [0x20c3f9c] Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/VisualThreatManager/WindManager.WindManager_C.Register player for render to texture purposes
	// void Register player for render to texture purposes(class UPrimitiveComponent* Effect Water Interaction FX, class UPrimitiveComponent* Gameplay Wind INteraction Effects); // [0x20c3f9c] BlueprintCallable|BlueprintEvent 
	// Function /Game/VisualThreatManager/WindManager.WindManager_C.Add Wind Component
	// void Add Wind Component(class UPrimitiveComponent* InComponent);                                                         // [0x20c3f9c] BlueprintCallable|BlueprintEvent 
	...
	// void Update Test(double NewMagnitude);                                                                                   // [0x20c3f9c] BlueprintCallable|BlueprintEvent 
	// Function /Game/VisualThreatManager/WindManager.WindManager_C.Add Render To Texture Particle
	// void Add Render To Texture Particle(class UParticleSystem* EmitterTemplate, FTransform& InTransform);                    // [0x20c3f9c] HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /Game/VisualThreatManager/WindManager.WindManager_C.ExecuteUbergraph_WindManager
	// void ExecuteUbergraph_WindManager(int32_t EntryPoint);                                                                   // [0x20c3f9c] Final|HasDefaults    
};
...
public:
	...
	// void SetForceOff(bool bForceOff);                                                                                        // [0x20c3f9c] Public|BlueprintCallable|BlueprintEvent 
	...
	// void CalculatePlayerPositionNearBox(FVector BoxMin, FVector BoxMax, double& VolumePlayerCoveragePercentage);             // [0x20c3f9c] Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void Ramp Up down values on death__FinishedFunc();                                                                       // [0x20c3f9c] BlueprintEvent       
	...
	// void Ramp Up down values on death__UpdateFunc();                                                                         // [0x20c3f9c] BlueprintEvent       
	...
	// void OnThreatCloudsChanged(TArray<FThreatLocationInfo>& ThreatLocationInfo);                                             // [0x20c3f9c] Event|Public|HasOutParms|BlueprintEvent 
	...
	// void OnWorldReady();                                                                                                     // [0x20c3f9c] Event|Protected|BlueprintEvent 
	...
	// void VFX_RainTracePeriodic();                                                                                            // [0x20c3f9c] BlueprintCallable|BlueprintEvent 
	...
	// void StartTraceTimer();                                                                                                  // [0x20c3f9c] BlueprintCallable|BlueprintEvent 
	...
	// void ForceUpdateLensEffect();                                                                                            // [0x20c3f9c] BlueprintCallable|BlueprintEvent 
	...
	// void OnThreatOverrideChanged(bool bForceThreatOn);                                                                       // [0x20c3f9c] Event|Public|BlueprintEvent 
	...
	// void ExecuteUbergraph_ThreatPostProcessManagerAndParticleBlueprint(int32_t EntryPoint);                                  // [0x20c3f9c] Final|HasDefaults    
	...
	// void NewEventDispatcher0__DelegateSignature();                                                                           // [0x20c3f9c] Public|Delegate|BlueprintCallable|BlueprintEvent 
...
public:
	...
	// void ExecuteUbergraph_B_CameraRainDrops_01(int32_t EntryPoint);                                                          // [0x20c3f9c] Final                
};
