...
public:
	...
	// void HandleInventoryChanged(TArray<UFortItem*>& AddedItems, TArray<UFortItem*>& RemovedItems);                           // [0xc646590] Final|Native|Protected|HasOutParms 
};
...
public:
	...
	// void HandleInventoryChanged(TArray<UFortItem*>& AddedItems, TArray<UFortItem*>& RemovedItems);                           // [0xc6466a4] Final|Native|Protected|HasOutParms 
	// Function /Script/JunoPowerSystemRuntime.JunoPowerCenter.GetPowerConsumptionAmount
	// float GetPowerConsumptionAmount();                                                                                       // [0xc646554] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoPowerSystemRuntime.JunoPowerCenter.GetPowerCapacityPercent
	// float GetPowerCapacityPercent();                                                                                         // [0xc646504] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoPowerSystemRuntime.JunoPowerCenter.GetMaxPowerCapacity
	// float GetMaxPowerCapacity();                                                                                             // [0xc64649c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoPowerSystemRuntime.JunoPowerCenter.GetCurrentPowerItemGUID
	// FGuid GetCurrentPowerItemGUID();                                                                                         // [0xc646480] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoPowerSystemRuntime.JunoPowerCenter.GetCurrentPowerCapacity
	// float GetCurrentPowerCapacity();                                                                                         // [0xc6463bc] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void RemovePowerChannel(FGameplayTag Channel);                                                                           // [0xc646a0c] Final|Native|Public|BlueprintCallable 
	// Function /Script/JunoPowerSystemRuntime.JunoPowerConsumerComponent.RegisterPowerConsumer
	// void RegisterPowerConsumer(FGameplayTagContainer Channels);                                                              // [0xc64690c] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/JunoPowerSystemRuntime.JunoPowerConsumerComponent.OnDetached
	// void OnDetached();                                                                                                       // [0xc64687c] Final|Native|Private 
	// Function /Script/JunoPowerSystemRuntime.JunoPowerConsumerComponent.OnAttached
	// void OnAttached(FGraphIslandHandle& IslandHandle);                                                                       // [0xc6467dc] Final|Native|Private|HasOutParms 
	// Function /Script/JunoPowerSystemRuntime.JunoPowerConsumerComponent.HasPower
	// bool HasPower();                                                                                                         // [0xc6467b8] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/JunoPowerSystemRuntime.JunoPowerConsumerComponent.ConsumePower
	// bool ConsumePower();                                                                                                     // [0xc646320] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/JunoPowerSystemRuntime.JunoPowerConsumerComponent.AddPowerChannel
	// void AddPowerChannel(FGameplayTag Channel);                                                                              // [0xc646260] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void OnStopConsumingPower__DelegateSignature();                                                                          // [0x186becc] MulticastDelegate|Public|Delegate 
	// Function /Script/JunoPowerSystemRuntime.JunoPowerManagerComponent.OnStartConsumingPower__DelegateSignature
	// void OnStartConsumingPower__DelegateSignature();                                                                         // [0x186becc] MulticastDelegate|Public|Delegate 
	// Function /Script/JunoPowerSystemRuntime.JunoPowerManagerComponent.OnRep_IsConsumingPower
	// void OnRep_IsConsumingPower();                                                                                           // [0xc6468a4] Final|Native|Private 
	// Function /Script/JunoPowerSystemRuntime.JunoPowerManagerComponent.OnRep_AttachedPowerCenters
	// void OnRep_AttachedPowerCenters();                                                                                       // [0xc646890] Final|Native|Private 
	// Function /Script/JunoPowerSystemRuntime.JunoPowerManagerComponent.GetRemainingPowerItemsCount
	// int32_t GetRemainingPowerItemsCount();                                                                                   // [0xc64656c] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoPowerSystemRuntime.JunoPowerManagerComponent.GetPowerCenterInUse
	// class AJunoPowerCenter* GetPowerCenterInUse();                                                                           // [0xc64652c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoPowerSystemRuntime.JunoPowerManagerComponent.GetMaxPowerItemsCount
	// int32_t GetMaxPowerItemsCount();                                                                                         // [0x653b32c] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoPowerSystemRuntime.JunoPowerManagerComponent.GetMaxPowerItemDurability
	// float GetMaxPowerItemDurability();                                                                                       // [0xc6464dc] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoPowerSystemRuntime.JunoPowerManagerComponent.GetMaxPowerCapacity
	// float GetMaxPowerCapacity();                                                                                             // [0xc6464c4] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoPowerSystemRuntime.JunoPowerManagerComponent.GetCurrentPowerItemDurability
	// float GetCurrentPowerItemDurability();                                                                                   // [0xc646458] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoPowerSystemRuntime.JunoPowerManagerComponent.GetCurrentPowerItem
	// class UFortWorldItem* GetCurrentPowerItem();                                                                             // [0xc646434] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoPowerSystemRuntime.JunoPowerManagerComponent.GetCurrentPowerCapacityPercent
	// float GetCurrentPowerCapacityPercent();                                                                                  // [0xc64640c] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoPowerSystemRuntime.JunoPowerManagerComponent.GetCurrentPowerCapacity
	// float GetCurrentPowerCapacity();                                                                                         // [0xc6463e4] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoPowerSystemRuntime.JunoPowerManagerComponent.GetAttachedPowerConsumerInfo
	// TArray<FConsumerChannelPowerInfo> GetAttachedPowerConsumerInfo();                                                        // [0xc646344] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
