...
public:
	...
	// void UpdateNearbyBuildingActors();                                                                                       // [0xcad8754] Final|Native|Private 
	// Function /Script/MilkshakeRuntime.MilkshakeControllerComponent.UnregisterEarthquake
	// void UnregisterEarthquake(class AMilkshakeEarthquakeActor* Earthquake);                                                  // [0xcad86d4] Final|Native|Public|BlueprintCallable 
	// Function /Script/MilkshakeRuntime.MilkshakeControllerComponent.SpawnBuildingDamageFX
	// void SpawnBuildingDamageFX();                                                                                            // [0xcad8644] Final|Native|Private 
	// Function /Script/MilkshakeRuntime.MilkshakeControllerComponent.RegisterEarthquake
	// void RegisterEarthquake(class AMilkshakeEarthquakeActor* Earthquake);                                                    // [0xcad8544] Final|Native|Public|BlueprintCallable 
	// Function /Script/MilkshakeRuntime.MilkshakeControllerComponent.PlayForceFeedback
	// void PlayForceFeedback();                                                                                                // [0xcad8530] Final|Native|Private 
};
...
public:
	...
	// void TickEarthquakePhysicsActorForces(float DeltaSeconds);                                                               // [0xcad8658] Final|BlueprintAuthorityOnly|Native|Protected|BlueprintCallable 
	// Function /Script/MilkshakeRuntime.MilkshakeEarthquakeActor.RemoveNullsFromAsyncOverlappedActors
	// void RemoveNullsFromAsyncOverlappedActors();                                                                             // [0x35cf850] Final|BlueprintAuthorityOnly|Native|Protected|BlueprintCallable 
	// Function /Script/MilkshakeRuntime.MilkshakeEarthquakeActor.RemoveAsyncOverlappedActorsOutsideRadius
	// void RemoveAsyncOverlappedActorsOutsideRadius();                                                                         // [0x35cf850] Final|BlueprintAuthorityOnly|Native|Protected|BlueprintCallable 
	// Function /Script/MilkshakeRuntime.MilkshakeEarthquakeActor.OnActorRemovedFromAsyncOverlappedActors
	// void OnActorRemovedFromAsyncOverlappedActors(class AActor* RemovedActor);                                                // [0x20c3f9c] Event|Protected|BlueprintEvent 
	// Function /Script/MilkshakeRuntime.MilkshakeEarthquakeActor.GetRadius
	// float GetRadius();                                                                                                       // [0x20c3f9c] Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /Script/MilkshakeRuntime.MilkshakeEarthquakeActor.GetNormalizedMagnitudeAtLocation
	// float GetNormalizedMagnitudeAtLocation(FVector Location);                                                                // [0x20c3f9c] Event|Public|HasDefaults|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// void SetStrength(float InStrength);                                                                                      // [0xcad85c4] Final|BlueprintCosmetic|Native|Public|BlueprintCallable 
};
