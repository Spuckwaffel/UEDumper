...
public:
	...
	// FGameplayAttribute GetGameplayAttributeForClass(class UClass*& AttributeClass);                                          // [0xb48ea08] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
};
