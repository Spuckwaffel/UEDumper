...
public:
	...
	// FGameplayAttribute GetGameplayAttributeForClass(class UClass*& AttributeClass);                                          // [0xafc17bc] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
};
