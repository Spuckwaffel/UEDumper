...
public:
	...
	// void OnRep_SoundAsset();                                                                                                 // [0xb244538] Final|Native|Protected 
	// Function /Script/VGameplayRst.AudioComponentBase.OnRep_ActiveSoundInfo
	// void OnRep_ActiveSoundInfo();                                                                                            // [0xb244350] Final|Native|Protected 
};
...
public:
	...
	// void OnRep_ActiveStates();                                                                                               // [0xb244380] Final|Native|Private 
};
...
public:
	...
	// void TellServer_ClientLevelUnloaded(class UVerseLevelStreamingComponentBase* LevelStreamingComponent);                   // [0x6d5e974] Net|NetReliableNative|Event|Public|NetServer 
	// Function /Script/VGameplayRst.VerseLevelStreamingPlayerControllerRpcComponent.TellServer_ClientLevelLoaded
	// void TellServer_ClientLevelLoaded(class UVerseLevelStreamingComponentBase* LevelStreamingComponent);                     // [0x6f251e8] Net|NetReliableNative|Event|Public|NetServer 
};
...
public:
	...
	// void OnRep_LightComponent();                                                                                             // [0xb244470] Final|Native|Protected 
	// Function /Script/VGameplayRst.VerseLightPropertiesBase.OnRep_LightColor
	// void OnRep_LightColor();                                                                                                 // [0xb244430] Final|Native|Protected 
	// Function /Script/VGameplayRst.VerseLightPropertiesBase.OnRep_Intensity
	// void OnRep_Intensity();                                                                                                  // [0xb2443fc] Final|Native|Protected 
};
...
public:
	...
	// void OnRep_AttenuationRadius();                                                                                          // [0xb244394] Final|Native|Protected 
};
...
public:
	...
	// void OnRep_SourceRadius();                                                                                               // [0xb244594] Final|Native|Public  
	// Function /Script/VGameplayRst.VersePointLightProperties.OnRep_SourceLength
	// void OnRep_SourceLength();                                                                                               // [0xb244560] Final|Native|Public  
};
...
public:
	...
	// void OnRep_OuterConeAngle();                                                                                             // [0xb244504] Final|Native|Public  
	// Function /Script/VGameplayRst.VerseSpotLightProperties.OnRep_InnerConeAngle
	// void OnRep_InnerConeAngle();                                                                                             // [0xb2443c8] Final|Native|Public  
};
