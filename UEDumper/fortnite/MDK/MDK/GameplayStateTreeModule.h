...
public:
	...
	// void SetStartLogicAutomatically(bool bInStartLogicAutomatically);                                                        // [0x8674888] Final|Native|Public|BlueprintCallable 
	// Function /Script/GameplayStateTreeModule.StateTreeComponent.SendStateTreeEvent
	// void SendStateTreeEvent(FStateTreeEvent& Event);                                                                         // [0x867479c] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/GameplayStateTreeModule.StateTreeComponent.GetStateTreeRunStatus
	// EStateTreeRunStatus GetStateTreeRunStatus();                                                                             // [0x8674778] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
