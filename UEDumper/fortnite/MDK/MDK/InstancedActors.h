...
/// Class /Script/InstancedActors.GameFeatureAction_ConfigureInstancedActors
...
public:
	SMember(FInstancedActorsConfig)                    ConfigOverride                                              OFFSET(getStruct<T>, {0x28, 32, 0, 0})
};
...
public:
	...
	// void OnRep_InstanceHandle();                                                                                             // [0xc39e108] Final|Native|Protected 
	// Function /Script/InstancedActors.InstancedActorsComponent.HasMassEntity
	// bool HasMassEntity();                                                                                                    // [0xc39e0d0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// class AInstancedActorsManager* GetManager();                                                                             // [0x37f8ab4] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	SMember(FInstancedActorsConfig)                    DefaultConfig                                               OFFSET(getStruct<T>, {0x48, 32, 0, 0})
	SMember(FInstancedActorsConfig)                    CompiledActiveConfig                                        OFFSET(getStruct<T>, {0x80, 32, 0, 0})
	CMember(TArray<FClassConfigOverrideEntry>)         ClassConfigOverrides                                        OFFSET(get<T>, {0xA0, 16, 0, 0})
};
...
public:
	...
	CMember(class UClass*)                             InstancedActorsManagerClass                                 OFFSET(get<T>, {0x58, 8, 0, 0})
	CMember(class UWorld*)                             ExemplarActorWorld                                          OFFSET(get<T>, {0x2B0, 8, 0, 0})
	CMember(class UScriptStruct*)                      SettingsType                                                OFFSET(get<T>, {0x308, 8, 0, 0})
};
...
/// Struct /Script/InstancedActors.InstancedActorsConfig
/// Size: 0x0020 (0x000000 - 0x000020)
class FInstancedActorsConfig : public MDKBase
{ 
	friend MDKHandler;
	friend MDKBase;
...
public:
	CMember(class UClass*)                             ServerActorSpawnerSubsystemClass                            OFFSET(get<T>, {0x0, 8, 0, 0})
	CMember(class UClass*)                             ClientActorSpawnerSubsystemClass                            OFFSET(get<T>, {0x8, 8, 0, 0})
	CMember(class UClass*)                             InstancedActorsSubsystemClass                               OFFSET(get<T>, {0x10, 8, 0, 0})
	CMember(class UClass*)                             StationaryVisualizationTraitClass                           OFFSET(get<T>, {0x18, 8, 0, 0})
};

/// Struct /Script/InstancedActors.ClassConfigOverrideEntry
/// Size: 0x0028 (0x000000 - 0x000028)
class FClassConfigOverrideEntry : public MDKBase
{ 
	friend MDKHandler;
	friend MDKBase;
	static inline constexpr uint64_t __MDKClassSize = 40;
...
public:
	SMember(FInstancedActorsConfig)                    ConfigOverride                                              OFFSET(getStruct<T>, {0x8, 32, 0, 0})
};
