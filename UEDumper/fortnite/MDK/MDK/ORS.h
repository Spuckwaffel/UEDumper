...
public:
	...
	// void OnOwnerAdded(class AActor* Actor);                                                                                  // [0xc800d50] Final|Native|Private 
};
...
public:
	...
	// void ORSListObjects();                                                                                                   // [0x35cf850] Final|Exec|Native|Protected 
	// Function /Script/ORS.ORSCheatManager.ORSDebug
	// void ORSDebug(FName& Path);                                                                                              // [0xc800ce8] Final|Exec|Native|Protected|HasOutParms 
};
...
public:
	...
	// void OnRep_ReplicatedObjectReferences();                                                                                 // [0xc800df8] Final|Native|Protected 
	// Function /Script/ORS.ORSGroupComponent.OnRep_ReplicatedNetSerializeObjects
	// void OnRep_ReplicatedNetSerializeObjects();                                                                              // [0xc800de4] Final|Native|Protected 
	// Function /Script/ORS.ORSGroupComponent.OnRep_ReplayNetSerializeObjects
	// void OnRep_ReplayNetSerializeObjects();                                                                                  // [0xc800dd0] Final|Native|Protected 
};
...
public:
	...
	// void OnActorDestroyed(class AActor* Actor);                                                                              // [0x1ced1e0] Final|Native|Protected 
};
