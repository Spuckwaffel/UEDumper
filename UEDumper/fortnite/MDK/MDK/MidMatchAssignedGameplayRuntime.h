...
public:
	...
	// void StartAssignedObjectives();                                                                                          // [0x35cf850] Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
	// Function /Script/MidMatchAssignedGameplayRuntime.FortGameStateComponent_AssignedObjective.OnAssignedObjectiveReady
	// void OnAssignedObjectiveReady(FFortAssignedObjectiveData& ObjectiveData);                                                // [0x20c3f9c] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/MidMatchAssignedGameplayRuntime.FortGameStateComponent_AssignedObjective.CalculateSquadAvgLocation
	// FVector CalculateSquadAvgLocation(char SquadID, class UObject* WorldContextObject);                                      // [0xbd46e8c] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
};
