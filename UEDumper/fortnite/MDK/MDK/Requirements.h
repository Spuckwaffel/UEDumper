...
public:
	...
	// bool IsRequirementMetInternal(FControllerRequirementTestContext& RequestContext);                                        // [0x18a39e4] Event|Protected|HasOutParms|BlueprintCallable|BlueprintEvent|Const 
};
