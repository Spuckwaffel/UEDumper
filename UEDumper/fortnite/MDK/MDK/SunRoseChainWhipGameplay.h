...
public:
	...
	// void SunRoseSpawnHookShotShooter();                                                                                      // [0x35cf850] Final|Exec|Native|Public 
	// Function /Script/SunRoseChainWhipGameplay.FortCheatManager_SunRoseChainWhip.SunRoseRemoveHookShotShooter
	// void SunRoseRemoveHookShotShooter();                                                                                     // [0xb4e1b98] Final|Exec|Native|Public 
	// Function /Script/SunRoseChainWhipGameplay.FortCheatManager_SunRoseChainWhip.SunRoseApplyHookShot
	// void SunRoseApplyHookShot(float Delay);                                                                                  // [0x6997f24] Final|Exec|Native|Public 
};
