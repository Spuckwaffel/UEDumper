...
public:
	...
	// void UpdateShowMore();                                                                                                   // [0xc6b7dac] Final|Native|Protected|BlueprintCallable 
	// Function /Script/FabricTooltipUI.FabricTooltipWidget.ToggleShowMore
	// void ToggleShowMore();                                                                                                   // [0xc6b7d5c] Native|Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Script/FabricTooltipUI.FabricTooltipWidget.SetShowMore
	// void SetShowMore(bool bShowingMore);                                                                                     // [0xc6b7cdc] Final|Native|Protected|BlueprintCallable 
	// Function /Script/FabricTooltipUI.FabricTooltipWidget.InitTooltip
	// void InitTooltip(class AActor* TargetedActor, class UPrimitiveComponent* TargetedComponent);                             // [0xc6b7c18] Final|Native|Public|BlueprintCallable 
};
