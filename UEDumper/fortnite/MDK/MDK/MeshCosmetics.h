...
public:
	SMember(FCosmeticSlotSelector)                     SlotValidWithin                                             OFFSET(getStruct<T>, {0x580, 2, 0, 0})
	SMember(FApparelCustomizableItemReference)         Parameter                                                   OFFSET(getStruct<T>, {0x588, 32, 0, 0})
};
...
public:
	...
	// void ApplyVariants(class AActor* Actor, FFortAthenaLoadout& Loadout);                                                    // [0xa86c0e8] Final|Native|Static|Private|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// void OnPostCustomizationAnimGameplayTags_BP(FGameplayTagContainer& GameplayTags);                                        // [0x20c3f9c] Event|Public|HasOutParms|BlueprintEvent 
};
