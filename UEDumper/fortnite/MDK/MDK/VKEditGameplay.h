...
public:
	...
	// void OnClientActivatedContent(FUniqueNetIdRepl& ClientNetId);                                                            // [0xcabaea8] Final|Native|Private|HasOutParms|Const 
};
...
public:
	...
	// void OnRep_VkEditStatus();                                                                                               // [0xcabafe4] Final|Native|Protected|Const 
	// Function /Script/VKEditGameplay.PlayspaceComponent_EditConnectionManager.OnRep_EditConnections
	// void OnRep_EditConnections();                                                                                            // [0xcabaf78] Final|Native|Protected|Const 
};
