...
public:
	...
	CMember(class UIconTextButton_C*)                  btn_Defaults                                                OFFSET(get<T>, {0x2C8, 8, 0, 0})
	CMember(class UIconTextButton_C*)                  btn_Reload                                                  OFFSET(get<T>, {0x2D0, 8, 0, 0})
	CMember(class UIconTextButton_C*)                  btn_Save                                                    OFFSET(get<T>, {0x2D8, 8, 0, 0})
	CMember(class UCheckBox*)                          chk_Collapse                                                OFFSET(get<T>, {0x2E0, 8, 0, 0})
	CMember(class UImage*)                             Image                                                       OFFSET(get<T>, {0x2E8, 8, 0, 0})
	CMember(class UImage*)                             Image1                                                      OFFSET(get<T>, {0x2F0, 8, 0, 0})
	CMember(class UVerticalBox*)                       vb_Items                                                    OFFSET(get<T>, {0x2F8, 8, 0, 0})
	CMember(class UBP_SparksCosmeticComponent_C*)      CosmeticComponent                                           OFFSET(get<T>, {0x300, 8, 0, 0})
	CMember(class UWBP_Sparks_Dbg_CosmeticItem_C*)     AuraWidget                                                  OFFSET(get<T>, {0x308, 8, 0, 0})
	CMember(class UWBP_Sparks_Dbg_Cosmetic_Group_C*)   InstrumentWidget                                            OFFSET(get<T>, {0x310, 8, 0, 0})
	CMember(class UWBP_Sparks_Dbg_Cosmetic_Group_C*)   SpotlightWidget                                             OFFSET(get<T>, {0x318, 8, 0, 0})
...
public:
	...
	CMember(class UImage*)                             Image                                                       OFFSET(get<T>, {0x2D0, 8, 0, 0})
	CMember(class UCommonTextBlock*)                   txt_Name                                                    OFFSET(get<T>, {0x2D8, 8, 0, 0})
	CMember(class UVerticalBox*)                       vb_Channels                                                 OFFSET(get<T>, {0x2E0, 8, 0, 0})
	CMember(class USparksAccountItemDefinition*)       AccountItem                                                 OFFSET(get<T>, {0x2E8, 8, 0, 0})
	CMember(ESparksAccountItemSubtype)                 Subtype                                                     OFFSET(get<T>, {0x2F0, 1, 0, 0})
	CMember(ESparksInstrumentType)                     Instrument                                                  OFFSET(get<T>, {0x2F1, 1, 0, 0})
...
public:
	SMember(FPointerToUberGraphFrame)                  UberGraphFrame                                              OFFSET(getStruct<T>, {0x2C0, 8, 0, 0})
	CMember(class UCheckBox*)                          chk_Collapse                                                OFFSET(get<T>, {0x2C8, 8, 0, 0})
	CMember(class UImage*)                             Image                                                       OFFSET(get<T>, {0x2D0, 8, 0, 0})
	CMember(class UCommonTextBlock*)                   txt_Title                                                   OFFSET(get<T>, {0x2D8, 8, 0, 0})
	CMember(class UVerticalBox*)                       vb_Items                                                    OFFSET(get<T>, {0x2E0, 8, 0, 0})
	DMember(bool)                                      Title                                                       OFFSET(get<bool>, {0x2E8, 1, 0, 0})
	CMember(ESparksAccountItemSubtype)                 Item_Type                                                   OFFSET(get<T>, {0x2E9, 1, 0, 0})
	CMember(class UWBP_Sparks_Dbg_CosmeticPicker_C*)   ParentPicker                                                OFFSET(get<T>, {0x2F0, 8, 0, 0})
	CMember(TMap<ESparksInstrumentType, UWBP_Sparks_Dbg_CosmeticItem_C*>) Items                                    OFFSET(get<T>, {0x2F8, 80, 0, 0})
