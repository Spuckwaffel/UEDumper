...
public:
	...
	// void HandleResolveComplete(bool bSuccess, FString LinkCode, TArray<FString>& PluginURLs);                                // [0xb7b2204] Final|Native|Private|HasOutParms 
	// Function /Script/FMJamContentResolver.JamContentResolver.HandleGameFeatureLoadComplete
	// void HandleGameFeatureLoadComplete(bool bSuccess, FString LinkCode, FString PluginURL);                                  // [0xb7b1aa4] Final|Native|Private 
};
