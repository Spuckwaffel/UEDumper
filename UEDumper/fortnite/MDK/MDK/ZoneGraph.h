...
public:
	...
	// void SetTags(FZoneGraphTagMask NewTags);                                                                                 // [0xb28fc18] Final|Native|Public|BlueprintCallable 
	// Function /Script/ZoneGraph.ZoneShapeComponent.SetShapeType
	// void SetShapeType(FZoneShapeType Type);                                                                                  // [0x67ebb28] Final|Native|Public|BlueprintCallable 
	// Function /Script/ZoneGraph.ZoneShapeComponent.SetReverseLaneProfile
	// bool SetReverseLaneProfile(bool bReverse);                                                                               // [0xb28fb8c] Final|Native|Public|BlueprintCallable 
	// Function /Script/ZoneGraph.ZoneShapeComponent.SetPolygonRoutingType
	// void SetPolygonRoutingType(EZoneShapePolygonRoutingType NewType);                                                        // [0xb28fb10] Final|Native|Public|BlueprintCallable 
	// Function /Script/ZoneGraph.ZoneShapeComponent.IsLaneProfileReversed
	// bool IsLaneProfileReversed();                                                                                            // [0x3e63734] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ZoneGraph.ZoneShapeComponent.GetTags
	// FZoneGraphTagMask GetTags();                                                                                             // [0xb28faf8] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ZoneGraph.ZoneShapeComponent.GetShapeType
	// FZoneShapeType GetShapeType();                                                                                           // [0x67e4ddc] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
