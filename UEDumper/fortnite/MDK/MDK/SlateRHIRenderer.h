...
public:
	...
	// class USlateRHIPostBufferProcessor* GetSlatePostProcessor(ESlatePostRT InPostBufferBit);                                 // [0x657d590] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// FSlatePostSettings GetSlatePostSetting(ESlatePostRT InPostBufferBit);                                                    // [0x657d620] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/SlateRHIRenderer.SlateRHIRendererSettings.GetMutableSlatePostSetting
	// FSlatePostSettings GetMutableSlatePostSetting(ESlatePostRT InPostBufferBit);                                             // [0x657d4b4] Final|Native|Public|BlueprintCallable 
};
