...
public:
	...
	// void NativeAddToCheatManager();                                                                                          // [0x35cf850] Final|Native|Protected|BlueprintCallable 
	// Function /Script/JunoRidableRuntime.JunoRidableCheatManager.JunoStopRidingDelayedResetRiderComponent
	// void JunoStopRidingDelayedResetRiderComponent();                                                                         // [0x35cf850] Final|Native|Protected 
	// Function /Script/JunoRidableRuntime.JunoRidableCheatManager.JunoStopRiding
	// void JunoStopRiding();                                                                                                   // [0x26017bc] BlueprintAuthorityOnly|Exec|Native|Public 
	// Function /Script/JunoRidableRuntime.JunoRidableCheatManager.JunoStartRiding
	// void JunoStartRiding();                                                                                                  // [0x1448960] BlueprintAuthorityOnly|Exec|Native|Public 
};
