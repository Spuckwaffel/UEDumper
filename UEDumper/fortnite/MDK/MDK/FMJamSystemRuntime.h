...
public:
	...
	// void UpdateJamUI();                                                                                                      // [0x20c3f9c] Event|Protected|BlueprintEvent 
	// Function /Script/FMJamSystemRuntime.JamControllerComponent.GetControllerOfClass
	// class AController* GetControllerOfClass(class UClass* ControllerType, bool bMatchChildTypes);                            // [0xb7e6bf8] Final|Native|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// void OnLoadoutChanged();                                                                                                 // [0xb7e755c] Final|Native|Private 
	// Function /Script/FMJamSystemRuntime.JamControllerComponent_LoopOptions.AddJamCategories
	// void AddJamCategories(bool bPostLockerCategory);                                                                         // [0xb7e6b64] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void OnSongCatalogRetrieved(bool bSuccess);                                                                              // [0xb7e7788] Final|Native|Protected 
	// Function /Script/FMJamSystemRuntime.JamControllerComponent_LoopPreloader.OnPawnSet
	// void OnPawnSet(class APlayerState* Player, class APawn* NewPawn, class APawn* OldPawn);                                  // [0xb7e7598] Final|Native|Protected 
	// Function /Script/FMJamSystemRuntime.JamControllerComponent_LoopPreloader.OnLoadoutFilled
	// void OnLoadoutFilled();                                                                                                  // [0xb7e7570] Final|Native|Protected 
};
...
public:
	...
	// void Close();                                                                                                            // [0xb7e6be4] Final|Native|Protected|BlueprintCallable 
};
...
public:
	...
	// bool ShouldApplyJamOnSplitscreenLogic(class UObject* WorldContextObject, class APlayerController* ReferenceController);  // [0xb7e7808] Final|RequiredAPI|Native|Static|Public|BlueprintCallable 
	// Function /Script/FMJamSystemRuntime.JamOnOffSwitchComponent.OnPlayerStatePawnSet
	// void OnPlayerStatePawnSet(class APlayerState* Player, class APawn* NewPawn, class APawn* OldPawn);                       // [0xb7e7690] Final|Native|Protected 
	// Function /Script/FMJamSystemRuntime.JamOnOffSwitchComponent.OnMutatorUpdated
	// void OnMutatorUpdated();                                                                                                 // [0xb7e7584] Final|Native|Protected 
};
...
public:
	...
	// class APawn* GetPawnOfClass(class UClass* PawnType, bool bMatchChildTypes);                                              // [0xb7e7454] Final|Native|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// bool IsJamDebugDisplayEnabled();                                                                                         // [0xb7e7540] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
