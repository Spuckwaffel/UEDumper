...
public:
	...
	// bool BroadcastEvent(FGameplayEventDescriptor& EventDescriptor, class UObject* EventContext, int32_t& Event, class UClass* EventRouterScope, class AActor* RouterContextActor); // [0x20da68c] Final|Native|Static|Private|HasOutParms|BlueprintCallable 
};
