...
public:
	CMember(class UFortKeybindWidget*)                 Keybind_ActivateAction                                      OFFSET(get<T>, {0x360, 8, 0, 0})
	CMember(class UFortKeybindWidget*)                 Keybind_CycleCategoryAction                                 OFFSET(get<T>, {0x368, 8, 0, 0})
	CMember(class UFortKeybindWidget*)                 Keybind_CyclePropAction                                     OFFSET(get<T>, {0x370, 8, 0, 0})
