...
public:
	...
	// void ValidateDelMarWorld_CookOnly();                                                                                     // [0x186becc] Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Script/DelMarValidatorCommon.DelMarWorldValidator_Task.ValidateDelMarWorld_ClientOnly
	// void ValidateDelMarWorld_ClientOnly();                                                                                   // [0x186becc] Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Script/DelMarValidatorCommon.DelMarWorldValidator_Task.ValidateDelMarWorld
	// void ValidateDelMarWorld();                                                                                              // [0x186becc] Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Script/DelMarValidatorCommon.DelMarWorldValidator_Task.LogString
	// void LogString(FString InString);                                                                                        // [0xc475758] Final|Native|Public|BlueprintCallable 
	// Function /Script/DelMarValidatorCommon.DelMarWorldValidator_Task.AddWarningTokenized
	// void AddWarningTokenized(class UObject* InAsset, FText& Msg);                                                            // [0xc475630] Final|Native|Protected|HasOutParms|BlueprintCallable 
	// Function /Script/DelMarValidatorCommon.DelMarWorldValidator_Task.AddWarning
	// void AddWarning(FText& Msg);                                                                                             // [0xc475590] Final|Native|Protected|HasOutParms|BlueprintCallable 
	// Function /Script/DelMarValidatorCommon.DelMarWorldValidator_Task.AddErrorTokenized
	// void AddErrorTokenized(class UObject* InAsset, FText& Msg);                                                              // [0xc475468] Final|Native|Protected|HasOutParms|BlueprintCallable 
	// Function /Script/DelMarValidatorCommon.DelMarWorldValidator_Task.AddError
	// void AddError(FText& Msg);                                                                                               // [0xc4753cc] Final|Native|Protected|HasOutParms|BlueprintCallable 
};
