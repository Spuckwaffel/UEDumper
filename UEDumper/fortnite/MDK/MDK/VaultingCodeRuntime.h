...
public:
	...
	// void BP_GetAnimationMontageInformation(FSynchedActionInfo SynchedActionInfo, EHurdleType Type, bool bIsNarrowOpening, bool bIsCrouched, class UAnimMontage*& AnimMontage, FName& StartSectionName, FName& MontageMiddleSectionName); // [0x20c3f9c] Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/VaultingCodeRuntime.FortMovementMode_ExtLogicHurdle.BP_DestroyProp
	// void BP_DestroyProp(class ABuildingProp* BuildPropToDestroy);                                                            // [0x20c3f9c] Event|Public|BlueprintEvent 
};
...
public:
	...
	// bool ShouldShowHurdleIndicator();                                                                                        // [0xbf5e228] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/VaultingCodeRuntime.HurdleComponent.RegisterMutatorUpdatedDelegate
	// void RegisterMutatorUpdatedDelegate(class APawn* AffectedPawn);                                                          // [0xbf5e024] Final|Native|Protected 
	// Function /Script/VaultingCodeRuntime.HurdleComponent.OnPlayerStatePawnSet
	// void OnPlayerStatePawnSet(class APlayerState* Player, class APawn* NewPawn, class APawn* OldPawn);                       // [0xbf5dc10] Final|Native|Protected 
	// Function /Script/VaultingCodeRuntime.HurdleComponent.OnMutatorUpdated
	// void OnMutatorUpdated();                                                                                                 // [0xbf5dbfc] Final|Native|Protected 
	// Function /Script/VaultingCodeRuntime.HurdleComponent.IsUsingGamepad
	// bool IsUsingGamepad();                                                                                                   // [0xbf5db84] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/VaultingCodeRuntime.HurdleComponent.HandleOwnerJumpInput
	// void HandleOwnerJumpInput(bool bPressed);                                                                                // [0xbf5db04] Final|Native|Protected 
	// Function /Script/VaultingCodeRuntime.HurdleComponent.HandleNavLinkMoveStarted
	// void HandleNavLinkMoveStarted(FVector LinkEndPoint);                                                                     // [0xbf5da74] Final|Native|Protected|HasDefaults 
	// Function /Script/VaultingCodeRuntime.HurdleComponent.GetHurdleHighlightTransform
	// FTransform GetHurdleHighlightTransform();                                                                                // [0xbf5da18] Final|Native|Protected|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/VaultingCodeRuntime.HurdleComponent.BP_UseAutoHurdle
	// bool BP_UseAutoHurdle();                                                                                                 // [0xbf5d9a4] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/VaultingCodeRuntime.HurdleComponent.BP_UpdateHurdleHighlight
	// void BP_UpdateHurdleHighlight();                                                                                         // [0x20c3f9c] Event|Protected|BlueprintEvent 
	// Function /Script/VaultingCodeRuntime.HurdleComponent.BP_ShowHurdleInputPrompt
	// void BP_ShowHurdleInputPrompt(bool bVisible);                                                                            // [0x20c3f9c] Event|Protected|BlueprintEvent 
	// Function /Script/VaultingCodeRuntime.HurdleComponent.BP_IsTacticalSprinting
	// bool BP_IsTacticalSprinting();                                                                                           // [0xbf5d944] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/VaultingCodeRuntime.HurdleComponent.BP_CreateHurdleHighlight
	// void BP_CreateHurdleHighlight(FHurdleTargetingData& TargetingData);                                                      // [0x20c3f9c] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/VaultingCodeRuntime.HurdleComponent.BP_CleanupHurdleIndicator
	// void BP_CleanupHurdleIndicator();                                                                                        // [0x20c3f9c] Event|Protected|BlueprintEvent 
	// Function /Script/VaultingCodeRuntime.HurdleComponent.BP_CanStartHurdle
	// void BP_CanStartHurdle(bool& OutCanStartHurdle);                                                                         // [0x20c3f9c] Event|Protected|HasOutParms|BlueprintEvent|Const 
};
...
public:
	...
	// bool PerformHurdleTargeting(class ACharacter* Character, FHurdleInputConfigCache& HurdleInputConfig, FHurdleTargetingData& OutTargetingData, bool bIsAutoHurdle, FVector OverrideAimDirection); // [0xbf5dd08] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
};
