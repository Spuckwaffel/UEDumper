...
public:
	SMember(FScalableFloat)                            MinTimeBeforeCompletion                                     OFFSET(getStruct<T>, {0x1A8, 40, 0, 0})
};
...
public:
	DMember(float)                                     TelegraphUpdateIntervalSeconds                              OFFSET(get<float>, {0xB60, 4, 0, 0})
	CMember(TArray<TEnumAsByte<EObjectTypeQuery>>)     TelegraphCollisionObjectTypes                               OFFSET(get<T>, {0xB68, 16, 0, 0})
	DMember(float)                                     TelegraphInterpSpeed                                        OFFSET(get<float>, {0xB78, 4, 0, 0})
	DMember(float)                                     CrashWindupDuration                                         OFFSET(get<float>, {0xBA8, 4, 0, 0})
	DMember(float)                                     CrashLookPitchMin                                           OFFSET(get<float>, {0xBAC, 4, 0, 0})
	DMember(float)                                     CrashLookPitchMax                                           OFFSET(get<float>, {0xBB0, 4, 0, 0})
	DMember(float)                                     TelegraphTraceStartDist                                     OFFSET(get<float>, {0xBB4, 4, 0, 0})
	DMember(float)                                     TelegraphTraceEndDist                                       OFFSET(get<float>, {0xBB8, 4, 0, 0})
	CMember(class UClass*)                             TelegraphActorClass                                         OFFSET(get<T>, {0xBC0, 8, 0, 0})
	CMember(class AActor*)                             TelegraphActor                                              OFFSET(get<T>, {0xBC8, 8, 0, 0})
	CMember(class UFXSystemAsset*)                     TelegraphFXSystemAsset                                      OFFSET(get<T>, {0xBD0, 8, 0, 0})
	CMember(class UFXSystemComponent*)                 TelegraphNS                                                 OFFSET(get<T>, {0xBD8, 8, 0, 0})
...
public:
	DMember(bool)                                      bIsStartingFlying                                           OFFSET(get<bool>, {0x4A, 1, 0, 0})
	CMember(EWingedFlyingStatus)                       FlyingStatus                                                OFFSET(get<T>, {0x4B, 1, 0, 0})
	DMember(float)                                     CurrentHeightAboveWorld                                     OFFSET(get<float>, {0x80, 4, 0, 0})
	DMember(float)                                     InterpolatedHeightAboveWorld                                OFFSET(get<float>, {0x84, 4, 0, 0})
	DMember(float)                                     SpeedMultiplierFromForwardInput                             OFFSET(get<float>, {0x88, 4, 0, 0})
	DMember(float)                                     InterpolatedYInput                                          OFFSET(get<float>, {0x8C, 4, 0, 0})
	SMember(FVector2D)                                 InterpolatedCrashInput                                      OFFSET(getStruct<T>, {0x90, 16, 0, 0})
	DMember(float)                                     FlyingEnergy                                                OFFSET(get<float>, {0xA0, 4, 0, 0})
};
