...
public:
	...
	// void ClearOvershieldListenerDelegates(class UGameplayAbility* OwningAbility);                                            // [0xca9b5f0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/FortOvershieldHelpers.FortOvershieldHelperComponent.AssignOvershieldListenerDelegates
	// void AssignOvershieldListenerDelegates(class UGameplayAbility* OwningAbility, FFortOvershieldDelegateContainer Delegates); // [0xca9b4fc] Final|Native|Static|Public|BlueprintCallable 
};
