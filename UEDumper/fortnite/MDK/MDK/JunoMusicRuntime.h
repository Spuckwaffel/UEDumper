...
public:
	...
	// void OnDayNightPhaseChangeSignature(EFortDayPhase CurrentDayPhaseIn, EFortDayPhase PreviousDayPhaseIn, bool bAtCreationIn); // [0xcc8b100] Final|Native|Public  
	// Function /Script/JunoMusicRuntime.ActiveJunoMusicPlayer.OnActiveMusicPlayerCooldownFinished
	// void OnActiveMusicPlayerCooldownFinished();                                                                              // [0xcc8b0e8] Final|Native|Public  
	// Function /Script/JunoMusicRuntime.ActiveJunoMusicPlayer.OnActiveMusicElementControllerFinishedPlaying
	// void OnActiveMusicElementControllerFinishedPlaying();                                                                    // [0xcc8b0d4] Final|Native|Public  
};
...
public:
	...
	// void OnFinishedPlaying();                                                                                                // [0x1447724] Native|Public        
};
...
public:
	...
	// void RemoveMusicStates(FGameplayTagContainer& InStates);                                                                 // [0xcc8b4c4] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/JunoMusicRuntime.JunoMusicControllerSubsystem.RemoveMusicState
	// void RemoveMusicState(FGameplayTag& InState);                                                                            // [0xcc8b3fc] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/JunoMusicRuntime.JunoMusicControllerSubsystem.PushMusicStates
	// void PushMusicStates(FGameplayTagContainer& InStates);                                                                   // [0xcc8b2c4] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/JunoMusicRuntime.JunoMusicControllerSubsystem.PushMusicState
	// void PushMusicState(FGameplayTag& InState);                                                                              // [0xcc8b1fc] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/JunoMusicRuntime.JunoMusicControllerSubsystem.GetCollectedString
	// FString GetCollectedString(FName ParameterName, ESetParamResult& Result);                                                // [0xcc8aafc] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoMusicRuntime.JunoMusicControllerSubsystem.GetCollectedInt
	// int32_t GetCollectedInt(FName ParameterName, ESetParamResult& Result);                                                   // [0xcc8a710] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoMusicRuntime.JunoMusicControllerSubsystem.GetCollectedFloat
	// float GetCollectedFloat(FName ParameterName, ESetParamResult& Result);                                                   // [0xcc8a324] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoMusicRuntime.JunoMusicControllerSubsystem.GetCollectedBool
	// bool GetCollectedBool(FName ParameterName, ESetParamResult& Result);                                                     // [0xcc89f54] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void BP_OnUpdate(float DeltaSeconds, class UMetasoundParameterPack* AggregatedData);                                     // [0x20c3f9c] Event|Public|BlueprintEvent 
	// Function /Script/JunoMusicRuntime.JunoMusicDataCollector.BP_OnUnregistered
	// void BP_OnUnregistered();                                                                                                // [0x20c3f9c] Event|Public|BlueprintEvent 
	// Function /Script/JunoMusicRuntime.JunoMusicDataCollector.BP_OnRegistered
	// void BP_OnRegistered(class UMetasoundParameterPack* AggregatedData);                                                     // [0x20c3f9c] Event|Public|BlueprintEvent 
};
...
public:
	...
	// void SetThreatLevelMultiplier(float InThreatLevelMultiplier);                                                            // [0xcc8b830] Final|Native|Protected|BlueprintCallable 
};
...
public:
	...
	// void StopWorldMusicSystem(class UWorld* World);                                                                          // [0xcc8b930] Final|Native|Public|BlueprintCallable 
	// Function /Script/JunoMusicRuntime.JunoMusicManager.StartWorldMusicSystem
	// void StartWorldMusicSystem(class UWorld* World);                                                                         // [0xcc8b8b0] Final|Native|Public|BlueprintCallable 
	// Function /Script/JunoMusicRuntime.JunoMusicManager.SetSuspendWorldActiveMusicPlayback
	// void SetSuspendWorldActiveMusicPlayback(class UWorld* World, bool bSuspendPlayback, bool bStopCurrentlyPlayingMusic);    // [0xcc8b724] Final|Native|Public|BlueprintCallable 
	// Function /Script/JunoMusicRuntime.JunoMusicManager.SetSuspendActiveMusicPlayback
	// void SetSuspendActiveMusicPlayback(bool bSuspendPlayback, bool bStopCurrentlyPlayingMusic);                              // [0xcc8b660] Final|Native|Public|BlueprintCallable 
	// Function /Script/JunoMusicRuntime.JunoMusicManager.SetActiveJunoMusicManagerData
	// void SetActiveJunoMusicManagerData(FActiveJunoMusicManagerData& ActiveJunoMusicManagerDataIn);                           // [0xcc8b5cc] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/JunoMusicRuntime.JunoMusicManager.RemoveJunoMusicPlaylist
	// void RemoveJunoMusicPlaylist(class UJunoMusicPlaylistDataAsset* JunoMusicPlaylist);                                      // [0xcc8b37c] Final|Native|Public|BlueprintCallable 
	// Function /Script/JunoMusicRuntime.JunoMusicManager.GetCollectedString
	// FString GetCollectedString(class UObject* WorldContextObject, FName ParameterName, ESetParamResult& Result);             // [0xcc8ac84] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoMusicRuntime.JunoMusicManager.GetCollectedInt
	// int32_t GetCollectedInt(class UObject* WorldContextObject, FName ParameterName, ESetParamResult& Result);                // [0xcc8a898] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoMusicRuntime.JunoMusicManager.GetCollectedFloat
	// float GetCollectedFloat(class UObject* WorldContextObject, FName ParameterName, ESetParamResult& Result);                // [0xcc8a4a4] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoMusicRuntime.JunoMusicManager.GetCollectedBool
	// bool GetCollectedBool(class UObject* WorldContextObject, FName ParameterName, ESetParamResult& Result);                  // [0xcc8a0c0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoMusicRuntime.JunoMusicManager.AddJunoMusicPlaylist
	// void AddJunoMusicPlaylist(class UJunoMusicPlaylistDataAsset* JunoMusicPlaylist);                                         // [0xcc89e50] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// bool BP_ShouldPlay();                                                                                                    // [0x355e94c] Native|Event|Public|BlueprintEvent 
	...
	// void BP_OnRegistered();                                                                                                  // [0x20c3f9c] Event|Public|BlueprintEvent 
};
...
public:
	...
	// void BP_OnUpdate(float DeltaSeconds);                                                                                    // [0x20c3f9c] Event|Public|BlueprintEvent 
...
public:
	...
	// void HandleEnvironmentChanged(class AActor* Actor, FJunoBiomeInfoQueryResult& PreviousEnvironmentResult, FJunoBiomeInfoQueryResult& NewEnvironmentResult); // [0xcc8af18] Final|Native|Private|HasOutParms 
	// Function /Script/JunoMusicRuntime.JunoMusicPlayspaceProbe_Environment.CacheFortPlayerPawn
	// void CacheFortPlayerPawn(class AFortPawn* NewPawn);                                                                      // [0xcc89ed0] Final|Native|Private 
};
