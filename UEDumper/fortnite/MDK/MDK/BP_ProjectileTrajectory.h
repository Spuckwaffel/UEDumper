...
public:
	...
	// void SetProjectileBudgetMesh(class USkeletalMeshComponentBudgeted* ProjectileBudgetMesh);                                // [0x20c3f9c] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/BP_ProjectileTrajectory.BP_ProjectileTrajectory_C.SetShouldUpdateFromOwner
	// void SetShouldUpdateFromOwner(bool ShouldUpdate, class UObject* Owner);                                                  // [0x20c3f9c] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/BP_ProjectileTrajectory.BP_ProjectileTrajectory_C.UpdateFromTrajectoryOwner
	// void UpdateFromTrajectoryOwner();                                                                                        // [0x20c3f9c] Public|BlueprintCallable|BlueprintEvent 
	...
	// void SetTrajectorySpline(TArray<FVector>& SplinePoints, TArray<FVector>& SplineTangents);                                // [0x20c3f9c] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /Game/BP_ProjectileTrajectory.BP_ProjectileTrajectory_C.SetTrajectoryValid
	// void SetTrajectoryValid(bool bIsTrajectoryValid);                                                                        // [0x20c3f9c] BlueprintCallable|BlueprintEvent 
	// Function /Game/BP_ProjectileTrajectory.BP_ProjectileTrajectory_C.UpdateTargetMeshVisibility
	// void UpdateTargetMeshVisibility();                                                                                       // [0x20c3f9c] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_BP_ProjectileTrajectory(int32_t EntryPoint);                                                       // [0x20c3f9c] Final|HasDefaults    
};
