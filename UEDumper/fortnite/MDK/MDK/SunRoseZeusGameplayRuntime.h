...
public:
	...
	// void StrikeLightning(FVector Location);                                                                                  // [0xb51c958] Final|Native|Private|HasDefaults 
	// Function /Script/SunRoseZeusGameplayRuntime.BuildingGameplayActorZeusThunderstorm.StartLightningStrike
	// void StartLightningStrike(FVector& Location, float BoltHeight);                                                          // [0xb51c808] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/SunRoseZeusGameplayRuntime.BuildingGameplayActorZeusThunderstorm.StartLightningFX
	// void StartLightningFX();                                                                                                 // [0xb51c7f4] Final|Native|Private 
	// Function /Script/SunRoseZeusGameplayRuntime.BuildingGameplayActorZeusThunderstorm.SetStrikeTargetingLocation
	// void SetStrikeTargetingLocation(FTargetingRequestHandle& TargetingHandle, FVector& Location);                            // [0xb51c67c] Final|BlueprintAuthorityOnly|Native|Protected|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/SunRoseZeusGameplayRuntime.BuildingGameplayActorZeusThunderstorm.OnTelegraphStart
	// void OnTelegraphStart(FVector Location);                                                                                 // [0xb51c5fc] Net|NetReliableNative|Event|NetMulticast|Protected|HasDefaults 
	// Function /Script/SunRoseZeusGameplayRuntime.BuildingGameplayActorZeusThunderstorm.OnTelegraphEnd
	// void OnTelegraphEnd();                                                                                                   // [0x8ceae20] Net|NetReliableNative|Event|NetMulticast|Protected 
	// Function /Script/SunRoseZeusGameplayRuntime.BuildingGameplayActorZeusThunderstorm.K2_OnTelegraphStart
	// void K2_OnTelegraphStart(FVector& Location);                                                                             // [0x20c3f9c] Event|Protected|HasOutParms|HasDefaults|BlueprintEvent 
	// Function /Script/SunRoseZeusGameplayRuntime.BuildingGameplayActorZeusThunderstorm.K2_OnTelegraphEnd
	// void K2_OnTelegraphEnd();                                                                                                // [0x20c3f9c] Event|Protected|BlueprintEvent 
	// Function /Script/SunRoseZeusGameplayRuntime.BuildingGameplayActorZeusThunderstorm.K2_OnLightningStrikeFX
	// void K2_OnLightningStrikeFX(FVector& Location, float BoltHeight);                                                        // [0x20c3f9c] Event|Protected|HasOutParms|HasDefaults|BlueprintEvent 
	// Function /Script/SunRoseZeusGameplayRuntime.BuildingGameplayActorZeusThunderstorm.K2_OnLightningStrike
	// void K2_OnLightningStrike(FVector& Location);                                                                            // [0x20c3f9c] Event|Protected|HasOutParms|HasDefaults|BlueprintEvent 
	// Function /Script/SunRoseZeusGameplayRuntime.BuildingGameplayActorZeusThunderstorm.GetStrikeTargetingLocation
	// FVector GetStrikeTargetingLocation(FTargetingRequestHandle& TargetingHandle);                                            // [0xb51c550] Final|BlueprintAuthorityOnly|Native|Protected|HasOutParms|HasDefaults|BlueprintCallable 
};
...
public:
	...
	// void OnExplosionFinished();                                                                                              // [0x20c3f9c] Event|Protected|BlueprintEvent 
	// Function /Script/SunRoseZeusGameplayRuntime.FortProjectileSunRoseLightning.DoExplosionAsyncLOS
	// void DoExplosionAsyncLOS();                                                                                              // [0xb51c53c] Final|BlueprintAuthorityOnly|Native|Protected|BlueprintCallable 
};
