...
public:
	...
	// void HandleCursorModeChanging(bool bCursorModeEnabled, FName ActionName);                                                // [0xb78bf20] Final|Native|Protected 
};
...
public:
	...
	// void SetQuestScreenVisible(bool bVisible);                                                                               // [0xb78c0a8] Final|Native|Protected|BlueprintCallable 
	// Function /Script/SparksCoreUI.SparksQuestScreenContainer.HandleToggleQuestListFromMapVisibility
	// void HandleToggleQuestListFromMapVisibility(bool bMapVisible);                                                           // [0xb78c0a8] Final|Native|Protected 
	// Function /Script/SparksCoreUI.SparksQuestScreenContainer.HandleToggleQuestList
	// void HandleToggleQuestList();                                                                                            // [0xb78c094] Final|Native|Protected 
	// Function /Script/SparksCoreUI.SparksQuestScreenContainer.HandleMapPanelExitButtonPressed
	// void HandleMapPanelExitButtonPressed();                                                                                  // [0xb78c080] Final|Native|Protected|BlueprintCallable 
	// Function /Script/SparksCoreUI.SparksQuestScreenContainer.HandleAthenaScreenDeactivated
	// void HandleAthenaScreenDeactivated();                                                                                    // [0x9386c70] Final|Native|Protected 
};
...
public:
	...
	// void BP_SetSocialUserFromPlayerState(class AFortPlayerState* PlayerState);                                               // [0xb78be8c] Final|RequiredAPI|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void OnSongCatalogRetrieved(bool bSuccess);                                                                              // [0xb78c128] Final|Native|Private 
};
