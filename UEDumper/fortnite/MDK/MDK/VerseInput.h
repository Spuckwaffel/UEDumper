...
public:
	...
	// void ServerInputActionTriggered(FGuid Guid, FVector InputValue);                                                         // [0xd27a154] Final|Net|NetReliableNative|Event|Private|NetServer|HasDefaults|Const 
	// Function /Script/VerseInput.VerseReplicatedInputDataComponent.OnInputActionTriggered
	// void OnInputActionTriggered(FInputActionInstance& ActionInstance);                                                       // [0xd27a0b0] Final|Native|Private|HasOutParms 
};
