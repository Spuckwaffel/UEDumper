...
public:
	...
	// void RemoveFromEndGameQueue();                                                                                           // [0x35cf850] Final|Native|Public|BlueprintCallable 
	...
	// bool IsWithinPublishedPlayspace();                                                                                       // [0x2f99024] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CRD_GameStreamRuntime.CreativeGameStreamDeviceComponent.Init
	// void Init(class UFortMinigameLogicComponent* InMinigameLogicComponent);                                                  // [0x656aec4] Final|Native|Public|BlueprintCallable 
	...
	// void CreativeGameStreamDeviceComponentSignature__DelegateSignature(class UCreativeGameStreamDeviceComponent* CreativeGameStreamDeviceComponent); // [0x20c3f9c] MulticastDelegate|Public|Delegate 
	// Function /Script/CRD_GameStreamRuntime.CreativeGameStreamDeviceComponent.AddToEndGameQueue
	// void AddToEndGameQueue();                                                                                                // [0x35cf850] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void OnMinigameStateChanged(class AFortMinigame* InMinigame, EFortMinigameState NewMinigameState);                       // [0x8fc9afc] Final|Native|Private 
};
