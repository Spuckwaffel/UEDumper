...
public:
	...
	// void TeleportTrainToTrainStartLocation();                                                                                // [0x3518b8c] Final|BlueprintAuthorityOnly|Exec|Native|Private 
	// Function /Script/TrainRuntime.FortTrainCheatManager.TeleportTrainToCursor
	// void TeleportTrainToCursor();                                                                                            // [0x3518b8c] Final|BlueprintAuthorityOnly|Exec|Native|Private 
	// Function /Script/TrainRuntime.FortTrainCheatManager.TeleportToTrainStartLocation
	// void TeleportToTrainStartLocation();                                                                                     // [0x3518b8c] Final|BlueprintAuthorityOnly|Exec|Native|Private 
	// Function /Script/TrainRuntime.FortTrainCheatManager.TeleportToTrain
	// void TeleportToTrain();                                                                                                  // [0x3518b8c] Final|BlueprintAuthorityOnly|Exec|Native|Private 
	// Function /Script/TrainRuntime.FortTrainCheatManager.SetTrainStartLocationToCursor
	// void SetTrainStartLocationToCursor();                                                                                    // [0x3518b8c] Final|BlueprintAuthorityOnly|Exec|Native|Private 
	// Function /Script/TrainRuntime.FortTrainCheatManager.SetTrainMoveInPositiveRailDirection
	// void SetTrainMoveInPositiveRailDirection(bool bMoveInPositiveRailDirection);                                             // [0x63958fc] Final|BlueprintAuthorityOnly|Exec|Native|Private 
	// Function /Script/TrainRuntime.FortTrainCheatManager.PrintTrainDebug
	// void PrintTrainDebug();                                                                                                  // [0x3518b8c] Final|Exec|Native|Private|Const 
};
...
public:
	...
	// void OnPawnDebasedTrainCar(class AFortPawn* Pawn, class AActor* NewBase);                                                // [0x186becc] Event|Protected|BlueprintEvent 
	// Function /Script/TrainRuntime.TrainCar.OnPawnBasedOnTrainCar
	// void OnPawnBasedOnTrainCar(class AFortPawn* Pawn);                                                                       // [0x186becc] Event|Protected|BlueprintEvent 
	// Function /Script/TrainRuntime.TrainCar.OnActorTargetedForImpulse
	// void OnActorTargetedForImpulse(class AActor* Actor);                                                                     // [0x186becc] Event|Public|BlueprintEvent 
	// Function /Script/TrainRuntime.TrainCar.GetTransformAtServerTime
	// FTransform GetTransformAtServerTime(float ServerTime);                                                                   // [0xb7f040c] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/TrainRuntime.TrainCar.GetTrainManager
	// class UFortTrainManager* GetTrainManager();                                                                              // [0xb7f03e8] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/TrainRuntime.TrainCar.GetCarIndex
	// int32_t GetCarIndex();                                                                                                   // [0xb7f03c4] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void PlaceOnRails();                                                                                                     // [0xb7f0abc] Final|Native|Protected 
	// Function /Script/TrainRuntime.FortTrainManager.OnRep_ReplicatedMovementData
	// void OnRep_ReplicatedMovementData();                                                                                     // [0xb7f0aa8] Final|Native|Protected 
	// Function /Script/TrainRuntime.FortTrainManager.OnRep_Rail
	// void OnRep_Rail();                                                                                                       // [0xb7f0a8c] Final|Native|Protected 
	// Function /Script/TrainRuntime.FortTrainManager.MoveToTimeAlongRail
	// void MoveToTimeAlongRail(float Time, bool bUpdateReplicatedMovementData);                                                // [0xb7f094c] Final|Native|Public|BlueprintCallable 
	// Function /Script/TrainRuntime.FortTrainManager.MoveToPositionOnRailAtCurrentServerTime
	// void MoveToPositionOnRailAtCurrentServerTime(bool bUpdateReplicatedMovementData);                                        // [0xb7f0888] Final|Native|Public|BlueprintCallable 
	// Function /Script/TrainRuntime.FortTrainManager.MoveToPositionOnRail
	// void MoveToPositionOnRail(float RailDistance, bool bUpdateReplicatedMovementData);                                       // [0xb7f0748] Final|Native|Public|BlueprintCallable 
	// Function /Script/TrainRuntime.FortTrainManager.MoveAlongRail
	// void MoveAlongRail(float DeltaDistance, bool bUpdateReplicatedMovementData);                                             // [0xb7f0600] Final|Native|Public|BlueprintCallable 
	// Function /Script/TrainRuntime.FortTrainManager.GetWorldLocationAtServerTime
	// FVector GetWorldLocationAtServerTime(float ServerTime);                                                                  // [0xb7f051c] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void ValidateSpline();                                                                                                   // [0x3518b8c] Final|Native|Private|Const 
	// Function /Script/TrainRuntime.FortTrainRail.GetTimeFromNextTrainArrival
	// float GetTimeFromNextTrainArrival(FGameplayTag& StationIdentifierTag);                                                   // [0x31edf94] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/TrainRuntime.FortTrainRail.GenerateSpline
	// void GenerateSpline();                                                                                                   // [0x3518b8c] Final|Native|Private|Const 
};
...
public:
	...
	// class UFortTrainManager* FindOrGetTrainManager();                                                                        // [0xb7f03a0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
