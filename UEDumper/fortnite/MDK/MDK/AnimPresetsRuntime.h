...
public:
	...
	// void HandleAnimInstance(class UAnimInstance* Instance);                                                                  // [0x80c7c10] Native|Event|Public|BlueprintCallable|BlueprintEvent|Const 
	// Function /Script/AnimPresetsRuntime.AnimPreset.GetPresetClass
	// TWeakObjectPtr<UClass*> GetPresetClass();                                                                                // [0x80c7bc8] Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
};
