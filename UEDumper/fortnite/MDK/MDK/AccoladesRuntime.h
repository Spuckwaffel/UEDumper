...
public:
	...
	// void TriggerAccolade(FString AccoladeName);                                                                              // [0x6dbbe2c] Final|BlueprintAuthorityOnly|Exec|Native|Private 
	// Function /Script/AccoladesRuntime.FortCheatManager_Accolades.ResetAccoladeData
	// void ResetAccoladeData();                                                                                                // [0x35cf850] Final|BlueprintAuthorityOnly|Exec|Native|Private 
};
...
public:
	...
	// void ServerPinAccolade(FName AccoladeName);                                                                              // [0xb33af14] Final|Net|NetReliableNative|Event|Private|NetServer 
	// Function /Script/AccoladesRuntime.FortControllerComponent_AccoladeCollection.ServerMarkAccoladesAsSeen
	// void ServerMarkAccoladesAsSeen(TArray<FName> AccoladeNames);                                                             // [0x954b528] Final|Net|NetReliableNative|Event|Private|NetServer 
	// Function /Script/AccoladesRuntime.FortControllerComponent_AccoladeCollection.HandlePlayerProfileInitialized
	// void HandlePlayerProfileInitialized();                                                                                   // [0xb33aec8] Final|Native|Private 
	// Function /Script/AccoladesRuntime.FortControllerComponent_AccoladeCollection.HandlePinnedQuestChanged
	// void HandlePinnedQuestChanged(FAthenaPinnedQuestData& PinnedQuestData);                                                  // [0xb33ae3c] Final|Native|Private|HasOutParms 
	// Function /Script/AccoladesRuntime.FortControllerComponent_AccoladeCollection.ClientResetAccoladeData
	// void ClientResetAccoladeData();                                                                                          // [0x8a24830] Final|Net|NetReliableNative|Event|Private|NetClient 
};
