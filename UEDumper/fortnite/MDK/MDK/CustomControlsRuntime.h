...
public:
	...
	// class UFortControllerComponent_CustomControls* GetOwningComponent();                                                     // [0xc6994bc] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CustomControlsRuntime.CustomControlOptions_Base.BP_OnDeactivate
	// void BP_OnDeactivate();                                                                                                  // [0x20c3f9c] Event|Protected|BlueprintEvent 
	// Function /Script/CustomControlsRuntime.CustomControlOptions_Base.BP_OnActivate
	// void BP_OnActivate();                                                                                                    // [0x20c3f9c] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void BP_InitRetentionTargetingPreset(class UTargetingPreset* Preset);                                                    // [0x20c3f9c] Event|Protected|BlueprintEvent 
	// Function /Script/CustomControlsRuntime.CustomControlOptions_ThirdPerson.BP_InitRangedTargetingPreset
	// void BP_InitRangedTargetingPreset(class UTargetingPreset* Preset);                                                       // [0x20c3f9c] Event|Protected|BlueprintEvent 
	// Function /Script/CustomControlsRuntime.CustomControlOptions_ThirdPerson.BP_InitMeleeTargetingPreset
	// void BP_InitMeleeTargetingPreset(class UTargetingPreset* Preset);                                                        // [0x20c3f9c] Event|Protected|BlueprintEvent 
	// Function /Script/CustomControlsRuntime.CustomControlOptions_ThirdPerson.BP_InitAimingTargetingPreset
	// void BP_InitAimingTargetingPreset(class UTargetingPreset* Preset);                                                       // [0x20c3f9c] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void WeaponGetAimRotOverride(class AFortWeapon* Weapon, EFortAbilityTargetingSource TargetingSource, FRotator& OutOverrideAimRot, bool& bOutExecutionResult); // [0xc699904] Final|Native|Private|HasOutParms|HasDefaults 
	// Function /Script/CustomControlsRuntime.FortControllerComponent_CustomControls.SetOptionsPriority
	// bool SetOptionsPriority(class UObject* ContextObject, float Priority, bool bRefreshRelativePriority);                    // [0xc699764] Final|Native|Public|BlueprintCallable 
	// Function /Script/CustomControlsRuntime.FortControllerComponent_CustomControls.SetOptionsEnabled
	// bool SetOptionsEnabled(class UObject* ContextObject, bool bEnabled);                                                     // [0xc6996a0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CustomControlsRuntime.FortControllerComponent_CustomControls.ServerSetUseDesiredRotationOverride
	// void ServerSetUseDesiredRotationOverride(bool bNewUseDesiredRotationOverride);                                           // [0x90d47a0] Final|Net|NetReliableNative|Event|Private|NetServer 
	// Function /Script/CustomControlsRuntime.FortControllerComponent_CustomControls.ServerSetOptionsQueueBlocked
	// void ServerSetOptionsQueueBlocked(bool bIsBlocked);                                                                      // [0x9541a00] Final|Net|NetReliableNative|Event|Private|NetServer 
	// Function /Script/CustomControlsRuntime.FortControllerComponent_CustomControls.ServerSetFocusTarget
	// void ServerSetFocusTarget(class AActor* NewFocusTarget);                                                                 // [0xa928ce4] Final|Net|NetReliableNative|Event|Private|NetServer 
	// Function /Script/CustomControlsRuntime.FortControllerComponent_CustomControls.ServerSetDesiredAimTargetOffset
	// void ServerSetDesiredAimTargetOffset(float NewDesiredAimTargetOffset);                                                   // [0xc69961c] Final|Net|NetReliableNative|Event|Private|NetServer 
	// Function /Script/CustomControlsRuntime.FortControllerComponent_CustomControls.ServerResetAimTargetOffset
	// void ServerResetAimTargetOffset();                                                                                       // [0x8ce98d4] Final|Net|NetReliableNative|Event|Private|NetServer 
	// Function /Script/CustomControlsRuntime.FortControllerComponent_CustomControls.RemoveOptions
	// void RemoveOptions(class UObject* ContextObject);                                                                        // [0xc69959c] Final|Native|Public|BlueprintCallable 
	// Function /Script/CustomControlsRuntime.FortControllerComponent_CustomControls.OnRep_ActiveOptions
	// void OnRep_ActiveOptions(class UCustomControlOptions_Base* OldOptions);                                                  // [0xc699518] Final|Native|Private 
	// Function /Script/CustomControlsRuntime.FortControllerComponent_CustomControls.GetOptions
	// class UCustomControlOptions_Base* GetOptions(class UObject* ContextObject);                                              // [0xc699420] Final|Native|Public|BlueprintCallable 
	// Function /Script/CustomControlsRuntime.FortControllerComponent_CustomControls.GetMovementModeLogic
	// class UFortMovementMode_BaseExtLogic* GetMovementModeLogic();                                                            // [0xc6993fc] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CustomControlsRuntime.FortControllerComponent_CustomControls.CreateOptions
	// class UCustomControlOptions_Base* CreateOptions(class UClass* OptionsClass);                                             // [0xc699304] Final|Native|Public|BlueprintCallable 
	// Function /Script/CustomControlsRuntime.FortControllerComponent_CustomControls.ClientRegisterTagsQueries
	// void ClientRegisterTagsQueries();                                                                                        // [0x9387564] Final|Net|NetReliableNative|Event|Private|NetClient 
	// Function /Script/CustomControlsRuntime.FortControllerComponent_CustomControls.AddOptions
	// bool AddOptions(class UObject* ContextObject, class UCustomControlOptions_Base* Options, float Priority, bool bEnabled); // [0xc6990ec] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void SetStickRotation(FRotator& InStickRotation);                                                                        // [0xc699878] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
};
