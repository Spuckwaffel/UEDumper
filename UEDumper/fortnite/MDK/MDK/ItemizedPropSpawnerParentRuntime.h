...
public:
	...
	// void HandleAbilityRejectedOnClient(class AFortWeapon* SourceWeapon);                                                     // [0x20c3f9c] Event|Public|BlueprintEvent 
};
...
public:
	...
	// bool NativeShouldDestroyOverlappedActor(class AActor* Actor, FGameplayTagContainer& TagsToDestroyOverlappedActor);       // [0xbd18320] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/ItemizedPropSpawnerParentRuntime.EmeraldGlassIceWallChunk.NativeShouldActorBlockSpawn
	// bool NativeShouldActorBlockSpawn(class AActor* Actor, bool bShouldLaunch, FGameplayTag& BlockTag);                       // [0xbd181cc] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/ItemizedPropSpawnerParentRuntime.EmeraldGlassIceWallChunk.NativeCheckOverlappedActor
	// void NativeCheckOverlappedActor(FSereneYardOverlappedActorCheckData& CheckData, class AActor* OverlappedActor, TArray<UCapsuleComponent*>& InOutComponentsSetToIgnoreCollision, bool& bInOutShouldPlayImpulseCue, bool& bOutDestroyOverlappedActor, bool& bOutShouldWaitATick, bool& bOutDestroyProp); // [0xbd16e48] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/ItemizedPropSpawnerParentRuntime.EmeraldGlassIceWallChunk.IsIceWallAllowedToOverlapActor
	// bool IsIceWallAllowedToOverlapActor(class AActor* Actor);                                                                // [0xbd16d78] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ItemizedPropSpawnerParentRuntime.EmeraldGlassIceWallChunk.GetComponentsForOverlapCheck
	// void GetComponentsForOverlapCheck(TArray<UPrimitiveComponent*>& OutComponents);                                          // [0x20c3f9c] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure 
	// Function /Script/ItemizedPropSpawnerParentRuntime.EmeraldGlassIceWallChunk.FindSupportingActors
	// void FindSupportingActors(TArray<AActor*>& InOutSupportingActors, bool bAllowIceWallsAsSupportingActors, TArray<AEmeraldGlassIceWallChunk*>& ChunksInMyWall); // [0xbd16568] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/ItemizedPropSpawnerParentRuntime.EmeraldGlassIceWallChunk.AttachActors
	// void AttachActors(TArray<AEmeraldGlassIceWallChunk*>& ChunksInMyWall, TArray<AActor*>& SupportingActors, class AActor* DirectBase); // [0xbd15550] Final|Native|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// void RemoveOldestTrackedInstance();                                                                                      // [0xbd186ac] Final|Native|Public|BlueprintCallable 
	// Function /Script/ItemizedPropSpawnerParentRuntime.FortControllerComponent_SereneYard.GetTrackedInstanceCount
	// int32_t GetTrackedInstanceCount();                                                                                       // [0x65cbba8] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ItemizedPropSpawnerParentRuntime.FortControllerComponent_SereneYard.GetOldestTrackedInstance
	// class ABuildingGameplayActor* GetOldestTrackedInstance();                                                                // [0xbd16d40] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ItemizedPropSpawnerParentRuntime.FortControllerComponent_SereneYard.AddTrackedInstance
	// void AddTrackedInstance(class ABuildingGameplayActor* TrackedInstance);                                                  // [0xbd15420] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// bool NativeUpdateTarget(FSereneYardWeaponData& WeaponData, FVector& outTargetLocation, ESereneYardTargetingFailedReason& OutFailureReason, TArray<bool>& OutValidity); // [0xbd18448] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/ItemizedPropSpawnerParentRuntime.SereneYardFunctionLibraryNative.NativeCheckSpawnValidity
	// bool NativeCheckSpawnValidity(FSereneYardWeaponData& WeaponData, FVector& InOutTargetLocation, float CameraYaw, bool bCheckForAllChunks, TArray<bool>& OutValidity, TArray<double>& OutOffsets, TArray<AActor*>& OutActorsBeingUsedAsBase, ESereneYardTargetingFailedReason& OutFailureReason); // [0xbd17cf8] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/ItemizedPropSpawnerParentRuntime.SereneYardFunctionLibraryNative.BuildPropDataForWeaponData
	// void BuildPropDataForWeaponData(TArray<FNativeItemizedPropSpawner_PropSpawnData>& PropSpawnDataArray, TArray<FTransform>& PropRelativeTransforms, TMap<ESereneYardChunkLocation, int32_t>& ChunkLocationToPropIndexMap); // [0xbd15da4] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
};
