...
public:
	...
	// void OnShowGamemodeDescription(FString ActivityTitle);                                                                   // [0x20c3f9c] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void OnStyleUpdated(FSqueegeeStyleParams& StyleParams);                                                                  // [0x20c3f9c] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/SqueegeeUI.FortContentGateRatingWidget.OnLabelUpdated
	// void OnLabelUpdated(bool bLabelEnabled, FText& LabelText, FText& LabelNumber);                                           // [0x20c3f9c] Event|Protected|HasOutParms|BlueprintEvent 
};
...
public:
	...
	// void OnShowWeaponData();                                                                                                 // [0x20c3f9c] Event|Protected|BlueprintEvent 
	// Function /Script/SqueegeeUI.FortContentManagementDetails.OnShowActivityData
	// void OnShowActivityData(FText& ActivityDisplayName, FText& ActivityDescription, FString CreatorName, FText& LinkCode, bool IsCreative, FDateTime& UnlockTime, class UFortGameActivity* GameActivity); // [0x20c3f9c] Event|Protected|HasOutParms|HasDefaults|BlueprintEvent 
...
public:
	...
	// void OnShowGameActivity(class UFortGameActivity* NewGameActivity);                                                       // [0x20c3f9c] Event|Protected|BlueprintEvent 
	// Function /Script/SqueegeeUI.FortContentManagementButton.OnShowError
	// void OnShowError(FText& ErrorText);                                                                                      // [0x20c3f9c] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/SqueegeeUI.FortContentManagementButton.OnChangeManagementState
	// void OnChangeManagementState(EFortContentManagementState NewState);                                                      // [0x20c3f9c] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void OnSetLabel(FText& InText);                                                                                          // [0x20c3f9c] Event|Protected|HasOutParms|BlueprintEvent 
};
...
public:
	...
	// void ResetUnlockList();                                                                                                  // [0xbf2d798] Final|Native|Protected|BlueprintCallable 
	// Function /Script/SqueegeeUI.FortContentManagementList.RequestNextUnlockPage
	// void RequestNextUnlockPage();                                                                                            // [0xbf2d784] Final|Native|Protected|BlueprintCallable 
	// Function /Script/SqueegeeUI.FortContentManagementList.OnNextUnlockPageRequestCompleted
	// void OnNextUnlockPageRequestCompleted(bool bSuccess);                                                                    // [0x20c3f9c] Event|Protected|BlueprintEvent 
	// Function /Script/SqueegeeUI.FortContentManagementList.CanRequestNextUnlockPage
	// bool CanRequestNextUnlockPage();                                                                                         // [0xbf2d74c] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void ExitScreen();                                                                                                       // [0xbf2d770] Final|Native|Protected|BlueprintCallable 
};
