...
/// Class /Script/EpicMediaCDNHostnames.EpicMediaCDNHostnames
...
public:
	...
	// FString GetSelectedHostName();                                                                                           // [0x8597b0c] Final|Native|Public|BlueprintCallable 
	// Function /Script/EpicMediaCDNHostnames.EpicMediaCDNHostnames.GetHostnames
	// TArray<FString> GetHostnames();                                                                                          // [0x8597ad0] Final|Native|Public|BlueprintCallable 
};
