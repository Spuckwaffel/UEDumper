...
public:
	...
	// void SuspendSimulation();                                                                                                // [0xd2c6fa8] Final|Native|Public|BlueprintCallable 
	// Function /Script/ChaosClothAssetEngine.ChaosClothComponent.SetEnableSimulation
	// void SetEnableSimulation(bool bEnable);                                                                                  // [0xd2c40ac] Final|Native|Public|BlueprintCallable 
	// Function /Script/ChaosClothAssetEngine.ChaosClothComponent.SetClothAsset
	// void SetClothAsset(class UChaosClothAsset* InClothAsset);                                                                // [0xd2c4024] Final|Native|Public|BlueprintCallable 
	// Function /Script/ChaosClothAssetEngine.ChaosClothComponent.ResumeSimulation
	// void ResumeSimulation();                                                                                                 // [0xd2c400c] Final|Native|Public|BlueprintCallable 
	// Function /Script/ChaosClothAssetEngine.ChaosClothComponent.ResetTeleportMode
	// void ResetTeleportMode();                                                                                                // [0xd2c3ff4] Final|Native|Public|BlueprintCallable 
	// Function /Script/ChaosClothAssetEngine.ChaosClothComponent.ResetConfigProperties
	// void ResetConfigProperties();                                                                                            // [0xd2c3fe0] Final|Native|Public|BlueprintCallable 
	// Function /Script/ChaosClothAssetEngine.ChaosClothComponent.RecreateClothSimulationProxy
	// void RecreateClothSimulationProxy();                                                                                     // [0xd2c3fcc] Final|Native|Public|BlueprintCallable 
	// Function /Script/ChaosClothAssetEngine.ChaosClothComponent.IsSimulationSuspended
	// bool IsSimulationSuspended();                                                                                            // [0xd2c3fa8] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ChaosClothAssetEngine.ChaosClothComponent.IsSimulationEnabled
	// bool IsSimulationEnabled();                                                                                              // [0xd2c3f84] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ChaosClothAssetEngine.ChaosClothComponent.GetClothOutfitInteractor
	// class UChaosClothAssetInteractor* GetClothOutfitInteractor();                                                            // [0xd2c12ec] Final|Native|Public|BlueprintCallable 
	// Function /Script/ChaosClothAssetEngine.ChaosClothComponent.GetClothAsset
	// class UChaosClothAsset* GetClothAsset();                                                                                 // [0xd2c12c8] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ChaosClothAssetEngine.ChaosClothComponent.ForceNextUpdateTeleportAndReset
	// void ForceNextUpdateTeleportAndReset();                                                                                  // [0xd2c120c] Final|Native|Public|BlueprintCallable 
	// Function /Script/ChaosClothAssetEngine.ChaosClothComponent.ForceNextUpdateTeleport
	// void ForceNextUpdateTeleport();                                                                                          // [0xd2c11ec] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// class UPhysicsAsset* GetShadowPhysicsAsset();                                                                            // [0x6e418e8] Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void SetWeightedFloatValue(FString PropertyName, int32_t LODIndex, FVector2D Value);                                     // [0xd2c676c] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/ChaosClothAssetEngine.ChaosClothAssetInteractor.SetVectorValue
	// void SetVectorValue(FString PropertyName, int32_t LODIndex, FVector Value);                                              // [0xd2c5f0c] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/ChaosClothAssetEngine.ChaosClothAssetInteractor.SetLowFloatValue
	// void SetLowFloatValue(FString PropertyName, int32_t LODIndex, float Value);                                              // [0xd2c57c4] Final|Native|Public|BlueprintCallable 
	// Function /Script/ChaosClothAssetEngine.ChaosClothAssetInteractor.SetIntValue
	// void SetIntValue(FString PropertyName, int32_t LODIndex, int32_t Value);                                                 // [0xd2c4fc8] Final|Native|Public|BlueprintCallable 
	// Function /Script/ChaosClothAssetEngine.ChaosClothAssetInteractor.SetHighFloatValue
	// void SetHighFloatValue(FString PropertyName, int32_t LODIndex, float Value);                                             // [0xd2c4880] Final|Native|Public|BlueprintCallable 
	// Function /Script/ChaosClothAssetEngine.ChaosClothAssetInteractor.SetFloatValue
	// void SetFloatValue(FString PropertyName, int32_t LODIndex, float Value);                                                 // [0xd2c4138] Final|Native|Public|BlueprintCallable 
	// Function /Script/ChaosClothAssetEngine.ChaosClothAssetInteractor.GetWeightedFloatValue
	// FVector2D GetWeightedFloatValue(FString PropertyName, int32_t LODIndex, FVector2D DefaultValue);                         // [0xd2c3830] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ChaosClothAssetEngine.ChaosClothAssetInteractor.GetVectorValue
	// FVector GetVectorValue(FString PropertyName, int32_t LODIndex, FVector DefaultValue);                                    // [0xd2c30c8] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ChaosClothAssetEngine.ChaosClothAssetInteractor.GetStringValue
	// FString GetStringValue(FString PropertyName, int32_t LODIndex, FString DefaultValue);                                    // [0xd2c2900] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ChaosClothAssetEngine.ChaosClothAssetInteractor.GetLowFloatValue
	// float GetLowFloatValue(FString PropertyName, int32_t LODIndex, float DefaultValue);                                      // [0xd2c1304] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ChaosClothAssetEngine.ChaosClothAssetInteractor.GetIntValue
	// int32_t GetIntValue(FString PropertyName, int32_t LODIndex, int32_t DefaultValue);                                       // [0xd2c217c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ChaosClothAssetEngine.ChaosClothAssetInteractor.GetHighFloatValue
	// float GetHighFloatValue(FString PropertyName, int32_t LODIndex, float DefaultValue);                                     // [0xd2c1a40] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ChaosClothAssetEngine.ChaosClothAssetInteractor.GetFloatValue
	// float GetFloatValue(FString PropertyName, int32_t LODIndex, float DefaultValue);                                         // [0xd2c1304] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ChaosClothAssetEngine.ChaosClothAssetInteractor.GetAllProperties
	// TArray<FString> GetAllProperties(int32_t LODIndex);                                                                      // [0xd2c1224] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
