...
public:
	...
	// void SetEnabled(bool bInEnabled);                                                                                        // [0xb281e24] Final|Native|Protected|BlueprintCallable 
	// Function /Script/VerseDevices.ScriptDevice.BP_SetVisibility
	// void BP_SetVisibility(bool bVisible);                                                                                    // [0x20c3f9c] Event|Public|BlueprintEvent 
};
...
public:
	...
	// void HandleOnActorEndPlay(class AActor* Actor, TEnumAsByte<EEndPlayReason> EndPlayReason);                               // [0xb281d60] Final|Native|Private 
};
