...
public:
	...
	// bool TryGetResults(FName& Name, FHarmonixAudioAnalyzerResults& Results);                                                 // [0xb7eb8fc] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/HarmonixAudioReactivity.HarmonixAudioAnalyzerResultsDispatcher.HasProvider
	// bool HasProvider(FName& Name);                                                                                           // [0xb7eb788] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void SetArbitraryTextureData(TArray<float>& ArbitraryTextureData);                                                       // [0xb7eb820] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/HarmonixAudioReactivity.HarmonixAudioAnalyzerResultsProvider.CreateHarmonixAudioAnalyzerResultsProvider
	// class UHarmonixAudioAnalyzerResultsProvider* CreateHarmonixAudioAnalyzerResultsProvider(FName Name);                     // [0xb7eb658] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// int32_t GetCurrentTextureWidth();                                                                                        // [0x9f79144] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/HarmonixAudioReactivity.HarmonixTextureBase.GetCurrentTextureHeight
	// int32_t GetCurrentTextureHeight();                                                                                       // [0xb7eb770] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
