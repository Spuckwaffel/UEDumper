...
public:
	...
	// FCosmeticsEventHandle RegisterOnCosmeticApplicationCompleted_BP(FDelegateProperty& Delegate, int32_t Flags);             // [0x867c408] Native|Public|HasOutParms|BlueprintCallable 
};
