...
public:
	...
	// void OnVehicleStateChanged(ENevadaFlightStates VehicleState);                                                            // [0x20c3f9c] Event|Protected|BlueprintEvent 
	// Function /Script/NevadaUI.FortNevadaVehicleReticle.OnTractorBeamEnabledChanged
	// void OnTractorBeamEnabledChanged(bool bEnabled);                                                                         // [0x20c3f9c] Event|Protected|BlueprintEvent 
	// Function /Script/NevadaUI.FortNevadaVehicleReticle.OnTractorBeamDetached
	// void OnTractorBeamDetached();                                                                                            // [0x20c3f9c] Event|Protected|BlueprintEvent 
	// Function /Script/NevadaUI.FortNevadaVehicleReticle.OnTractorBeamDeactivated
	// void OnTractorBeamDeactivated(float Cooldown);                                                                           // [0x20c3f9c] Event|Protected|BlueprintEvent 
	...
	// void OnEnergyCanonFired(float Cooldown);                                                                                 // [0x20c3f9c] Event|Protected|BlueprintEvent 
	// Function /Script/NevadaUI.FortNevadaVehicleReticle.OnEnergyCannonEnabledChanged
	// void OnEnergyCannonEnabledChanged(bool bEnabled);                                                                        // [0x20c3f9c] Event|Protected|BlueprintEvent 
	// Function /Script/NevadaUI.FortNevadaVehicleReticle.OnBatteryChanged
	// void OnBatteryChanged(float BatteryLevel);                                                                               // [0x20c3f9c] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void OnTractorBeamAttached(bool bAttached);                                                                              // [0x20c3f9c] Event|Protected|BlueprintEvent 
	// Function /Script/NevadaUI.NevadaTargetIndicator.OnTractorBeamActivated
	// void OnTractorBeamActivated(bool bActivated);                                                                            // [0x20c3f9c] Event|Protected|BlueprintEvent 
};
