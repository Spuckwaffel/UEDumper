...
public:
	...
	// FTransform GetOffsetRootTransform(FAnimNodeReference& Node);                                                             // [0xd2a70fc] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/AnimationWarpingRuntime.AnimationWarpingLibrary.GetCurveValueFromAnimation
	// bool GetCurveValueFromAnimation(class UAnimSequenceBase* Animation, FName CurveName, float Time, float& OutValue);       // [0xd2a6d8c] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
};
