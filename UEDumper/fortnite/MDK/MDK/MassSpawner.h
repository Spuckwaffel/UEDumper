...
public:
	...
	// void UnloadConfig();                                                                                                     // [0xb2974d8] Final|Native|Public|BlueprintCallable 
	// Function /Script/MassSpawner.MassSpawner.ScaleSpawningCount
	// void ScaleSpawningCount(float Scale);                                                                                    // [0xb297458] Final|Native|Public|BlueprintCallable 
	// Function /Script/MassSpawner.MassSpawner.GetSpawningCountScale
	// float GetSpawningCountScale();                                                                                           // [0xaaa9c20] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MassSpawner.MassSpawner.GetCount
	// int32_t GetCount();                                                                                                      // [0xb297440] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MassSpawner.MassSpawner.DoSpawning
	// void DoSpawning();                                                                                                       // [0xb29742c] Final|Native|Public|BlueprintCallable 
	// Function /Script/MassSpawner.MassSpawner.DoDespawning
	// void DoDespawning();                                                                                                     // [0xb297418] Final|Native|Public|BlueprintCallable 
	// Function /Script/MassSpawner.MassSpawner.ClearTemplates
	// void ClearTemplates();                                                                                                   // [0xb297404] Final|Native|Public|BlueprintCallable 
};
