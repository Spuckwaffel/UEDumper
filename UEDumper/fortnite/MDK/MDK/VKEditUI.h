...
public:
	...
	// void OnMinigameStateChanged(EFortMinigameState MinigameState, EFortMinigameState PreviousMinigameState);                 // [0x20c3f9c] Event|Protected|BlueprintEvent 
	// Function /Script/VKEditUI.VKConnectionIndicator.HandleMemorySamplerProgressUpdated
	// void HandleMemorySamplerProgressUpdated(float Progress);                                                                 // [0xcabe1e0] Final|Native|Private 
};
...
public:
	...
	// void HandleGameStateInitialized(class AFortGameState* GameState);                                                        // [0xcabe160] Final|Native|Protected 
	// Function /Script/VKEditUI.VKDebugMessagesBase.BP_OnGameStateInitialized
	// void BP_OnGameStateInitialized(class AFortGameState* GameState);                                                         // [0x20c3f9c] Event|Protected|BlueprintEvent 
};
