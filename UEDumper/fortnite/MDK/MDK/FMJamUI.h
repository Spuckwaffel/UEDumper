...
public:
	...
	// void HandlePickerOpenRequest(EFortPickerMode Mode, int32_t InitialOption, bool bIgnoreFirstAccept);                      // [0xb7e8c80] Final|Native|Private 
};
...
public:
	...
	// void RebuildJamSongIndicatorsForPlayspace(class AJamPlayspace* Playspace);                                               // [0xb7e8d78] Final|Native|Public|BlueprintCallable 
	// Function /Script/FMJamUI.JamUIManagerComponent_SongIndicators.ClearJamIndicators
	// void ClearJamIndicators();                                                                                               // [0xb7e8c00] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void OnInitInfo(class UCatalogData* Song, EFMJamLoopType Type);                                                          // [0x20c3f9c] Event|Protected|BlueprintEvent 
	...
	// class AFortPlayerStateAthena* GetIndicatedPlayerStateAthena();                                                           // [0xb7e8c14] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
