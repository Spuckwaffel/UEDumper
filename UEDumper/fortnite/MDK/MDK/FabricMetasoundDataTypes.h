...
public:
	...
	// TArray<FText> GetSampleLabels();                                                                                         // [0xc07cc98] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	CMember(class USoundWave*)                         WaveAsset                                                   OFFSET(get<T>, {0x18, 8, 0, 0})
};
