...
public:
	...
	CMember(class UTransformProxy*)                    ActiveTarget                                                OFFSET(get<T>, {0xA8, 8, 0, 0})
...
public:
	CMember(class UToolTarget*)                        Target                                                      OFFSET(get<T>, {0xA8, 8, 0, 0})
};
...
public:
	CMember(class UBrushBaseProperties*)               BrushProperties                                             OFFSET(get<T>, {0x108, 8, 0, 0})
...
public:
	CMember(TArray<class UToolTarget*>)                Targets                                                     OFFSET(get<T>, {0xA8, 16, 0, 0})
};
