...
public:
	...
	// void BP_ProcessViewRotation(FRotator& InViewRotation, FRotator& InDeltaRot, float DeltaTime, bool& bOutShouldOverride, FRotator& OutViewRotation, FRotator& OutDeltaRot); // [0x20c3f9c] Event|Public|HasOutParms|HasDefaults|BlueprintEvent|Const 
};
...
public:
	...
	// bool CanBeginFlying();                                                                                                   // [0x31ddd98] Native|Event|Public|BlueprintEvent|Const 
};
