...
public:
	...
	// void BlockScreenContent(bool bBlockScreen, FText& ContentBlockedText);                                                   // [0x186becc] Event|Protected|HasOutParms|BlueprintEvent 
};
...
public:
	...
	// void OnAthenaProfileInitialized();                                                                                       // [0x3d6dec0] Final|Native|Private 
};
...
public:
	...
	// void OnTemporaryItemsStateChanged();                                                                                     // [0xb71db28] Final|Native|Private 
};
...
public:
	...
	// void SetTileView(class UTileView* InTileView);                                                                           // [0xa4a734c] Final|Native|Protected|BlueprintCallable 
	// Function /Script/CrewUI.FortTemporaryItemsRow.GetCategoryText
	// FText GetCategoryText(EAthenaCustomizationCategory InCategory);                                                          // [0xb71d860] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	CMember(class UAthenaRewardItemTypeRarityTag*)     Widget_ItemTypeRarityTag                                    OFFSET(get<T>, {0x2E8, 8, 0, 0})
	CMember(class UCommonTextBlock*)                   Text_ItemName                                               OFFSET(get<T>, {0x2F0, 8, 0, 0})
	...
	// void SetData(class UFortSubscriptionVM* SubscriptionVM, class UFortTemporaryItemsRewardVM* RewardVM);                    // [0xb71dca8] Final|Native|Public|BlueprintCallable 
	// Function /Script/CrewUI.FortTemporaryItemsScreenItemInfo.OnDataSet
	// void OnDataSet(bool bValidItem, bool bIsSubscribed, bool IsOwned);                                                       // [0x186becc] Event|Protected|BlueprintEvent 
};
...
public:
	CMember(class UFortCosmeticItemCard*)              ItemCard                                                    OFFSET(get<T>, {0x1498, 8, 0, 0})


	/// Functions
	// Function /Script/CrewUI.FortTemporaryItemsTileButton.SetupRewardItem
	// void SetupRewardItem(class UFortAccountItemDefinition* ItemDef);                                                         // [0xb71dde8] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	CMember(class UCommonTextBlock*)                   Text_Label                                                  OFFSET(get<T>, {0x1530, 8, 0, 0})
	CMember(class UCommonTextBlock*)                   Text_SecondaryLabel                                         OFFSET(get<T>, {0x1538, 8, 0, 0})
	CMember(class UCommonTextBlock*)                   Text_FinalCost                                              OFFSET(get<T>, {0x1540, 8, 0, 0})
	CMember(class UWidget*)                            Container_SecondaryLabel                                    OFFSET(get<T>, {0x1548, 8, 0, 0})


	/// Functions
	// Function /Script/CrewUI.BattlePassCrewPurchaseButton.OnCurrencyUpdated
	// void OnCurrencyUpdated();                                                                                                // [0x186becc] Event|Protected|BlueprintEvent 
};
...
public:
	...
	CMember(class UCommonActivatableWidgetSwitcher*)   Switcher_ContentContainer                                   OFFSET(get<T>, {0x430, 8, 0, 0})
	CMember(class UBattlePassPurchaseScreen*)          BattlePassPurchaseScreen                                    OFFSET(get<T>, {0x438, 8, 0, 0})
	CMember(class UWidgetAnimation*)                   Intro                                                       OFFSET(get<T>, {0x440, 8, 0, 0})
	CMember(class UWidgetAnimation*)                   QuickIntro                                                  OFFSET(get<T>, {0x448, 8, 0, 0})
	CMember(class UWidgetAnimation*)                   CrewBenefitsIntro                                           OFFSET(get<T>, {0x450, 8, 0, 0})
	CMember(class UClass*)                             CrewSubscriptionErrorModalClass                             OFFSET(get<T>, {0x458, 8, 0, 0})


	/// Functions
	// Function /Script/CrewUI.BattlePassCrewPurchaseContainer.OnTriggerIntroAnimation
	// void OnTriggerIntroAnimation(bool bCanClaimRewards);                                                                     // [0x186becc] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.BattlePassCrewPurchaseContainer.OnContentStateUpdated
	// void OnContentStateUpdated(EBattlePassCrewContentState InState, bool bInScreenOpened);                                   // [0x186becc] Event|Protected|BlueprintEvent 
};
...
public:
	CMember(class UCommonRichTextBlock*)               Text_Season                                                 OFFSET(get<T>, {0x2E8, 8, 0, 0})
};
...
public:
	...
	CMember(class UClass*)                             PurchaseCompleteModal                                       OFFSET(get<T>, {0x4F0, 8, 0, 0})
	CMember(class UCommonButtonBase*)                  Button_ToCrew                                               OFFSET(get<T>, {0x4F8, 8, 0, 0})
	CMember(class UBattlePassCrewPurchaseButton*)      Button_Purchase                                             OFFSET(get<T>, {0x500, 8, 0, 0})
	CMember(class UCommonButtonBase*)                  Button_MoreInfo                                             OFFSET(get<T>, {0x508, 8, 0, 0})
	CMember(class UCommonButtonBase*)                  Button_GiftBattlePass                                       OFFSET(get<T>, {0x510, 8, 0, 0})
	CMember(class UBattlePassCrewPurchaseButton*)      Button_ConfirmBase                                          OFFSET(get<T>, {0x518, 8, 0, 0})
	CMember(class UBattlePassCrewPurchaseButton*)      Button_ConfirmBundle                                        OFFSET(get<T>, {0x520, 8, 0, 0})
	CMember(class UBattlePassSeasonHeading*)           Heading_Primary                                             OFFSET(get<T>, {0x528, 8, 0, 0})
	CMember(class UBattlePassSeasonHeading*)           Heading_Secondary                                           OFFSET(get<T>, {0x530, 8, 0, 0})
	CMember(class UCommonRichTextBlock*)               RichText_Disclaimer                                         OFFSET(get<T>, {0x538, 8, 0, 0})
	CMember(class UCommonTextBlock*)                   Text_Description                                            OFFSET(get<T>, {0x540, 8, 0, 0})
	CMember(class UCommonAnimatedSwitcher*)            Switcher_PurchaseState                                      OFFSET(get<T>, {0x548, 8, 0, 0})


	/// Functions
	// Function /Script/CrewUI.BattlePassPurchaseScreen.RefreshFocus
	// void RefreshFocus();                                                                                                     // [0x3d6f348] Final|Native|Protected|BlueprintCallable 
	// Function /Script/CrewUI.BattlePassPurchaseScreen.OnShowNavButtonNotification
	// void OnShowNavButtonNotification(bool bShowNotification);                                                                // [0x186becc] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.BattlePassPurchaseScreen.OnSetScreenInteractable
	// void OnSetScreenInteractable(bool bInteractable);                                                                        // [0x186becc] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.BattlePassPurchaseScreen.OnSetNavButtonNotificationText
	// void OnSetNavButtonNotificationText(FText& NotificationText);                                                            // [0x186becc] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/CrewUI.BattlePassPurchaseScreen.OnPurchaseStateChanged
	// void OnPurchaseStateChanged(EBattlePassPurchaseState InCurrentState);                                                    // [0x186becc] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.BattlePassPurchaseScreen.OnPurchaseConfirmed
	// void OnPurchaseConfirmed();                                                                                              // [0x186becc] Event|Protected|BlueprintEvent 
};
...
public:
	CMember(class UDynamicEntryBox*)                   EntryBox_BulletPoints                                       OFFSET(get<T>, {0x408, 8, 0, 0})
	CMember(class UCommonButtonBase*)                  Button_OpenHowToURL                                         OFFSET(get<T>, {0x410, 8, 0, 0})
	CMember(class UCommonButtonBase*)                  Button_TextURL                                              OFFSET(get<T>, {0x418, 8, 0, 0})
	CMember(class UCommonButtonBase*)                  Button_DoNotRemind                                          OFFSET(get<T>, {0x420, 8, 0, 0})
	CMember(class UCommonButtonBase*)                  Button_Close                                                OFFSET(get<T>, {0x428, 8, 0, 0})
	CMember(class UCommonButtonBase*)                  Button_TouchClose                                           OFFSET(get<T>, {0x430, 8, 0, 0})
	...
	// void OnSetHowToCancelURL(FString MoreInfoUrl);                                                                           // [0x186becc] Event|Protected|BlueprintEvent 
};
...
public:
	CMember(class UCommonButtonBase*)                  Button_Accept                                               OFFSET(get<T>, {0x408, 8, 0, 0})
	CMember(class UCommonButtonBase*)                  Button_CancelSubscription                                   OFFSET(get<T>, {0x410, 8, 0, 0})
	CMember(class UCommonButtonBase*)                  Button_MoreInfo                                             OFFSET(get<T>, {0x418, 8, 0, 0})
	...
	// void OnSetPriceChangeAcknowledgeTitle(FText& Title);                                                                     // [0x186becc] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/CrewUI.CrewPriceChangeAcknowledgeModal.OnSetPriceChangeAcknowledgeMoreInfoUrl
	// void OnSetPriceChangeAcknowledgeMoreInfoUrl(FText& MoreInfoUrl);                                                         // [0x186becc] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/CrewUI.CrewPriceChangeAcknowledgeModal.OnSetPriceChangeAcknowledgeMoreInfoText
	// void OnSetPriceChangeAcknowledgeMoreInfoText(FText& ConfirmButtonText);                                                  // [0x186becc] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/CrewUI.CrewPriceChangeAcknowledgeModal.OnSetPriceChangeAcknowledgeConfirmButtonText
	// void OnSetPriceChangeAcknowledgeConfirmButtonText(FText& ConfirmButtonText);                                             // [0x186becc] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/CrewUI.CrewPriceChangeAcknowledgeModal.OnSetPriceChangeAcknowledgeCheckboxText
	// void OnSetPriceChangeAcknowledgeCheckboxText(FText& CheckboxText);                                                       // [0x186becc] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/CrewUI.CrewPriceChangeAcknowledgeModal.OnSetPriceChangeAcknowledgeCancelSubscriptionButtonText
	// void OnSetPriceChangeAcknowledgeCancelSubscriptionButtonText(FText& CancelSubscriptionButtonText);                       // [0x186becc] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/CrewUI.CrewPriceChangeAcknowledgeModal.OnSetPriceChangeAcknowledgeBodyText
	// void OnSetPriceChangeAcknowledgeBodyText(FText& BodyText);                                                               // [0x186becc] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/CrewUI.CrewPriceChangeAcknowledgeModal.OnSetPriceChangeAcknowledgeBodyTable
	// void OnSetPriceChangeAcknowledgeBodyTable(TArray<FCrewTableRow>& PriceChangeByRegionRows);                               // [0x186becc] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/CrewUI.CrewPriceChangeAcknowledgeModal.OnModalBackout
	// void OnModalBackout();                                                                                                   // [0x186becc] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.CrewPriceChangeAcknowledgeModal.ExitModal
	// void ExitModal();                                                                                                        // [0x755bd9c] Final|Native|Protected|BlueprintCallable 
};
...
public:
	...
	CMember(class UWidget*)                            ContentPurchasedFocusWidget                                 OFFSET(get<T>, {0x4C0, 8, 0, 0})
	CMember(class UWidget*)                            FocusWidget                                                 OFFSET(get<T>, {0x4C8, 8, 0, 0})
	CMember(class UCommonButtonGroupBase*)             ButtonGroup_BenefitsTiles                                   OFFSET(get<T>, {0x4D0, 8, 0, 0})
	...
	CMember(TWeakObjectPtr<UClass*>)                   ContinueModalClass                                          OFFSET(get<T>, {0x558, 32, 0, 0})
	CMember(class UCommonButtonBase*)                  Button_ToBattlePass                                         OFFSET(get<T>, {0x578, 8, 0, 0})
	CMember(class UBattlePassCrewPurchaseButton*)      Button_Purchase                                             OFFSET(get<T>, {0x580, 8, 0, 0})
	CMember(class UBattlePassCrewPurchaseButton*)      Button_Rejoin                                               OFFSET(get<T>, {0x588, 8, 0, 0})
	CMember(class UBattlePassCrewPurchaseButton*)      Button_Continue                                             OFFSET(get<T>, {0x590, 8, 0, 0})
	CMember(class UCommonButtonBase*)                  Button_ResolvePayment                                       OFFSET(get<T>, {0x598, 8, 0, 0})
	CMember(class UCommonButtonBase*)                  Button_WatchTrailer                                         OFFSET(get<T>, {0x5A0, 8, 0, 0})
	CMember(class UCommonButtonBase*)                  Button_Terms                                                OFFSET(get<T>, {0x5A8, 8, 0, 0})
	CMember(class UCommonButtonBase*)                  Button_CancellationInfo                                     OFFSET(get<T>, {0x5B0, 8, 0, 0})
	CMember(class UDynamicEntryBox*)                   EntryBox_RecurringRewards                                   OFFSET(get<T>, {0x5B8, 8, 0, 0})
	CMember(class UDynamicEntryBox*)                   EntryBox_LimitedTimeRewards                                 OFFSET(get<T>, {0x5C0, 8, 0, 0})
	CMember(class UCrewTileDetails*)                   Details_CurrentCrewTile                                     OFFSET(get<T>, {0x5C8, 8, 0, 0})
	CMember(class UCommonTextBlock*)                   Text_LimitedTime                                            OFFSET(get<T>, {0x5D0, 8, 0, 0})
	CMember(class UOverlay*)                           Overlay_UserInformation                                     OFFSET(get<T>, {0x5D8, 8, 0, 0})
	CMember(class UCommonTextBlock*)                   Text_UserInformation                                        OFFSET(get<T>, {0x5E0, 8, 0, 0})
	CMember(class UCommonTextBlock*)                   Text_CrewDisclaimer                                         OFFSET(get<T>, {0x5E8, 8, 0, 0})
	CMember(class UCommonBorder*)                      Border_Disclaimer                                           OFFSET(get<T>, {0x5F0, 8, 0, 0})


	/// Functions
	// Function /Script/CrewUI.CrewPurchaseScreen.OnUserInformationTextsUpdated
	// void OnUserInformationTextsUpdated(FText& UserInformationText1, FText& UserInformationText2, EMcpSubscriptionState SubscriptionState); // [0x186becc] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/CrewUI.CrewPurchaseScreen.OnUpdateVBuckRefundVisibility
	// void OnUpdateVBuckRefundVisibility(bool bVisible);                                                                       // [0x186becc] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.CrewPurchaseScreen.OnUpdatePurchaseButtonState
	// void OnUpdatePurchaseButtonState(ECrewPurchaseButtonState ButtonState);                                                  // [0x186becc] Event|Protected|BlueprintEvent 
	...
	// void OnSetPaymentLegalText(FText& LegalText);                                                                            // [0x186becc] Event|Protected|HasOutParms|BlueprintEvent 
	...
	// void OnContainerTabVisibilityUpdated(bool bTabsVisible, float SpacingAdjustmentForTabs);                                 // [0x186becc] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.CrewPurchaseScreen.EndProgress
	// void EndProgress();                                                                                                      // [0x186becc] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.CrewPurchaseScreen.BeginProgress
	// void BeginProgress(FText& ProgressLabel);                                                                                // [0x186becc] Event|Protected|HasOutParms|BlueprintEvent 
};
...
public:
	...
	CMember(class UImage*)                             Image_TileImage                                             OFFSET(get<T>, {0x14D8, 8, 0, 0})
	CMember(class UCommonTextBlock*)                   Text_TileLabel                                              OFFSET(get<T>, {0x14E0, 8, 0, 0})


	/// Functions
	// Function /Script/CrewUI.CrewRewardTile.OnUpdateOwnedState
	// void OnUpdateOwnedState(bool bOwned);                                                                                    // [0x186becc] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.CrewRewardTile.OnStartingDownloadTileImage
	// void OnStartingDownloadTileImage();                                                                                      // [0x186becc] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.CrewRewardTile.OnDownloadTileImageComplete
	// void OnDownloadTileImageComplete(class UTexture2D* Texture);                                                             // [0x186becc] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.CrewRewardTile.IsMonthlyBenefit
	// bool IsMonthlyBenefit();                                                                                                 // [0xb71dafc] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	CMember(class UBattlePassSeasonHeading*)           Heading_SeasonInfo                                          OFFSET(get<T>, {0x498, 8, 0, 0})
	CMember(class UCommonTextBlock*)                   Text_Description                                            OFFSET(get<T>, {0x4A0, 8, 0, 0})
	CMember(class UCommonButtonBase*)                  Button_Claim                                                OFFSET(get<T>, {0x4A8, 8, 0, 0})
	CMember(class UCommonButtonBase*)                  Button_ResolveIssue                                         OFFSET(get<T>, {0x4B0, 8, 0, 0})
	CMember(class UCommonButtonBase*)                  Button_GiftBattlePass                                       OFFSET(get<T>, {0x4B8, 8, 0, 0})
	CMember(class UCommonRichTextBlock*)               RichText_Disclaimer                                         OFFSET(get<T>, {0x4C0, 8, 0, 0})
};
...
public:
	CMember(class UCrewSubscriptionContentContainer*)  Widget_CrewContentContainer                                 OFFSET(get<T>, {0x4D0, 8, 0, 0})
};
...
public:
	...
	CMember(class UDynamicEntryBox*)                   EntryBox_Tabs                                               OFFSET(get<T>, {0x460, 8, 0, 0})
	CMember(class UCommonButtonGroupBase*)             ButtonGroup_Tabs                                            OFFSET(get<T>, {0x468, 8, 0, 0})
	CMember(class UCommonActivatableWidgetSwitcher*)   Switcher_Tabs                                               OFFSET(get<T>, {0x470, 8, 0, 0})
	CMember(class UWidget*)                            Widget_TabsContainer                                        OFFSET(get<T>, {0x478, 8, 0, 0})
	...
	// void OnTabSelected(int32_t TabIndex);                                                                                    // [0x186becc] Event|Protected|BlueprintEvent 
};
...
public:
	...
	CMember(class UCommonButtonBase*)                  Button_TouchClose                                           OFFSET(get<T>, {0x408, 8, 0, 0})
};
...
public:
	...
	CMember(class UCommonRichTextBlock*)               RichText_Description                                        OFFSET(get<T>, {0x318, 8, 0, 0})
	CMember(class UDynamicEntryBox*)                   EntryBox_Tags                                               OFFSET(get<T>, {0x320, 8, 0, 0})
	CMember(class UCommonButtonBase*)                  Button_MobileMoreInfo                                       OFFSET(get<T>, {0x328, 8, 0, 0})
};
...
public:
	CMember(class UCommonRichTextBlock*)               Text_Label                                                  OFFSET(get<T>, {0x2E8, 8, 0, 0})


	/// Functions
	// Function /Script/CrewUI.CrewTileDetailsTag.OnTagSetup
	// void OnTagSetup(ECrewDetailsTag RewardTag, bool bIsOwnedTag);                                                            // [0x186becc] Event|Protected|BlueprintEvent 
};
...
public:
	CMember(class UCommonActivatableWidgetSwitcher*)   Switcher_PrimaryContent                                     OFFSET(get<T>, {0x438, 8, 0, 0})
	CMember(class UFortProgressiveTableOfContentsScreen*) Widget_ProgressiveTableOfContentsScreen                  OFFSET(get<T>, {0x440, 8, 0, 0})
	CMember(class UFortProgressiveItemScreen*)         Widget_ProgressiveItemScreen                                OFFSET(get<T>, {0x448, 8, 0, 0})
};
...
public:
	CMember(class UCommonTextBlock*)                   Text_CosmeticStage                                          OFFSET(get<T>, {0x2C0, 8, 0, 0})
	CMember(class UCommonRichTextBlock*)               Text_UnlockCriteria                                         OFFSET(get<T>, {0x2C8, 8, 0, 0})
	CMember(class UWidget*)                            Widget_UnlockCriteriaContainer                              OFFSET(get<T>, {0x2D0, 8, 0, 0})
	CMember(class UAthenaRewardItemTypeRarityTag*)     Widget_ItemTypeRarityTag                                    OFFSET(get<T>, {0x2D8, 8, 0, 0})
	CMember(class UWidget*)                            Tag_Owned                                                   OFFSET(get<T>, {0x2E0, 8, 0, 0})
};
...
public:
	...
	// void BP_OnContainerTabVisibilityUpdated(bool bTabsVisible, float SpacingAdjustmentForTabs);                              // [0x186becc] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void OnUpdateSubscriptionState(bool bSubscribed);                                                                        // [0x186becc] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.FortProgressiveItemScreen.OnItemSelected
	// void OnItemSelected();                                                                                                   // [0x186becc] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.FortProgressiveItemScreen.OnErrorStateTextUpdated
	// void OnErrorStateTextUpdated(FText& ErrorStateText);                                                                     // [0x186becc] Event|Protected|HasOutParms|BlueprintEvent 
};
...
public:
	...
	// void BP_OnSetHeaderInfo(FText& Subheading, bool bSubscribed, int32_t UnlockedStages, int32_t MaxStages);                 // [0x186becc] Event|Protected|HasOutParms|BlueprintEvent 
};
...
public:
	CMember(class UAthenaItemShopReactiveTileText*)    TileText_ItemName                                           OFFSET(get<T>, {0x1490, 8, 0, 0})
	...
	// void OnUnhighlighted();                                                                                                  // [0x186becc] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.FortProgressiveItemWidget.OnTileMaterialLoaded
	// void OnTileMaterialLoaded(bool bSubscribed);                                                                             // [0x186becc] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.FortProgressiveItemWidget.OnStageItemChanged
	// void OnStageItemChanged(FProgressiveStageItemInfo& InStageItemInfo);                                                     // [0x186becc] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/CrewUI.FortProgressiveItemWidget.OnPeekStateChanged
	// void OnPeekStateChanged(bool bIsInPeekState);                                                                            // [0x186becc] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.FortProgressiveItemWidget.OnHighlighted
	// void OnHighlighted();                                                                                                    // [0x186becc] Event|Protected|BlueprintEvent 
};
...
public:
	CMember(class UCommonButtonBase*)                  Button_MoreInfo                                             OFFSET(get<T>, {0x2C0, 8, 0, 0})


	/// Functions
	// Function /Script/CrewUI.FortProgressiveSetDetailsWidget.BP_OnUpdateSetDetails
	// void BP_OnUpdateSetDetails(FText& SetName, FText& ExpiringText, bool bCompleted);                                        // [0x186becc] Event|Protected|HasOutParms|BlueprintEvent 
};
...
public:
	CMember(class UAthenaScrollBox*)                   ScrollBox_SetList                                           OFFSET(get<T>, {0x408, 8, 0, 0})
	CMember(class UFortSwipePanel*)                    SwipePanel_Navigation                                       OFFSET(get<T>, {0x410, 8, 0, 0})
	CMember(class UCommonButtonGroupBase*)             ButtonGroup_SetTiles                                        OFFSET(get<T>, {0x418, 8, 0, 0})
	DMember(int32_t)                                   NumTilesPerPage                                             OFFSET(get<int32_t>, {0x420, 4, 0, 0})
	CMember(TArray<class UFortProgressiveSetTile*>)    SetTiles                                                    OFFSET(get<T>, {0x428, 16, 0, 0})


	/// Functions
	// Function /Script/CrewUI.FortProgressiveSetList.ClearSetTiles
	// void ClearSetTiles();                                                                                                    // [0x186becc] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.FortProgressiveSetList.AddSetTile
	// class UFortProgressiveSetTile* AddSetTile();                                                                             // [0x186becc] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void BP_OnTileMaterialLoaded(bool bSubscribed);                                                                          // [0x186becc] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.FortProgressiveSetTile.BP_OnInitializeSetInfo
	// void BP_OnInitializeSetInfo(FProgressiveSetInfo& InSetInfo, FText& BottomText, FText& BottomSubtext, bool bSubscribed);  // [0x186becc] Event|Protected|HasOutParms|BlueprintEvent 
};
...
public:
	CMember(class UCommonButtonGroupBase*)             ButtonGroup_StageItems                                      OFFSET(get<T>, {0x418, 8, 0, 0})
	CMember(class UAthenaScrollBox*)                   ScrollBox_StageList                                         OFFSET(get<T>, {0x420, 8, 0, 0})
	CMember(class UFortSwipePanel*)                    SwipePanel_Navigation                                       OFFSET(get<T>, {0x428, 8, 0, 0})
	CMember(TArray<class UFortProgressiveStageWidget*>) Stages                                                     OFFSET(get<T>, {0x438, 16, 0, 0})


	/// Functions
	// Function /Script/CrewUI.FortProgressiveStageList.SelectStageInDirection
	// void SelectStageInDirection(int32_t Direction);                                                                          // [0xb71db3c] Final|Native|Public|BlueprintCallable 
	// Function /Script/CrewUI.FortProgressiveStageList.ClearStageWidgets
	// void ClearStageWidgets();                                                                                                // [0x186becc] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.FortProgressiveStageList.AddStageWidget
	// class UFortProgressiveStageWidget* AddStageWidget();                                                                     // [0x186becc] Event|Protected|BlueprintEvent 
};
...
public:
	CMember(class UCommonTextBlock*)                   Text_Month                                                  OFFSET(get<T>, {0x2E8, 8, 0, 0})


	/// Functions
	// Function /Script/CrewUI.FortProgressiveStageWidget.OnSetTooltipVisible
	// void OnSetTooltipVisible(bool bVisible);                                                                                 // [0x186becc] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.FortProgressiveStageWidget.OnSetTooltipText
	// void OnSetTooltipText(FText& InToolTipText);                                                                             // [0x186becc] Event|Protected|HasOutParms|BlueprintEvent 
	...
	// void ClearStageItemWidgets();                                                                                            // [0x186becc] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.FortProgressiveStageWidget.AddStageItemWidget
	// class UFortProgressiveItemWidget* AddStageItemWidget();                                                                  // [0x186becc] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void BP_OnUpdateSubscriptionState(bool bSubscribed);                                                                     // [0x186becc] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.FortProgressiveTableOfContentsScreen.BP_OnUpdateNumTilesAvailable
	// void BP_OnUpdateNumTilesAvailable(int32_t NumTiles);                                                                     // [0x186becc] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.FortProgressiveTableOfContentsScreen.BP_OnUpdateErrorStateText
	// void BP_OnUpdateErrorStateText(FText& ErrorStateText);                                                                   // [0x186becc] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/CrewUI.FortProgressiveTableOfContentsScreen.BP_OnUpdateBanner
	// void BP_OnUpdateBanner(FText& BannerText, bool bAllSetsCompleted, bool bSubscribed);                                     // [0x186becc] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/CrewUI.FortProgressiveTableOfContentsScreen.BP_OnSetDescriptionText
	// void BP_OnSetDescriptionText(FText& ProductDescription);                                                                 // [0x186becc] Event|Protected|HasOutParms|BlueprintEvent 
};
...
public:
	...
	// void SetupRowEntry(class UFortTemporaryItemsRow* RewardRow);                                                             // [0xb71dec4] Final|Native|Protected|BlueprintCallable 
	// Function /Script/CrewUI.FortTemporaryItemsScreen.GetSubscriptionVM
	// class UFortSubscriptionVM* GetSubscriptionVM();                                                                          // [0x186becc] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.FortTemporaryItemsScreen.GetRemainingDaysLabel
	// FText GetRemainingDaysLabel(class UFortTemporaryItemsVM* TemporaryItemsVM);                                              // [0xb71d950] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
