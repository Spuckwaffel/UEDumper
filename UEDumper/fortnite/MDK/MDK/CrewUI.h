...
public:
	...
	// void OnAthenaProfileInitialized();                                                                                       // [0x3e2f560] Final|Native|Private 
};
...
public:
	...
	// void OnTemporaryItemsStateChanged();                                                                                     // [0xbc7b888] Final|Native|Private 
};
...
public:
	...
	// void SetTileView(class UTileView* InTileView);                                                                           // [0xa8c7b78] Final|Native|Protected|BlueprintCallable 
	// Function /Script/CrewUI.FortTemporaryItemsRow.GetCategoryText
	// FText GetCategoryText(EAthenaCustomizationCategory InCategory);                                                          // [0xbc7b61c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void SetData(class UFortSubscriptionVM* SubscriptionVM, class UFortTemporaryItemsRewardVM* RewardVM);                    // [0xbc7b9c8] Final|Native|Public|BlueprintCallable 
	// Function /Script/CrewUI.FortTemporaryItemsScreenItemInfo.OnDataSet
	// void OnDataSet(bool bValidItem, bool bIsSubscribed, bool IsOwned);                                                       // [0x20c3f9c] Event|Protected|BlueprintEvent 
};
...
public:
	CMember(class UFortCosmeticItemCard*)              ItemCard                                                    OFFSET(get<T>, {0x14A8, 8, 0, 0})


	/// Functions
	// Function /Script/CrewUI.FortTemporaryItemsTileButton.SetupRewardItem
	// void SetupRewardItem(class UFortAccountItemDefinition* ItemDef);                                                         // [0xbc7ba8c] Final|Native|Public|BlueprintCallable 
};
...
public:
	CMember(EBattlePassPurchaseButtonCurrencyType)     CurrencyType                                                OFFSET(get<T>, {0x1538, 1, 0, 0})
	CMember(class UCommonTextBlock*)                   Text_Label                                                  OFFSET(get<T>, {0x1540, 8, 0, 0})
	CMember(class UCommonTextBlock*)                   Text_SecondaryLabel                                         OFFSET(get<T>, {0x1548, 8, 0, 0})
	CMember(class UCommonTextBlock*)                   Text_FinalCost                                              OFFSET(get<T>, {0x1550, 8, 0, 0})
	CMember(class UWidget*)                            Container_SecondaryLabel                                    OFFSET(get<T>, {0x1558, 8, 0, 0})


	/// Functions
	// Function /Script/CrewUI.BattlePassCrewPurchaseButton.OnCurrencyUpdated
	// void OnCurrencyUpdated();                                                                                                // [0x20c3f9c] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void OnTriggerIntroAnimation(bool bCanClaimRewards);                                                                     // [0x20c3f9c] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.BattlePassCrewPurchaseContainer.OnContentStateUpdated
	// void OnContentStateUpdated(EBattlePassCrewContentState InState, bool bInScreenOpened);                                   // [0x20c3f9c] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void RefreshFocus();                                                                                                     // [0x3e534c0] Final|Native|Protected|BlueprintCallable 
	// Function /Script/CrewUI.BattlePassPurchaseScreen.OnShowNavButtonNotification
	// void OnShowNavButtonNotification(bool bShowNotification);                                                                // [0x20c3f9c] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.BattlePassPurchaseScreen.OnSetScreenInteractable
	// void OnSetScreenInteractable(bool bInteractable);                                                                        // [0x20c3f9c] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.BattlePassPurchaseScreen.OnSetNavButtonNotificationText
	// void OnSetNavButtonNotificationText(FText& NotificationText);                                                            // [0x20c3f9c] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/CrewUI.BattlePassPurchaseScreen.OnPurchaseStateChanged
	// void OnPurchaseStateChanged(EBattlePassPurchaseState InCurrentState);                                                    // [0x20c3f9c] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.BattlePassPurchaseScreen.OnPurchaseConfirmed
	// void OnPurchaseConfirmed();                                                                                              // [0x20c3f9c] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void OnSetHowToCancelURL(FString MoreInfoUrl);                                                                           // [0x20c3f9c] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void OnSetPriceChangeAcknowledgeTitle(FText& Title);                                                                     // [0x20c3f9c] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/CrewUI.CrewPriceChangeAcknowledgeModal.OnSetPriceChangeAcknowledgeMoreInfoUrl
	// void OnSetPriceChangeAcknowledgeMoreInfoUrl(FText& MoreInfoUrl);                                                         // [0x20c3f9c] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/CrewUI.CrewPriceChangeAcknowledgeModal.OnSetPriceChangeAcknowledgeMoreInfoText
	// void OnSetPriceChangeAcknowledgeMoreInfoText(FText& ConfirmButtonText);                                                  // [0x20c3f9c] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/CrewUI.CrewPriceChangeAcknowledgeModal.OnSetPriceChangeAcknowledgeConfirmButtonText
	// void OnSetPriceChangeAcknowledgeConfirmButtonText(FText& ConfirmButtonText);                                             // [0x20c3f9c] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/CrewUI.CrewPriceChangeAcknowledgeModal.OnSetPriceChangeAcknowledgeCheckboxText
	// void OnSetPriceChangeAcknowledgeCheckboxText(FText& CheckboxText);                                                       // [0x20c3f9c] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/CrewUI.CrewPriceChangeAcknowledgeModal.OnSetPriceChangeAcknowledgeCancelSubscriptionButtonText
	// void OnSetPriceChangeAcknowledgeCancelSubscriptionButtonText(FText& CancelSubscriptionButtonText);                       // [0x20c3f9c] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/CrewUI.CrewPriceChangeAcknowledgeModal.OnSetPriceChangeAcknowledgeBodyText
	// void OnSetPriceChangeAcknowledgeBodyText(FText& BodyText);                                                               // [0x20c3f9c] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/CrewUI.CrewPriceChangeAcknowledgeModal.OnSetPriceChangeAcknowledgeBodyTable
	// void OnSetPriceChangeAcknowledgeBodyTable(TArray<FCrewTableRow>& PriceChangeByRegionRows);                               // [0x20c3f9c] Event|Protected|HasOutParms|BlueprintEvent 
	...
	// void ExitModal();                                                                                                        // [0x3e637c4] Final|Native|Protected|BlueprintCallable 
};
...
public:
	...
	// void OnUserInformationTextsUpdated(FText& UserInformationText1, FText& UserInformationText2, EMcpSubscriptionState SubscriptionState); // [0x20c3f9c] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/CrewUI.CrewPurchaseScreen.OnUpdateVBuckRefundVisibility
	// void OnUpdateVBuckRefundVisibility(bool bVisible);                                                                       // [0x20c3f9c] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.CrewPurchaseScreen.OnUpdatePurchaseButtonState
	// void OnUpdatePurchaseButtonState(ECrewPurchaseButtonState ButtonState);                                                  // [0x20c3f9c] Event|Protected|BlueprintEvent 
	...
	// void OnSetPaymentLegalText(FText& LegalText);                                                                            // [0x20c3f9c] Event|Protected|HasOutParms|BlueprintEvent 
	...
	// void OnContainerTabVisibilityUpdated(bool bTabsVisible, float SpacingAdjustmentForTabs);                                 // [0x20c3f9c] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.CrewPurchaseScreen.EndProgress
	// void EndProgress();                                                                                                      // [0x20c3f9c] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.CrewPurchaseScreen.BeginProgress
	// void BeginProgress(FText& ProgressLabel);                                                                                // [0x20c3f9c] Event|Protected|HasOutParms|BlueprintEvent 
};
...
public:
	DMember(float)                                     TileImageStreamoutSeconds                                   OFFSET(get<float>, {0x14E0, 4, 0, 0})
	CMember(class UImage*)                             Image_TileImage                                             OFFSET(get<T>, {0x14E8, 8, 0, 0})
	CMember(class UCommonTextBlock*)                   Text_TileLabel                                              OFFSET(get<T>, {0x14F0, 8, 0, 0})


	/// Functions
	// Function /Script/CrewUI.CrewRewardTile.OnUpdateOwnedState
	// void OnUpdateOwnedState(bool bOwned);                                                                                    // [0x20c3f9c] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.CrewRewardTile.OnStartingDownloadTileImage
	// void OnStartingDownloadTileImage();                                                                                      // [0x20c3f9c] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.CrewRewardTile.OnDownloadTileImageComplete
	// void OnDownloadTileImageComplete(class UTexture2D* Texture);                                                             // [0x20c3f9c] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.CrewRewardTile.IsMonthlyBenefit
	// bool IsMonthlyBenefit();                                                                                                 // [0xbc7b85c] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void OnTabSelected(int32_t TabIndex);                                                                                    // [0x20c3f9c] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void OnTagSetup(ECrewDetailsTag RewardTag, bool bIsOwnedTag);                                                            // [0x20c3f9c] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void BP_OnContainerTabVisibilityUpdated(bool bTabsVisible, float SpacingAdjustmentForTabs);                              // [0x20c3f9c] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void OnUpdateSubscriptionState(bool bSubscribed);                                                                        // [0x20c3f9c] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.FortProgressiveItemScreen.OnItemSelected
	// void OnItemSelected();                                                                                                   // [0x20c3f9c] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.FortProgressiveItemScreen.OnErrorStateTextUpdated
	// void OnErrorStateTextUpdated(FText& ErrorStateText);                                                                     // [0x20c3f9c] Event|Protected|HasOutParms|BlueprintEvent 
};
...
public:
	...
	// void BP_OnSetHeaderInfo(FText& Subheading, bool bSubscribed, int32_t UnlockedStages, int32_t MaxStages);                 // [0x20c3f9c] Event|Protected|HasOutParms|BlueprintEvent 
};

/// Class /Script/CrewUI.FortProgressiveItemWidget
/// Size: 0x0080 (0x0014A0 - 0x001520)
...
public:
	CMember(class UAthenaItemShopReactiveTileText*)    TileText_ItemName                                           OFFSET(get<T>, {0x14A0, 8, 0, 0})
	SMember(FProgressiveStageItemInfo)                 StageItemInfo                                               OFFSET(getStruct<T>, {0x14A8, 96, 0, 0})


	/// Functions
	// Function /Script/CrewUI.FortProgressiveItemWidget.OnUnhighlighted
	// void OnUnhighlighted();                                                                                                  // [0x20c3f9c] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.FortProgressiveItemWidget.OnTileMaterialLoaded
	// void OnTileMaterialLoaded(bool bSubscribed);                                                                             // [0x20c3f9c] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.FortProgressiveItemWidget.OnStageItemChanged
	// void OnStageItemChanged(FProgressiveStageItemInfo& InStageItemInfo);                                                     // [0x20c3f9c] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/CrewUI.FortProgressiveItemWidget.OnPeekStateChanged
	// void OnPeekStateChanged(bool bIsInPeekState);                                                                            // [0x20c3f9c] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.FortProgressiveItemWidget.OnHighlighted
	// void OnHighlighted();                                                                                                    // [0x20c3f9c] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void BP_OnUpdateSetDetails(FText& SetName, FText& ExpiringText, bool bCompleted);                                        // [0x20c3f9c] Event|Protected|HasOutParms|BlueprintEvent 
};
...
public:
	...
	// void ClearSetTiles();                                                                                                    // [0x20c3f9c] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.FortProgressiveSetList.AddSetTile
	// class UFortProgressiveSetTile* AddSetTile();                                                                             // [0x20c3f9c] Event|Protected|BlueprintEvent 
};

/// Class /Script/CrewUI.FortProgressiveSetTile
/// Size: 0x00A0 (0x0014A0 - 0x001540)
...
public:
	...
	// void BP_OnTileMaterialLoaded(bool bSubscribed);                                                                          // [0x20c3f9c] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.FortProgressiveSetTile.BP_OnInitializeSetInfo
	// void BP_OnInitializeSetInfo(FProgressiveSetInfo& InSetInfo, FText& BottomText, FText& BottomSubtext, bool bSubscribed);  // [0x20c3f9c] Event|Protected|HasOutParms|BlueprintEvent 
};
...
public:
	...
	// void SelectStageInDirection(int32_t Direction);                                                                          // [0xbc7b89c] Final|Native|Public|BlueprintCallable 
	// Function /Script/CrewUI.FortProgressiveStageList.ClearStageWidgets
	// void ClearStageWidgets();                                                                                                // [0x20c3f9c] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.FortProgressiveStageList.AddStageWidget
	// class UFortProgressiveStageWidget* AddStageWidget();                                                                     // [0x20c3f9c] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void OnSetTooltipVisible(bool bVisible);                                                                                 // [0x20c3f9c] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.FortProgressiveStageWidget.OnSetTooltipText
	// void OnSetTooltipText(FText& InToolTipText);                                                                             // [0x20c3f9c] Event|Protected|HasOutParms|BlueprintEvent 
	...
	// void ClearStageItemWidgets();                                                                                            // [0x20c3f9c] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.FortProgressiveStageWidget.AddStageItemWidget
	// class UFortProgressiveItemWidget* AddStageItemWidget();                                                                  // [0x20c3f9c] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void BP_OnUpdateSubscriptionState(bool bSubscribed);                                                                     // [0x20c3f9c] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.FortProgressiveTableOfContentsScreen.BP_OnUpdateNumTilesAvailable
	// void BP_OnUpdateNumTilesAvailable(int32_t NumTiles);                                                                     // [0x20c3f9c] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.FortProgressiveTableOfContentsScreen.BP_OnUpdateErrorStateText
	// void BP_OnUpdateErrorStateText(FText& ErrorStateText);                                                                   // [0x20c3f9c] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/CrewUI.FortProgressiveTableOfContentsScreen.BP_OnUpdateBanner
	// void BP_OnUpdateBanner(FText& BannerText, bool bAllSetsCompleted, bool bSubscribed);                                     // [0x20c3f9c] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/CrewUI.FortProgressiveTableOfContentsScreen.BP_OnSetDescriptionText
	// void BP_OnSetDescriptionText(FText& ProductDescription);                                                                 // [0x20c3f9c] Event|Protected|HasOutParms|BlueprintEvent 
};
...
public:
	...
	// void SetupRowEntry(class UFortTemporaryItemsRow* RewardRow);                                                             // [0xbc7bb24] Final|Native|Protected|BlueprintCallable 
	// Function /Script/CrewUI.FortTemporaryItemsScreen.GetSubscriptionVM
	// class UFortSubscriptionVM* GetSubscriptionVM();                                                                          // [0x20c3f9c] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.FortTemporaryItemsScreen.GetRemainingDaysLabel
	// FText GetRemainingDaysLabel(class UFortTemporaryItemsVM* TemporaryItemsVM);                                              // [0xbc7b6c4] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
