...
public:
	CMember(TScriptInterface<Class>)                   CachedFortInventory                                         OFFSET(get<T>, {0x80, 16, 0, 0})
	CMember(class AFortPawn*)                          CachedFortPawn                                              OFFSET(get<T>, {0x90, 8, 0, 0})
	CMember(class UBlackboardComponent*)               CachedBlackboardComponent                                   OFFSET(get<T>, {0x98, 8, 0, 0})
};
...
public:
	...
	// void OnBotControllerAlertLevelChanged(class AFortAthenaAIBotController* BotController, EAlertLevel OldAlertLevel, EAlertLevel NewAlertLevel); // [0xafd36f0] Final|Native|Protected 
};
