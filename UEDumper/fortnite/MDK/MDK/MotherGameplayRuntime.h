...
public:
	...
	// bool IsValidTarget(class AActor* OwningPlayer, class AActor* PotentialTarget, FGameplayTagContainer& ReasonForFailure);  // [0xbfc8230] Final|Native|Protected|HasOutParms|BlueprintCallable 
	// Function /Script/MotherGameplayRuntime.GravityGunTargetTrackingComponent.FindTargetProjectile
	// bool FindTargetProjectile(class AActor* OwningPlayer, FVector& TraceStart, FVector& TraceEnd, float TargetingRadius);    // [0xbfc7c34] Final|Native|Protected|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/MotherGameplayRuntime.GravityGunTargetTrackingComponent.FindTargetActor
	// void FindTargetActor(class AActor* OwningPlayer, FVector& TraceStart, FVector& TraceEnd);                                // [0xbfc7a98] Final|Native|Protected|HasOutParms|HasDefaults|BlueprintCallable 
};
...
public:
	...
	// void UpdatePropPreviewPosition(class USceneComponent* PropPreviewComponent, float DeltaTime, class AFortPawn* AttachPawn, FName AttachSocket, class USkeletalMeshComponent* WeaponMesh, FVector& DesiredRelativeTransform, float MinimumZOffset, FRotator& RelativeRotation, FVector& CachedScale, float InterpSpeed); // [0xbfc858c] Final|Native|Static|Private|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/MotherGameplayRuntime.PropGunFunctionLibrary.UpdatePropIndexEventState
	// void UpdatePropIndexEventState(class AActor* ContextActor, FPaddleGingerPropData& Payload);                              // [0xbfc8484] Final|Native|Static|Private|HasOutParms|BlueprintCallable 
	// Function /Script/MotherGameplayRuntime.PropGunFunctionLibrary.UpdatePropActivatedEventState
	// void UpdatePropActivatedEventState(class AActor* ContextActor, FPaddleGingerPropActivatedData& Payload);                 // [0xbfc8384] Final|Native|Static|Private|HasOutParms|BlueprintCallable 
	// Function /Script/MotherGameplayRuntime.PropGunFunctionLibrary.ClearPropIndexEventState
	// void ClearPropIndexEventState(class AActor* ContextActor);                                                               // [0xbfc7a0c] Final|Native|Static|Private|BlueprintCallable 
	// Function /Script/MotherGameplayRuntime.PropGunFunctionLibrary.ClearPropActivatedEventState
	// void ClearPropActivatedEventState(class AActor* ContextActor);                                                           // [0xbfc7980] Final|Native|Static|Private|BlueprintCallable 
};
...
public:
	...
	// void UpdateAimEndPoint();                                                                                                // [0xbfc8370] Final|Native|Public|BlueprintCallable 
	// Function /Script/MotherGameplayRuntime.ReactorGradeGameplayCue_ChargeUp.OnEndPointUpdated
	// void OnEndPointUpdated(FVector& FoundPoint);                                                                             // [0x20c3f9c] Event|Public|HasOutParms|HasDefaults|BlueprintEvent 
	// Function /Script/MotherGameplayRuntime.ReactorGradeGameplayCue_ChargeUp.GetFoundEndPoint
	// FVector GetFoundEndPoint();                                                                                              // [0xbfc8208] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
};
