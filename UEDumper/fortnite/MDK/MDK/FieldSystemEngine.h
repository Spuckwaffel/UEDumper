...
public:
	...
	// void ResetFieldSystem();                                                                                                 // [0x65dd980] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/FieldSystemEngine.FieldSystemComponent.RemovePersistentFields
	// void RemovePersistentFields();                                                                                           // [0x35b5014] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/FieldSystemEngine.FieldSystemComponent.ApplyUniformVectorFalloffForce
	// void ApplyUniformVectorFalloffForce(bool Enabled, FVector Position, FVector Direction, float Radius, float Magnitude);   // [0x65dd7c4] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/FieldSystemEngine.FieldSystemComponent.ApplyStrainField
	// void ApplyStrainField(bool Enabled, FVector Position, float Radius, float Magnitude, int32_t Iterations);                // [0x65dd628] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/FieldSystemEngine.FieldSystemComponent.ApplyStayDynamicField
	// void ApplyStayDynamicField(bool Enabled, FVector Position, float Radius);                                                // [0x65dd50c] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/FieldSystemEngine.FieldSystemComponent.ApplyRadialVectorFalloffForce
	// void ApplyRadialVectorFalloffForce(bool Enabled, FVector Position, float Radius, float Magnitude);                       // [0x65dd3ac] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/FieldSystemEngine.FieldSystemComponent.ApplyRadialForce
	// void ApplyRadialForce(bool Enabled, FVector Position, float Magnitude);                                                  // [0x65dd290] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/FieldSystemEngine.FieldSystemComponent.ApplyPhysicsField
	// void ApplyPhysicsField(bool Enabled, TEnumAsByte<EFieldPhysicsType> Target, class UFieldSystemMetaData* MetaData, class UFieldNodeBase* Field); // [0x65dd140] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/FieldSystemEngine.FieldSystemComponent.ApplyLinearForce
	// void ApplyLinearForce(bool Enabled, FVector Direction, float Magnitude);                                                 // [0x65dd024] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/FieldSystemEngine.FieldSystemComponent.AddPersistentField
	// void AddPersistentField(bool Enabled, TEnumAsByte<EFieldPhysicsType> Target, class UFieldSystemMetaData* MetaData, class UFieldNodeBase* Field); // [0x33e38c4] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/FieldSystemEngine.FieldSystemComponent.AddFieldCommand
	// void AddFieldCommand(bool Enabled, TEnumAsByte<EFieldPhysicsType> Target, class UFieldSystemMetaData* MetaData, class UFieldNodeBase* Field); // [0x65dced4] Final|RequiredAPI|Native|Public|BlueprintCallable 
};
...
public:
	...
	// class UFieldSystemMetaDataIteration* SetMetaDataIteration(int32_t Iterations);                                           // [0x65dde60] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class UFieldSystemMetaDataProcessingResolution* SetMetaDataaProcessingResolutionType(TEnumAsByte<EFieldResolutionType> ResolutionType); // [0x65ddeec] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class UFieldSystemMetaDataFilter* SetMetaDataFilterType(TEnumAsByte<EFieldFilterType> FilterType, TEnumAsByte<EFieldObjectType> ObjectType, TEnumAsByte<EFieldPositionType> PositionType); // [0x65ddd5c] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class UUniformInteger* SetUniformInteger(int32_t Magnitude);                                                             // [0x65dde60] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class URadialIntMask* SetRadialIntMask(float Radius, FVector Position, int32_t InteriorValue, int32_t ExteriorValue, TEnumAsByte<ESetMaskConditionType> SetMaskConditionIn); // [0x65de3a8] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class UUniformScalar* SetUniformScalar(float Magnitude);                                                                 // [0x65de544] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class UWaveScalar* SetWaveScalar(float Magnitude, FVector Position, float WaveLength, float Period, float Time, TEnumAsByte<EWaveFunctionType> Function, TEnumAsByte<EFieldFalloffType> Falloff); // [0x3177ea4] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class URadialFalloff* SetRadialFalloff(float Magnitude, float MinRange, float MaxRange, float Default, float Radius, FVector Position, TEnumAsByte<EFieldFalloffType> Falloff); // [0x3313f00] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class UPlaneFalloff* SetPlaneFalloff(float Magnitude, float MinRange, float MaxRange, float Default, float Distance, FVector Position, FVector Normal, TEnumAsByte<EFieldFalloffType> Falloff); // [0x65de124] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class UBoxFalloff* SetBoxFalloff(float Magnitude, float MinRange, float MaxRange, float Default, FTransform Transform, TEnumAsByte<EFieldFalloffType> Falloff); // [0x65dd994] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class UNoiseField* SetNoiseField(float MinRange, float MaxRange, FTransform Transform);                                  // [0x65ddf7c] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class UUniformVector* SetUniformVector(float Magnitude, FVector Direction);                                              // [0x65de688] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class URadialVector* SetRadialVector(float Magnitude, FVector Position);                                                 // [0x34ddd1c] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class URandomVector* SetRandomVector(float Magnitude);                                                                   // [0x65de544] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class UOperatorField* SetOperatorField(float Magnitude, class UFieldNodeBase* LeftField, class UFieldNodeBase* RightField, TEnumAsByte<EFieldOperationType> Operation); // [0x3065bc8] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class UToIntegerField* SetToIntegerField(class UFieldNodeFloat* FloatField);                                             // [0x65de5ec] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class UToFloatField* SetToFloatField(class UFieldNodeInt* IntegerField);                                                 // [0x65de5ec] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class UCullingField* SetCullingField(class UFieldNodeBase* Culling, class UFieldNodeBase* Field, TEnumAsByte<EFieldCullingOperationType> Operation); // [0x65ddc14] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class UReturnResultsTerminal* SetReturnResultsTerminal();                                                                // [0x65de5d8] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure 
};
