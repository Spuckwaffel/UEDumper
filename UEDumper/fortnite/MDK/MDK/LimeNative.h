...
public:
	...
	// void OnEndPlay(class AActor* Actor, TEnumAsByte<EEndPlayReason> EndPlayReason);                                          // [0xc9e2974] Final|Native|Private 
};
...
public:
	...
	// void HandleEnterVehicle();                                                                                               // [0xc9e28a8] Final|Native|Protected 
};
...
public:
	...
	// void OnRep_CurrentMoodState();                                                                                           // [0xc9e2a38] Final|Native|Private 
	// Function /Script/LimeNative.LimePawnComponentMood.GetCurrentMoodState
	// FLimeMoodStateData GetCurrentMoodState();                                                                                // [0x90ff0e4] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void SetEmotionalState(FLimeEmotionalStateData Emotion);                                                                 // [0xc9e2a74] Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
	// Function /Script/LimeNative.LimePawnComponent_EmotionalState.SetCurrentEmotionalState
	// void SetCurrentEmotionalState(ELimePawnEmotionalState NewEmotion);                                                       // [0xc61d960] Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
	// Function /Script/LimeNative.LimePawnComponent_EmotionalState.ResetToDefaultEmotionalState
	// void ResetToDefaultEmotionalState();                                                                                     // [0xc9e2a60] Final|Native|Private 
	// Function /Script/LimeNative.LimePawnComponent_EmotionalState.OnRep_TargetEmotionalState
	// void OnRep_TargetEmotionalState();                                                                                       // [0xc9e2a4c] Final|Native|Private 
	...
	// void HandleLimeAwesomeLevelChanged(int32_t NewAwesomeLevel);                                                             // [0xc9e28bc] Final|Native|Private 
	...
	// ELimePawnEmotionalState GetCurrentEmotionalState();                                                                      // [0x93b5134] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
