...
public:
	...
	// void OnSystemFinished(class UAudioComponent* FinishedComponent);                                                         // [0xb1c4090] Final|Native|Private 
	// Function /Script/EpicGamesAssets.PlayedSoundReplication.OnRep_SoundAsset
	// void OnRep_SoundAsset();                                                                                                 // [0xb1c4054] Final|Native|Private 
};
...
public:
	...
	// void OnSystemFinished(class UNiagaraComponent* FinishedComponent);                                                       // [0xb1c4090] Final|Native|Private 
	// Function /Script/EpicGamesAssets.SpawnedParticleSystemReplication.OnRep_VFXAsset
	// void OnRep_VFXAsset();                                                                                                   // [0xb1c407c] Final|Native|Private 
	// Function /Script/EpicGamesAssets.SpawnedParticleSystemReplication.OnRep_StartTime
	// void OnRep_StartTime();                                                                                                  // [0xb1c4068] Final|Native|Private 
};
