...
public:
	...
	// void StopAnalyzing(class UObject* WorldContextObject);                                                                   // [0xb370574] Final|RequiredAPI|BlueprintCosmetic|Native|Public|BlueprintCallable 
	// Function /Script/AudioAnalyzer.AudioAnalyzer.StartAnalyzing
	// void StartAnalyzing(class UObject* WorldContextObject, class UAudioBus* AudioBusToAnalyze);                              // [0xb3703b0] Final|RequiredAPI|BlueprintCosmetic|Native|Public|BlueprintCallable 
};
