...
public:
	...
	// void SetTitle(FText& TitleText);                                                                                         // [0x20c3f9c] Event|Protected|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /Script/AccoladesUI.AthenaAccoladeListEntryWidget.SetSource
	// void SetSource(FText& SourceText);                                                                                       // [0x20c3f9c] Event|Protected|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /Script/AccoladesUI.AthenaAccoladeListEntryWidget.SetJustCompleted
	// void SetJustCompleted(bool bJustCompleted);                                                                              // [0x20c3f9c] Event|Protected|BlueprintCallable|BlueprintEvent 
	// Function /Script/AccoladesUI.AthenaAccoladeListEntryWidget.SetIconImage
	// void SetIconImage(TWeakObjectPtr<UTexture2D*>& IconImage, EFortAccoladeType AccoladeType);                               // [0x20c3f9c] Event|Protected|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /Script/AccoladesUI.AthenaAccoladeListEntryWidget.SetIcon
	// void SetIcon(class UFortAccoladeItemDefinition* ItemDef);                                                                // [0x20c3f9c] Event|Protected|BlueprintCallable|BlueprintEvent 
	// Function /Script/AccoladesUI.AthenaAccoladeListEntryWidget.SetCount
	// void SetCount(int32_t Count);                                                                                            // [0x20c3f9c] Event|Protected|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// void PopulateWidget();                                                                                                   // [0xb33d478] Final|Native|Public|BlueprintCallable 
};
