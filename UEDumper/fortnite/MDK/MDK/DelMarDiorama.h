...
public:
	...
	// void BP_OnBoundVehicleChanged(class ADelMarVehicle* NewVehicle);                                                         // [0x20c3f9c] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void HandleSequenceFinished();                                                                                           // [0xc98de30] Final|Native|Protected 
};
...
public:
	...
	// void DelMarIntercomPlayInteraction(FString InteractionTag);                                                              // [0x6dbbe2c] Final|Exec|Native|Protected 
	// Function /Script/DelMarDiorama.DelMarDriverCheatManager.DelMarIntercomBroadcastEmote
	// void DelMarIntercomBroadcastEmote(FString EmoteTag);                                                                     // [0x6dbbe2c] Final|Exec|Native|Protected 
	// Function /Script/DelMarDiorama.DelMarDriverCheatManager.DelMarDioramaSetVisibleInSceneCaptureOnly
	// void DelMarDioramaSetVisibleInSceneCaptureOnly(bool bOnly);                                                              // [0x654e370] Final|Exec|Native|Protected 
	// Function /Script/DelMarDiorama.DelMarDriverCheatManager.DelMarDioramaSetLocation
	// void DelMarDioramaSetLocation(float X, float Y, float Z);                                                                // [0x95b8cd8] Final|Exec|Native|Protected 
	// Function /Script/DelMarDiorama.DelMarDriverCheatManager.DelMarDioramaSetLightingChannel
	// void DelMarDioramaSetLightingChannel(bool bMainChannel);                                                                 // [0x654e370] Final|Exec|Native|Protected 
	// Function /Script/DelMarDiorama.DelMarDriverCheatManager.DelMarDioramaSetEnabled
	// void DelMarDioramaSetEnabled(bool bEnabled);                                                                             // [0x654e370] Final|Exec|Native|Protected 
	// Function /Script/DelMarDiorama.DelMarDriverCheatManager.DelMarDioramaSetDriverReaction
	// void DelMarDioramaSetDriverReaction(FString ReactionTag);                                                                // [0x6dbbe2c] Final|Exec|Native|Protected 
	// Function /Script/DelMarDiorama.DelMarDriverCheatManager.DelMarDioramaOpenChannel
	// void DelMarDioramaOpenChannel(bool bOpened);                                                                             // [0x654e370] Final|Exec|Native|Protected 
};
...
public:
	...
	// bool IsDrivingSpeed();                                                                                                   // [0xc98e4b8] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void HandleViewTargetChanged(class AFortPlayerController* PC, class AActor* Old, class AActor* NewViewTarget);           // [0xc98e270] Final|Native|Protected 
};
...
public:
	...
	// void HandleSequenceFinished();                                                                                           // [0x1447724] Native|Protected     
};
...
public:
	...
	// void HandleVehicleSpawned(bool bFirstCar, bool bPrevCarDemolished);                                                      // [0xc98e1ac] Final|Native|Protected 
	// Function /Script/DelMarDiorama.DelMarDriverChannel.HandleVehicleLanded
	// void HandleVehicleLanded(float LandingForce, bool bLandedKickflip);                                                      // [0xc98e0e4] Final|Native|Protected 
	// Function /Script/DelMarDiorama.DelMarDriverChannel.HandleVehicleHitWall
	// void HandleVehicleHitWall(float ImpactMagnitude, FVector WorldLocation, float ForwardRotationDegrees);                   // [0xc98dfd8] Final|Native|Protected|HasDefaults 
	// Function /Script/DelMarDiorama.DelMarDriverChannel.HandleVehicleDemolished
	// void HandleVehicleDemolished(FGameplayTag CausedByTag);                                                                  // [0xc98df58] Final|Native|Protected 
	// Function /Script/DelMarDiorama.DelMarDriverChannel.HandleTurboActivated
	// void HandleTurboActivated();                                                                                             // [0xc98df44] Final|Native|Protected 
	// Function /Script/DelMarDiorama.DelMarDriverChannel.HandleStartlineBoostActivated
	// void HandleStartlineBoostActivated(float PercentageSpeedEarned);                                                         // [0xc98dec4] Final|Native|Protected 
	// Function /Script/DelMarDiorama.DelMarDriverChannel.HandleSpeedChanged
	// void HandleSpeedChanged(float NewSpeed);                                                                                 // [0xc98de44] Final|Native|Protected 
	// Function /Script/DelMarDiorama.DelMarDriverChannel.HandleHazardSpeedLost
	// void HandleHazardSpeedLost();                                                                                            // [0xc98de1c] Final|Native|Protected 
	// Function /Script/DelMarDiorama.DelMarDriverChannel.HandleDriftBoostActivated
	// void HandleDriftBoostActivated(float PercentageMaxBoostGained);                                                          // [0xc98dd9c] Final|Native|Protected 
	// Function /Script/DelMarDiorama.DelMarDriverChannel.HandleDraftStateChanged
	// void HandleDraftStateChanged(EDelmarDraftingState DraftState);                                                           // [0xc98dd1c] Final|Native|Protected 
};
...
public:
	...
	// void ServerReceiveInteraction(FGameplayTag EmoteTag, class APlayerState* Receiver);                                      // [0xc98e560] Net|Native|Event|Public|NetServer 
	// Function /Script/DelMarDiorama.DelMarIntercomComponent.ServerReceiveEmote
	// void ServerReceiveEmote(FGameplayTag EmoteTag);                                                                          // [0xc98e4dc] Net|Native|Event|Protected|NetServer 
	// Function /Script/DelMarDiorama.DelMarIntercomComponent.HandleViewTargetChanged
	// void HandleViewTargetChanged(class AFortPlayerController* InController, class AActor* OldViewTarget, class AActor* NewViewTarget); // [0xc98e3c0] Final|Native|Protected 
	// Function /Script/DelMarDiorama.DelMarIntercomComponent.ClientReceiveInteraction
	// void ClientReceiveInteraction(FGameplayTag InteractionTag, class APlayerState* Instigator, class APlayerState* Receiver); // [0xc98dc20] Net|Native|Event|Protected|NetClient 
	// Function /Script/DelMarDiorama.DelMarIntercomComponent.ClientReceiveEmote
	// void ClientReceiveEmote(FGameplayTag EmoteTag, class APlayerState* Instigator);                                          // [0xc98db58] Net|Native|Event|Protected|NetClient 
};
