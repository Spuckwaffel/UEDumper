...
public:
	...
	// void SetImagePlate(FImagePlateParameters Plate);                                                                         // [0xcf32ed8] Final|Native|Public|BlueprintCallable 
	// Function /Script/ImagePlate.ImagePlateComponent.OnRenderTextureChanged
	// void OnRenderTextureChanged();                                                                                           // [0xcf32ec4] Final|Native|Public  
	// Function /Script/ImagePlate.ImagePlateComponent.GetPlate
	// FImagePlateParameters GetPlate();                                                                                        // [0xcf32e4c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
