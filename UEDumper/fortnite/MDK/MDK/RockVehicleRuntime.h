...
public:
	...
	// void RockVehicleSetVelocity(float X, float Y, float Z);                                                                  // [0x95b8cd8] Final|Exec|Native|Public 
	// Function /Script/RockVehicleRuntime.FortCheatManager_RockVehicle.RockVehicleSetRotation
	// void RockVehicleSetRotation(float pitch, float Yaw, float Roll);                                                         // [0x95b8cd8] Final|Exec|Native|Public 
	// Function /Script/RockVehicleRuntime.FortCheatManager_RockVehicle.RockVehicleSetLocation
	// void RockVehicleSetLocation(float X, float Y, float Z);                                                                  // [0x95b8cd8] Final|Exec|Native|Public 
	// Function /Script/RockVehicleRuntime.FortCheatManager_RockVehicle.RockVehicleSetBalboaVelocity
	// void RockVehicleSetBalboaVelocity(float X, float Y, float Z);                                                            // [0x95b8cd8] Final|Exec|Native|Public 
};

/// Class /Script/RockVehicleRuntime.RockVehicle
/// Size: 0x0240 (0x001F30 - 0x002170)
...
public:
	DMember(float)                                     InputSwivelPitch                                            OFFSET(get<float>, {0x1F30, 4, 0, 0})
	DMember(float)                                     InputSwivelYaw                                              OFFSET(get<float>, {0x1F34, 4, 0, 0})
	DMember(bool)                                      bInputReverseCamera                                         OFFSET(get<bool>, {0x1F38, 1, 1, 0})
	DMember(bool)                                      bHasDoubleJumped                                            OFFSET(get<bool>, {0x1F38, 1, 1, 1})
	DMember(bool)                                      bHasDodged                                                  OFFSET(get<bool>, {0x1F38, 1, 1, 2})
	DMember(bool)                                      bFreeLookCamera                                             OFFSET(get<bool>, {0x1F39, 1, 0, 0})
	SMember(FMulticastInlineDelegate)                  OnFreeCamToggled                                            OFFSET(getStruct<T>, {0x1F40, 16, 0, 0})
	SMember(FRockRuntimeConfigOverrides)               RockRuntimeConfigs                                          OFFSET(getStruct<T>, {0x1F51, 4, 0, 0})
	SMember(FMulticastInlineDelegate)                  OnSpringImpact                                              OFFSET(getStruct<T>, {0x1F70, 16, 0, 0})
	CMember(class URockVehicleAnalyticsComponent*)     RockAnalyticsComp                                           OFFSET(get<T>, {0x1FF8, 8, 0, 0})
	CMember(TArray<class URockVehicleAbility*>)        VehicleAbilities                                            OFFSET(get<T>, {0x2000, 16, 0, 0})
	CMember(TArray<TWeakObjectPtr<UClass*>>)           VehicleAbilityTickOrder                                     OFFSET(get<T>, {0x2010, 16, 0, 0})
	CMember(class AFortVehicleAudioController*)        CachedVehicleAudioController                                OFFSET(get<T>, {0x2020, 8, 0, 0})
	CMember(class URockVehicleAbility_Supersonic*)     SupersonicAbility                                           OFFSET(get<T>, {0x2028, 8, 0, 0})
	CMember(class URockVehicleAnimInstance*)           RockAnimInstance                                            OFFSET(get<T>, {0x2030, 8, 0, 0})
	SMember(FFortAthenaVehicleInputState)              PendingDriverInputState                                     OFFSET(getStruct<T>, {0x2038, 64, 0, 0})
	SMember(FFortAthenaVehicleInputState)              PrevDriverInputState                                        OFFSET(getStruct<T>, {0x2078, 64, 0, 0})
	SMember(FVector)                                   EnterExitImpulse                                            OFFSET(getStruct<T>, {0x20B8, 24, 0, 0})


	/// Functions
	// Function /Script/RockVehicleRuntime.RockVehicle.ServerToggleFreeCam
	// void ServerToggleFreeCam();                                                                                              // [0xbe77bf0] Net|NetReliableNative|Event|Public|NetServer|NetValidate 
	// Function /Script/RockVehicleRuntime.RockVehicle.ServerSetLegacyDamageValues
	// void ServerSetLegacyDamageValues(bool bDamageFriendlyVehicles, bool bDamageOtherVehicles, bool bDamageOwnVehicle, bool bDamageAllowedFromOtherVehicle); // [0xbe77a90] Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
	// Function /Script/RockVehicleRuntime.RockVehicle.RockFreeCamToggledDelegate__DelegateSignature
	// void RockFreeCamToggledDelegate__DelegateSignature(bool bFreeCam);                                                       // [0x20c3f9c] MulticastDelegate|Public|Delegate 
	// Function /Script/RockVehicleRuntime.RockVehicle.OnSpringImpact__DelegateSignature
	// void OnSpringImpact__DelegateSignature(FName Socket, float ImpactSpeed, FHitResult& OutHit);                             // [0x20c3f9c] MulticastDelegate|Public|Delegate|HasOutParms 
	// Function /Script/RockVehicleRuntime.RockVehicle.OnRep_FreeLookCamera
	// void OnRep_FreeLookCamera();                                                                                             // [0xbe7781c] Final|Native|Public  
	// Function /Script/RockVehicleRuntime.RockVehicle.GetThrottleState
	// float GetThrottleState();                                                                                                // [0xbe77074] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/RockVehicleRuntime.RockVehicle.GetDriverInput
	// FFortAthenaVehicleInputState GetDriverInput();                                                                           // [0xbe76fc0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/RockVehicleRuntime.RockVehicle.GetCurrentRockRuntimeConfigOverrides
	// FRockRuntimeConfigOverrides GetCurrentRockRuntimeConfigOverrides();                                                      // [0xbe76fa8] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// class ARockVehicle* GetVehicle();                                                                                        // [0x337553c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/RockVehicleRuntime.RockVehicleAbility.GetInactiveSeconds
	// float GetInactiveSeconds();                                                                                              // [0xbe7700c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/RockVehicleRuntime.RockVehicleAbility.GetActiveSeconds
	// float GetActiveSeconds();                                                                                                // [0x65cbba8] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void OnRep_SecondsRemaining(float PrevValue);                                                                            // [0xbe77850] Final|Native|Protected 
	// Function /Script/RockVehicleRuntime.RockVehicleBoostTank.IsBoostFull
	// bool IsBoostFull();                                                                                                      // [0xbe7713c] Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/RockVehicleRuntime.RockVehicleBoostTank.HasBoost
	// bool HasBoost();                                                                                                         // [0xbe7711c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/RockVehicleRuntime.RockVehicleBoostTank.GiveBoost
	// void GiveBoost(float Seconds);                                                                                           // [0xbe7709c] Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
	// Function /Script/RockVehicleRuntime.RockVehicleBoostTank.GetPercentRemaining
	// float GetPercentRemaining();                                                                                             // [0xbe77054] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/RockVehicleRuntime.RockVehicleBoostTank.GetMaxBoostInSeconds
	// float GetMaxBoostInSeconds();                                                                                            // [0xb519d78] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void SetEnabled(bool bValue);                                                                                            // [0xbe77cbc] Final|Native|Public|BlueprintCallable 
	// Function /Script/RockVehicleRuntime.RockVehicleAbility_GroundTrails.OnSurfaceChanged
	// void OnSurfaceChanged(TEnumAsByte<EPhysicalSurface> NewSurface);                                                         // [0xbe77a10] Final|Native|Protected|BlueprintCallable 
};
...
public:
	...
	// void OnSupersonicStart(class UActorComponent* InComp, bool bInReset);                                                    // [0xbe77958] Final|Native|Private 
	// Function /Script/RockVehicleRuntime.RockVehicleAnalyticsComponent.OnSupersonicEnd
	// void OnSupersonicEnd(class UActorComponent* InComp);                                                                     // [0xbe778e8] Final|Native|Private 
	// Function /Script/RockVehicleRuntime.RockVehicleAnalyticsComponent.OnPawnExitedSeat
	// void OnPawnExitedSeat(TScriptInterface<Class>& InVehicle, class AFortPawn* InPlayerPawn, int32_t InSeatIndex);           // [0xbe775dc] Final|Native|Private|HasOutParms 
	// Function /Script/RockVehicleRuntime.RockVehicleAnalyticsComponent.OnPawnEnteredSeat
	// void OnPawnEnteredSeat(TScriptInterface<Class>& InVehicle, class AFortPawn* InPlayerPawn, int32_t InSeatIndex);          // [0xbe7739c] Final|Native|Private|HasOutParms 
	// Function /Script/RockVehicleRuntime.RockVehicleAnalyticsComponent.OnJumped
	// void OnJumped(class UActorComponent* InComp, bool bInReset);                                                             // [0xbe772e4] Final|Native|Private 
	// Function /Script/RockVehicleRuntime.RockVehicleAnalyticsComponent.OnDoubleJumped
	// void OnDoubleJumped(class UActorComponent* InComp, bool bInReset);                                                       // [0xbe7722c] Final|Native|Private 
	// Function /Script/RockVehicleRuntime.RockVehicleAnalyticsComponent.OnDodged
	// void OnDodged(class UActorComponent* InComp, bool bInReset);                                                             // [0xbe77174] Final|Native|Private 
};

/// Class /Script/RockVehicleRuntime.RockVehicleAnimInstance
/// Size: 0x0188 (0x000618 - 0x0007A0)
...
public:
	...
	// void SetSurfaceTypeParam(float NewSurfaceParam);                                                                         // [0xbe77d3c] Final|Native|Public|BlueprintCallable 
	// Function /Script/RockVehicleRuntime.RockVehicleAudioController.SetBoosting
	// void SetBoosting(bool bNewBoosting);                                                                                     // [0xbe77c3c] Final|Native|Public|BlueprintCallable 
	// Function /Script/RockVehicleRuntime.RockVehicleAudioController.OnInAirUpdated
	// void OnInAirUpdated(bool bNewInAir);                                                                                     // [0x20c3f9c] Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Script/RockVehicleRuntime.RockVehicleAudioController.GetMotorSimComponent
	// class UAudioMotorModelComponent* GetMotorSimComponent();                                                                 // [0x9755980] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};

/// Class /Script/RockVehicleRuntime.RockVehicleCameraMode
/// Size: 0x0208 (0x001CE8 - 0x001EF0)
...
public:
	...
	// void VehicleExploded(class AController* LastDamageInstigator, class AFortAthenaVehicle* Vehicle);                        // [0xbe77dbc] Final|Native|Protected 
};
