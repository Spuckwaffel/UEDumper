...
public:
	...
	// void ShowSparksCaptureTool(bool bShow);                                                                                  // [0x20c3f9c] Event|Protected|BlueprintEvent 
	// Function /Script/SparksCommonRuntime.SparksCommonUtilities.GetSparksCommonUtilities
	// class USparksCommonUtilities* GetSparksCommonUtilities(class UObject* WorldContextObject);                               // [0xbad0094] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// void OnSparksActivationChange(FString ActivationString);                                                                 // [0x20c3f9c] Event|Protected|BlueprintEvent 
	// Function /Script/SparksCommonRuntime.SparksMapDataLayerController.GetCurrentSparksActivation
	// FString GetCurrentSparksActivation();                                                                                    // [0xbad0078] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
