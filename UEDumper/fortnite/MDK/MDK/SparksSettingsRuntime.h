...
public:
	...
	// void SetGameplayMusicVolume(float NewVolume);                                                                            // [0xbbaf830] Final|Native|Public  
	// Function /Script/SparksSettingsRuntime.SparksClientSettingRecordPartition.GetGameplayMusicVolume
	// float GetGameplayMusicVolume();                                                                                          // [0x6f63df0] Final|RequiredAPI|Native|Public|Const 
};
...
public:
	...
	// void UpdateSparksMixFromPartition();                                                                                     // [0xbbaf8b4] Final|Native|Public|Const 
	// Function /Script/SparksSettingsRuntime.SparksSettingsControllerComponent.GetSparksClientSettingRecordPartition
	// class USparksClientSettingRecordPartition* GetSparksClientSettingRecordPartition();                                      // [0xbbaf80c] Final|Native|Public|Const 
};
