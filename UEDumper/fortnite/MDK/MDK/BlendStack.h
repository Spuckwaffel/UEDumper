...
public:
	...
	// float GetCurrentBlendStackAnimAssetTime(FAnimNodeReference& Node);                                                       // [0x80dac24] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/BlendStack.BlendStackAnimNodeLibrary.GetCurrentBlendStackAnimAsset
	// class UAnimationAsset* GetCurrentBlendStackAnimAsset(FAnimNodeReference& Node);                                          // [0x80dab38] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/BlendStack.BlendStackAnimNodeLibrary.ForceBlendNextUpdate
	// void ForceBlendNextUpdate(FBlendStackAnimNodeReference& BlendStackNode);                                                 // [0x80daa94] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/BlendStack.BlendStackAnimNodeLibrary.ConvertToBlendStackNodePure
	// void ConvertToBlendStackNodePure(FAnimNodeReference& Node, FBlendStackAnimNodeReference& BlendStackNode, bool& Result);  // [0x80da8cc] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/BlendStack.BlendStackAnimNodeLibrary.ConvertToBlendStackNode
	// FBlendStackAnimNodeReference ConvertToBlendStackNode(FAnimNodeReference& Node, EAnimNodeReferenceConversionResult& Result); // [0x80da7a0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/BlendStack.BlendStackAnimNodeLibrary.BlendTo
	// void BlendTo(FAnimUpdateContext& Context, FBlendStackAnimNodeReference& BlendStackNode, class UAnimationAsset* AnimationAsset, float AnimationTime, bool bLoop, bool bMirrored, float BlendTime, FVector BlendParameters, float WantedPlayRate, float ActivationDelay); // [0x80d9bc4] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
};
...
public:
	...
	// void GetProperties(FBlendStackInputAnimNodeReference& BlendStackInputNode, class UAnimationAsset*& AnimationAsset, float& AccumulatedTime); // [0x80dacf0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/BlendStack.BlendStackInputAnimNodeLibrary.ConvertToBlendStackInputNodePure
	// void ConvertToBlendStackInputNodePure(FAnimNodeReference& Node, FBlendStackInputAnimNodeReference& BlendStackInputNode, bool& Result); // [0x80da5d8] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/BlendStack.BlendStackInputAnimNodeLibrary.ConvertToBlendStackInputNode
	// FBlendStackInputAnimNodeReference ConvertToBlendStackInputNode(FAnimNodeReference& Node, EAnimNodeReferenceConversionResult& Result); // [0x80da4ac] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
