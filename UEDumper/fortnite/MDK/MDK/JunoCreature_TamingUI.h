...
public:
	...
	// void OnBarnAssignmentObjectSet(class UJunoBarnAssignmentListObject* NewBarnAssignmentListObject);                        // [0x20c3f9c] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// bool IsSelectable();                                                                                                     // [0xcd437d0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoCreature_TamingUI.JunoBarnAssignmentListObject.GetUniqueAIIdentifier
	// FGameplayTag GetUniqueAIIdentifier();                                                                                    // [0xbadb2b0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoCreature_TamingUI.JunoBarnAssignmentListObject.GetIsNoVillageSlot
	// bool GetIsNoVillageSlot();                                                                                               // [0xcd4365c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoCreature_TamingUI.JunoBarnAssignmentListObject.GetIsNoNearbyAnimalEntry
	// bool GetIsNoNearbyAnimalEntry();                                                                                         // [0x3e62840] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoCreature_TamingUI.JunoBarnAssignmentListObject.GetIsGlobalLimitReachedEntry
	// bool GetIsGlobalLimitReachedEntry();                                                                                     // [0xa8c0bb4] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoCreature_TamingUI.JunoBarnAssignmentListObject.GetIsFollowingEntry
	// bool GetIsFollowingEntry();                                                                                              // [0xbae3524] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoCreature_TamingUI.JunoBarnAssignmentListObject.GetIcon
	// TWeakObjectPtr<UTexture2D*> GetIcon();                                                                                   // [0xcd435bc] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoCreature_TamingUI.JunoBarnAssignmentListObject.GetHasBed
	// bool GetHasBed();                                                                                                        // [0xcd435a8] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoCreature_TamingUI.JunoBarnAssignmentListObject.GetFriendshipValue
	// float GetFriendshipValue();                                                                                              // [0x3cdfaa4] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoCreature_TamingUI.JunoBarnAssignmentListObject.GetFriendshipStateTag
	// FGameplayTag GetFriendshipStateTag();                                                                                    // [0x3e62d5c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoCreature_TamingUI.JunoBarnAssignmentListObject.GetDisplayName
	// FText GetDisplayName();                                                                                                  // [0xcd43544] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoCreature_TamingUI.JunoBarnAssignmentListObject.GetDescriptorTag
	// FGameplayTag GetDescriptorTag();                                                                                         // [0x3a008ac] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void UpdateVillageInfo();                                                                                                // [0x784f7b4] Native|Event|Protected|BlueprintEvent 
	// Function /Script/JunoCreature_TamingUI.JunoVillageTamingHubScreen.HandleRemoveVillageConfirmed
	// void HandleRemoveVillageConfirmed();                                                                                     // [0xcd436a4] Final|Native|Protected 
...
public:
	...
	// void SetVillageRewardEntryInfo(FJunoVillageTamingLevelRewardsColumnInfo& InVillageTamingLevelRewardsColumnInfo, FJunoVillageUIData& InParentVillageUIData); // [0xcd437f0] Native|Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/JunoCreature_TamingUI.JunoVillageTamingLevelRewardsColumn.SetIsExpanded
	// void SetIsExpanded(bool bIsExpanded);                                                                                    // [0x20c3f9c] Event|Public|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// void SetVillageRewardEntryInfo(FJunoVillageTamingLevelRewardsEntryInfo& InVillageTamingLevelRewardsEntryInfo, FJunoVillageUIData& InParentVillageUIData); // [0xcd4392c] Native|Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/JunoCreature_TamingUI.JunoVillageTamingLevelRewardsEntry.SetExpanded
	// void SetExpanded(bool bInIsExpanded);                                                                                    // [0x20c3f9c] Event|Public|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// void RefreshPointsProgressBars();                                                                                        // [0x20c3f9c] Event|Protected|BlueprintEvent 
	// Function /Script/JunoCreature_TamingUI.JunoVillageTamingLevelRewardsScreen.OnRewardsFilledOut
	// void OnRewardsFilledOut();                                                                                               // [0x20c3f9c] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void SetVillagerInfo(FJunoVillageTamingVillagerEntryInfo& InVillagerInfo);                                               // [0xcd43a64] Native|Event|Public|HasOutParms|BlueprintEvent 
};
...
public:
	...
	// void OnSelectionChanged(class UJunoBarnAssignmentListObject* InSelectedListObject);                                      // [0x20c3f9c] Event|Protected|BlueprintEvent 
	// Function /Script/JunoCreature_TamingUI.JunoBarnAssignmentScreen.GetVillageHasSlotForAnimal
	// bool GetVillageHasSlotForAnimal();                                                                                       // [0xcd43670] Final|Native|Protected|BlueprintCallable|Const 
	// Function /Script/JunoCreature_TamingUI.JunoBarnAssignmentScreen.GetGlobalHasSlotForAnimal
	// bool GetGlobalHasSlotForAnimal();                                                                                        // [0xcd43588] Final|Native|Protected|BlueprintCallable|Const 
};
...
public:
	...
	// void SetupAnimalInfo(FActiveCampCreatureEntry& Data);                                                                    // [0x20c3f9c] Event|Protected|HasOutParms|BlueprintEvent 
};
...
public:
	...
	// void SetPreviewMarkerMaterial(bool bIsTown);                                                                             // [0x20c3f9c] Event|Public|BlueprintEvent 
	// Function /Script/JunoCreature_TamingUI.JunoTamingMapMarkerIconScreen.SetMarkerNameText
	// void SetMarkerNameText(bool bIsTown, FText& Name);                                                                       // [0x20c3f9c] Event|Public|HasOutParms|BlueprintEvent 
};
...
public:
	...
	// void HandleTabSelected(FName SelectedTabId);                                                                             // [0xcd436b8] Final|Native|Private 
};
...
public:
	...
	// void OnEntryHovered(class UJunoVillageTamingVillagerEntry* Entry);                                                       // [0x20c3f9c] Event|Protected|BlueprintEvent 
	// Function /Script/JunoCreature_TamingUI.JunoVillageTamingVillagersScreen.HandleAskToLeaveConfirmed
	// void HandleAskToLeaveConfirmed();                                                                                        // [0xcd43690] Final|Native|Protected 
	// Function /Script/JunoCreature_TamingUI.JunoVillageTamingVillagersScreen.HandleAskToLeaveCancelled
	// void HandleAskToLeaveCancelled();                                                                                        // [0xccf2a7c] Final|Native|Protected 
};
