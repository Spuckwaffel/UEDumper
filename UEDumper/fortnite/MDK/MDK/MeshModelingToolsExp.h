...
public:
	...
	// TArray<FString> GetTargetUVLayerNamesFunc();                                                                             // [0xc268fd8] Final|Native|Public|Const 
	// Function /Script/MeshModelingToolsExp.BakeInputMeshProperties.GetSourceUVLayerNamesFunc
	// TArray<FString> GetSourceUVLayerNamesFunc();                                                                             // [0xc268fbc] Final|Native|Public|Const 
};
...
public:
	...
	// TArray<FString> GetUVLayerNamesFunc();                                                                                   // [0xc12ce20] Final|Native|Public|Const 
};
...
public:
	...
	// TArray<FString> GetUVLayerNamesFunc();                                                                                   // [0xc268534] Final|Native|Public|Const 
};
...
public:
	...
	// bool IsPreventTinyTrianglesEnabled();                                                                                    // [0x68907a8] Native|Protected|Const 
	// Function /Script/MeshModelingToolsExp.MeshConstraintProperties.IsPreventNormalFlipsEnabled
	// bool IsPreventNormalFlipsEnabled();                                                                                      // [0x38c923c] Native|Protected|Const 
};
...
public:
	...
	// void ResetAxis();                                                                                                        // [0xc283b38] Final|Native|Public  
};
...
public:
	...
	// TArray<FString> GetMapPreviewNamesFunc();                                                                                // [0xc283b00] Final|Native|Public  
};
...
public:
	...
	// TArray<FString> GetTargetUVLayerNamesFunc();                                                                             // [0xc283b1c] Final|Native|Public|Const 
};
...
public:
	...
	// TArray<FString> GetGroupOptionsList();                                                                                   // [0xc12cde4] Final|Native|Public  
};
...
public:
	...
	// TArray<FString> GetWeightMapsFunc();                                                                                     // [0xc2c4950] Final|Native|Public  
};
...
public:
	...
	// TArray<FString> GetMaterialIDsFunc();                                                                                    // [0xc12cde4] Final|Native|Public  
};
...
public:
	...
	// void DiscardAttributes();                                                                                                // [0xc2c48f0] Final|Native|Public  
};
...
public:
	...
	// void SelectAll();                                                                                                        // [0xc31dfdc] Final|Native|Public  
	// Function /Script/MeshModelingToolsExp.HoleFillToolActions.Clear
	// void Clear();                                                                                                            // [0xc31dd5c] Final|Native|Public  
};
...
public:
	...
	// void Constrain();                                                                                                        // [0xc31ddd0] Final|Native|Public  
	// Function /Script/MeshModelingToolsExp.LatticeDeformerToolProperties.ClearConstraints
	// void ClearConstraints();                                                                                                 // [0xc31dda4] Final|Native|Public  
};
...
public:
	...
	// TArray<FString> GetAttributeNames();                                                                                     // [0xc268550] Final|Native|Public  
};
...
public:
	...
	// TArray<FString> GetUVChannelNamesFunc();                                                                                 // [0xc268534] Final|Native|Public|Const 
};
...
public:
	...
	// void ShiftToCenter();                                                                                                    // [0xc31e024] Final|Native|Public  
};
...
public:
	...
	// TArray<FString> GetLODNamesFunc();                                                                                       // [0xc283b1c] Final|Native|Public|Const 
	// Function /Script/MeshModelingToolsExp.MeshVertexPaintToolUtilityActions.ApplySelectedOperation
	// void ApplySelectedOperation();                                                                                           // [0xc31dd2c] Final|Native|Public  
};
...
public:
	...
	// void FlipPlane();                                                                                                        // [0xc3647bc] Final|Native|Protected 
	// Function /Script/MeshModelingToolsExp.PlaneCutTool.Cut
	// void Cut();                                                                                                              // [0xc364768] Final|Native|Protected 
};
...
public:
	...
	// TArray<FString> GetTargetLODNamesFunc();                                                                                 // [0xc3647d4] Final|Native|Public|Const 
	// Function /Script/MeshModelingToolsExp.TransferMeshToolProperties.GetSourceLODNamesFunc
	// TArray<FString> GetSourceLODNamesFunc();                                                                                 // [0xc283b00] Final|Native|Public|Const 
};
