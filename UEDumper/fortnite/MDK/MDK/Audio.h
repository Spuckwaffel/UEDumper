...
public:
	...
	// void InitPreview();                                                                                                      // [0x20c3f9c] Public|BlueprintCallable|BlueprintEvent 
	// Function /SparksCore/Audio/BPC_SparksSongPreviewer.BPC_SparksSongPreviewer_C.ForceStopPreviewImmediate
	// void ForceStopPreviewImmediate();                                                                                        // [0x20c3f9c] Public|BlueprintCallable|BlueprintEvent 
	// Function /SparksCore/Audio/BPC_SparksSongPreviewer.BPC_SparksSongPreviewer_C.StopPreviewingSong
	// void StopPreviewingSong(bool WithFadeout, FName SongShortName);                                                          // [0x20c3f9c] Public|BlueprintCallable|BlueprintEvent 
	// Function /SparksCore/Audio/BPC_SparksSongPreviewer.BPC_SparksSongPreviewer_C.IsPlayingPreview
	// void IsPlayingPreview(FName Song, bool& Is Playing Or Pending, bool& Is Playing, bool& Is Pending);                      // [0x20c3f9c] Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /SparksCore/Audio/BPC_SparksSongPreviewer.BPC_SparksSongPreviewer_C.StopPreview
	// void StopPreview(bool WithFadeout);                                                                                      // [0x20c3f9c] Public|BlueprintCallable|BlueprintEvent 
	...
	// void VideoOnTerminalError_Event(EBaseMediaTerminalErrorReason Reason);                                                   // [0x20c3f9c] BlueprintCallable|BlueprintEvent 
	// Function /SparksCore/Audio/BPC_SparksSongPreviewer.BPC_SparksSongPreviewer_C.OnVideoResumed
	// void OnVideoResumed();                                                                                                   // [0x20c3f9c] BlueprintCallable|BlueprintEvent 
	// Function /SparksCore/Audio/BPC_SparksSongPreviewer.BPC_SparksSongPreviewer_C.DoneFadingOutForStop
	// void DoneFadingOutForStop();                                                                                             // [0x20c3f9c] BlueprintCallable|BlueprintEvent 
	// Function /SparksCore/Audio/BPC_SparksSongPreviewer.BPC_SparksSongPreviewer_C.ExecuteUbergraph_BPC_SparksSongPreviewer
	// void ExecuteUbergraph_BPC_SparksSongPreviewer(int32_t EntryPoint);                                                       // [0x20c3f9c] Final|HasDefaults    
};
