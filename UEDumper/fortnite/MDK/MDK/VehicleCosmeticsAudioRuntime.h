...
public:
	...
	// void UpdateAudioData(class UVehicleAudioCosmeticData* CosmeticData);                                                     // [0xb43c01c] Final|Native|Public|BlueprintCallable 
	// Function /Script/VehicleCosmeticsAudioRuntime.VehicleCosmeticsAudioController.HandleEngineAudioItemUpdated
	// void HandleEngineAudioItemUpdated(TWeakObjectPtr<UVehicleCosmeticsItemDefinition_EngineAudio*> EngineAudioItem);         // [0x2f75008] Final|Native|Public  
	// Function /Script/VehicleCosmeticsAudioRuntime.VehicleCosmeticsAudioController.HandleEngineAudioCosmeticsFailed
	// void HandleEngineAudioCosmeticsFailed(FVehicleCosmeticsFailureInfo ReasonInfo);                                          // [0xb43bf04] Final|Native|Public  
	// Function /Script/VehicleCosmeticsAudioRuntime.VehicleCosmeticsAudioController.BP_OnUpdateAudioData
	// void BP_OnUpdateAudioData(class UVehicleAudioCosmeticData* CosmeticData);                                                // [0x20c3f9c] Event|Public|BlueprintEvent 
	// Function /Script/VehicleCosmeticsAudioRuntime.VehicleCosmeticsAudioController.BP_OnCosmeticsFailed
	// void BP_OnCosmeticsFailed(FVehicleCosmeticsFailureInfo ReasonInfo);                                                      // [0x20c3f9c] Event|Public|BlueprintEvent 
	// Function /Script/VehicleCosmeticsAudioRuntime.VehicleCosmeticsAudioController.BP_OnAudioDataLoaded
	// void BP_OnAudioDataLoaded(class USoundBase* sound);                                                                      // [0x20c3f9c] Event|Public|BlueprintEvent 
	// Function /Script/VehicleCosmeticsAudioRuntime.VehicleCosmeticsAudioController.BP_OnAudioDataEjected
	// void BP_OnAudioDataEjected();                                                                                            // [0x20c3f9c] Event|Public|BlueprintEvent 
};
...
public:
	...
	// void UnregisterVehcle(TScriptInterface<Class> Vehicle);                                                                  // [0x19a7bc0] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/VehicleCosmeticsAudioRuntime.VehicleCosmeticsAudioManager.SetVehicleBudgetOverride
	// void SetVehicleBudgetOverride(int32_t NewBudget);                                                                        // [0xb43bfa0] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/VehicleCosmeticsAudioRuntime.VehicleCosmeticsAudioManager.RemoveVehicleBudgetOverride
	// void RemoveVehicleBudgetOverride();                                                                                      // [0xb43bf84] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/VehicleCosmeticsAudioRuntime.VehicleCosmeticsAudioManager.RegisterVehicleWithAsset
	// void RegisterVehicleWithAsset(FVehicleCosmeticLoadRequestInfo& RequestInfo);                                             // [0x2da0c34] Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable 
};
