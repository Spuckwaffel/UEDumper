...
public:
	...
	// void Empty();                                                                                                            // [0x1447bfc] Native|Public|BlueprintCallable 
};
...
public:
	...
	// bool LoadOptimizedNetwork(FString OnnxPath);                                                                             // [0x20c3f9c] Event|Public|BlueprintEvent 
	// Function /Script/NearestNeighborModel.NearestNeighborOptimizedNetworkLoader.GetOptimizedNetwork
	// class UNearestNeighborOptimizedNetwork* GetOptimizedNetwork();                                                           // [0x80f21c4] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// int32_t GetNumBasis();                                                                                                   // [0x6f63df0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// bool IsReadyForTraining();                                                                                               // [0xbe128d0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/NearestNeighborModel.NearestNeighborModel.IsReadyForInference
	// bool IsReadyForInference();                                                                                              // [0xbe128b8] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/NearestNeighborModel.NearestNeighborModel.GetTotalNumBasis
	// int32_t GetTotalNumBasis();                                                                                              // [0xbe12894] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/NearestNeighborModel.NearestNeighborModel.GetSectionPtr
	// class UNearestNeighborModelSection* GetSectionPtr(int32_t Index);                                                        // [0xbe12804] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/NearestNeighborModel.NearestNeighborModel.GetPCACoeffStarts
	// TArray<int32_t> GetPCACoeffStarts();                                                                                     // [0xbe127e8] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/NearestNeighborModel.NearestNeighborModel.GetNumSections
	// int32_t GetNumSections();                                                                                                // [0xb697d48] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/NearestNeighborModel.NearestNeighborModel.DoesUsePCA
	// bool DoesUsePCA();                                                                                                       // [0xbe126cc] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void Reset();                                                                                                            // [0xbe128e8] Final|Native|Public|BlueprintCallable 
	// Function /Script/NearestNeighborModel.NearestNeighborModelInstance.Eval
	// TArray<float> Eval(TArray<float>& InputData);                                                                            // [0xbe126e4] Final|Native|Private|HasOutParms|BlueprintCallable 
};
