...
public:
	...
	// void SetWaterBodyMIDParameters(class AWaterBody* WaterBody);                                                             // [0xbcc9ed0] Final|Native|Public|BlueprintCallable 
	// Function /Script/WaterAdvanced.ShallowWaterSubsystem.ResetImpacts
	// void ResetImpacts();                                                                                                     // [0xbcc9ebc] Final|Native|Public|BlueprintCallable 
	// Function /Script/WaterAdvanced.ShallowWaterSubsystem.RemoveCollisionTrackerForActor
	// void RemoveCollisionTrackerForActor(class AActor* CollisionTrackerActor);                                                // [0xbcc9df4] Final|Native|Protected|BlueprintCallable 
	// Function /Script/WaterAdvanced.ShallowWaterSubsystem.RegisterImpact
	// void RegisterImpact(FVector ImpactPosition, FVector ImpactVelocity, float ImpactRadius);                                 // [0xbcc9cc8] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/WaterAdvanced.ShallowWaterSubsystem.OnWaterInfoTextureCreated
	// void OnWaterInfoTextureCreated(class UTextureRenderTarget2D* WaterInfoTexture);                                          // [0xbcc9c24] Final|Native|Protected 
	// Function /Script/WaterAdvanced.ShallowWaterSubsystem.OnLocalPlayerPawnBecomesValid
	// void OnLocalPlayerPawnBecomesValid(class APawn* OldPawn, class APawn* NewPawn);                                          // [0xbcc9b60] Final|Native|Private 
	// Function /Script/WaterAdvanced.ShallowWaterSubsystem.OnLocalPlayerControllerBecomesValid
	// void OnLocalPlayerControllerBecomesValid(class APlayerController* InPlayerController);                                   // [0xbcc9ae0] Final|Native|Private 
	// Function /Script/WaterAdvanced.ShallowWaterSubsystem.GetAllOverlappingWaterBodiesAndUpdateCollisionTrackers
	// TSet<AWaterBody*> GetAllOverlappingWaterBodiesAndUpdateCollisionTrackers();                                              // [0xbcc9a24] Native|Protected|BlueprintCallable 
	// Function /Script/WaterAdvanced.ShallowWaterSubsystem.AddCollisionTrackerForActor
	// void AddCollisionTrackerForActor(class AActor* CollisionTrackerActor, float MaxLifespan);                                // [0xbcc9830] Final|Native|Protected|BlueprintCallable 
};
