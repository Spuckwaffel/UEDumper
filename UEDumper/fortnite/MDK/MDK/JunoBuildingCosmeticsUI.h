...
public:
	...
	// int32_t GetTotalPartCount();                                                                                             // [0xcca0a8c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoBuildingCosmeticsUI.JunoShopBuildSetItemDetailsVM.GetFormattedPartList
	// TArray<FText> GetFormattedPartList();                                                                                    // [0xcca0a14] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoBuildingCosmeticsUI.JunoShopBuildSetItemDetailsVM.ForceUpdateItemDetails
	// void ForceUpdateItemDetails();                                                                                           // [0xcca0a00] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// TArray<FText> GetPropNames();                                                                                            // [0xcca0a50] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
