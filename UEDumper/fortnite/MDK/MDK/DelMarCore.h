...
public:
	...
	SMember(FDelMarAnalyticsPlayerRaceData)            CurrentRunData                                              OFFSET(getStruct<T>, {0x108, 56, 0, 0})
...
{ 
	friend MDKHandler;
	static inline constexpr uint64_t __MDKClassSize = 8928;

public:
	SMember(FDelMarVehicleCameraSettings)              CameraSettings                                              OFFSET(getStruct<T>, {0x1CB8, 28, 0, 0})
	SMember(FRuntimeFloatCurve)                        VelocityViewDistance                                        OFFSET(getStruct<T>, {0x1CD8, 136, 0, 0})
	SMember(FRuntimeFloatCurve)                        VelocityFOV                                                 OFFSET(getStruct<T>, {0x1D60, 136, 0, 0})
	SMember(FRuntimeFloatCurve)                        AerialViewDistance                                          OFFSET(getStruct<T>, {0x1DE8, 136, 0, 0})
	SMember(FRuntimeFloatCurve)                        AerialFocusOffset                                           OFFSET(getStruct<T>, {0x1E70, 136, 0, 0})
	SMember(FRuntimeFloatCurve)                        AerialPitch                                                 OFFSET(getStruct<T>, {0x1EF8, 136, 0, 0})
	SMember(FRuntimeFloatCurve)                        AccelViewDistance                                           OFFSET(getStruct<T>, {0x1F80, 136, 0, 0})
	SMember(FRuntimeFloatCurve)                        AccelPitch                                                  OFFSET(getStruct<T>, {0x2008, 136, 0, 0})
	SMember(FRuntimeFloatCurve)                        AirRotationInterpRate                                       OFFSET(getStruct<T>, {0x2090, 136, 0, 0})
	DMember(float)                                     DriftSwivelSpeed                                            OFFSET(get<float>, {0x2118, 4, 0, 0})
	DMember(float)                                     ViewDistanceInterpSpeed                                     OFFSET(get<float>, {0x211C, 4, 0, 0})
	DMember(float)                                     FOVInterpSpeed                                              OFFSET(get<float>, {0x2120, 4, 0, 0})
	DMember(float)                                     AccelerationViewDistanceDecayRate                           OFFSET(get<float>, {0x2124, 4, 0, 0})
	DMember(float)                                     MaxAccumulatedAccelViewDistance                             OFFSET(get<float>, {0x2128, 4, 0, 0})
	DMember(float)                                     MinAccumulatedAccelViewDistance                             OFFSET(get<float>, {0x212C, 4, 0, 0})
	DMember(float)                                     AerialOffsetInterpSpeed                                     OFFSET(get<float>, {0x2130, 4, 0, 0})
	DMember(float)                                     MaximumDownwardAerialPitch                                  OFFSET(get<float>, {0x2134, 4, 0, 0})
	DMember(float)                                     MaximumUpwardAerialPitch                                    OFFSET(get<float>, {0x2138, 4, 0, 0})
	DMember(float)                                     AccelerationPitchDecayRate                                  OFFSET(get<float>, {0x213C, 4, 0, 0})
	DMember(float)                                     MaxAccumulatedAccelPitch                                    OFFSET(get<float>, {0x2140, 4, 0, 0})
	DMember(float)                                     MinAccumulatedAccelPitch                                    OFFSET(get<float>, {0x2144, 4, 0, 0})
	DMember(bool)                                      bPreventSpeedIncreaseInAir                                  OFFSET(get<bool>, {0x2148, 1, 0, 0})
	DMember(float)                                     SpeedInputScalar                                            OFFSET(get<float>, {0x214C, 4, 0, 0})
	DMember(float)                                     SwivelPitchMax                                              OFFSET(get<float>, {0x2150, 4, 0, 0})
	DMember(float)                                     SwivelYawMax                                                OFFSET(get<float>, {0x2154, 4, 0, 0})
	DMember(float)                                     GroundPitchInterpRate                                       OFFSET(get<float>, {0x2158, 4, 0, 0})
	DMember(float)                                     GroundMaxPitchForNormalBlend                                OFFSET(get<float>, {0x215C, 4, 0, 0})
	DMember(float)                                     GroundNormalInterpRate                                      OFFSET(get<float>, {0x2160, 4, 0, 0})
	DMember(float)                                     GroundNormalAirInterpRate                                   OFFSET(get<float>, {0x2164, 4, 0, 0})
	DMember(float)                                     GroundYawRateMin                                            OFFSET(get<float>, {0x2168, 4, 0, 0})
	DMember(float)                                     GroundYawRateMax                                            OFFSET(get<float>, {0x216C, 4, 0, 0})
	DMember(float)                                     WallYawRateMin                                              OFFSET(get<float>, {0x2170, 4, 0, 0})
	DMember(float)                                     WallYawRateMax                                              OFFSET(get<float>, {0x2174, 4, 0, 0})
	DMember(float)                                     InterpToGroundTime                                          OFFSET(get<float>, {0x2178, 4, 0, 0})
	DMember(float)                                     InterpToAirTime                                             OFFSET(get<float>, {0x217C, 4, 0, 0})
	DMember(float)                                     AverageVelocityInterpRate                                   OFFSET(get<float>, {0x2180, 4, 0, 0})
	DMember(float)                                     FocusOffsetInterpRate                                       OFFSET(get<float>, {0x2184, 4, 0, 0})
	DMember(float)                                     DistanceSpeedScale                                          OFFSET(get<float>, {0x2188, 4, 0, 0})
	DMember(float)                                     DistanceOffsetMin                                           OFFSET(get<float>, {0x218C, 4, 0, 0})
	DMember(float)                                     DistanceOffsetMax                                           OFFSET(get<float>, {0x2190, 4, 0, 0})
	DMember(float)                                     DistanceInterpRate                                          OFFSET(get<float>, {0x2194, 4, 0, 0})
	DMember(float)                                     MaxSpeedFOVOffset                                           OFFSET(get<float>, {0x2198, 4, 0, 0})
	DMember(float)                                     SupersonicFOVOffset                                         OFFSET(get<float>, {0x219C, 4, 0, 0})
	DMember(float)                                     FOVInterpRate                                               OFFSET(get<float>, {0x21A0, 4, 0, 0})
	CMember(class ADelMarVehicle*)                     VehicleTarget                                               OFFSET(get<T>, {0x21A8, 8, 0, 0})
};
...
public:
	CMember(class UDelMarEvent_GlobalLeaderboardPersonalBestRetrieved*) PersonalBestRetrievedEvent                 OFFSET(get<T>, {0xA0, 8, 0, 0})
	SMember(FDelMarLeaderboardConfig)                  LeaderboardConfig                                           OFFSET(getStruct<T>, {0xC8, 32, 0, 0})
...
public:
	...
	CMember(class UDelMarVehicleBodySetup*)            DefaultBodySetup                                            OFFSET(get<T>, {0xB60, 8, 0, 0})
	CMember(class UDelMarVehicleBodySetupMap*)         BodySetupMap                                                OFFSET(get<T>, {0xB68, 8, 0, 0})
...
public:
	...
	CMember(TWeakObjectPtr<AActor*>)                   ActorSource                                                 OFFSET(get<T>, {0x10, 8, 0, 0})
};
...
public:
	...
	DMember(float)                                     StackCooldown                                               OFFSET(get<float>, {0x18, 4, 0, 0})
	CMember(TArray<class UClass*>)                     WorldBonusSpeedActors                                       OFFSET(get<T>, {0x20, 16, 0, 0})
};
...
public:
	...
	SMember(FDelMarVehicleConfigOverride_Collision)    Collision                                                   OFFSET(getStruct<T>, {0x4, 8, 0, 0})
	SMember(FDelMarVehicleConfigOverride_Drift)        Drift                                                       OFFSET(getStruct<T>, {0xC, 12, 0, 0})
	SMember(FDelMarVehicleConfigOverride_DriftBoost)   DriftBoost                                                  OFFSET(getStruct<T>, {0x18, 12, 0, 0})
	SMember(FDelMarVehicleConfigOverride_Drive)        Drive                                                       OFFSET(getStruct<T>, {0x24, 20, 0, 0})
