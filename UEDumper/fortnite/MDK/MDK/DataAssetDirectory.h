...
public:
	...
	SMember(FText)                                     TextProperty                                                OFFSET(getStruct<T>, {0x60, 16, 0, 0})
};
...
public:
	SMember(FDataAssetDirectoryTestPODStruct)          TestStruct                                                  OFFSET(getStruct<T>, {0x28, 56, 0, 0})
};
...
public:
	...
	SMember(FText)                                     TextProperty                                                OFFSET(getStruct<T>, {0x28, 16, 0, 0})
};
