...
public:
	...
	// void HandlePawnEmoteStopped(class UFortItemDefinition* MontageItemDef, class AFortPawn* PawnEmoting);                    // [0xbce78b4] Final|Native|Private 
	// Function /Script/HomerUI.FortHomerComponent.HandleLocalPlayerEliminatedPlayer
	// void HandleLocalPlayerEliminatedPlayer(class AFortPlayerStateAthena* Player);                                            // [0xbce7838] Final|Native|Private 
};
