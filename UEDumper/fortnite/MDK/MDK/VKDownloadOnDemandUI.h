...
public:
	...
	// void UpdateProjectConfirmed();                                                                                           // [0xcab5964] Final|Native|Protected|BlueprintCallable 
	// Function /Script/VKDownloadOnDemandUI.DownloadOnDemandProjectManagementTab.RemoveProjectConfirmed
	// void RemoveProjectConfirmed();                                                                                           // [0xcab58c0] Final|Native|Protected|BlueprintCallable 
};
...
public:
	...
	// void UpdateLightningViolator(ESlateVisibility InVisibility, FText& InText);                                              // [0x20c3f9c] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/VKDownloadOnDemandUI.DownloadOnDemandAddProjectModal.HandleDownloadLinkIdTextChanged
	// void HandleDownloadLinkIdTextChanged(FText& InputLinkCode);                                                              // [0xcab5824] Final|Native|Private|HasOutParms 
};
...
public:
	CMember(class UDownloadOnDemandProjectAssetTileInitializer*) Initializer                                       OFFSET(get<T>, {0x14F8, 8, 0, 0})
	CMember(class UImage*)                             Image_Item                                                  OFFSET(get<T>, {0x1510, 8, 0, 0})
	CMember(class UImage*)                             Image_Spinner                                               OFFSET(get<T>, {0x1518, 8, 0, 0})
	CMember(class UCommonNumericTextBlock*)            NumericTextBlock_ItemCount                                  OFFSET(get<T>, {0x1520, 8, 0, 0})
};

/// Class /Script/VKDownloadOnDemandUI.DownloadOnDemandProjectTile
/// Size: 0x01F0 (0x0014F0 - 0x0016E0)
...
public:
	SMember(FSlateBrush)                               SelectedHighlightBrush                                      OFFSET(getStruct<T>, {0x1500, 192, 0, 0})
	SMember(FSlateBrush)                               HoveredHighlightBrush                                       OFFSET(getStruct<T>, {0x15C0, 192, 0, 0})
	DMember(bool)                                      bIsSelected                                                 OFFSET(get<bool>, {0x1680, 1, 0, 0})
	CMember(class UDownloadOnDemandProject*)           Project                                                     OFFSET(get<T>, {0x1688, 8, 0, 0})
	CMember(class UDownloadOnDemandProjectTileImage*)  ProjectTileImage_Preview                                    OFFSET(get<T>, {0x16A0, 8, 0, 0})
	CMember(class UImage*)                             Image_UpdatePending                                         OFFSET(get<T>, {0x16A8, 8, 0, 0})
	CMember(class UImage*)                             Image_AddProject                                            OFFSET(get<T>, {0x16B0, 8, 0, 0})
	CMember(class UImage*)                             Image_Spinner                                               OFFSET(get<T>, {0x16B8, 8, 0, 0})
	CMember(class UImage*)                             Image_Error                                                 OFFSET(get<T>, {0x16C0, 8, 0, 0})
	CMember(class USizeBox*)                           SizeBox_Label                                               OFFSET(get<T>, {0x16C8, 8, 0, 0})
	CMember(class UCommonTextBlock*)                   TextBlock_Label                                             OFFSET(get<T>, {0x16D0, 8, 0, 0})
	CMember(class UCommonBorder*)                      Border_Highlight                                            OFFSET(get<T>, {0x16D8, 8, 0, 0})


	/// Functions
	// Function /Script/VKDownloadOnDemandUI.DownloadOnDemandProjectTile.UpdateLabel
	// void UpdateLabel(bool bShowLabel);                                                                                       // [0xcab58e4] Final|Native|Public|BlueprintCallable 
	// Function /Script/VKDownloadOnDemandUI.DownloadOnDemandProjectTile.OnLabelUpdated
	// void OnLabelUpdated();                                                                                                   // [0x20c3f9c] Event|Protected|BlueprintEvent 
};
