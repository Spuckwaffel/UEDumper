...
public:
	...
	// void Server_RenameAnimal(class AFortPlayerController* TriggeringPlayer, FGameplayTag UniqueAIIdentifier, FText NewName); // [0xcd3ad00] RequiredAPI|Net|NetReliableNative|Event|Public|NetServer 
	// Function /Script/JunoCreature_TamingRuntime.JunoControllerComponent_Taming.Server_ReassignAnimalToBarn
	// void Server_ReassignAnimalToBarn(class AFortPlayerController* TriggeringPlayer, class AActor* BarnActor, FGameplayTag UniqueAIIdentifier, FText ExistingName); // [0xcd3abb0] RequiredAPI|Net|NetReliableNative|Event|Public|NetServer 
	// Function /Script/JunoCreature_TamingRuntime.JunoControllerComponent_Taming.Server_BarnInteractionStarted
	// void Server_BarnInteractionStarted();                                                                                    // [0x8ce98d4] RequiredAPI|Net|NetReliableNative|Event|Public|NetServer 
	// Function /Script/JunoCreature_TamingRuntime.JunoControllerComponent_Taming.Server_BarnInteractionEnded
	// void Server_BarnInteractionEnded();                                                                                      // [0x8a24830] RequiredAPI|Net|NetReliableNative|Event|Public|NetServer 
	// Function /Script/JunoCreature_TamingRuntime.JunoControllerComponent_Taming.Server_AssignAnimalToBarn
	// void Server_AssignAnimalToBarn(class AFortPlayerController* TriggeringPlayer, class AActor* BarnActor, class AActor* AnimalActor, FText CustomName); // [0xcd3aa60] RequiredAPI|Net|NetReliableNative|Event|Public|NetServer 
	// Function /Script/JunoCreature_TamingRuntime.JunoControllerComponent_Taming.OnUnconvertFollowingAnimal
	// void OnUnconvertFollowingAnimal(class AFortPawn* UnconvertedPawn, EUnconvertReason UnconvertReason);                     // [0xcd3a9a0] Final|Native|Public  
	// Function /Script/JunoCreature_TamingRuntime.JunoControllerComponent_Taming.OnRep_FollowingAnimalAIDescriptorTag
	// void OnRep_FollowingAnimalAIDescriptorTag();                                                                             // [0xcd3a96c] Final|Native|Protected 
	// Function /Script/JunoCreature_TamingRuntime.JunoControllerComponent_Taming.OnConvertFollowingAnimal
	// void OnConvertFollowingAnimal(class AFortPawn* ConvertedPawn);                                                           // [0xcd3a8cc] Final|Native|Public  
	// Function /Script/JunoCreature_TamingRuntime.JunoControllerComponent_Taming.BP_HandleBarnInteractionStarted
	// void BP_HandleBarnInteractionStarted();                                                                                  // [0x20c3f9c] Event|Protected|BlueprintEvent 
	// Function /Script/JunoCreature_TamingRuntime.JunoControllerComponent_Taming.BP_HandleBarnInteractionEnded
	// void BP_HandleBarnInteractionEnded();                                                                                    // [0x20c3f9c] Event|Protected|BlueprintEvent 
};
