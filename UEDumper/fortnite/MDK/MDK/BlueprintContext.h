...
public:
	...
	// class USubsystem* GetContext(class UObject* ContextObject, class UClass* Class);                                         // [0x2d566b0] Final|BlueprintCosmetic|Native|Static|Public|BlueprintCallable|BlueprintPure 
};
