...
public:
	...
	// void EnableCustomTests();                                                                                                // [0xb2a13f8] Final|Native|Public|BlueprintCallable 
	// Function /Script/ZoneGraphDebug.ZoneGraphTestingComponent.DisableCustomTests
	// void DisableCustomTests();                                                                                               // [0xb2a13bc] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void EnableCustomTests();                                                                                                // [0xb2a13d0] Final|Native|Public|BlueprintCallable 
	// Function /Script/ZoneGraphDebug.ZoneGraphTestingActor.DisableCustomTests
	// void DisableCustomTests();                                                                                               // [0xb2a1394] Final|Native|Public|BlueprintCallable 
};
