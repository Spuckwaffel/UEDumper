...
public:
	SMember(FDataTableRowHandle)                       SearchInputActionRow                                        OFFSET(getStruct<T>, {0x400, 16, 0, 0})
	SMember(FDataTableRowHandle)                       ClearSearchInputActionRow                                   OFFSET(getStruct<T>, {0x410, 16, 0, 0})
