...
public:
	...
	// float GetMaxHealth();                                                                                                    // [0xba05664] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/WheelGrenadeRuntime.WheelGrenadeWheel.GetHealth
	// float GetHealth();                                                                                                       // [0xba05624] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
