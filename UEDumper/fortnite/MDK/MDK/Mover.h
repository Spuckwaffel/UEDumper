...
public:
	DMember(bool)                                      bIgnoreBaseRotation                                         OFFSET(get<bool>, {0x48, 1, 0, 0})
	CMember(class UObject*)                            TurnGenerator                                               OFFSET(get<T>, {0x50, 8, 0, 0})
...
public:
	DMember(float)                                     RadialForceLimit                                            OFFSET(get<float>, {0x68, 4, 0, 0})
	DMember(float)                                     FrictionForceLimit                                          OFFSET(get<float>, {0x6C, 4, 0, 0})
	DMember(float)                                     TwistTorqueLimit                                            OFFSET(get<float>, {0x70, 4, 0, 0})
	DMember(float)                                     SwingTorqueLimit                                            OFFSET(get<float>, {0x74, 4, 0, 0})
	DMember(float)                                     TargetHeight                                                OFFSET(get<float>, {0x78, 4, 0, 0})
	DMember(float)                                     GroundDamping                                               OFFSET(get<float>, {0x7C, 4, 0, 0})
	DMember(float)                                     FractionalVelocityToTarget                                  OFFSET(get<float>, {0x80, 4, 0, 0})
	DMember(float)                                     FractionalDownwardVelocityToTarget                          OFFSET(get<float>, {0x84, 4, 0, 0})
	DMember(float)                                     MaxUnsupportedTimeBeforeFalling                             OFFSET(get<float>, {0x88, 4, 0, 0})
};
...
public:
	...
	SMember(FHitResult)                                HitResult                                                   OFFSET(getStruct<T>, {0x8, 232, 0, 0})
	SMember(FWaterFlowSplineData)                      WaterSplineData                                             OFFSET(getStruct<T>, {0xF0, 232, 0, 0})
};
