...
public:
	...
	CMember(TMap<FGraphEdgeHandle, UGraphEdge*>)       Edges                                                       OFFSET(get<T>, {0xC0, 80, 0, 0})
	CMember(TMap<FGraphIslandHandle, UGraphIsland*>)   Islands                                                     OFFSET(get<T>, {0x110, 80, 0, 0})
};
...
public:
	SMember(FGraphVertexHandle)                        A                                                           OFFSET(getStruct<T>, {0x48, 40, 0, 0})
	SMember(FGraphVertexHandle)                        B                                                           OFFSET(getStruct<T>, {0x70, 40, 0, 0})
};
