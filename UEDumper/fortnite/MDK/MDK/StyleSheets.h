...
public:
	...
	// void BP_OnWidgetStyled();                                                                                                // [0x20c3f9c] RequiredAPI|Event|Protected|BlueprintEvent 
};
...
public:
	...
	/// Functions
	// Function /Script/StyleSheets.StyleSheetsSubsystem.UpdateWidgetStyleTags
	// bool UpdateWidgetStyleTags(class UWidget* InWidget, TArray<FGameplayTag> InAddedTags, TArray<FGameplayTag> InRemovedTags); // [0xa82eca8] Final|RequiredAPI|Native|Static|Public|BlueprintCallable 
};
