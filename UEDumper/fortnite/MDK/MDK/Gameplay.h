...
public:
	...
	CMember(class UPrimitiveComponent*)                ZiplineInteractComponent                                    OFFSET(get<T>, {0xC30, 8, 0, 0})
	CMember(class AB_Athena_Zipline_Ascender_C*)       AscenderZipline                                             OFFSET(get<T>, {0xC38, 8, 0, 0})
	SMember(FGameplayTag)                              DescendingTag                                               OFFSET(getStruct<T>, {0xC40, 4, 0, 0})
	CMember(class UAnimMontage*)                       M_AscendingAnim                                             OFFSET(get<T>, {0xC48, 8, 0, 0})
	CMember(class UAnimMontage*)                       M_DescendingAnim                                            OFFSET(get<T>, {0xC50, 8, 0, 0})
	...
	CMember(class UAnimMontage*)                       F_AscendingAnim                                             OFFSET(get<T>, {0xC68, 8, 0, 0})
	CMember(class UAnimMontage*)                       F_DescendingAnim                                            OFFSET(get<T>, {0xC70, 8, 0, 0})
