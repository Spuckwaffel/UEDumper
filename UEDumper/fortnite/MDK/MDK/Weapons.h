...
public:
	...
	// void EvaluateGraphExposedInputs_ExecuteUbergraph_Blueprint_Paper_VIM_AnimGraphNode_AnimDynamics_9E5EF2534AF35AEF656F7798016DF75B(); // [0x186becc] BlueprintEvent       
	...
	// void EvaluateGraphExposedInputs_ExecuteUbergraph_Blueprint_Paper_VIM_AnimGraphNode_AnimDynamics_3AF159404BD341EBBF1D83916A014149(); // [0x186becc] BlueprintEvent       
	...
	// void EvaluateGraphExposedInputs_ExecuteUbergraph_Blueprint_Paper_VIM_AnimGraphNode_AnimDynamics_ADC4973B4FF994FAB62509B5C600BF73(); // [0x186becc] BlueprintEvent       
	...
	// void EvaluateGraphExposedInputs_ExecuteUbergraph_Blueprint_Paper_VIM_AnimGraphNode_AnimDynamics_BCA43E284168E0AB05BB9E98D217441B(); // [0x186becc] BlueprintEvent       
	...
	// void ExecuteUbergraph_Blueprint_Paper_VIM(int32_t EntryPoint);                                                           // [0x186becc] Final                
};
...
public:
	...
	// void BlueprintUpdateAnimation(float DeltaTimeX);                                                                         // [0x186becc] Event|Public|BlueprintEvent 
	...
	// void ExecuteUbergraph_SpaceFeline_Axe_AnimBP(int32_t EntryPoint);                                                        // [0x186becc] Final|HasDefaults    
};
...
public:
	...
	// void AnimGraph(FPoseLink InPose, FPoseLink& AnimGraph);                                                                  // [0x186becc] HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_M_MED_Patches_Axe_AnimBP(int32_t EntryPoint);                                                      // [0x186becc] Final|HasDefaults    
};
...
{ 
	friend MDKHandler;
	static inline constexpr uint64_t __MDKClassSize = 8352;

public:
	SMember(FPointerToUberGraphFrame)                  UberGraphFrame                                              OFFSET(getStruct<T>, {0x1CE0, 8, 0, 0})
	DMember(float)                                     AnimateScopePostProcess_DownSightPostProcessAmount_393D8BA5486879173797EF8C9B8D4642 OFFSET(get<float>, {0x1CE8, 4, 0, 0})
	CMember(TEnumAsByte<ETimelineDirection>)           AnimateScopePostProcess__Direction_393D8BA5486879173797EF8C9B8D4642 OFFSET(get<T>, {0x1CEC, 1, 0, 0})
	CMember(class UTimelineComponent*)                 AnimateScopePostProcess                                     OFFSET(get<T>, {0x1CF0, 8, 0, 0})
	CMember(class UNiagaraSystem*)                     OpticGlint                                                  OFFSET(get<T>, {0x1CF8, 8, 0, 0})
	DMember(bool)                                      UseDestroyEffect                                            OFFSET(get<bool>, {0x1D00, 1, 0, 0})
	CMember(class UParticleSystem*)                    WeaponDurabilityDestroyEffect                               OFFSET(get<T>, {0x1D08, 8, 0, 0})
	CMember(class UParticleSystem*)                    WeaponDurabilityDestroyEffectIcon                           OFFSET(get<T>, {0x1D10, 8, 0, 0})
	DMember(bool)                                      Use_Reload_Particles                                        OFFSET(get<bool>, {0x1D18, 1, 0, 0})
	DMember(bool)                                      UseShellsOnFire_                                            OFFSET(get<bool>, {0x1D19, 1, 0, 0})
	DMember(bool)                                      UseShellsOnReload_                                          OFFSET(get<bool>, {0x1D1A, 1, 0, 0})
	DMember(bool)                                      UseShellsOnPump_                                            OFFSET(get<bool>, {0x1D1B, 1, 0, 0})
	CMember(class UNiagaraSystem*)                     Shell_Burst_FX                                              OFFSET(get<T>, {0x1D20, 8, 0, 0})
	CMember(class UNiagaraSystem*)                     Shell_Looping_FX                                            OFFSET(get<T>, {0x1D28, 8, 0, 0})
	CMember(class UNiagaraSystem*)                     Reload_System                                               OFFSET(get<T>, {0x1D30, 8, 0, 0})
	CMember(class UMaterialInterface*)                 Reload_Smoke_Material                                       OFFSET(get<T>, {0x1D38, 8, 0, 0})
	SMember(FName)                                     ReloadSocketName                                            OFFSET(getStruct<T>, {0x1D40, 4, 0, 0})
	SMember(FGameplayTag)                              TagToApplyOpticGlint                                        OFFSET(getStruct<T>, {0x1D44, 4, 0, 0})
	CMember(TArray<class AFortAIPawn*>)                Array_Of_Active_Enemy_AI                                    OFFSET(get<T>, {0x1D48, 16, 0, 0})
	DMember(bool)                                      Scope___Render_Enemies_To_Custom_Depth_Buffer               OFFSET(get<bool>, {0x1D58, 1, 0, 0})
	SMember(FName)                                     Shells_Socket_Name                                          OFFSET(getStruct<T>, {0x1D5C, 4, 0, 0})
	CMember(TEnumAsByte<En_ShellTypes_01>)             ShellTypeSelect                                             OFFSET(get<T>, {0x1D60, 1, 0, 0})
	DMember(double)                                    Shells_Spawn_Rate_Scale                                     OFFSET(get<double>, {0x1D68, 8, 0, 0})
	SMember(FVector)                                   ShellsRotationRate                                          OFFSET(getStruct<T>, {0x1D70, 24, 0, 0})
	SMember(FVector)                                   Shells_Velocity                                             OFFSET(getStruct<T>, {0x1D88, 24, 0, 0})
	SMember(FVector)                                   Shells_Gravity                                              OFFSET(getStruct<T>, {0x1DA0, 24, 0, 0})
	SMember(FVector)                                   Shells_Size                                                 OFFSET(getStruct<T>, {0x1DB8, 24, 0, 0})
	DMember(double)                                    Target_Scope_Vignette_Blur_Screen_Percentage                OFFSET(get<double>, {0x1DD0, 8, 0, 0})
	DMember(double)                                    ScopeCameraOffsetX                                          OFFSET(get<double>, {0x1DD8, 8, 0, 0})
	DMember(double)                                    ScopeCameraOffsetY                                          OFFSET(get<double>, {0x1DE0, 8, 0, 0})
	DMember(double)                                    Scope_Camera_Offset_Amount                                  OFFSET(get<double>, {0x1DE8, 8, 0, 0})
	DMember(double)                                    Inherit_Parent_Velocity                                     OFFSET(get<double>, {0x1DF0, 8, 0, 0})
	DMember(double)                                    Cylindrical_Radius                                          OFFSET(get<double>, {0x1DF8, 8, 0, 0})
	DMember(double)                                    Cylindrical_Height                                          OFFSET(get<double>, {0x1E00, 8, 0, 0})
	SMember(FLinearColor)                              Shell_Color                                                 OFFSET(getStruct<T>, {0x1E08, 16, 0, 0})
	CMember(class UNiagaraComponent*)                  Spawned_Shells                                              OFFSET(get<T>, {0x1E18, 8, 0, 0})
	DMember(bool)                                      DebugShellsSocket_                                          OFFSET(get<bool>, {0x1E20, 1, 0, 0})
	CMember(class USoundBase*)                         Sound_ScopeZoomIn                                           OFFSET(get<T>, {0x1E28, 8, 0, 0})
	CMember(class USoundBase*)                         Sound_ScopeZoomOut                                          OFFSET(get<T>, {0x1E30, 8, 0, 0})
	CMember(class UNiagaraComponent*)                  Alteration_Ambient_PS                                       OFFSET(get<T>, {0x1E38, 8, 0, 0})
	SMember(FGameplayTagContainer)                     ReticleHUDElementTags                                       OFFSET(getStruct<T>, {0x1E40, 32, 0, 0})
	DMember(bool)                                      Is_Wind_Enabled                                             OFFSET(get<bool>, {0x1E60, 1, 0, 0})
	CMember(class UParticleSystem*)                    MuzzleWindParticleSystem                                    OFFSET(get<T>, {0x1E68, 8, 0, 0})
	DMember(bool)                                      ShouldHideReticleAfterDelay                                 OFFSET(get<bool>, {0x1E70, 1, 0, 0})
	CMember(class UParticleSystemComponent*)           MuzzleWindParticleSpawned                                   OFFSET(get<T>, {0x1E78, 8, 0, 0})
	DMember(int32_t)                                   StencilBufferValue                                          OFFSET(get<int32_t>, {0x1E80, 4, 0, 0})
	CMember(class UCurveFloat*)                        Curve_PitchOffset                                           OFFSET(get<T>, {0x1E88, 8, 0, 0})
	CMember(class USoundBase*)                         Sound_ScopedInLoop                                          OFFSET(get<T>, {0x1E90, 8, 0, 0})
	CMember(class UAudioComponent*)                    ScopeZoomInComp                                             OFFSET(get<T>, {0x1E98, 8, 0, 0})
	CMember(class UAudioComponent*)                    ScopedInLoopComp                                            OFFSET(get<T>, {0x1EA0, 8, 0, 0})
	CMember(class UAudioComponent*)                    ScopeZoomOutComp                                            OFFSET(get<T>, {0x1EA8, 8, 0, 0})
	DMember(double)                                    Alteration_Ambient_PS_Max_Draw_Distance                     OFFSET(get<double>, {0x1EB0, 8, 0, 0})
	DMember(double)                                    Muzzle_PS_Max_Draw_Distance                                 OFFSET(get<double>, {0x1EB8, 8, 0, 0})
	DMember(double)                                    Beam_PS_Max_Draw_Distance                                   OFFSET(get<double>, {0x1EC0, 8, 0, 0})
	DMember(double)                                    Reload_PS_Max_Draw_Distance                                 OFFSET(get<double>, {0x1EC8, 8, 0, 0})
	DMember(double)                                    Shells_PS_Max_Draw_Distance                                 OFFSET(get<double>, {0x1ED0, 8, 0, 0})
	SMember(FMulticastInlineDelegate)                  onAimDownSightsChanged                                      OFFSET(getStruct<T>, {0x1ED8, 16, 0, 0})
	CMember(class UNiagaraComponent*)                  MuzzleNiagaraComponentInstance                              OFFSET(get<T>, {0x1EE8, 8, 0, 0})
	SMember(FTimerHandle)                              ScopeEffectDelay1Handle                                     OFFSET(getStruct<T>, {0x1EF0, 8, 0, 0})
	SMember(FTimerHandle)                              ScopeEffectDelay2Handle                                     OFFSET(getStruct<T>, {0x1EF8, 8, 0, 0})
	SMember(FScalableFloat)                            UseUpdatedFeedback                                          OFFSET(getStruct<T>, {0x1F00, 40, 0, 0})
	SMember(FMulticastInlineDelegate)                  OnStartFiring                                               OFFSET(getStruct<T>, {0x1F28, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  OnPersistentFireStopped                                     OFFSET(getStruct<T>, {0x1F38, 16, 0, 0})
	CMember(class UStaticMesh*)                        ScopeMesh                                                   OFFSET(get<T>, {0x1F48, 8, 0, 0})
	CMember(class UStaticMeshComponent*)               ScopeMesh1P_Spawned                                         OFFSET(get<T>, {0x1F50, 8, 0, 0})
	CMember(TArray<class UMaterialInterface*>)         ScopeMaterialOverrides                                      OFFSET(get<T>, {0x1F58, 16, 0, 0})
	DMember(float)                                     Reload_Smoke_Lifetime                                       OFFSET(get<float>, {0x1F68, 4, 0, 0})
	DMember(float)                                     Reload_Smoke_Width_Scale                                    OFFSET(get<float>, {0x1F6C, 4, 0, 0})
	SMember(FLinearColor)                              BaseColorAlpha                                              OFFSET(getStruct<T>, {0x1F70, 16, 0, 0})
	DMember(bool)                                      Use_Emissive_in_Reload                                      OFFSET(get<bool>, {0x1F80, 1, 0, 0})
	SMember(FLinearColor)                              Reload_Emissive_Color                                       OFFSET(getStruct<T>, {0x1F84, 16, 0, 0})
	DMember(bool)                                      Is_Rocket_Launcher                                          OFFSET(get<bool>, {0x1F94, 1, 0, 0})
	SMember(FLinearColor)                              Rocket_Launcher_Spark_Color                                 OFFSET(getStruct<T>, {0x1F98, 16, 0, 0})
	DMember(bool)                                      Reload_Ejects_Shells                                        OFFSET(get<bool>, {0x1FA8, 1, 0, 0})
	CMember(class UNiagaraComponent*)                  OpticGlintComp                                              OFFSET(get<T>, {0x1FB0, 8, 0, 0})
	CMember(class UFXSystemAsset*)                     Muzzle_System                                               OFFSET(get<T>, {0x1FB8, 8, 0, 0})
	DMember(float)                                     Muzzle_Hue_Control                                          OFFSET(get<float>, {0x1FC0, 4, 0, 0})
	DMember(float)                                     Muzzle_Core_Cap_Scale                                       OFFSET(get<float>, {0x1FC4, 4, 0, 0})
	SMember(FVector)                                   Muzzle_Core_Scale                                           OFFSET(getStruct<T>, {0x1FC8, 24, 0, 0})
	DMember(float)                                     Spark_Amount_Scale                                          OFFSET(get<float>, {0x1FE0, 4, 0, 0})
	DMember(float)                                     Smoke_Size_Scale                                            OFFSET(get<float>, {0x1FE4, 4, 0, 0})
	SMember(FLinearColor)                              MuzzleSmokeInitialColor                                     OFFSET(getStruct<T>, {0x1FE8, 16, 0, 0})
	DMember(float)                                     Smoke_Initial_Color_Scale_Variance                          OFFSET(get<float>, {0x1FF8, 4, 0, 0})
	DMember(float)                                     Smoke_Emissive_Scale                                        OFFSET(get<float>, {0x1FFC, 4, 0, 0})
	DMember(bool)                                      Use_Heated_Elements                                         OFFSET(get<bool>, {0x2000, 1, 0, 0})
	DMember(float)                                     Decal_Size                                                  OFFSET(get<float>, {0x2004, 4, 0, 0})
	SMember(FVector)                                   Decal_Offset                                                OFFSET(getStruct<T>, {0x2008, 24, 0, 0})
	DMember(float)                                     Decal_Alpha                                                 OFFSET(get<float>, {0x2020, 4, 0, 0})
	CMember(class UFXSystemComponent*)                 Spawned_Muzzle_System                                       OFFSET(get<T>, {0x2028, 8, 0, 0})
	DMember(int32_t)                                   Burst_Loops                                                 OFFSET(get<int32_t>, {0x2030, 4, 0, 0})
	DMember(bool)                                      Muzzle_BakedSupressor__Always_Suppressed_                   OFFSET(get<bool>, {0x2034, 1, 0, 0})
	DMember(bool)                                      Baked_Optics__Always_has_Optics_element_                    OFFSET(get<bool>, {0x2035, 1, 0, 0})
	DMember(double)                                    MinPlayFXTime                                               OFFSET(get<double>, {0x2038, 8, 0, 0})
	DMember(double)                                    LastPlayFXTime                                              OFFSET(get<double>, {0x2040, 8, 0, 0})
	SMember(FScalableFloat)                            UseNativeFX                                                 OFFSET(getStruct<T>, {0x2048, 40, 0, 0})
	DMember(bool)                                      bIsLocal                                                    OFFSET(get<bool>, {0x2070, 1, 0, 0})
	CMember(class UNiagaraSystem*)                     Magazine_Eject_System                                       OFFSET(get<T>, {0x2078, 8, 0, 0})
	SMember(FName)                                     Magazine_Eject_Socket_Name                                  OFFSET(getStruct<T>, {0x2080, 4, 0, 0})
	DMember(bool)                                      Use_Magazine_Eject                                          OFFSET(get<bool>, {0x2084, 1, 0, 0})
	CMember(class UMaterialInterface*)                 Magazine_Eject_Material                                     OFFSET(get<T>, {0x2088, 8, 0, 0})
	CMember(class UStaticMesh*)                        Magazine_Eject_Model                                        OFFSET(get<T>, {0x2090, 8, 0, 0})
	DMember(float)                                     ScopeEffectDelay1Time                                       OFFSET(get<float>, {0x2098, 4, 0, 0})
	DMember(float)                                     ScopeEffectDelay2Time                                       OFFSET(get<float>, {0x209C, 4, 0, 0})


	/// Functions
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.Try Show Reticle
	// void Try Show Reticle();                                                                                                 // [0x186becc] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.Activate Magazine Eject FX
	// void Activate Magazine Eject FX();                                                                                       // [0x186becc] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.MuzzleModCheck
	// void MuzzleModCheck(bool& isMuzzleBrake, bool& isMuzzleSupressor, bool& isMuzzleBreacher);                               // [0x186becc] Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.MuzzleADSCheck
	// void MuzzleADSCheck(bool& Return ADS Bool);                                                                              // [0x186becc] Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.ShowOpticGlint
	// void ShowOpticGlint(bool AimDownsights);                                                                                 // [0x186becc] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.StopLocalForceFeedback
	// void StopLocalForceFeedback(class UForceFeedbackEffect* ForceFeedbackEffect, FName tag);                                 // [0x186becc] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.PlayLocalForceFeedback
	// void PlayLocalForceFeedback(class UForceFeedbackEffect* ForceFeedbackEffect, FName tag, bool bLooping);                  // [0x186becc] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.getScopeComp
	// void getScopeComp(class UStaticMeshComponent*& ScopeComponent);                                                          // [0x186becc] Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.initScope
	// void initScope();                                                                                                        // [0x186becc] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.IsNewFeedbackEnabled
	// void IsNewFeedbackEnabled(bool& Enabled);                                                                                // [0x186becc] Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.LocalReloadStarted
	// void LocalReloadStarted(float ReloadTime, EFortWeaponReloadType ReloadType);                                             // [0x186becc] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.PlayScopeOutAudio
	// void PlayScopeOutAudio();                                                                                                // [0x186becc] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.GetScopeParameters
	// void GetScopeParameters(class UStaticMeshComponent*& ScopeComponent, FVector2D& DepthOfFieldVignetteRange, FVector& WeaponSightsOffset); // [0x186becc] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.StopScopedAudio
	// void StopScopedAudio();                                                                                                  // [0x186becc] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.StartScopedAudio
	// void StartScopedAudio();                                                                                                 // [0x186becc] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.SetPostProcessParams
	// void SetPostProcessParams(double InputPin);                                                                              // [0x186becc] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.SetActiveAlterationIdleParticles
	// void SetActiveAlterationIdleParticles(bool Active);                                                                      // [0x186becc] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.ShowReticle
	// void ShowReticle();                                                                                                      // [0x186becc] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.HideReticle
	// void HideReticle();                                                                                                      // [0x186becc] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.ActivateOrDeactivateWindParticle
	// void ActivateOrDeactivateWindParticle(bool bNewActive);                                                                  // [0x186becc] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.DeactivateMuzzleFX
	// void DeactivateMuzzleFX();                                                                                               // [0x186becc] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.ActivateReloadSmokeFX
	// void ActivateReloadSmokeFX();                                                                                            // [0x186becc] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.ActivateShellsFX
	// void ActivateShellsFX(bool bool);                                                                                        // [0x186becc] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.DeactivateShellsFX
	// void DeactivateShellsFX();                                                                                               // [0x186becc] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.SetupShellFX
	// void SetupShellFX();                                                                                                     // [0x186becc] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.UpdateShellEmittersFX
	// void UpdateShellEmittersFX();                                                                                            // [0x186becc] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.Muzzle Play Reload FX
	// void Muzzle Play Reload FX(TEnumAsByte<EFortReloadFXState> Selection);                                                   // [0x186becc] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.Muzzle Flash FX
	// void Muzzle Flash FX(bool Persistent Fire);                                                                              // [0x186becc] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.SetWpnRarity
	// void SetWpnRarity();                                                                                                     // [0x186becc] Public|BlueprintCallable|BlueprintEvent 
	...
	// void AnimateScopePostProcess__FinishedFunc();                                                                            // [0x186becc] BlueprintEvent       
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.AnimateScopePostProcess__UpdateFunc
	// void AnimateScopePostProcess__UpdateFunc();                                                                              // [0x186becc] BlueprintEvent       
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.AnimateScopePostProcess__Toggle Scope__EventFunc
	// void AnimateScopePostProcess__Toggle Scope__EventFunc();                                                                 // [0x186becc] BlueprintEvent       
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.OnLoaded_F0DCFB40496C39D956D872BA984FA1F2
	// void OnLoaded_F0DCFB40496C39D956D872BA984FA1F2(class UObject* Loaded);                                                   // [0x186becc] BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.OnLoaded_3A9BBE884A5C5966375089938B7DC0CA
	// void OnLoaded_3A9BBE884A5C5966375089938B7DC0CA(class UObject* Loaded);                                                   // [0x186becc] BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.OnLoaded_83457BA843174AC6288682A342EBEAD9
	// void OnLoaded_83457BA843174AC6288682A342EBEAD9(class UObject* Loaded);                                                   // [0x186becc] BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.OnLoaded_5B08633343C4DA6FF40449A8A36357E4
	// void OnLoaded_5B08633343C4DA6FF40449A8A36357E4(class UObject* Loaded);                                                   // [0x186becc] BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.OnPlayWeaponFireFX
	// void OnPlayWeaponFireFX(bool bPersistentFire, bool bSecondaryFire);                                                      // [0x186becc] BlueprintCosmetic|Event|Protected|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.OnStopWeaponFireFX
	// void OnStopWeaponFireFX();                                                                                               // [0x186becc] BlueprintCosmetic|Event|Protected|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.OnPlayReloadFX
	// void OnPlayReloadFX(TEnumAsByte<EFortReloadFXState> ReloadStage);                                                        // [0x186becc] BlueprintCosmetic|Event|Protected|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.OnSetTargeting
	// void OnSetTargeting(bool bNewIsTargeting);                                                                               // [0x186becc] Event|Public|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.K2_OnUnEquip
	// void K2_OnUnEquip();                                                                                                     // [0x186becc] Event|Public|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.InitializeScopeVariables
	// void InitializeScopeVariables();                                                                                         // [0x186becc] BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.Update Enemy Custom Depths
	// void Update Enemy Custom Depths(bool Enable Or Disable, int32_t StencilBufferValue);                                     // [0x186becc] BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.OnWeaponAttached
	// void OnWeaponAttached();                                                                                                 // [0x186becc] Event|Public|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.OnInitAlteration
	// void OnInitAlteration(class UFortAlterationItemDefinition* NewAlteration);                                               // [0x186becc] Event|Protected|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.OnInitCosmeticAlterations
	// void OnInitCosmeticAlterations(FFortCosmeticModification CosmeticMod);                                                   // [0x186becc] Event|Protected|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.ShellsON_(onPump)
	// void ShellsON_(onPump)();                                                                                                // [0x186becc] BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.OnEquippedWeaponDestory
	// void OnEquippedWeaponDestory();                                                                                          // [0x186becc] BlueprintCosmetic|Event|Protected|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.SetWeaponPierceThrough
	// void SetWeaponPierceThrough(bool Enable, int32_t TargetLimit);                                                           // [0x186becc] Net|NetReliableNetServer|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.SetWeaponPierceThrough_ClientRep
	// void SetWeaponPierceThrough_ClientRep(bool Enable, int32_t TargetLimit);                                                 // [0x186becc] Net|NetReliableNetClient|BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_B_Ranged_Generic(int32_t EntryPoint);                                                              // [0x186becc] Final|HasDefaults    
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.OnPersistentFireStopped__DelegateSignature
	// void OnPersistentFireStopped__DelegateSignature();                                                                       // [0x186becc] Public|Delegate|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.OnStartFiring__DelegateSignature
	// void OnStartFiring__DelegateSignature();                                                                                 // [0x186becc] Public|Delegate|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.onAimDownSightsChanged__DelegateSignature
	// void onAimDownSightsChanged__DelegateSignature(bool AimDownsights);                                                      // [0x186becc] Public|Delegate|BlueprintCallable|BlueprintEvent 
};
...
{ 
	friend MDKHandler;
	static inline constexpr uint64_t __MDKClassSize = 6184;

public:
	SMember(FPointerToUberGraphFrame)                  UberGraphFrame                                              OFFSET(getStruct<T>, {0x1798, 8, 0, 0})
	CMember(class UParticleSystemComponent*)           MeleeHeavy_PSC                                              OFFSET(get<T>, {0x17A0, 8, 0, 0})
	CMember(class UParticleSystem*)                    MeleeHeavy_ParticleSystem                                   OFFSET(get<T>, {0x17A8, 8, 0, 0})
	CMember(class UParticleSystem*)                    WeaponDurabilityDestroyEffect                               OFFSET(get<T>, {0x17B0, 8, 0, 0})
	CMember(class UParticleSystem*)                    WeaponDurabilityDestroyEffectIcon                           OFFSET(get<T>, {0x17B8, 8, 0, 0})
	DMember(bool)                                      UseDestroyEffect                                            OFFSET(get<bool>, {0x17C0, 1, 0, 0})
	CMember(class UNiagaraComponent*)                  Alteration_Ambient_PS                                       OFFSET(get<T>, {0x17C8, 8, 0, 0})
	SMember(FVector)                                   Effects_Color_Level                                         OFFSET(getStruct<T>, {0x17D0, 24, 0, 0})
	DMember(bool)                                      Equipped                                                    OFFSET(get<bool>, {0x17E8, 1, 0, 0})
	DMember(bool)                                      bEquipPendingInstigator                                     OFFSET(get<bool>, {0x17E9, 1, 0, 0})
	DMember(bool)                                      UseTimeofDayControl                                         OFFSET(get<bool>, {0x17EA, 1, 0, 0})
	DMember(bool)                                      Swing_Right_                                                OFFSET(get<bool>, {0x17EB, 1, 0, 0})
	CMember(class UFXSystemComponent*)                 Impact_FX                                                   OFFSET(get<T>, {0x17F0, 8, 0, 0})
	SMember(FRotator)                                  Left_Swing_Rotation                                         OFFSET(getStruct<T>, {0x17F8, 24, 0, 0})
	SMember(FRotator)                                  Right_Swing_Rotation                                        OFFSET(getStruct<T>, {0x1810, 24, 0, 0})


	/// Functions
	// Function /Game/Weapons/FORT_Melee/Blueprints/B_Athena_Pickaxe_Generic.B_Athena_Pickaxe_Generic_C.Melee_Effect_Color
	// void Melee_Effect_Color(FVector& Melee_Color_Set);                                                                       // [0x186becc] Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// int32_t Setup Swing Montage Section Index();                                                                             // [0x186becc] Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void Binding Time of Day Control(bool Bind / Unbind (T/F));                                                              // [0x186becc] Public|BlueprintCallable|BlueprintEvent 
	...
	// void UnbindSwingAnimTrailEvents();                                                                                       // [0x186becc] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/FORT_Melee/Blueprints/B_Athena_Pickaxe_Generic.B_Athena_Pickaxe_Generic_C.BindSwingAnimTrailEvents
	// void BindSwingAnimTrailEvents();                                                                                         // [0x186becc] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/FORT_Melee/Blueprints/B_Athena_Pickaxe_Generic.B_Athena_Pickaxe_Generic_C.PlayCQCPickaxeEnemyAudio
	// void PlayCQCPickaxeEnemyAudio(FHitResult Hit Result);                                                                    // [0x186becc] Public|BlueprintCallable|BlueprintEvent 
	...
	// void SetActiveAlterationIdleParticles(bool Active, bool Reset);                                                          // [0x186becc] Public|BlueprintCallable|BlueprintEvent 
	...
	// void OnStatChanged_F171C56748FEA3E19F93088E968D3E21(FName StatName, int32_t StatValue);                                  // [0x186becc] BlueprintCallable|BlueprintEvent 
	...
	// void PlayRClickImpacts();                                                                                                // [0x186becc] BlueprintCallable|BlueprintEvent 
	...
	// void TODCheck(EFortDayPhase CurrentDayPhase, EFortDayPhase PreviousDayPhase, bool bAtCreation);                          // [0x186becc] BlueprintCallable|BlueprintEvent 
	...
	// void HandleWeaponHolstered();                                                                                            // [0x186becc] BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/FORT_Melee/Blueprints/B_Athena_Pickaxe_Generic.B_Athena_Pickaxe_Generic_C.Vehicle Passenger
	// void Vehicle Passenger(class AFortPlayerPawn* FortPlayerPawn, class AActor* NewVehicle, class AActor* OldVehicle);       // [0x186becc] BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/FORT_Melee/Blueprints/B_Athena_Pickaxe_Generic.B_Athena_Pickaxe_Generic_C.Legacy Anim Trail Setup
	// void Legacy Anim Trail Setup(bool Activate);                                                                             // [0x186becc] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_B_Athena_Pickaxe_Generic(int32_t EntryPoint);                                                      // [0x186becc] Final|HasDefaults    
};
...
{ 
	friend MDKHandler;
	static inline constexpr uint64_t __MDKClassSize = 7001;

public:
	SMember(FPointerToUberGraphFrame)                  UberGraphFrame                                              OFFSET(getStruct<T>, {0x1AB8, 8, 0, 0})
	DMember(bool)                                      Equipped                                                    OFFSET(get<bool>, {0x1AC0, 1, 0, 0})
	CMember(class UNiagaraComponent*)                  Alteration_Ambient_PS                                       OFFSET(get<T>, {0x1AC8, 8, 0, 0})
	CMember(class UParticleSystem*)                    MeleeHeavy_ParticleSystem                                   OFFSET(get<T>, {0x1AD0, 8, 0, 0})
	CMember(class UParticleSystemComponent*)           MeleeHeavy_PSC                                              OFFSET(get<T>, {0x1AD8, 8, 0, 0})
	DMember(bool)                                      UseDestroyEffect                                            OFFSET(get<bool>, {0x1AE0, 1, 0, 0})
	CMember(class UParticleSystem*)                    WeaponDurabilityDestroyEffect                               OFFSET(get<T>, {0x1AE8, 8, 0, 0})
	CMember(class UParticleSystem*)                    WeaponDurabilityDestroyEffectIcon                           OFFSET(get<T>, {0x1AF0, 8, 0, 0})
	CMember(class UNiagaraComponent*)                  Offhand_Alteration_Ambient_PS                               OFFSET(get<T>, {0x1AF8, 8, 0, 0})
	DMember(bool)                                      bEquipPendingInstigator                                     OFFSET(get<bool>, {0x1B00, 1, 0, 0})
	SMember(FName)                                     Offhand_Socket_Name                                         OFFSET(getStruct<T>, {0x1B04, 4, 0, 0})
	CMember(class UAnimMontage*)                       MontageReference                                            OFFSET(get<T>, {0x1B08, 8, 0, 0})
	DMember(bool)                                      UseTimeofDayControl                                         OFFSET(get<bool>, {0x1B10, 1, 0, 0})
	CMember(class UFXSystemComponent*)                 Impact_FX                                                   OFFSET(get<T>, {0x1B18, 8, 0, 0})
	DMember(bool)                                      Swing_Right_                                                OFFSET(get<bool>, {0x1B20, 1, 0, 0})
	SMember(FRotator)                                  Left_Swing_Rotation                                         OFFSET(getStruct<T>, {0x1B28, 24, 0, 0})
	SMember(FRotator)                                  Right_Swing_Rotation                                        OFFSET(getStruct<T>, {0x1B40, 24, 0, 0})
	DMember(bool)                                      Swing_Right_1                                               OFFSET(get<bool>, {0x1B58, 1, 0, 0})
	...
	// void Unbind Dual Melee Swing Events();                                                                                   // [0x186becc] Public|BlueprintCallable|BlueprintEvent 
	...
	// void Bind Dual Melee Swing Events();                                                                                     // [0x186becc] Public|BlueprintCallable|BlueprintEvent 
	...
	// void Set Active Alteration Idle Particles(bool Active, bool Reset);                                                      // [0x186becc] Public|BlueprintCallable|BlueprintEvent 
	...
	// void OnStatChanged_9F72D14C4573F491E38302B51F08A0B8(FName StatName, int32_t StatValue);                                  // [0x186becc] BlueprintCallable|BlueprintEvent 
	...
	// void OnLoaded_F1C7B8E24518F4F2DE2C8DBABB95E06D(class UObject* Loaded);                                                   // [0x186becc] BlueprintCallable|BlueprintEvent 
	...
	// void Swing Left End();                                                                                                   // [0x186becc] BlueprintCallable|BlueprintEvent 
	...
	// void Swing Right End();                                                                                                  // [0x186becc] BlueprintCallable|BlueprintEvent 
	...
	// void SwingRight_Common();                                                                                                // [0x186becc] BlueprintCallable|BlueprintEvent 
	...
	// void SwingLeft_Common();                                                                                                 // [0x186becc] BlueprintCallable|BlueprintEvent 
	...
	// void Swing Left();                                                                                                       // [0x186becc] BlueprintCallable|BlueprintEvent 
	...
	// void Swing Right();                                                                                                      // [0x186becc] BlueprintCallable|BlueprintEvent 
	...
	// void Swing Left 2();                                                                                                     // [0x186becc] BlueprintCallable|BlueprintEvent 
	...
	// void Swing Right 2();                                                                                                    // [0x186becc] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_B_Athena_Pickaxe_DualWield_Generic(int32_t EntryPoint);                                            // [0x186becc] Final|HasDefaults    
};
...
public:
	...
	// void ExecuteUbergraph_LoudPhoenix_Axe_AnimBP(int32_t EntryPoint);                                                        // [0x186becc] Final                
};
...
public:
	...
	// void BlueprintInitializeAnimation();                                                                                     // [0x186becc] Event|Public|BlueprintEvent 
	...
	// void ExecuteUbergraph_EmberRae_Axe_L_AnimBP_Post(int32_t EntryPoint);                                                    // [0x186becc] Final                
};
...
public:
	...
	// void ExecuteUbergraph_EmberRae_Axe_R_AnimBP_Post(int32_t EntryPoint);                                                    // [0x186becc] Final                
};
...
public:
	...
	// void ExecuteUbergraph_NitroFlow_Axe_AnimBP(int32_t EntryPoint);                                                          // [0x186becc] Final                
};
...
public:
	...
	// void ExecuteUbergraph_Mechanical_Engineer_Female_AnimBP(int32_t EntryPoint);                                             // [0x186becc] Final                
};
...
public:
	...
	// void ExecuteUbergraph_HighTower_Tapas_Axe_AnimBP(int32_t EntryPoint);                                                    // [0x186becc] Final                
};
...
public:
	...
	// void ExecuteUbergraph_MetalScout_Axe_AnimBP(int32_t EntryPoint);                                                         // [0x186becc] Final                
};
...
public:
	...
	// void ExecuteUbergraph_GoldenGuard_Axe_AnimBP(int32_t EntryPoint);                                                        // [0x186becc] Final                
};
...
class FAnimBlueprintGeneratedConstantDatadup_189 : public FAnimBlueprintConstantData
{ 
	friend MDKHandler;
	friend MDKBase;
...
class FAnimBlueprintGeneratedMutableDatadup_190 : public FAnimBlueprintMutableData
{ 
	friend MDKHandler;
	friend MDKBase;
...
class FAnimBlueprintGeneratedConstantDatadup_191 : public FAnimBlueprintConstantData
{ 
	friend MDKHandler;
	friend MDKBase;
...
/// Struct None
/// Size: 0x9A74E8C0 (0x000000 - 0x9A74E8C0)
class FNone : public MDKBase
{ 
	friend MDKHandler;
	friend MDKBase;
	static inline constexpr uint64_t __MDKClassSize = -1703614272;
...
class FAnimBlueprintGeneratedConstantDatadup_192 : public FAnimBlueprintConstantData
{ 
	friend MDKHandler;
	friend MDKBase;
...
/// Struct None
/// Size: 0xEF3AB480 (0x000000 - 0xEF3AB480)
class FNonedup_193 : public MDKBase
{ 
	friend MDKHandler;
	friend MDKBase;
	static inline constexpr uint64_t __MDKClassSize = -281365376;
...
/// Size: 0x011F (0x000001 - 0x000120)
class FAnimBlueprintGeneratedConstantDatadup_194 : public FAnimBlueprintConstantData
{ 
	friend MDKHandler;
	friend MDKBase;
	static inline constexpr uint64_t __MDKClassSize = 288;
...
/// Struct +¼%
/// Size: 0x6C006C (0x000000 - 0x6C006C)
class F___dup_195 : public MDKBase
{ 
	friend MDKHandler;
	friend MDKBase;
	static inline constexpr uint64_t __MDKClassSize = 7077996;
...
class FAnimBlueprintGeneratedConstantDatadup_196 : public FAnimBlueprintConstantData
{ 
	friend MDKHandler;
	friend MDKBase;
...
/// Struct None
/// Size: 0x9A74E920 (0x000000 - 0x9A74E920)
class FNonedup_197 : public MDKBase
{ 
	friend MDKHandler;
	friend MDKBase;
	static inline constexpr uint64_t __MDKClassSize = -1703614176;
...
class FAnimBlueprintGeneratedConstantDatadup_198 : public FAnimBlueprintConstantData
{ 
	friend MDKHandler;
	friend MDKBase;
...
class FAnimBlueprintGeneratedConstantDatadup_199 : public FAnimBlueprintConstantData
{ 
	friend MDKHandler;
	friend MDKBase;
...
/// Struct None
/// Size: 0xA53701A0 (0x000000 - 0xA53701A0)
class FNonedup_200 : public MDKBase
{ 
	friend MDKHandler;
	friend MDKBase;
	static inline constexpr uint64_t __MDKClassSize = -1523121760;
...
/// Size: 0x020F (0x000001 - 0x000210)
class FAnimBlueprintGeneratedConstantDatadup_201 : public FAnimBlueprintConstantData
{ 
	friend MDKHandler;
	friend MDKBase;
	static inline constexpr uint64_t __MDKClassSize = 528;
...
/// Struct +¼%
/// Size: 0x72006F (0x000000 - 0x72006F)
class F___dup_202 : public MDKBase
{ 
	friend MDKHandler;
	friend MDKBase;
	static inline constexpr uint64_t __MDKClassSize = 7471215;
...
class FAnimBlueprintGeneratedConstantDatadup_203 : public FAnimBlueprintConstantData
{ 
	friend MDKHandler;
	friend MDKBase;
...
/// Size: 0x0001 (0x000001 - 0x000002)
class FAnimBlueprintGeneratedMutableDatadup_204 : public FAnimBlueprintMutableData
{ 
	friend MDKHandler;
	friend MDKBase;
	static inline constexpr uint64_t __MDKClassSize = 2;
...
/// Size: 0x011F (0x000001 - 0x000120)
class FAnimBlueprintGeneratedConstantDatadup_205 : public FAnimBlueprintConstantData
{ 
	friend MDKHandler;
	friend MDKBase;
	static inline constexpr uint64_t __MDKClassSize = 288;
...
/// Struct +¼%
/// Size: 0x6F006F (0x000000 - 0x6F006F)
class F___dup_206 : public MDKBase
{ 
	friend MDKHandler;
	friend MDKBase;
	static inline constexpr uint64_t __MDKClassSize = 7274607;
...
/// Size: 0x011F (0x000001 - 0x000120)
class FAnimBlueprintGeneratedConstantDatadup_207 : public FAnimBlueprintConstantData
{ 
	friend MDKHandler;
	friend MDKBase;
	static inline constexpr uint64_t __MDKClassSize = 288;
...
/// Struct None
/// Size: 0xE3EABA00 (0x000000 - 0xE3EABA00)
class FNonedup_208 : public MDKBase
{ 
	friend MDKHandler;
	friend MDKBase;
	static inline constexpr uint64_t __MDKClassSize = -471156224;
