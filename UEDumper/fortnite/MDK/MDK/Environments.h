...
public:
	...
	DMember(bool)                                      Floor_Enabled                                               OFFSET(get<bool>, {0x528, 1, 0, 0})
...
{ 
	friend MDKHandler;
	static inline constexpr uint64_t __MDKClassSize = 1844;

public:
	SMember(FPointerToUberGraphFrame)                  UberGraphFrame                                              OFFSET(getStruct<T>, {0x558, 8, 0, 0})
	CMember(class UChildActorComponent*)               PrefabActorComp                                             OFFSET(get<T>, {0x560, 8, 0, 0})
	CMember(class USkeletalMeshComponent*)             SkeletalMesh                                                OFFSET(get<T>, {0x568, 8, 0, 0})
	CMember(class UStaticMeshComponent*)               StaticMesh                                                  OFFSET(get<T>, {0x570, 8, 0, 0})
	CMember(class UStaticMeshComponent*)               ScalePivot                                                  OFFSET(get<T>, {0x578, 8, 0, 0})
	CMember(class UStaticMeshComponent*)               PivotHolder                                                 OFFSET(get<T>, {0x580, 8, 0, 0})
	CMember(class UParticleSystemComponent*)           CelebratoryFX                                               OFFSET(get<T>, {0x588, 8, 0, 0})
	CMember(class USceneComponent*)                    DefaultSceneRoot                                            OFFSET(get<T>, {0x590, 8, 0, 0})
	DMember(float)                                     HoloMatColorPulse_Alpha_E6C257BB472EFEF7971B66A1E8FAE3D8    OFFSET(get<float>, {0x598, 4, 0, 0})
	CMember(TEnumAsByte<ETimelineDirection>)           HoloMatColorPulse__Direction_E6C257BB472EFEF7971B66A1E8FAE3D8 OFFSET(get<T>, {0x59C, 1, 0, 0})
	CMember(class UTimelineComponent*)                 HoloMatColorPulse                                           OFFSET(get<T>, {0x5A0, 8, 0, 0})
	DMember(float)                                     ScaleAnimEvolve_Scaling_6D0D09564D54A0DEA88CCC96FA6653CC    OFFSET(get<float>, {0x5A8, 4, 0, 0})
	CMember(TEnumAsByte<ETimelineDirection>)           ScaleAnimEvolve__Direction_6D0D09564D54A0DEA88CCC96FA6653CC OFFSET(get<T>, {0x5AC, 1, 0, 0})
	CMember(class UTimelineComponent*)                 ScaleAnimEvolve                                             OFFSET(get<T>, {0x5B0, 8, 0, 0})
	DMember(float)                                     ScaleAnimLevel_Scaling_CC68128E49202D0C982B7A945E41AF43     OFFSET(get<float>, {0x5B8, 4, 0, 0})
	CMember(TEnumAsByte<ETimelineDirection>)           ScaleAnimLevel__Direction_CC68128E49202D0C982B7A945E41AF43  OFFSET(get<T>, {0x5BC, 1, 0, 0})
	CMember(class UTimelineComponent*)                 ScaleAnimLevel                                              OFFSET(get<T>, {0x5C0, 8, 0, 0})
	SMember(FTimerHandle)                              TimerHandle                                                 OFFSET(getStruct<T>, {0x5C8, 8, 0, 0})
	DMember(double)                                    Rotation                                                    OFFSET(get<double>, {0x5D0, 8, 0, 0})
	CMember(class UFortItem*)                          ItemToRepresent                                             OFFSET(get<T>, {0x5D8, 8, 0, 0})
	DMember(bool)                                      PreviewRotation                                             OFFSET(get<bool>, {0x5E0, 1, 0, 0})
	CMember(class UCurveFloat*)                        RotationAnimation                                           OFFSET(get<T>, {0x5E8, 8, 0, 0})
	CMember(class UParticleSystem*)                    LevelUpFX                                                   OFFSET(get<T>, {0x5F0, 8, 0, 0})
	CMember(class UParticleSystem*)                    EvolveUpFX                                                  OFFSET(get<T>, {0x5F8, 8, 0, 0})
	SMember(FVector)                                   FXTargetLocation                                            OFFSET(getStruct<T>, {0x600, 24, 0, 0})
	DMember(bool)                                      IsCharacter                                                 OFFSET(get<bool>, {0x618, 1, 0, 0})
	DMember(bool)                                      IsEvolve                                                    OFFSET(get<bool>, {0x619, 1, 0, 0})
	CMember(class UParticleSystem*)                    CharLevelUpFX                                               OFFSET(get<T>, {0x620, 8, 0, 0})
	CMember(class UParticleSystem*)                    CharEvolveUpFX                                              OFFSET(get<T>, {0x628, 8, 0, 0})
	CMember(class UMaterialInstanceDynamic*)           UIoverrideMID                                               OFFSET(get<T>, {0x630, 8, 0, 0})
	DMember(bool)                                      HasResetVisuals                                             OFFSET(get<bool>, {0x638, 1, 0, 0})
	CMember(class UParticleSystemComponent*)           ParticleSystem1                                             OFFSET(get<T>, {0x640, 8, 0, 0})
	CMember(class UParticleSystemComponent*)           ParticleSystem2                                             OFFSET(get<T>, {0x648, 8, 0, 0})
	CMember(class UParticleSystem*)                    CharSwapTransitionFX                                        OFFSET(get<T>, {0x650, 8, 0, 0})
	DMember(bool)                                      IsCharacterVisible                                          OFFSET(get<bool>, {0x658, 1, 0, 0})
	CMember(class AFortPlayerPawn*)                    HeroPawn                                                    OFFSET(get<T>, {0x660, 8, 0, 0})
	DMember(bool)                                      SanityChecker                                               OFFSET(get<bool>, {0x668, 1, 0, 0})
	CMember(class UMaterialInstanceDynamic*)           MID_HoloMaterial                                            OFFSET(get<T>, {0x670, 8, 0, 0})
	SMember(FName)                                     HideElement                                                 OFFSET(getStruct<T>, {0x678, 4, 0, 0})
	SMember(FName)                                     VertexRange                                                 OFFSET(getStruct<T>, {0x67C, 4, 0, 0})
	SMember(FName)                                     HideElement1                                                OFFSET(getStruct<T>, {0x680, 4, 0, 0})
	SMember(FName)                                     HideElement2                                                OFFSET(getStruct<T>, {0x684, 4, 0, 0})
	SMember(FName)                                     HideElement3                                                OFFSET(getStruct<T>, {0x688, 4, 0, 0})
	SMember(FName)                                     HideElement4                                                OFFSET(getStruct<T>, {0x68C, 4, 0, 0})
	SMember(FName)                                     HideElement5                                                OFFSET(getStruct<T>, {0x690, 4, 0, 0})
	SMember(FName)                                     HideElement6                                                OFFSET(getStruct<T>, {0x694, 4, 0, 0})
	SMember(FName)                                     HideElement7                                                OFFSET(getStruct<T>, {0x698, 4, 0, 0})
	SMember(FName)                                     HideElement8                                                OFFSET(getStruct<T>, {0x69C, 4, 0, 0})
	SMember(FName)                                     HideElement9                                                OFFSET(getStruct<T>, {0x6A0, 4, 0, 0})
	SMember(FVector)                                   ScalePivotPreScaleLocation                                  OFFSET(getStruct<T>, {0x6A8, 24, 0, 0})
	SMember(FVector)                                   StaticMeshPreScaleLocation                                  OFFSET(getStruct<T>, {0x6C0, 24, 0, 0})
	SMember(FVector)                                   SkelMeshPreScaleLocation                                    OFFSET(getStruct<T>, {0x6D8, 24, 0, 0})
	SMember(FVector)                                   PrefabPreScaleLocation                                      OFFSET(getStruct<T>, {0x6F0, 24, 0, 0})
	CMember(class UParticleSystemComponent*)           GhostPistolVFX                                              OFFSET(get<T>, {0x708, 8, 0, 0})
	CMember(class UParticleSystemComponent*)           Ghost_Sword_VFX                                             OFFSET(get<T>, {0x710, 8, 0, 0})
	CMember(class UStaticMeshComponent*)               Ghost_Sword_Mesh                                            OFFSET(get<T>, {0x718, 8, 0, 0})
	CMember(class UParticleSystemComponent*)           TransitionFXComponent                                       OFFSET(get<T>, {0x720, 8, 0, 0})
	CMember(class UParticleSystem*)                    CharSwapTransitionFXLoop                                    OFFSET(get<T>, {0x728, 8, 0, 0})
	SMember(FName)                                     HideElementsOnlyConsidersRedChannel                         OFFSET(getStruct<T>, {0x730, 4, 0, 0})
...
public:
	...
	CMember(class UCommonRichTextBlock*)               CustomString                                                OFFSET(get<T>, {0x2C8, 8, 0, 0})
	SMember(FText)                                     CustomText                                                  OFFSET(getStruct<T>, {0x2D0, 24, 0, 0})
