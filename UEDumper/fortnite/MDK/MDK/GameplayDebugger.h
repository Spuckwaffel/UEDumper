...
public:
	...
	// void ServerSetViewPoint(FVector InViewLocation, FVector InViewDirection);                                                // [0x743cdc8] RequiredAPI|Net|NetReliableNative|Event|Protected|NetServer|HasDefaults|NetValidate 
	// Function /Script/GameplayDebugger.GameplayDebuggerCategoryReplicator.ServerSetEnabled
	// void ServerSetEnabled(bool bEnable);                                                                                     // [0x743cd18] RequiredAPI|Net|NetReliableNative|Event|Protected|NetServer|NetValidate 
	// Function /Script/GameplayDebugger.GameplayDebuggerCategoryReplicator.ServerSetDebugActor
	// void ServerSetDebugActor(class AActor* Actor, bool bSelectInEditor);                                                     // [0x743cc20] RequiredAPI|Net|NetReliableNative|Event|Protected|NetServer|NetValidate 
	// Function /Script/GameplayDebugger.GameplayDebuggerCategoryReplicator.ServerSetCategoryEnabled
	// void ServerSetCategoryEnabled(int32_t CategoryID, bool bEnable);                                                         // [0x743cb28] RequiredAPI|Net|NetReliableNative|Event|Protected|NetServer|NetValidate 
	// Function /Script/GameplayDebugger.GameplayDebuggerCategoryReplicator.ServerSendExtensionInputEvent
	// void ServerSendExtensionInputEvent(int32_t ExtensionId, int32_t HandlerId);                                              // [0x743ca40] RequiredAPI|Net|NetReliableNative|Event|Protected|NetServer|NetValidate 
	// Function /Script/GameplayDebugger.GameplayDebuggerCategoryReplicator.ServerSendCategoryInputEvent
	// void ServerSendCategoryInputEvent(int32_t CategoryID, int32_t HandlerId);                                                // [0x743c958] RequiredAPI|Net|NetReliableNative|Event|Protected|NetServer|NetValidate 
	// Function /Script/GameplayDebugger.GameplayDebuggerCategoryReplicator.ServerResetViewPoint
	// void ServerResetViewPoint();                                                                                             // [0x743c90c] RequiredAPI|Net|NetReliableNative|Event|Protected|NetServer|NetValidate 
	// Function /Script/GameplayDebugger.GameplayDebuggerCategoryReplicator.OnRep_ReplicatedData
	// void OnRep_ReplicatedData();                                                                                             // [0x743c8d8] Final|RequiredAPI|Native|Protected 
	// Function /Script/GameplayDebugger.GameplayDebuggerCategoryReplicator.ClientDataPackPacket
	// void ClientDataPackPacket(FGameplayDebuggerDataPackRPCParams Params);                                                    // [0x743c828] RequiredAPI|Net|NetReliableNative|Event|Protected|NetClient 
};
