...
public:
	...
	// void HandleTrailerTerminalError(EBaseMediaTerminalErrorReason Reason);                                                   // [0xcd49b18] Final|Native|Private 
	// Function /Script/JunoFrontendUI.JunoFrontendExperienceFlow.HandleFinishTrailerStep
	// void HandleFinishTrailerStep();                                                                                          // [0xcd49b04] Final|Native|Private 
};

/// Class /Script/JunoFrontendUI.MatchmakingWidgetErrorVisualsForJuno
...
public:
	...
	// void StartMatchmakingInModeratorMode(FString InWorldId);                                                                 // [0xcd49cc4] Final|Native|Public|BlueprintCallable 
	// Function /Script/JunoFrontendUI.JunoWorldManagementViewModel.RemoveSelectedWorldFromList
	// void RemoveSelectedWorldFromList();                                                                                      // [0xcd49cb0] Final|Native|Public|BlueprintCallable 
	// Function /Script/JunoFrontendUI.JunoWorldManagementViewModel.InitWorldData
	// class UJunoWorldDataViewModel* InitWorldData(TWeakObjectPtr<UDataTable*>& InSettingDataTable, TWeakObjectPtr<UDataTable*>& InWorldImageDataTable); // [0xcd49b94] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/JunoFrontendUI.JunoWorldManagementViewModel.GetIsCreateFlowSelected
	// bool GetIsCreateFlowSelected();                                                                                          // [0xcd49abc] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoFrontendUI.JunoWorldManagementViewModel.FetchWorldData
	// void FetchWorldData();                                                                                                   // [0xcd49aa8] Final|Native|Public|BlueprintCallable 
	// Function /Script/JunoFrontendUI.JunoWorldManagementViewModel.EnableDataRefresh
	// void EnableDataRefresh();                                                                                                // [0xcd49a94] Final|Native|Public|BlueprintCallable 
	// Function /Script/JunoFrontendUI.JunoWorldManagementViewModel.DisableDataRefresh
	// void DisableDataRefresh();                                                                                               // [0xcd49a80] Final|Native|Public|BlueprintCallable 
};
...
/// Enum /Script/JunoFrontendUI.EJunoUIMatchmakingError
/// Size: 0x05
enum class EJunoUIMatchmakingError : uint8_t
{
	EJunoUIMatchmakingError__WorldOwnerMustBePartyLeader                             = 0,
	EJunoUIMatchmakingError__YouMustSelectWorldFirst                                 = 1,
	EJunoUIMatchmakingError__YouMustWaitForWorldToBeSelected                         = 2,
	EJunoUIMatchmakingError__WorldUnavailable                                        = 3,
	EJunoUIMatchmakingError__Num                                                     = 4
};
