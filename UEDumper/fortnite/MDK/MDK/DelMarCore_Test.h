...
public:
	...
	// void ReceiveTrackScrubberCompletedProfiling();                                                                           // [0xc972328] Final|Native|Protected 
	// Function /Script/DelMarCore_Test.DelMarTestControllerTrackScrubber.ReceiveRaceBeginEvent
	// void ReceiveRaceBeginEvent(FDelMarEvent_RaceActive& Event);                                                              // [0xc9722a8] Final|Native|Protected|HasOutParms 
};
