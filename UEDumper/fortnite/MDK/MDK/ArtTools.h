...
public:
	...
	// void Set Canvas Material Scale and Position(FVector2D Size, FVector2D Position, double Scale, class UObject* __WorldContext, FVector2D& Screen Position, FVector2D& Screen Size); // [0x186becc] Static|Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure 
	...
	// void Array to HLSL Int Array(TEnumAsByte<EIntTypes> Type, FString& Variable Name, TArray<int32_t>& Int, TArray<FVector2D>& int2, TArray<FVector>& int3, TArray<FLinearColor>& int4, class UObject* __WorldContext, FString& String); // [0x186becc] Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent 
};
