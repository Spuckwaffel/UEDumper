...
public:
	...
	// bool HasMatchingGameplayTag(FVerseGameplayTag TagToCheck);                                                               // [0x7f5704c] Native|Public|Const  
	// Function /Script/VerseGameplayTags.VerseGameplayTagAssetInterface.HasAnyMatchingGameplayTags
	// bool HasAnyMatchingGameplayTags(FVerseGameplayTagContainer& TagContainer);                                               // [0x7f5695c] Native|Public|HasOutParms|Const 
	// Function /Script/VerseGameplayTags.VerseGameplayTagAssetInterface.HasAllMatchingGameplayTags
	// bool HasAllMatchingGameplayTags(FVerseGameplayTagContainer& TagContainer);                                               // [0x7f5626c] Native|Public|HasOutParms|Const 
	// Function /Script/VerseGameplayTags.VerseGameplayTagAssetInterface.GetOwnedGameplayTags
	// void GetOwnedGameplayTags(FVerseGameplayTagContainer& TagContainer);                                                     // [0x7f55b84] Native|Public|HasOutParms|Const 
};
