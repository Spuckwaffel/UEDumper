...
public:
	...
	// void SetMediaURL(FString MediaUrl);                                                                                      // [0x84c386c] Final|Native|Public|BlueprintCallable 
};
...
public:
	CMember(class UClass*)                             DefaultTitleTextStyle                                       OFFSET(get<T>, {0x14F8, 8, 0, 0})
	CMember(class UClass*)                             FeaturedTitleTextStyle                                      OFFSET(get<T>, {0x1500, 8, 0, 0})
	SMember(FText)                                     Title                                                       OFFSET(getStruct<T>, {0x1508, 16, 0, 0})
	SMember(FString)                                   Link                                                        OFFSET(getStruct<T>, {0x1518, 16, 0, 0})
	DMember(bool)                                      bDownloadingExternalMedia                                   OFFSET(get<bool>, {0x1528, 1, 0, 0})
	DMember(bool)                                      bRefreshingMcpCatalog                                       OFFSET(get<bool>, {0x1529, 1, 0, 0})
	CMember(class UTexture2D*)                         ExternalMedia                                               OFFSET(get<T>, {0x1530, 8, 0, 0})
	CMember(class UCommonLazyImage*)                   LazyImage_Icon                                              OFFSET(get<T>, {0x1550, 8, 0, 0})
	CMember(class UCommonTextBlock*)                   TitleTextBlock                                              OFFSET(get<T>, {0x1558, 8, 0, 0})
	CMember(class UCommonTextBlock*)                   SubtitleTextBlock                                           OFFSET(get<T>, {0x1560, 8, 0, 0})
	CMember(class UCommonTextBlock*)                   EyebrowTextBlock                                            OFFSET(get<T>, {0x1568, 8, 0, 0})


	/// Functions
	// Function /Script/EpicCMSUIFramework.EpicCMSTileBase.Launch
	// void Launch();                                                                                                           // [0x84c37ac] Final|Native|Protected|BlueprintCallable 
};
...
public:
	...
	// void SetCurrentPageByIndex(int32_t PageIndex);                                                                           // [0x84c37e8] Final|Native|Protected|BlueprintCallable 
	// Function /Script/EpicCMSUIFramework.EpicCMSTileCarousel.PreviousPage
	// void PreviousPage();                                                                                                     // [0x84c37d4] Final|Native|Protected|BlueprintCallable 
	// Function /Script/EpicCMSUIFramework.EpicCMSTileCarousel.NextPage
	// void NextPage();                                                                                                         // [0x84c37c0] Final|Native|Protected|BlueprintCallable 
	// Function /Script/EpicCMSUIFramework.EpicCMSTileCarousel.NavigationVisibilityChanged
	// void NavigationVisibilityChanged(bool bShowNavigation);                                                                  // [0x20c3f9c] Event|Protected|BlueprintEvent 
	// Function /Script/EpicCMSUIFramework.EpicCMSTileCarousel.HandleTilePageAdded
	// void HandleTilePageAdded(class UWidget* TileWidget);                                                                     // [0x6f251e8] Native|Event|Protected|BlueprintEvent 
	// Function /Script/EpicCMSUIFramework.EpicCMSTileCarousel.GetCurrentPageIndex
	// int32_t GetCurrentPageIndex();                                                                                           // [0x84c3784] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/EpicCMSUIFramework.EpicCMSTileCarousel.BeginAutoScrolling
	// void BeginAutoScrolling();                                                                                               // [0x84c3750] Final|Native|Public|BlueprintCallable 
	// Function /Script/EpicCMSUIFramework.EpicCMSTileCarousel.AddTilePage
	// void AddTilePage(class UWidget* TilePageWidget);                                                                         // [0x84c35b8] Final|Native|Public|BlueprintCallable 
};
