...
public:
	...
	// void HandleUnconverted(class AFortPawn* UnconvertedPawn, EUnconvertReason UnconvertReason);                              // [0xcadb1d8] Final|Native|Private 
	// Function /Script/JunoAIRuntime.JunoAIFriendshipPawnComponent.HandleConverted
	// void HandleConverted(class AFortPawn* InstigatorPawn, class AFortPawn* ConvertedPawn);                                   // [0xcadb114] Final|Native|Private 
	// Function /Script/JunoAIRuntime.JunoAIFriendshipPawnComponent.GetFriendshipValue
	// float GetFriendshipValue();                                                                                              // [0xcada7d4] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoAIRuntime.JunoAIFriendshipPawnComponent.GetFriendshipState
	// FGameplayTag GetFriendshipState();                                                                                       // [0x8a31f30] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoAIRuntime.JunoAIFriendshipPawnComponent.EnableFriendshipChanges
	// bool EnableFriendshipChanges();                                                                                          // [0xcada77c] Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
	// Function /Script/JunoAIRuntime.JunoAIFriendshipPawnComponent.DisableFriendshipChanges
	// bool DisableFriendshipChanges();                                                                                         // [0xcada758] Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
	// Function /Script/JunoAIRuntime.JunoAIFriendshipPawnComponent.AreFriendshipChangesEnabled
	// bool AreFriendshipChangesEnabled();                                                                                      // [0xcada740] Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// bool RequestCreatureTemporaryDespawn(FGameplayTag& UniqueAIIdentifier);                                                  // [0xcadb29c] Final|BlueprintAuthorityOnly|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/JunoAIRuntime.JunoCampAIManagementComponent.HandleAwesomeLevelReady
	// void HandleAwesomeLevelReady(FJunoCampAwesomeStatsData& AwesomeData);                                                    // [0xcadb090] Final|Native|Protected|HasOutParms 
	// Function /Script/JunoAIRuntime.JunoCampAIManagementComponent.HandleAwesomeLevelChanged
	// void HandleAwesomeLevelChanged(FJunoAwesomeLevelChangeData& ChangeData);                                                 // [0xcadb000] Final|Native|Protected|HasOutParms 
	// Function /Script/JunoAIRuntime.JunoCampAIManagementComponent.HandleAISpawned
	// void HandleAISpawned(class AActor* SpawnedAIPawn, class UFortAthenaLivingWorldEventData* EventData);                     // [0xcadaf3c] Final|Native|Protected 
	// Function /Script/JunoAIRuntime.JunoCampAIManagementComponent.HandleAIDespawned
	// void HandleAIDespawned(class AActor* DespawnedAIPawn, class UFortAthenaLivingWorldEventData* EventData);                 // [0xcadae78] Final|Native|Protected 
	// Function /Script/JunoAIRuntime.JunoCampAIManagementComponent.HandleAIControllerFullySpawned
	// void HandleAIControllerFullySpawned(class AAIController* Controller, class AFortPawn* Pawn);                             // [0xcadab0c] Final|Native|Protected 
	// Function /Script/JunoAIRuntime.JunoCampAIManagementComponent.HandleAIControllerChanged
	// void HandleAIControllerChanged(class APawn* Pawn, class AController* OldController, class AController* NewController);   // [0xcada91c] Final|Native|Protected 
	// Function /Script/JunoAIRuntime.JunoCampAIManagementComponent.GetSpawnedAIFromUniqueAIIdentifier
	// class AFortPawn* GetSpawnedAIFromUniqueAIIdentifier(FGameplayTag& UniqueAIIdentifier);                                   // [0xcada7ec] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoAIRuntime.JunoCampAIManagementComponent.GetCachedAndReplicatedRecruitmentData
	// FJunoCampAICachedRecruitmentData GetCachedAndReplicatedRecruitmentData();                                                // [0xcada7a0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// bool RecruitToCampIfPossible(FJunoCreatureRecruitmentRequestData& RecruitmentRequestData);                               // [0xcadda1c] Final|RequiredAPI|BlueprintAuthorityOnly|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/JunoAIRuntime.JunoCreaturePawnComponent.OnRep_CachedCustomName
	// void OnRep_CachedCustomName();                                                                                           // [0xcadda08] Final|Native|Private|Const 
	// Function /Script/JunoAIRuntime.JunoCreaturePawnComponent.NotifyPetting
	// void NotifyPetting(class AFortPawn* Instigator);                                                                         // [0xcadd988] Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
	// Function /Script/JunoAIRuntime.JunoCreaturePawnComponent.NotifyFeeding
	// void NotifyFeeding(class AFortPawn* Instigator, class UFortItemDefinition* ItemBeingFed);                                // [0xcadd6ac] Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
	// Function /Script/JunoAIRuntime.JunoCreaturePawnComponent.HandleUnconverted
	// void HandleUnconverted(class AFortPawn* UnconvertedPawn, EUnconvertReason UnconvertReason);                              // [0xcadd5e8] Final|Native|Private 
	// Function /Script/JunoAIRuntime.JunoCreaturePawnComponent.HandleDied
	// void HandleDied(class AActor* DamagedActor, float Damage, class AController* InstigatedBy, class AActor* DamageCauser, FVector HitLocation, class UPrimitiveComponent* FHitComponent, FName BoneName, FVector Momentum); // [0xcadd1b4] Final|Native|Private|HasDefaults 
	// Function /Script/JunoAIRuntime.JunoCreaturePawnComponent.HandleConverted
	// void HandleConverted(class AFortPawn* InstigatorPawn, class AFortPawn* ConvertedPawn);                                   // [0xcadd0f0] Final|Native|Private 
	// Function /Script/JunoAIRuntime.JunoCreaturePawnComponent.GetCustomName
	// FText GetCustomName();                                                                                                   // [0xcadd0b8] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoAIRuntime.JunoCreaturePawnComponent.GetAssignedRecruitmentObjectId
	// FGuid GetAssignedRecruitmentObjectId();                                                                                  // [0xcadd09c] Final|BlueprintAuthorityOnly|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoAIRuntime.JunoCreaturePawnComponent.GetAssignedAndSpawnedRecruitmentObject
	// class UJunoCampRecruitmentObjectComponent* GetAssignedAndSpawnedRecruitmentObject();                                     // [0xcadd078] Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoAIRuntime.JunoCreaturePawnComponent.AssignNewCustomName
	// bool AssignNewCustomName(FText& NewCustomName);                                                                          // [0xcadcebc] Final|RequiredAPI|BlueprintAuthorityOnly|Native|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// FGameplayTagContainer GetSoftRemovedReasons();                                                                           // [0xcadd0d4] Final|Native|Private|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoAIRuntime.JunoNPCPawnComponent.GetAIRoleDisplayText
	// FText GetAIRoleDisplayText();                                                                                            // [0xcadd044] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoAIRuntime.JunoNPCPawnComponent.GetAIRole
	// FGameplayTag GetAIRole();                                                                                                // [0x82f0d34] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoAIRuntime.JunoNPCPawnComponent.ConvertAIRoleToDisplayText
	// FText ConvertAIRoleToDisplayText(FGameplayTag& AIRole);                                                                  // [0xcadcf64] Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void HandleFTUENPCSpawned(class AActor* FTUENPC, class UFortAthenaLivingWorldEventData* EventData);                      // [0xcadd524] Final|Native|Private 
};
...
public:
	...
	// void OnTimeOfDayPhaseChanged(EFortDayPhase CurrentDayPhase, EFortDayPhase PreviousDayPhase, bool bAtCreation);           // [0xcafe2f8] Final|Native|Protected 
};
...
public:
	...
	// void JunoEnableRecruitedCreaturePermaDeath(bool bEnable);                                                                // [0x654e370] Final|BlueprintAuthorityOnly|Exec|Native|Private 
	// Function /Script/JunoAIRuntime.JunoAICheatManager.JunoEnableHostileCreatures
	// void JunoEnableHostileCreatures(bool bEnable);                                                                           // [0x654e370] Final|BlueprintAuthorityOnly|Exec|Native|Private 
	// Function /Script/JunoAIRuntime.JunoAICheatManager.JunoEnableFriendlyNPCs
	// void JunoEnableFriendlyNPCs(bool bEnable);                                                                               // [0x654e370] Final|BlueprintAuthorityOnly|Exec|Native|Private 
	// Function /Script/JunoAIRuntime.JunoAICheatManager.JunoEnableFriendlyCreatures
	// void JunoEnableFriendlyCreatures(bool bEnable);                                                                          // [0x654e370] Final|BlueprintAuthorityOnly|Exec|Native|Private 
};
