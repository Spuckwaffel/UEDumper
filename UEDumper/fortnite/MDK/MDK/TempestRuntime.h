...
public:
	...
	// void EndTempestStorm(FString StormName);                                                                                 // [0x95b2bd0] Final|BlueprintAuthorityOnly|Exec|Native|Public 
};
...
public:
	...
	// void OnRep_MovementData();                                                                                               // [0xbf38bd8] Final|Native|Private|Const 
};
...
public:
	...
	// void OnRep_CurrentStateInfo();                                                                                           // [0xbf38b98] Final|Native|Private 
	// Function /Script/TempestRuntime.TempestStateMachineComponent.GetCurrentStateInfo
	// FTempestStateInfo GetCurrentStateInfo();                                                                                 // [0xbf38b70] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/TempestRuntime.TempestStateMachineComponent.GetCurrentStateCompletionPercentage
	// float GetCurrentStateCompletionPercentage();                                                                             // [0xbf38b48] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/TempestRuntime.TempestStateMachineComponent.GetCurrentState
	// ETempestState GetCurrentState();                                                                                         // [0xbf38b30] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/TempestRuntime.TempestStateMachineComponent.ForceDissipate
	// void ForceDissipate(FString InDissipationReason);                                                                        // [0xbf38450] Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
};
