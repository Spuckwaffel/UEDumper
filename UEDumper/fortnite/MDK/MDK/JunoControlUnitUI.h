...
public:
	...
	// void UpdateFromPowerManagerComponent(class UJunoPowerManagerComponent* InPowerManagerComponent);                         // [0xcd34ea8] Final|Native|Public|BlueprintCallable 
	// Function /Script/JunoControlUnitUI.JunoPowerManagerComponentVM.UpdateFromJunoPhysicsToyActor
	// void UpdateFromJunoPhysicsToyActor(class AJunoPhysicsToyActor* InJunoPhysicsToyActor);                                   // [0xcd34e00] Final|Native|Public|BlueprintCallable 
};
