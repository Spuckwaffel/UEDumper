...
public:
	...
	// void UpdateFromPowerManagerComponent(class UJunoPowerManagerComponent* InPowerManagerComponent);                         // [0xc6b41b0] Final|Native|Public|BlueprintCallable 
	// Function /Script/JunoControlUnitUI.JunoPowerManagerComponentVM.UpdateFromJunoPhysicsToyActor
	// void UpdateFromJunoPhysicsToyActor(class AJunoPhysicsToyActor* InJunoPhysicsToyActor);                                   // [0xc6b40c4] Final|Native|Public|BlueprintCallable 
};
