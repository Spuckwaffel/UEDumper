...
public:
	...
	// void OnLocalPlayersTeam(class AActor* TargetActor, class UObject* __WorldContext, bool& Return Value);                   // [0x186becc] Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure 
};
...
public:
	...
	// void PassParticle_Parameter(double NewParam, bool First_Hit);                                                            // [0x186becc] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_B_PlayerHealthDamage_CameraLensEffect(int32_t EntryPoint);                                         // [0x186becc] Final                
};
...
public:
	...
	// FRuntimeFloatCurve GetStrengthCurveForActiveType();                                                                      // [0x186becc] Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /Game/Effects/Fort_Effects/Camera_Effects/B_SoundIndicator_01.B_SoundIndicator_01_C.GetDefaultTint
	// FLinearColor GetDefaultTint();                                                                                           // [0x186becc] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Fort_Effects/Camera_Effects/B_SoundIndicator_01.B_SoundIndicator_01_C.GetDefaultIcon
	// class UTexture* GetDefaultIcon();                                                                                        // [0x186becc] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Fort_Effects/Camera_Effects/B_SoundIndicator_01.B_SoundIndicator_01_C.GetWeaponCurve
	// FRuntimeFloatCurve GetWeaponCurve();                                                                                     // [0x186becc] Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	...
	// void ExecuteUbergraph_B_SoundIndicator_01(int32_t EntryPoint);                                                           // [0x186becc] Final                
};
...
public:
	...
	// void PassParticle_Parameter_Shield(double NewParam);                                                                     // [0x186becc] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_B_PlayerShieldDamage_CameraLensEffect(int32_t EntryPoint);                                         // [0x186becc] Final                
};
...
public:
	...
	CMember(class UParticleSystemComponent*)           ParticleComponent                                           OFFSET(get<T>, {0x318, 8, 0, 0})
	CMember(class UCapsuleComponent*)                  CollisionComponent                                          OFFSET(get<T>, {0x320, 8, 0, 0})
	DMember(float)                                     ScaleDownParticleTL_ScaleDown_544AE05F40294D09C3C361AB7BCF6C4E OFFSET(get<float>, {0x328, 4, 0, 0})
	CMember(TEnumAsByte<ETimelineDirection>)           ScaleDownParticleTL__Direction_544AE05F40294D09C3C361AB7BCF6C4E OFFSET(get<T>, {0x32C, 1, 0, 0})
	CMember(class UTimelineComponent*)                 ScaleDownParticleTL                                         OFFSET(get<T>, {0x330, 8, 0, 0})
	CMember(class USoundBase*)                         SpawnSound                                                  OFFSET(get<T>, {0x338, 8, 0, 0})
	SMember(FVector)                                   Particle_Location                                           OFFSET(getStruct<T>, {0x340, 24, 0, 0})
	CMember(TArray<class USoundBase*>)                 Crack_sounds                                                OFFSET(get<T>, {0x358, 16, 0, 0})
	DMember(double)                                    ConnectTheDotsWidth                                         OFFSET(get<double>, {0x368, 8, 0, 0})
	DMember(double)                                    ConnectTheDotsDuration                                      OFFSET(get<double>, {0x370, 8, 0, 0})
	DMember(double)                                    ConnectTheDotsTimeoutFromPreviousHit                        OFFSET(get<double>, {0x378, 8, 0, 0})
	DMember(double)                                    ConnectTheDotsDurationScale                                 OFFSET(get<double>, {0x380, 8, 0, 0})
	DMember(double)                                    ConnectTheDotsMaxDuration                                   OFFSET(get<double>, {0x388, 8, 0, 0})
	DMember(double)                                    ConnectTheDotsTileScale                                     OFFSET(get<double>, {0x390, 8, 0, 0})
	DMember(double)                                    ConnectTheDotsMinLength                                     OFFSET(get<double>, {0x398, 8, 0, 0})
	DMember(double)                                    ConnectTheDotsMaxLength                                     OFFSET(get<double>, {0x3A0, 8, 0, 0})
	CMember(class UParticleSystem*)                    DamageTemplate                                              OFFSET(get<T>, {0x3A8, 8, 0, 0})
	CMember(class UParticleSystem*)                    IdleTemplate                                                OFFSET(get<T>, {0x3B0, 8, 0, 0})
	CMember(class UMaterialInstanceDynamic*)           ConnectMID                                                  OFFSET(get<T>, {0x3B8, 8, 0, 0})
	SMember(FTimerHandle)                              HideMeshTimer                                               OFFSET(getStruct<T>, {0x3C0, 8, 0, 0})
...
public:
	...
	// int32_t GetViewDistanceQuality();                                                                                        // [0x186becc] Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Fort_Effects/Gameplay/Pickups/B_Pickups_Parent.B_Pickups_Parent_C.Setup View Distances
	// void Setup View Distances(int32_t& viewDistanceQuality);                                                                 // [0x186becc] Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Fort_Effects/Gameplay/Pickups/B_Pickups_Parent.B_Pickups_Parent_C.Mobile Interation Icon Setup
	// void Mobile Interation Icon Setup();                                                                                     // [0x186becc] Public|BlueprintCallable|BlueprintEvent 
	...
	// void SetActiveBackgroundParticleSystem(bool Active, bool Reset);                                                         // [0x186becc] Public|BlueprintCallable|BlueprintEvent 
	...
	// void SetHiddenBackgroundVisualComponents(bool Hidden);                                                                   // [0x186becc] Public|BlueprintCallable|BlueprintEvent 
	...
	// void DestroyBackgroundVisualComponents();                                                                                // [0x186becc] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Fort_Effects/Gameplay/Pickups/B_Pickups_Parent.B_Pickups_Parent_C.ScaleHologramTimingsForPvP
	// void ScaleHologramTimingsForPvP();                                                                                       // [0x186becc] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Fort_Effects/Gameplay/Pickups/B_Pickups_Parent.B_Pickups_Parent_C.SetHologramPickedUpParams
	// void SetHologramPickedUpParams(bool Tier 0);                                                                             // [0x186becc] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Fort_Effects/Gameplay/Pickups/B_Pickups_Parent.B_Pickups_Parent_C.SpawnPickedUpTrailPS
	// void SpawnPickedUpTrailPS();                                                                                             // [0x186becc] Public|BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_B_Pickups_Parent(int32_t EntryPoint);                                                              // [0x186becc] Final|HasDefaults    
};
...
public:
	...
	// void initializeSpotlightComponent();                                                                                     // [0x186becc] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Fort_Effects/Gameplay/Pickups/B_Pickups_Default.B_Pickups_Default_C.AddRareFX
	// void AddRareFX();                                                                                                        // [0x186becc] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Effects/Fort_Effects/Gameplay/Pickups/B_Pickups_Default.B_Pickups_Default_C.Set Initial BKGD Param
	// void Set Initial BKGD Param(class UMaterialInstanceDynamic* Mid);                                                        // [0x186becc] Public|BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_B_Pickups_Default(int32_t EntryPoint);                                                             // [0x186becc] Final                
};
...
public:
	...
	// void RestoreInProgressRes();                                                                                             // [0x186becc] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	...
	// void Store Original Material for Teleport In();                                                                          // [0x186becc] Public|BlueprintCallable|BlueprintEvent 
	...
	// void External Mesh Masked Setup(TArray<USkeletalMeshComponent*>& External MEsh Component Array, TArray<UMaterialInstanceDynamic*>& Corrected Mid Array); // [0x186becc] Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent 
	...
	// void ProcessSpawnInTimeline(double ZHeight, double LightIntensity);                                                      // [0x186becc] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	...
	// void Make internal mids and append external and intermal mids to mid array();                                            // [0x186becc] Public|BlueprintCallable|BlueprintEvent 
	...
	// void Make and slave internal meshes();                                                                                   // [0x186becc] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	...
	// void Spawn  Light();                                                                                                     // [0x186becc] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	...
	// void Find Bounds();                                                                                                      // [0x186becc] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	...
	// void initializeExternalSkeletalMeshArray();                                                                              // [0x186becc] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	...
	// void CharacterSpawnInTimeline__FinishedFunc();                                                                           // [0x186becc] BlueprintEvent       
	...
	// void CharacterSpawnInTimeline__UpdateFunc();                                                                             // [0x186becc] BlueprintEvent       
	...
	// void UpdateExternalParameters(TArray<UMaterialInstanceDynamic*>& MID Array, TArray<USkeletalMeshComponent*>& External MEsh Component Array); // [0x186becc] HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_DuplicateResOutMesh(int32_t EntryPoint);                                                           // [0x186becc] Final|HasDefaults    
};
...
public:
	...
	// void ExecuteUbergraph_B_CameraLens_Boat_Droplets(int32_t EntryPoint);                                                    // [0x186becc] Final                
};
...
public:
	...
	// FTransform NewFunction(double Roll, double Scale);                                                                       // [0x186becc] Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure 
	...
	// void ExecuteUbergraph_FN_RadialForce(int32_t EntryPoint);                                                                // [0x186becc] Final                
};
...
public:
	...
	// void ExecuteUbergraph_B_CameraLens_Geyser(int32_t EntryPoint);                                                           // [0x186becc] Final                
};
...
public:
	...
	// void ExecuteUbergraph_B_CameraLens_Splash_Water_Droplets(int32_t EntryPoint);                                            // [0x186becc] Final                
};
...
public:
	...
	// void ExecuteUbergraph_B_CameraLens_SwimBoost(int32_t EntryPoint);                                                        // [0x186becc] Final                
};
...
public:
	...
	// void ExecuteUbergraph_B_CameraLens_Drown_Damage(int32_t EntryPoint);                                                     // [0x186becc] Final                
};
...
public:
	...
	// void ExecuteUbergraph_B_CameraLens_Shadow_Bomb_Loop(int32_t EntryPoint);                                                 // [0x186becc] Final                
};
...
public:
	...
	// void ExecuteUbergraph_B_CameraLens_Shadow_Bomb_End(int32_t EntryPoint);                                                  // [0x186becc] Final                
};
...
public:
	...
	// void ExecuteUbergraph_B_CameraLens_SpookyMist_Loop(int32_t EntryPoint);                                                  // [0x186becc] Final                
};
...
public:
	...
	// void ExecuteUbergraph_B_CameraLens_SpookyMist_End(int32_t EntryPoint);                                                   // [0x186becc] Final                
};
...
public:
	...
	// void ExecuteUbergraph_B_CameraLens_Lava_Bouncing(int32_t EntryPoint);                                                    // [0x186becc] Final                
};
...
public:
	...
	// bool Received_NotifyTick(class USkeletalMeshComponent* MeshComp, class UAnimSequenceBase* Animation, float FrameDeltaTime, FAnimNotifyEventReference& EventReference); // [0x186becc] Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|Const 
};
