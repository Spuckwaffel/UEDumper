...
public:
	...
	// void ResolveBuildingDamage(class ABuildingActor* DamagedBuildingActor, class AController* InstigatedBy, class AActor* DamageCauser); // [0xbcec688] Final|Native|Private 
	// Function /Script/IceRuntime.FortCurieElementAttachHandlerIce.HandleBuildingDamaged
	// void HandleBuildingDamaged(class AActor* DamagedActor, float Damage, class AController* InstigatedBy, class AActor* DamageCauser, FVector HitLocation, class UPrimitiveComponent* FHitComponent, FName BoneName, FVector Momentum); // [0xbcebf18] Final|Native|Private|HasDefaults 
};
...
public:
	...
	// void OnRep_SplinePoints();                                                                                               // [0xbcec634] Final|Native|Private 
	// Function /Script/IceRuntime.IceGroundPath.GetLocationOnLandscape
	// FVector GetLocationOnLandscape(FVector Location);                                                                        // [0xbcebe5c] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/IceRuntime.IceGroundPath.GetLastSplinePointLocation
	// bool GetLastSplinePointLocation(FVector& LastPointLocation);                                                             // [0xbcebd48] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/IceRuntime.IceGroundPath.AddSplinePoint
	// void AddSplinePoint(FVector InWorldLoc);                                                                                 // [0xbcebc70] Final|Native|Public|HasDefaults|BlueprintCallable 
};
...
public:
	...
	// void OnIceBlockDied(class AActor* DamagedActor, float Damage, class AController* InstigatedBy, class AActor* DamageCauser, FVector HitLocation, class UPrimitiveComponent* FHitComponent, FName BoneName, FVector Momentum); // [0xbcec288] Final|Native|Public|HasDefaults 
};
