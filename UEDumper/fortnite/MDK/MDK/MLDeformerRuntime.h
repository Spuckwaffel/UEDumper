...
public:
	DMember(bool)                                      bDisableWhenOwnerIsNotViewTarget                            OFFSET(get<bool>, {0x530, 1, 0, 0})
	DMember(bool)                                      bShouldRampUpWeightWhenEnabled                              OFFSET(get<bool>, {0x531, 1, 0, 0})
	DMember(float)                                     WeightIncreasePerSecond                                     OFFSET(get<float>, {0x534, 4, 0, 0})
};
