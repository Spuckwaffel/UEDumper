...
public:
	...
	// void DelMarStopMusic();                                                                                                  // [0x35cf850] Final|Exec|Native|Protected 
	// Function /Script/DelMarAudio.DelMarAudioCheatManager.DelMarStartMusic
	// void DelMarStartMusic();                                                                                                 // [0x35cf850] Final|Exec|Native|Protected 
	// Function /Script/DelMarAudio.DelMarAudioCheatManager.DelMarSkipMusic
	// void DelMarSkipMusic();                                                                                                  // [0x35cf850] Final|Exec|Native|Protected 
	// Function /Script/DelMarAudio.DelMarAudioCheatManager.DelMarSetMusicTrigger
	// void DelMarSetMusicTrigger(FName TriggerName);                                                                           // [0x849e64c] Final|Exec|Native|Protected 
	// Function /Script/DelMarAudio.DelMarAudioCheatManager.DelMarPrintMusicTrackName
	// void DelMarPrintMusicTrackName();                                                                                        // [0x35cf850] Final|Exec|Native|Protected 
};
...
public:
	...
	// class UAudioComponent* CreateSoundAttached(class USoundBase* sound, class USceneComponent* AttachComponent, FName AttachPointName, float VolumeMultiplier, float PitchMultiplier, bool bStopWhenAttachedToDestroyed, bool bAutoDestroy); // [0xc96fd00] Final|Native|Protected|BlueprintCallable 
	// Function /Script/DelMarAudio.DelMarAudioProximityComponentBase.BP_Update
	// void BP_Update(class APlayerCameraManager* Camera, class ADelMarVehicle* Vehicle);                                       // [0x20c3f9c] Event|Public|BlueprintEvent 
	// Function /Script/DelMarAudio.DelMarAudioProximityComponentBase.BP_StopProximity
	// void BP_StopProximity();                                                                                                 // [0x20c3f9c] Event|Public|BlueprintEvent 
	// Function /Script/DelMarAudio.DelMarAudioProximityComponentBase.BP_StartProximity
	// void BP_StartProximity();                                                                                                // [0x20c3f9c] Event|Public|BlueprintEvent 
};
...
public:
	...
	// float GetObjectScale();                                                                                                  // [0x8d23cf4] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// bool IsPlayingPassby();                                                                                                  // [0x88e725c] Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DelMarAudio.DelMarAudioPassbyComponent.HandlePassbyFinished
	// void HandlePassbyFinished();                                                                                             // [0xc970254] Final|Native|Public  
	// Function /Script/DelMarAudio.DelMarAudioPassbyComponent.BP_StopPassby
	// void BP_StopPassby();                                                                                                    // [0x20c3f9c] Event|Public|BlueprintEvent 
	// Function /Script/DelMarAudio.DelMarAudioPassbyComponent.BP_StartPassby
	// void BP_StartPassby(class AActor* Instigator, float PassbySpeed);                                                        // [0x20c3f9c] Event|Public|BlueprintEvent 
};
...
public:
	...
	// bool SetMixState(FGameplayTag& MixState, bool bFallBackToNearestParent, bool bDeactivateChildren);                       // [0xc970704] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/DelMarAudio.DelMarAudioStateMixerSubsystem.RemoveMixes
	// void RemoveMixes(FName GroupName);                                                                                       // [0xc9704d4] Final|Native|Public|BlueprintCallable 
	// Function /Script/DelMarAudio.DelMarAudioStateMixerSubsystem.GetActiveMixes
	// TMap<FGameplayTag, FDelMarStateMix> GetActiveMixes();                                                                    // [0xc9701c4] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DelMarAudio.DelMarAudioStateMixerSubsystem.ClearMixState
	// void ClearMixState(FGameplayTag& MixState, bool bDeactivateChildren);                                                    // [0xc96fbac] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/DelMarAudio.DelMarAudioStateMixerSubsystem.AddMixes
	// void AddMixes(FName GroupName, TArray<FDelMarStateMix>& Mixes);                                                          // [0xc96fa40] Final|Native|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// void BP_OnVehicleDemolished();                                                                                           // [0x20c3f9c] Event|Public|BlueprintEvent 
	// Function /Script/DelMarAudio.DelMarCrowdAudioManager.BP_OnRacerStateChanged
	// void BP_OnRacerStateChanged(FGameplayTag NewStateTag);                                                                   // [0x20c3f9c] Event|Public|BlueprintEvent 
	// Function /Script/DelMarAudio.DelMarCrowdAudioManager.BP_OnRaceModeChanged
	// void BP_OnRaceModeChanged(FGameplayTag NewRaceModeTag);                                                                  // [0x20c3f9c] Event|Public|BlueprintEvent 
	// Function /Script/DelMarAudio.DelMarCrowdAudioManager.BP_OnPlayerFinishedRace
	// void BP_OnPlayerFinishedRace();                                                                                          // [0x20c3f9c] Event|Public|BlueprintEvent 
	// Function /Script/DelMarAudio.DelMarCrowdAudioManager.BP_OnGameplayStateChanged
	// void BP_OnGameplayStateChanged(FGameplayTag NewStateTag);                                                                // [0x20c3f9c] Event|Public|BlueprintEvent 
	// Function /Script/DelMarAudio.DelMarCrowdAudioManager.BP_OnApproachingFinishLine
	// void BP_OnApproachingFinishLine();                                                                                       // [0x20c3f9c] Event|Public|BlueprintEvent 
};
...
public:
	...
	// void StopMusic();                                                                                                        // [0xc970aac] Final|Native|Public|BlueprintCallable 
	// Function /Script/DelMarAudio.DelMarRaceMusicManager.StartStartLineMusic
	// void StartStartLineMusic(float CountdownLength);                                                                         // [0xc970a2c] Final|Native|Public|BlueprintCallable 
	// Function /Script/DelMarAudio.DelMarRaceMusicManager.StartRaceMusic
	// void StartRaceMusic();                                                                                                   // [0xc970a18] Final|Native|Public|BlueprintCallable 
	// Function /Script/DelMarAudio.DelMarRaceMusicManager.SkipTrack
	// void SkipTrack();                                                                                                        // [0xc9709ec] Final|Native|Public|BlueprintCallable 
	// Function /Script/DelMarAudio.DelMarRaceMusicManager.SetPreRaceMusic
	// void SetPreRaceMusic(class USoundBase* InPreRaceMusic);                                                                  // [0xa1c7f6c] Final|Native|Public|BlueprintCallable 
	// Function /Script/DelMarAudio.DelMarRaceMusicManager.SetPostRaceMusic
	// void SetPostRaceMusic(class USoundBase* InPostRaceMusic);                                                                // [0xc970960] Final|Native|Public|BlueprintCallable 
	// Function /Script/DelMarAudio.DelMarRaceMusicManager.SetPlaylist
	// void SetPlaylist(class UDelMarRaceMusicPlaylist* InPlaylist);                                                            // [0xc9708e0] Final|Native|Public|BlueprintCallable 
	// Function /Script/DelMarAudio.DelMarRaceMusicManager.SetAudioTrigger
	// void SetAudioTrigger(FName InTrigger);                                                                                   // [0xc9705ec] Final|Native|Protected|BlueprintCallable 
	// Function /Script/DelMarAudio.DelMarRaceMusicManager.HandleSpectatorViewTargetChange
	// void HandleSpectatorViewTargetChange(class AFortPlayerController* PlayerController, class AActor* OldViewTarget, class AActor* NewViewTarget); // [0xc9702f8] Final|Native|Protected 
	...
	// void BP_OnRaceModeChanged(FGameplayTag NewModeTag);                                                                      // [0x20c3f9c] Event|Public|BlueprintEvent 
	...
	// void BP_OnCountdownTimeSet(float TimeUntilRunStart);                                                                     // [0x20c3f9c] Event|Public|BlueprintEvent 
};
...
public:
	...
	// void HandleRaceModeChanged(FDelMarEvent_RaceModeSet& Event);                                                             // [0xc97026c] Final|Native|Public|HasOutParms 
};
