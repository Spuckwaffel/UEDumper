...
public:
	...
	// void ResetToDefault();                                                                                                   // [0xd336a04] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// bool ExportToGLTF(class UObject* Object, FString FilePath, class UGLTFExportOptions* Options, TSet<AActor*>& SelectedActors, FGLTFExportMessages& OutMessages); // [0xd33619c] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// void ResetToDefault();                                                                                                   // [0xd336a18] Final|Native|Public|BlueprintCallable 
};
