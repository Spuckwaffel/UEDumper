...
public:
	unsigned char                                      UnknownData00_3[0x28];                                      // 0x0000   (0x0028)  MISSED
	SDK_UNDEFINED(16,14261) /* FString */              __um(Filename);                                             // 0x0028   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(80,14262) /* TMap<FName, FInterchangePipelinePropertyStates> */ __um(PropertiesStates);          // 0x0048   (0x0050)  
	unsigned char                                      UnknownData01_6[0x70];                                      // 0x0098   (0x0070)  MISSED
...
public:
	unsigned char                                      UnknownData00_3[0x28];                                      // 0x0000   (0x0028)  MISSED
	SDK_UNDEFINED(16,14263) /* FString */              __um(SourceAssetName);                                      // 0x0028   (0x0010)  
	SDK_UNDEFINED(16,14264) /* FString */              __um(DestinationAssetName);                                 // 0x0038   (0x0010)  
	SDK_UNDEFINED(16,14265) /* FString */              __um(AssetFriendlyName);                                    // 0x0048   (0x0010)  
	class UClass*                                      AssetType;                                                  // 0x0058   (0x0008)  
	SDK_UNDEFINED(16,14266) /* FString */              __um(InterchangeKey);                                       // 0x0060   (0x0010)  
};
...
{ 
public:
	SDK_UNDEFINED(24,14267) /* FText */                __um(Text);                                                 // 0x0070   (0x0018)  
};
...
{ 
public:
	SDK_UNDEFINED(24,14268) /* FText */                __um(Text);                                                 // 0x0070   (0x0018)  
};
...
{ 
public:
	SDK_UNDEFINED(24,14269) /* FText */                __um(Text);                                                 // 0x0070   (0x0018)  
};
...
public:
	unsigned char                                      UnknownData00_3[0x28];                                      // 0x0000   (0x0028)  MISSED
	SDK_UNDEFINED(80,14270) /* TMap<FString, UInterchangeBaseNode*> */ __um(Nodes);                                // 0x0028   (0x0050)  
...
{ 
	SDK_UNDEFINED(16,14271) /* FString */              __um(Name);                                                 // 0x0000   (0x0010)  
