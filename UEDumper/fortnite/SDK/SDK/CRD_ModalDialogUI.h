...
{ 
public:
	SDK_UNDEFINED(24,12590) /* FText */                __um(Title);                                                // 0x0068   (0x0018)  
	SDK_UNDEFINED(24,12591) /* FText */                __um(Body);                                                 // 0x0080   (0x0018)  
	class UDataTable*                                  TextStyleSet;                                               // 0x0098   (0x0008)  
	SDK_UNDEFINED(24,12592) /* FText */                __um(Button01_MainText);                                    // 0x00A0   (0x0018)  
	SDK_UNDEFINED(24,12593) /* FText */                __um(Button02_MainText);                                    // 0x00B8   (0x0018)  
	SDK_UNDEFINED(24,12594) /* FText */                __um(Button03_MainText);                                    // 0x00D0   (0x0018)  
	SDK_UNDEFINED(24,12595) /* FText */                __um(Button04_MainText);                                    // 0x00E8   (0x0018)  
	SDK_UNDEFINED(24,12596) /* FText */                __um(Button05_MainText);                                    // 0x0100   (0x0018)  
	SDK_UNDEFINED(24,12597) /* FText */                __um(Button06_MainText);                                    // 0x0118   (0x0018)  
	SDK_UNDEFINED(24,12598) /* FText */                __um(Button01_SubText);                                     // 0x0130   (0x0018)  
	SDK_UNDEFINED(24,12599) /* FText */                __um(Button02_SubText);                                     // 0x0148   (0x0018)  
	SDK_UNDEFINED(24,12600) /* FText */                __um(Button03_SubText);                                     // 0x0160   (0x0018)  
	SDK_UNDEFINED(24,12601) /* FText */                __um(Button04_SubText);                                     // 0x0178   (0x0018)  
	SDK_UNDEFINED(24,12602) /* FText */                __um(Button05_SubText);                                     // 0x0190   (0x0018)  
	SDK_UNDEFINED(24,12603) /* FText */                __um(Button06_SubText);                                     // 0x01A8   (0x0018)  
