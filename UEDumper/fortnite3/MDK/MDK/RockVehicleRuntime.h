...
public:
	...
	// void RockVehicleSetVelocity(float X, float Y, float Z);                                                                  // [0x954def0] Final|Exec|Native|Public 
	// Function /Script/RockVehicleRuntime.FortCheatManager_RockVehicle.RockVehicleSetRotation
	// void RockVehicleSetRotation(float pitch, float Yaw, float Roll);                                                         // [0x954def0] Final|Exec|Native|Public 
	// Function /Script/RockVehicleRuntime.FortCheatManager_RockVehicle.RockVehicleSetLocation
	// void RockVehicleSetLocation(float X, float Y, float Z);                                                                  // [0x954def0] Final|Exec|Native|Public 
	// Function /Script/RockVehicleRuntime.FortCheatManager_RockVehicle.RockVehicleSetBalboaVelocity
	// void RockVehicleSetBalboaVelocity(float X, float Y, float Z);                                                            // [0x954def0] Final|Exec|Native|Public 
};

/// Class /Script/RockVehicleRuntime.RockVehicle
/// Size: 0x0240 (0x001F40 - 0x002180)
...
public:
	DMember(float)                                     InputSwivelPitch                                            OFFSET(get<float>, {0x1F38, 4, 0, 0})
	DMember(float)                                     InputSwivelYaw                                              OFFSET(get<float>, {0x1F3C, 4, 0, 0})
	DMember(bool)                                      bInputReverseCamera                                         OFFSET(get<bool>, {0x1F40, 1, 1, 0})
	DMember(bool)                                      bHasDoubleJumped                                            OFFSET(get<bool>, {0x1F40, 1, 1, 1})
	DMember(bool)                                      bHasDodged                                                  OFFSET(get<bool>, {0x1F40, 1, 1, 2})
	DMember(bool)                                      bFreeLookCamera                                             OFFSET(get<bool>, {0x1F41, 1, 0, 0})
	SMember(FMulticastInlineDelegate)                  OnFreeCamToggled                                            OFFSET(getStruct<T>, {0x1F48, 16, 0, 0})
	SMember(FRockRuntimeConfigOverrides)               RockRuntimeConfigs                                          OFFSET(getStruct<T>, {0x1F59, 4, 0, 0})
	SMember(FMulticastInlineDelegate)                  OnSpringImpact                                              OFFSET(getStruct<T>, {0x1F78, 16, 0, 0})
	CMember(class URockVehicleAnalyticsComponent*)     RockAnalyticsComp                                           OFFSET(get<T>, {0x2000, 8, 0, 0})
	CMember(TArray<class URockVehicleAbility*>)        VehicleAbilities                                            OFFSET(get<T>, {0x2008, 16, 0, 0})
	CMember(TArray<TWeakObjectPtr<UClass*>>)           VehicleAbilityTickOrder                                     OFFSET(get<T>, {0x2018, 16, 0, 0})
	CMember(class AFortVehicleAudioController*)        CachedVehicleAudioController                                OFFSET(get<T>, {0x2028, 8, 0, 0})
	CMember(class URockVehicleAbility_Supersonic*)     SupersonicAbility                                           OFFSET(get<T>, {0x2030, 8, 0, 0})
	CMember(class URockVehicleAnimInstance*)           RockAnimInstance                                            OFFSET(get<T>, {0x2038, 8, 0, 0})
	SMember(FFortAthenaVehicleInputState)              PendingDriverInputState                                     OFFSET(getStruct<T>, {0x2040, 64, 0, 0})
	SMember(FFortAthenaVehicleInputState)              PrevDriverInputState                                        OFFSET(getStruct<T>, {0x2080, 64, 0, 0})
	SMember(FVector)                                   EnterExitImpulse                                            OFFSET(getStruct<T>, {0x20C0, 24, 0, 0})


	/// Functions
	// Function /Script/RockVehicleRuntime.RockVehicle.ServerToggleFreeCam
	// void ServerToggleFreeCam();                                                                                              // [0xbe3ac40] Net|NetReliableNative|Event|Public|NetServer|NetValidate 
	// Function /Script/RockVehicleRuntime.RockVehicle.ServerSetLegacyDamageValues
	// void ServerSetLegacyDamageValues(bool bDamageFriendlyVehicles, bool bDamageOtherVehicles, bool bDamageOwnVehicle, bool bDamageAllowedFromOtherVehicle); // [0xbe3aae0] Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
	// Function /Script/RockVehicleRuntime.RockVehicle.RockFreeCamToggledDelegate__DelegateSignature
	// void RockFreeCamToggledDelegate__DelegateSignature(bool bFreeCam);                                                       // [0x1340978] MulticastDelegate|Public|Delegate 
	// Function /Script/RockVehicleRuntime.RockVehicle.OnSpringImpact__DelegateSignature
	// void OnSpringImpact__DelegateSignature(FName Socket, float ImpactSpeed, FHitResult& OutHit);                             // [0x1340978] MulticastDelegate|Public|Delegate|HasOutParms 
	// Function /Script/RockVehicleRuntime.RockVehicle.OnRep_FreeLookCamera
	// void OnRep_FreeLookCamera();                                                                                             // [0xbe3a86c] Final|Native|Public  
	// Function /Script/RockVehicleRuntime.RockVehicle.GetThrottleState
	// float GetThrottleState();                                                                                                // [0xbe3a02c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/RockVehicleRuntime.RockVehicle.GetDriverInput
	// FFortAthenaVehicleInputState GetDriverInput();                                                                           // [0xbe39f78] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/RockVehicleRuntime.RockVehicle.GetCurrentRockRuntimeConfigOverrides
	// FRockRuntimeConfigOverrides GetCurrentRockRuntimeConfigOverrides();                                                      // [0xbe39f60] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// class ARockVehicle* GetVehicle();                                                                                        // [0x3623c48] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/RockVehicleRuntime.RockVehicleAbility.GetInactiveSeconds
	// float GetInactiveSeconds();                                                                                              // [0xbe39fc4] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/RockVehicleRuntime.RockVehicleAbility.GetActiveSeconds
	// float GetActiveSeconds();                                                                                                // [0x65249e0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void OnRep_SecondsRemaining(float PrevValue);                                                                            // [0xbe3a8a0] Final|Native|Protected 
	// Function /Script/RockVehicleRuntime.RockVehicleBoostTank.IsBoostFull
	// bool IsBoostFull();                                                                                                      // [0xbe3a0f4] Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/RockVehicleRuntime.RockVehicleBoostTank.HasBoost
	// bool HasBoost();                                                                                                         // [0xbe3a0d4] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/RockVehicleRuntime.RockVehicleBoostTank.GiveBoost
	// void GiveBoost(float Seconds);                                                                                           // [0xbe3a054] Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
	// Function /Script/RockVehicleRuntime.RockVehicleBoostTank.GetPercentRemaining
	// float GetPercentRemaining();                                                                                             // [0xbe3a00c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/RockVehicleRuntime.RockVehicleBoostTank.GetMaxBoostInSeconds
	// float GetMaxBoostInSeconds();                                                                                            // [0x77bf36c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void SetEnabled(bool bValue);                                                                                            // [0xbe3ad0c] Final|Native|Public|BlueprintCallable 
	// Function /Script/RockVehicleRuntime.RockVehicleAbility_GroundTrails.OnSurfaceChanged
	// void OnSurfaceChanged(TEnumAsByte<EPhysicalSurface> NewSurface);                                                         // [0xbe3aa60] Final|Native|Protected|BlueprintCallable 
};
...
public:
	...
	// void OnSupersonicStart(class UActorComponent* InComp, bool bInReset);                                                    // [0xbe3a9a8] Final|Native|Private 
	// Function /Script/RockVehicleRuntime.RockVehicleAnalyticsComponent.OnSupersonicEnd
	// void OnSupersonicEnd(class UActorComponent* InComp);                                                                     // [0xbe3a938] Final|Native|Private 
	// Function /Script/RockVehicleRuntime.RockVehicleAnalyticsComponent.OnPawnExitedSeat
	// void OnPawnExitedSeat(TScriptInterface<Class>& InVehicle, class AFortPawn* InPlayerPawn, int32_t InSeatIndex);           // [0xbe3a5e0] Final|Native|Private|HasOutParms 
	// Function /Script/RockVehicleRuntime.RockVehicleAnalyticsComponent.OnPawnEnteredSeat
	// void OnPawnEnteredSeat(TScriptInterface<Class>& InVehicle, class AFortPawn* InPlayerPawn, int32_t InSeatIndex);          // [0xbe3a354] Final|Native|Private|HasOutParms 
	// Function /Script/RockVehicleRuntime.RockVehicleAnalyticsComponent.OnJumped
	// void OnJumped(class UActorComponent* InComp, bool bInReset);                                                             // [0xbe3a29c] Final|Native|Private 
	// Function /Script/RockVehicleRuntime.RockVehicleAnalyticsComponent.OnDoubleJumped
	// void OnDoubleJumped(class UActorComponent* InComp, bool bInReset);                                                       // [0xbe3a1e4] Final|Native|Private 
	// Function /Script/RockVehicleRuntime.RockVehicleAnalyticsComponent.OnDodged
	// void OnDodged(class UActorComponent* InComp, bool bInReset);                                                             // [0xbe3a12c] Final|Native|Private 
};
...
public:
	SMember(FRuntimeFloatCurve)                        SideSpeedToSkidVolume                                       OFFSET(getStruct<T>, {0x328, 136, 0, 0})
	DMember(float)                                     SurfaceTypeInterpSpeed                                      OFFSET(get<float>, {0x3B0, 4, 0, 0})
	CMember(class UAudioComponent*)                    TireSurfaceComponent                                        OFFSET(get<T>, {0x3B8, 8, 0, 0})
	CMember(class UAudioComponent*)                    AirLoopComponent                                            OFFSET(get<T>, {0x3C0, 8, 0, 0})
	CMember(class UAudioComponent*)                    SuperSonicComponent                                         OFFSET(get<T>, {0x3C8, 8, 0, 0})
	DMember(bool)                                      bInWater                                                    OFFSET(get<bool>, {0x3D0, 1, 0, 0})
	CMember(class UAudioMotorModelComponent*)          MotorModel                                                  OFFSET(get<T>, {0x3D8, 8, 0, 0})
	CMember(class ARockVehicle*)                       CachedVehicle                                               OFFSET(get<T>, {0x3E0, 8, 0, 0})


	/// Functions
	// Function /Script/RockVehicleRuntime.RockVehicleAudioController.SetSurfaceTypeParam
	// void SetSurfaceTypeParam(float NewSurfaceParam);                                                                         // [0xbe3ad8c] Final|Native|Public|BlueprintCallable 
	// Function /Script/RockVehicleRuntime.RockVehicleAudioController.SetBoosting
	// void SetBoosting(bool bNewBoosting);                                                                                     // [0xbe3ac8c] Final|Native|Public|BlueprintCallable 
	// Function /Script/RockVehicleRuntime.RockVehicleAudioController.OnInAirUpdated
	// void OnInAirUpdated(bool bNewInAir);                                                                                     // [0x1340978] Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Script/RockVehicleRuntime.RockVehicleAudioController.GetMotorSimComponent
	// class UAudioMotorModelComponent* GetMotorSimComponent();                                                                 // [0x96dff20] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};

/// Class /Script/RockVehicleRuntime.RockVehicleCameraMode
/// Size: 0x0200 (0x001CF0 - 0x001EF0)
class URockVehicleCameraMode : public UFortCameraMode_AthenaVehicle
{ 
	friend MDKHandler;
	static inline constexpr uint64_t __MDKClassSize = 7920;

public:
	DMember(float)                                     SwivelPitchMax                                              OFFSET(get<float>, {0x1CE8, 4, 0, 0})
	DMember(float)                                     SwivelYawMax                                                OFFSET(get<float>, {0x1CEC, 4, 0, 0})
	DMember(float)                                     GroundNormalInterpRate                                      OFFSET(get<float>, {0x1CF0, 4, 0, 0})
	DMember(float)                                     GroundNormalAirInterpRate                                   OFFSET(get<float>, {0x1CF4, 4, 0, 0})
	DMember(float)                                     GroundYawRate                                               OFFSET(get<float>, {0x1CF8, 4, 0, 0})
	DMember(float)                                     WallYawRate                                                 OFFSET(get<float>, {0x1CFC, 4, 0, 0})
	DMember(float)                                     InterpToGroundTime                                          OFFSET(get<float>, {0x1D00, 4, 0, 0})
	DMember(float)                                     InterpToAirTime                                             OFFSET(get<float>, {0x1D04, 4, 0, 0})
	DMember(float)                                     AverageVelocityInterpRate                                   OFFSET(get<float>, {0x1D08, 4, 0, 0})
	SMember(FRuntimeFloatCurve)                        AirRotationInterpRateForSpeed                               OFFSET(getStruct<T>, {0x1D10, 136, 0, 0})
	DMember(float)                                     FocusOffsetInterpRate                                       OFFSET(get<float>, {0x1D98, 4, 0, 0})
	DMember(float)                                     DistanceSpeedScale                                          OFFSET(get<float>, {0x1D9C, 4, 0, 0})
	DMember(float)                                     DistanceOffsetMin                                           OFFSET(get<float>, {0x1DA0, 4, 0, 0})
	DMember(float)                                     DistanceOffsetMax                                           OFFSET(get<float>, {0x1DA4, 4, 0, 0})
	DMember(float)                                     DistanceInterpRate                                          OFFSET(get<float>, {0x1DA8, 4, 0, 0})
	DMember(float)                                     MaxSpeedFOVOffset                                           OFFSET(get<float>, {0x1DAC, 4, 0, 0})
	DMember(float)                                     SupersonicFOVOffset                                         OFFSET(get<float>, {0x1DB0, 4, 0, 0})
	DMember(float)                                     FOVInterpRate                                               OFFSET(get<float>, {0x1DB4, 4, 0, 0})
	SMember(FRockCameraSettings)                       CameraSettings                                              OFFSET(getStruct<T>, {0x1DB8, 28, 0, 0})
	CMember(class ARockVehicle*)                       VehicleTarget                                               OFFSET(get<T>, {0x1DD8, 8, 0, 0})
	CMember(class URockVehicleAbility_Jump*)           JumpAbility                                                 OFFSET(get<T>, {0x1DE0, 8, 0, 0})
};

/// Class /Script/RockVehicleRuntime.RockVehicleConfigs
/// Size: 0x0608 (0x000930 - 0x000F38)
class URockVehicleConfigs : public UFortPhysicsVehicleConfigs
{ 
	friend MDKHandler;
	static inline constexpr uint64_t __MDKClassSize = 3896;

public:
	SMember(FRockVehicleAxleConfig)                    FrontAxle                                                   OFFSET(getStruct<T>, {0x930, 52, 0, 0})
	SMember(FRockVehicleAxleConfig)                    BackAxle                                                    OFFSET(getStruct<T>, {0x964, 52, 0, 0})
	SMember(FRockVehicleDriveConfig)                   Drive                                                       OFFSET(getStruct<T>, {0x998, 1296, 0, 0})
	SMember(FRockVehicleDemoConfig)                    DemolitionConfiguration                                     OFFSET(getStruct<T>, {0xEA8, 40, 0, 0})
	SMember(FRockScalableFloat)                        MaxLinearSpeed                                              OFFSET(getStruct<T>, {0xED0, 48, 0, 0})
	SMember(FRockScalableFloat)                        SupersonicSpeed                                             OFFSET(getStruct<T>, {0xF00, 48, 0, 0})
	DMember(float)                                     MaxAngularSpeed                                             OFFSET(get<float>, {0xF30, 4, 0, 0})
	DMember(float)                                     SafeBuildingLandingDegrees                                  OFFSET(get<float>, {0xF34, 4, 0, 0})
};
...
public:
	...
	// void VehicleExploded(class AController* LastDamageInstigator, class AFortAthenaVehicle* Vehicle);                        // [0xbe3ae0c] Final|Native|Protected 
};
