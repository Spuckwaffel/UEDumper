...
public:
	...
	// void ClearOvershieldListenerDelegates(class UGameplayAbility* OwningAbility);                                            // [0xca25bb8] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/FortOvershieldHelpers.FortOvershieldHelperComponent.AssignOvershieldListenerDelegates
	// void AssignOvershieldListenerDelegates(class UGameplayAbility* OwningAbility, FFortOvershieldDelegateContainer Delegates); // [0xca25ac4] Final|Native|Static|Public|BlueprintCallable 
};
