...
public:
	...
	// void ExecuteUbergraph_WBP_Mobile_Augment_Selection_Proxy(int32_t EntryPoint);                                            // [0x1340978] Final                
};
...
public:
	...
	CMember(class UWBP_Augment_SelectionTimer_C*)      WBP_Augment_SelectionTimer                                  OFFSET(get<T>, {0x388, 8, 0, 0})
	...
	// void ExecuteUbergraph_WBP_Mobile_Augment_SelectionTimer(int32_t EntryPoint);                                             // [0x1340978] Final|HasDefaults    
};
