...
public:
	...
	// void SetWaterBodyMIDParameters(class AWaterBody* WaterBody);                                                             // [0xbc86000] Final|Native|Public|BlueprintCallable 
	// Function /Script/WaterAdvanced.ShallowWaterSubsystem.ResetImpacts
	// void ResetImpacts();                                                                                                     // [0xbc85fec] Final|Native|Public|BlueprintCallable 
	// Function /Script/WaterAdvanced.ShallowWaterSubsystem.RemoveCollisionTrackerForActor
	// void RemoveCollisionTrackerForActor(class AActor* CollisionTrackerActor);                                                // [0xbc85f24] Final|Native|Protected|BlueprintCallable 
	// Function /Script/WaterAdvanced.ShallowWaterSubsystem.RegisterImpact
	// void RegisterImpact(FVector ImpactPosition, FVector ImpactVelocity, float ImpactRadius);                                 // [0xbc85df8] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/WaterAdvanced.ShallowWaterSubsystem.OnWaterInfoTextureCreated
	// void OnWaterInfoTextureCreated(class UTextureRenderTarget2D* WaterInfoTexture);                                          // [0xbc85d54] Final|Native|Protected 
	// Function /Script/WaterAdvanced.ShallowWaterSubsystem.OnLocalPlayerPawnBecomesValid
	// void OnLocalPlayerPawnBecomesValid(class APawn* OldPawn, class APawn* NewPawn);                                          // [0xbc85c90] Final|Native|Private 
	// Function /Script/WaterAdvanced.ShallowWaterSubsystem.OnLocalPlayerControllerBecomesValid
	// void OnLocalPlayerControllerBecomesValid(class APlayerController* InPlayerController);                                   // [0xbc85c10] Final|Native|Private 
	// Function /Script/WaterAdvanced.ShallowWaterSubsystem.GetAllOverlappingWaterBodiesAndUpdateCollisionTrackers
	// TSet<AWaterBody*> GetAllOverlappingWaterBodiesAndUpdateCollisionTrackers();                                              // [0xbc85b54] Native|Protected|BlueprintCallable 
	// Function /Script/WaterAdvanced.ShallowWaterSubsystem.AddCollisionTrackerForActor
	// void AddCollisionTrackerForActor(class AActor* CollisionTrackerActor, float MaxLifespan);                                // [0xbc85960] Final|Native|Protected|BlueprintCallable 
};
