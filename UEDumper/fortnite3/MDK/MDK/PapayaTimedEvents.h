...
public:
	...
	// void ShutdownTimedEvents_Native();                                                                                       // [0xbdec8c4] Final|Native|Public|BlueprintCallable 
	// Function /Script/PapayaTimedEvents.PapayaTimedEvents.SetupTimedEvents_Native
	// void SetupTimedEvents_Native(FString ScreenName);                                                                        // [0xbdec1e0] Final|Native|Public|BlueprintCallable 
	// Function /Script/PapayaTimedEvents.PapayaTimedEvents.ResetTimedEvents_Native
	// void ResetTimedEvents_Native();                                                                                          // [0xbdec1cc] Final|Native|Public|BlueprintCallable 
	// Function /Script/PapayaTimedEvents.PapayaTimedEvents.OnRep_TimedEventsArray
	// void OnRep_TimedEventsArray(FMediaTimeEventArray& PreviousValue);                                                        // [0xbdec114] Final|Native|Private|HasOutParms 
	// Function /Script/PapayaTimedEvents.PapayaTimedEvents.OnRep_ScreenName
	// void OnRep_ScreenName(FString PreviousValue);                                                                            // [0xbdeba34] Final|Native|Private 
	// Function /Script/PapayaTimedEvents.PapayaTimedEvents.AddTimedEvent_Native
	// void AddTimedEvent_Native(FString EventName, int64_t Time, FString EventParam);                                          // [0xbdeb2d8] Final|Native|Public|BlueprintCallable 
};
