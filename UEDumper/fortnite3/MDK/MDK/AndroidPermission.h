...
public:
	...
	// bool CheckPermission(FString Permission);                                                                                // [0xcd8e598] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/AndroidPermission.AndroidPermissionFunctionLibrary.AcquirePermissions
	// class UAndroidPermissionCallbackProxy* AcquirePermissions(TArray<FString>& Permissions);                                 // [0xcd8e4b0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
