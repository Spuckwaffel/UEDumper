...
public:
	...
	// void EndProfileBlock(FSolarisProfilingData Data, int64_t UserTag);                                                       // [0x77db400] Final|Native|Static|Public 
	// Function /Script/VerseNative.SolarisProfilingLibrary.BeginProfileBlock
	// FSolarisProfilingData BeginProfileBlock();                                                                               // [0x77db3a8] Final|Native|Static|Public 
};
...
public:
	...
	// void StmSave(FakeType& Property);                                                                                        // [0x77dbd34] Final|Native|Static|Public|HasOutParms 
	// Function /Script/VerseNative.VerseStmLibrary.StmRollback
	// void StmRollback();                                                                                                      // [0x77dbb38] Final|Native|Static|Public 
	// Function /Script/VerseNative.VerseStmLibrary.StmLeaveFrame
	// void StmLeaveFrame();                                                                                                    // [0x77dbb24] Final|Native|Static|Public 
	// Function /Script/VerseNative.VerseStmLibrary.StmEnterFrame
	// void StmEnterFrame();                                                                                                    // [0x77dbad4] Final|Native|Static|Public 
	// Function /Script/VerseNative.VerseStmLibrary.StmEnabled
	// void StmEnabled();                                                                                                       // [0x77dba40] Final|Native|Static|Public 
	// Function /Script/VerseNative.VerseStmLibrary.StmCommit
	// void StmCommit();                                                                                                        // [0x77db5e8] Final|Native|Static|Public 
	// Function /Script/VerseNative.VerseStmLibrary.StmBegin
	// void StmBegin();                                                                                                         // [0x77db5d4] Final|Native|Static|Public 
};
