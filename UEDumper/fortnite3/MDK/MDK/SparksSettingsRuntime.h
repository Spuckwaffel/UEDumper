...
public:
	...
	// void SetGameplayMusicVolume(float NewVolume);                                                                            // [0xbb1f800] Final|Native|Public  
	// Function /Script/SparksSettingsRuntime.SparksClientSettingRecordPartition.GetGameplayMusicVolume
	// float GetGameplayMusicVolume();                                                                                          // [0x6ec646c] Final|RequiredAPI|Native|Public|Const 
};
...
public:
	...
	// void UpdateSparksMixFromPartition();                                                                                     // [0xbb1f884] Final|Native|Public|Const 
	// Function /Script/SparksSettingsRuntime.SparksSettingsControllerComponent.GetSparksClientSettingRecordPartition
	// class USparksClientSettingRecordPartition* GetSparksClientSettingRecordPartition();                                      // [0xbb1f7dc] Final|Native|Public|Const 
};
