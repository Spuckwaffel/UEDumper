...
public:
	...
	// void UpdateSkeletalMeshComponent();                                                                                      // [0xbdc9c00] Final|Native|Public|BlueprintCallable 
	// Function /Script/MLDeformerFramework.MLDeformerComponent.SetWeight
	// void SetWeight(float NormalizedWeightValue);                                                                             // [0x74fb5a8] Final|Native|Public|BlueprintCallable 
	// Function /Script/MLDeformerFramework.MLDeformerComponent.SetQualityLevel
	// void SetQualityLevel(int32_t InQualityLevel);                                                                            // [0x6b56e20] Final|Native|Public  
	// Function /Script/MLDeformerFramework.MLDeformerComponent.SetDeformerAsset
	// void SetDeformerAsset(class UMLDeformerAsset* InDeformerAsset);                                                          // [0x6e87c98] Final|Native|Public|BlueprintCallable 
	// Function /Script/MLDeformerFramework.MLDeformerComponent.GetWeight
	// float GetWeight();                                                                                                       // [0x9070170] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MLDeformerFramework.MLDeformerComponent.GetSkeletalMeshComponent
	// class USkeletalMeshComponent* GetSkeletalMeshComponent();                                                                // [0x67cf678] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MLDeformerFramework.MLDeformerComponent.GetQualityLevel
	// int32_t GetQualityLevel();                                                                                               // [0x88b0b14] Final|Native|Public|Const 
	// Function /Script/MLDeformerFramework.MLDeformerComponent.GetModelInstance
	// class UMLDeformerModelInstance* GetModelInstance();                                                                      // [0x7e1a9cc] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MLDeformerFramework.MLDeformerComponent.GetDeformerAsset
	// class UMLDeformerAsset* GetDeformerAsset();                                                                              // [0x968e2cc] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MLDeformerFramework.MLDeformerComponent.FindSkeletalMeshComponent
	// class USkeletalMeshComponent* FindSkeletalMeshComponent(class UMLDeformerAsset* Asset);                                  // [0xbdc962c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void SetMorphTargetsMinMaxWeights(TArray<float>& MinValues, TArray<float>& MaxValues);                                   // [0xbdc9a74] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MLDeformerFramework.MLDeformerMorphModel.SetMorphTargetsMaxWeights
	// void SetMorphTargetsMaxWeights(TArray<float>& MaxWeights);                                                               // [0x90729c0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MLDeformerFramework.MLDeformerMorphModel.SetMorphTargetsErrorOrder
	// void SetMorphTargetsErrorOrder(TArray<int32_t>& MorphTargetOrder, TArray<float>& ErrorValues);                           // [0xbdc9910] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MLDeformerFramework.MLDeformerMorphModel.SetMorphTargetDeltas
	// void SetMorphTargetDeltas(TArray<FVector3f>& Deltas);                                                                    // [0xbdc9870] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MLDeformerFramework.MLDeformerMorphModel.SetMorphTargetDeltaFloats
	// void SetMorphTargetDeltaFloats(TArray<float>& Deltas);                                                                   // [0xbdc9790] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MLDeformerFramework.MLDeformerMorphModel.CanDynamicallyUpdateMorphTargets
	// bool CanDynamicallyUpdateMorphTargets();                                                                                 // [0xbdc95ec] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
