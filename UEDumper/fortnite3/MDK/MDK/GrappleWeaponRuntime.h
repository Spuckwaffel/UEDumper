...
public:
	DMember(bool)                                      bIsAttached                                                 OFFSET(get<bool>, {0x1520, 1, 0, 0})
	DMember(bool)                                      bIsFired                                                    OFFSET(get<bool>, {0x1521, 1, 0, 0})
	DMember(bool)                                      bAnimStartWallBounce                                        OFFSET(get<bool>, {0x1522, 1, 0, 0})
	DMember(float)                                     PawnRotationRateYaw                                         OFFSET(get<float>, {0x1524, 4, 0, 0})
	DMember(float)                                     AnimBounceAngle                                             OFFSET(get<float>, {0x1528, 4, 0, 0})
	DMember(bool)                                      bIsFireOnMotorBike                                          OFFSET(get<bool>, {0x152C, 1, 0, 0})
	DMember(bool)                                      bIsExitUnexpectedly                                         OFFSET(get<bool>, {0x152D, 1, 0, 0})
	DMember(bool)                                      bIsCastInAir                                                OFFSET(get<bool>, {0x152E, 1, 0, 0})
	DMember(bool)                                      bIsCastUpperbody                                            OFFSET(get<bool>, {0x152F, 1, 0, 0})
	DMember(bool)                                      bIsCastGroundIdle                                           OFFSET(get<bool>, {0x1530, 1, 0, 0})
	DMember(bool)                                      bIsCastGroundLoco                                           OFFSET(get<bool>, {0x1531, 1, 0, 0})
	DMember(bool)                                      bDistanceBucketIs0                                          OFFSET(get<bool>, {0x1532, 1, 0, 0})
	DMember(bool)                                      bDistanceBucketIs2                                          OFFSET(get<bool>, {0x1533, 1, 0, 0})
	DMember(bool)                                      bIsExitGround                                               OFFSET(get<bool>, {0x1534, 1, 0, 0})
	DMember(bool)                                      bIsExitWallBounce                                           OFFSET(get<bool>, {0x1535, 1, 0, 0})
	DMember(bool)                                      bIsExitZipAirStart                                          OFFSET(get<bool>, {0x1536, 1, 0, 0})
};
...
public:
	...
	// void GetGrappleKnifeData(bool& bIsAttached, bool& bIsFired, int32_t& DistanceBucket, bool& bAnimStartWallBounce, float& AnimBounceAngle); // [0xbd13cec] Native|Event|Public|HasOutParms|BlueprintEvent 
};
...
public:
	...
	// void IsTargetingLedge(class ACharacter* SourceCharacter, class AActor* TargetActor, FVector& TargetLocation, FVector& TargetNormal, FGrappleWeaponLedgeConfig& Config, bool& OutDidImpactWalkableSurface, bool& OutTargetingLedge, FVector& OutLedgeLocation, bool bDrawDebug); // [0xbd14130] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/GrappleWeaponRuntime.GrappleWeaponLibrary.GetGrappleWeaponTargetInfo
	// FGrappleWeaponTargetInfo GetGrappleWeaponTargetInfo(class AFortPlayerPawn* SourcePlayerPawn, FGrappleWeaponTargetingConfig& Config, float DrawDebugDuration); // [0xbd13f04] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/GrappleWeaponRuntime.GrappleWeaponLibrary.DidHitResultImpactLedge
	// void DidHitResultImpactLedge(class ACharacter* SourceCharacter, FHitResult& HitResult, FGrappleWeaponLedgeConfig& Config, bool& OutDidImpactWalkableSurface, bool& OutTargetingLedge, FVector& OutLedgeLocation, bool bDrawDebug); // [0xbd13888] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/GrappleWeaponRuntime.GrappleWeaponLibrary.CalculateDirectionalTargetOffset
	// FVector CalculateDirectionalTargetOffset(FVector& DirToTarget, FVector& MovementOffset, FVector& LedgeOffset);           // [0xbd13680] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
};
