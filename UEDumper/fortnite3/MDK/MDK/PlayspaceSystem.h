...
public:
	...
	// void OnEndActorOverlap(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex); // [0x7ec4658] Native|Protected     
	// Function /Script/PlayspaceSystem.OverlapComponent.OnBeginActorOverlap
	// void OnBeginActorOverlap(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool bFromSweep, FHitResult& SweepResult); // [0x7ec4420] Native|Protected|HasOutParms 
};
...
public:
	...
	// void ServerMarkReadyForSpawning();                                                                                       // [0x7ec4c30] Final|Net|NetReliableNative|Event|Private|NetServer|NetValidate 
	// Function /Script/PlayspaceSystem.PlayspaceControllerComponent_PlayerSpawning.OnRep_ReplicatedSpawnInfo
	// void OnRep_ReplicatedSpawnInfo();                                                                                        // [0x7ec4b8c] Final|Native|Private 
	// Function /Script/PlayspaceSystem.PlayspaceControllerComponent_PlayerSpawning.GetSpawnInfo
	// FReplicatedSpawnInfo GetSpawnInfo();                                                                                     // [0x7ec42ac] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/PlayspaceSystem.PlayspaceControllerComponent_PlayerSpawning.ClientReplicatedSpawnInfo
	// void ClientReplicatedSpawnInfo(FReplicatedSpawnInfo InReplicatedSpawnInfo);                                              // [0x7ec4158] Final|Net|NetReliableNative|Event|Private|NetClient 
};
...
public:
	...
	// void UpdateSize(FVector& NewScale);                                                                                      // [0x7ec4c7c] Native|Public|HasOutParms|HasDefaults 
	// Function /Script/PlayspaceSystem.GameplayVolume.OnRep_Playspace
	// void OnRep_Playspace();                                                                                                  // [0x7ec4b5c] Final|Native|Protected 
	// Function /Script/PlayspaceSystem.GameplayVolume.OnOverlappedPawnControllerChanged
	// void OnOverlappedPawnControllerChanged(class APawn* Pawn, class AController* OldController, class AController* NewController); // [0x7ec4798] Native|Protected     
	// Function /Script/PlayspaceSystem.GameplayVolume.InitializeBoundsComponent
	// void InitializeBoundsComponent(class UOverlapComponent* NewBoundsComponent);                                             // [0x7ec4304] Final|Native|Private|BlueprintCallable 
	// Function /Script/PlayspaceSystem.GameplayVolume.GetPlayspace
	// class APlayspace* GetPlayspace();                                                                                        // [0x2d3812c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void OnRep_PlayspaceUsers();                                                                                             // [0x23b32b0] Final|RequiredAPI|Native|Protected 
	// Function /Script/PlayspaceSystem.Playspace.OnRep_MatchStartTime
	// void OnRep_MatchStartTime();                                                                                             // [0x3e7d3f0] RequiredAPI|Native|Protected 
	// Function /Script/PlayspaceSystem.Playspace.OnRep_BoundGameplayVolume
	// void OnRep_BoundGameplayVolume();                                                                                        // [0x7ec4b1c] Final|Native|Protected 
	// Function /Script/PlayspaceSystem.Playspace.OnRep_bMatchHasEnded
	// void OnRep_bMatchHasEnded();                                                                                             // [0x3e2a2f8] Final|RequiredAPI|Native|Protected 
	// Function /Script/PlayspaceSystem.Playspace.OnRep_bIsInitialized
	// void OnRep_bIsInitialized();                                                                                             // [0x6cc3d98] Final|RequiredAPI|Native|Protected 
};
...
public:
	...
	// void OnPlayerPawnSet(class APlayerState* Player, class APawn* NewPawn, class APawn* OldPawn);                            // [0x7ec4a1c] Final|Native|Protected 
};
...
public:
	...
	// class APlayspace* GetPlayspaceForActor(class UObject* WorldContextObject, class AActor* InActor);                        // [0x3c0901c] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/PlayspaceSystem.PlayspaceLibrary.DestroyPlayspace
	// void DestroyPlayspace(class APlayspace* PlayspaceToDestroy);                                                             // [0x7ec4230] Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// void OnRep_MatchStartTime();                                                                                             // [0x37c3ff8] Native|Protected     
	// Function /Script/PlayspaceSystem.PlayspaceLogic.OnRep_bMatchHasEnded
	// void OnRep_bMatchHasEnded();                                                                                             // [0x25494d8] Final|Native|Private 
};
...
public:
	...
	// bool ProcessOverlapEvents(float DeltaTime);                                                                              // [0x7ec4ba0] Final|Native|Private 
	// Function /Script/PlayspaceSystem.PlayspaceManagerComponent.OnRep_RootPlayspace
	// void OnRep_RootPlayspace();                                                                                              // [0x2e1685c] Final|Native|Private 
	// Function /Script/PlayspaceSystem.PlayspaceManagerComponent.OnPlayerEndOverlapGameplayVolume
	// void OnPlayerEndOverlapGameplayVolume(class APlayerState* PlayerState, class AGameplayVolume* Volume);                   // [0x7ec4958] Final|Native|Private 
	// Function /Script/PlayspaceSystem.PlayspaceManagerComponent.OnPlayerBeginOverlapGameplayVolume
	// void OnPlayerBeginOverlapGameplayVolume(class APlayerState* PlayerState, class AGameplayVolume* Volume);                 // [0x7ec4894] Final|Native|Private 
};
