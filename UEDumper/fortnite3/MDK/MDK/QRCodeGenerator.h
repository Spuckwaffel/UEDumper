...
public:
	...
	// class UTexture2D* GenerateQRCodeTextureFromString(FString StringToEncode);                                               // [0x88b8ea4] Final|Native|Static|Private|BlueprintCallable 
};
...
public:
	...
	// void EncodeString(FString StringToEncode);                                                                               // [0x88b8790] Final|Native|Public|BlueprintCallable 
};
