...
public:
	...
	// void EndTempestStorm(FString StormName);                                                                                 // [0x9548a24] Final|BlueprintAuthorityOnly|Exec|Native|Public 
};
...
public:
	...
	// void OnRep_MovementData();                                                                                               // [0xbefdc78] Final|Native|Private|Const 
};
...
public:
	...
	// void OnRep_CurrentStateInfo();                                                                                           // [0xbefdc38] Final|Native|Private 
	// Function /Script/TempestRuntime.TempestStateMachineComponent.GetCurrentStateInfo
	// FTempestStateInfo GetCurrentStateInfo();                                                                                 // [0xbefdc10] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/TempestRuntime.TempestStateMachineComponent.GetCurrentStateCompletionPercentage
	// float GetCurrentStateCompletionPercentage();                                                                             // [0xbefdbe8] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/TempestRuntime.TempestStateMachineComponent.GetCurrentState
	// ETempestState GetCurrentState();                                                                                         // [0xbefdbd0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/TempestRuntime.TempestStateMachineComponent.ForceDissipate
	// void ForceDissipate(FString InDissipationReason);                                                                        // [0xbefd4f0] Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
};
