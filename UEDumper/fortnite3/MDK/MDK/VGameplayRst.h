...
public:
	...
	// void OnRep_SoundAsset();                                                                                                 // [0xb1b8b78] Final|Native|Protected 
	// Function /Script/VGameplayRst.AudioComponentBase.OnRep_ActiveSoundInfo
	// void OnRep_ActiveSoundInfo();                                                                                            // [0xb1b8990] Final|Native|Protected 
};
...
public:
	...
	// void OnRep_ActiveStates();                                                                                               // [0xb1b89c0] Final|Native|Private 
};
...
public:
	...
	// void TellServer_ClientLevelUnloaded(class UVerseLevelStreamingComponentBase* LevelStreamingComponent);                   // [0x6cc408c] Net|NetReliableNative|Event|Public|NetServer 
	// Function /Script/VGameplayRst.VerseLevelStreamingPlayerControllerRpcComponent.TellServer_ClientLevelLoaded
	// void TellServer_ClientLevelLoaded(class UVerseLevelStreamingComponentBase* LevelStreamingComponent);                     // [0x6e87c98] Net|NetReliableNative|Event|Public|NetServer 
};
...
public:
	...
	// void OnRep_LightComponent();                                                                                             // [0xb1b8ab0] Final|Native|Protected 
	// Function /Script/VGameplayRst.VerseLightPropertiesBase.OnRep_LightColor
	// void OnRep_LightColor();                                                                                                 // [0xb1b8a70] Final|Native|Protected 
	// Function /Script/VGameplayRst.VerseLightPropertiesBase.OnRep_Intensity
	// void OnRep_Intensity();                                                                                                  // [0xb1b8a3c] Final|Native|Protected 
};
...
public:
	...
	// void OnRep_AttenuationRadius();                                                                                          // [0xb1b89d4] Final|Native|Protected 
};
...
public:
	...
	// void OnRep_SourceRadius();                                                                                               // [0xb1b8bd4] Final|Native|Public  
	// Function /Script/VGameplayRst.VersePointLightProperties.OnRep_SourceLength
	// void OnRep_SourceLength();                                                                                               // [0xb1b8ba0] Final|Native|Public  
};
...
public:
	...
	// void OnRep_OuterConeAngle();                                                                                             // [0xb1b8b44] Final|Native|Public  
	// Function /Script/VGameplayRst.VerseSpotLightProperties.OnRep_InnerConeAngle
	// void OnRep_InnerConeAngle();                                                                                             // [0xb1b8a08] Final|Native|Public  
};
