...
public:
	...
	// void OnShowGamemodeDescription(FString ActivityTitle);                                                                   // [0x1340978] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void OnStyleUpdated(FSqueegeeStyleParams& StyleParams);                                                                  // [0x1340978] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/SqueegeeUI.FortContentGateRatingWidget.OnLabelUpdated
	// void OnLabelUpdated(bool bLabelEnabled, FText& LabelText, FText& LabelNumber);                                           // [0x1340978] Event|Protected|HasOutParms|BlueprintEvent 
};
...
public:
	...
	// void OnShowWeaponData();                                                                                                 // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/SqueegeeUI.FortContentManagementDetails.OnShowActivityData
	// void OnShowActivityData(FText& ActivityDisplayName, FText& ActivityDescription, FString CreatorName, FText& LinkCode, bool IsCreative, FDateTime& UnlockTime, class UFortGameActivity* GameActivity); // [0x1340978] Event|Protected|HasOutParms|HasDefaults|BlueprintEvent 
...
public:
	...
	// void OnShowGameActivity(class UFortGameActivity* NewGameActivity);                                                       // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/SqueegeeUI.FortContentManagementButton.OnShowError
	// void OnShowError(FText& ErrorText);                                                                                      // [0x1340978] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/SqueegeeUI.FortContentManagementButton.OnChangeManagementState
	// void OnChangeManagementState(EFortContentManagementState NewState);                                                      // [0x1340978] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void OnSetLabel(FText& InText);                                                                                          // [0x1340978] Event|Protected|HasOutParms|BlueprintEvent 
};
...
public:
	...
	// void ResetUnlockList();                                                                                                  // [0xbef2b10] Final|Native|Protected|BlueprintCallable 
	// Function /Script/SqueegeeUI.FortContentManagementList.RequestNextUnlockPage
	// void RequestNextUnlockPage();                                                                                            // [0xbef2afc] Final|Native|Protected|BlueprintCallable 
	// Function /Script/SqueegeeUI.FortContentManagementList.OnNextUnlockPageRequestCompleted
	// void OnNextUnlockPageRequestCompleted(bool bSuccess);                                                                    // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/SqueegeeUI.FortContentManagementList.CanRequestNextUnlockPage
	// bool CanRequestNextUnlockPage();                                                                                         // [0xbef2ac4] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void ExitScreen();                                                                                                       // [0xbef2ae8] Final|Native|Protected|BlueprintCallable 
};
