...
public:
	...
	// void ExecuteUbergraph(int32_t EntryPoint);                                                                               // [0x1340978] Event|Public|BlueprintEvent 
};
...
public:
	DMember(int64_t)                                   Ticks                                                       OFFSET(get<int64_t>, {0x0, 8, 0, 0})
};
...
public:
	...
	SMember(FText)                                     CachedText                                                  OFFSET(getStruct<T>, {0xA0, 16, 0, 0})
};
