...
public:
	...
	// FTransform GetOffsetRootTransform(FAnimNodeReference& Node);                                                             // [0xd2359f4] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/AnimationWarpingRuntime.AnimationWarpingLibrary.GetCurveValueFromAnimation
	// bool GetCurveValueFromAnimation(class UAnimSequenceBase* Animation, FName CurveName, float Time, float& OutValue);       // [0xd2355f4] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
};
