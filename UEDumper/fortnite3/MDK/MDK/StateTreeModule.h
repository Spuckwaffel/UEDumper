...
public:
	...
	// void SendEvent(FStateTreeEvent& Event);                                                                                  // [0x7514c30] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/StateTreeModule.StateTreeNodeBlueprintBase.RequestTransition
	// void RequestTransition(FStateTreeStateLink& TargetState, EStateTreeTransitionPriority Priority);                         // [0x7514aa0] Final|Native|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// bool ReceiveTestCondition();                                                                                             // [0x1340978] Event|Public|BlueprintEvent|Const 
};
...
public:
	...
	// void ReceiveTreeStop();                                                                                                  // [0x1340978] Event|Public|BlueprintEvent 
	// Function /Script/StateTreeModule.StateTreeEvaluatorBlueprintBase.ReceiveTreeStart
	// void ReceiveTreeStart();                                                                                                 // [0x1340978] Event|Public|BlueprintEvent 
	// Function /Script/StateTreeModule.StateTreeEvaluatorBlueprintBase.ReceiveTick
	// void ReceiveTick(float DeltaTime);                                                                                       // [0x1340978] Event|Public|BlueprintEvent 
};
...
public:
	...
	// EStateTreeRunStatus ReceiveTick(float DeltaTime);                                                                        // [0x1340978] Event|Public|BlueprintEvent 
	// Function /Script/StateTreeModule.StateTreeTaskBlueprintBase.ReceiveStateCompleted
	// void ReceiveStateCompleted(EStateTreeRunStatus CompletionStatus, FStateTreeActiveStates CompletedActiveStates);          // [0x1340978] Event|Public|BlueprintEvent 
	// Function /Script/StateTreeModule.StateTreeTaskBlueprintBase.ReceiveLatentTick
	// void ReceiveLatentTick(float DeltaTime);                                                                                 // [0x1340978] Event|Public|BlueprintEvent 
	// Function /Script/StateTreeModule.StateTreeTaskBlueprintBase.ReceiveLatentEnterState
	// void ReceiveLatentEnterState(FStateTreeTransitionResult& TRANSITION);                                                    // [0x1340978] Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/StateTreeModule.StateTreeTaskBlueprintBase.ReceiveExitState
	// void ReceiveExitState(FStateTreeTransitionResult& TRANSITION);                                                           // [0x1340978] Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/StateTreeModule.StateTreeTaskBlueprintBase.ReceiveEnterState
	// EStateTreeRunStatus ReceiveEnterState(FStateTreeTransitionResult& TRANSITION);                                           // [0x1340978] Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/StateTreeModule.StateTreeTaskBlueprintBase.FinishTask
	// void FinishTask(bool bSucceeded);                                                                                        // [0x7514a24] Final|Native|Protected|BlueprintCallable 
};
