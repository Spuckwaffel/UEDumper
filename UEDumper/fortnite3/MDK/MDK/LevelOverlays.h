...
public:
	...
	// void ExecuteUbergraph_ColdDayEventVaultWorld(int32_t EntryPoint);                                                        // [0x1340978] Final|HasDefaults    
};
...
public:
	...
	// void ExecuteUbergraph_PilgrimEventScreenEventVaultWorld(int32_t EntryPoint);                                             // [0x1340978] Final|HasDefaults    
};
