...
public:
	...
	// void OnRep_InstanceHandle();                                                                                             // [0xcb03408] Final|Native|Protected 
	// Function /Script/InstancedActors.InstancedActorsComponent.HasMassEntity
	// bool HasMassEntity();                                                                                                    // [0xcb033d0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// class AInstancedActorsManager* GetManager();                                                                             // [0x133f4ac] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
