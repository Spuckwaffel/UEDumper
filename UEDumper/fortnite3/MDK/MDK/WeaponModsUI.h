...
public:
	...
	// void SetItemSlotInfo(FFortWeaponModSlot& ModSlot);                                                                       // [0x1340978] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/WeaponModsUI.AthenaEquippedItemInfoWeaponMods.ResetItemInfo
	// void ResetItemInfo();                                                                                                    // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/WeaponModsUI.AthenaEquippedItemInfoWeaponMods.HandleWeaponFullyEquipped
	// void HandleWeaponFullyEquipped(class AFortWeapon* NewWeapon, class AFortWeapon* PrevWeapon);                             // [0xbf2cc70] Final|Native|Private 
};
...
public:
	...
	// void HandleButtonClicked(class UObject* Object);                                                                         // [0xbf2c8ac] Final|Native|Protected|BlueprintCallable 
	// Function /Script/WeaponModsUI.AthenaInventoryGroupWeaponMods.CanWeaponEquipMod
	// bool CanWeaponEquipMod(class AFortWeapon* Weapon, class UFortWeaponModItemDefinition* Mod);                              // [0xbf2c7d8] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void UpdateItemMods();                                                                                                   // [0xbf2c9ac] Final|Native|Protected|BlueprintCallable 
	...
	// void SetIsModifiableWeapon(bool bIsModifiable);                                                                          // [0x1340978] Event|Protected|BlueprintEvent 
	...
	// void HandleWeaponModSlotsChanged(class AFortWeapon* Weapon);                                                             // [0xbf2cd90] Final|Native|Private 
	// Function /Script/WeaponModsUI.AthenaInventoryItemInfoWeaponMods.HandleInventoryPanelOpened
	// void HandleInventoryPanelOpened();                                                                                       // [0xbf2c9ac] Final|Native|Private 
	// Function /Script/WeaponModsUI.AthenaInventoryItemInfoWeaponMods.HandleInventoryItemSelected
	// void HandleInventoryItemSelected(class UFortItem* SelectedItem);                                                         // [0xbf2c92c] Final|Native|Private 
};
...
public:
	...
	// void RemoveMod(class UFortWeaponModItemDefinition* ModItemDef);                                                          // [0xbf2cf30] Final|Native|Protected|BlueprintCallable 
};
...
public:
	...
	// void SetKillerWeaponMods(TArray<FFortWeaponModSlot>& ModSlots);                                                          // [0x1340978] Event|Protected|HasOutParms|BlueprintEvent 
};
...
public:
	...
	// void SetItemModifiedWeaponName(FText& ModifiedWeaponName);                                                               // [0x1340978] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/WeaponModsUI.AthenaPickupIndicatorWeaponMods.SetEquippedWeaponItemSlotInfo
	// void SetEquippedWeaponItemSlotInfo(FFortWeaponModSlot& ModSlot);                                                         // [0x1340978] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/WeaponModsUI.AthenaPickupIndicatorWeaponMods.SetEquippedWeaponItemInfo
	// void SetEquippedWeaponItemInfo(class UItemDefinitionBase* ItemDef);                                                      // [0x1340978] Event|Protected|BlueprintEvent 
	...
	// bool IsInspectViewCollapsedBySettings();                                                                                 // [0xbf2cee8] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/WeaponModsUI.AthenaPickupIndicatorWeaponMods.HandleWeaponEquipped
	// void HandleWeaponEquipped(class AFortWeapon* NewWeapon, class AFortWeapon* PrevWeapon);                                  // [0xbf2cb04] Final|Native|Protected 
	// Function /Script/WeaponModsUI.AthenaPickupIndicatorWeaponMods.HandlePickupHovered
	// void HandlePickupHovered(class AFortPickup* Pickup);                                                                     // [0xbf2c9c0] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void UpdateModVisuals(TArray<FFortWeaponModSlot>& ModSlots);                                                             // [0xbf2d060] Final|Native|Protected|HasOutParms|BlueprintCallable 
	// Function /Script/WeaponModsUI.AthenaQuickBarSlotWeaponModsIndicator.SetItemSlotsInfo
	// void SetItemSlotsInfo(TArray<FFortWeaponModSlot>& ModSlots);                                                             // [0xbf2cfc4] Final|Native|Protected|HasOutParms|BlueprintCallable 
	// Function /Script/WeaponModsUI.AthenaQuickBarSlotWeaponModsIndicator.SetItemSlotSelected
	// void SetItemSlotSelected(bool bIsSelected);                                                                              // [0x1340978] Event|Protected|BlueprintEvent 
	...
	// void ResetItemInfo();                                                                                                    // [0xbf2cfb0] Final|Native|Protected|BlueprintCallable 
	// Function /Script/WeaponModsUI.AthenaQuickBarSlotWeaponModsIndicator.ResetIconOpacities
	// void ResetIconOpacities();                                                                                               // [0x2f52968] Final|Native|Protected|BlueprintCallable 
	// Function /Script/WeaponModsUI.AthenaQuickBarSlotWeaponModsIndicator.HandleWeaponModSlotsChanged
	// void HandleWeaponModSlotsChanged(class AFortWeapon* Weapon);                                                             // [0xbf2ce10] Final|Native|Private 
	// Function /Script/WeaponModsUI.AthenaQuickBarSlotWeaponModsIndicator.HandleWeaponFullyEquipped
	// void HandleWeaponFullyEquipped(class AFortWeapon* NewWeapon, class AFortWeapon* PrevWeapon);                             // [0x2f52b64] Final|Native|Private 
	// Function /Script/WeaponModsUI.AthenaQuickBarSlotWeaponModsIndicator.HandleQuickBarSlotFocusChanged
	// void HandleQuickBarSlotFocusChanged(EFortQuickBars QuickBarType, int32_t QuickBarSlot);                                  // [0xbf2ca40] Final|Native|Private 
};
