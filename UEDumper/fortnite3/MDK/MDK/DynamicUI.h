...
public:
	...
	// void BroadcastTransitionCompleted();                                                                                     // [0x3454f8c] Native|Protected|BlueprintCallable 
};
...
public:
	...
	// void RemoveScene(class UDynamicUIScene* Scene);                                                                          // [0x8046c5c] Final|Native|Public|BlueprintCallable 
	// Function /Script/DynamicUI.DynamicUIDirectorBase.GetOwningLocalPlayerController
	// class APlayerController* GetOwningLocalPlayerController();                                                               // [0x8046aa0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DynamicUI.DynamicUIDirectorBase.GetOwningLocalPlayer
	// class ULocalPlayer* GetOwningLocalPlayer();                                                                              // [0x8046a7c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DynamicUI.DynamicUIDirectorBase.AddScene
	// void AddScene(class UDynamicUIScene* Scene);                                                                             // [0x80459a8] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void RemoveScenes(TArray<UDynamicUIScene*> Scenes, class APlayerController*& Player);                                    // [0x8047020] Final|Native|Protected|HasOutParms|BlueprintCallable 
	// Function /Script/DynamicUI.DynamicUIManager.RemoveSceneFromFirstLocalPlayer
	// void RemoveSceneFromFirstLocalPlayer(class UDynamicUIScene* Scene);                                                      // [0x8046ea0] Final|Native|Protected|BlueprintCallable 
	// Function /Script/DynamicUI.DynamicUIManager.RemoveScene
	// void RemoveScene(class UDynamicUIScene* Scene, class APlayerController*& Player);                                        // [0x8046cdc] Final|Native|Protected|HasOutParms|BlueprintCallable 
	// Function /Script/DynamicUI.DynamicUIManager.IsSceneActiveOnFirstLocalPlayer
	// bool IsSceneActiveOnFirstLocalPlayer(class UDynamicUIScene* Scene);                                                      // [0x8046bac] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DynamicUI.DynamicUIManager.IsSceneActive
	// bool IsSceneActive(class UDynamicUIScene* Scene, class APlayerController*& Player);                                      // [0x8046ac4] Final|Native|Protected|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/DynamicUI.DynamicUIManager.AddSceneToFirstLocalPlayer
	// void AddSceneToFirstLocalPlayer(class UDynamicUIScene* Scene);                                                           // [0x8045ec4] Final|Native|Protected|BlueprintCallable 
	// Function /Script/DynamicUI.DynamicUIManager.AddScenes
	// void AddScenes(TArray<UDynamicUIScene*> Scenes, class APlayerController*& Player);                                       // [0x8046324] Final|Native|Protected|HasOutParms|BlueprintCallable 
	// Function /Script/DynamicUI.DynamicUIManager.AddScene
	// void AddScene(class UDynamicUIScene* Scene, class APlayerController*& Player);                                           // [0x8045a28] Final|Native|Protected|HasOutParms|BlueprintCallable 
};
