...
public:
	...
	// int32_t GetTotalPartCount();                                                                                             // [0xcc2d374] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoBuildingCosmeticsUI.JunoShopBuildSetItemDetailsVM.GetFormattedPartList
	// TArray<FText> GetFormattedPartList();                                                                                    // [0xcc2d2fc] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoBuildingCosmeticsUI.JunoShopBuildSetItemDetailsVM.ForceUpdateItemDetails
	// void ForceUpdateItemDetails();                                                                                           // [0xcc2d2e8] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// TArray<FText> GetPropNames();                                                                                            // [0xcc2d338] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
