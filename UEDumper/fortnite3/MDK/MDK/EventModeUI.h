...
public:
	...
	// void HandleEventModeFocusingChanged(bool bIsEventModeFocusing);                                                          // [0xbc79cdc] Final|Native|Private 
	// Function /Script/EventModeUI.FocusButton.HandleCanUseEventModeFocusChanged
	// void HandleCanUseEventModeFocusChanged(bool bCanUseEventModeFocus);                                                      // [0xbc79c60] Final|Native|Private 
};
...
public:
	...
	// void OnFocusStateChanged(bool bIsFocusing);                                                                              // [0x1340978] Event|Public|BlueprintEvent 
	// Function /Script/EventModeUI.FortEventModeEmotesWidget.OnFocusAvailableChanged
	// void OnFocusAvailableChanged(bool bIsFocusAvailable);                                                                    // [0x1340978] Event|Public|BlueprintEvent 
};
...
public:
	...
	// void HandleEventModeFocusingChanged(bool bIsEventModeFocusing);                                                          // [0xaa859d4] Final|Native|Private 
	// Function /Script/EventModeUI.FortMobileActionButtonBehavior_Focus.HandleCanUseEventModeFocusChanged
	// void HandleCanUseEventModeFocusChanged(bool bCanUseEventModeFocus);                                                      // [0xaa85a54] Final|Native|Private 
};
