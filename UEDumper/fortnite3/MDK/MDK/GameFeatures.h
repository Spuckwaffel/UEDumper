...
public:
	...
	// void GetPluginName(class UGameFeatureData* GFD, FString& PluginName);                                                    // [0x7391234] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	DMember(char)                                      AdditionFlags                                               OFFSET(get<char>, {0x41, 1, 0, 0})
};
