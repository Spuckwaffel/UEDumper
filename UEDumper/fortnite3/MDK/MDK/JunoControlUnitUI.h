...
public:
	...
	// void UpdateFromPowerManagerComponent(class UJunoPowerManagerComponent* InPowerManagerComponent);                         // [0xccbe6a0] Final|Native|Public|BlueprintCallable 
	// Function /Script/JunoControlUnitUI.JunoPowerManagerComponentVM.UpdateFromJunoPhysicsToyActor
	// void UpdateFromJunoPhysicsToyActor(class AJunoPhysicsToyActor* InJunoPhysicsToyActor);                                   // [0xccbe5f8] Final|Native|Public|BlueprintCallable 
};
