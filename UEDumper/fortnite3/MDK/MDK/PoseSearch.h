...
public:
	...
	// void SetInterruptMode(FMotionMatchingAnimNodeReference& MotionMatchingNode, EPoseSearchInterruptMode InterruptMode);     // [0x85fac74] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/PoseSearch.MotionMatchingAnimNodeLibrary.SetDatabaseToSearch
	// void SetDatabaseToSearch(FMotionMatchingAnimNodeReference& MotionMatchingNode, class UPoseSearchDatabase* Database, EPoseSearchInterruptMode InterruptMode); // [0x85fa800] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/PoseSearch.MotionMatchingAnimNodeLibrary.SetDatabasesToSearch
	// void SetDatabasesToSearch(FMotionMatchingAnimNodeReference& MotionMatchingNode, TArray<UPoseSearchDatabase*>& Databases, EPoseSearchInterruptMode InterruptMode); // [0x85faa80] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/PoseSearch.MotionMatchingAnimNodeLibrary.ResetDatabasesToSearch
	// void ResetDatabasesToSearch(FMotionMatchingAnimNodeReference& MotionMatchingNode, EPoseSearchInterruptMode InterruptMode); // [0x85fa674] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/PoseSearch.MotionMatchingAnimNodeLibrary.GetMotionMatchingSearchResult
	// void GetMotionMatchingSearchResult(FMotionMatchingAnimNodeReference& MotionMatchingNode, FPoseSearchBlueprintResult& Result, bool& bIsResultValid); // [0x85fa518] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/PoseSearch.MotionMatchingAnimNodeLibrary.ConvertToMotionMatchingNodePure
	// void ConvertToMotionMatchingNodePure(FAnimNodeReference& Node, FMotionMatchingAnimNodeReference& MotionMatchingNode, bool& Result); // [0x85fa3a0] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/PoseSearch.MotionMatchingAnimNodeLibrary.ConvertToMotionMatchingNode
	// FMotionMatchingAnimNodeReference ConvertToMotionMatchingNode(FAnimNodeReference& Node, EAnimNodeReferenceConversionResult& Result); // [0x85fa274] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// FQuat BP_GetWorldRotation(class UAnimInstance* AnimInstance);                                                            // [0x1340978] Event|Public|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
};
...
public:
	...
	// FVector BP_GetWorldPosition(class UAnimInstance* AnimInstance);                                                          // [0x1340978] Event|Public|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
};
...
public:
	...
	// float BP_GetTimeToEvent(class UAnimInstance* AnimInstance);                                                              // [0x1340978] Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
};
...
public:
	...
	// FVector BP_GetWorldVelocity(class UAnimInstance* AnimInstance);                                                          // [0x1340978] Event|Public|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
};
...
public:
	...
	// void SetPoseHistoryNodeTrajectory(FPoseSearchHistoryCollectorAnimNodeReference& PoseSearchHistoryCollectorNode, FPoseSearchQueryTrajectory& Trajectory); // [0x86009b0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/PoseSearch.PoseSearchHistoryCollectorAnimNodeLibrary.GetPoseHistoryNodeTrajectory
	// void GetPoseHistoryNodeTrajectory(FPoseSearchHistoryCollectorAnimNodeReference& PoseSearchHistoryCollectorNode, FPoseSearchQueryTrajectory& Trajectory); // [0x85ff14c] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/PoseSearch.PoseSearchHistoryCollectorAnimNodeLibrary.ConvertToPoseHistoryNodePure
	// void ConvertToPoseHistoryNodePure(FAnimNodeReference& Node, FPoseSearchHistoryCollectorAnimNodeReference& PoseSearchHistoryCollectorNode, bool& Result); // [0x85fefd4] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/PoseSearch.PoseSearchHistoryCollectorAnimNodeLibrary.ConvertToPoseHistoryNode
	// FPoseSearchHistoryCollectorAnimNodeReference ConvertToPoseHistoryNode(FAnimNodeReference& Node, EAnimNodeReferenceConversionResult& Result); // [0x85feea8] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// class UAnimSequenceBase* GetSequence(FName& Role);                                                                       // [0x85ff264] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void MotionMatchMulti(TArray<ACharacter*> AnimInstances, TArray<FName> Roles, TArray<UObject*> AssetsToSearch, FName PoseHistoryName, FPoseSearchBlueprintResult& Result, int32_t DebugSessionUniqueIdentifier); // [0x8607084] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/PoseSearch.PoseSearchLibrary.MotionMatch
	// void MotionMatch(class UAnimInstance* AnimInstance, TArray<UObject*> AssetsToSearch, FName PoseHistoryName, FPoseSearchFutureProperties Future, FPoseSearchBlueprintResult& Result, int32_t DebugSessionUniqueIdentifier); // [0x8606c0c] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
};
