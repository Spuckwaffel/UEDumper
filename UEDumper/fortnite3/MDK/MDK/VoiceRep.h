...
public:
	...
	// void UpdateVisuals(UFortVoiceReportIntroModalType DescriptionType);                                                      // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/VoiceRep.FortVoiceReportIntroModal.HandleTurnOnClicked
	// void HandleTurnOnClicked();                                                                                              // [0xd0f67f8] Final|Native|Protected|BlueprintCallable 
	// Function /Script/VoiceRep.FortVoiceReportIntroModal.HandleTurnOffClicked
	// void HandleTurnOffClicked();                                                                                             // [0xd0f67e4] Final|Native|Protected|BlueprintCallable 
	// Function /Script/VoiceRep.FortVoiceReportIntroModal.HandleLearnMore
	// void HandleLearnMore();                                                                                                  // [0xd0f67d0] Final|Native|Protected|BlueprintCallable 
};
