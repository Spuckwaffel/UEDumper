...
public:
	...
	// float TickVisibilityLevel(float DeltaSeconds);                                                                           // [0xbbe33f4] Final|Native|Protected|BlueprintCallable 
	// Function /Script/CloakGameplay.FortGameCueNotifyLoop_Cloak.SetModifierEnabled
	// bool SetModifierEnabled(FName& ModifierName, bool bNewEnabled);                                                          // [0xbbe32d4] Final|Native|Protected|HasOutParms|BlueprintCallable 
	// Function /Script/CloakGameplay.FortGameCueNotifyLoop_Cloak.SetModifierCanBeEnabled
	// bool SetModifierCanBeEnabled(FName& ModifierName, bool bNewCanBeEnabled);                                                // [0xbbe31b4] Final|Native|Protected|HasOutParms|BlueprintCallable 
	// Function /Script/CloakGameplay.FortGameCueNotifyLoop_Cloak.GetCurrentModifierValues
	// bool GetCurrentModifierValues(float& OutVisibilityMultiplier, float& OutVisibilityAddition, FName& ModifierName);        // [0xbbe3088] Final|Native|Protected|HasOutParms|BlueprintCallable|BlueprintPure|Const 
};
