...
public:
	...
	// void ExecuteUbergraph_B_SparksOnActorPreviewDefault(int32_t EntryPoint);                                                 // [0x1340978] Final|HasDefaults    
};
...
public:
	...
	// void FixupMeshAndMaterials(class USkeletalMeshComponent* MeshComponent, class USkeletalMesh* NewMesh, class UMaterialInstance* Material1, class UMaterialInstance* Material2, class UFXSystemAsset* FX); // [0x1340978] Public|BlueprintCallable|BlueprintEvent 
	// Function /SparksCosmetics/FrontendPreview/B_SparksCosmeticPreviewDisplay.B_SparksCosmeticPreviewDisplay_C.Hide all
	// void Hide all();                                                                                                         // [0x1340978] Public|BlueprintCallable|BlueprintEvent 
	...
	// void CustomizePreviewInstance(class UFortItemDefinition* InItemDefinition);                                              // [0x1340978] Event|Public|BlueprintEvent 
	...
	// void ExecuteUbergraph_B_SparksCosmeticPreviewDisplay(int32_t EntryPoint);                                                // [0x1340978] Final|HasDefaults    
	...
	// void NewEventDispatcher__DelegateSignature();                                                                            // [0x1340978] Public|Delegate|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// void Timeline__PlayResIn__EventFunc();                                                                                   // [0x1340978] BlueprintEvent       
	...
	// void Timeline__LoadingFXOutro__EventFunc();                                                                              // [0x1340978] BlueprintEvent       
	// Function /SparksCosmetics/FrontendPreview/B_SparksOffActorPreview.B_SparksOffActorPreview_C.Timeline__ShowPawn__EventFunc
	// void Timeline__ShowPawn__EventFunc();                                                                                    // [0x1340978] BlueprintEvent       
	...
	// void ExecuteUbergraph_B_SparksOffActorPreview(int32_t EntryPoint);                                                       // [0x1340978] Final                
};
...
public:
	...
	// void ExecuteUbergraph_SongItemPreview(int32_t EntryPoint);                                                               // [0x1340978] Final                
};
...
public:
	...
	// FTransform GetFrameTargetTransform();                                                                                    // [0x1340978] Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /SparksCosmetics/FrontendPreview/B_SparksSong_PreviewDisplay.B_SparksSong_PreviewDisplay_C.GetFrameTargetBounds
	// FBoxSphereBounds GetFrameTargetBounds();                                                                                 // [0x1340978] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /SparksCosmetics/FrontendPreview/B_SparksSong_PreviewDisplay.B_SparksSong_PreviewDisplay_C.PerformSpecialAction
	// void PerformSpecialAction(FName ActionName);                                                                             // [0x1340978] Event|Public|BlueprintCallable|BlueprintEvent 
	...
	// void DebounceEvent();                                                                                                    // [0x1340978] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_B_SparksSong_PreviewDisplay(int32_t EntryPoint);                                                   // [0x1340978] Final|HasDefaults    
};
