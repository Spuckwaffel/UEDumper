...
public:
	...
	// void SetControlChannel_SteerAngle(FGameplayTag InChannelTag);                                                            // [0xccd69e4] Final|Native|Public|BlueprintCallable 
	// Function /Script/JunoWheelsDemoRuntime.JunoWheelActor.SetControlChannel_Brake
	// void SetControlChannel_Brake(FGameplayTag InChannelTag);                                                                 // [0xccd6960] Final|Native|Public|BlueprintCallable 
	// Function /Script/JunoWheelsDemoRuntime.JunoWheelActor.SetControlChannel_AngularVelocity
	// void SetControlChannel_AngularVelocity(FGameplayTag InChannelTag);                                                       // [0xccd68dc] Final|Native|Public|BlueprintCallable 
	// Function /Script/JunoWheelsDemoRuntime.JunoWheelActor.SetAssociatedItem
	// void SetAssociatedItem(class UItemDefinitionBase* ItemDefinition);                                                       // [0xccd6858] Native|Public|BlueprintCallable 
	// Function /Script/JunoWheelsDemoRuntime.JunoWheelActor.SetActorRef
	// void SetActorRef(class AActor* NewActorRef);                                                                             // [0xccd67d8] Final|Native|Public|BlueprintCallable 
	// Function /Script/JunoWheelsDemoRuntime.JunoWheelActor.OnLocalInteractStop
	// void OnLocalInteractStop(class AFortPlayerController* FortPC);                                                           // [0x1340978] Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Script/JunoWheelsDemoRuntime.JunoWheelActor.OnLocalInteractStart
	// void OnLocalInteractStart(class AFortPlayerController* FortPC);                                                          // [0x1340978] Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Script/JunoWheelsDemoRuntime.JunoWheelActor.OnHeldObjectPickedUp
	// void OnHeldObjectPickedUp();                                                                                             // [0xccd67c4] Final|Native|Private 
	// Function /Script/JunoWheelsDemoRuntime.JunoWheelActor.K2_RemoveGameplayCue
	// void K2_RemoveGameplayCue(FGameplayTag GameplayCueTag, FGameplayCueParameters& GameplayCueParameters);                   // [0xccd6678] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/JunoWheelsDemoRuntime.JunoWheelActor.K2_ExecuteGameplayCueWithParams
	// void K2_ExecuteGameplayCueWithParams(FGameplayTag GameplayCueTag, FGameplayCueParameters& GameplayCueParameters);        // [0xccd652c] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/JunoWheelsDemoRuntime.JunoWheelActor.K2_AddGameplayCueWithParams
	// void K2_AddGameplayCueWithParams(FGameplayTag GameplayCueTag, FGameplayCueParameters& GameplayCueParameters);            // [0xccd63e0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/JunoWheelsDemoRuntime.JunoWheelActor.HandleOutOfHealth
	// void HandleOutOfHealth(float InDamage, FGameplayTagContainer& InTags, FGameplayEffectContextHandle& InEffectContext, class AController* InEventInstigator, class AActor* InDamageCauser); // [0xbf32d38] Native|Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/JunoWheelsDemoRuntime.JunoWheelActor.HandleDamaged
	// void HandleDamaged(float Damage, FGameplayTagContainer& InTags, FGameplayEffectContextHandle& EffectContext, class AController* EventInstigator, class AActor* DamageCauser); // [0x1340978] Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/JunoWheelsDemoRuntime.JunoWheelActor.GetMaxHealth
	// float GetMaxHealth();                                                                                                    // [0xccd63b0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoWheelsDemoRuntime.JunoWheelActor.GetHealth
	// float GetHealth();                                                                                                       // [0xccd6380] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoWheelsDemoRuntime.JunoWheelActor.GetActorRef
	// class AActor* GetActorRef();                                                                                             // [0x6740710] Final|Native|Public|BlueprintCallable 
	// Function /Script/JunoWheelsDemoRuntime.JunoWheelActor.GameplayCue_Damage
	// void GameplayCue_Damage(TEnumAsByte<EGameplayCueEvent> EventType, FGameplayCueParameters Parameters);                    // [0xccd628c] Final|Native|Public  
	// Function /Script/JunoWheelsDemoRuntime.JunoWheelActor.Die
	// void Die(FGameplayTag DeathReason, class AController* Killer, class AActor* DamageCauser);                               // [0xccd6194] Final|BlueprintAuthorityOnly|Native|Private|BlueprintCallable 
	// Function /Script/JunoWheelsDemoRuntime.JunoWheelActor.BlueprintOnInteract
	// void BlueprintOnInteract(class AFortPawn* InteractingPawn, TEnumAsByte<EInteractionBeingAttempted> InteractionBeingAttempted); // [0x1340978] BlueprintAuthorityOnly|Event|Public|BlueprintEvent 
	// Function /Script/JunoWheelsDemoRuntime.JunoWheelActor.BlueprintGetInteractionTime
	// bool BlueprintGetInteractionTime(class AFortPawn* InteractingPawn, float& OutInteractionTime, TEnumAsByte<EInteractionBeingAttempted> InteractionBeingAttempted); // [0xccd6038] Native|Event|Public|HasOutParms|BlueprintEvent|Const 
	// Function /Script/JunoWheelsDemoRuntime.JunoWheelActor.BlueprintGetInteractionString
	// FText BlueprintGetInteractionString(class AFortPawn* InteractingPawn, TEnumAsByte<EInteractionBeingAttempted> InteractionBeingAttempted); // [0x1340978] Event|Public|BlueprintEvent|Const 
	// Function /Script/JunoWheelsDemoRuntime.JunoWheelActor.BlueprintFillContextInfo
	// void BlueprintFillContextInfo(FInteractionType& InteractType, class UFortInteractContextInfo* ContextInfo);              // [0x1340978] Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/JunoWheelsDemoRuntime.JunoWheelActor.BlueprintCanInteract
	// bool BlueprintCanInteract(class AFortPawn* InteractingPawn, TEnumAsByte<EInteractionBeingAttempted> InteractionBeingAttempted, TEnumAsByte<TInteractionType> InteractionType); // [0x1340978] Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /Script/JunoWheelsDemoRuntime.JunoWheelActor.AttachToUsingCachedData
	// bool AttachToUsingCachedData(class UPrimitiveComponent* InAttachComponent);                                              // [0xccd5fa8] Final|Native|Public|BlueprintCallable 
};
