...
public:
	...
	// void HandleActorDamaged(class AActor* DamagedActor, float Damage, class AController* InstigatedBy, class AActor* DamageCauser, FVector HitLocation, class UPrimitiveComponent* FHitComponent, FName BoneName, FVector Momentum); // [0xb188418] Final|Native|Private|HasDefaults 
};
...
public:
	...
	// void HandlePawnControllerChanged(class APawn* Pawn, class AController* OldController, class AController* NewController); // [0xb188a44] Final|Native|Private 
};
...
public:
	...
	// void HandlePreInvalidateAbilitySystem();                                                                                 // [0xb188ca0] Final|Native|Private 
	// Function /Script/VerseFortnite.FortPawnAbilityComponentBridgeHelper.HandleAbilitySystemInitialized
	// void HandleAbilitySystemInitialized(class UFortAbilitySystemComponent* AbilitySystemComponent, class AFortPlayerPawn* AffectedPawn); // [0xb188354] Final|Native|Private 
};
...
public:
	...
	// class UNPCCharacterDefinition* GetCharacterDefinition();                                                                 // [0xb187a3c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/VerseFortnite.NPCCharacterModifier.BP_OnSpawned
	// void BP_OnSpawned(class AFortPawn* Pawn);                                                                                // [0x8037210] Native|Event|Public|BlueprintEvent 
	// Function /Script/VerseFortnite.NPCCharacterModifier.BP_OnPreSpawned
	// void BP_OnPreSpawned(class AFortPawn* Pawn);                                                                             // [0x75a60e0] Native|Event|Public|BlueprintEvent 
	// Function /Script/VerseFortnite.NPCCharacterModifier.BP_ModifySpawnComponentList
	// void BP_ModifySpawnComponentList(class UFortAthenaAISpawnerDataComponentList* OutList, class UObject* ComponentOuter);   // [0xb1860fc] Native|Event|Public|BlueprintEvent 
	// Function /Script/VerseFortnite.NPCCharacterModifier.BP_IsNeededForPreview
	// bool BP_IsNeededForPreview();                                                                                            // [0x67d5d7c] Native|Event|Public|BlueprintEvent|Const 
	// Function /Script/VerseFortnite.NPCCharacterModifier.BP_IsDataValid
	// EDataValidationResult BP_IsDataValid(TArray<FText>& OutErrorMessages);                                                   // [0xb18604c] Native|Event|Public|HasOutParms|BlueprintEvent|Const 
};
...
public:
	...
	// void NotifyTargetPerceptionUpdated(class AActor* Actor, FAIStimulus Stimulus);                                           // [0xb18a1b8] Final|Native|Private 
	// Function /Script/VerseFortnite.AIPerceptionComponentData.NotifyTargetPerceptionForgotten
	// void NotifyTargetPerceptionForgotten(class AActor* Actor);                                                               // [0xb18a138] Final|Native|Private 
};
...
public:
	...
	// void OnActiveTeamArrayBuilt();                                                                                           // [0xb18a2a0] Final|Native|Private 
};
...
public:
	...
	// void OnMinigameSetup(class AFortMinigame* InMinigame);                                                                   // [0xb18a628] Final|Native|Private 
	// Function /Script/VerseFortnite.VerseFortniteMinigameTeamCollection.OnMinigameDestroyed
	// void OnMinigameDestroyed(class AActor* DestroyedMinigame);                                                               // [0xb18a490] Final|Native|Private 
};
...
public:
	...
	// void SetNPCBehaviorScript(class UNPCBehaviorScript* InAIBehaviorScript);                                                 // [0xb18a798] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void OnBotControllerAlertLevelChanged(class AFortAthenaAIBotController* BotController, EAlertLevel OldAlertLevel, EAlertLevel NewAlertLevel); // [0xb18a35c] Final|Native|Private 
};
...
public:
	...
	// class UNPCBehaviorScript* GetBehaviorScript();                                                                           // [0x7e1aba8] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// class ULoadNPCCharacterDefinitionAsync* LoadCharacterDefinitionAsync(class UObject* ContextObj, TWeakObjectPtr<UNPCCharacterDefinition*> CharacterDefinition, TArray<UNPCCharacterModifier*>& AdditionalModifiers); // [0xb1897d0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// class ULoadAndCreateComponentListAsync* LoadAndCreateComponentListAsync(class UObject* ContextObj, TWeakObjectPtr<UNPCCharacterDefinition*> CharacterDefinition, TArray<UNPCCharacterModifier*>& AdditionalModifiers, bool bForPreview); // [0xb188d48] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// void GetRequiredAssets(TArray<FSoftObjectPath>& OutAssets);                                                              // [0xb188294] Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/VerseFortnite.NPCCharacterDefinition.GetPreviewMesh
	// void GetPreviewMesh(class UObject* Outer, TArray<UNPCCharacterModifier*>& AdditionalModifiers, TArray<FCharacterPreviewMesh>& OutCharacterPreviewMeshes, class APawn*& OutDefaultPawn); // [0xb187adc] Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/VerseFortnite.NPCCharacterDefinition.GetCharacterCID
	// class UAthenaCharacterItemDefinition* GetCharacterCID(class UObject* Outer, TArray<UNPCCharacterModifier*>& AdditionalModifiers); // [0xb187158] Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/VerseFortnite.NPCCharacterDefinition.GetCharacterBlueprint
	// class UClass* GetCharacterBlueprint(TArray<UNPCCharacterModifier*>& AdditionalModifiers);                                // [0xb186a74] Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/VerseFortnite.NPCCharacterDefinition.CreateComponentList
	// class UFortAthenaAISpawnerDataComponentList* CreateComponentList(class UObject* Outer, TArray<UNPCCharacterModifier*>& AdditionalModifiers, bool bForPreview); // [0xb1861c4] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void SetNPCCharacterDefinition(TWeakObjectPtr<UNPCCharacterDefinition*> Definition);                                     // [0xb18a820] Final|Native|Public|BlueprintCallable 
	// Function /Script/VerseFortnite.NPCCharacterDefinitionComponent.OnNPCCharacterTypeChanged
	// void OnNPCCharacterTypeChanged();                                                                                        // [0x35e6228] Final|Native|Public|BlueprintCallable 
	// Function /Script/VerseFortnite.NPCCharacterDefinitionComponent.GetNPCCharacterModifiers
	// TArray<UNPCCharacterModifier*> GetNPCCharacterModifiers();                                                               // [0xb187aa4] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/VerseFortnite.NPCCharacterDefinitionComponent.GetNPCCharacterDefinition
	// TWeakObjectPtr<UNPCCharacterDefinition*> GetNPCCharacterDefinition();                                                    // [0xb187a60] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// TWeakObjectPtr<UAthenaCharacterItemDefinition*> GetCharacterCosmetic();                                                  // [0xb1879f8] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// TArray<FNPCCustomEffect> GetCustomEffects();                                                                             // [0x1340978] Event|Public|BlueprintEvent|Const 
};
...
public:
	...
	// class AFortAthenaPatrolPath* GetPatrolPathToAssign(class AActor* ModifierOwner);                                         // [0x1340978] Event|Public|BlueprintEvent 
};
...
public:
	...
	// bool IsPlayerCharacterRequired(ECharacterLook CharacterLook);                                                            // [0xb188cb4] Native|Event|Public|BlueprintEvent|Const 
};
...
public:
	...
	// TArray<FString> GetAvailableAIs();                                                                                       // [0xb186a38] Final|Native|Protected|Const 
	// Function /Script/VerseFortnite.NPCCharacterType_FromPreset.GetAIToSpawn
	// TWeakObjectPtr<UClass*> GetAIToSpawn();                                                                                  // [0xb1869f4] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void OnActorDestroyed(class AActor* DestroyedActor);                                                                     // [0xb18a2b4] Final|Native|Private 
};
...
public:
	...
	// void HandlePossessedPawnChanged(class APawn* OldPawn, class APawn* NewPawn);                                             // [0xb188b3c] Final|Native|Private 
	// Function /Script/VerseFortnite.VerseFortniteCharacter.HandlePawnEliminated
	// void HandlePawnEliminated(class AFortPlayerPawnAthena* EliminatedPawn);                                                  // [0x75a60e0] Native|Protected     
};
...
public:
	...
	// void OnMinigameSetup(class AFortMinigame* Minigame);                                                                     // [0xb18a6a8] Final|Native|Private 
	// Function /Script/VerseFortnite.VerseFortnitePlayspace.OnMinigamePlayerAdded
	// void OnMinigamePlayerAdded(FUniqueNetIdRepl UniqueNetId, bool bIsLocalPlayer);                                           // [0xb18a50c] Final|Native|Private 
};
...
public:
	...
	// void HandleMinigameStateChanged(class AFortMinigame* Minigame, EFortMinigameState NewMinigameState);                     // [0xb1887ec] Final|Native|Private 
};
...
enum class ENPCIndicatorCondition : uint8_t
{
	...
	ENPCIndicatorCondition__ENPCIndicatorCondition_MAX                               = 4
};
