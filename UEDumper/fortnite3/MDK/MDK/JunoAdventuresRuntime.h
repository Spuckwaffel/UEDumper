...
public:
	...
	// void Client_SetCachedContextualMessageResult(FJunoContextualMessageQueryResult Result);                                  // [0xcaa427c] Final|Net|NetReliableNative|Event|Private|NetClient 
};
...
public:
	...
	// void Server_RequestNPCHardRemoval(FGameplayTag UniqueAIIdentifier);                                                      // [0xcaa6700] RequiredAPI|Net|NetReliableNative|Event|Public|NetServer|BlueprintCallable 
	// Function /Script/JunoAdventuresRuntime.JunoControllerComponent_SocialSimAI.Server_RequestCreatureHardRemoval
	// void Server_RequestCreatureHardRemoval(FGameplayTag UniqueAIIdentifier);                                                 // [0xcaa667c] RequiredAPI|Net|NetReliableNative|Event|Public|NetServer|BlueprintCallable 
};
...
public:
	...
	// bool ValidateUniqueResidentTag(FGameplayTag& OtherResidentIdentifier);                                                   // [0xcaa68ec] Final|Native|Private|HasOutParms|Const 
	// Function /Script/JunoAdventuresRuntime.JunoControllerRequirement_CampResidentsHaveTag.ValidateRoleTag
	// bool ValidateRoleTag(FGameplayTag& OtherResidentIdentifier, class UPlayspaceComponent_JunoAIPersistence* RootAIPersistenceComp); // [0xcaa6784] Final|Native|Private|HasOutParms|Const 
};
...
public:
	...
	// TArray<FName> Editor_GetValidObjectives();                                                                               // [0x840fb34] Final|Native|Private|Const 
};
...
public:
	...
	// void PlayClientVoiceLine(FConversationContext& Context, FJunoContextualMessageQueryResult& MessageParams);               // [0xcaa5c94] Native|Event|Protected|HasOutParms|BlueprintEvent|Const 
};
...
public:
	...
	// void OnRep_ParticipantIconSmall();                                                                                       // [0xcaa5c30] Final|Native|Protected 
};
...
public:
	...
	// void HandleInventoryChangedEvent(FJunoItemSlot& ItemSlot, EJunoItemChangeType ChangeType);                               // [0xcaa5258] Final|Native|Public|HasOutParms 
};
...
public:
	...
	// void RollGrantableQuestID();                                                                                             // [0xcaa64a8] Final|Native|Public|BlueprintCallable 
	// Function /Script/JunoAdventuresRuntime.JunoQuestGiverComponent.HandleOnJunoQuestComplete
	// void HandleOnJunoQuestComplete(TScriptInterface<Class>& QuestInstance);                                                  // [0xcaa5444] Final|Native|Private|HasOutParms 
	// Function /Script/JunoAdventuresRuntime.JunoQuestGiverComponent.GetGrantableQuestID
	// FString GetGrantableQuestID();                                                                                           // [0xcaa4310] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoAdventuresRuntime.JunoQuestGiverComponent.BindToQuestManagerDelegates
	// void BindToQuestManagerDelegates();                                                                                      // [0xcaa4268] Final|Native|Private 
};
...
public:
	...
	// void ReceiveToken(FGameplayTag& JunoToken);                                                                              // [0xcaa63dc] Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/JunoAdventuresRuntime.JunoTokenHandlerAIComponent.GetSavedTokens
	// FGameplayTagContainer GetSavedTokens();                                                                                  // [0xcaa5228] Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// EJunoQuestState GetJunoQuestState(FString QuestID);                                                                      // [0xcaa445c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void SendQuestStatEvent(EFortQuestObjectiveStatEvent Type, FGameplayTagContainer SourceTags, FGameplayTagContainer TargetTags, int32_t Count); // [0xcaa64bc] Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
	// Function /Script/JunoAdventuresRuntime.JunoQuestManagerComponent.GetQuestGiverForQuestID
	// class AActor* GetQuestGiverForQuestID(FString QuestID);                                                                  // [0xcaa4b3c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoAdventuresRuntime.JunoQuestManagerComponent.ActivateQuest
	// void ActivateQuest(class UFortQuestItemDefinition_Athena* QuestDefinition, class AActor* QuestGiver);                    // [0xcaa41a4] Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
};
...
public:
	...
	// TArray<FName> Editor_GetValidObjectiveNames();                                                                           // [0x840fb34] Final|Native|Private|Const 
};
...
public:
	...
	// class UJunoQuestManagerComponent* GetJunoQuestManager(class UObject* WorldContextObject);                                // [0xcaa43dc] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/JunoAdventuresRuntime.JunoAdventuresBlueprintLibrary.GetJunoQuestDatabase
	// class UJunoQuestDatabaseComponent* GetJunoQuestDatabase(class UObject* WorldContextObject);                              // [0xcaa435c] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// void JunoSpawnVisitorInClosestCamp(FString PartialUniqueAIIdentifier, int32_t Count);                                    // [0x9ac1fc8] Final|BlueprintAuthorityOnly|Exec|Native|Private|Const 
	// Function /Script/JunoAdventuresRuntime.JunoCheatManager_Adventures.JunoRepopulateAvailableQuestsWithTags
	// void JunoRepopulateAvailableQuestsWithTags(FString QuestPoolTags);                                                       // [0xcaa554c] Final|BlueprintAuthorityOnly|Exec|Native|Private 
	// Function /Script/JunoAdventuresRuntime.JunoCheatManager_Adventures.JunoRepopulateAvailableQuests
	// void JunoRepopulateAvailableQuests();                                                                                    // [0xcaa54d4] Final|BlueprintAuthorityOnly|Exec|Native|Private 
	// Function /Script/JunoAdventuresRuntime.JunoCheatManager_Adventures.JunoQueueScriptRowMessagesForNpcConversation
	// void JunoQueueScriptRowMessagesForNpcConversation(FString ScriptName, FString RowName);                                  // [0x9f2c6d8] Final|BlueprintAuthorityOnly|Exec|Native|Private 
	// Function /Script/JunoAdventuresRuntime.JunoCheatManager_Adventures.JunoPrintNPCsInfo
	// void JunoPrintNPCsInfo(bool bIgnoreAIsWithNoAssignment);                                                                 // [0x64a7494] Final|Exec|Native|Private|Const 
	// Function /Script/JunoAdventuresRuntime.JunoCheatManager_Adventures.JunoPrintCurrentConversationInfo
	// void JunoPrintCurrentConversationInfo();                                                                                 // [0x35e6228] Final|Exec|Native|Private|Const 
	// Function /Script/JunoAdventuresRuntime.JunoCheatManager_Adventures.JunoInjectDisplayTextForNpcConversation
	// void JunoInjectDisplayTextForNpcConversation(FString TestString);                                                        // [0x6d232d0] Final|BlueprintAuthorityOnly|Exec|Native|Private|Const 
};
...
enum class EJunoNPCJoinReason : uint8_t
{
	...
	EJunoNPCJoinReason__EJunoNPCJoinReason_MAX                                       = 3
};
