...
public:
	...
	// void HandleAbilityRejectedOnClient(class AFortWeapon* SourceWeapon);                                                     // [0x1340978] Event|Public|BlueprintEvent 
};

/// Class /Script/ItemizedPropSpawnerParentRuntime.FortWeaponRangedPropSpawner
/// Size: 0x0008 (0x001D00 - 0x001D08)
class AFortWeaponRangedPropSpawner : public AFortWeaponRanged
{ 
	friend MDKHandler;
	static inline constexpr uint64_t __MDKClassSize = 7432;

public:
	DMember(bool)                                      bForceSyncAmmoForLocalPropSpawnerWeapon                     OFFSET(get<bool>, {0x1D00, 1, 0, 0})
};
...
public:
	DMember(bool)                                      bIsUpperBody                                                OFFSET(get<bool>, {0x1510, 1, 0, 0})
	DMember(bool)                                      bGrindRail                                                  OFFSET(get<bool>, {0x1511, 1, 0, 0})
	DMember(bool)                                      bIsIceFireToSprint                                          OFFSET(get<bool>, {0x1512, 1, 0, 0})
	DMember(bool)                                      bIsIceFireToIdle                                            OFFSET(get<bool>, {0x1513, 1, 0, 0})
	DMember(bool)                                      bIsIceFireFallStart                                         OFFSET(get<bool>, {0x1514, 1, 0, 0})
	DMember(bool)                                      bIsIceFireFallEnd                                           OFFSET(get<bool>, {0x1515, 1, 0, 0})
	DMember(bool)                                      bIsIceFireFullBodyGround                                    OFFSET(get<bool>, {0x1516, 1, 0, 0})
	DMember(bool)                                      bIsIceFire                                                  OFFSET(get<bool>, {0x1517, 1, 0, 0})
	DMember(bool)                                      bIsIceFireUpperBody                                         OFFSET(get<bool>, {0x1518, 1, 0, 0})
	DMember(bool)                                      bIsFromIceFireEndStates                                     OFFSET(get<bool>, {0x1519, 1, 0, 0})
	DMember(bool)                                      bIsTrFromFireEndIdle                                        OFFSET(get<bool>, {0x151A, 1, 0, 0})
	DMember(bool)                                      bIsTrFromFireEndLoco                                        OFFSET(get<bool>, {0x151B, 1, 0, 0})
	DMember(bool)                                      bIsFireExitUnexpectedly                                     OFFSET(get<bool>, {0x151C, 1, 0, 0})
	DMember(bool)                                      bIsFireEndExitUnexpectedly                                  OFFSET(get<bool>, {0x151D, 1, 0, 0})
	SMember(FRotator)                                  UpperBodyTwistRotator                                       OFFSET(getStruct<T>, {0x1520, 24, 0, 0})
	DMember(float)                                     TurnEndThreshold                                            OFFSET(get<float>, {0x1538, 4, 0, 0})
	DMember(float)                                     TurnEndLocoThreshold                                        OFFSET(get<float>, {0x153C, 4, 0, 0})
	DMember(float)                                     PawnVelocityZThreshold                                      OFFSET(get<float>, {0x1540, 4, 0, 0})
	DMember(float)                                     InterruptibleThreshold                                      OFFSET(get<float>, {0x1544, 4, 0, 0})
};

/// Class /Script/ItemizedPropSpawnerParentRuntime.EmeraldGlassIceWallChunk
/// Size: 0x0018 (0x000BD0 - 0x000BE8)
...
public:
	CMember(TWeakObjectPtr<AEmeraldGlassIceWallChunk*>) ParentChunk                                                OFFSET(get<T>, {0xBD0, 8, 0, 0})
	CMember(TArray<TWeakObjectPtr<UClass*>>)           IceWallActorClassDenyList                                   OFFSET(get<T>, {0xBD8, 16, 0, 0})


	/// Functions
	// Function /Script/ItemizedPropSpawnerParentRuntime.EmeraldGlassIceWallChunk.NativeShouldDestroyOverlappedActor
	// bool NativeShouldDestroyOverlappedActor(class AActor* Actor, FGameplayTagContainer& TagsToDestroyOverlappedActor);       // [0xbc1148c] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/ItemizedPropSpawnerParentRuntime.EmeraldGlassIceWallChunk.NativeShouldActorBlockSpawn
	// bool NativeShouldActorBlockSpawn(class AActor* Actor, bool bShouldLaunch, FGameplayTag& BlockTag);                       // [0xbc11338] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/ItemizedPropSpawnerParentRuntime.EmeraldGlassIceWallChunk.NativeCheckOverlappedActor
	// void NativeCheckOverlappedActor(FSereneYardOverlappedActorCheckData& CheckData, class AActor* OverlappedActor, TArray<UCapsuleComponent*>& InOutComponentsSetToIgnoreCollision, bool& bInOutShouldPlayImpulseCue, bool& bOutDestroyOverlappedActor, bool& bOutShouldWaitATick, bool& bOutDestroyProp); // [0xbc10094] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/ItemizedPropSpawnerParentRuntime.EmeraldGlassIceWallChunk.IsIceWallAllowedToOverlapActor
	// bool IsIceWallAllowedToOverlapActor(class AActor* Actor);                                                                // [0xbc0ffc4] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ItemizedPropSpawnerParentRuntime.EmeraldGlassIceWallChunk.GetComponentsForOverlapCheck
	// void GetComponentsForOverlapCheck(TArray<UPrimitiveComponent*>& OutComponents);                                          // [0x1340978] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure 
	// Function /Script/ItemizedPropSpawnerParentRuntime.EmeraldGlassIceWallChunk.FindSupportingActors
	// void FindSupportingActors(TArray<AActor*>& InOutSupportingActors, bool bAllowIceWallsAsSupportingActors, TArray<AEmeraldGlassIceWallChunk*>& ChunksInMyWall); // [0xbc0f7b4] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/ItemizedPropSpawnerParentRuntime.EmeraldGlassIceWallChunk.AttachActors
	// void AttachActors(TArray<AEmeraldGlassIceWallChunk*>& ChunksInMyWall, TArray<AActor*>& SupportingActors, class AActor* DirectBase); // [0xbc0e768] Final|Native|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// void RemoveOldestTrackedInstance();                                                                                      // [0xbc11844] Final|Native|Public|BlueprintCallable 
	// Function /Script/ItemizedPropSpawnerParentRuntime.FortControllerComponent_SereneYard.GetTrackedInstanceCount
	// int32_t GetTrackedInstanceCount();                                                                                       // [0x65249e0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ItemizedPropSpawnerParentRuntime.FortControllerComponent_SereneYard.GetOldestTrackedInstance
	// class ABuildingGameplayActor* GetOldestTrackedInstance();                                                                // [0xbc0ff8c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ItemizedPropSpawnerParentRuntime.FortControllerComponent_SereneYard.AddTrackedInstance
	// void AddTrackedInstance(class ABuildingGameplayActor* TrackedInstance);                                                  // [0xbc0e638] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// bool NativeUpdateTarget(FSereneYardWeaponData& WeaponData, FVector& outTargetLocation, ESereneYardTargetingFailedReason& OutFailureReason, TArray<bool>& OutValidity); // [0xbc115b4] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/ItemizedPropSpawnerParentRuntime.SereneYardFunctionLibraryNative.NativeCheckSpawnValidity
	// bool NativeCheckSpawnValidity(FSereneYardWeaponData& WeaponData, FVector& InOutTargetLocation, float CameraYaw, bool bCheckForAllChunks, TArray<bool>& OutValidity, TArray<double>& OutOffsets, TArray<AActor*>& OutActorsBeingUsedAsBase, ESereneYardTargetingFailedReason& OutFailureReason); // [0xbc10df4] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/ItemizedPropSpawnerParentRuntime.SereneYardFunctionLibraryNative.BuildPropDataForWeaponData
	// void BuildPropDataForWeaponData(TArray<FNativeItemizedPropSpawner_PropSpawnData>& PropSpawnDataArray, TArray<FTransform>& PropRelativeTransforms, TMap<ESereneYardChunkLocation, int32_t>& ChunkLocationToPropIndexMap); // [0xbc0eff0] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	CMember(TWeakObjectPtr<AFortWeaponRanged*>)        Weapon                                                      OFFSET(get<T>, {0x8, 8, 0, 0})
