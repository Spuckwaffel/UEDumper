...
public:
	...
	// void ServerInputActionTriggered(FGuid Guid, FVector InputValue);                                                         // [0xd2086d8] Final|Net|NetReliableNative|Event|Private|NetServer|HasDefaults|Const 
	// Function /Script/VerseInput.VerseReplicatedInputDataComponent.OnInputActionTriggered
	// void OnInputActionTriggered(FInputActionInstance& ActionInstance);                                                       // [0xd208634] Final|Native|Private|HasOutParms 
};
