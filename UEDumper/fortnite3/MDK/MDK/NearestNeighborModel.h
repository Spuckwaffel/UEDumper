...
public:
	...
	// void Empty();                                                                                                            // [0x1c3ab38] Native|Public|BlueprintCallable 
};
...
public:
	...
	// bool LoadOptimizedNetwork(FString OnnxPath);                                                                             // [0x1340978] Event|Public|BlueprintEvent 
	// Function /Script/NearestNeighborModel.NearestNeighborOptimizedNetworkLoader.GetOptimizedNetwork
	// class UNearestNeighborOptimizedNetwork* GetOptimizedNetwork();                                                           // [0x80575f0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// int32_t GetNumBasis();                                                                                                   // [0x6ec646c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// bool IsReadyForTraining();                                                                                               // [0xbde5d4c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/NearestNeighborModel.NearestNeighborModel.IsReadyForInference
	// bool IsReadyForInference();                                                                                              // [0xbde5d34] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/NearestNeighborModel.NearestNeighborModel.GetTotalNumBasis
	// int32_t GetTotalNumBasis();                                                                                              // [0xbde5d10] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/NearestNeighborModel.NearestNeighborModel.GetSectionPtr
	// class UNearestNeighborModelSection* GetSectionPtr(int32_t Index);                                                        // [0xbde5c80] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/NearestNeighborModel.NearestNeighborModel.GetPCACoeffStarts
	// TArray<int32_t> GetPCACoeffStarts();                                                                                     // [0xbde5c64] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/NearestNeighborModel.NearestNeighborModel.GetNumSections
	// int32_t GetNumSections();                                                                                                // [0x9265840] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/NearestNeighborModel.NearestNeighborModel.DoesUsePCA
	// bool DoesUsePCA();                                                                                                       // [0xbde5b48] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void Reset();                                                                                                            // [0xbde5d64] Final|Native|Public|BlueprintCallable 
	// Function /Script/NearestNeighborModel.NearestNeighborModelInstance.Eval
	// TArray<float> Eval(TArray<float>& InputData);                                                                            // [0xbde5b60] Final|Native|Private|HasOutParms|BlueprintCallable 
};
