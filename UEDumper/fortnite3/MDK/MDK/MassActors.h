...
public:
	...
	// void PrepareForPooling();                                                                                                // [0x328d468] Native|Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Script/MassActors.MassActorPoolableInterface.PrepareForGame
	// void PrepareForGame();                                                                                                   // [0x77c0170] Native|Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Script/MassActors.MassActorPoolableInterface.CanBePooled
	// bool CanBePooled();                                                                                                      // [0x17ad324] Native|Event|Public|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// void OnRep_NetID();                                                                                                      // [0x3b0eddc] Native|Public        
	// Function /Script/MassActors.MassAgentComponent.KillEntity
	// void KillEntity(bool bDestroyActor);                                                                                     // [0xb228dd0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MassActors.MassAgentComponent.Enable
	// void Enable();                                                                                                           // [0xb228dac] Final|Native|Public|BlueprintCallable 
	// Function /Script/MassActors.MassAgentComponent.Disable
	// void Disable();                                                                                                          // [0xb228d88] Final|Native|Public|BlueprintCallable 
};
