...
public:
	...
	// FLinearColor GetDebugParticipantColor(FGameplayTag ParticipantID);                                                       // [0x80eb7f8] Final|Native|Protected|HasDefaults|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void FillChoice(FConversationContext& Context, FClientConversationOptionEntry& ChoiceEntry);                             // [0x80e8ac0] Native|Event|Protected|HasOutParms|BlueprintEvent|Const 
};
...
public:
	...
	// FConversationTaskResult ReturnToLastClientChoice(FConversationContext& Context);                                         // [0x80e6200] Final|BlueprintAuthorityOnly|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/CommonConversationRuntime.ConversationContextHelpers.ReturnToCurrentClientChoice
	// FConversationTaskResult ReturnToCurrentClientChoice(FConversationContext& Context);                                      // [0x80e6200] Final|BlueprintAuthorityOnly|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/CommonConversationRuntime.ConversationContextHelpers.ReturnToConversationStart
	// FConversationTaskResult ReturnToConversationStart(FConversationContext& Context);                                        // [0x80e6200] Final|BlueprintAuthorityOnly|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/CommonConversationRuntime.ConversationContextHelpers.PauseConversationAndSendClientChoices
	// FConversationTaskResult PauseConversationAndSendClientChoices(FConversationContext& Context, FClientConversationMessage& Message); // [0x80ed14c] Final|BlueprintAuthorityOnly|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/CommonConversationRuntime.ConversationContextHelpers.MakeConversationParticipant
	// void MakeConversationParticipant(FConversationContext& Context, class AActor* ParticipantActor, FGameplayTag ParticipantTag); // [0x80ec874] Final|BlueprintAuthorityOnly|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/CommonConversationRuntime.ConversationContextHelpers.GetCurrentConversationNodeHandle
	// FConversationNodeHandle GetCurrentConversationNodeHandle(FConversationContext& Context);                                 // [0x80eb0f0] Final|BlueprintAuthorityOnly|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/CommonConversationRuntime.ConversationContextHelpers.GetConversationParticipantActor
	// class AActor* GetConversationParticipantActor(FConversationContext& Context, FGameplayTag ParticipantTag);               // [0x80ea8f0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/CommonConversationRuntime.ConversationContextHelpers.GetConversationParticipant
	// class UConversationParticipantComponent* GetConversationParticipant(FConversationContext& Context, FGameplayTag ParticipantTag); // [0x80ea0f0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/CommonConversationRuntime.ConversationContextHelpers.GetConversationInstance
	// class UConversationInstance* GetConversationInstance(FConversationContext& Context);                                     // [0x80e9a04] Final|BlueprintAuthorityOnly|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/CommonConversationRuntime.ConversationContextHelpers.FindConversationComponent
	// class UConversationParticipantComponent* FindConversationComponent(class AActor* Actor);                                 // [0x80e9210] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/CommonConversationRuntime.ConversationContextHelpers.CanConversationContinue
	// bool CanConversationContinue(FConversationTaskResult& ConversationTasResult);                                            // [0x80e707c] Final|BlueprintAuthorityOnly|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/CommonConversationRuntime.ConversationContextHelpers.AdvanceConversationWithChoice
	// FConversationTaskResult AdvanceConversationWithChoice(FConversationContext& Context, FAdvanceConversationRequest& Choice); // [0x80e6910] Final|BlueprintAuthorityOnly|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/CommonConversationRuntime.ConversationContextHelpers.AdvanceConversation
	// FConversationTaskResult AdvanceConversation(FConversationContext& Context);                                              // [0x80e6200] Final|BlueprintAuthorityOnly|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/CommonConversationRuntime.ConversationContextHelpers.AbortConversation
	// FConversationTaskResult AbortConversation(FConversationContext& Context);                                                // [0x80e6200] Final|BlueprintAuthorityOnly|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// class UConversationInstance* StartConversationFromGraph(FGameplayTag& ConversationEntryTag, class AActor* Instigator, FGameplayTag& InstigatorTag, class AActor* Target, FGameplayTag& TargetTag, class UConversationDatabase* Graph); // [0x80edcf4] Final|BlueprintAuthorityOnly|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/CommonConversationRuntime.ConversationLibrary.StartConversation
	// class UConversationInstance* StartConversation(FGameplayTag& ConversationEntryTag, class AActor* Instigator, FGameplayTag& InstigatorTag, class AActor* Target, FGameplayTag& TargetTag, class UClass* ConversationInstanceClass); // [0x80eda08] Final|BlueprintAuthorityOnly|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// EConversationRequirementResult IsRequirementSatisfied(FConversationContext& Context);                                    // [0x80ec180] BlueprintAuthorityOnly|Native|Event|Protected|HasOutParms|BlueprintEvent|Const 
	// Function /Script/CommonConversationRuntime.ConversationTaskNode.GetNodeBodyColor
	// bool GetNodeBodyColor(FLinearColor& BodyColor);                                                                          // [0x80eb8b8] Native|Event|Public|HasOutParms|HasDefaults|BlueprintEvent|Const 
	// Function /Script/CommonConversationRuntime.ConversationTaskNode.GatherStaticExtraData
	// void GatherStaticExtraData(FConversationContext& Context, TArray<FConversationNodeParameterPair>& InOutExtraData);       // [0x80e929c] BlueprintAuthorityOnly|Native|Event|Protected|HasOutParms|BlueprintEvent|Const 
	// Function /Script/CommonConversationRuntime.ConversationTaskNode.ExecuteTaskNode
	// FConversationTaskResult ExecuteTaskNode(FConversationContext& Context);                                                  // [0x80e83a8] BlueprintAuthorityOnly|Native|Event|Protected|HasOutParms|BlueprintEvent|Const 
	// Function /Script/CommonConversationRuntime.ConversationTaskNode.ExecuteClientEffects
	// void ExecuteClientEffects(FConversationContext& Context);                                                                // [0x80e7cb8] BlueprintCosmetic|Native|Event|Protected|HasOutParms|BlueprintEvent|Const 
};
...
public:
	...
	// void ServerAdvanceConversation(FAdvanceConversationRequest InChoicePicked);                                              // [0x80ed960] Net|NetReliableNative|Event|Protected|NetServer 
	// Function /Script/CommonConversationRuntime.ConversationParticipantComponent.RequestServerAdvanceConversation
	// void RequestServerAdvanceConversation(FAdvanceConversationRequest& InChoicePicked);                                      // [0x80ed8b0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/CommonConversationRuntime.ConversationParticipantComponent.OnRep_ConversationsActive
	// void OnRep_ConversationsActive(int32_t OldConversationsActive);                                                          // [0x2d1af88] Final|Native|Protected 
	// Function /Script/CommonConversationRuntime.ConversationParticipantComponent.IsInActiveConversation
	// bool IsInActiveConversation();                                                                                           // [0x80eba6c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CommonConversationRuntime.ConversationParticipantComponent.GetParticipantDisplayName
	// FText GetParticipantDisplayName();                                                                                       // [0x80eba2c] Native|Public|BlueprintCallable 
	// Function /Script/CommonConversationRuntime.ConversationParticipantComponent.GetParticipantActor
	// class AActor* GetParticipantActor(FGameplayTag& ParticipantTag);                                                         // [0x80eb954] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CommonConversationRuntime.ConversationParticipantComponent.ClientUpdateParticipants
	// void ClientUpdateParticipants(FConversationParticipants InParticipants);                                                 // [0x80e7c24] Net|NetReliableNative|Event|Protected|NetClient 
	// Function /Script/CommonConversationRuntime.ConversationParticipantComponent.ClientUpdateConversationTaskChoiceData
	// void ClientUpdateConversationTaskChoiceData(FConversationNodeHandle Handle, FClientConversationOptionEntry OptionEntry); // [0x80e7ab0] Net|NetReliableNative|Event|Protected|NetClient 
	// Function /Script/CommonConversationRuntime.ConversationParticipantComponent.ClientUpdateConversations
	// void ClientUpdateConversations(int32_t InConversationsActive);                                                           // [0x80e7ba0] Net|NetReliableNative|Event|Protected|NetClient 
	// Function /Script/CommonConversationRuntime.ConversationParticipantComponent.ClientUpdateConversation
	// void ClientUpdateConversation(FClientConversationMessagePayload Message);                                                // [0x80e7a14] Net|NetReliableNative|Event|Protected|NetClient 
	// Function /Script/CommonConversationRuntime.ConversationParticipantComponent.ClientStartConversation
	// void ClientStartConversation(FConversationParticipants InParticipants);                                                  // [0x80e7980] Net|NetReliableNative|Event|Protected|NetClient 
	// Function /Script/CommonConversationRuntime.ConversationParticipantComponent.ClientExitConversation
	// void ClientExitConversation(FConversationParticipants InParticipants);                                                   // [0x80e78ec] Net|NetReliableNative|Event|Protected|NetClient 
	// Function /Script/CommonConversationRuntime.ConversationParticipantComponent.ClientExecuteTaskAndSideEffects
	// void ClientExecuteTaskAndSideEffects(FConversationNodeHandle Handle, class UConversationDatabase* Graph);                // [0x80e7810] Net|NetReliableNative|Event|Protected|NetClient 
};
...
public:
	...
	// EConversationRequirementResult IsRequirementSatisfied(FConversationContext& Context);                                    // [0x80eba8c] Native|Event|Public|HasOutParms|BlueprintEvent|Const 
};
...
public:
	...
	// void ServerCauseSideEffect(FConversationContext& Context);                                                               // [0x80e7cb8] BlueprintAuthorityOnly|Native|Event|Protected|HasOutParms|BlueprintEvent|Const 
	// Function /Script/CommonConversationRuntime.ConversationSideEffectNode.ClientCauseSideEffect
	// void ClientCauseSideEffect(FConversationContext& Context);                                                               // [0x80e7120] BlueprintCosmetic|Native|Event|Protected|HasOutParms|BlueprintEvent|Const 
};
