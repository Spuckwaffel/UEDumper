...
public:
	...
	// void GetBallisticShieldData(EBallisticShieldPlayerActionState& BallisticShieldPlayerState, float& StaggerBuildupPercent); // [0xb4a89d4] Native|Event|Public|HasOutParms|BlueprintEvent 
};
