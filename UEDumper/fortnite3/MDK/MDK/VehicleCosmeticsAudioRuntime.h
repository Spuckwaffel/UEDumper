...
public:
	CMember(TWeakObjectPtr<UVehicleAudioCosmeticData*>) CachedEngineAudioItem                                      OFFSET(get<T>, {0x330, 32, 0, 0})


	/// Functions
	// Function /Script/VehicleCosmeticsAudioRuntime.VehicleCosmeticsAudioController.UpdateAudioData
	// void UpdateAudioData(class UVehicleAudioCosmeticData* CosmeticData);                                                     // [0xb3b2348] Final|Native|Public|BlueprintCallable 
	// Function /Script/VehicleCosmeticsAudioRuntime.VehicleCosmeticsAudioController.HandleEngineAudioItemUpdated
	// void HandleEngineAudioItemUpdated(TWeakObjectPtr<UVehicleCosmeticsItemDefinition_EngineAudio*> EngineAudioItem);         // [0x2b1afc4] Final|Native|Public  
	// Function /Script/VehicleCosmeticsAudioRuntime.VehicleCosmeticsAudioController.HandleEngineAudioCosmeticsFailed
	// void HandleEngineAudioCosmeticsFailed(FVehicleCosmeticsFailureInfo ReasonInfo);                                          // [0xb3b2230] Final|Native|Public  
	// Function /Script/VehicleCosmeticsAudioRuntime.VehicleCosmeticsAudioController.BP_OnUpdateAudioData
	// void BP_OnUpdateAudioData(class UVehicleAudioCosmeticData* CosmeticData);                                                // [0x1340978] Event|Public|BlueprintEvent 
	// Function /Script/VehicleCosmeticsAudioRuntime.VehicleCosmeticsAudioController.BP_OnCosmeticsFailed
	// void BP_OnCosmeticsFailed(FVehicleCosmeticsFailureInfo ReasonInfo);                                                      // [0x1340978] Event|Public|BlueprintEvent 
	// Function /Script/VehicleCosmeticsAudioRuntime.VehicleCosmeticsAudioController.BP_OnAudioDataLoaded
	// void BP_OnAudioDataLoaded(class USoundBase* sound);                                                                      // [0x1340978] Event|Public|BlueprintEvent 
	// Function /Script/VehicleCosmeticsAudioRuntime.VehicleCosmeticsAudioController.BP_OnAudioDataEjected
	// void BP_OnAudioDataEjected();                                                                                            // [0x1340978] Event|Public|BlueprintEvent 
};
...
public:
	...
	// void UnregisterVehcle(TScriptInterface<Class> Vehicle);                                                                  // [0x1ec6c54] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/VehicleCosmeticsAudioRuntime.VehicleCosmeticsAudioManager.SetVehicleBudgetOverride
	// void SetVehicleBudgetOverride(int32_t NewBudget);                                                                        // [0xb3b22cc] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/VehicleCosmeticsAudioRuntime.VehicleCosmeticsAudioManager.RemoveVehicleBudgetOverride
	// void RemoveVehicleBudgetOverride();                                                                                      // [0xb3b22b0] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/VehicleCosmeticsAudioRuntime.VehicleCosmeticsAudioManager.RegisterVehicleWithAsset
	// void RegisterVehicleWithAsset(FVehicleCosmeticLoadRequestInfo& RequestInfo);                                             // [0x1b560d8] Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable 
};
