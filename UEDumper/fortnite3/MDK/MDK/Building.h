...
public:
	...
	// void ExecuteUbergraph_PBWA_S1_Solid(int32_t EntryPoint);                                                                 // [0x1340978] Final|HasDefaults    
};
...
public:
	...
	// void OnRep_Random Chance();                                                                                              // [0x1340978] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_PBW_BP_Parent(int32_t EntryPoint);                                                                 // [0x1340978] Final                
};
...
public:
	...
	// void On Free Resources(class UCreativeIslandResourceManagerComponent* Resource Manager);                                 // [0x1340978] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Building/ActorBlueprints/Containers/Creative_Tiered_Chest.Creative_Tiered_Chest_C.On Request Resources
	// void On Request Resources(class UCreativeIslandResourceManagerComponent* Resource Manager);                              // [0x1340978] Public|BlueprintCallable|BlueprintEvent 
	...
	// void OnSetCustomDepthStencilValue(TArray<UPrimitiveComponent*>& PrimComponents, bool bUseCustomDepth, int32_t StencilValue, bool& bOutConsume); // [0x1340978] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void GetMaxAudibleDistance(double& Max Distance);                                                                        // [0x1340978] Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure 
	// Function /Game/Building/ActorBlueprints/Containers/Creative_Tiered_Chest.Creative_Tiered_Chest_C.CleanupWiggleMIDs
	// void CleanupWiggleMIDs();                                                                                                // [0x1340978] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Building/ActorBlueprints/Containers/Creative_Tiered_Chest.Creative_Tiered_Chest_C.CreateMobileMIDs
	// void CreateMobileMIDs();                                                                                                 // [0x1340978] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Building/ActorBlueprints/Containers/Creative_Tiered_Chest.Creative_Tiered_Chest_C.ShouldDie
	// bool ShouldDie(float Damage, class AController* EventInstigator, class AActor* DamageCauser, bool bIsTest, FGameplayEffectContextHandle& EffectContext); // [0x1340978] BlueprintAuthorityOnly|Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /Game/Building/ActorBlueprints/Containers/Creative_Tiered_Chest.Creative_Tiered_Chest_C.BlueprintCanInteract
	// bool BlueprintCanInteract(class AFortPawn* InteractingPawn, TEnumAsByte<EInteractionBeingAttempted> InteractionBeingAttempted, TEnumAsByte<TInteractionType> InteractionType); // [0x1340978] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /Game/Building/ActorBlueprints/Containers/Creative_Tiered_Chest.Creative_Tiered_Chest_C.SetLightVisibility
	// void SetLightVisibility(bool Visible);                                                                                   // [0x1340978] Public|BlueprintCallable|BlueprintEvent 
	...
	// void MobileOnInteractTL__FinishedFunc();                                                                                 // [0x1340978] BlueprintEvent       
	...
	// void MobileOnInteractTL__UpdateFunc();                                                                                   // [0x1340978] BlueprintEvent       
	...
	// void OnLoot();                                                                                                           // [0x1340978] Event|Public|BlueprintEvent 
	...
	// void OnBeginSearch();                                                                                                    // [0x1340978] Event|Public|BlueprintEvent 
	...
	// void BndEvt__CreativeIslandResource_K2Node_ComponentBoundEvent_0_RequestResourcesSignature__DelegateSignature(class UCreativeIslandResourceManagerComponent* ResourceManager); // [0x1340978] BlueprintEvent       
	...
	// void BndEvt__CreativeIslandResource_K2Node_ComponentBoundEvent_1_FreeResourcesSignature__DelegateSignature(class UCreativeIslandResourceManagerComponent* ResourceManager); // [0x1340978] BlueprintEvent       
	...
	// void ExecuteUbergraph_Creative_Tiered_Chest(int32_t EntryPoint);                                                         // [0x1340978] Final|HasDefaults    
};
