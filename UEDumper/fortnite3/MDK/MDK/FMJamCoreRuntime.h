...
public:
	...
	// bool ShouldRunServerCode(class AActor* Context);                                                                         // [0xb5a25ec] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/FMJamCoreRuntime.JamCoreBPFL.ShouldRunClientCode
	// bool ShouldRunClientCode(class AActor* Context);                                                                         // [0xb5a2488] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
};
