...
public:
	...
	// void OnIsCraftableItemChanged(bool bIsCraftableItem);                                                                    // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/CraftingUI.AthenaCraftingQuickBarButton.OnCanCraftNowChanged
	// void OnCanCraftNowChanged(bool bCanCraftNow);                                                                            // [0x1340978] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void HandleWeaponEquipped(class AFortWeapon* NewWeapon, class AFortWeapon* PrevWeapon);                                  // [0xb58e200] Final|Native|Private 
	// Function /Script/CraftingUI.AthenaEquippedItemCraftingIndicator.HandleInventoryActiveChanged
	// void HandleInventoryActiveChanged(bool bInventoryActive);                                                                // [0xb58e008] Final|Native|Private 
};
...
public:
	...
	// void HandleInventoryItemSelected(class UFortItem* SelectedItem);                                                         // [0xb58e100] Final|Native|Private 
};
...
public:
	...
	// void OnIngredientChanged(bool bCanCraftNow);                                                                             // [0x1340978] Event|Protected|BlueprintEvent 
	...
	// void HandleWeaponEquipped(class AFortWeapon* NewWeapon, class AFortWeapon* PrevWeapon);                                  // [0xb58e2c4] Final|Native|Private 
	// Function /Script/CraftingUI.AthenaQuickBarSlotCraftingIndicator.HandleInventoryActiveChanged
	// void HandleInventoryActiveChanged(bool bInventoryActive);                                                                // [0xb58e084] Final|Native|Private 
};
...
public:
	...
	// void OnIngredientWidgetUpdated(int32_t NumAvailable, int32_t NumRequired, bool bIsPrimaryIngredient, bool bIsLastIngredient); // [0x1340978] Event|Protected|BlueprintEvent 
};
...
public:
	CMember(class UAthenaItemIcon*)                    ItemIcon                                                    OFFSET(get<T>, {0x14D8, 8, 0, 0})
	DMember(bool)                                      bCanCraftItem                                               OFFSET(get<bool>, {0x14E0, 1, 0, 0})


	/// Functions
	// Function /Script/CraftingUI.FortCraftingListEntry.OnCraftingListItemSet
	// void OnCraftingListItemSet();                                                                                            // [0x1340978] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void OnFormulaListUpdated(int32_t NumFormulas);                                                                          // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/CraftingUI.FortCraftingTab.HandleInventoryItemSelected
	// void HandleInventoryItemSelected(class UFortItem* Item);                                                                 // [0xb58e180] Final|Native|Private 
};
...
public:
	...
	// void SetOwningCraftingObject(class ACraftingObjectBGA* InCraftingObject);                                                // [0xb58e380] Final|Native|Public|BlueprintCallable 
};
...
public:
	CMember(class UCommonLazyImage*)                   Image_Item                                                  OFFSET(get<T>, {0x14D8, 8, 0, 0})
};
