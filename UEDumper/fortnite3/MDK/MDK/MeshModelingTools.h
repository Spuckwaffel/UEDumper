...
public:
	...
	CMember(class UProceduralShapeToolProperties*)     ShapeSettings                                               OFFSET(get<T>, {0xC0, 8, 0, 0})
	CMember(class UNewMeshMaterialProperties*)         MaterialProperties                                          OFFSET(get<T>, {0xC8, 8, 0, 0})
	CMember(class UPreviewMesh*)                       PreviewMesh                                                 OFFSET(get<T>, {0xD0, 8, 0, 0})
	CMember(class UCombinedTransformGizmo*)            Gizmo                                                       OFFSET(get<T>, {0xD8, 8, 0, 0})
	CMember(class UDragAlignmentMechanic*)             DragAlignmentMechanic                                       OFFSET(get<T>, {0xE0, 8, 0, 0})
	SMember(FString)                                   AssetName                                                   OFFSET(getStruct<T>, {0xE8, 16, 0, 0})
};
...
public:
	CMember(class UCombineMeshesToolProperties*)       BasicProperties                                             OFFSET(get<T>, {0xC0, 8, 0, 0})
	CMember(class UCreateMeshObjectTypeProperties*)    OutputTypeProperties                                        OFFSET(get<T>, {0xC8, 8, 0, 0})
	CMember(class UOnAcceptHandleSourcesPropertiesBase*) HandleSourceProperties                                    OFFSET(get<T>, {0xD0, 8, 0, 0})
};
...
public:
	CMember(class UCSGMeshesToolProperties*)           CSGProperties                                               OFFSET(get<T>, {0x108, 8, 0, 0})
	CMember(class UTrimMeshesToolProperties*)          TrimProperties                                              OFFSET(get<T>, {0x110, 8, 0, 0})
	CMember(TArray<class UPreviewMesh*>)               OriginalMeshPreviews                                        OFFSET(get<T>, {0x128, 16, 0, 0})
	CMember(class UMaterialInstanceDynamic*)           PreviewsGhostMaterial                                       OFFSET(get<T>, {0x138, 8, 0, 0})
...
public:
	CMember(class UCutMeshWithMeshToolProperties*)     CutProperties                                               OFFSET(get<T>, {0x108, 8, 0, 0})
	CMember(class UPreviewMesh*)                       IntersectPreviewMesh                                        OFFSET(get<T>, {0x110, 8, 0, 0})
	CMember(class ULineSetComponent*)                  DrawnLineSet                                                OFFSET(get<T>, {0x138, 8, 0, 0})
};
...
public:
	CMember(class UCurveControlPointsMechanic*)        ControlPointsMechanic                                       OFFSET(get<T>, {0x128, 8, 0, 0})
	CMember(class UConstructionPlaneMechanic*)         PlaneMechanic                                               OFFSET(get<T>, {0x130, 8, 0, 0})
	CMember(class UCreateMeshObjectTypeProperties*)    OutputTypeProperties                                        OFFSET(get<T>, {0x138, 8, 0, 0})
	CMember(class URevolveToolProperties*)             Settings                                                    OFFSET(get<T>, {0x140, 8, 0, 0})
	CMember(class UNewMeshMaterialProperties*)         MaterialProperties                                          OFFSET(get<T>, {0x148, 8, 0, 0})
	CMember(class UMeshOpPreviewWithBackgroundCompute*) Preview                                                    OFFSET(get<T>, {0x150, 8, 0, 0})
};
...
public:
	...
	CMember(class UDrawPolygonToolStandardProperties*) PolygonProperties                                           OFFSET(get<T>, {0xA8, 8, 0, 0})
	CMember(class UDrawPolygonToolSnapProperties*)     SnapProperties                                              OFFSET(get<T>, {0xB0, 8, 0, 0})
	CMember(class UNewMeshMaterialProperties*)         MaterialProperties                                          OFFSET(get<T>, {0xB8, 8, 0, 0})
	CMember(class UPreviewMesh*)                       PreviewMesh                                                 OFFSET(get<T>, {0x150, 8, 0, 0})
	CMember(class UPlaneDistanceFromHitMechanic*)      HeightMechanic                                              OFFSET(get<T>, {0x528, 8, 0, 0})
	CMember(class UDragAlignmentMechanic*)             DragAlignmentMechanic                                       OFFSET(get<T>, {0x530, 8, 0, 0})
	CMember(class UConstructionPlaneMechanic*)         PlaneMechanic                                               OFFSET(get<T>, {0x538, 8, 0, 0})
};
...
public:
	...
	// void RegenerateExtraCorners();                                                                                           // [0xc22d814] Final|Native|Public  
};
...
public:
	...
	// void Poke();                                                                                                             // [0xc22d7cc] Final|Native|Public  
...
public:
	...
	// void PlanarProjection();                                                                                                 // [0xc22d7b4] Final|Native|Public  
};
...
public:
	...
	// void Collapse();                                                                                                         // [0xc22d5e4] Final|Native|Public  
...
public:
	CMember(class UMeshOpPreviewWithBackgroundCompute*) Preview                                                    OFFSET(get<T>, {0x140, 8, 0, 0})
	CMember(class UPolyEditCommonProperties*)          CommonProps                                                 OFFSET(get<T>, {0x148, 8, 0, 0})
	CMember(class UEditMeshPolygonsToolActions*)       EditActions                                                 OFFSET(get<T>, {0x150, 8, 0, 0})
	CMember(class UEditMeshPolygonsToolActions_Triangles*) EditActions_Triangles                                   OFFSET(get<T>, {0x158, 8, 0, 0})
	CMember(class UEditMeshPolygonsToolEdgeActions*)   EditEdgeActions                                             OFFSET(get<T>, {0x160, 8, 0, 0})
	CMember(class UEditMeshPolygonsToolEdgeActions_Triangles*) EditEdgeActions_Triangles                           OFFSET(get<T>, {0x168, 8, 0, 0})
	CMember(class UEditMeshPolygonsToolUVActions*)     EditUVActions                                               OFFSET(get<T>, {0x170, 8, 0, 0})
	CMember(class UPolyEditTopologyProperties*)        TopologyProperties                                          OFFSET(get<T>, {0x178, 8, 0, 0})
	CMember(class UPolyEditExtrudeActivity*)           ExtrudeActivity                                             OFFSET(get<T>, {0x180, 8, 0, 0})
	CMember(class UPolyEditInsetOutsetActivity*)       InsetOutsetActivity                                         OFFSET(get<T>, {0x188, 8, 0, 0})
	CMember(class UPolyEditCutFacesActivity*)          CutFacesActivity                                            OFFSET(get<T>, {0x190, 8, 0, 0})
	CMember(class UPolyEditPlanarProjectionUVActivity*) PlanarProjectionUVActivity                                 OFFSET(get<T>, {0x198, 8, 0, 0})
	CMember(class UPolyEditInsertEdgeActivity*)        InsertEdgeActivity                                          OFFSET(get<T>, {0x1A0, 8, 0, 0})
	CMember(class UPolyEditInsertEdgeLoopActivity*)    InsertEdgeLoopActivity                                      OFFSET(get<T>, {0x1A8, 8, 0, 0})
	CMember(class UPolyEditBevelEdgeActivity*)         BevelEdgeActivity                                           OFFSET(get<T>, {0x1B0, 8, 0, 0})
	CMember(class UPolyEditExtrudeEdgeActivity*)       ExtrudeEdgeActivity                                         OFFSET(get<T>, {0x1B8, 8, 0, 0})
	CMember(class UPolyEditActivityContext*)           ActivityContext                                             OFFSET(get<T>, {0x298, 8, 0, 0})
	CMember(class UPolygonSelectionMechanic*)          SelectionMechanic                                           OFFSET(get<T>, {0x2A0, 8, 0, 0})
	CMember(class UDragAlignmentMechanic*)             DragAlignmentMechanic                                       OFFSET(get<T>, {0x2A8, 8, 0, 0})
	CMember(class UCombinedTransformGizmo*)            TransformGizmo                                              OFFSET(get<T>, {0x2B0, 8, 0, 0})
	CMember(class UTransformProxy*)                    TransformProxy                                              OFFSET(get<T>, {0x2B8, 8, 0, 0})
};
...
public:
	...
	// TArray<FString> GetUVChannelNamesFunc();                                                                                 // [0xc22d708] Final|Native|Public|Const 
};
...
public:
	CMember(class UMeshUVChannelProperties*)           UVChannelProperties                                         OFFSET(get<T>, {0xB8, 8, 0, 0})
	CMember(class URecomputeUVsToolProperties*)        Settings                                                    OFFSET(get<T>, {0xC0, 8, 0, 0})
	CMember(class UPolygroupLayersProperties*)         PolygroupLayerProperties                                    OFFSET(get<T>, {0xC8, 8, 0, 0})
	CMember(class UExistingMeshMaterialProperties*)    MaterialSettings                                            OFFSET(get<T>, {0xD0, 8, 0, 0})
	DMember(bool)                                      bCreateUVLayoutViewOnSetup                                  OFFSET(get<bool>, {0xD8, 1, 0, 0})
	CMember(class UUVLayoutPreview*)                   UVLayoutView                                                OFFSET(get<T>, {0xE0, 8, 0, 0})
	CMember(class URecomputeUVsOpFactory*)             RecomputeUVsOpFactory                                       OFFSET(get<T>, {0xE8, 8, 0, 0})
...
public:
	...
	CMember(class UUVLayoutProperties*)                BasicProperties                                             OFFSET(get<T>, {0xC8, 8, 0, 0})
	CMember(class UExistingMeshMaterialProperties*)    MaterialSettings                                            OFFSET(get<T>, {0xD0, 8, 0, 0})
	CMember(TArray<class UMeshOpPreviewWithBackgroundCompute*>) Previews                                           OFFSET(get<T>, {0xD8, 16, 0, 0})
	CMember(TArray<class UUVLayoutOperatorFactory*>)   Factories                                                   OFFSET(get<T>, {0xE8, 16, 0, 0})
...
public:
	CMember(class UMeshUVChannelProperties*)           UVChannelProperties                                         OFFSET(get<T>, {0x120, 8, 0, 0})
	CMember(class UUVProjectionToolProperties*)        BasicProperties                                             OFFSET(get<T>, {0x128, 8, 0, 0})
	CMember(class UUVProjectionToolEditActions*)       EditActions                                                 OFFSET(get<T>, {0x130, 8, 0, 0})
	CMember(class UExistingMeshMaterialProperties*)    MaterialSettings                                            OFFSET(get<T>, {0x138, 8, 0, 0})
	CMember(class UMeshOpPreviewWithBackgroundCompute*) Preview                                                    OFFSET(get<T>, {0x140, 8, 0, 0})
	CMember(class UMaterialInstanceDynamic*)           CheckerMaterial                                             OFFSET(get<T>, {0x148, 8, 0, 0})
	CMember(class UCombinedTransformGizmo*)            TransformGizmo                                              OFFSET(get<T>, {0x150, 8, 0, 0})
	CMember(class UTransformProxy*)                    TransformProxy                                              OFFSET(get<T>, {0x158, 8, 0, 0})
	CMember(class UUVProjectionOperatorFactory*)       OperatorFactory                                             OFFSET(get<T>, {0x160, 8, 0, 0})
	CMember(class UPreviewGeometry*)                   EdgeRenderer                                                OFFSET(get<T>, {0x168, 8, 0, 0})
	CMember(class USingleClickInputBehavior*)          ClickToSetPlaneBehavior                                     OFFSET(get<T>, {0x4B8, 8, 0, 0})
};
