...
public:
	SMember(FScalableFloat)                            MaxApproaches                                               OFFSET(getStruct<T>, {0x1D0, 40, 0, 0})
	SMember(FFortNearbyActorsPerceptionConfiguration)  PerceptionConfiguration                                     OFFSET(getStruct<T>, {0x200, 208, 0, 0})
	SMember(FName)                                     EnableKeyName                                               OFFSET(getStruct<T>, {0x2D0, 4, 0, 0})
};
...
public:
	CMember(class UClass*)                             ProjectionNavigationQueryFilterClass                        OFFSET(get<T>, {0x1F8, 8, 0, 0})
	CMember(class UClass*)                             ValidNavigationQueryFilterClassOverride                     OFFSET(get<T>, {0x200, 8, 0, 0})
	SMember(FScalableFloat)                            MaximumTimeToHelpFromLastPlayerDamage                       OFFSET(getStruct<T>, {0x208, 40, 0, 0})
	SMember(FScalableFloat)                            KeepTargetTimeOnWeaponTrigger                               OFFSET(getStruct<T>, {0x230, 40, 0, 0})
	SMember(FScalableFloat)                            AmountOfTimesPlayerBuiltStructuresNeedToBeDamaged           OFFSET(getStruct<T>, {0x258, 40, 0, 0})
	SMember(FScalableFloat)                            TimeToTrackDamagedActors                                    OFFSET(getStruct<T>, {0x280, 40, 0, 0})
	SMember(FScalableFloat)                            MaxDistanceFromActorForFallbackNoHarvestBehaviour           OFFSET(getStruct<T>, {0x2A8, 40, 0, 0})
	CMember(TArray<class UClass*>)                     GEsToApplyOnFallbackBehaviorTrigger                         OFFSET(get<T>, {0x2D0, 16, 0, 0})
	CMember(TArray<class UClass*>)                     GEsToApplyOnCannotDamageBehaviorTrigger                     OFFSET(get<T>, {0x2E0, 16, 0, 0})
	SMember(FName)                                     HarvestTargetKeyName                                        OFFSET(getStruct<T>, {0x2F0, 4, 0, 0})
	SMember(FName)                                     HarvestTargetHitPointKeyName                                OFFSET(getStruct<T>, {0x2F8, 4, 0, 0})
	SMember(FName)                                     HarvestDestinationKeyName                                   OFFSET(getStruct<T>, {0x300, 4, 0, 0})
	SMember(FName)                                     FallbackBehaviorKeyName                                     OFFSET(getStruct<T>, {0x308, 4, 0, 0})
	SMember(FName)                                     CannotDamageKeyName                                         OFFSET(getStruct<T>, {0x310, 4, 0, 0})
	SMember(FName)                                     WeaponTriggerMeleeKeyName                                   OFFSET(getStruct<T>, {0x318, 4, 0, 0})


	/// Functions
	// Function /Script/FortniteAIServer.FortAthenaAIBotEvaluator_Harvest.HandleUnconverted
	// void HandleUnconverted(class AFortPawn* UnconvertedPawn, EUnconvertReason UnconvertReason);                              // [0xa6bd74c] Final|Native|Protected 
	// Function /Script/FortniteAIServer.FortAthenaAIBotEvaluator_Harvest.HandleConverted
	// void HandleConverted(class AFortPawn* InstigatorPawn, class AFortPawn* ConvertedPawn);                                   // [0xa6bd68c] Final|Native|Protected 
};
...
public:
	SMember(FScalableFloat)                            MaxSecondsToReactToBump                                     OFFSET(getStruct<T>, {0x220, 40, 0, 0})
	SMember(FScalableFloat)                            MaxSecondsToReactToBox                                      OFFSET(getStruct<T>, {0x248, 40, 0, 0})
	SMember(FScalableFloat)                            MinSecondsBetweenInstantReactions                           OFFSET(getStruct<T>, {0x270, 40, 0, 0})
	CMember(class UEnvQuery*)                          FindAwayLocationFromPawnQueryTemplate                       OFFSET(get<T>, {0x298, 8, 0, 0})
	CMember(TEnumAsByte<EEnvQueryRunMode>)             FindAwayLocationFromPawnRunMode                             OFFSET(get<T>, {0x2A0, 1, 0, 0})
	CMember(class UEnvQuery*)                          FindAwayLocationFromBoxQueryTemplate                        OFFSET(get<T>, {0x2A8, 8, 0, 0})
	CMember(TEnumAsByte<EEnvQueryRunMode>)             FindAwayLocationFromBoxRunMode                              OFFSET(get<T>, {0x2B0, 1, 0, 0})
};
...
public:
	CMember(class UFortAthenaAIRuntimeParameters_SmartObjectBase*) SmartObjectRuntimeParameters                    OFFSET(get<T>, {0x1B0, 8, 0, 0})
	CMember(class USmartObjectSubsystem*)              SmartObjectSubsystem                                        OFFSET(get<T>, {0x1B8, 8, 0, 0})
	SMember(FFortAIActiveCommandSOUsageData)           RunningCommandData                                          OFFSET(getStruct<T>, {0x1C8, 16, 0, 0})
	SMember(FBotEvaluatorCommandCooldown)              CommandOnCooldown                                           OFFSET(getStruct<T>, {0x1D8, 24, 0, 0})
	SMember(FGameplayTag)                              EvaluationTag                                               OFFSET(getStruct<T>, {0x1F0, 4, 0, 0})
	DMember(bool)                                      bEvaluateSOValidityAfterChosen                              OFFSET(get<bool>, {0x1F4, 1, 0, 0})
	DMember(bool)                                      bEnableEntryLocationsSupport                                OFFSET(get<bool>, {0x1F5, 1, 0, 0})
	SMember(FScalableFloat)                            SingleCommandCooldown                                       OFFSET(getStruct<T>, {0x1F8, 40, 0, 0})
	CMember(class UClass*)                             OverridenFilterClassForEntryPoints                          OFFSET(get<T>, {0x220, 8, 0, 0})
	SMember(FName)                                     SmartObjectExecutionStatusKeyName                           OFFSET(getStruct<T>, {0x228, 4, 0, 0})
	SMember(FName)                                     SmartObjectMovementStateKeyName                             OFFSET(getStruct<T>, {0x22C, 4, 0, 0})
	SMember(FName)                                     SmartObjectDestinationKeyName                               OFFSET(getStruct<T>, {0x230, 4, 0, 0})
	SMember(FName)                                     SmartObjectDestinationRotationKeyName                       OFFSET(getStruct<T>, {0x234, 4, 0, 0})
	SMember(FName)                                     SmartObjectShouldMoveKeyName                                OFFSET(getStruct<T>, {0x238, 4, 0, 0})
	SMember(FName)                                     SmartObjectUrgencyKeyName                                   OFFSET(getStruct<T>, {0x23C, 4, 0, 0})
};
...
public:
	CMember(class UFortAthenaAIRuntimeParameters_SmartObjectBase*) SmartObjectRuntimeParameters                    OFFSET(get<T>, {0x1B0, 8, 0, 0})
	CMember(class USmartObjectSubsystem*)              SmartObjectSubsystem                                        OFFSET(get<T>, {0x1B8, 8, 0, 0})
	SMember(FBotEvaluatorSmartObjectConvertedData)     RunningData                                                 OFFSET(getStruct<T>, {0x1C8, 8, 0, 0})
	SMember(FGameplayTag)                              EvaluationTag                                               OFFSET(getStruct<T>, {0x1D0, 4, 0, 0})
	DMember(bool)                                      bEvaluateSOValidityAfterChosen                              OFFSET(get<bool>, {0x1D4, 1, 0, 0})
	DMember(bool)                                      bEnableEntryLocationsSupport                                OFFSET(get<bool>, {0x1D5, 1, 0, 0})
	DMember(bool)                                      bIgnoreCooldowns                                            OFFSET(get<bool>, {0x1D6, 1, 0, 0})
	CMember(class UClass*)                             OverridenFilterClassForEntryPoints                          OFFSET(get<T>, {0x1D8, 8, 0, 0})
	SMember(FName)                                     SmartObjectExecutionStatusKeyName                           OFFSET(getStruct<T>, {0x1E0, 4, 0, 0})
	SMember(FName)                                     SmartObjectMovementStateKeyName                             OFFSET(getStruct<T>, {0x1E4, 4, 0, 0})
	SMember(FName)                                     SmartObjectDestinationKeyName                               OFFSET(getStruct<T>, {0x1E8, 4, 0, 0})
	SMember(FName)                                     SmartObjectDestinationRotationKeyName                       OFFSET(getStruct<T>, {0x1EC, 4, 0, 0})
	SMember(FName)                                     SmartObjectShouldMoveKeyName                                OFFSET(getStruct<T>, {0x1F0, 4, 0, 0})
	SMember(FName)                                     SmartObjectUrgencyKeyName                                   OFFSET(getStruct<T>, {0x1F4, 4, 0, 0})
};
...
public:
	SMember(FName)                                     WeaponKeyName                                               OFFSET(getStruct<T>, {0x1B4, 4, 0, 0})
	SMember(FName)                                     MoveToDestinationKeyName                                    OFFSET(getStruct<T>, {0x1B8, 4, 0, 0})
	SMember(FName)                                     TargetActorName                                             OFFSET(getStruct<T>, {0x1BC, 4, 0, 0})
};

/// Class /Script/FortniteAIServer.FortAthenaAIBotEvaluator_TokenPosition
/// Size: 0x0088 (0x0001C8 - 0x000250)
...
public:
	CMember(TArray<FPositioningEQS>)                   EQSs                                                        OFFSET(get<T>, {0x1D8, 16, 0, 0})
	DMember(float)                                     TokenPositionCooldown                                       OFFSET(get<float>, {0x1E8, 4, 0, 0})
	DMember(float)                                     TokenPositionCooldownVariation                              OFFSET(get<float>, {0x1EC, 4, 0, 0})
	SMember(FFortBehaviorValue_Float)                  NewTokenPositionCooldown                                    OFFSET(getStruct<T>, {0x1F0, 12, 0, 0})
	SMember(FFortBehaviorValue_Float)                  NewTokenPositionCooldownVariation                           OFFSET(getStruct<T>, {0x1FC, 12, 0, 0})
	CMember(class UFortAICombatTokenConsumerComponent*) CachedTokenConsumerComponent                               OFFSET(get<T>, {0x238, 8, 0, 0})
	CMember(TWeakObjectPtr<UFortAICombatTokenProviderComponent*>) CachedTokenProviderComponent                     OFFSET(get<T>, {0x240, 8, 0, 0})
	DMember(int32_t)                                   RunningEQSRequestID                                         OFFSET(get<int32_t>, {0x248, 4, 0, 0})
	DMember(bool)                                      bPositionRequested                                          OFFSET(get<bool>, {0x24C, 1, 0, 0})
	DMember(bool)                                      bPositionAcquiredInEnter                                    OFFSET(get<bool>, {0x24D, 1, 0, 0})
};
...
public:
	...
	// void HandleTimeOfDayPhaseChange(EFortDayPhase CurrentDayPhase, EFortDayPhase PreviousDayPhase, bool bAtCreation);        // [0xa6c45fc] Final|Native|Private 
};
...
public:
	...
	// void SetQueryTemplate(class UEnvQuery* InPrevisQueryTemplate);                                                           // [0x64c3a10] Final|Native|Public|BlueprintCallable 
	// Function /Script/FortniteAIServer.FortEQSPrevisActor.PrepForPrevis
	// void PrepForPrevis();                                                                                                    // [0x1340978] Event|Public|BlueprintEvent 
};
...
public:
	SMember(FName)                                     LastKnownPositionName                                       OFFSET(getStruct<T>, {0x1B0, 4, 0, 0})
	SMember(FName)                                     DestinationKeyName                                          OFFSET(getStruct<T>, {0x1B4, 4, 0, 0})
	SMember(FName)                                     MoveToDestinationKeyName                                    OFFSET(getStruct<T>, {0x1B8, 4, 0, 0})
	SMember(FName)                                     AggressivenessName                                          OFFSET(getStruct<T>, {0x1BC, 4, 0, 0})


	/// Functions
	// Function /Script/FortniteAIServer.FortAthenaAIBotEvaluator_Ambush.OnAssignedPerksChangedEvent
	// void OnAssignedPerksChangedEvent();                                                                                      // [0xa724028] Final|Native|Private 
};
...
public:
	SMember(FName)                                     AvoidThreatKeyName                                          OFFSET(getStruct<T>, {0x1B0, 4, 0, 0})
	SMember(FName)                                     AvoidThreatMovementStateKeyName                             OFFSET(getStruct<T>, {0x1B4, 4, 0, 0})
	SMember(FName)                                     AvoidThreatDestinationKeyName                               OFFSET(getStruct<T>, {0x1B8, 4, 0, 0})
	CMember(class AActor*)                             CurrentThreatActorAvoiding                                  OFFSET(get<T>, {0x1C8, 8, 0, 0})
	CMember(class UFortAthenaAIBotEvasiveManeuversDigestedSkillSet*) CacheEMDigestedSkillSet                       OFFSET(get<T>, {0x1D0, 8, 0, 0})
};
...
public:
	SMember(FName)                                     BuildExecutionStatusKeyName                                 OFFSET(getStruct<T>, {0x1B0, 4, 0, 0})
	SMember(FName)                                     HealingStatusKeyName                                        OFFSET(getStruct<T>, {0x1B4, 4, 0, 0})
	SMember(FGameplayTagContainer)                     DangerTags                                                  OFFSET(getStruct<T>, {0x1B8, 32, 0, 0})


	/// Functions
	// Function /Script/FortniteAIServer.FortAthenaAIBotEvaluator_Bunker.OnAssignedPerksChangedEvent
	// void OnAssignedPerksChangedEvent();                                                                                      // [0xa72403c] Final|Native|Private 
};
...
public:
	...
	// void OnZiplineStateChanged(bool bIsZiplining, class AFortPlayerPawn* FortPlayerPawn);                                    // [0xa724158] Final|Native|Private 
	// Function /Script/FortniteAIServer.FortAthenaAIBotEvaluator_CharacterLaunched.OnCharacterLaunchChanged
	// void OnCharacterLaunchChanged(class UFortMovementComp_Character* MovementComponent, FVector& LaunchVelocity);            // [0xa724050] Final|Native|Private|HasOutParms|HasDefaults 
};
...
public:
	...
	// void OnPlayerPawnSpawned(class AAIController* Controller, class AFortPawn* Pawn);                                        // [0xa747ba0] Final|Native|Private 
};
...
public:
	SMember(FName)                                     ShouldMoveTowardsConverterName                              OFFSET(getStruct<T>, {0x1B0, 4, 0, 0})
	SMember(FName)                                     ShouldTeleportTowardsConverterName                          OFFSET(getStruct<T>, {0x1B4, 4, 0, 0})
	SMember(FName)                                     ConvertedAllowPatrolAroundName                              OFFSET(getStruct<T>, {0x1B8, 4, 0, 0})
	SMember(FName)                                     ConvertedAllowScanAroundWhenWaitingName                     OFFSET(getStruct<T>, {0x1BC, 4, 0, 0})
	SMember(FName)                                     ConvertedDestinationName                                    OFFSET(getStruct<T>, {0x1C0, 4, 0, 0})
	SMember(FName)                                     CrouchExecutionStatusName                                   OFFSET(getStruct<T>, {0x1C4, 4, 0, 0})
	SMember(FVector)                                   TeleportLocationProjectionExtent                            OFFSET(getStruct<T>, {0x1C8, 24, 0, 0})
	SMember(FVector)                                   MovingFromLosLocationProjectionExtent                       OFFSET(getStruct<T>, {0x1E0, 24, 0, 0})
	SMember(FScalableFloat)                            AmountOfTimesNonHostilePawnNeedsToBeDamagedForTargeting     OFFSET(getStruct<T>, {0x1F8, 40, 0, 0})
	SMember(FScalableFloat)                            TimeToTrackDamagedActors                                    OFFSET(getStruct<T>, {0x220, 40, 0, 0})
	SMember(FScalableFloat)                            NearbyPlayerDistanceForTeleportTowardsConverter             OFFSET(getStruct<T>, {0x248, 40, 0, 0})
	SMember(FScalableFloat)                            PlayerFOVForNearbyPlayersVisibility                         OFFSET(getStruct<T>, {0x270, 40, 0, 0})
	CMember(class UEnvQuery*)                          TeleportToConverterQueryTemplate                            OFFSET(get<T>, {0x298, 8, 0, 0})
	CMember(TEnumAsByte<EEnvQueryRunMode>)             TeleportToConverterRunMode                                  OFFSET(get<T>, {0x2A0, 1, 0, 0})
	CMember(TArray<FMimicConverterAbilityData>)        AbilitiesToMimic                                            OFFSET(get<T>, {0x2A8, 16, 0, 0})
	SMember(FGameplayTagQuery)                         RequiredTagQueryToTargetConverterDamagedPawn                OFFSET(getStruct<T>, {0x2B8, 72, 0, 0})
	CMember(class AFortPawn*)                          ConverterPawn                                               OFFSET(get<T>, {0x368, 8, 0, 0})
	CMember(class UFortAthenaAIRuntimeParameters_AIBotConvert*) CachedAIBotConvertParameters                       OFFSET(get<T>, {0x370, 8, 0, 0})


	/// Functions
	// Function /Script/FortniteAIServer.FortAthenaAIBotEvaluator_Converted.OnUnconvertedEvent
	// void OnUnconvertedEvent(class AFortPawn* UnconvertedPawn, EUnconvertReason UnconvertReason);                             // [0xa747c64] Final|Native|Protected 
	// Function /Script/FortniteAIServer.FortAthenaAIBotEvaluator_Converted.OnConvertedEvent
	// void OnConvertedEvent(class AFortPawn* InstigatorPawn, class AFortPawn* ConvertedPawn);                                  // [0xa747a1c] Final|Native|Protected 
};
...
public:
	SMember(FName)                                     DBNODestinationKeyName                                      OFFSET(getStruct<T>, {0x1B0, 4, 0, 0})
	DMember(bool)                                      bAllowReachSquadmates                                       OFFSET(get<bool>, {0x1B6, 1, 1, 0})
	DMember(bool)                                      bAllowReachSameFactionNPCs                                  OFFSET(get<bool>, {0x1B6, 1, 1, 1})
	CMember(TArray<class AFortPlayerPawnAthena*>)      AllyPawns                                                   OFFSET(get<T>, {0x1B8, 16, 0, 0})
	SMember(FVector)                                   CachedCurrentDestination                                    OFFSET(getStruct<T>, {0x1C8, 24, 0, 0})
	CMember(class UFortAthenaAIBotDBNODigestedSkillSet*) DBNOSkillSet                                              OFFSET(get<T>, {0x1E0, 8, 0, 0})
	CMember(class UFortAthenaAICoverComponent*)        CachedCoverComponent                                        OFFSET(get<T>, {0x1E8, 8, 0, 0})
	CMember(class UFortAthenaAIRuntimeParameters_DBNOBehavior*) DBNOBehaviorRuntimeParameters                      OFFSET(get<T>, {0x1F0, 8, 0, 0})


	/// Functions
	// Function /Script/FortniteAIServer.FortAthenaAIBotEvaluator_DBNO.OnAllyPawnDBNOStateChanged
	// void OnAllyPawnDBNOStateChanged(class AFortPawn* InPlayer, bool bInIsDBNO);                                              // [0xa747940] Final|Native|Private 
};
...
public:
	SMember(FGameplayTagContainer)                     EscapeTags                                                  OFFSET(getStruct<T>, {0x1B0, 32, 0, 0})
	DMember(float)                                     CooldownBetweenAggressivenessChanges                        OFFSET(get<float>, {0x1D0, 4, 0, 0})
	SMember(FName)                                     AggressivenessName                                          OFFSET(getStruct<T>, {0x1D4, 4, 0, 0})
};
...
public:
	...
	// void OnMoveCompleted(FAIRequestID RequestID, TEnumAsByte<EPathFollowingResult> MovementResult);                          // [0xa747adc] Final|Native|Public  
	// Function /Script/FortniteAIServer.FortAthenaAIBotEvaluator_EvasiveManeuvers.OnAssignedPerksChangedEvent
	// void OnAssignedPerksChangedEvent();                                                                                      // [0xa747a08] Final|Native|Private 
};
...
public:
	CMember(class AFortAIDirector*)                    CachedAIDirector                                            OFFSET(get<T>, {0x1B0, 8, 0, 0})
	CMember(class UFortAthenaAIBotRangeAttackDigestedSkillSet*) CachedRangeAttackDigestedSkillSet                  OFFSET(get<T>, {0x1B8, 8, 0, 0})
	SMember(FName)                                     FlankingExecutionStatusKeyName                              OFFSET(getStruct<T>, {0x1C0, 4, 0, 0})
	SMember(FName)                                     FlankingMovementStateKeyName                                OFFSET(getStruct<T>, {0x1C4, 4, 0, 0})
	SMember(FName)                                     FlankingDestinationKeyName                                  OFFSET(getStruct<T>, {0x1C8, 4, 0, 0})
	CMember(TArray<FFlankingLocationInfo>)             LocationsToEvaluate                                         OFFSET(get<T>, {0x1D8, 16, 0, 0})
	CMember(TArray<FFlankingLocationInfo>)             BestLocations                                               OFFSET(get<T>, {0x1E8, 16, 0, 0})
	CMember(TArray<TWeakObjectPtr<AActor*>>)           ActorsInArea                                                OFFSET(get<T>, {0x1F8, 16, 0, 0})
};
...
public:
	DMember(float)                                     MinDistanceFromTarget                                       OFFSET(get<float>, {0x1B0, 4, 0, 0})
	DMember(float)                                     MinValidDistanceForFleeLocation                             OFFSET(get<float>, {0x1B4, 4, 0, 0})
	DMember(float)                                     FleeDistance                                                OFFSET(get<float>, {0x1B8, 4, 0, 0})
	DMember(float)                                     MaxDistanceFromTargetWhenFleeing                            OFFSET(get<float>, {0x1BC, 4, 0, 0})
	DMember(float)                                     MinDistanceHysteresisWhenChangingTarget                     OFFSET(get<float>, {0x1C0, 4, 0, 0})
	SMember(FName)                                     FleeKeyName                                                 OFFSET(getStruct<T>, {0x1C4, 4, 0, 0})
	SMember(FName)                                     FleeMovementStateKeyName                                    OFFSET(getStruct<T>, {0x1C8, 4, 0, 0})
	SMember(FName)                                     FleeDestinationKeyName                                      OFFSET(getStruct<T>, {0x1CC, 4, 0, 0})
	SMember(FName)                                     FleeActorKeyName                                            OFFSET(getStruct<T>, {0x1D0, 4, 0, 0})
	CMember(class AActor*)                             CurrentActorFleeingFrom                                     OFFSET(get<T>, {0x1E0, 8, 0, 0})
};
...
public:
	...
	// void HandlePlayerHealthOrShieldChanged();                                                                                // [0xa74792c] Final|Native|Private 
};
...
public:
	SMember(FScalableFloat)                            AttackDurationBeforeEvade                                   OFFSET(getStruct<T>, {0x1B0, 40, 0, 0})
	SMember(FScalableFloat)                            MeleeAttackMaxDistToEvade                                   OFFSET(getStruct<T>, {0x1D8, 40, 0, 0})
	SMember(FScalableFloat)                            ClampEvadeDistanceEnable                                    OFFSET(getStruct<T>, {0x200, 40, 0, 0})
	SMember(FScalableFloat)                            MinDistanceToEvade                                          OFFSET(getStruct<T>, {0x228, 40, 0, 0})
	SMember(FScalableFloat)                            MaxDistanceToEvade                                          OFFSET(getStruct<T>, {0x250, 40, 0, 0})
	SMember(FName)                                     EvadeKeyName                                                OFFSET(getStruct<T>, {0x278, 4, 0, 0})
	SMember(FName)                                     EvadeMovementStateKeyName                                   OFFSET(getStruct<T>, {0x27C, 4, 0, 0})
	SMember(FName)                                     EvadeDestinationKeyName                                     OFFSET(getStruct<T>, {0x280, 4, 0, 0})
	SMember(FName)                                     WeaponTriggerMeleeName                                      OFFSET(getStruct<T>, {0x284, 4, 0, 0})
	DMember(float)                                     MeleeAttackMaxDistToEvadeSqr                                OFFSET(get<float>, {0x298, 4, 0, 0})
	DMember(float)                                     MaxDistanceToEvadeSqr                                       OFFSET(get<float>, {0x29C, 4, 0, 0})
};
...
public:
	...
	SMember(FName)                                     MoveToDestinationKeyName                                    OFFSET(getStruct<T>, {0x1B8, 4, 0, 0})
	SMember(FName)                                     AggressivenessName                                          OFFSET(getStruct<T>, {0x1BC, 4, 0, 0})
	SMember(FName)                                     CautiousKeyName                                             OFFSET(getStruct<T>, {0x1C0, 4, 0, 0})
	SMember(FName)                                     AlertLevelName                                              OFFSET(getStruct<T>, {0x1C4, 4, 0, 0})
	CMember(class UClass*)                             SearchQueryFilterClass                                      OFFSET(get<T>, {0x1C8, 8, 0, 0})
	CMember(class UFortAthenaAIBotAimingDigestedSkillSet*) CacheAimingDigestedSkillSet                             OFFSET(get<T>, {0x1E0, 8, 0, 0})
	CMember(class UFortAthenaAIBotAttackingDigestedSkillSet*) CacheAttackingDigestedSkillSet                       OFFSET(get<T>, {0x1E8, 8, 0, 0})
	CMember(class UFortAthenaAIBotUnstuckDigestedSkillSet*) CachedUnstuckSkillSet                                  OFFSET(get<T>, {0x1F0, 8, 0, 0})
	CMember(class AActor*)                             InvestigatingSupportingActor                                OFFSET(get<T>, {0x240, 8, 0, 0})
	CMember(class ABuildingSMActor*)                   UnderminingBuildingActor                                    OFFSET(get<T>, {0x248, 8, 0, 0})
	CMember(class AActor*)                             ExcludeReachingTarget                                       OFFSET(get<T>, {0x250, 8, 0, 0})
};
...
public:
	SMember(FName)                                     WeaponTriggerMeleeName                                      OFFSET(getStruct<T>, {0x1CC, 4, 0, 0})
	SMember(FName)                                     ThrowableAttacksAllowedName                                 OFFSET(getStruct<T>, {0x1D0, 4, 0, 0})
	SMember(FName)                                     TraversalBlockMeleeAttackName                               OFFSET(getStruct<T>, {0x1D4, 4, 0, 0})
	SMember(FName)                                     TargetContextReachableKeyName                               OFFSET(getStruct<T>, {0x1D8, 4, 0, 0})
	SMember(FName)                                     TargetContextInsideLeashKeyName                             OFFSET(getStruct<T>, {0x1DC, 4, 0, 0})
	CMember(class UFortAthenaAIBotAttackingDigestedSkillSet*) AttackingSkillSet                                    OFFSET(get<T>, {0x1F8, 8, 0, 0})
};
...
public:
	SMember(FEQSParametrizedQueryExecutionRequest)     EQSRequest                                                  OFFSET(getStruct<T>, {0x1B0, 72, 0, 0})
	CMember(class UClass*)                             NavigationQueryFilterClass                                  OFFSET(get<T>, {0x1F8, 8, 0, 0})
	DMember(bool)                                      bFallbackToPointWithNoCustomNavigationQueryFilter           OFFSET(get<bool>, {0x200, 1, 0, 0})
	SMember(FName)                                     PatrolDestinationName                                       OFFSET(getStruct<T>, {0x204, 4, 0, 0})
	SMember(FName)                                     PatrolExecutionStatusName                                   OFFSET(getStruct<T>, {0x208, 4, 0, 0})
	SMember(FName)                                     PatrolMovementStateName                                     OFFSET(getStruct<T>, {0x20C, 4, 0, 0})
	SMember(FName)                                     BestTargetActorName                                         OFFSET(getStruct<T>, {0x210, 4, 0, 0})
	SMember(FName)                                     EnableKeyName                                               OFFSET(getStruct<T>, {0x214, 4, 0, 0})
	CMember(class AFortGameModeAthena*)                CacheAthenaGameMode                                         OFFSET(get<T>, {0x220, 8, 0, 0})
};
...
public:
	SMember(FName)                                     PlayEmoteExecutionStatusKeyName                             OFFSET(getStruct<T>, {0x1B0, 4, 0, 0})
	SMember(FName)                                     PlayEmoteDestinationKeyName                                 OFFSET(getStruct<T>, {0x1B4, 4, 0, 0})
	CMember(class AActor*)                             ExcludeReachingTarget                                       OFFSET(get<T>, {0x1C0, 8, 0, 0})
};
...
public:
	SMember(FName)                                     WeaponReloadName                                            OFFSET(getStruct<T>, {0x200, 4, 0, 0})
	SMember(FName)                                     WeaponFireName                                              OFFSET(getStruct<T>, {0x204, 4, 0, 0})
	SMember(FName)                                     RangeAttackIsReadyToFireName                                OFFSET(getStruct<T>, {0x208, 4, 0, 0})
	SMember(FName)                                     WeaponTargetingName                                         OFFSET(getStruct<T>, {0x20C, 4, 0, 0})
	SMember(FName)                                     AggressivenessName                                          OFFSET(getStruct<T>, {0x210, 4, 0, 0})
	SMember(FName)                                     HasLoSOnThreatName                                          OFFSET(getStruct<T>, {0x214, 4, 0, 0})
	SMember(FName)                                     UrgentMovementKeyName                                       OFFSET(getStruct<T>, {0x218, 4, 0, 0})
	DMember(bool)                                      bAlwaysAllowTargetingEvaluation                             OFFSET(get<bool>, {0x22A, 1, 0, 0})
	DMember(bool)                                      bSkipADSEvaluation                                          OFFSET(get<bool>, {0x22B, 1, 0, 0})
	SMember(FFortBehaviorValue_Bool)                   SkipADSEvaluation                                           OFFSET(getStruct<T>, {0x22C, 12, 0, 0})
	DMember(bool)                                      bConsiderLoF                                                OFFSET(get<bool>, {0x238, 1, 0, 0})
	DMember(bool)                                      bShouldValidateRangedWeapon                                 OFFSET(get<bool>, {0x239, 1, 0, 0})
	DMember(float)                                     RangeReachHysteresisRatio                                   OFFSET(get<float>, {0x23C, 4, 0, 0})
	CMember(class UFortAthenaAIBotRangeAttackDigestedSkillSet*) CacheRangeAttackDigestedSkillSet                   OFFSET(get<T>, {0x260, 8, 0, 0})
	CMember(class UFortAthenaAIBotAimingDigestedSkillSet*) CacheAimingDigestedSkillSet                             OFFSET(get<T>, {0x268, 8, 0, 0})
	CMember(class UFortAthenaAIBotPerceptionDigestedSkillSet*) CachePerceptionDigestedSkillSet                     OFFSET(get<T>, {0x270, 8, 0, 0})
	CMember(class UFortAthenaAIBotAttackingDigestedSkillSet*) CacheAttackingDigestedSkillSet                       OFFSET(get<T>, {0x278, 8, 0, 0})
	CMember(TWeakObjectPtr<UAthenaAIServiceZoneManager*>) CacheZoneManager                                         OFFSET(get<T>, {0x280, 8, 0, 0})
	CMember(TWeakObjectPtr<UAthenaAIServiceCover*>)    CachedAIServiceCover                                        OFFSET(get<T>, {0x288, 8, 0, 0})
	CMember(class AActor*)                             ExcludeReachingTarget                                       OFFSET(get<T>, {0x290, 8, 0, 0})


	/// Functions
	// Function /Script/FortniteAIServer.FortAthenaAIBotEvaluator_RangeAttack.FindShootingPosition_Async
	// void FindShootingPosition_Async(int32_t RequestID, float DistanceFromTarget, float WeaponIdealAttackRange, FVector& TargetPosition); // [0xa7477ac] Final|Native|Protected|HasOutParms|HasDefaults 
};
...
public:
	SMember(FName)                                     ReachBeaconStatusKeyName                                    OFFSET(getStruct<T>, {0x1B0, 4, 0, 0})
	SMember(FName)                                     ReachBeaconMovementStateKeyName                             OFFSET(getStruct<T>, {0x1B4, 4, 0, 0})
	SMember(FName)                                     ReachBeaconTargetKeyName                                    OFFSET(getStruct<T>, {0x1B8, 4, 0, 0})
	CMember(TWeakObjectPtr<UFortAthenaBeaconComponent*>) CurrentBeacon                                             OFFSET(get<T>, {0x1C4, 8, 0, 0})
};
...
public:
	CMember(class UFortAthenaAIBotReactToVerbDigestedSkillSet*) CacheReactToVerbDigestedSkillSet                   OFFSET(get<T>, {0x218, 8, 0, 0})
	CMember(class UDataTable*)                         VerbReactions                                               OFFSET(get<T>, {0x220, 8, 0, 0})
	SMember(FScalableFloat)                            MinDistanceFromPlayerToReact                                OFFSET(getStruct<T>, {0x228, 40, 0, 0})
	SMember(FScalableFloat)                            MaxReactionEmoteDuration                                    OFFSET(getStruct<T>, {0x250, 40, 0, 0})
	SMember(FScalableFloat)                            MaxReactionWaitTime                                         OFFSET(getStruct<T>, {0x278, 40, 0, 0})
	SMember(FFortNearbyActorsPerceptionConfiguration)  PerceptionConfiguration                                     OFFSET(getStruct<T>, {0x2A0, 208, 0, 0})
	DMember(bool)                                      bIsHighPriorityEvaluator                                    OFFSET(get<bool>, {0x370, 1, 0, 0})
	SMember(FScalableFloat)                            ReactToEmotes                                               OFFSET(getStruct<T>, {0x378, 40, 0, 0})
	SMember(FName)                                     ReactToVerbTargetActorKeyName                               OFFSET(getStruct<T>, {0x3A0, 4, 0, 0})
	SMember(FName)                                     ReactToVerbShouldMoveKeyName                                OFFSET(getStruct<T>, {0x3A8, 4, 0, 0})
	SMember(FName)                                     GameplayEffectReactionKeyName                               OFFSET(getStruct<T>, {0x3B0, 4, 0, 0})
	SMember(FPersistenceFrameworkSaveControl)          SaveControl                                                 OFFSET(getStruct<T>, {0x3E0, 16, 0, 0})


	/// Functions
	// Function /Script/FortniteAIServer.FortAthenaAIBotEvaluator_ReactToVerb.HandlePawnStoppedEmote
	// void HandlePawnStoppedEmote(class UFortItemDefinition* MontageItemDef, class AFortPawn* PawnEmoting);                    // [0x6e93710] Final|Native|Protected 
	// Function /Script/FortniteAIServer.FortAthenaAIBotEvaluator_ReactToVerb.HandlePawnStartedEmote
	// void HandlePawnStartedEmote(class UFortItemDefinition* MontageItemDef, class AFortPawn* PawnEmoting);                    // [0x6e93710] Final|Native|Protected 
};
...
public:
	SMember(FScalableFloat)                            RecoveringLineOfSightMaxDuration                            OFFSET(getStruct<T>, {0x1B0, 40, 0, 0})
	CMember(TArray<FName>)                             ExecutionStatusToListenKeyNames                             OFFSET(get<T>, {0x1D8, 16, 0, 0})
	SMember(FName)                                     RecoverLineOfSightExecutionStatusKeyName                    OFFSET(getStruct<T>, {0x1E8, 4, 0, 0})
	SMember(FName)                                     RecoverLineOfSightMovementStateKeyName                      OFFSET(getStruct<T>, {0x1EC, 4, 0, 0})
	SMember(FName)                                     RecoverLineOfSightDestinationKeyName                        OFFSET(getStruct<T>, {0x1F0, 4, 0, 0})
};
...
public:
	SMember(FName)                                     RetreatDestinationName                                      OFFSET(getStruct<T>, {0x1B0, 4, 0, 0})
	CMember(class UFortAthenaAIBotAttackingDigestedSkillSet*) CacheAttackingDigestedSkillSet                       OFFSET(get<T>, {0x1B8, 8, 0, 0})
	CMember(class UFortAthenaAICoverComponent*)        CachedCoverComponent                                        OFFSET(get<T>, {0x1C0, 8, 0, 0})


	/// Functions
	// Function /Script/FortniteAIServer.FortAthenaAIBotEvaluator_Retreat.HandlePlayerHealthOrShieldChanged
	// void HandlePlayerHealthOrShieldChanged();                                                                                // [0xa764770] Final|Native|Protected 
};
...
public:
	SMember(FScalableFloat)                            LastReviveTargetExpiration                                  OFFSET(getStruct<T>, {0x1B0, 40, 0, 0})
	SMember(FName)                                     ReviveTargetKeyName                                         OFFSET(getStruct<T>, {0x1D8, 4, 0, 0})
	SMember(FName)                                     ReviveLastTargetKeyName                                     OFFSET(getStruct<T>, {0x1DC, 4, 0, 0})
	CMember(class UFortAthenaAIRuntimeParameters_ReviveBehavior*) ReviveBehaviorRuntimeParameters                  OFFSET(get<T>, {0x1E0, 8, 0, 0})
	CMember(class AFortPlayerPawnAthena*)              CurrentReviveTarget                                         OFFSET(get<T>, {0x1E8, 8, 0, 0})
	CMember(TArray<class AFortPlayerPawnAthena*>)      DBNOAllyPawns                                               OFFSET(get<T>, {0x1F0, 16, 0, 0})
	CMember(class UFortAthenaAIBotReviveDigestedSkillSet*) ReviveSkillSet                                          OFFSET(get<T>, {0x200, 8, 0, 0})


	/// Functions
	// Function /Script/FortniteAIServer.FortAthenaAIBotEvaluator_Revive.OnCurrentTargetRevived
	// void OnCurrentTargetRevived(class AFortPlayerPawn* RevivedPawn);                                                         // [0xa764960] Final|Native|Private 
};
...
public:
	...
	// void OnBotControllerAlertLevelChanged(class AFortAthenaAIBotController* BotController, EAlertLevel OldAlertLevel, EAlertLevel NewAlertLevel); // [0xa76485c] Final|Native|Private 
	// Function /Script/FortniteAIServer.FortAthenaAIBotEvaluator_SandTunnel.Jump
	// void Jump();                                                                                                             // [0xa764784] Final|Native|Protected 
};
...
public:
	SMember(FName)                                     DynamicPOIExecutionStatusKeyName                            OFFSET(getStruct<T>, {0x1B0, 4, 0, 0})
	SMember(FName)                                     DynamicPOILocationKeyName                                   OFFSET(getStruct<T>, {0x1B4, 4, 0, 0})
	CMember(class AFortTeamInfoAthena*)                CachedTeamInfo                                              OFFSET(get<T>, {0x1C0, 8, 0, 0})
	CMember(class UFortGameStateComponent_BattleRoyaleGamePhaseLogic*) CachedGamePhaseLogic                        OFFSET(get<T>, {0x1C8, 8, 0, 0})
	SMember(FTimerHandle)                              NextSearchTimerHandle                                       OFFSET(getStruct<T>, {0x208, 8, 0, 0})
	CMember(TArray<FFailedToReachPOI>)                 FailedBotPOIList                                            OFFSET(get<T>, {0x210, 16, 0, 0})
	DMember(int32_t)                                   CachedSelectedBotPOIID                                      OFFSET(get<int32_t>, {0x220, 4, 0, 0})


	/// Functions
	// Function /Script/FortniteAIServer.FortAthenaAIBotEvaluator_SelectNextDynamicPOI.ReachingPositionFail_Async
	// void ReachingPositionFail_Async(int32_t RequestID);                                                                      // [0xa764c40] Final|Native|Private 
	// Function /Script/FortniteAIServer.FortAthenaAIBotEvaluator_SelectNextDynamicPOI.OnSafeZonePhaseChanged
	// void OnSafeZonePhaseChanged(FFortSafeZonePhaseUpdatedEvent& Event);                                                      // [0xa764a6c] Final|Native|Private|HasOutParms 
	// Function /Script/FortniteAIServer.FortAthenaAIBotEvaluator_SelectNextDynamicPOI.OnGamePhaseLogicReady
	// void OnGamePhaseLogicReady(FFortBattleRoyaleGamePhaseLogicComponentReadyEvent& Event);                                   // [0xa7649e0] Final|Native|Private|HasOutParms 
	// Function /Script/FortniteAIServer.FortAthenaAIBotEvaluator_SelectNextDynamicPOI.OnAgentDied
	// void OnAgentDied(class AFortAthenaAIBotController* BotController, class AFortPawn* FortPawn);                            // [0xa764798] Final|Native|Protected 
};
...
public:
	SMember(FName)                                     NextPOIKeyName                                              OFFSET(getStruct<T>, {0x1B0, 4, 0, 0})
	SMember(FName)                                     MarkerLocationKeyName                                       OFFSET(getStruct<T>, {0x1B4, 4, 0, 0})
	CMember(class AFortPoiVolume*)                     StartingGroundPOI                                           OFFSET(get<T>, {0x1C0, 8, 0, 0})
	DMember(bool)                                      bCheckForStartingGroundPOI                                  OFFSET(get<bool>, {0x1C8, 1, 0, 0})
	DMember(float)                                     CurrentPOICompletionTime                                    OFFSET(get<float>, {0x1CC, 4, 0, 0})
	DMember(float)                                     DurationInsideCurrentPOI                                    OFFSET(get<float>, {0x1D0, 4, 0, 0})
	CMember(class AFortTeamInfoAthena*)                CachedTeamInfo                                              OFFSET(get<T>, {0x1D8, 8, 0, 0})
	CMember(class UFortAthenaAIBotLootingDigestedSkillSet*) CachedLootingSkillSet                                  OFFSET(get<T>, {0x1E0, 8, 0, 0})
};
...
public:
	SMember(FName)                                     VehicleDestinationKeyName                                   OFFSET(getStruct<T>, {0x1B0, 4, 0, 0})
	SMember(FName)                                     SelectVehicleMovementStateKeyName                           OFFSET(getStruct<T>, {0x1B4, 4, 0, 0})
	SMember(FName)                                     SelectVehicleStatusKeyName                                  OFFSET(getStruct<T>, {0x1B8, 4, 0, 0})
	SMember(FName)                                     SelectedVehicleKeyName                                      OFFSET(getStruct<T>, {0x1BC, 4, 0, 0})
	SMember(FScalableFloat)                            Enabled                                                     OFFSET(getStruct<T>, {0x1C8, 40, 0, 0})
	DMember(float)                                     VehicleSearchRadius                                         OFFSET(get<float>, {0x1F0, 4, 0, 0})
	DMember(bool)                                      bCanEnterOnlyWithHisConverter                               OFFSET(get<bool>, {0x1F4, 1, 0, 0})
	DMember(bool)                                      bCanEnterAsDriver                                           OFFSET(get<bool>, {0x1F5, 1, 0, 0})
	DMember(bool)                                      bCanEnterVehiclesInWater                                    OFFSET(get<bool>, {0x1F6, 1, 0, 0})
	DMember(bool)                                      bCanEnterOutOfFuelVehicles                                  OFFSET(get<bool>, {0x1F7, 1, 0, 0})
	DMember(bool)                                      bCanEnterWithPlayerDriver                                   OFFSET(get<bool>, {0x1F8, 1, 0, 0})
	DMember(bool)                                      bCanEnterOnlyMatchingPatrols                                OFFSET(get<bool>, {0x1F9, 1, 0, 0})
	SMember(FGameplayTagQuery)                         VehiclesFilterTagQuery                                      OFFSET(getStruct<T>, {0x200, 72, 0, 0})
	SMember(FGameplayTagQuery)                         SeatsFilterTagQuery                                         OFFSET(getStruct<T>, {0x248, 72, 0, 0})
};
...
public:
	...
	SMember(FScalableFloat)                            MaximumEntryLocationsChecksPerEvaluation                    OFFSET(getStruct<T>, {0x1D0, 40, 0, 0})
	SMember(FScalableFloat)                            EntryLocationFailuresBlacklistedTime                        OFFSET(getStruct<T>, {0x1F8, 40, 0, 0})
	CMember(class UCurveFloat*)                        DistanceToWeightCurveForSlotPicking                         OFFSET(get<T>, {0x220, 8, 0, 0})
	CMember(class UClass*)                             OverridenFilterClassForEntryPoints                          OFFSET(get<T>, {0x228, 8, 0, 0})
	CMember(TArray<FName>)                             ExecutionStatusesToCheckForAllowToAvoidGoingToSOKeyNames    OFFSET(get<T>, {0x230, 16, 0, 0})
	SMember(FName)                                     SmartObjectExecutionStatusKeyName                           OFFSET(getStruct<T>, {0x250, 4, 0, 0})
	SMember(FName)                                     SmartObjectMovementStateKeyName                             OFFSET(getStruct<T>, {0x254, 4, 0, 0})
	SMember(FName)                                     SmartObjectDestinationKeyName                               OFFSET(getStruct<T>, {0x258, 4, 0, 0})
	SMember(FName)                                     SmartObjectDestinationRotationKeyName                       OFFSET(getStruct<T>, {0x25C, 4, 0, 0})
	SMember(FName)                                     SmartObjectShouldMoveKeyName                                OFFSET(getStruct<T>, {0x260, 4, 0, 0})
	SMember(FName)                                     SmartObjectUrgencyKeyName                                   OFFSET(getStruct<T>, {0x264, 4, 0, 0})
};
...
public:
	CMember(class UFortAthenaAIBotRangeAttackDigestedSkillSet*) CachedRangeAttackDigestedSkillSet                  OFFSET(get<T>, {0x1B0, 8, 0, 0})
	CMember(class UAthenaAIServiceCover*)              CachedAIServiceCover                                        OFFSET(get<T>, {0x1B8, 8, 0, 0})
	SMember(FName)                                     StepBackExecutionStatusKeyName                              OFFSET(getStruct<T>, {0x1C8, 4, 0, 0})
	SMember(FName)                                     StepBackMovementStateKeyName                                OFFSET(getStruct<T>, {0x1CC, 4, 0, 0})
	SMember(FName)                                     StepBackDestinationKeyName                                  OFFSET(getStruct<T>, {0x1D0, 4, 0, 0})
};
...
public:
	SMember(FName)                                     StormDestinationName                                        OFFSET(getStruct<T>, {0x1B0, 4, 0, 0})
	CMember(class AFortGameModeAthena*)                CacheAthenaGameMode                                         OFFSET(get<T>, {0x1C0, 8, 0, 0})
	CMember(class UBehaviorTreeComponent*)             CachedBTComp                                                OFFSET(get<T>, {0x1C8, 8, 0, 0})
	CMember(class UFortGameStateComponent_BattleRoyaleGamePhaseLogic*) CachedGamePhaseLogic                        OFFSET(get<T>, {0x1D0, 8, 0, 0})


	/// Functions
	// Function /Script/FortniteAIServer.FortAthenaAIBotEvaluator_Storm.OnSafeZoneStateChanged
	// void OnSafeZoneStateChanged(EFortSafeZoneState NewState);                                                                // [0xa764afc] Final|Native|Public  
};
...
public:
	CMember(class UFortAthenaAIBotRangeAttackDigestedSkillSet*) CacheRangeAttackDigestedSkillSet                   OFFSET(get<T>, {0x1B0, 8, 0, 0})
	CMember(class UFortAthenaAIBotAimingDigestedSkillSet*) CacheAimingDigestedSkillSet                             OFFSET(get<T>, {0x1B8, 8, 0, 0})
	CMember(class UAthenaAIServiceCover*)              CachedAIServiceCover                                        OFFSET(get<T>, {0x1C0, 8, 0, 0})
	SMember(FName)                                     DestinationKeyName                                          OFFSET(getStruct<T>, {0x1C8, 4, 0, 0})
	SMember(FName)                                     MoveToDestinationKeyName                                    OFFSET(getStruct<T>, {0x1CC, 4, 0, 0})
	SMember(FName)                                     HealingStatusKeyName                                        OFFSET(getStruct<T>, {0x1D0, 4, 0, 0})
	SMember(FName)                                     WeaponFireName                                              OFFSET(getStruct<T>, {0x1D4, 4, 0, 0})
	SMember(FName)                                     TargetActorName                                             OFFSET(getStruct<T>, {0x1D8, 4, 0, 0})
	SMember(FName)                                     BunkerStatusKeyName                                         OFFSET(getStruct<T>, {0x1DC, 4, 0, 0})
	CMember(class ABuildingActor*)                     CachedCoverBuildingActor                                    OFFSET(get<T>, {0x1F0, 8, 0, 0})
	CMember(TArray<class ABuildingActor*>)             ExcludedBuildingActors                                      OFFSET(get<T>, {0x1F8, 16, 0, 0})
};
...
public:
	SMember(FName)                                     WeaponTriggerThrowableName                                  OFFSET(getStruct<T>, {0x1C8, 4, 0, 0})
	SMember(FName)                                     ThrowableAttackIsReadyToThrowName                           OFFSET(getStruct<T>, {0x1CC, 4, 0, 0})
	CMember(class UFortAthenaAIBotAttackingDigestedSkillSet*) AttackingSkillSet                                    OFFSET(get<T>, {0x1D8, 8, 0, 0})
	CMember(class UFortAthenaAIBotRangeAttackDigestedSkillSet*) RangeAttackSkillSet                                OFFSET(get<T>, {0x1E0, 8, 0, 0})
	CMember(class UFortAthenaAIBotAimingDigestedSkillSet*) AimingSkillSet                                          OFFSET(get<T>, {0x1E8, 8, 0, 0})
	CMember(class UFortWorldItem*)                     ChosenWeapon                                                OFFSET(get<T>, {0x1F0, 8, 0, 0})
	CMember(class AFortPawn*)                          CachedFortPawn                                              OFFSET(get<T>, {0x1F8, 8, 0, 0})
};
...
public:
	SMember(FName)                                     CurrentDestinationKeyName                                   OFFSET(getStruct<T>, {0x1B0, 4, 0, 0})
	SMember(FName)                                     ZiplineTargetKeyName                                        OFFSET(getStruct<T>, {0x1B4, 4, 0, 0})
	SMember(FName)                                     LastZiplineUsedName                                         OFFSET(getStruct<T>, {0x1B8, 4, 0, 0})
	SMember(FName)                                     ZiplineMoveExecutionStatusKeyName                           OFFSET(getStruct<T>, {0x1BC, 4, 0, 0})
	SMember(FName)                                     ZiplineEntryLocationKeyName                                 OFFSET(getStruct<T>, {0x1C0, 4, 0, 0})
	SMember(FName)                                     ZiplineExitLocationKeyName                                  OFFSET(getStruct<T>, {0x1C4, 4, 0, 0})
	SMember(FName)                                     ZiplineLastUsageTimeName                                    OFFSET(getStruct<T>, {0x1C8, 4, 0, 0})
	SMember(FName)                                     ZiplineUsageExecutionStatusName                             OFFSET(getStruct<T>, {0x1CC, 4, 0, 0})
	SMember(FScalableFloat)                            WaitTimeBetweenZiplineRandomChoices                         OFFSET(getStruct<T>, {0x1D0, 40, 0, 0})
	SMember(FScalableFloat)                            ProbabilityToUseZipline                                     OFFSET(getStruct<T>, {0x1F8, 40, 0, 0})


	/// Functions
	// Function /Script/FortniteAIServer.FortAthenaAIBotEvaluator_Zipline.OnZiplineStateChanged
	// void OnZiplineStateChanged(bool bIsZiplining, class AFortPlayerPawn* FortPlayerPawn);                                    // [0xa764b7c] Final|Native|Protected 
};
...
public:
	...
	DMember(bool)                                      bCooldownEvaluator                                          OFFSET(get<bool>, {0xD8, 1, 0, 0})
	DMember(float)                                     Cooldown                                                    OFFSET(get<float>, {0xDC, 4, 0, 0})
	DMember(float)                                     CooldownVariation                                           OFFSET(get<float>, {0xE0, 4, 0, 0})
	CMember(TEnumAsByte<ECooldownType>)                CooldownType                                                OFFSET(get<T>, {0xE4, 1, 0, 0})
	DMember(bool)                                      bDistanceEvaluator                                          OFFSET(get<bool>, {0xE5, 1, 0, 0})
	DMember(float)                                     StartDistance                                               OFFSET(get<float>, {0xE8, 4, 0, 0})
	DMember(float)                                     OngoingDistance                                             OFFSET(get<float>, {0xEC, 4, 0, 0})
	SMember(FName)                                     DistanceTargetKeyName                                       OFFSET(getStruct<T>, {0xF0, 4, 0, 0})
	DMember(bool)                                      bEvaluateOnBlackboardKeyChange                              OFFSET(get<bool>, {0xF6, 1, 0, 0})
	CMember(TArray<FName>)                             ListeningBlackboardKeyNames                                 OFFSET(get<T>, {0xF8, 16, 0, 0})


	/// Functions
	// Function /Script/FortniteAIServer.FortAthenaAIEvaluator_BlueprintBase.OnExit
	// void OnExit(class UBehaviorTreeComponent* OwnerComp);                                                                    // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/FortniteAIServer.FortAthenaAIEvaluator_BlueprintBase.OnEnter
	// void OnEnter(class UBehaviorTreeComponent* OwnerComp);                                                                   // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/FortniteAIServer.FortAthenaAIEvaluator_BlueprintBase.EvaluateStartingConditions
	// bool EvaluateStartingConditions(class UBehaviorTreeComponent* OwnerComp);                                                // [0xa7646dc] Native|Event|Protected|BlueprintEvent|Const 
	// Function /Script/FortniteAIServer.FortAthenaAIEvaluator_BlueprintBase.EvaluateOngoingConditions
	// bool EvaluateOngoingConditions(class UBehaviorTreeComponent* OwnerComp);                                                 // [0xa764648] Native|Event|Protected|BlueprintEvent|Const 
};
...
public:
	SMember(FName)                                     FollowGroupLeaderStatusKeyName                              OFFSET(getStruct<T>, {0x1B0, 4, 0, 0})
	SMember(FName)                                     FollowGroupLeaderMovementStateKeyName                       OFFSET(getStruct<T>, {0x1B4, 4, 0, 0})
	SMember(FName)                                     FollowGroupLeaderDestinationKeyName                         OFFSET(getStruct<T>, {0x1B8, 4, 0, 0})
	SMember(FName)                                     TooFarFromLeaderKeyName                                     OFFSET(getStruct<T>, {0x1BC, 4, 0, 0})
	CMember(class UFortPawnComponent_AIGroup*)         CachedAIGroupComponent                                      OFFSET(get<T>, {0x1C8, 8, 0, 0})
};
...
public:
	...
	// void ManageWeaponTargeting(class UBehaviorTreeComponent* OwnerComp);                                                     // [0xa786c08] Final|Native|Protected|Const 
};
...
public:
	...
	// void OnStopSliding(class AFortPlayerPawn* Pawn);                                                                         // [0xa786d18] Final|Native|Private 
};
...
public:
	SMember(FName)                                     ActionObjectKeyName                                         OFFSET(getStruct<T>, {0x70, 4, 0, 0})
	SMember(FName)                                     ExecutionStatusKeyName                                      OFFSET(getStruct<T>, {0x74, 4, 0, 0})
	SMember(FFortBehaviorValue_Float)                  MinimumWaitTimeBetweenUses                                  OFFSET(getStruct<T>, {0x78, 12, 0, 0})
	SMember(FFortBehaviorValue_Float)                  MaximumWaitTimeBetweenUses                                  OFFSET(getStruct<T>, {0x84, 12, 0, 0})
	SMember(FFortBehaviorValue_Bool)                   ValidateAbility                                             OFFSET(getStruct<T>, {0x90, 12, 0, 0})
	SMember(FFortBehaviorValue_Bool)                   ResetActionObjectKey                                        OFFSET(getStruct<T>, {0x9C, 12, 0, 0})
	SMember(FFortBehaviorValue_Bool)                   UseAlternateMode                                            OFFSET(getStruct<T>, {0xA8, 12, 0, 0})
	DMember(float)                                     MinWaitTimeBetweenUses                                      OFFSET(get<float>, {0xB8, 4, 0, 0})
	DMember(float)                                     MaxWaitTimeBetweenUses                                      OFFSET(get<float>, {0xBC, 4, 0, 0})
	DMember(bool)                                      bValidateAbility                                            OFFSET(get<bool>, {0xC0, 1, 0, 0})
	DMember(bool)                                      bResetActionObjectKey                                       OFFSET(get<bool>, {0xC1, 1, 0, 0})
	DMember(bool)                                      bUseAlternateMode                                           OFFSET(get<bool>, {0xC2, 1, 0, 0})
};
...
public:
	...
	// void OnZiplineStateChanged(bool bIsZiplining, class AFortPlayerPawn* FortPlayerPawn);                                    // [0xa7a6e48] Final|Native|Public  
};
...
public:
	SMember(FScalableFloat)                            EncampmentEnable                                            OFFSET(getStruct<T>, {0x1B0, 40, 0, 0})
	SMember(FScalableFloat)                            EncampmentTentativeDelayMin                                 OFFSET(getStruct<T>, {0x1D8, 40, 0, 0})
	SMember(FScalableFloat)                            EncampmentTentativeDelayMax                                 OFFSET(getStruct<T>, {0x200, 40, 0, 0})
	SMember(FScalableFloat)                            EncampmentDurationMin                                       OFFSET(getStruct<T>, {0x228, 40, 0, 0})
	SMember(FScalableFloat)                            EncampmentDurationMax                                       OFFSET(getStruct<T>, {0x250, 40, 0, 0})
	SMember(FScalableFloat)                            BuilderPercentage                                           OFFSET(getStruct<T>, {0x278, 40, 0, 0})
	SMember(FScalableFloat)                            BuilderMinDistance                                          OFFSET(getStruct<T>, {0x2A0, 40, 0, 0})
	SMember(FScalableFloat)                            BuilderMaxDistance                                          OFFSET(getStruct<T>, {0x2C8, 40, 0, 0})
	SMember(FScalableFloat)                            GuardMinDistance                                            OFFSET(getStruct<T>, {0x2F0, 40, 0, 0})
	SMember(FScalableFloat)                            GuardMaxDistance                                            OFFSET(getStruct<T>, {0x318, 40, 0, 0})
	SMember(FScalableFloat)                            AllowInSwimming                                             OFFSET(getStruct<T>, {0x340, 40, 0, 0})
	SMember(FScalableFloat)                            AllowInFalling                                              OFFSET(getStruct<T>, {0x368, 40, 0, 0})
	SMember(FScalableFloat)                            MinSquadMembersCountToBuild                                 OFFSET(getStruct<T>, {0x390, 40, 0, 0})
	SMember(FName)                                     EncampmentStatusKeyName                                     OFFSET(getStruct<T>, {0x3B8, 4, 0, 0})
	SMember(FName)                                     EncampmentMovementStateKeyName                              OFFSET(getStruct<T>, {0x3C0, 4, 0, 0})
	SMember(FName)                                     EncampmentCenterLocationKeyName                             OFFSET(getStruct<T>, {0x3C8, 4, 0, 0})
	SMember(FName)                                     EncampmentDestinationKeyName                                OFFSET(getStruct<T>, {0x3D0, 4, 0, 0})
	SMember(FName)                                     EncampmentAroundCampFireLocationKeyName                     OFFSET(getStruct<T>, {0x3D8, 4, 0, 0})
	SMember(FName)                                     EncampmentRoleKeyName                                       OFFSET(getStruct<T>, {0x3E0, 4, 0, 0})
	SMember(FName)                                     DefensiveBuildName                                          OFFSET(getStruct<T>, {0x3E8, 4, 0, 0})
};
...
public:
	SMember(FName)                                     FollowPatrolPathKeyName                                     OFFSET(getStruct<T>, {0x1B0, 4, 0, 0})
	SMember(FName)                                     FollowPatrolPathMovementStateKeyName                        OFFSET(getStruct<T>, {0x1B4, 4, 0, 0})
	SMember(FName)                                     FollowPatrolPathDestinationKeyName                          OFFSET(getStruct<T>, {0x1B8, 4, 0, 0})
	DMember(float)                                     ChanceToTakeABreak                                          OFFSET(get<float>, {0x1C4, 4, 0, 0})
	DMember(float)                                     BreakDurationMin                                            OFFSET(get<float>, {0x1C8, 4, 0, 0})
	DMember(float)                                     BreakDurationMax                                            OFFSET(get<float>, {0x1CC, 4, 0, 0})
};
...
public:
	SMember(FScalableFloat)                            FormationOffsetRadiusMin                                    OFFSET(getStruct<T>, {0x1B0, 40, 0, 0})
	SMember(FScalableFloat)                            FormationOffsetRadiusMax                                    OFFSET(getStruct<T>, {0x1D8, 40, 0, 0})
	SMember(FScalableFloat)                            TooFarFromSquadLeaderDistance                               OFFSET(getStruct<T>, {0x200, 40, 0, 0})
	SMember(FScalableFloat)                            MaxNoiseRadius                                              OFFSET(getStruct<T>, {0x228, 40, 0, 0})
	SMember(FScalableFloat)                            MinDurationNoiseEvaluate                                    OFFSET(getStruct<T>, {0x250, 40, 0, 0})
	SMember(FScalableFloat)                            MaxDurationNoiseEvaluate                                    OFFSET(getStruct<T>, {0x278, 40, 0, 0})
	SMember(FName)                                     FollowSquadLeaderStatusKeyName                              OFFSET(getStruct<T>, {0x2A0, 4, 0, 0})
	SMember(FName)                                     FollowSquadLeaderMovementStateKeyName                       OFFSET(getStruct<T>, {0x2A8, 4, 0, 0})
	SMember(FName)                                     FollowSquadLeaderDestinationKeyName                         OFFSET(getStruct<T>, {0x2B0, 4, 0, 0})
	SMember(FName)                                     TooFarFromLeaderKeyName                                     OFFSET(getStruct<T>, {0x2B8, 4, 0, 0})
	SMember(FVector)                                   CachedSquadFormationOffset                                  OFFSET(getStruct<T>, {0x2C0, 24, 0, 0})
	SMember(FVector)                                   CachedNoiseOffset                                           OFFSET(getStruct<T>, {0x2D8, 24, 0, 0})
	DMember(float)                                     CachedTooFarFromSquadLeaderDistanceSqr                      OFFSET(get<float>, {0x2F0, 4, 0, 0})
	DMember(float)                                     LastNoiseOffsetUpdateTime                                   OFFSET(get<float>, {0x2F4, 4, 0, 0})
	DMember(float)                                     DurationNoiseEvaluate                                       OFFSET(get<float>, {0x2F8, 4, 0, 0})
};
...
public:
	SMember(FName)                                     LeashKeyName                                                OFFSET(getStruct<T>, {0x1B0, 4, 0, 0})
	SMember(FName)                                     LeashMovementStateKeyName                                   OFFSET(getStruct<T>, {0x1B4, 4, 0, 0})
	SMember(FName)                                     LeashDestinationKeyName                                     OFFSET(getStruct<T>, {0x1B8, 4, 0, 0})
	SMember(FName)                                     LeashLocationKeyName                                        OFFSET(getStruct<T>, {0x1BC, 4, 0, 0})
	SMember(FName)                                     LeashOuterRadiusKeyName                                     OFFSET(getStruct<T>, {0x1C0, 4, 0, 0})
	SMember(FName)                                     ShouldTeleportInLeashKeyName                                OFFSET(getStruct<T>, {0x1C4, 4, 0, 0})
	SMember(FName)                                     TriggerLeashBehaviorKeyName                                 OFFSET(getStruct<T>, {0x1C8, 4, 0, 0})
	DMember(bool)                                      bAlwaysForceMoveToLeashCenter                               OFFSET(get<bool>, {0x1CC, 1, 0, 0})
	DMember(bool)                                      bForcePositionOnLeash                                       OFFSET(get<bool>, {0x1CD, 1, 0, 0})
	CMember(class UClass*)                             AvoidObstaclesFilterClass                                   OFFSET(get<T>, {0x1D0, 8, 0, 0})
	CMember(class UFortAthenaAIRuntimeParameters_Leash*) LeashRuntimeParameters                                    OFFSET(get<T>, {0x1E8, 8, 0, 0})
};
...
public:
	SMember(FName)                                     PatrollingKeyName                                           OFFSET(getStruct<T>, {0x1B0, 4, 0, 0})
	SMember(FName)                                     PatrollingMovementStateKeyName                              OFFSET(getStruct<T>, {0x1B4, 4, 0, 0})
	SMember(FName)                                     PatrollingDestinationKeyName                                OFFSET(getStruct<T>, {0x1B8, 4, 0, 0})
	SMember(FName)                                     DynamicBlueprintStatusKeyName                               OFFSET(getStruct<T>, {0x1BC, 4, 0, 0})
	SMember(FName)                                     DynamicBlueprintActorKeyName                                OFFSET(getStruct<T>, {0x1C0, 4, 0, 0})
	SMember(FName)                                     PatrollingShouldMoveKeyName                                 OFFSET(getStruct<T>, {0x1C4, 4, 0, 0})
	SMember(FName)                                     PatrollingAppendDestinationKeyName                          OFFSET(getStruct<T>, {0x1C8, 4, 0, 0})
	DMember(float)                                     DistanceToTestPoint                                         OFFSET(get<float>, {0x1DC, 4, 0, 0})
	DMember(bool)                                      bCanDisablePatrolling                                       OFFSET(get<bool>, {0x1E0, 1, 0, 0})
	DMember(bool)                                      bCanReenablePatrolling                                      OFFSET(get<bool>, {0x1E1, 1, 0, 0})
	DMember(float)                                     ReenableTimer                                               OFFSET(get<float>, {0x1E4, 4, 0, 0})
	DMember(bool)                                      bCanSelectNearestPatrolPointAtStart                         OFFSET(get<bool>, {0x1E8, 1, 0, 0})
	DMember(bool)                                      bCanRetryOnPartialPathSuccess                               OFFSET(get<bool>, {0x1E9, 1, 0, 0})
	CMember(class UFortAthenaNpcPatrollingComponent*)  CachedNpcPatrollingComponent                                OFFSET(get<T>, {0x1F0, 8, 0, 0})
};
...
public:
	...
	// void OnNotifyBeginReceived(FName NotifyName, FBranchingPointNotifyPayload& BranchingPointNotifyPayload);                 // [0xa7a6b10] Final|Native|Public|HasOutParms 
	// Function /Script/FortniteAIServer.FortAthenaPlayContextualAnimTaskInstanceData.OnMontageEnded
	// void OnMontageEnded(class UAnimMontage* EndedMontage, bool bInterrupted);                                                // [0xa7a6980] Final|Native|Public  
};
...
public:
	...
	// void OnNotifyBeginReceived(FName NotifyName, FBranchingPointNotifyPayload& BranchingPointNotifyPayload);                 // [0xa7a6cac] Final|Native|Private|HasOutParms 
	// Function /Script/FortniteAIServer.FortAthenaPlayInteractionStateTreeTask.OnMontageEnded
	// void OnMontageEnded(class UAnimMontage* EndedMontage, bool bInterrupted);                                                // [0xa7a6a48] Final|Native|Private 
};
...
public:
	...
	// void HandleNotifyBeginReceived(FName NotifyName, FBranchingPointNotifyPayload& BranchingPointNotifyPayload);             // [0xa7a67cc] Final|Native|Private|HasOutParms 
	// Function /Script/FortniteAIServer.FortAthenaPlayMontageStateTreeTask.HandleMontageEnded
	// void HandleMontageEnded(class UAnimMontage* EndedMontage, bool bInterrupted);                                            // [0xa7a6704] Final|Native|Private 
};
...
public:
	...
	// void HandleWorldStateChanged();                                                                                          // [0xa7a6968] Final|Native|Private 
};
...
enum class EForstStateTreeFireWeaponBehavior : uint8_t
{
	...
	EForstStateTreeFireWeaponBehavior__EForstStateTreeFireWeaponBehavior_MAX         = 4
};
...
enum class ESTFortAthenaPlayMontageExecMode : uint8_t
{
	...
	ESTFortAthenaPlayMontageExecMode__ESTFortAthenaPlayMontageExecMode_MAX           = 3
};
...
enum class ESTFortAthenaPlayMontageLoopMode : uint8_t
{
	...
	ESTFortAthenaPlayMontageLoopMode__ESTFortAthenaPlayMontageLoopMode_MAX           = 2
};
