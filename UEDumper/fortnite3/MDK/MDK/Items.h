...
public:
	...
	// void ExecuteUbergraph_VictoryCrownComponent(int32_t EntryPoint);                                                         // [0x1340978] Final                
};
...
public:
	...
	// void UpdateForGCNL();                                                                                                    // [0x1340978] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	...
	// void OnStatChanged_80A6FD2F402F11C0D0A207ACE25F03A6(FName StatName, int32_t StatValue);                                  // [0x1340978] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_VictoryCrownFrontEndPawnComponent(int32_t EntryPoint);                                             // [0x1340978] Final                
};
