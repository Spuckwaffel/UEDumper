...
public:
	...
	// void OnOwnerAdded(class AActor* Actor);                                                                                  // [0xc793640] Final|Native|Private 
};
...
public:
	...
	// void ORSListObjects();                                                                                                   // [0x35e6228] Final|Exec|Native|Protected 
	// Function /Script/ORS.ORSCheatManager.ORSDebug
	// void ORSDebug(FName& Path);                                                                                              // [0xc7935d8] Final|Exec|Native|Protected|HasOutParms 
};
...
public:
	...
	// void OnRep_ReplicatedObjectReferences();                                                                                 // [0xc7936e8] Final|Native|Protected 
	// Function /Script/ORS.ORSGroupComponent.OnRep_ReplicatedNetSerializeObjects
	// void OnRep_ReplicatedNetSerializeObjects();                                                                              // [0xc7936d4] Final|Native|Protected 
	// Function /Script/ORS.ORSGroupComponent.OnRep_ReplayNetSerializeObjects
	// void OnRep_ReplayNetSerializeObjects();                                                                                  // [0xc7936c0] Final|Native|Protected 
};
...
public:
	...
	// void OnActorDestroyed(class AActor* Actor);                                                                              // [0x1770b78] Final|Native|Protected 
};
