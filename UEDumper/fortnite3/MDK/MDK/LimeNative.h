...
public:
	...
	// void OnEndPlay(class AActor* Actor, TEnumAsByte<EEndPlayReason> EndPlayReason);                                          // [0xc96d0e4] Final|Native|Private 
};
...
public:
	...
	// void HandleEnterVehicle();                                                                                               // [0xc96d018] Final|Native|Protected 
};
...
public:
	...
	// void OnRep_CurrentMoodState();                                                                                           // [0xc96d1a8] Final|Native|Private 
	// Function /Script/LimeNative.LimePawnComponentMood.GetCurrentMoodState
	// FLimeMoodStateData GetCurrentMoodState();                                                                                // [0x9070170] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void SetEmotionalState(FLimeEmotionalStateData Emotion);                                                                 // [0xc96d1e4] Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
	// Function /Script/LimeNative.LimePawnComponent_EmotionalState.SetCurrentEmotionalState
	// void SetCurrentEmotionalState(ELimePawnEmotionalState NewEmotion);                                                       // [0xc5df458] Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
	// Function /Script/LimeNative.LimePawnComponent_EmotionalState.ResetToDefaultEmotionalState
	// void ResetToDefaultEmotionalState();                                                                                     // [0xc96d1d0] Final|Native|Private 
	// Function /Script/LimeNative.LimePawnComponent_EmotionalState.OnRep_TargetEmotionalState
	// void OnRep_TargetEmotionalState();                                                                                       // [0xc96d1bc] Final|Native|Private 
	...
	// void HandleLimeAwesomeLevelChanged(int32_t NewAwesomeLevel);                                                             // [0xc96d02c] Final|Native|Private 
	...
	// ELimePawnEmotionalState GetCurrentEmotionalState();                                                                      // [0x9343ce8] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
