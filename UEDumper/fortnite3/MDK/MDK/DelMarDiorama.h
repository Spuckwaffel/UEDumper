...
public:
	...
	// void BP_OnBoundVehicleChanged(class ADelMarVehicle* NewVehicle);                                                         // [0x1340978] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void HandleSequenceFinished();                                                                                           // [0xc916474] Final|Native|Protected 
};
...
public:
	...
	// void DelMarIntercomPlayInteraction(FString InteractionTag);                                                              // [0x6d232d0] Final|Exec|Native|Protected 
	// Function /Script/DelMarDiorama.DelMarDriverCheatManager.DelMarIntercomBroadcastEmote
	// void DelMarIntercomBroadcastEmote(FString EmoteTag);                                                                     // [0x6d232d0] Final|Exec|Native|Protected 
	// Function /Script/DelMarDiorama.DelMarDriverCheatManager.DelMarDioramaSetVisibleInSceneCaptureOnly
	// void DelMarDioramaSetVisibleInSceneCaptureOnly(bool bOnly);                                                              // [0x64a7494] Final|Exec|Native|Protected 
	// Function /Script/DelMarDiorama.DelMarDriverCheatManager.DelMarDioramaSetLocation
	// void DelMarDioramaSetLocation(float X, float Y, float Z);                                                                // [0x954def0] Final|Exec|Native|Protected 
	// Function /Script/DelMarDiorama.DelMarDriverCheatManager.DelMarDioramaSetLightingChannel
	// void DelMarDioramaSetLightingChannel(bool bMainChannel);                                                                 // [0x64a7494] Final|Exec|Native|Protected 
	// Function /Script/DelMarDiorama.DelMarDriverCheatManager.DelMarDioramaSetEnabled
	// void DelMarDioramaSetEnabled(bool bEnabled);                                                                             // [0x64a7494] Final|Exec|Native|Protected 
	// Function /Script/DelMarDiorama.DelMarDriverCheatManager.DelMarDioramaSetDriverReaction
	// void DelMarDioramaSetDriverReaction(FString ReactionTag);                                                                // [0x6d232d0] Final|Exec|Native|Protected 
	// Function /Script/DelMarDiorama.DelMarDriverCheatManager.DelMarDioramaOpenChannel
	// void DelMarDioramaOpenChannel(bool bOpened);                                                                             // [0x64a7494] Final|Exec|Native|Protected 
};
...
public:
	...
	// bool IsDrivingSpeed();                                                                                                   // [0xc916afc] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void HandleViewTargetChanged(class AFortPlayerController* PC, class AActor* Old, class AActor* NewViewTarget);           // [0xc9168b4] Final|Native|Protected 
};
...
public:
	...
	// void HandleSequenceFinished();                                                                                           // [0x1745e54] Native|Protected     
};
...
public:
	...
	// void HandleVehicleSpawned(bool bFirstCar, bool bPrevCarDemolished);                                                      // [0xc9167f0] Final|Native|Protected 
	// Function /Script/DelMarDiorama.DelMarDriverChannel.HandleVehicleLanded
	// void HandleVehicleLanded(float LandingForce, bool bLandedKickflip);                                                      // [0xc916728] Final|Native|Protected 
	// Function /Script/DelMarDiorama.DelMarDriverChannel.HandleVehicleHitWall
	// void HandleVehicleHitWall(float ImpactMagnitude, FVector WorldLocation, float ForwardRotationDegrees);                   // [0xc91661c] Final|Native|Protected|HasDefaults 
	// Function /Script/DelMarDiorama.DelMarDriverChannel.HandleVehicleDemolished
	// void HandleVehicleDemolished(FGameplayTag CausedByTag);                                                                  // [0xc91659c] Final|Native|Protected 
	// Function /Script/DelMarDiorama.DelMarDriverChannel.HandleTurboActivated
	// void HandleTurboActivated();                                                                                             // [0xc916588] Final|Native|Protected 
	// Function /Script/DelMarDiorama.DelMarDriverChannel.HandleStartlineBoostActivated
	// void HandleStartlineBoostActivated(float PercentageSpeedEarned);                                                         // [0xc916508] Final|Native|Protected 
	// Function /Script/DelMarDiorama.DelMarDriverChannel.HandleSpeedChanged
	// void HandleSpeedChanged(float NewSpeed);                                                                                 // [0xc916488] Final|Native|Protected 
	// Function /Script/DelMarDiorama.DelMarDriverChannel.HandleHazardSpeedLost
	// void HandleHazardSpeedLost();                                                                                            // [0xc916460] Final|Native|Protected 
	// Function /Script/DelMarDiorama.DelMarDriverChannel.HandleDriftBoostActivated
	// void HandleDriftBoostActivated(float PercentageMaxBoostGained);                                                          // [0xc9163e0] Final|Native|Protected 
	// Function /Script/DelMarDiorama.DelMarDriverChannel.HandleDraftStateChanged
	// void HandleDraftStateChanged(EDelmarDraftingState DraftState);                                                           // [0xc916360] Final|Native|Protected 
};
...
public:
	...
	// void ServerReceiveInteraction(FGameplayTag EmoteTag, class APlayerState* Receiver);                                      // [0xc916ba4] Net|Native|Event|Public|NetServer 
	// Function /Script/DelMarDiorama.DelMarIntercomComponent.ServerReceiveEmote
	// void ServerReceiveEmote(FGameplayTag EmoteTag);                                                                          // [0xc916b20] Net|Native|Event|Protected|NetServer 
	// Function /Script/DelMarDiorama.DelMarIntercomComponent.HandleViewTargetChanged
	// void HandleViewTargetChanged(class AFortPlayerController* InController, class AActor* OldViewTarget, class AActor* NewViewTarget); // [0xc916a04] Final|Native|Protected 
	// Function /Script/DelMarDiorama.DelMarIntercomComponent.ClientReceiveInteraction
	// void ClientReceiveInteraction(FGameplayTag InteractionTag, class APlayerState* Instigator, class APlayerState* Receiver); // [0xc916264] Net|Native|Event|Protected|NetClient 
	// Function /Script/DelMarDiorama.DelMarIntercomComponent.ClientReceiveEmote
	// void ClientReceiveEmote(FGameplayTag EmoteTag, class APlayerState* Instigator);                                          // [0xc91619c] Net|Native|Event|Protected|NetClient 
};
