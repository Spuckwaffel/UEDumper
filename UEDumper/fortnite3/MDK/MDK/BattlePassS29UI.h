...
public:
	...
	// void OnBattlePassSubscriptionAllowed(bool bSubscriptionAllowed);                                                         // [0x1340978] Event|Public|BlueprintEvent 
};
...
public:
	...
	// void OnPageChanged(int32_t PageNumber, int32_t RewardPageTotal);                                                         // [0x1340978] Event|Public|BlueprintEvent 
	// Function /Script/BattlePassS29UI.BattlePassRewardPageS29.OnLoadingScreenSelectedChanged
	// void OnLoadingScreenSelectedChanged(bool bIsSelected);                                                                   // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/BattlePassS29UI.BattlePassRewardPageS29.OnInputMethodChanged
	// void OnInputMethodChanged(ECommonInputType InputType);                                                                   // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/BattlePassS29UI.BattlePassRewardPageS29.OnInitForPageType
	// void OnInitForPageType(ERewardPageType InRewardPageType);                                                                // [0x1340978] Event|Public|BlueprintEvent 
	// Function /Script/BattlePassS29UI.BattlePassRewardPageS29.HandleRewardTracksBoundaryNavigation
	// class UWidget* HandleRewardTracksBoundaryNavigation(EUINavigation InNavigation);                                         // [0xb4d17d4] Final|Native|Private 
	// Function /Script/BattlePassS29UI.BattlePassRewardPageS29.GetRewardPageBackgroundData
	// FVaultWorldBackgroundData GetRewardPageBackgroundData();                                                                 // [0xb4d14f4] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};

/// Class /Script/BattlePassS29UI.BattlePassScreenS29
/// Size: 0x0518 (0x000948 - 0x000E60)
...
public:
	CMember(class UClass*)                             ResourcePurchaseScreenClass                                 OFFSET(get<T>, {0x948, 8, 0, 0})
	CMember(class UCommonButtonBase*)                  Button_Close                                                OFFSET(get<T>, {0x958, 8, 0, 0})
	CMember(class UCommonButtonLegacy*)                Button_TouchClose                                           OFFSET(get<T>, {0x960, 8, 0, 0})
	CMember(class UCommonButtonBase*)                  Button_ToggleViewDetails                                    OFFSET(get<T>, {0x968, 8, 0, 0})
	CMember(class UCommonButtonBase*)                  Button_ReplayTrailer                                        OFFSET(get<T>, {0x970, 8, 0, 0})
	CMember(class UCommonButtonBase*)                  Button_ReplayTrailer_Mobile                                 OFFSET(get<T>, {0x978, 8, 0, 0})
	CMember(class UCommonButtonBase*)                  Button_ShowAbout                                            OFFSET(get<T>, {0x980, 8, 0, 0})
	CMember(class UCommonButtonBase*)                  Button_ShowAbout_Mobile                                     OFFSET(get<T>, {0x988, 8, 0, 0})
	CMember(class UCommonButtonBase*)                  Button_ShowAboutCustomization                               OFFSET(get<T>, {0x990, 8, 0, 0})
	CMember(class UCommonButtonBase*)                  Button_ShowAboutCustomization_Mobile                        OFFSET(get<T>, {0x998, 8, 0, 0})
	CMember(class UCommonButtonBase*)                  Button_BulkBuyRewards                                       OFFSET(get<T>, {0x9A0, 8, 0, 0})
	CMember(class UCommonButtonBase*)                  Button_PageComplete                                         OFFSET(get<T>, {0x9A8, 8, 0, 0})
	CMember(class UCommonButtonBase*)                  Button_GiftBattlePass                                       OFFSET(get<T>, {0x9B0, 8, 0, 0})
	CMember(class UCommonVisibilitySwitcher*)          VisibilitySwitcher_PlatformBasedButtons                     OFFSET(get<T>, {0x9B8, 8, 0, 0})
	CMember(class UFortBattlePassResourcesWidgetBase*) BattlePassCurrencyPanel                                     OFFSET(get<T>, {0x9C0, 8, 0, 0})
	CMember(class UAthenaExclusiveRewardBanner*)       AthenaExclusiveRewardBanner                                 OFFSET(get<T>, {0x9C8, 8, 0, 0})
	CMember(class UCommonTextBlock*)                   Text_Description                                            OFFSET(get<T>, {0x9D0, 8, 0, 0})
	CMember(class UCommonTextBlock*)                   Text_ItemName                                               OFFSET(get<T>, {0x9D8, 8, 0, 0})
	CMember(class UAthenaRewardItemTypeRarityTag*)     ItemRewardTag                                               OFFSET(get<T>, {0x9E0, 8, 0, 0})
	CMember(class UCommonTextBlock*)                   Text_SetDetails                                             OFFSET(get<T>, {0x9E8, 8, 0, 0})
	CMember(class UWidgetSwitcher*)                    Switcher_PrerequisiteInfo                                   OFFSET(get<T>, {0x9F0, 8, 0, 0})
	CMember(class UCommonTextBlock*)                   Text_Prerequisite                                           OFFSET(get<T>, {0x9F8, 8, 0, 0})
	CMember(class UWidget*)                            Widget_PrerequisiteProgress                                 OFFSET(get<T>, {0xA00, 8, 0, 0})
	CMember(class UWidget*)                            Widget_LevelUpMessageFree                                   OFFSET(get<T>, {0xA08, 8, 0, 0})
	CMember(class UWidget*)                            Widget_LevelUpMessagePremium                                OFFSET(get<T>, {0xA10, 8, 0, 0})
	CMember(class UWidget*)                            Widget_CustomResourceMessage                                OFFSET(get<T>, {0xA18, 8, 0, 0})
	CMember(class UWidgetSwitcher*)                    Switcher_PrimaryAction                                      OFFSET(get<T>, {0xA20, 8, 0, 0})
	CMember(class UFortCTAButton*)                     Button_BuyLevels                                            OFFSET(get<T>, {0xA28, 8, 0, 0})
	CMember(class UFortCTAButton*)                     Button_BuyBattlePass                                        OFFSET(get<T>, {0xA30, 8, 0, 0})
	CMember(class UFortCTAButton*)                     Button_ClaimReward                                          OFFSET(get<T>, {0xA38, 8, 0, 0})
	CMember(class UCommonButtonBase*)                  Button_ViewQuests                                           OFFSET(get<T>, {0xA40, 8, 0, 0})
	CMember(class UCommonButtonBase*)                  Button_PreviewLoadingScreen                                 OFFSET(get<T>, {0xA48, 8, 0, 0})
	CMember(class UFortDynamicEntryBox*)               ItemVMCards                                                 OFFSET(get<T>, {0xA50, 8, 0, 0})
	CMember(class UBorder*)                            Tag_RequiresBP                                              OFFSET(get<T>, {0xA58, 8, 0, 0})
	CMember(class UBorder*)                            Tag_PageLocked                                              OFFSET(get<T>, {0xA60, 8, 0, 0})
	CMember(class UBorder*)                            Tag_BaseItem                                                OFFSET(get<T>, {0xA68, 8, 0, 0})
	CMember(class UBorder*)                            Tag_Prerequisite                                            OFFSET(get<T>, {0xA70, 8, 0, 0})
	CMember(class UBorder*)                            Tag_CompletePage                                            OFFSET(get<T>, {0xA78, 8, 0, 0})
	CMember(class UBorder*)                            Tag_NotEnough_Currency                                      OFFSET(get<T>, {0xA80, 8, 0, 0})
	CMember(class UBorder*)                            Tag_Cost                                                    OFFSET(get<T>, {0xA88, 8, 0, 0})
	CMember(class UBorder*)                            Tag_Owned                                                   OFFSET(get<T>, {0xA90, 8, 0, 0})
	CMember(class UBorder*)                            Tag_Delayed                                                 OFFSET(get<T>, {0xA98, 8, 0, 0})
	SMember(FGameplayTag)                              QuestCategoryParentTag                                      OFFSET(getStruct<T>, {0xAA0, 4, 0, 0})
	CMember(class UClass*)                             PreviewLoadingScreenWidgetClass                             OFFSET(get<T>, {0xAA8, 8, 0, 0})
	...
	// void OverviewShowAnimationFinished();                                                                                    // [0x35e6228] Final|Native|Public|BlueprintCallable 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.OnUpdateStatusBar
	// void OnUpdateStatusBar(FText& StatusText, EBattlePassStatusBarTypeS29& BarType);                                         // [0x1340978] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.OnUpdateOwnedOrEquippedTag
	// void OnUpdateOwnedOrEquippedTag(FText& StatusText);                                                                      // [0x1340978] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.OnUpdateBattlePassRequiredBar
	// void OnUpdateBattlePassRequiredBar(bool bPassRequiredVisible);                                                           // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.OnTransitionItemDetails
	// void OnTransitionItemDetails(bool bTransitionForward);                                                                   // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.OnSetWeeklyRewardsInfo
	// void OnSetWeeklyRewardsInfo(FTimespan& DelayTimespan, int32_t AvailableRewards, int32_t OwnedRewards, int32_t TotalRewards, int32_t AvailablePages, int32_t CompletedPages, int32_t TotalPages); // [0x1340978] Event|Protected|HasOutParms|HasDefaults|BlueprintEvent 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.OnSetWarningToolTip
	// void OnSetWarningToolTip(ERewardWarningTooltipType29& WarningTooltipType, FText& Description);                           // [0x1340978] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.OnSetResourcePrice
	// void OnSetResourcePrice(int32_t Cost, class UFortPersistentResourceItemDefinition* PersistentResource);                  // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.OnSetQuestRewardsInfo
	// void OnSetQuestRewardsInfo(FTimespan& DelayTimespan, int32_t OwnedRewards, int32_t TotalRewards, int32_t CompletedPages, int32_t TotalPages); // [0x1340978] Event|Protected|HasOutParms|HasDefaults|BlueprintEvent 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.OnSetPrerequisiteInfo
	// void OnSetPrerequisiteInfo(FText& Description, int32_t CurrentAmount, int32_t NeededAmount, EBattlePassRewardPrerequisiteType PrerequisiteType, bool bShowPrerequisiteLock); // [0x1340978] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.OnSetItemPrice
	// void OnSetItemPrice(int32_t Cost, EBattlePassCurrencyType CurrencyType);                                                 // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.OnSetEquipButtonEnable
	// void OnSetEquipButtonEnable(bool bIsEnable);                                                                             // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.OnSetCrewInfo
	// void OnSetCrewInfo(bool bIsNextMonthRewards, FText& MonthText, FTimespan& NextMonthlyRewardTimespan, FText& CharacterDisplayName, FText& CharacterDescription); // [0x1340978] Event|Protected|HasOutParms|HasDefaults|BlueprintEvent 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.OnSetCoverPageData
	// void OnSetCoverPageData(FText& Title, FText& Description, bool bPageComplete);                                           // [0x1340978] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.OnSetBonusRewardsInfo
	// void OnSetBonusRewardsInfo(bool bIsUnlocked, int32_t OwnedRewards, int32_t TotalRewards, int32_t CompletedPages, int32_t TotalPages, int32_t ClaimedOutfits, int32_t TotalOutfits); // [0x1340978] Event|Protected|BlueprintEvent 
	...
	// void OnSetBaseRewardsInfo(int32_t OwnedRewards, int32_t TotalRewards, int32_t CompletedPages, int32_t TotalPages);       // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.OnItemVmCardUpdate
	// void OnItemVmCardUpdate(FExpandedItemVM ItemVMs, class UAthenaSeasonItemEntryBase* EntrySelected);                       // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.OnItemDelayed
	// void OnItemDelayed(FTimespan Delay);                                                                                     // [0x1340978] Event|Protected|HasDefaults|BlueprintEvent 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.OnInsufficientResource
	// void OnInsufficientResource(class UFortPersistentResourceItemDefinition* PersistentResource);                            // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.OnInsufficientFunds
	// void OnInsufficientFunds(EBattlePassCurrencyType CurrencyType);                                                          // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.OnGameModeCompatibilityTagUpdate
	// void OnGameModeCompatibilityTagUpdate(class UFortItemVM* FortItem);                                                      // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.OnBattlePassOwned
	// void OnBattlePassOwned();                                                                                                // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.OnBattlePassGiftingAllowed
	// void OnBattlePassGiftingAllowed(bool bGiftingAllowed);                                                                   // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.IsSeasonalCustomizationItemOwned
	// bool IsSeasonalCustomizationItemOwned();                                                                                 // [0xb4d188c] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.HandleSwitcherVisibilityShown
	// void HandleSwitcherVisibilityShown();                                                                                    // [0xb4d1864] Final|Native|Public|BlueprintCallable 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.HandleItemVMCardClicked
	// void HandleItemVMCardClicked(class UFortItemVM* ItemVM, class UAthenaSeasonItemEntryBase* EntrySelected);                // [0xb4d1710] Final|Native|Public|BlueprintCallable 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.HandleFullScreenMapToggled
	// void HandleFullScreenMapToggled(bool bMapVisible);                                                                       // [0xb4d1690] Final|Native|Private 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.HandleClaimRewardComplete
	// void HandleClaimRewardComplete(bool bSuccess, TArray<FString>& OfferTemplateIdList);                                     // [0xb4d15a4] Final|Native|Private|HasOutParms 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.GoBackOneScreen
	// void GoBackOneScreen();                                                                                                  // [0xb4d1590] Final|Native|Public|BlueprintCallable 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.GetQuestPageDelay
	// FTimespan GetQuestPageDelay();                                                                                           // [0xb4d14c8] Final|Native|Protected|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/BattlePassS29UI.BattlePassScreenS29.GetEquipButtonEnable
	// bool GetEquipButtonEnable();                                                                                             // [0xb4d14ac] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void OnStylePointsRewardsSet(int32_t Rewards);                                                                           // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/BattlePassS29UI.FortBattlePassResourcesWidgetS29.OnBattleStarRewardsSet
	// void OnBattleStarRewardsSet(int32_t Rewards);                                                                            // [0x1340978] Event|Protected|BlueprintEvent 
};
