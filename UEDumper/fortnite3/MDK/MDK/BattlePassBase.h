...
public:
	...
	// void EnableTabActions();                                                                                                 // [0xb4be728] Final|Native|Protected|BlueprintCallable 
};
...
public:
	CMember(class UCommonLazyImage*)                   LazyImage_Icon                                              OFFSET(get<T>, {0x1480, 8, 0, 0})
	SMember(FVector2D)                                 ImageSize_Mobile                                            OFFSET(getStruct<T>, {0x1488, 16, 0, 0})


	/// Functions
	// Function /Script/BattlePassBase.FortBattlePassCustomSkinTab.SetIcon
	// void SetIcon(TWeakObjectPtr<UObject*> LazyObject);                                                                       // [0xb4bfd18] Final|Native|Public|BlueprintCallable 
	// Function /Script/BattlePassBase.FortBattlePassCustomSkinTab.BP_ShowBang
	// void BP_ShowBang(bool bShow);                                                                                            // [0x1340978] Event|Public|BlueprintEvent 
};
...
public:
	CMember(EBattlePassView)                           SubPageType                                                 OFFSET(get<T>, {0x1480, 1, 0, 0})
	CMember(EBattlePassFeatures)                       FeatureType                                                 OFFSET(get<T>, {0x1481, 1, 0, 0})
	SMember(FBattlePassLandingPageEntryPreviewInfo)    PreviewInfo                                                 OFFSET(getStruct<T>, {0x1488, 144, 0, 0})
	DMember(bool)                                      bNeedsBattlePass                                            OFFSET(get<bool>, {0x1518, 1, 0, 0})
	CMember(class UFortChallengeBundleScheduleDefinition*) DelayQuestSchedule                                      OFFSET(get<T>, {0x1520, 8, 0, 0})
	DMember(int32_t)                                   DelayDaysSinceSeasonStart                                   OFFSET(get<int32_t>, {0x1528, 4, 0, 0})
	CMember(class UFortItemDefinition*)                RequiredItem                                                OFFSET(get<T>, {0x1530, 8, 0, 0})
	CMember(class UFortBangWrapper_NUI*)               BangWrapper                                                 OFFSET(get<T>, {0x1538, 8, 0, 0})
	DMember(bool)                                      bUsesTelemetry                                              OFFSET(get<bool>, {0x1540, 1, 0, 0})
	SMember(FIntPoint)                                 Telemetry_Size                                              OFFSET(getStruct<T>, {0x1544, 8, 0, 0})
	SMember(FIntPoint)                                 Telemetry_Position                                          OFFSET(getStruct<T>, {0x154C, 8, 0, 0})
	SMember(FBattlePassLandingPageButtonTexts)         DefaultTexts                                                OFFSET(getStruct<T>, {0x1558, 48, 0, 0})
	SMember(FBattlePassLandingPageButtonTexts)         DelayedTexts                                                OFFSET(getStruct<T>, {0x1588, 48, 0, 0})
	SMember(FBattlePassLandingPageButtonTexts)         SubscribedTexts                                             OFFSET(getStruct<T>, {0x15B8, 48, 0, 0})
	SMember(FBattlePassLandingPageButtonDisplayBehaviorData) DisplayBehaviorData                                   OFFSET(getStruct<T>, {0x15E8, 24, 0, 0})


	/// Functions
	// Function /Script/BattlePassBase.BattlePassLandingPageButton.OnSubscriptionTextureLoaded
	// void OnSubscriptionTextureLoaded(class UTexture2D* Texture);                                                             // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/BattlePassBase.BattlePassLandingPageButton.OnSubscriptionOwnershipUpdated
	// void OnSubscriptionOwnershipUpdated(bool bOwnsSubsciption);                                                              // [0x1340978] RequiredAPI|Event|Public|BlueprintEvent 
	// Function /Script/BattlePassBase.BattlePassLandingPageButton.OnShowDisplayDetails
	// void OnShowDisplayDetails();                                                                                             // [0x1340978] RequiredAPI|Event|Public|BlueprintEvent 
	// Function /Script/BattlePassBase.BattlePassLandingPageButton.OnSetTileImageMaterial
	// void OnSetTileImageMaterial(class UMaterialInstance* Material);                                                          // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/BattlePassBase.BattlePassLandingPageButton.OnDisplayDetailsUpdated
	// void OnDisplayDetailsUpdated(FBattlePassLandingPageButtonDisplayDetails& NewDisplayDetails);                             // [0x1340978] Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/BattlePassBase.BattlePassLandingPageButton.GetBattlePassDisplayDetails
	// FBattlePassLandingPageButtonDisplayDetails GetBattlePassDisplayDetails();                                                // [0x29bfe98] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void SetPreviewedTile(int32_t Index);                                                                                    // [0xb4bfe0c] Final|Native|Public|BlueprintCallable 
	// Function /Script/BattlePassBase.FortBattlePassCustomSkinCategoryTile.OnOwnedTilesUpdated
	// void OnOwnedTilesUpdated(int32_t CurrentlyOwnedRewards, int32_t TotalRewards, float CategoryProgress);                   // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/BattlePassBase.FortBattlePassCustomSkinCategoryTile.OnLockedStateChanged
	// void OnLockedStateChanged(bool bCategoryLocked);                                                                         // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/BattlePassBase.FortBattlePassCustomSkinCategoryTile.OnLockedProgressUpdated
	// void OnLockedProgressUpdated(int32_t CurrentlyOwnedBeforeCategory, int32_t TotalRewardsBeforeCategory, float LockedProgress); // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/BattlePassBase.FortBattlePassCustomSkinCategoryTile.FocusTile
	// void FocusTile(int32_t Index);                                                                                           // [0xb4be73c] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void OnRewardCountChanged(int32_t Count);                                                                                // [0x1340978] Event|Public|BlueprintEvent 
	// Function /Script/BattlePassBase.FortBattlePassBulkBuyPageBase.OnPageRangeChanged
	// void OnPageRangeChanged(int32_t FromPage, int32_t ToPage);                                                               // [0x1340978] Event|Public|BlueprintEvent 
	// Function /Script/BattlePassBase.FortBattlePassBulkBuyPageBase.OnCostChanged
	// void OnCostChanged(int32_t Cost);                                                                                        // [0x1340978] Event|Public|BlueprintEvent 
	// Function /Script/BattlePassBase.FortBattlePassBulkBuyPageBase.HandleUserScrolled
	// void HandleUserScrolled(float ScrollAmount);                                                                             // [0xb4bfb10] Final|Native|Protected 
};
...
public:
	...
	// void OnStateChanged(bool bNewIsChecked);                                                                                 // [0x1340978] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// TArray<FSeasonCurrencyMcpData> GetSeasonalCurrencies();                                                                  // [0xb4bea38] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/BattlePassBase.FortBattlePassContext.GetLevelPurchaseDisclaimerText
	// FText GetLevelPurchaseDisclaimerText();                                                                                  // [0xb4be994] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/BattlePassBase.FortBattlePassContext.GetDefaultDisclaimerText
	// FText GetDefaultDisclaimerText();                                                                                        // [0x29be840] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/BattlePassBase.FortBattlePassContext.GetCurrentSeasonNumberAsText
	// FText GetCurrentSeasonNumberAsText(bool bFullText);                                                                      // [0xb4be8c4] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/BattlePassBase.FortBattlePassContext.GetCurrentChapterAsText
	// FText GetCurrentChapterAsText(bool bFullText);                                                                           // [0xb4be7f4] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/BattlePassBase.FortBattlePassContext.CanPurchaseBattlePassLevel
	// bool CanPurchaseBattlePassLevel();                                                                                       // [0xb4be704] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void ShowResourcesInfoModal();                                                                                           // [0xb4c013c] Final|Native|Protected|BlueprintCallable 
	// Function /Script/BattlePassBase.FortBattlePassResourcesWidgetBase.OnShowMoreInfo
	// void OnShowMoreInfo(bool bShouldShowMoreInfo);                                                                           // [0x1340978] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void OnBattlePassInfoUpdated(bool bOwnsBattlePass);                                                                      // [0x1340978] Event|Protected|BlueprintEvent|Const 
};
...
public:
	...
	// void OnUpdatePageUnlockText(FText& PageUnlockText);                                                                      // [0x1340978] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/BattlePassBase.FortBattlePassPurchaseResourcesWidget.OnTotalPriceChanged
	// void OnTotalPriceChanged(int32_t NewPrice);                                                                              // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/BattlePassBase.FortBattlePassPurchaseResourcesWidget.OnPurchaseAmountChanged
	// void OnPurchaseAmountChanged(int32_t NewAmount, int32_t LevelsLeft);                                                     // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/BattlePassBase.FortBattlePassPurchaseResourcesWidget.OnOfferUnavailable
	// void OnOfferUnavailable();                                                                                               // [0x1340978] Event|Protected|BlueprintEvent 
	...
	// bool IsReloadMtxEnabled();                                                                                               // [0xb4bfc8c] Final|Native|Protected|BlueprintCallable 
	// Function /Script/BattlePassBase.FortBattlePassPurchaseResourcesWidget.HandlePurchaseMultiComplete
	// void HandlePurchaseMultiComplete(bool bSuccess, TArray<FPurchasedItemInfo>& PurchasedItems, TArray<FString>& OfferIdList); // [0xb4bf3a0] Final|Native|Private|HasOutParms 
	// Function /Script/BattlePassBase.FortBattlePassPurchaseResourcesWidget.HandlePurchaseComplete
	// void HandlePurchaseComplete(bool bSuccess, TArray<FPurchasedItemInfo>& PurchasedItems, FString OfferId);                 // [0xb4beb60] Final|Native|Private|HasOutParms 
};
...
public:
	...
	// void OnPageUnselected();                                                                                                 // [0x1340978] Event|Public|BlueprintEvent 
	// Function /Script/BattlePassBase.FortBattlePassRewardGrid.OnPageSelected
	// void OnPageSelected();                                                                                                   // [0x1340978] Event|Public|BlueprintEvent 
};
...
public:
	...
	// void OnSetPageType(ERewardPageType PageType);                                                                            // [0x1340978] Event|Public|BlueprintEvent 
	// Function /Script/BattlePassBase.FortBattlePassRewardGridHeader.OnSetPageCustomName
	// void OnSetPageCustomName(FText& CustomName);                                                                             // [0x1340978] Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/BattlePassBase.FortBattlePassRewardGridHeader.OnPageUnlocked
	// void OnPageUnlocked(int32_t PurchasedRewards, int32_t TotalRewards);                                                     // [0x1340978] Event|Public|BlueprintEvent 
	// Function /Script/BattlePassBase.FortBattlePassRewardGridHeader.OnPageNumberSet
	// void OnPageNumberSet(int32_t InPageNumber);                                                                              // [0x1340978] Event|Public|BlueprintEvent 
	// Function /Script/BattlePassBase.FortBattlePassRewardGridHeader.OnPageLocked
	// void OnPageLocked(int32_t RequiredLevel, int32_t RequiredRewards, bool IsTimeLocked, FTimespan TimeRemaining);           // [0x1340978] Event|Public|HasDefaults|BlueprintEvent 
	// Function /Script/BattlePassBase.FortBattlePassRewardGridHeader.OnBattlePassLevelSet
	// void OnBattlePassLevelSet(int32_t BattlePassLevel);                                                                      // [0x1340978] Event|Public|BlueprintEvent 
	// Function /Script/BattlePassBase.FortBattlePassRewardGridHeader.GetPageNumber
	// int32_t GetPageNumber();                                                                                                 // [0xaaf3a00] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	CMember(ERewardPageType)                           RewardPageType                                              OFFSET(get<T>, {0x1520, 1, 0, 0})
	CMember(class USizeBox*)                           SizeBox_Content                                             OFFSET(get<T>, {0x1528, 8, 0, 0})
	CMember(TMap<FName, FLinearColor>)                 TileColors                                                  OFFSET(get<T>, {0x1530, 80, 0, 0})
	SMember(FLinearColor)                              OverlayDimColor                                             OFFSET(getStruct<T>, {0x1580, 16, 0, 0})
	SMember(FVector2D)                                 TileDesiredCellSpan                                         OFFSET(getStruct<T>, {0x1590, 16, 0, 0})
	DMember(float)                                     UnitHeight                                                  OFFSET(get<float>, {0x15A0, 4, 0, 0})
	DMember(float)                                     UnitWidth                                                   OFFSET(get<float>, {0x15A4, 4, 0, 0})


	/// Functions
	// Function /Script/BattlePassBase.FortBattlePassTileBase.SetState
	// void SetState(BattlePassTileAvailabilityStates NewState);                                                                // [0xb4bff88] Final|Native|Protected|BlueprintCallable 
	// Function /Script/BattlePassBase.FortBattlePassTileBase.SetSize
	// void SetSize(EPageItemTileSize TileSize, FVector2D& CellSpacing);                                                        // [0xb4bfeb8] Final|Native|Protected|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/BattlePassBase.FortBattlePassTileBase.OnStateChanged
	// void OnStateChanged(BattlePassTileAvailabilityStates NewState);                                                          // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/BattlePassBase.FortBattlePassTileBase.OnSizeChanged
	// void OnSizeChanged(FVector2D& NewSize);                                                                                  // [0x1340978] Event|Protected|HasOutParms|HasDefaults|BlueprintEvent 
	// Function /Script/BattlePassBase.FortBattlePassTileBase.OnSetTileColors
	// void OnSetTileColors();                                                                                                  // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/BattlePassBase.FortBattlePassTileBase.OnSetRequiresBattlePass
	// void OnSetRequiresBattlePass(bool bRequiresBP);                                                                          // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/BattlePassBase.FortBattlePassTileBase.OnRevealed
	// void OnRevealed();                                                                                                       // [0x1340978] Event|Public|BlueprintEvent 
	// Function /Script/BattlePassBase.FortBattlePassTileBase.OnPeeked
	// void OnPeeked();                                                                                                         // [0x1340978] Event|Public|BlueprintEvent 
	// Function /Script/BattlePassBase.FortBattlePassTileBase.IsOwned
	// bool IsOwned();                                                                                                          // [0xb4bfc70] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/BattlePassBase.FortBattlePassTileBase.IsLocked
	// bool IsLocked();                                                                                                         // [0xb4bfc54] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/BattlePassBase.FortBattlePassTileBase.IsAvailable
	// bool IsAvailable();                                                                                                      // [0xb4bfc38] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/BattlePassBase.FortBattlePassTileBase.GetState
	// BattlePassTileAvailabilityStates GetState();                                                                             // [0xb4beb48] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/BattlePassBase.FortBattlePassTileBase.AreAnyGrantedItemsEquipped
	// bool AreAnyGrantedItemsEquipped();                                                                                       // [0xb4be6d8] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};

/// Class /Script/BattlePassBase.FortBattlePassTile
/// Size: 0x0080 (0x0015E0 - 0x001660)
...
public:
	CMember(class UFortLazyImage*)                     Image_RewardItem                                            OFFSET(get<T>, {0x15F8, 8, 0, 0})
	CMember(class UImage*)                             Image_Currency                                              OFFSET(get<T>, {0x1600, 8, 0, 0})
	CMember(class UImage*)                             Age_Gating_Item                                             OFFSET(get<T>, {0x1608, 8, 0, 0})
	DMember(bool)                                      bIsOnBulkBuyMode                                            OFFSET(get<bool>, {0x1610, 1, 0, 0})


	/// Functions
	// Function /Script/BattlePassBase.FortBattlePassTile.OnUnpreviewed
	// void OnUnpreviewed();                                                                                                    // [0x1340978] Event|Public|BlueprintEvent 
	// Function /Script/BattlePassBase.FortBattlePassTile.OnUnhighlighted
	// void OnUnhighlighted();                                                                                                  // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/BattlePassBase.FortBattlePassTile.OnTilePreviewCycled
	// void OnTilePreviewCycled();                                                                                              // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/BattlePassBase.FortBattlePassTile.OnSetTrack
	// void OnSetTrack(bool bIsFreeTrack, bool bOwnsBattlePass);                                                                // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/BattlePassBase.FortBattlePassTile.OnSetCurrencyAndPrice
	// void OnSetCurrencyAndPrice(EBattlePassCurrencyType Currency, int32_t Price);                                             // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/BattlePassBase.FortBattlePassTile.OnPreviewed
	// void OnPreviewed();                                                                                                      // [0x1340978] Event|Public|BlueprintEvent 
	// Function /Script/BattlePassBase.FortBattlePassTile.OnLockedStateUpdated
	// void OnLockedStateUpdated(bool OwnsBattlePass, bool ParentUnlocked, bool HasRemainingPrerequisites, bool bIsDelayed);    // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/BattlePassBase.FortBattlePassTile.OnLockedProgressUpdated
	// void OnLockedProgressUpdated(float Progress, int32_t CurrentlyOwnedRewards, int32_t NeededRewards);                      // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/BattlePassBase.FortBattlePassTile.OnHighlighted
	// void OnHighlighted();                                                                                                    // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/BattlePassBase.FortBattlePassTile.OnAffordabilityChanged
	// void OnAffordabilityChanged(bool bHasEnougCurrency);                                                                     // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/BattlePassBase.FortBattlePassTile.IsAffordable
	// bool IsAffordable();                                                                                                     // [0xb4bfbb0] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/BattlePassBase.FortBattlePassTile.HasPrerequisites
	// bool HasPrerequisites();                                                                                                 // [0xb4bfb8c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void ShowTooltip();                                                                                                      // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/BattlePassBase.FortBattlePassTutorialTooltip.SetTooltipEnabled
	// void SetTooltipEnabled(bool bEnable);                                                                                    // [0xb4c00bc] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/BattlePassBase.FortBattlePassTutorialTooltip.SetText
	// void SetText(FText Text);                                                                                                // [0xb4c000c] Final|Native|Public|BlueprintCallable 
	// Function /Script/BattlePassBase.FortBattlePassTutorialTooltip.HideTooltip
	// void HideTooltip();                                                                                                      // [0x1340978] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void OnRebootRallyEligibilityUpdated(bool bEligible);                                                                    // [0x1340978] Event|Public|BlueprintEvent 
};
