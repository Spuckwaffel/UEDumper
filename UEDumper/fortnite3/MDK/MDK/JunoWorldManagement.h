...
public:
	SMember(FString)                                   ID                                                          OFFSET(getStruct<T>, {0x0, 16, 0, 0})
	SMember(FJunoWorldGameMetadata)                    Game                                                        OFFSET(getStruct<T>, {0x10, 40, 0, 0})
};
...
public:
	SMember(FJunoWorldMetadata)                        MetaData                                                    OFFSET(getStruct<T>, {0x8, 56, 0, 0})
};
...
enum class EJunoWorldSettingOptions_RecruitedCreaturePermaDeath : uint8_t
{
	...
	EJunoWorldSettingOptions_RecruitedCreaturePermaDeath__EJunoWorldSettingOptions_MAX = 2
};
