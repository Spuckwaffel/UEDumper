...
/// Size: 0x0200 (0x001710 - 0x001910)
class AJunoAIBotController : public AFortAthenaAIBotController
{ 
	friend MDKHandler;
	static inline constexpr uint64_t __MDKClassSize = 6416;

public:
	CMember(class UJunoAIInventoryComponent*)          JunoAIInventoryComponent                                    OFFSET(get<T>, {0x1710, 8, 0, 0})
	CMember(TArray<FItemAndCount>)                     DefaultItemsToAdd                                           OFFSET(get<T>, {0x1718, 16, 0, 0})
	DMember(bool)                                      bRequiresPersistentInventory                                OFFSET(get<bool>, {0x17B1, 1, 0, 0})
	SMember(FScalableFloat)                            EnableDurabilityOnInventory                                 OFFSET(getStruct<T>, {0x17B8, 40, 0, 0})
	SMember(FScalableFloat)                            UseRoleCheckForDurability                                   OFFSET(getStruct<T>, {0x17E0, 40, 0, 0})
	SMember(FGameplayTagQuery)                         RequiredRoleForDurability                                   OFFSET(getStruct<T>, {0x1808, 72, 0, 0})
	DMember(bool)                                      bUseFocusedActorEyeLocationForFocalPoint                    OFFSET(get<bool>, {0x1850, 1, 0, 0})
	DMember(bool)                                      bUseValidItemsPerType                                       OFFSET(get<bool>, {0x1851, 1, 0, 0})
	SMember(FScalableFloat)                            EffectivenessMultiplierForWeaponSelectionOnPickedOrAddedItem OFFSET(getStruct<T>, {0x1858, 40, 0, 0})
	CMember(TMap<FGameplayTag, FValidItemSlotConfiguration>) ValidItemsTablePerType                                OFFSET(get<T>, {0x1880, 80, 0, 0})
	CMember(class UFortItemDefinition*)                AutomaticallyEquippedWeaponOnDurabilityBreak                OFFSET(get<T>, {0x18D0, 8, 0, 0})
	SMember(FScalableFloat)                            DurabilityMultiplier                                        OFFSET(getStruct<T>, {0x18D8, 40, 0, 0})
	SMember(FGameplayTag)                              TagToApplyWhenAddingFallbackItemForDurabilityBreak          OFFSET(getStruct<T>, {0x1900, 4, 0, 0})
};
...
public:
	...
	// void HandleUnconverted(class AFortPawn* UnconvertedPawn, EUnconvertReason UnconvertReason);                              // [0xca657c4] Final|Native|Private 
	// Function /Script/JunoAIRuntime.JunoAIFriendshipPawnComponent.HandleConverted
	// void HandleConverted(class AFortPawn* InstigatorPawn, class AFortPawn* ConvertedPawn);                                   // [0xca65700] Final|Native|Private 
	// Function /Script/JunoAIRuntime.JunoAIFriendshipPawnComponent.GetFriendshipValue
	// float GetFriendshipValue();                                                                                              // [0xca64dcc] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoAIRuntime.JunoAIFriendshipPawnComponent.GetFriendshipState
	// FGameplayTag GetFriendshipState();                                                                                       // [0x89a6658] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoAIRuntime.JunoAIFriendshipPawnComponent.EnableFriendshipChanges
	// bool EnableFriendshipChanges();                                                                                          // [0xca64d74] Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
	// Function /Script/JunoAIRuntime.JunoAIFriendshipPawnComponent.DisableFriendshipChanges
	// bool DisableFriendshipChanges();                                                                                         // [0xca64d50] Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
	// Function /Script/JunoAIRuntime.JunoAIFriendshipPawnComponent.AreFriendshipChangesEnabled
	// bool AreFriendshipChangesEnabled();                                                                                      // [0xca64d38] Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	SMember(FScalableFloat)                            PassiveResourceGatheringTime                                OFFSET(getStruct<T>, {0xBC8, 40, 0, 0})
	SMember(FScalableFloat)                            MultiplierForSimulatedGeneration                            OFFSET(getStruct<T>, {0xBF0, 40, 0, 0})
	SMember(FScalableFloat)                            MaximumAllocableSOPerAIForSimulation                        OFFSET(getStruct<T>, {0xC18, 40, 0, 0})
	SMember(FNavAgentSelector)                         SupportedAgents                                             OFFSET(getStruct<T>, {0xC40, 4, 0, 0})
	SMember(FScalableFloat)                            ShouldCheckWCForRemoteRecruitment                           OFFSET(getStruct<T>, {0xC48, 40, 0, 0})
	SMember(FScalableFloat)                            RequireNPCToBeInVisitorsListForRemoteRecruitment            OFFSET(getStruct<T>, {0xC70, 40, 0, 0})
	SMember(FScalableFloat)                            SpawnDelayFromCampSpawn                                     OFFSET(getStruct<T>, {0xC98, 40, 0, 0})
	SMember(FScalableFloat)                            MinDistanceFromPlayersToAddVisitors                         OFFSET(getStruct<T>, {0xCC0, 40, 0, 0})
	SMember(FScalableFloat)                            MinDistanceFromPlayersToAddFixedNPCs                        OFFSET(getStruct<T>, {0xCE8, 40, 0, 0})


	/// Functions
	// Function /Script/JunoAIRuntime.JunoCampAIManagementComponent.RequestCreatureTemporaryDespawn
	// bool RequestCreatureTemporaryDespawn(FGameplayTag& UniqueAIIdentifier);                                                  // [0xca65888] Final|BlueprintAuthorityOnly|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/JunoAIRuntime.JunoCampAIManagementComponent.HandleAwesomeLevelReady
	// void HandleAwesomeLevelReady(FJunoCampAwesomeStatsData& AwesomeData);                                                    // [0xca6567c] Final|Native|Protected|HasOutParms 
	// Function /Script/JunoAIRuntime.JunoCampAIManagementComponent.HandleAwesomeLevelChanged
	// void HandleAwesomeLevelChanged(FJunoAwesomeLevelChangeData& ChangeData);                                                 // [0xca655f8] Final|Native|Protected|HasOutParms 
	// Function /Script/JunoAIRuntime.JunoCampAIManagementComponent.HandleAISpawned
	// void HandleAISpawned(class AActor* SpawnedAIPawn, class UFortAthenaLivingWorldEventData* EventData);                     // [0xca65534] Final|Native|Protected 
	// Function /Script/JunoAIRuntime.JunoCampAIManagementComponent.HandleAIDespawned
	// void HandleAIDespawned(class AActor* DespawnedAIPawn, class UFortAthenaLivingWorldEventData* EventData);                 // [0xca65470] Final|Native|Protected 
	// Function /Script/JunoAIRuntime.JunoCampAIManagementComponent.HandleAIControllerFullySpawned
	// void HandleAIControllerFullySpawned(class AAIController* Controller, class AFortPawn* Pawn);                             // [0xca65104] Final|Native|Protected 
	// Function /Script/JunoAIRuntime.JunoCampAIManagementComponent.HandleAIControllerChanged
	// void HandleAIControllerChanged(class APawn* Pawn, class AController* OldController, class AController* NewController);   // [0xca64f14] Final|Native|Protected 
	// Function /Script/JunoAIRuntime.JunoCampAIManagementComponent.GetSpawnedAIFromUniqueAIIdentifier
	// class AFortPawn* GetSpawnedAIFromUniqueAIIdentifier(FGameplayTag& UniqueAIIdentifier);                                   // [0xca64de4] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoAIRuntime.JunoCampAIManagementComponent.GetCachedAndReplicatedRecruitmentData
	// FJunoCampAICachedRecruitmentData GetCachedAndReplicatedRecruitmentData();                                                // [0xca64d98] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// bool RecruitToCampIfPossible(FJunoCreatureRecruitmentRequestData& RecruitmentRequestData);                               // [0xca67ae4] Final|RequiredAPI|BlueprintAuthorityOnly|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/JunoAIRuntime.JunoCreaturePawnComponent.OnRep_CachedCustomName
	// void OnRep_CachedCustomName();                                                                                           // [0xca67ad0] Final|Native|Private|Const 
	// Function /Script/JunoAIRuntime.JunoCreaturePawnComponent.NotifyPetting
	// void NotifyPetting(class AFortPawn* Instigator);                                                                         // [0xca67a50] Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
	// Function /Script/JunoAIRuntime.JunoCreaturePawnComponent.NotifyFeeding
	// void NotifyFeeding(class AFortPawn* Instigator, class UFortItemDefinition* ItemBeingFed);                                // [0xca67774] Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
	// Function /Script/JunoAIRuntime.JunoCreaturePawnComponent.HandleUnconverted
	// void HandleUnconverted(class AFortPawn* UnconvertedPawn, EUnconvertReason UnconvertReason);                              // [0xca676b0] Final|Native|Private 
	// Function /Script/JunoAIRuntime.JunoCreaturePawnComponent.HandleDied
	// void HandleDied(class AActor* DamagedActor, float Damage, class AController* InstigatedBy, class AActor* DamageCauser, FVector HitLocation, class UPrimitiveComponent* FHitComponent, FName BoneName, FVector Momentum); // [0xca67218] Final|Native|Private|HasDefaults 
	// Function /Script/JunoAIRuntime.JunoCreaturePawnComponent.HandleConverted
	// void HandleConverted(class AFortPawn* InstigatorPawn, class AFortPawn* ConvertedPawn);                                   // [0xca67154] Final|Native|Private 
	// Function /Script/JunoAIRuntime.JunoCreaturePawnComponent.GetCustomName
	// FText GetCustomName();                                                                                                   // [0xca6711c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoAIRuntime.JunoCreaturePawnComponent.GetAssignedRecruitmentObjectId
	// FGuid GetAssignedRecruitmentObjectId();                                                                                  // [0xca67100] Final|BlueprintAuthorityOnly|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoAIRuntime.JunoCreaturePawnComponent.GetAssignedAndSpawnedRecruitmentObject
	// class UJunoCampRecruitmentObjectComponent* GetAssignedAndSpawnedRecruitmentObject();                                     // [0xca670dc] Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoAIRuntime.JunoCreaturePawnComponent.AssignNewCustomName
	// bool AssignNewCustomName(FText& NewCustomName);                                                                          // [0xca66f20] Final|RequiredAPI|BlueprintAuthorityOnly|Native|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// FGameplayTagContainer GetSoftRemovedReasons();                                                                           // [0xca67138] Final|Native|Private|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoAIRuntime.JunoNPCPawnComponent.GetAIRoleDisplayText
	// FText GetAIRoleDisplayText();                                                                                            // [0xca670a8] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoAIRuntime.JunoNPCPawnComponent.GetAIRole
	// FGameplayTag GetAIRole();                                                                                                // [0x8263938] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoAIRuntime.JunoNPCPawnComponent.ConvertAIRoleToDisplayText
	// FText ConvertAIRoleToDisplayText(FGameplayTag& AIRole);                                                                  // [0xca66fc8] Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	SMember(FScalableFloat)                            MaxNoInteractionTimeForNPCBeforeSoftRemovalInJunoGameTimeHours OFFSET(getStruct<T>, {0xCB0, 40, 0, 0})
	SMember(FScalableFloat)                            TimeBeforeSoftRemovedNPCBecomesHardRemovedInJunoGameTimeHours OFFSET(getStruct<T>, {0xCD8, 40, 0, 0})
	...
	SMember(FScalableFloat)                            TimeBeforeSoftRemovedCreatureBecomesHardRemovedInJunoGameTimeHours OFFSET(getStruct<T>, {0xD50, 40, 0, 0})
	SMember(FScalableFloat)                            MinFriendshipValueBeforeSoftRemoval                         OFFSET(getStruct<T>, {0xD78, 40, 0, 0})
	SMember(FScalableFloat)                            GlobalRecruitableNPCsCap                                    OFFSET(getStruct<T>, {0xDA0, 40, 0, 0})
	SMember(FScalableFloat)                            GlobalRecruitableCreaturesCap                               OFFSET(getStruct<T>, {0xDC8, 40, 0, 0})
	CMember(class UDataTable*)                         BannedDescriptorTagsTable                                   OFFSET(get<T>, {0xDF0, 8, 0, 0})
	CMember(TArray<FJunoAIFollowerManagedData>)        ManagedFollowers                                            OFFSET(get<T>, {0xE28, 16, 0, 0})
	CMember(TScriptInterface<Class>)                   TemporaryGlobalEncounterPointProvider                       OFFSET(get<T>, {0xE38, 16, 0, 0})
	CMember(class UFortAthenaLivingWorldEncounterInstance*) TemporaryGlobalEncounter                               OFFSET(get<T>, {0xE48, 8, 0, 0})
	CMember(TScriptInterface<Class>)                   FTUEEncounterPointProvider                                  OFFSET(get<T>, {0xE50, 16, 0, 0})
	CMember(class UFortAthenaLivingWorldEncounterInstance*) FTUEEncounter                                          OFFSET(get<T>, {0xE60, 8, 0, 0})
	SMember(FWorldConditionQueryState)                 FTUEEndQueryState                                           OFFSET(getStruct<T>, {0xE68, 48, 0, 0})
	CMember(TMap<FGameplayTag, FJunoAIWorldNPCSpawningData>) WorldAssignedNPCs                                     OFFSET(get<T>, {0xF58, 80, 0, 0})


	/// Functions
	// Function /Script/JunoAIRuntime.PlayspaceComponent_Root_JunoAIManagement.HandleFTUENPCSpawned
	// void HandleFTUENPCSpawned(class AActor* FTUENPC, class UFortAthenaLivingWorldEventData* EventData);                      // [0xca675ec] Final|Native|Private 
};
...
public:
	...
	// void OnTimeOfDayPhaseChanged(EFortDayPhase CurrentDayPhase, EFortDayPhase PreviousDayPhase, bool bAtCreation);           // [0xca89310] Final|Native|Protected 
};
...
public:
	...
	// void JunoEnableRecruitedCreaturePermaDeath(bool bEnable);                                                                // [0x64a7494] Final|BlueprintAuthorityOnly|Exec|Native|Private 
	// Function /Script/JunoAIRuntime.JunoAICheatManager.JunoEnableHostileCreatures
	// void JunoEnableHostileCreatures(bool bEnable);                                                                           // [0x64a7494] Final|BlueprintAuthorityOnly|Exec|Native|Private 
	// Function /Script/JunoAIRuntime.JunoAICheatManager.JunoEnableFriendlyNPCs
	// void JunoEnableFriendlyNPCs(bool bEnable);                                                                               // [0x64a7494] Final|BlueprintAuthorityOnly|Exec|Native|Private 
	// Function /Script/JunoAIRuntime.JunoAICheatManager.JunoEnableFriendlyCreatures
	// void JunoEnableFriendlyCreatures(bool bEnable);                                                                          // [0x64a7494] Final|BlueprintAuthorityOnly|Exec|Native|Private 
};
...
enum class EJunoAIFriendshipVerbPawnSubjectRequirement : uint8_t
{
	...
	EJunoAIFriendshipVerbPawnSubjectRequirement__EJunoAIFriendshipVerbPawnSubjectRequirement_MAX = 3
};
