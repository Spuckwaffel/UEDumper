...
public:
	...
	// bool IsValidTarget(class AActor* OwningPlayer, class AActor* PotentialTarget, FGameplayTagContainer& ReasonForFailure);  // [0xbf89898] Final|Native|Protected|HasOutParms|BlueprintCallable 
	// Function /Script/MotherGameplayRuntime.GravityGunTargetTrackingComponent.FindTargetProjectile
	// bool FindTargetProjectile(class AActor* OwningPlayer, FVector& TraceStart, FVector& TraceEnd, float TargetingRadius);    // [0xbf8929c] Final|Native|Protected|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/MotherGameplayRuntime.GravityGunTargetTrackingComponent.FindTargetActor
	// void FindTargetActor(class AActor* OwningPlayer, FVector& TraceStart, FVector& TraceEnd);                                // [0xbf89100] Final|Native|Protected|HasOutParms|HasDefaults|BlueprintCallable 
};
...
public:
	...
	// void UpdatePropIndexEventState(class AActor* ContextActor, FPaddleGingerPropData& Payload);                              // [0xbf89aec] Final|Native|Static|Private|HasOutParms|BlueprintCallable 
	// Function /Script/MotherGameplayRuntime.PropGunFunctionLibrary.UpdatePropActivatedEventState
	// void UpdatePropActivatedEventState(class AActor* ContextActor, FPaddleGingerPropActivatedData& Payload);                 // [0xbf899ec] Final|Native|Static|Private|HasOutParms|BlueprintCallable 
	// Function /Script/MotherGameplayRuntime.PropGunFunctionLibrary.ClearPropIndexEventState
	// void ClearPropIndexEventState(class AActor* ContextActor);                                                               // [0xbf89074] Final|Native|Static|Private|BlueprintCallable 
	// Function /Script/MotherGameplayRuntime.PropGunFunctionLibrary.ClearPropActivatedEventState
	// void ClearPropActivatedEventState(class AActor* ContextActor);                                                           // [0xbf88fe8] Final|Native|Static|Private|BlueprintCallable 
};
...
public:
	...
	// void UpdateAimEndPoint();                                                                                                // [0xbf899d8] Final|Native|Public|BlueprintCallable 
	// Function /Script/MotherGameplayRuntime.ReactorGradeGameplayCue_ChargeUp.OnEndPointUpdated
	// void OnEndPointUpdated(FVector& FoundPoint);                                                                             // [0x1340978] Event|Public|HasOutParms|HasDefaults|BlueprintEvent 
	// Function /Script/MotherGameplayRuntime.ReactorGradeGameplayCue_ChargeUp.GetFoundEndPoint
	// FVector GetFoundEndPoint();                                                                                              // [0xbf89870] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
};
