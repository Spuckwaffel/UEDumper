...
/// Struct /Script/VkEngineTypes.VkModuleVersionDependency
/// Size: 0x0010 (0x000018 - 0x000028)
class FVkModuleVersionDependency : public FVkModuleVersion
{ 
	friend MDKHandler;
	friend MDKBase;
...
public:
	CMember(TArray<FName>)                             References                                                  OFFSET(get<T>, {0x18, 16, 0, 0})
};
...
/// Struct /Script/VkEngineTypes.VkModuleImports
/// Size: 0x0010 (0x000000 - 0x000010)
class FVkModuleImports : public MDKBase
{ 
	friend MDKHandler;
	friend MDKBase;
	static inline constexpr uint64_t __MDKClassSize = 16;
...
public:
	CMember(TArray<FName>)                             References                                                  OFFSET(get<T>, {0x0, 16, 0, 0})
};
...
public:
	...
	CMember(TMap<FString, FVkModuleImports>)           Imports                                                     OFFSET(get<T>, {0x10, 80, 0, 0})
};
...
/// Struct /Script/VkEngineTypes.VkOwnerInfo
/// Size: 0x0020 (0x000000 - 0x000020)
class FVkOwnerInfo : public MDKBase
{ 
	friend MDKHandler;
	friend MDKBase;
	static inline constexpr uint64_t __MDKClassSize = 32;
...
public:
	...
	CMember(TArray<FVkModuleVersionDependency>)        Dependencies                                                OFFSET(get<T>, {0x50, 16, 0, 0})
