...
public:
	...
	// void ServerTriggerAxis(FName AxisName, float Value);                                                                     // [0xb131a88] Final|Net|NetReliableNative|Event|Private|NetServer|NetValidate 
	// Function /Script/EpicGamesEngine.VerseUEInputComponentBase.ServerTriggerAction
	// void ServerTriggerAction(FName ActionName, TEnumAsByte<EInputEvent> InputEvent);                                         // [0xb131828] Final|Net|NetReliableNative|Event|Private|NetServer|NetValidate 
};
