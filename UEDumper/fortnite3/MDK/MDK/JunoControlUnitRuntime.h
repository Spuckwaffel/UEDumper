...
public:
	...
	// void FireEvent_EndControlUnitSession(class AController* PlayerController, class AActor* ControlUnitActor);               // [0xccbf524] Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable 
	// Function /Script/JunoControlUnitRuntime.JunoControlUnitBlueprintLibrary.FireEvent_BeginControlUnitSession
	// void FireEvent_BeginControlUnitSession(class AController* PlayerController, class AActor* ControlUnitActor);             // [0xccbf2dc] Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable 
};
