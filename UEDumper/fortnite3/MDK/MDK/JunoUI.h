...
public:
	...
	// void SetBangVisibility(EJunoBangVisibility BangVisibility);                                                              // [0x1340978] Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Script/JunoUI.JunoBangWidget.SetBangCount
	// void SetBangCount(int32_t NewCount);                                                                                     // [0x1340978] Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Script/JunoUI.JunoBangWidget.OnFreeBuildToggled
	// void OnFreeBuildToggled(bool bFreeBuildEnabled);                                                                         // [0x1340978] Event|Public|BlueprintEvent 
	// Function /Script/JunoUI.JunoBangWidget.IsFreeBuildEnabled
	// bool IsFreeBuildEnabled();                                                                                               // [0xcc52020] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void OnBedAssignmentObjectSet(class UJunoBedAssignmentListObject* NewBedAssignmentListObject);                           // [0x1340978] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// bool IsSelectable();                                                                                                     // [0xcc5208c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoUI.JunoBedAssignmentListObject.IsPlayer
	// bool IsPlayer();                                                                                                         // [0xcc52068] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoUI.JunoBedAssignmentListObject.IsNPC
	// bool IsNPC();                                                                                                            // [0xcc52050] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoUI.JunoBedAssignmentListObject.IsEmpty
	// bool IsEmpty();                                                                                                          // [0xcc51ffc] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoUI.JunoBedAssignmentListObject.GetNPCIcon
	// TWeakObjectPtr<UTexture2D*> GetNPCIcon();                                                                                // [0xcc51dc0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoUI.JunoBedAssignmentListObject.GetNPCGameplayTag
	// FGameplayTag GetNPCGameplayTag();                                                                                        // [0x6ec646c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoUI.JunoBedAssignmentListObject.GetNPCDisplayName
	// FText GetNPCDisplayName();                                                                                               // [0xcc51d84] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoUI.JunoBedAssignmentListObject.GetIsBed
	// bool GetIsBed();                                                                                                         // [0xcc51d2c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoUI.JunoBedAssignmentListObject.GetHasBed
	// bool GetHasBed();                                                                                                        // [0x6881780] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// class UJunoBiomeUIData* GetJunoBIomeUIData();                                                                            // [0xcc51d44] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/JunoUI.JunoBiomeUIData.FindBiomeTypeUIData
	// bool FindBiomeTypeUIData(EJunoBiome& Biome, FJunoBiomeUIDisplayData& OutBiomeUIDisplayData);                             // [0xcc51ba8] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void SetRecipeToAssign(FName InRecipeToAssign);                                                                          // [0xcc520c8] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void OnSelectionChanged(bool bInSelected, FJunoBuildingSlotData& BuildingSlotInitData);                                  // [0x1340978] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoBuildingBarHudSlot.OnBuildingSlotPinned
	// void OnBuildingSlotPinned(bool bIsPinned);                                                                               // [0x1340978] Event|Public|BlueprintEvent 
};
...
public:
	...
	// void OnLeavePreview();                                                                                                   // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoBuildingBarMenuSlot.OnEnterPreview
	// void OnEnterPreview(FJunoBuildingSlotData& InPreviewSlotData);                                                           // [0x1340978] Event|Protected|HasOutParms|BlueprintEvent 
};
...
public:
	...
	// void OnSetBuildingSlotInitData(FJunoBuildingSlotData& BuildingSlotInitData);                                             // [0x1340978] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoBuildingDisplaySlot.OnSelectionChanged
	// void OnSelectionChanged(bool bInSelected);                                                                               // [0x1340978] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void OnRecipeDisplayDataChanged(FText& RecipeDisplayName, class UJunoBuildInstructionsItemDefinition* BuildingItemDefinition); // [0x1340978] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoBuildingIngredientsGroup.OnCanCraftChanged
	// void OnCanCraftChanged(bool bCanCraft);                                                                                  // [0x1340978] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void UpdateRecipeFocus(FName& Recipe);                                                                                   // [0xcc87e10] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/JunoUI.JunoRecipeDetailsWidget.SetCraftingObject
	// void SetCraftingObject(class AActor* InCraftingObject);                                                                  // [0xcc87bd8] Final|Native|Public|BlueprintCallable 
	// Function /Script/JunoUI.JunoRecipeDetailsWidget.OnSetRecipeDetails
	// void OnSetRecipeDetails(FText& Name, EJunoKnowledgeState KnowledgeState, int32_t CraftCount, class UItemDefinitionBase* CraftedItemDef, FText& SourceName, FSlateBrush SourceIcon); // [0x1340978] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoRecipeDetailsWidget.NotifyParentDeactivated
	// void NotifyParentDeactivated();                                                                                          // [0x133f4e8] Native|Public|BlueprintCallable 
	// Function /Script/JunoUI.JunoRecipeDetailsWidget.NotifyParentActivated
	// void NotifyParentActivated();                                                                                            // [0x3145fc4] Native|Public|BlueprintCallable 
	// Function /Script/JunoUI.JunoRecipeDetailsWidget.HandleInventoryChanged
	// void HandleInventoryChanged(FJunoItemSlot& Item, EJunoItemChangeType ChangeType);                                        // [0xcc8755c] Final|Native|Protected|HasOutParms 
	// Function /Script/JunoUI.JunoRecipeDetailsWidget.HandleCraftingSuccess
	// void HandleCraftingSuccess(FCraftingObjectSuccessEvent& Event);                                                          // [0xcc874b4] Final|Native|Protected|HasOutParms 
	// Function /Script/JunoUI.JunoRecipeDetailsWidget.GetCurrentRecipe
	// FName GetCurrentRecipe();                                                                                                // [0x823c7c4] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void SetGuidedBuildIngredientsToPreviewCount(int32_t InGuidedBuildIngredientsToPreviewCount);                            // [0x981bd54] Final|Native|Public|BlueprintCallable 
	// Function /Script/JunoUI.JunoBuildingRecipeDetails.OnLoadingBuildingActorAssetComplete
	// void OnLoadingBuildingActorAssetComplete(FJunoGuidedBuildingUIData GuidedBuildingUIData);                                // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoBuildingRecipeDetails.OnLoadingBuildingActorAsset
	// void OnLoadingBuildingActorAsset();                                                                                      // [0x1340978] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void UpdateHasAdvancedCompassFlag();                                                                                     // [0xcc52210] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void OnUpdateStationCraftingState(EStationInventoryState NewState);                                                      // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoDisassemblingScreen.OnSlotItemSelected
	// void OnSlotItemSelected(class UFortItem* Item);                                                                          // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoDisassemblingScreen.OnDisabledInventoryItemHovered
	// void OnDisabledInventoryItemHovered();                                                                                   // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoDisassemblingScreen.OnCrafringFormulaResultsChanged
	// void OnCrafringFormulaResultsChanged(TArray<FItemAndCount>& CraftingResults);                                            // [0x1340978] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoDisassemblingScreen.HandleCraftingFormulaChanged
	// void HandleCraftingFormulaChanged(class AActor* CraftingObjectActor, FName& NewFormula);                                 // [0xcc53340] Final|Native|Protected|HasOutParms 
};
...
public:
	...
	// void OnProceessingSlotsChanged(int32_t NumberOfOccupiedSlots);                                                           // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoComposterScreen.HandleCraftingProcessesFinished
	// void HandleCraftingProcessesFinished(class AActor* CraftingObjectRaw);                                                   // [0xcc51edc] Final|Native|Private 
	// Function /Script/JunoUI.JunoComposterScreen.HandleCraftingProcessesBlocked
	// void HandleCraftingProcessesBlocked(class AActor* CraftingObjectRaw);                                                    // [0xcc51e60] Final|Native|Private 
};
...
public:
	...
	// void SetNPCStatus(FJunoNPCStateUIData& NPCStateData);                                                                    // [0x1340978] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoConversationMarker.OnParticipantNameChanged
	// void OnParticipantNameChanged(FText& InParticipantName);                                                                 // [0x1340978] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoConversationMarker.OnMessageUpdated
	// void OnMessageUpdated(FText& MessageText);                                                                               // [0x1340978] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoConversationMarker.OnConversationInteractionUpdated
	// void OnConversationInteractionUpdated(EDialogMarkerInteractionState NewInteractionState, bool bNewCanInteract);          // [0x1340978] Event|Protected|BlueprintCallable|BlueprintEvent 
	// Function /Script/JunoUI.JunoConversationMarker.OnCanInteract
	// bool OnCanInteract();                                                                                                    // [0xcc520b0] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoUI.JunoConversationMarker.GetInteractionState
	// EDialogMarkerInteractionState GetInteractionState();                                                                     // [0x78db928] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoUI.JunoConversationMarker.ClearNPCStatus
	// void ClearNPCStatus();                                                                                                   // [0x1340978] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void OnDisplayItemDefLoaded(class UItemDefinitionBase* ResolvedItemDef);                                                 // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoConversationOption.OnDisplayAssetLoaded
	// void OnDisplayAssetLoaded(class UObject* ResolvedAsset);                                                                 // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoConversationOption.OnConversationOptionUpdated
	// void OnConversationOptionUpdated(FClientConversationOptionEntry& InOption);                                              // [0x1340978] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoConversationOption.GetConversationOption
	// FClientConversationOptionEntry GetConversationOption();                                                                  // [0xcc51d10] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void OnParticipantIconChanged(TWeakObjectPtr<UTexture2D*>& Icon);                                                        // [0x1340978] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoConversationScreen.OnConversationStarted
	// void OnConversationStarted();                                                                                            // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoConversationScreen.OnConversationOptionsUpdated
	// void OnConversationOptionsUpdated();                                                                                     // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoConversationScreen.OnConversationMessageUpdated
	// void OnConversationMessageUpdated(FClientConversationMessage& ConversationMessage);                                      // [0x1340978] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoConversationScreen.HandleParticipantIconChanged
	// void HandleParticipantIconChanged(TWeakObjectPtr<UTexture2D*>& Icon);                                                    // [0xcc51f5c] Final|Native|Private|HasOutParms 
	// Function /Script/JunoUI.JunoConversationScreen.EndConversation
	// void EndConversation();                                                                                                  // [0xcc51b94] Final|Native|Protected|BlueprintCallable 
};
...
public:
	...
	// bool ShouldShowSeed();                                                                                                   // [0xcc53c40] Final|Native|Public|BlueprintCallable 
	// Function /Script/JunoUI.JunoDebugWatermark.GetWorldID
	// FString GetWorldID();                                                                                                    // [0xcc53300] Final|Native|Public|BlueprintCallable|Const 
};
...
public:
	...
	// void InitializeEntry(FJunoInputAlternateDisplayText& DisplayText, class UUserWidget* EntryWidget);                       // [0x1340978] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoDynamicControlPromptsWidget.AddEntry
	// void AddEntry(FJunoInputAlternateDisplayText& DisplayText);                                                              // [0xcc531b4] Final|Native|Protected|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// void SelectInventorySlot(class UJunoInventorySlot* InventorySlot);                                                       // [0xcc53778] Final|Native|Private 
	// Function /Script/JunoUI.JunoEnchantmentScreen.RequestBackout
	// void RequestBackout();                                                                                                   // [0xcc53710] Final|Native|Protected|BlueprintCallable 
	// Function /Script/JunoUI.JunoEnchantmentScreen.OnRecipeEntrySelected
	// void OnRecipeEntrySelected(class UFortAlterationItemDefinition* PreviewEnchantment);                                     // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoEnchantmentScreen.OnRecipeEntryHovered
	// void OnRecipeEntryHovered(class UFortAlterationItemDefinition* PreviewEnchantment);                                      // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoEnchantmentScreen.OnItemEnchanted
	// void OnItemEnchanted(class UFortItem* Item, class UFortItemDefinition* PreviewAlteration, int32_t UpdatedAlterationIndex); // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoEnchantmentScreen.OnInventoryItemHovered
	// void OnInventoryItemHovered(class UFortItem* HoveredInventoryItem);                                                      // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoEnchantmentScreen.OnInventoryItemChosen
	// void OnInventoryItemChosen(class UFortItem* ChosenInventoryItem);                                                        // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoEnchantmentScreen.OnInputMethodChanged
	// void OnInputMethodChanged(ECommonInputType NewInputType);                                                                // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoEnchantmentScreen.OnEnchantmentStationHeaderData
	// void OnEnchantmentStationHeaderData(FJunoCraftingStationUIDataEntry& InEntry);                                           // [0x1340978] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoEnchantmentScreen.OnEnchantButtonStateChanged
	// void OnEnchantButtonStateChanged(EJunoEnchantButtonState InButtonState);                                                 // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoEnchantmentScreen.OnEnchantableItemSlotsCreated
	// void OnEnchantableItemSlotsCreated(bool bNothingToEnchant);                                                              // [0x1340978] Event|Protected|BlueprintEvent 
	...
	// void HandleCraftingSuccess(FCraftingObjectSuccessEvent& Event);                                                          // [0xcc53410] Final|Native|Private|HasOutParms 
	// Function /Script/JunoUI.JunoEnchantmentScreen.GetCurrentScreenState
	// EJunoEnchantmentScreenState GetCurrentScreenState();                                                                     // [0xcc532e8] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoUI.JunoEnchantmentScreen.CancelEnchanting
	// void CancelEnchanting();                                                                                                 // [0xcc53250] Final|Native|Protected|BlueprintCallable 
};
...
public:
	...
	// void SetUpdatedEnchantmentIndex(int32_t UpdatedIndex);                                                                   // [0xcc53b90] Final|Native|Public|BlueprintCallable 
	// Function /Script/JunoUI.JunoEnchantmentsWidget.SetRepresentedItem
	// void SetRepresentedItem(class UFortItem* InRepresentedItem);                                                             // [0xcc539ac] Final|Native|Public|BlueprintCallable 
	// Function /Script/JunoUI.JunoEnchantmentsWidget.SetPreviewEnchantment
	// void SetPreviewEnchantment(class UFortAlterationItemDefinition* InEnchantment);                                          // [0xcc538d8] Final|Native|Public|BlueprintCallable 
	// Function /Script/JunoUI.JunoEnchantmentsWidget.OnEnchantmentsUpdated
	// void OnEnchantmentsUpdated(bool bHasEnchantments);                                                                       // [0x1340978] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void OnRepresentedItemChanged();                                                                                         // [0x1340978] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void ResetFocusToPlayer();                                                                                               // [0xcc53754] Final|Native|Protected|BlueprintCallable 
	// Function /Script/JunoUI.JunoFullScreenMap.IsMapTabAllowed
	// bool IsMapTabAllowed();                                                                                                  // [0xcc53680] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void OnInitDataSet(class UJunoHudMenuBaseInitData* InInitData);                                                          // [0x1340978] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// int32_t GetNumUnviewedItems();                                                                                           // [0x88b0b14] Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
};
...
public:
	...
	// void OnSetIngredientData(TWeakObjectPtr<UTexture2D*>& Icon, EFortRarity ItemRarity, int32_t EntryIndex, FText& ItemDescription); // [0x1340978] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoIngredientWidget.OnSetIngredientCounts
	// void OnSetIngredientCounts(int32_t OwnedCount, int32_t RequiredCount);                                                   // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoIngredientWidget.OnSetHasEnough
	// void OnSetHasEnough(bool bHasEnough);                                                                                    // [0x1340978] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void UpdateItemDisplay(class UFortItemDefinition* FortItemDefinition);                                                   // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoItemSpawnerEntrySlot.OnLeaveContextMenuMode
	// void OnLeaveContextMenuMode();                                                                                           // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoItemSpawnerEntrySlot.OnEnterContextMenuMode
	// void OnEnterContextMenuMode(bool bIsCurrentlySelectedSlot);                                                              // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoItemSpawnerEntrySlot.HandleOnMenuOpenChanged
	// void HandleOnMenuOpenChanged(bool bIsOpen);                                                                              // [0xcc534b8] Final|Native|Private 
	// Function /Script/JunoUI.JunoItemSpawnerEntrySlot.GetContextMenu
	// class UUserWidget* GetContextMenu();                                                                                     // [0xcc532c4] Final|Native|Private 
};
...
public:
	...
	// void UpdateItemDetails(class UFortItemDefinition* FortItemDefinition);                                                   // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoItemSpawnerScreen.HandleTabSelected
	// void HandleTabSelected(FName TabID);                                                                                     // [0xcc53538] Final|Native|Private 
};
...
public:
	...
	// void OnSetTitleAndDescription(FText& Title, FText& Description);                                                         // [0x1340978] Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoSelectionModal.OnSelectionButtonCreated
	// void OnSelectionButtonCreated(class UCommonButtonBase* NewButton, FText& SelectionTitle);                                // [0x1340978] Event|Public|HasOutParms|BlueprintEvent 
};
...
public:
	...
	// void OnBuildingHealthChanged();                                                                                          // [0xcc55ec4] Final|Native|Protected 
	// Function /Script/JunoUI.JunoNPCStatusWidgetBase.OnActorHealthChanged
	// void OnActorHealthChanged(float NewHealth, float NewMaxHealth);                                                          // [0xcc55d7c] Final|Native|Protected 
};
...
public:
	...
	// void OpenSidebar();                                                                                                      // [0xcc5612c] Final|Native|Public|BlueprintCallable 
	// Function /Script/JunoUI.JunoPlayerManagementScreen.HandleBackButtonClicked
	// void HandleBackButtonClicked();                                                                                          // [0xcc5519c] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void OnQuickBuildSlotSelected(FJunoQuickBuildSlotData& SelectedQuickBuildSlotData);                                      // [0x1340978] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoQuickBuildRadialPicker.CancelSelection
	// void CancelSelection();                                                                                                  // [0x42a8120] Final|Native|Protected|BlueprintCallable 
	// Function /Script/JunoUI.JunoQuickBuildRadialPicker.ApplyCurrentSelection
	// void ApplyCurrentSelection();                                                                                            // [0xcc54ca4] Final|Native|Protected|BlueprintCallable 
};
...
public:
	...
	// void ViewRecipe();                                                                                                       // [0xcc565b4] Final|Native|Protected|BlueprintCallable 
	// Function /Script/JunoUI.JunoRecipeListEntry.SetPartsRemaining
	// void SetPartsRemaining(FJunoGuidedBuildRemainingPartsInfo& RemainingParts);                                              // [0xcc5639c] Native|Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoRecipeListEntry.OnUpdateListEntryVisuals
	// void OnUpdateListEntryVisuals();                                                                                         // [0x1340978] Event|Public|BlueprintEvent 
	// Function /Script/JunoUI.JunoRecipeListEntry.OnUpdateBangVisibility
	// void OnUpdateBangVisibility(EJunoBangVisibility BangType);                                                               // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoRecipeListEntry.OnSetRecipeInfo
	// void OnSetRecipeInfo(class UItemDefinitionBase* CraftedItemDef, int32_t CraftCount, FSlateBrush& SourceIcon);            // [0x1340978] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoRecipeListEntry.OnRecipePinned
	// void OnRecipePinned(bool bIsPinned);                                                                                     // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoRecipeListEntry.OnLeaveContextMenuMode
	// void OnLeaveContextMenuMode(bool bUnselectSlot);                                                                         // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoRecipeListEntry.OnInitWidgetComplete
	// void OnInitWidgetComplete();                                                                                             // [0x1340978] Event|Protected|BlueprintEvent 
	...
	// void OnCurrentStageUpdate(FGuidedBuildingUpdate& UpdateData);                                                            // [0xcc55ed8] Native|Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoRecipeListEntry.GetPopupMenu
	// class UUserWidget* GetPopupMenu();                                                                                       // [0xcc54d3c] Final|Native|Protected 
	// Function /Script/JunoUI.JunoRecipeListEntry.GetKnowledgeState
	// EJunoKnowledgeState GetKnowledgeState();                                                                                 // [0xcc54cd8] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoUI.JunoRecipeListEntry.GetCanCraft
	// bool GetCanCraft();                                                                                                      // [0xcc54cc0] Final|Native|Protected|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// void OnUpdateCraftingStationAttachedRecipe(FText& NewAttachedRecipe);                                                    // [0x1340978] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoStandaloneCraftingContainer.OnSetCraftingStationUIEntry
	// void OnSetCraftingStationUIEntry(FJunoCraftingStationUIDataEntry CraftingStationUIEntry);                                // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoStandaloneCraftingContainer.OnRecipeCraftingComplete
	// void OnRecipeCraftingComplete(class UItemDefinitionBase* Item);                                                          // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoStandaloneCraftingContainer.HandleCraftingSuccess
	// void HandleCraftingSuccess(FCraftingObjectSuccessEvent& Event);                                                          // [0xcc556b4] Final|Native|Private|HasOutParms 
	// Function /Script/JunoUI.JunoStandaloneCraftingContainer.HandleCraftingStationRecipeChanged
	// void HandleCraftingStationRecipeChanged(FName FormulaRowName);                                                           // [0xcc5556c] Final|Native|Private 
	// Function /Script/JunoUI.JunoStandaloneCraftingContainer.HandleCraftingObjectDeath
	// void HandleCraftingObjectDeath(float Damage, FGameplayTagContainer& DamageTags, FVector Momentum, FHitResult& HitInfo, class AFortPawn* InstigatedBy, class AActor* DamageCauser, FGameplayEffectContextHandle EffectContext); // [0xcc551e4] Final|Native|Private|HasOutParms|HasDefaults 
};
...
public:
	...
	// void OnUpdateCraftButton(EJunoCraftButtonState InButtonState, bool bIsStationUpgrade);                                   // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoStationUpgradeScreen.OnSetCurrentCraftingRecipeIcon
	// void OnSetCurrentCraftingRecipeIcon(TWeakObjectPtr<UTexture2D*>& UpgradeIcon);                                           // [0x1340978] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoStationUpgradeScreen.HandleCraftingSuccess
	// void HandleCraftingSuccess(FCraftingObjectSuccessEvent& Event);                                                          // [0xcc5575c] Native|Protected|HasOutParms 
};
...
public:
	...
	// bool ShouldShowUnacquiredBang(class APlayerController* PlayerController, FName RecipeRowName);                           // [0xcc56438] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/JunoUI.JunoUIFunctionLibrary.RemoveModalScene
	// void RemoveModalScene(class APlayerController* PlayerController);                                                        // [0xcc561b0] Final|RequiredAPI|Native|Static|Public|BlueprintCallable 
	// Function /Script/JunoUI.JunoUIFunctionLibrary.OpenItemShop
	// void OpenItemShop(class AFortPlayerController* PC);                                                                      // [0xcc55f6c] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/JunoUI.JunoUIFunctionLibrary.NumUnviewedRecipesInCategory
	// int32_t NumUnviewedRecipesInCategory(FCountUnviewedRecipesInCategoryArgs& InArgs);                                       // [0xcc55ce4] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/JunoUI.JunoUIFunctionLibrary.NumUnviewedItemsInInventory
	// int32_t NumUnviewedItemsInInventory(class AFortPlayerController* PlayerController);                                      // [0xcc559ac] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/JunoUI.JunoUIFunctionLibrary.NumUnviewedItemsInGroup
	// int32_t NumUnviewedItemsInGroup(class AFortPlayerController* PlayerController, FGameplayTag& GroupTag);                  // [0xcc55808] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/JunoUI.JunoUIFunctionLibrary.GetRecipesFromCraftingObject
	// TArray<FName> GetRecipesFromCraftingObject(class AFortPlayerController* PlayerController, class AActor* CraftingObject, FGameplayTag& CategoryTag, FGameplayTag& SubCategoryTag, bool bOnlyKnownRecipes, bool bOnlyOwnedRecipes); // [0xcc54e88] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/JunoUI.JunoUIFunctionLibrary.GetRecipeCategoryUIData
	// FJunoCraftingCategoryUIDataEntry GetRecipeCategoryUIData(FGameplayTag& CategoryTag);                                     // [0xcc54d60] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/JunoUI.JunoUIFunctionLibrary.AddModalScene
	// void AddModalScene(class APlayerController* PlayerController, FJunoModalSceneOperation& ModalScene);                     // [0xcc54be0] Final|RequiredAPI|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// void SetAwesomePointsInfo(int32_t CurrentAwesomePoints, int32_t RequiredAwesomePoints, int32_t InEntryIndex, int32_t CurrentAwesomeLevel, FColor MapMarkerColor); // [0xcc56220] RequiredAPI|Native|Event|Public|HasDefaults|BlueprintEvent 
};
...
public:
	...
	// void OnAwesomeLevelChanged(FJunoAwesomeLevelChangeData& LevelChangeData);                                                // [0xcc55e40] Final|Native|Protected|HasOutParms 
};
...
public:
	...
	SMember(FJunoVillageUIData)                        ParentVillageUIData                                         OFFSET(getStruct<T>, {0x14F8, 536, 0, 0})


	/// Functions
	// Function /Script/JunoUI.JunoVillageRewardEntry.SetVillageRewardEntryInfo
	// void SetVillageRewardEntryInfo(FJunoVillageRewardEntryInfo& InVillageRewardEntryInfo, FJunoVillageUIData& InParentVillageUIData); // [0xcc87cd8] Native|Event|Public|HasOutParms|BlueprintEvent 
};
...
public:
	...
	// void OnNotifySlotReleased();                                                                                             // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoAdjustableInventorySlot.OnIncreaseEventHandled
	// void OnIncreaseEventHandled();                                                                                           // [0x1340978] Event|Public|BlueprintEvent 
	// Function /Script/JunoUI.JunoAdjustableInventorySlot.OnDecreaseEventHandled
	// void OnDecreaseEventHandled();                                                                                           // [0x1340978] Event|Public|BlueprintEvent 
	// Function /Script/JunoUI.JunoAdjustableInventorySlot.OnButtonsStateUpdated
	// void OnButtonsStateUpdated();                                                                                            // [0x1340978] Event|Public|BlueprintEvent 
};
...
public:
	...
	// void ShowItemDetails(bool bShow);                                                                                        // [0x1340978] Event|Public|BlueprintEvent 
	// Function /Script/JunoUI.JunoInventorySlot.OnStackCountChanged
	// void OnStackCountChanged(int32_t StackCount, int32_t MaxStackCount);                                                     // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoInventorySlot.OnShowSelected
	// void OnShowSelected(bool bInSelected);                                                                                   // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoInventorySlot.OnPreviewStackCountChanged
	// void OnPreviewStackCountChanged(int32_t StackCount, int32_t MaxStackCount);                                              // [0x1340978] Event|Public|BlueprintEvent 
	// Function /Script/JunoUI.JunoInventorySlot.OnPreviewImageChanged
	// void OnPreviewImageChanged(TWeakObjectPtr<UTexture2D*>& SlotImage, bool bIsValidItem, TWeakObjectPtr<UObject*>& InInventoryGroupIcon, TWeakObjectPtr<UTexture2D*>& InMatchingItemIcon, EFortRarity ItemRarity); // [0x1340978] Event|Protected|HasOutParms|BlueprintEvent 
	...
	// void OnLeaveSwappingMode();                                                                                              // [0x1340978] Event|Protected|BlueprintEvent 
	...
	// void OnItemHasBeenViewed(bool bHasBeenPreviouslyViewed);                                                                 // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoInventorySlot.OnEnterSwappingMode
	// void OnEnterSwappingMode(EJunoSwapItemType InSwapItemType, class UFortItem* Item);                                       // [0x1340978] Event|Protected|BlueprintEvent 
	...
	// void OnEnchantmentsChanged(int32_t TotalSlots, int32_t OccupiedSlots);                                                   // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoInventorySlot.OnEnabledForScreenChanged
	// void OnEnabledForScreenChanged(bool bEnabledForScreen);                                                                  // [0x1340978] Event|Public|BlueprintEvent 
	// Function /Script/JunoUI.JunoInventorySlot.OnDurabilityChanged
	// void OnDurabilityChanged(float CurrentDurability, float MaxDurability, float NormalizedDurability, bool bFromItemInitializtion); // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoInventorySlot.HandleOnMenuOpenChanged
	// void HandleOnMenuOpenChanged(bool bIsOpen);                                                                              // [0xcc87748] Final|Native|Private 
	// Function /Script/JunoUI.JunoInventorySlot.GetSlotTags
	// FGameplayTagContainer GetSlotTags();                                                                                     // [0xcc87160] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoUI.JunoInventorySlot.GetRepresentedItem
	// class UFortItem* GetRepresentedItem();                                                                                   // [0xcc86e14] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoUI.JunoInventorySlot.GetPopupMenu
	// class UUserWidget* GetPopupMenu();                                                                                       // [0xcc86c28] Final|Native|Private 
	// Function /Script/JunoUI.JunoInventorySlot.GetMatchingItemGameplayTags
	// FGameplayTagContainer GetMatchingItemGameplayTags();                                                                     // [0xcc86b10] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoUI.JunoInventorySlot.GetIsEnabledForScreen
	// bool GetIsEnabledForScreen();                                                                                            // [0xcc86af8] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void OnInventorySlotChanged();                                                                                           // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoInventorySlotsInfo.GetNumInventorySlots
	// int32_t GetNumInventorySlots(bool bOccupied);                                                                            // [0xcc86b98] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoUI.JunoInventorySlotsInfo.GetMaxInventorySlotsAvailable
	// int32_t GetMaxInventorySlotsAvailable();                                                                                 // [0xcc86b4c] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// bool GetIsRecipeBeingCrafted();                                                                                          // [0xc0230c4] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void OnRecipeListUpdated();                                                                                              // [0x1340978] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void OnStartLoadingData();                                                                                               // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoBedAssignmentScreen.OnSelectionChanged
	// void OnSelectionChanged(class UJunoBedAssignmentListObject* InSelectedListObject);                                       // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoBedAssignmentScreen.OnModalConfirmed
	// void OnModalConfirmed();                                                                                                 // [0xcc87bc4] Final|Native|Protected 
	// Function /Script/JunoUI.JunoBedAssignmentScreen.OnModalCancelled
	// void OnModalCancelled();                                                                                                 // [0xcc8729c] Final|Native|Protected 
	// Function /Script/JunoUI.JunoBedAssignmentScreen.OnDataLoadingComplete
	// void OnDataLoadingComplete();                                                                                            // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoBedAssignmentScreen.GetTypeFromListObject
	// EJunoBedAssignmentActionType GetTypeFromListObject(class UJunoBedAssignmentListObject* InSelectedListObject);            // [0x94956bc] Native|Event|Protected|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /Script/JunoUI.JunoBedAssignmentScreen.GetShouldShowModal
	// bool GetShouldShowModal(class UJunoBedAssignmentListObject* InSelectedListObject);                                       // [0xcc870cc] Native|Event|Protected|BlueprintEvent|Const 
};
...
public:
	...
	// void OnSecondaryCategoriesChanged(bool bHasSecondaryCategories);                                                         // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoBuildingScreen.OnRecipeHovered
	// void OnRecipeHovered();                                                                                                  // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoBuildingScreen.OnGuidedBuildingSnapsUpdated
	// void OnGuidedBuildingSnapsUpdated(TArray<int32_t>& UpdatedSnaps);                                                        // [0xcc87b30] Final|Native|Private|HasOutParms 
	// Function /Script/JunoUI.JunoBuildingScreen.OnGuidedBuildingSetComplete
	// void OnGuidedBuildingSetComplete(FGuidedBuildingUpdate& UpdateData);                                                     // [0xcc87aac] Final|Native|Private|HasOutParms 
	// Function /Script/JunoUI.JunoBuildingScreen.HasPreviewRecipe
	// bool HasPreviewRecipe();                                                                                                 // [0xcc87a90] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoUI.JunoBuildingScreen.HandleShopClicked
	// void HandleShopClicked();                                                                                                // [0xcc87a7c] Final|Native|Private 
	// Function /Script/JunoUI.JunoBuildingScreen.HandleSecondaryTabTransitionComplete
	// void HandleSecondaryTabTransitionComplete();                                                                             // [0xcc87a58] Final|Native|Protected|BlueprintCallable 
	// Function /Script/JunoUI.JunoBuildingScreen.HandleSecondaryCategorySelected
	// void HandleSecondaryCategorySelected(FName TabID);                                                                       // [0xcc87910] Final|Native|Private 
	// Function /Script/JunoUI.JunoBuildingScreen.HandlePrimaryCategorySelected
	// void HandlePrimaryCategorySelected(FName TabID);                                                                         // [0xcc877c8] Final|Native|Private 
	// Function /Script/JunoUI.JunoBuildingScreen.HandleBackClicked
	// void HandleBackClicked();                                                                                                // [0x80aad48] Native|Protected|BlueprintCallable 
	// Function /Script/JunoUI.JunoBuildingScreen.GetWidgetFromItem
	// class UJunoRecipeListEntry* GetWidgetFromItem(class UObject* Item);                                                      // [0xcc871a4] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoUI.JunoBuildingScreen.GetSecondaryCategoryUIData
	// bool GetSecondaryCategoryUIData(FName PrimaryTabId, FName SecondaryTabId, FJunoCraftingSubCategoryUIDataEntry& OutSecondaryCategoryUIData); // [0xcc86e2c] Final|Native|Protected|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoUI.JunoBuildingScreen.GetPrimaryCategoryUIData
	// bool GetPrimaryCategoryUIData(FName PrimaryTabId, FJunoCraftingCategoryUIDataEntry& OutPrimaryCategoryUIData);           // [0xcc86c4c] Final|Native|Protected|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoUI.JunoBuildingScreen.GetCraftingObject
	// class AActor* GetCraftingObject();                                                                                       // [0xcc8692c] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void OnWithdrawStateUpdated(bool bWithdrawEnabled);                                                                      // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoCraftingScreen.OnUpdateSelectRecipeButton
	// void OnUpdateSelectRecipeButton(ESelectRecipeButtonState InButtonState);                                                 // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoCraftingScreen.OnUpdatePassiveCraftingProgress
	// void OnUpdatePassiveCraftingProgress(int32_t ItemsToCraft);                                                              // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoCraftingScreen.OnUpdateCraftingStationInventoryState
	// void OnUpdateCraftingStationInventoryState(ECraftingStationsInventoryState StationInventoryState);                       // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoCraftingScreen.OnUpdateCraftButton
	// void OnUpdateCraftButton(EJunoCraftButtonState InButtonState);                                                           // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoCraftingScreen.OnPassiveScreenFocusChange
	// void OnPassiveScreenFocusChange(bool bInputSlotsFocused);                                                                // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoCraftingScreen.HandleCraftingSuccess
	// void HandleCraftingSuccess(FCraftingObjectSuccessEvent& Event);                                                          // [0xcc8740c] Final|Native|Protected|HasOutParms 
	// Function /Script/JunoUI.JunoCraftingScreen.HandleCategorySelected
	// void HandleCategorySelected(FName TabID);                                                                                // [0xcc872c4] Final|Native|Protected 
	// Function /Script/JunoUI.JunoCraftingScreen.HandleAttachNewRecipeConfirmed
	// void HandleAttachNewRecipeConfirmed();                                                                                   // [0xcc872b0] Final|Native|Private 
	// Function /Script/JunoUI.JunoCraftingScreen.HandleAttachNewRecipeCancelled
	// void HandleAttachNewRecipeCancelled();                                                                                   // [0xcc8729c] Final|Native|Private 
	// Function /Script/JunoUI.JunoCraftingScreen.ForceCloseCraftingScreen
	// void ForceCloseCraftingScreen();                                                                                         // [0xcc86918] Final|Native|Private 
};
...
public:
	...
	// class UJunoProcessingSlot* GetInventorySlot(int32_t RowIndex, int32_t ColumnIndex);                                      // [0xcc86a38] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void OnNotifySlotReleased();                                                                                             // [0x1340978] Event|Public|BlueprintEvent 
	// Function /Script/JunoUI.JunoProcessingSlot.OnItemRemoved
	// void OnItemRemoved();                                                                                                    // [0x1340978] Event|Public|BlueprintEvent 
	// Function /Script/JunoUI.JunoProcessingSlot.OnItemAdded
	// void OnItemAdded();                                                                                                      // [0x1340978] Event|Public|BlueprintEvent 
	// Function /Script/JunoUI.JunoProcessingSlot.GetRepresentedItem
	// class UFortItem* GetRepresentedItem();                                                                                   // [0xc9396e8] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void OnSetGroupName(FText& InGroupName);                                                                                 // [0x1340978] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoInventoryGroup.GetInventorySlot
	// class UJunoInventorySlot* GetInventorySlot(int32_t RowIndex, int32_t ColumnIndex);                                       // [0xcc86978] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoUI.JunoInventoryGroup.GetFirstSlot
	// class UJunoInventorySlot* GetFirstSlot();                                                                                // [0xcc86954] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void OnInventoryObjectUpdated(bool bInventoryObjectPresent);                                                             // [0x1340978] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// bool ShouldShowPlayersTab();                                                                                             // [0xcc53c40] Final|Native|Public|BlueprintCallable|Const 
};
...
public:
	...
	// void OnUpdateTeamPlayerEntry(class UUserWidget* EntryWidget, FUniqueNetIdRepl PlayerUniqueNetId, FString PlayerName);    // [0x1340978] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void OnEntryInitialized(FJunoMapMarkerEntryInitData EntryInitData);                                                      // [0x1340978] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void SetPreviewMarkerMaterial();                                                                                         // [0x1340978] Event|Public|BlueprintEvent 
	...
	// FText GetRandomName();                                                                                                   // [0xccbd50c] Final|Native|Protected|BlueprintCallable 
};

/// Class /Script/JunoUI.JunoVillageScreenBase
/// Size: 0x0270 (0x000408 - 0x000678)
...
public:
	...
	SMember(FJunoVillageUIData)                        VillageUIData                                               OFFSET(getStruct<T>, {0x448, 536, 0, 0})
	CMember(class AJunoCampActor*)                     CampActor                                                   OFFSET(get<T>, {0x660, 8, 0, 0})
	CMember(class UJunoCampMembershipActorComponent*)  CampMembershipActorComponent                                OFFSET(get<T>, {0x668, 8, 0, 0})
	CMember(class UJunoAwesomeLevelComponent*)         AwesomeLevelComponent                                       OFFSET(get<T>, {0x670, 8, 0, 0})


	/// Functions
	// Function /Script/JunoUI.JunoVillageScreenBase.OnVillageDataChanged
	// void OnVillageDataChanged();                                                                                             // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoVillageScreenBase.OnAwesomePointsModified
	// void OnAwesomePointsModified(FJunoAwesomePointModificationData& PointModificationData);                                  // [0xccbd8a8] RequiredAPI|Native|Protected|HasOutParms 
	// Function /Script/JunoUI.JunoVillageScreenBase.OnAwesomeLevelChanged
	// void OnAwesomeLevelChanged(FJunoAwesomeLevelChangeData& LevelChangeData);                                                // [0xccbd814] RequiredAPI|Native|Protected|HasOutParms 
	// Function /Script/JunoUI.JunoVillageScreenBase.BP_OnAwesomePointsChanged
	// void BP_OnAwesomePointsChanged(FJunoAwesomePointModificationData& Data);                                                 // [0x1340978] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoVillageScreenBase.BP_OnAwesomeLevelChanged
	// void BP_OnAwesomeLevelChanged(FJunoAwesomeLevelChangeData& Data);                                                        // [0x1340978] Event|Protected|HasOutParms|BlueprintEvent 
};

/// Class /Script/JunoUI.JunoVillageDetailsScreen
/// Size: 0x0088 (0x000678 - 0x000700)
...
public:
	CMember(class UCommonButtonBase*)                  Button_RemoveVillage                                        OFFSET(get<T>, {0x678, 8, 0, 0})
	CMember(class UCommonButtonGroupBase*)             ButtonGroup_AllRewards                                      OFFSET(get<T>, {0x680, 8, 0, 0})
	CMember(class UDynamicEntryBox*)                   RewardList                                                  OFFSET(get<T>, {0x688, 8, 0, 0})
	CMember(class UJunoVillageRewardEntry*)            LastHoveredEntry                                            OFFSET(get<T>, {0x690, 8, 0, 0})
	...
	SMember(FDataTableRowHandle)                       ModalConfirmAction                                          OFFSET(getStruct<T>, {0x6E0, 16, 0, 0})
	SMember(FDataTableRowHandle)                       ModalCancelAction                                           OFFSET(getStruct<T>, {0x6F0, 16, 0, 0})


	/// Functions
	// Function /Script/JunoUI.JunoVillageDetailsScreen.OnEntryHovered
	// void OnEntryHovered(class UJunoVillageRewardEntry* Entry);                                                               // [0x1340978] Event|Protected|BlueprintEvent 
...
public:
	...
	// TWeakObjectPtr<UTexture2D*> FindRoleImage(FGameplayTagContainer& InTagContainer);                                        // [0xccbd0a0] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/JunoUI.JunoVillageUIDataAsset.FindPerkImage
	// TWeakObjectPtr<UTexture2D*> FindPerkImage(FGameplayTagContainer& InTagContainer);                                        // [0xccbcfc4] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
};
...
public:
	CMember(class UCommonButtonBase*)                  Button_Upgrade                                              OFFSET(get<T>, {0x678, 8, 0, 0})
	CMember(class UDynamicEntryBox*)                   EntryBox_Ingredients                                        OFFSET(get<T>, {0x680, 8, 0, 0})
	CMember(class UDynamicEntryBox*)                   EntryBox_Perks                                              OFFSET(get<T>, {0x688, 8, 0, 0})
	CMember(class UScrollBox*)                         ScrollBox_Rewards                                           OFFSET(get<T>, {0x690, 8, 0, 0})
	CMember(class UScrollBox*)                         ScrollBox_Requirements                                      OFFSET(get<T>, {0x698, 8, 0, 0})


	/// Functions
	// Function /Script/JunoUI.JunoVillageUpgradeScreen.OnUpgrade
	// void OnUpgrade();                                                                                                        // [0x1340978] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void ShowWidget();                                                                                                       // [0x3d0ce5c] Native|Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoGuidedBuildingHudStateWidget.OnStageComplete
	// void OnStageComplete(FGuidedBuildingUpdate& UpdateData);                                                                 // [0xccbdbb8] Native|Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoGuidedBuildingHudStateWidget.OnSnapsUpdated
	// void OnSnapsUpdated(TArray<int32_t>& UpdatedSnaps);                                                                      // [0xccbdb18] Native|Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoGuidedBuildingHudStateWidget.OnSetComplete
	// void OnSetComplete(FGuidedBuildingUpdate& UpdateData);                                                                   // [0xccbda84] Native|Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoGuidedBuildingHudStateWidget.OnSectionComplete
	// void OnSectionComplete(FGuidedBuildingUpdate& UpdateData);                                                               // [0xccbd9f0] Native|Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoGuidedBuildingHudStateWidget.OnCurrentStageUpdate
	// void OnCurrentStageUpdate(FGuidedBuildingUpdate& UpdateData);                                                            // [0xccbd948] Native|Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoGuidedBuildingHudStateWidget.OnAutoHideTimereFinished
	// void OnAutoHideTimereFinished();                                                                                         // [0x3145fc4] Native|Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoGuidedBuildingHudStateWidget.HideWidget
	// void HideWidget();                                                                                                       // [0x35f4808] Native|Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void SetFill(float Fill);                                                                                                // [0xccbdeb0] Final|Native|Public|BlueprintCallable 
	// Function /Script/JunoUI.JunoAnimatedProgressBar.SetDelta
	// void SetDelta(float Fill);                                                                                               // [0xccbde30] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void OnSlotItemChanged(EJunoItemChangeType ChangeType, class UFortItem* SlotItem);                                       // [0x1340978] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void OnShowPickup(class AFortPickup* InCurrentPickup);                                                                   // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoInteractionIndicatorWidget.OnShowBasicInteraction
	// void OnShowBasicInteraction(FText& Description, FLinearColor DescriptionColor, int32_t InteractionCount);                // [0x1340978] Event|Protected|HasOutParms|HasDefaults|BlueprintEvent 
};
...
public:
	...
	// void OnNotificationFinished();                                                                                           // [0xccbd9dc] Final|Native|Protected|BlueprintCallable 
	// Function /Script/JunoUI.JunoNotificationWidget.BP_DisplayNotification
	// void BP_DisplayNotification(FJunoNotificationData& NotificationData);                                                    // [0x1340978] Event|Protected|HasOutParms|BlueprintEvent 
};
...
public:
	...
	// void RefreshPickupEntry(class UUserWidget* EntryWidget, TWeakObjectPtr<UTexture2D*>& Icon, FText& DisplayName, int32_t Count, int32_t TotalInventoryCount, EFortRarity ItemRarity, EJunoPickupStreamAnim AnimType); // [0x1340978] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoPickupStream.OnHideExpiredPickup
	// void OnHideExpiredPickup(class UUserWidget* EntryWidget);                                                                // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoPickupStream.OnActivePickupsPresent
	// void OnActivePickupsPresent(bool bHasActivePickups);                                                                     // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoPickupStream.HandleItemPickedUp
	// void HandleItemPickedUp(class UFortWorldItem* WorldItem, int32_t Count);                                                 // [0xccbd67c] Final|Native|Protected 
	// Function /Script/JunoUI.JunoPickupStream.HandleEntryHideAnimComplete
	// void HandleEntryHideAnimComplete(class UUserWidget* EntryWidget);                                                        // [0xccbd5d4] Final|Native|Protected|BlueprintCallable 
};
...
public:
	...
	// void OnValueChangedWithReason(EFortHitPointModificationReason Reason);                                                   // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoPlayerHitpointWidget.OnMaxValueChanged
	// void OnMaxValueChanged(float Value);                                                                                     // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoPlayerHitpointWidget.OnDeltaChanged
	// void OnDeltaChanged();                                                                                                   // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoPlayerHitpointWidget.GetLastValuePercentage
	// float GetLastValuePercentage();                                                                                          // [0xccbd494] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoUI.JunoPlayerHitpointWidget.GetCurrentValuePercentage
	// float GetCurrentValuePercentage();                                                                                       // [0xccbd464] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void OnPlayerDataUpdated(FJunoPlayerIndicatorData& PlayerIndicatorData);                                                 // [0x1340978] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoPlayerIndicatorWidget.OnInFocusStateChanged
	// void OnInFocusStateChanged(bool bInInFocus);                                                                             // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoPlayerIndicatorWidget.OnClampedStatusChanged
	// void OnClampedStatusChanged(bool bInIsClamped);                                                                          // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoPlayerIndicatorWidget.HandlePlayerStatePawnDied
	// void HandlePlayerStatePawnDied(FPawnDamageData& PawnDamageInfo);                                                         // [0xccbd740] Final|Native|Private|HasOutParms 
	// Function /Script/JunoUI.JunoPlayerIndicatorWidget.HandleCurrentPawnChanged
	// void HandleCurrentPawnChanged();                                                                                         // [0xccbd5c0] Final|Native|Private 
};
...
public:
	...
	// void OnQuickbarSlotChanged(int32_t SelectedSlotIndex);                                                                   // [0x1340978] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void OnSlotItemChangeFailed();                                                                                           // [0x1340978] Event|Public|BlueprintEvent 
	// Function /Script/JunoUI.JunoQuickbarSlot.OnSlotItemChanged
	// void OnSlotItemChanged(EJunoItemChangeType ChangeType);                                                                  // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoQuickbarSlot.OnSlotInitialized
	// void OnSlotInitialized();                                                                                                // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoQuickbarSlot.OnSetQuickbarSlotSelected
	// void OnSetQuickbarSlotSelected(bool bInSelected, FText& ItemName);                                                       // [0x1340978] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/JunoUI.JunoQuickbarSlot.OnPrebuildStateChanged
	// void OnPrebuildStateChanged(bool bInEnabled);                                                                            // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoQuickbarSlot.GetSlotItem
	// class UFortItem* GetSlotItem();                                                                                          // [0xccbd5a0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void StartRegisteringUI();                                                                                               // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoDynamicUIDirector.OpenStandaloneMenuScene
	// void OpenStandaloneMenuScene(FJunoWidgetSceneAndIndex WidgetSceneAndIndex, class UObject* BoundObject);                  // [0xccbdd54] Final|Native|Protected|BlueprintCallable 
	// Function /Script/JunoUI.JunoDynamicUIDirector.OpenHudMenuScene
	// void OpenHudMenuScene(FJunoWidgetSceneAndIndex WidgetSceneAndIndex, class UJunoHudMenuBaseInitData* HudMenuData);        // [0xccbdc4c] Final|Native|Protected|BlueprintCallable 
	// Function /Script/JunoUI.JunoDynamicUIDirector.OnIsMobileHUDShowingChanged
	// void OnIsMobileHUDShowingChanged();                                                                                      // [0x1340978] Event|Protected|BlueprintCallable|BlueprintEvent 
	// Function /Script/JunoUI.JunoDynamicUIDirector.OnEnteredConversation
	// void OnEnteredConversation();                                                                                            // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/JunoUI.JunoDynamicUIDirector.HandleHudMenuSceneClosed
	// void HandleHudMenuSceneClosed();                                                                                         // [0xccbd654] Final|Native|Protected|BlueprintCallable 
	// Function /Script/JunoUI.JunoDynamicUIDirector.GetIsMobileHUDShowing
	// bool GetIsMobileHUDShowing();                                                                                            // [0x67406f8] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoUI.JunoDynamicUIDirector.FindTagDrivenSceneByTagContainer
	// bool FindTagDrivenSceneByTagContainer(FGameplayTagContainer& TagContainer, FGameplayTag& ParentTag, FJunoWidgetSceneAndIndex& OutWidgetSceneAndIndex); // [0xccbd2b4] Final|Native|Protected|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoUI.JunoDynamicUIDirector.FindTagDrivenScene
	// bool FindTagDrivenScene(FGameplayTag& tag, FJunoWidgetSceneAndIndex& OutWidgetSceneAndIndex);                            // [0xccbd17c] Final|Native|Protected|HasOutParms|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void UpdateHUDLayoutContexts(FGameplayTagContainer ContextsToAdd, FGameplayTagContainer ContextsToRemove);               // [0xccbdf30] Final|Native|Protected|BlueprintCallable 
	// Function /Script/JunoUI.JunoDynamicUIDirectorComponent.OnStartRegisteringUI
	// void OnStartRegisteringUI();                                                                                             // [0x1340978] Event|Public|BlueprintEvent 
	// Function /Script/JunoUI.JunoDynamicUIDirectorComponent.OnIsMobileHUDShowingChanged
	// void OnIsMobileHUDShowingChanged();                                                                                      // [0x1340978] Event|Public|BlueprintEvent 
	// Function /Script/JunoUI.JunoDynamicUIDirectorComponent.GetOwningLocalPlayerController
	// class APlayerController* GetOwningLocalPlayerController();                                                               // [0xccbd4e8] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoUI.JunoDynamicUIDirectorComponent.GetOwningJunoDirector
	// class AJunoDynamicUIDirector* GetOwningJunoDirector();                                                                   // [0xccbd4c4] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/JunoUI.JunoDynamicUIDirectorComponent.GetIsMobileHUDShowing
	// bool GetIsMobileHUDShowing();                                                                                            // [0x89a9d74] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	SMember(FJunoAwesomeUpgradeRequirements)           CurrentUpgradeRequirements                                  OFFSET(getStruct<T>, {0xF0, 80, 0, 0})
	CMember(TArray<FAwesomePerkReward>)                UnlockedPlayerPerks                                         OFFSET(get<T>, {0x140, 16, 0, 0})
	CMember(TArray<FActiveCampNPCEntry>)               ActiveNPCEntries                                            OFFSET(get<T>, {0x150, 16, 0, 0})
	DMember(int32_t)                                   MaxNPCs                                                     OFFSET(get<int32_t>, {0x160, 4, 0, 0})
	DMember(int32_t)                                   NPCSlots                                                    OFFSET(get<int32_t>, {0x164, 4, 0, 0})
	DMember(int32_t)                                   CreatureSlots                                               OFFSET(get<int32_t>, {0x168, 4, 0, 0})
	DMember(int32_t)                                   SharedSlots                                                 OFFSET(get<int32_t>, {0x16C, 4, 0, 0})
	DMember(int32_t)                                   MaxNPCsEver                                                 OFFSET(get<int32_t>, {0x170, 4, 0, 0})
	CMember(TArray<FActiveCampNPCEntry>)               VisitingNPCEntries                                          OFFSET(get<T>, {0x178, 16, 0, 0})
	CMember(TArray<FActiveCampCreatureEntry>)          ActiveCreatureEntries                                       OFFSET(get<T>, {0x188, 16, 0, 0})
	CMember(TMap<FGameplayTag, int32_t>)               JobCounts                                                   OFFSET(get<T>, {0x198, 80, 0, 0})
	CMember(TArray<TWeakObjectPtr<UJunoKnowledgeBundle*>>) KnowledgeBundles                                        OFFSET(get<T>, {0x1E8, 16, 0, 0})
	CMember(class UFortItemDefinition*)                VillageCenterItemDefinition                                 OFFSET(get<T>, {0x1F8, 8, 0, 0})
	DMember(bool)                                      bHasReachedGlobalNPCsCap                                    OFFSET(get<bool>, {0x200, 1, 0, 0})
	DMember(int32_t)                                   FreeSlotsForNPCs                                            OFFSET(get<int32_t>, {0x204, 4, 0, 0})
	DMember(int32_t)                                   GlobalNPCsCap                                               OFFSET(get<int32_t>, {0x208, 4, 0, 0})
	DMember(bool)                                      bHasReachedGlobalCreaturesCap                               OFFSET(get<bool>, {0x20C, 1, 0, 0})
	DMember(int32_t)                                   FreeSlotsForCreatures                                       OFFSET(get<int32_t>, {0x210, 4, 0, 0})
	DMember(int32_t)                                   GlobalCreaturesCap                                          OFFSET(get<int32_t>, {0x214, 4, 0, 0})
};
