...
public:
	...
	// class USubsystem* GetContext(class UObject* ContextObject, class UClass* Class);                                         // [0x2d1d2dc] Final|BlueprintCosmetic|Native|Static|Public|BlueprintCallable|BlueprintPure 
};
