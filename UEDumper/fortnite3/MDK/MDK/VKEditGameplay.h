...
public:
	...
	// void OnClientActivatedContent(FUniqueNetIdRepl& ClientNetId);                                                            // [0xca45ff4] Final|Native|Private|HasOutParms|Const 
};
...
public:
	...
	// void OnRep_VkEditStatus();                                                                                               // [0xca46108] Final|Native|Protected|Const 
	// Function /Script/VKEditGameplay.PlayspaceComponent_EditConnectionManager.OnRep_EditConnections
	// void OnRep_EditConnections();                                                                                            // [0xca460c4] Final|Native|Protected|Const 
};
