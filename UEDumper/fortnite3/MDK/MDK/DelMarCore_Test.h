...
/// Class /Script/DelMarCore_Test.DelMarTestControllerTrackScrubber
...
public:
	...
	// void ReceiveTrackScrubberCompletedProfiling();                                                                           // [0xc8fb738] Final|Native|Protected 
	// Function /Script/DelMarCore_Test.DelMarTestControllerTrackScrubber.ReceiveRaceBeginEvent
	// void ReceiveRaceBeginEvent(FDelMarEvent_RaceActive& Event);                                                              // [0xc8fb6b8] Final|Native|Protected|HasOutParms 
};
