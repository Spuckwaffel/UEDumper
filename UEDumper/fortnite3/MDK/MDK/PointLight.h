...
public:
	...
	// void UpdateShortCircuit();                                                                                               // [0xc727f4c] Final|Native|Private 
	// Function /Script/PointLight.PointLightNativeComponent.UpdateDeviceSettings
	// void UpdateDeviceSettings(FPointLightRhythmParameters& RhythmParameters);                                                // [0xc727ebc] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/PointLight.PointLightNativeComponent.StopShortCircuitUpdate
	// void StopShortCircuitUpdate();                                                                                           // [0xc727ea8] Final|Native|Public|BlueprintCallable 
	// Function /Script/PointLight.PointLightNativeComponent.StartShortCircuitUpdate
	// void StartShortCircuitUpdate(class UTimelineComponent* ShortCircuitTimeline);                                            // [0xc727ce4] Final|Native|Public|BlueprintCallable 
	// Function /Script/PointLight.PointLightNativeComponent.StartRhythmUpdate
	// void StartRhythmUpdate(FTimerHandle& TimerHandle, float Rate);                                                           // [0xc727bd4] Final|Native|Public|HasOutParms|BlueprintCallable 
};
