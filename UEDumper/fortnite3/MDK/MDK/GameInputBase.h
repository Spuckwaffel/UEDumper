...
public:
	SMember(FName)                                     KeyName                                                     OFFSET(getStruct<T>, {0x0, 4, 0, 0})
	DMember(bool)                                      bIgnoreAnalogInputDeviceScopeForThisRawReport               OFFSET(get<bool>, {0x4, 1, 0, 0})
	CMember(ERawDeviceReportTranslationBehavior)       TranslationBehavior                                         OFFSET(get<T>, {0x5, 1, 0, 0})
	DMember(char)                                      AnalogDeadzone                                              OFFSET(get<char>, {0x6, 1, 0, 0})
	DMember(float)                                     Scalar                                                      OFFSET(get<float>, {0x8, 4, 0, 0})
