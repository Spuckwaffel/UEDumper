...
public:
	...
	// void UpdateJamUI();                                                                                                      // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/FMJamSystemRuntime.JamControllerComponent.GetControllerOfClass
	// class AController* GetControllerOfClass(class UClass* ControllerType, bool bMatchChildTypes);                            // [0xb723e48] Final|Native|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// void OnLoadoutChanged();                                                                                                 // [0xb7247ac] Final|Native|Private 
	// Function /Script/FMJamSystemRuntime.JamControllerComponent_LoopOptions.AddJamCategories
	// void AddJamCategories(bool bPostLockerCategory);                                                                         // [0xb723db4] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void OnSongCatalogRetrieved(bool bSuccess);                                                                              // [0xb7249d8] Final|Native|Protected 
	// Function /Script/FMJamSystemRuntime.JamControllerComponent_LoopPreloader.OnPawnSet
	// void OnPawnSet(class APlayerState* Player, class APawn* NewPawn, class APawn* OldPawn);                                  // [0xb7247e8] Final|Native|Protected 
	// Function /Script/FMJamSystemRuntime.JamControllerComponent_LoopPreloader.OnLoadoutFilled
	// void OnLoadoutFilled();                                                                                                  // [0xb7247c0] Final|Native|Protected 
};
...
public:
	...
	// void Close();                                                                                                            // [0xb723e34] Final|Native|Protected|BlueprintCallable 
};
...
public:
	...
	// bool ShouldApplyJamOnSplitscreenLogic(class UObject* WorldContextObject, class APlayerController* ReferenceController);  // [0xb724a58] Final|RequiredAPI|Native|Static|Public|BlueprintCallable 
	// Function /Script/FMJamSystemRuntime.JamOnOffSwitchComponent.OnPlayerStatePawnSet
	// void OnPlayerStatePawnSet(class APlayerState* Player, class APawn* NewPawn, class APawn* OldPawn);                       // [0xb7248e0] Final|Native|Protected 
	// Function /Script/FMJamSystemRuntime.JamOnOffSwitchComponent.OnMutatorUpdated
	// void OnMutatorUpdated();                                                                                                 // [0xb7247d4] Final|Native|Protected 
};
...
public:
	...
	// class APawn* GetPawnOfClass(class UClass* PawnType, bool bMatchChildTypes);                                              // [0xb7246a4] Final|Native|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// bool IsJamDebugDisplayEnabled();                                                                                         // [0xb724790] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
