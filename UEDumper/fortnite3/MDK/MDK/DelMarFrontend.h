...
public:
	...
	// void DelMarResetNux();                                                                                                   // [0x35e6228] Final|Exec|Native|Protected 
	// Function /Script/DelMarFrontend.DelMarFrontendCheatManager.DelMarMarkTutorialPlayed
	// void DelMarMarkTutorialPlayed();                                                                                         // [0x35e6228] Final|Exec|Native|Protected 
};
...
public:
	...
	// void HandleVideoTerminalError(EBaseMediaTerminalErrorReason Reason);                                                     // [0xca61cc0] Final|Native|Protected 
	// Function /Script/DelMarFrontend.DelMarFrontendExperienceFlow.FinishTrailerStep
	// void FinishTrailerStep();                                                                                                // [0xca61c7c] Final|Native|Protected 
};
...
public:
	...
	// class UDelMarFrontendRuntimeOptions* GetDelMarFrontendRuntimeOptions();                                                  // [0xca61c90] Final|RequiredAPI|Native|Static|Public|BlueprintCallable|BlueprintPure 
};
