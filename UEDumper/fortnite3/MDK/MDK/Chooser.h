...
public:
	...
	// FInstancedStruct MakeEvaluateChooser(class UChooserTable* Chooser);                                                      // [0x805099c] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/Chooser.ChooserFunctionLibrary.MakeChooserEvaluationContext
	// FChooserEvaluationContext MakeChooserEvaluationContext();                                                                // [0x8050920] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/Chooser.ChooserFunctionLibrary.GetChooserStructOutput
	// void GetChooserStructOutput(FChooserEvaluationContext& Context, int32_t Index, int32_t& Value);                          // [0x80502a0] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/Chooser.ChooserFunctionLibrary.EvaluateObjectChooserBaseMulti
	// TArray<UObject*> EvaluateObjectChooserBaseMulti(FChooserEvaluationContext& Context, FInstancedStruct& ObjectChooser, class UClass* ObjectClass, bool bResultIsClass); // [0x804ff1c] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/Chooser.ChooserFunctionLibrary.EvaluateObjectChooserBase
	// class UObject* EvaluateObjectChooserBase(FChooserEvaluationContext& Context, FInstancedStruct& ObjectChooser, class UClass* ObjectClass, bool bResultIsClass); // [0x804fbb8] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/Chooser.ChooserFunctionLibrary.EvaluateChooserMulti
	// TArray<UObject*> EvaluateChooserMulti(class UObject* ContextObject, class UChooserTable* ChooserTable, class UClass* ObjectClass); // [0x804fa80] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/Chooser.ChooserFunctionLibrary.EvaluateChooser
	// class UObject* EvaluateChooser(class UObject* ContextObject, class UChooserTable* ChooserTable, class UClass* ObjectClass); // [0x804f970] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/Chooser.ChooserFunctionLibrary.AddChooserStructInput
	// void AddChooserStructInput(FChooserEvaluationContext& Context, int32_t Value);                                           // [0x804f41c] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/Chooser.ChooserFunctionLibrary.AddChooserObjectInput
	// void AddChooserObjectInput(FChooserEvaluationContext& Context, class UObject* Object);                                   // [0x804f244] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
