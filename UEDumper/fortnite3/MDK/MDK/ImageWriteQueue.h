...
public:
	...
	// void ExportToDisk(class UTexture* Texture, FString Filename, FImageWriteOptions& Options);                               // [0x6054c0c] Final|RequiredAPI|Native|Static|Public|HasOutParms|BlueprintCallable 
};
