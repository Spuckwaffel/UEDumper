...
public:
	...
	// void SetEventRouter(class UGameplayEventRouterComponent* EventRouter);                                                   // [0x1340978] Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDebugWidget.LogToScreen
	// void LogToScreen(FString Data, ESparksCameraLogType Type);                                                               // [0x1340978] Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDebugWidget.ClearCurrent
	// void ClearCurrent();                                                                                                     // [0x1340978] Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDebugWidget.ClearAll
	// void ClearAll();                                                                                                         // [0x1340978] Event|Public|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// void StartIntermissionCameras(float ForceLengthMS, bool bForceReloadNewSequence, bool bForceShotChange);                 // [0xb6e8268] Final|Native|Public  
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorComponent.Reset
	// void Reset(bool bForceShotChange);                                                                                       // [0xb6e78c8] Final|Native|Public|BlueprintCallable 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorComponent.ReplaceWithNonCloseupShot
	// void ReplaceWithNonCloseupShot(FSparksCameraDirectorSequenceEntry& OldEntry);                                            // [0xb6e77c0] Final|Native|Protected|HasOutParms 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorComponent.PlayShot
	// float PlayShot(FSparksCameraDirectorSequenceEntry& Entry);                                                               // [0xb6e76a0] Final|Native|Protected|HasOutParms 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorComponent.PlaySequenceEntry
	// void PlaySequenceEntry(FSparksCameraDirectorSequenceEntry& Entry, float MsOffset, bool bIntermission, class AActor* ForceTarget); // [0xb6e7298] Final|Native|Protected|HasOutParms 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorComponent.PlayNextShot
	// void PlayNextShot(float StartTimeOffset);                                                                                // [0xb6e7218] Final|Native|Protected 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorComponent.OnShotFinished
	// void OnShotFinished();                                                                                                   // [0xb6e7204] Final|Native|Protected 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorComponent.LogToScreen
	// void LogToScreen(FString Data, ESparksCameraLogType Type, float TimeSeconds);                                            // [0xb6e6a00] Final|Native|Protected 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorComponent.InsertSequence
	// void InsertSequence(FSparksCameraDirectorSequence& Sequence);                                                            // [0xb6e60dc] Final|Native|Protected|HasOutParms|BlueprintCallable 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorComponent.InsertPerformanceMap
	// void InsertPerformanceMap(class USparksPerformanceMap* Map);                                                             // [0xb6e605c] Final|Native|Public|BlueprintCallable 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorComponent.InitDynamicCameras
	// void InitDynamicCameras();                                                                                               // [0xb6e6048] Final|Native|Protected 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorComponent.HandleIntermissionTagsEvent
	// void HandleIntermissionTagsEvent(FSparksCommonIntermissionCameraDirectorEvent& Payload);                                 // [0xb6e5d08] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorComponent.HandleForceIntermissionEvent
	// void HandleForceIntermissionEvent(FSparksCommonForceIntermissionCameraDirectorEvent& Payload);                           // [0xb6e5c50] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorComponent.HandleDirectorDynamicEvent
	// void HandleDirectorDynamicEvent(FSparksCommonDynamicCameraDirectorEvent& Payload);                                       // [0xb6e5b78] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorComponent.GetCameraActive
	// bool GetCameraActive();                                                                                                  // [0xaaf7fb8] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorComponent.FindStartTimeForNextShotInSequenceMS
	// float FindStartTimeForNextShotInSequenceMS(float TimeToTest);                                                            // [0xb6e2c30] Final|Native|Protected 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorComponent.FindCurrentShot
	// bool FindCurrentShot(int32_t& SequenceIndex, int32_t& EntryIndex, float StartTimeIn);                                    // [0xb6e2a54] Final|Native|Protected|HasOutParms 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorComponent.DebugLockSpecificCameraShot
	// void DebugLockSpecificCameraShot(FSparksCameraShot Shot, bool bLockToFirstFrame, class AActor* Target);                  // [0xb6e283c] Net|NetReliableNative|Event|NetMulticast|Protected|BlueprintCallable 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorComponent.ActivateCameraControl
	// void ActivateCameraControl(bool bActive);                                                                                // [0xb6e2178] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// bool ShouldUseShot(class ULevelSequence* Shot, float AtTimestamp);                                                       // [0xb6e7cb8] Final|Native|Public|BlueprintCallable 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorConfig.ResetCache
	// void ResetCache();                                                                                                       // [0xb6e7948] Final|Native|Public|BlueprintCallable 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorConfig.MarkShotTime
	// void MarkShotTime(class ULevelSequence* Shot, float AtTimestamp);                                                        // [0xb6e7140] Final|Native|Public|BlueprintCallable 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorConfig.Init
	// void Init();                                                                                                             // [0xb6e5dc0] Final|Native|Public  
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorConfig.GenerateSequence
	// bool GenerateSequence(FSparksPerformanceMapSection& Section, FSparksCameraDirectorSequence& OutSequence);                // [0xb6e3584] Native|Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorConfig.GenerateEntry
	// bool GenerateEntry(FSparksPerformanceMapSection& Section, FSparksCameraDirectorSequenceEntry& OutEntry);                 // [0xb6e2cd4] Native|Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorConfig.FindBestGenerator
	// class USparksCameraDirectorSequenceGenerator* FindBestGenerator(FSparksPerformanceMapSection& Section);                  // [0xb6e29a0] Final|Native|Protected|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// bool GetValidTimestamp(float DesiredTimestampMS, float& OutTimestampMSHigh, float& OutTimestampMSLow);                   // [0xb6e5a54] Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraPluginDataProvider.GetTargetRelevantTags
	// bool GetTargetRelevantTags(class AActor* Target, FSparksCameraFilter& TagsOut);                                          // [0xb6e593c] Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraPluginDataProvider.GetTargetForCloseup
	// class AActor* GetTargetForCloseup(float ShotTimeMS, FGameplayTagContainer& TagsOut, bool bPreferLocal);                  // [0xb6e57ac] Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraPluginDataProvider.GetStaticShotCount
	// int32_t GetStaticShotCount();                                                                                            // [0xb6e49f4] Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraPluginDataProvider.GetStaticShot
	// bool GetStaticShot(int32_t Index, FSparksCameraShot& OutShot);                                                           // [0xb6e48c8] Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraPluginDataProvider.GetMatchingCameraTarget
	// class AActor* GetMatchingCameraTarget(FGameplayTagContainer& Tags, float ShotTimeMS, bool bPreferLocal);                 // [0xb6e4598] Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraPluginDataProvider.GetCurrentMSTimeInCameraEvent
	// float GetCurrentMSTimeInCameraEvent();                                                                                   // [0x69ce3ec] Native|Public|BlueprintCallable 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraPluginDataProvider.GetAllTargets
	// TArray<AActor*> GetAllTargets();                                                                                         // [0xb6e4538] Native|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// bool Reset();                                                                                                            // [0x67d5d7c] Native|Event|Public|BlueprintEvent 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraShotSelectRuleBase.Init
	// bool Init(class USparksCameraShotPool* InPool);                                                                          // [0xa4a16a4] Native|Event|Public|BlueprintEvent 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraShotSelectRuleBase.GetShotCount
	// int32_t GetShotCount();                                                                                                  // [0xb6e48b0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraShotSelectRuleBase.ChooseShot
	// bool ChooseShot(FSparksPerformanceMapSection& Section, FSparksCameraDirectorSequenceEntry& OutShot);                     // [0xb6e26a8] Native|Event|Public|HasOutParms|BlueprintEvent 
};
...
public:
	...
	// bool Init(FSparksCameraSectionWrapper& Section);                                                                         // [0xb6e5f90] Native|Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraPoolSelectRuleBase.GetShotCount
	// int32_t GetShotCount();                                                                                                  // [0xb6e488c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraPoolSelectRuleBase.GetPoolCount
	// int32_t GetPoolCount();                                                                                                  // [0x8c92cd8] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	...
	// bool ChooseIntroShot(FSparksPerformanceMapSection& Section, FSparksCameraDirectorSequenceEntry& OutShot);                // [0xb6e2514] Native|Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraPoolSelectRuleBase.ChooseExitShot
	// bool ChooseExitShot(FSparksPerformanceMapSection& Section, FSparksCameraDirectorSequenceEntry& OutShot);                 // [0xb6e2380] Native|Event|Public|HasOutParms|BlueprintEvent 
};
...
public:
	...
	// bool Reset();                                                                                                            // [0x68554c4] Native|Event|Public|BlueprintEvent 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorSequenceGenerator.Init
	// bool Init(FSparksCameraSectionWrapper& InPool, class USparksCameraDirectorConfig* Config);                               // [0xb6e5dd4] Native|Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorSequenceGenerator.GetFilter
	// FSparksCameraFilter GetFilter();                                                                                         // [0xb6e457c] Final|Native|Public|BlueprintCallable 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorSequenceGenerator.GenerateSequence
	// ESparksSectionGeneratorResult GenerateSequence(FSparksPerformanceMapSection& Section, class USparksCameraPluginDataProvider* DataProvider, FSparksCameraDirectorSequence& OutSequence); // [0xb6e3ce8] Native|Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorSequenceGenerator.GenerateIntroEntry
	// ESparksSectionGeneratorResult GenerateIntroEntry(FSparksPerformanceMapSection& Section, class USparksCameraPluginDataProvider* DataProvider, FSparksCameraDirectorSequenceEntry& OutEntry); // [0xb6e3324] Native|Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorSequenceGenerator.GenerateExitEntry
	// ESparksSectionGeneratorResult GenerateExitEntry(FSparksPerformanceMapSection& Section, class USparksCameraPluginDataProvider* DataProvider, FSparksCameraDirectorSequenceEntry& OutEntry); // [0xb6e30c4] Native|Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/SparksCameraDirectorRuntime.SparksCameraDirectorSequenceGenerator.GenerateEntry
	// ESparksSectionGeneratorResult GenerateEntry(FSparksPerformanceMapSection& Section, class USparksCameraPluginDataProvider* DataProvider, FSparksCameraDirectorSequenceEntry& OutEntry); // [0xb6e2e64] Native|Event|Public|HasOutParms|BlueprintEvent 
};
...
public:
	...
	// ESparksFilterResult ScoreTagsAgainstFilter(FSparksCameraFilter& Filter, FGameplayTagContainer& TagsToMatch, float& OutScore); // [0xb6e7a9c] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/SparksCameraDirectorRuntime.SparksCamera_BPFL.ScoreTagContainers
	// float ScoreTagContainers(FGameplayTagContainer& Tags1, FGameplayTagContainer& Tags2);                                    // [0xb6e795c] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/SparksCameraDirectorRuntime.SparksCamera_BPFL.GetTagForMidiEventName
	// FGameplayTag GetTagForMidiEventName(FString EventString);                                                                // [0xb6e50e4] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/SparksCameraDirectorRuntime.SparksCamera_BPFL.GetSubTagForMidiEventName
	// FGameplayTag GetSubTagForMidiEventName(FString EventString);                                                             // [0xb6e4a1c] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// int32_t InsertTimeline(class USparksPerformanceMap* Map, int32_t& OutFirstIndex, int32_t& OutLastIndex, bool bOverwrite); // [0xb6e67dc] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/SparksCameraDirectorRuntime.SparksPerformanceMap.GetSectionIndexAtTime
	// int32_t GetSectionIndexAtTime(float TimeMS);                                                                             // [0xb6e47fc] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/SparksCameraDirectorRuntime.SparksPerformanceMap.GetNextSectionIndexAtTime
	// int32_t GetNextSectionIndexAtTime(float TimeMS);                                                                         // [0xb6e4768] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/SparksCameraDirectorRuntime.SparksPerformanceMap.FixupSectionTimeLengths
	// void FixupSectionTimeLengths();                                                                                          // [0xb6e2cc0] Final|Native|Public|BlueprintCallable 
	// Function /Script/SparksCameraDirectorRuntime.SparksPerformanceMap.AddSection
	// void AddSection(float StartMS, FGameplayTag& PrimaryTag, FGameplayTagContainer& SecondaryTags);                          // [0xb6e21f8] Final|Native|Public|HasOutParms|BlueprintCallable 
};
