...
public:
	...
	// void OnLoopingStartGeneric(class AActor* MyTarget, FGameplayCueParameters& Parameters, TArray<UFXSystemComponent*>& ParticleComponents, TArray<UAudioComponent*>& AudioComponents); // [0x1340978] Event|Public|HasOutParms|BlueprintEvent 
	// Function /Irwin/GameplayCues/GCNL_Irwin_Slide.GCNL_Irwin_Slide_C.OnRemovalGeneric
	// void OnRemovalGeneric(class AActor* MyTarget, FGameplayCueParameters& Parameters, TArray<UFXSystemComponent*>& ParticleComponents, TArray<UAudioComponent*>& AudioComponents, class ULegacyCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance); // [0x1340978] Event|Public|HasOutParms|BlueprintEvent 
	// Function /Irwin/GameplayCues/GCNL_Irwin_Slide.GCNL_Irwin_Slide_C.ExecuteUbergraph_GCNL_Irwin_Slide
	// void ExecuteUbergraph_GCNL_Irwin_Slide(int32_t EntryPoint);                                                              // [0x1340978] Final|HasDefaults    
};
...
public:
	...
	// void ExecuteUbergraph_GCNL_RidingSprint_SpeedLines(int32_t EntryPoint);                                                  // [0x1340978] Final|HasDefaults    
};
...
public:
	...
	// void CalculateVelocityParam();                                                                                           // [0x1340978] Public|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/GameplayCues/GCNL_PlayerIsRiding.GCNL_PlayerIsRiding_C.WhileActive
	// bool WhileActive(class AActor* MyTarget, FGameplayCueParameters& Parameters);                                            // [0x1340978] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
...
public:
	...
	// bool OnExecute(class AActor* MyTarget, FGameplayCueParameters& Parameters);                                              // [0x1340978] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/GameplayCues/GCN_BurtCharging_Player_Latent.GCN_BurtCharging_Player_Latent_C.ExecuteBoostLogic
	// void ExecuteBoostLogic();                                                                                                // [0x1340978] BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/GameplayCues/GCN_BurtCharging_Player_Latent.GCN_BurtCharging_Player_Latent_C.BoostEndEvent
	// void BoostEndEvent();                                                                                                    // [0x1340978] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_GCN_BurtCharging_Player_Latent(int32_t EntryPoint);                                                // [0x1340978] Final|HasDefaults    
};
...
public:
	...
	// void ExecuteUbergraph_GCNL_Riding_Sprint_CameraShake(int32_t EntryPoint);                                                // [0x1340978] Final|HasDefaults    
};
...
public:
	...
	// void Added_7482F31A49360978B87F339D76FC2BB7();                                                                           // [0x1340978] BlueprintCallable|BlueprintEvent 
	...
	// void Removed_AD34CCD44592FD2F05DB47BDF9413ACC();                                                                         // [0x1340978] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_GCNL_Athena_Energy_ConstantRegen_Active_WildlifeMount(int32_t EntryPoint);                         // [0x1340978] Final|HasDefaults    
};
...
public:
	...
	// void VisualizeAudio();                                                                                                   // [0x1340978] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_GCNL_Ascender_Descent(int32_t EntryPoint);                                                         // [0x1340978] Final|HasDefaults    
};
...
public:
	...
	// void CameraShakeTimer();                                                                                                 // [0x1340978] BlueprintCallable|BlueprintEvent 
	// Function /Ascender/GameplayCues/GCNL_Ascender_Ascent.GCNL_Ascender_Ascent_C.ExecuteUbergraph_GCNL_Ascender_Ascent
	// void ExecuteUbergraph_GCNL_Ascender_Ascent(int32_t EntryPoint);                                                          // [0x1340978] Final|HasDefaults    
};
...
public:
	...
	CMember(class USkeletalMeshComponent*)             Vehicle_Mesh                                                OFFSET(get<T>, {0xA58, 8, 0, 0})
	CMember(TArray<class USkeletalMeshComponent*>)     Wheel_Meshes                                                OFFSET(get<T>, {0xA60, 16, 0, 0})
	DMember(bool)                                      Debug                                                       OFFSET(get<bool>, {0xA70, 1, 0, 0})
	...
	// void Material Switch(bool Restore Original, TScriptInterface<Class> Vehicle);                                            // [0x1340978] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	...
	// void Sweep Car to Normal__FinishedFunc();                                                                                // [0x1340978] BlueprintEvent       
	...
	// void Sweep Car to Normal__UpdateFunc();                                                                                  // [0x1340978] BlueprintEvent       
	...
	// void KeepCheckingForWheels();                                                                                            // [0x1340978] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_GCNL_VehicleCosmetics_CosmeticSwap(int32_t EntryPoint);                                            // [0x1340978] Final|HasDefaults    
};
...
public:
	...
	// void AVIndicatorLoop();                                                                                                  // [0x1340978] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_GCNL_Athena_VictoryCrown_CrownWearer_Looping(int32_t EntryPoint);                                  // [0x1340978] Final|HasDefaults    
};
