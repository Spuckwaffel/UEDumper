...
public:
	...
	// void BP_OnDroneStoppedDiving();                                                                                          // [0x1340978] BlueprintAuthorityOnly|Event|Protected|BlueprintEvent 
	// Function /Script/ScoutDroneRuntime.FortGameplayAbility_ScoutDrone_Dive.BP_OnDroneStartedDiving
	// void BP_OnDroneStartedDiving();                                                                                          // [0x1340978] BlueprintAuthorityOnly|Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void StopTargeting();                                                                                                    // [0xbf833a0] Final|Native|Protected|BlueprintCallable 
	// Function /Script/ScoutDroneRuntime.FortGameplayAbility_ScoutDrone_TargetingBase.StartTargeting
	// void StartTargeting();                                                                                                   // [0xbf83378] Final|Native|Protected|BlueprintCallable 
	// Function /Script/ScoutDroneRuntime.FortGameplayAbility_ScoutDrone_TargetingBase.BP_OnTargetsFound
	// void BP_OnTargetsFound(FTargetingRequestHandle& TargetingHandle);                                                        // [0x1340978] Event|Protected|HasOutParms|BlueprintEvent 
};
...
public:
	...
	// void OnDoorBashed(FHitResult& HitResult, class UFortBuildingWallDoorComponent* BashedDoor);                              // [0x1340978] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/ScoutDroneRuntime.FortGameplayAbility_ScoutDrone_SpeedBoost.OnBoostedIntoActor
	// void OnBoostedIntoActor(FHitResult& HitResult);                                                                          // [0x1340978] Event|Protected|HasOutParms|BlueprintEvent 
};
...
public:
	SMember(FScalableFloat)                            HoldToDeployTime                                            OFFSET(getStruct<T>, {0x1570, 40, 0, 0})
};
...
public:
	...
	// class AFortScoutDrone* GetControlledDrone();                                                                             // [0xbf825d8] Final|Native|Protected|BlueprintCallable 
};
...
public:
	...
	// void OnStoppedHighlightingTarget(class AActor* Target);                                                                  // [0x1340978] BlueprintCosmetic|Event|Protected|BlueprintEvent 
	// Function /Script/ScoutDroneRuntime.FortGameplayAbility_ScoutDrone_MarkPotentialTargets.OnStartHighlightingTarget
	// void OnStartHighlightingTarget(class AActor* Target);                                                                    // [0x1340978] BlueprintCosmetic|Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void OnRep_CurrentTargetStatus();                                                                                        // [0xbf82eec] Final|Native|Protected 
	// Function /Script/ScoutDroneRuntime.FortGameplayAbility_ScoutDrone_PassiveMark.OnActorIndicatorExpired
	// void OnActorIndicatorExpired(class AActor* IndicatedActor);                                                              // [0xbf827dc] Final|Native|Private 
	// Function /Script/ScoutDroneRuntime.FortGameplayAbility_ScoutDrone_PassiveMark.BP_OnTargetStatusChanged
	// void BP_OnTargetStatusChanged(class AActor* ActiveTarget);                                                               // [0x1340978] BlueprintAuthorityOnly|Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void ServerConfirmTargets();                                                                                             // [0x8ab0a8c] Final|Net|NetReliableNative|Event|Private|NetServer 
};
...
public:
	...
	// void OnViewTargetChanged(class AFortPlayerController* PlayerController, class AActor* OldViewTarget, class AActor* NewViewTarget); // [0xbf8306c] Final|Native|Private 
};
...
public:
	...
	// void OnRep_Energy(FFortGameplayAttributeData& OldValue);                                                                 // [0xbf82f00] Final|Native|Protected|HasOutParms 
};
...
public:
	...
	// void SetupGameplayAudioParameters();                                                                                     // [0xbf83350] Final|BlueprintCosmetic|Native|Protected|BlueprintCallable 
	// Function /Script/ScoutDroneRuntime.FortScoutDrone.SetTeamMatesIndicator
	// void SetTeamMatesIndicator(bool bState);                                                                                 // [0xbf832d0] Final|Native|Protected|BlueprintCallable 
	// Function /Script/ScoutDroneRuntime.FortScoutDrone.SetAffiliationAudio
	// void SetAffiliationAudio();                                                                                              // [0xbf832bc] Final|Native|Protected|BlueprintCallable 
	// Function /Script/ScoutDroneRuntime.FortScoutDrone.OnRep_ControllingPlayerPawn
	// void OnRep_ControllingPlayerPawn();                                                                                      // [0xbf82ec4] Final|Native|Private 
	// Function /Script/ScoutDroneRuntime.FortScoutDrone.OnDeathPlayEffects
	// void OnDeathPlayEffects(float Damage, FGameplayTagContainer& DamageTags, FVector Momentum, FHitResult& HitInfo, class AFortPawn* InstigatedBy, class AActor* DamageCauser, FGameplayEffectContextHandle EffectContext); // [0x1340978] BlueprintCosmetic|Event|Protected|HasOutParms|HasDefaults|BlueprintEvent 
	// Function /Script/ScoutDroneRuntime.FortScoutDrone.OnDamagePlayEffects
	// void OnDamagePlayEffects(float Damage, FGameplayTagContainer& DamageTags, FVector Momentum, FHitResult& HitInfo, class AFortPawn* InstigatedBy, class AActor* DamageCauser, FGameplayEffectContextHandle EffectContext); // [0x1340978] BlueprintCosmetic|Event|Protected|HasOutParms|HasDefaults|BlueprintEvent 
	// Function /Script/ScoutDroneRuntime.FortScoutDrone.GetHealthPercentage
	// float GetHealthPercentage();                                                                                             // [0xbf82780] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ScoutDroneRuntime.FortScoutDrone.GetForwardAndRightDotProducts_Native
	// void GetForwardAndRightDotProducts_Native(float& OutForwardDot, float& OutRightDot);                                     // [0xbf826a8] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/ScoutDroneRuntime.FortScoutDrone.GetDeltaRotator
	// FRotator GetDeltaRotator();                                                                                              // [0xbf82658] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ScoutDroneRuntime.FortScoutDrone.GetControllingPlayerPawn
	// class AFortPawn* GetControllingPlayerPawn();                                                                             // [0xbf82640] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ScoutDroneRuntime.FortScoutDrone.GameplayCue_Damage
	// void GameplayCue_Damage(TEnumAsByte<EGameplayCueEvent> EventType, FGameplayCueParameters Parameters);                    // [0x906f874] Native|Protected     
};
...
public:
	...
	// void ServerRequestDroneDismissal();                                                                                      // [0x8998b60] Final|Net|NetReliableNative|Event|Private|NetServer 
	// Function /Script/ScoutDroneRuntime.FortScoutDroneControllingComponent.OnWeaponEquipped
	// void OnWeaponEquipped(class AFortWeapon* NewWeapon, class AFortWeapon* PrevWeapon);                                      // [0xbf83164] Final|Native|Private 
	// Function /Script/ScoutDroneRuntime.FortScoutDroneControllingComponent.OnRep_CurrentDestructionData
	// void OnRep_CurrentDestructionData();                                                                                     // [0xbf82ed8] Final|Native|Private 
	// Function /Script/ScoutDroneRuntime.FortScoutDroneControllingComponent.OnRep_ControlledDrone
	// void OnRep_ControlledDrone();                                                                                            // [0xbf82e88] Final|Native|Private 
	// Function /Script/ScoutDroneRuntime.FortScoutDroneControllingComponent.OnPlayerInterruptionTagsChanged
	// void OnPlayerInterruptionTagsChanged(FGameplayTag tag, int32_t NewCount);                                                // [0xbf82d24] Final|Native|Private 
	// Function /Script/ScoutDroneRuntime.FortScoutDroneControllingComponent.OnOwningPlayerStartedDBNO
	// void OnOwningPlayerStartedDBNO();                                                                                        // [0xbf82c48] Final|Native|Private 
	// Function /Script/ScoutDroneRuntime.FortScoutDroneControllingComponent.OnControlledDroneDestroyed
	// void OnControlledDroneDestroyed(class AActor* InControlledDrone);                                                        // [0xbf82bc8] Final|Native|Private 
	// Function /Script/ScoutDroneRuntime.FortScoutDroneControllingComponent.GetControlledDrone
	// class AFortScoutDrone* GetControlledDrone();                                                                             // [0x89c1abc] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ScoutDroneRuntime.FortScoutDroneControllingComponent.BP_OnPlayerShortInteract
	// void BP_OnPlayerShortInteract();                                                                                         // [0x1340978] BlueprintCosmetic|Event|Protected|BlueprintEvent 
	// Function /Script/ScoutDroneRuntime.FortScoutDroneControllingComponent.BP_OnPlayerInteractLongUseChanged
	// void BP_OnPlayerInteractLongUseChanged(bool bInteracting, bool bLongUseInteractionCompleted);                            // [0x1340978] BlueprintCosmetic|Event|Protected|BlueprintEvent 
	// Function /Script/ScoutDroneRuntime.FortScoutDroneControllingComponent.BP_OnDroneDestroyed
	// void BP_OnDroneDestroyed(FGameplayTag& DismissalReason);                                                                 // [0x1340978] BlueprintCosmetic|Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/ScoutDroneRuntime.FortScoutDroneControllingComponent.BP_OnDismissalStarted
	// void BP_OnDismissalStarted(bool bInstantDismissal, FGameplayTag DismissalReason);                                        // [0x1340978] BlueprintCosmetic|Event|Protected|BlueprintEvent 
	// Function /Script/ScoutDroneRuntime.FortScoutDroneControllingComponent.BP_OnDestructionStarted
	// void BP_OnDestructionStarted(bool bInstantDestruction, FGameplayTag DismissalReason);                                    // [0x1340978] BlueprintCosmetic|Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void ServerUpdateItemAttachment(FVector CalculatedItemOffset);                                                           // [0xbf83228] Final|Net|NetReliableNative|Event|Private|NetServer|HasDefaults 
	// Function /Script/ScoutDroneRuntime.FortScoutDronePickupManager.ServerDropAttachedActors
	// void ServerDropAttachedActors();                                                                                         // [0x3145fc4] Net|NetReliableNative|Event|Public|NetServer 
	// Function /Script/ScoutDroneRuntime.FortScoutDronePickupManager.OnRep_AttachedTargets
	// void OnRep_AttachedTargets();                                                                                            // [0xbf82e00] Final|Native|Private 
	// Function /Script/ScoutDroneRuntime.FortScoutDronePickupManager.OnPawnDBNOStateChanged
	// void OnPawnDBNOStateChanged(class AFortPawn* Pawn, bool bIsDBNO);                                                        // [0xbf82c5c] Final|Native|Private 
	// Function /Script/ScoutDroneRuntime.FortScoutDronePickupManager.OnAttachedPawnDied
	// void OnAttachedPawnDied(class AActor* DamagedActor, float Damage, class AController* InstigatedBy, class AActor* DamageCauser, FVector HitLocation, class UPrimitiveComponent* FHitComponent, FName BoneName, FVector Momentum); // [0xbf8285c] Final|Native|Private|HasDefaults 
	// Function /Script/ScoutDroneRuntime.FortScoutDronePickupManager.HasAPawnAtached
	// bool HasAPawnAtached();                                                                                                  // [0xbf827a0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ScoutDroneRuntime.FortScoutDronePickupManager.HasAnyAttachedActors
	// bool HasAnyAttachedActors();                                                                                             // [0xbf827bc] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ScoutDroneRuntime.FortScoutDronePickupManager.BP_OnActorsDetached
	// void BP_OnActorsDetached();                                                                                              // [0x1340978] BlueprintCosmetic|Event|Protected|BlueprintEvent 
	// Function /Script/ScoutDroneRuntime.FortScoutDronePickupManager.BP_OnActorsAttached
	// void BP_OnActorsAttached();                                                                                              // [0x1340978] BlueprintCosmetic|Event|Protected|BlueprintEvent 
};
