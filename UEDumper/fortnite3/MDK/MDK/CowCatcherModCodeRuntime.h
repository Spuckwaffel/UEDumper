...
/// Class /Script/CowCatcherModCodeRuntime.CowCatcherBarricadeBase
...
public:
	...
	// void OnPlacementBlockedByPawnChanged(bool bBlockedByPawn);                                                               // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/CowCatcherModCodeRuntime.CowCatcherBarricadeBase.BeginCheckingForTouchingPawns
	// void BeginCheckingForTouchingPawns();                                                                                    // [0xbb6d464] Final|BlueprintAuthorityOnly|Native|Protected|BlueprintCallable 
};
