...
public:
	...
	// class USkeleton* MergeSkeletons(FSkeletonMergeParams& Params);                                                           // [0x7728004] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/SkeletalMerging.SkeletalMergingLibrary.MergeMeshes
	// class USkeletalMesh* MergeMeshes(FSkeletalMeshMergeParams& Params);                                                      // [0x7727f68] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
