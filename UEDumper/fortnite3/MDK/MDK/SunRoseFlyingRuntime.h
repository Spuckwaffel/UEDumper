...
public:
	...
	// void SetFlappingParameters(class UFXSystemComponent* FlyingTrailFX, TArray<UAudioComponent*>& AudioComponents, class AFortPlayerPawn* PlayerPawn, float FlappingAlpha, float RollCombined, float RollingAlpha, float PitchAlpha, bool bIsBoosting, bool bIsAscending, bool bAllowWingFlap, bool bIsSkimming, float Speed, bool bIsDiving, float CurrentHeight); // [0xb54e8d8] Final|Native|Private|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// void ShowWingFX(FVector SkimLocationLeft, FVector SkimNormalLeft, float SkimDistanceLeft, FVector SkimLocationRight, FVector SkimNormalRight, float SkimDistanceRight); // [0xb54f5b8] Final|Native|Public|HasDefaults|BlueprintCallable 
};
...
public:
	...
	// bool UseNativeCalculation();                                                                                             // [0xb550604] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void UpdateForRotation(FFortMovementMode_WingedFlyingRuntimeData& MoveStatus, float DeltaTime, FRotator& OutNewMoveOrientation); // [0xb550428] Native|Event|Public|HasOutParms|HasDefaults|BlueprintEvent 
	// Function /Script/SunRoseFlyingRuntime.FortMovementMode_ExtLogicFlyingWinged.UpdateForMovement
	// void UpdateForMovement(FFortMovementMode_WingedFlyingRuntimeData& MoveStatus, float DeltaTime, FVector& InVelocity, FVector& InAcceleration, FVector& OutNewVelocity, FVector& OutNewAcceleration, FFortMovementMode_WingedFlyingRuntimeData& OutNewMoveStatus); // [0xb54fe10] Native|Event|Public|HasOutParms|HasDefaults|BlueprintEvent 
	// Function /Script/SunRoseFlyingRuntime.FortMovementMode_ExtLogicFlyingWinged.UpdateForHitResponse
	// void UpdateForHitResponse(FFortMovementMode_WingedFlyingRuntimeData& MoveStatus, float DeltaTime, FVector& InVelocity, FVector& OldPosition, FVector& Adjustment, FHitResult& Hit, EFortMovementModeExt_PhysUpdateResult& OutHitResult, bool& bOutWantToSlide); // [0xb54f7d0] Native|Event|Public|HasOutParms|HasDefaults|BlueprintEvent 
	// Function /Script/SunRoseFlyingRuntime.FortMovementMode_ExtLogicFlyingWinged.IsClientReplaying
	// bool IsClientReplaying();                                                                                                // [0xb54e884] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/SunRoseFlyingRuntime.FortMovementMode_ExtLogicFlyingWinged.HandleFlyingStatusChanged
	// void HandleFlyingStatusChanged(FFortMovementMode_WingedFlyingRuntimeData& MoveStatus, EWingedFlyingStatus NewStatus, bool bIsActive, FGameplayTag& FailureTag); // [0x1340978] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/SunRoseFlyingRuntime.FortMovementMode_ExtLogicFlyingWinged.HandleFlyingStatusActivationFailed
	// void HandleFlyingStatusActivationFailed(EWingedFlyingStatus FailedStatus, FGameplayTag& FailureTag);                     // [0x1340978] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/SunRoseFlyingRuntime.FortMovementMode_ExtLogicFlyingWinged.CanStartFlyingStatus
	// void CanStartFlyingStatus(FFortMovementMode_WingedFlyingRuntimeData& MoveStatus, EWingedFlyingStatus StatusToStart, bool& bOutCanStart, FGameplayTag& OutFailureTag); // [0xb54e630] Native|Event|Protected|HasOutParms|BlueprintEvent|Const 
	// Function /Script/SunRoseFlyingRuntime.FortMovementMode_ExtLogicFlyingWinged.CanEndFlyingStatus
	// bool CanEndFlyingStatus(FFortMovementMode_WingedFlyingRuntimeData& MoveStatus, EWingedFlyingStatus StatusToEnd, float ElapsedDuration); // [0xb54e36c] Native|Event|Protected|HasOutParms|BlueprintEvent|Const 
	// Function /Script/SunRoseFlyingRuntime.FortMovementMode_ExtLogicFlyingWinged.CanContinueFlyingStatus
	// void CanContinueFlyingStatus(FFortMovementMode_WingedFlyingRuntimeData& MoveStatus, EWingedFlyingStatus StatusToContinue, float ElapsedDuration, bool& bOutCanContinue, FGameplayTag& OutFailureTag); // [0xb54e008] Native|Event|Protected|HasOutParms|BlueprintEvent|Const 
};
...
public:
	...
	// void UpdateCurrentFlyingEnergy(float NewFlyingEnergy, bool bForceUpdateFX);                                              // [0x21f184c] Final|BlueprintCosmetic|Native|Public|BlueprintCallable 
	// Function /Script/SunRoseFlyingRuntime.FortPawnComponent_WingedFlying.StartFlying
	// void StartFlying(FFortMovementMode_WingedFlyingCreationData& CreationData);                                              // [0xb55c328] BlueprintCosmetic|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/SunRoseFlyingRuntime.FortPawnComponent_WingedFlying.HandleRightSkimCheckComplete
	// void HandleRightSkimCheckComplete(FHitResult& HitResult);                                                                // [0x1340978] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/SunRoseFlyingRuntime.FortPawnComponent_WingedFlying.HandleOwnerASCInitialized
	// void HandleOwnerASCInitialized(class UFortAbilitySystemComponent* AbilitySystemComponent, class AFortPlayerPawn* AffectedPawn); // [0x37b0f58] Final|Native|Protected 
	// Function /Script/SunRoseFlyingRuntime.FortPawnComponent_WingedFlying.HandleLeftSkimCheckComplete
	// void HandleLeftSkimCheckComplete(FHitResult& HitResult);                                                                 // [0x1340978] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/SunRoseFlyingRuntime.FortPawnComponent_WingedFlying.HandleForwardSpeedUpdated
	// void HandleForwardSpeedUpdated(float NewForwardSpeed);                                                                   // [0x1340978] Event|Public|BlueprintEvent 
	// Function /Script/SunRoseFlyingRuntime.FortPawnComponent_WingedFlying.HandleFlyingMoveStatusUpdated
	// void HandleFlyingMoveStatusUpdated(FFortMovementMode_WingedFlyingRuntimeData& MoveStatus);                               // [0xb55c004] Native|Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/SunRoseFlyingRuntime.FortPawnComponent_WingedFlying.HandleAddedDownZVelocityUpdated
	// void HandleAddedDownZVelocityUpdated(float NewAddedDownZVelocity);                                                       // [0x1340978] Event|Public|BlueprintEvent 
	// Function /Script/SunRoseFlyingRuntime.FortPawnComponent_WingedFlying.GetLocalFlyingMoveActionValue
	// FVector2D GetLocalFlyingMoveActionValue();                                                                               // [0xb55bf0c] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/SunRoseFlyingRuntime.FortPawnComponent_WingedFlying.EndFlying
	// void EndFlying();                                                                                                        // [0xb55b910] Final|BlueprintCosmetic|Native|Public|BlueprintCallable 
};

/// Class /Script/SunRoseFlyingRuntime.FortWeaponWings
/// Size: 0x0130 (0x001570 - 0x0016A0)
...
public:
	CMember(class UMaterialInstanceDynamic*)           WingsMaterialInstance                                       OFFSET(get<T>, {0x15A0, 8, 0, 0})
	SMember(FGameplayTag)                              IsFlyingGameplayTag                                         OFFSET(getStruct<T>, {0x15A8, 4, 0, 0})
	SMember(FName)                                     IsFallingAudioParamName                                     OFFSET(getStruct<T>, {0x15AC, 4, 0, 0})
	SMember(FName)                                     FeatherDissolveName                                         OFFSET(getStruct<T>, {0x15B0, 4, 0, 0})
	SMember(FName)                                     ReplenishAnimationName                                      OFFSET(getStruct<T>, {0x15B4, 4, 0, 0})
	CMember(class USoundBase*)                         OutOfEnergy2DSound                                          OFFSET(get<T>, {0x15B8, 8, 0, 0})
	SMember(FGameplayTagContainer)                     OwnedGameplayTags                                           OFFSET(getStruct<T>, {0x15C0, 32, 0, 0})
	CMember(class UFortAbilitySystemComponent*)        AbilitySystemComponent                                      OFFSET(get<T>, {0x15E0, 8, 0, 0})
	CMember(class UFortHealthSet*)                     HealthSet                                                   OFFSET(get<T>, {0x15E8, 8, 0, 0})
	CMember(TEnumAsByte<EPhysicalSurface>)             PrimarySurfaceType                                          OFFSET(get<T>, {0x15F0, 1, 0, 0})
	CMember(TEnumAsByte<EFortBaseWeaponDamage>)        WeaponResponseType                                          OFFSET(get<T>, {0x15F1, 1, 0, 0})
	CMember(class UClass*)                             DamageGameplayEffectClass                                   OFFSET(get<T>, {0x15F8, 8, 0, 0})
	SMember(FGameplayTag)                              SetByCallerDamageTag                                        OFFSET(getStruct<T>, {0x1600, 4, 0, 0})
	SMember(FGameplayTagContainer)                     TagsToPreventReload                                         OFFSET(getStruct<T>, {0x1608, 32, 0, 0})
	SMember(FScalableFloat)                            ServerMeshRelativeRotationRoll                              OFFSET(getStruct<T>, {0x1628, 40, 0, 0})
	SMember(FScalableFloat)                            ServerMeshRelativeLocationY                                 OFFSET(getStruct<T>, {0x1650, 40, 0, 0})
	SMember(FScalableFloat)                            ServerMeshRelativeLocationZ                                 OFFSET(getStruct<T>, {0x1678, 40, 0, 0})


	/// Functions
	// Function /Script/SunRoseFlyingRuntime.FortWeaponWings.TryResetADSInput
	// void TryResetADSInput(class AFortWeapon* Weapon);                                                                        // [0xb55c68c] Final|Native|Protected 
	// Function /Script/SunRoseFlyingRuntime.FortWeaponWings.NativeUpdateEnergyFX
	// void NativeUpdateEnergyFX(bool bForceUpdate);                                                                            // [0xb55c0ac] Final|BlueprintCosmetic|Native|Public|BlueprintCallable 
	// Function /Script/SunRoseFlyingRuntime.FortWeaponWings.HandleWeaponAttachmentChanged
	// void HandleWeaponAttachmentChanged(class AFortWeapon* NewWeapon, class AFortWeapon* PrevWeapon);                         // [0x32b84c0] Final|Native|Protected 
	// Function /Script/SunRoseFlyingRuntime.FortWeaponWings.HandleSecondaryFirePressed
	// void HandleSecondaryFirePressed(class AFortWeapon* Weapon);                                                              // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/SunRoseFlyingRuntime.FortWeaponWings.HandleDBNOStateChanged
	// void HandleDBNOStateChanged(class AFortPawn* FortPawn, bool bInIsDBNO);                                                  // [0xb55bf3c] Final|Native|Protected 
	// Function /Script/SunRoseFlyingRuntime.FortWeaponWings.BP_ModifyIncomingDamage
	// void BP_ModifyIncomingDamage(float Damage, FGameplayTagContainer& DamageTags, FHitResult& DamageHit, class AController* EventInstigator, class AActor* DamageCauser, float& OutNewDamage); // [0x1340978] BlueprintAuthorityOnly|Event|Protected|HasOutParms|BlueprintEvent 
};
...
public:
	...
	// void TraceForWorldAndWater(class AActor* PlayerPawn, FVector& TraceStart, FVector& TraceEnd, bool& bIsBlockingHit, FHitResult& ClosestHit); // [0xb55c3e8] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/SunRoseFlyingRuntime.FortWingedFlyingBlueprintLibrary.SetInputActionDisplayContext
	// void SetInputActionDisplayContext(class AFortPawn* PlayerPawn, class UFortInputMappingContext* InputMappingContext);     // [0xb55c12c] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/SunRoseFlyingRuntime.FortWingedFlyingBlueprintLibrary.GetFlyingStatusElapsedTime
	// float GetFlyingStatusElapsedTime(EWingedFlyingStatus FlyingStatus, FFortMovementMode_WingedFlyingRuntimeData& MoveStatus); // [0xb55be1c] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/SunRoseFlyingRuntime.FortWingedFlyingBlueprintLibrary.GetFlyingDuration
	// float GetFlyingDuration(FFortMovementMode_WingedFlyingRuntimeData& MoveStatus);                                          // [0xb55bd78] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/SunRoseFlyingRuntime.FortWingedFlyingBlueprintLibrary.GetDodgeElapsedTime
	// float GetDodgeElapsedTime(FFortMovementMode_WingedFlyingRuntimeData& MoveStatus);                                        // [0xb55bcbc] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/SunRoseFlyingRuntime.FortWingedFlyingBlueprintLibrary.FlyingStatusRemoveFlags
	// void FlyingStatusRemoveFlags(EWingedFlyingStatus Status, int32_t FlagsToRemove, EWingedFlyingStatus& NewStatus);         // [0xb55bbbc] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/SunRoseFlyingRuntime.FortWingedFlyingBlueprintLibrary.FlyingStatusHasAnyFlags
	// bool FlyingStatusHasAnyFlags(EWingedFlyingStatus Status, int32_t Flags);                                                 // [0xb55bafc] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/SunRoseFlyingRuntime.FortWingedFlyingBlueprintLibrary.FlyingStatusHasAllFlags
	// bool FlyingStatusHasAllFlags(EWingedFlyingStatus Status, int32_t Flags);                                                 // [0xb55ba38] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/SunRoseFlyingRuntime.FortWingedFlyingBlueprintLibrary.FlyingStatusAddFlags
	// void FlyingStatusAddFlags(EWingedFlyingStatus Status, int32_t FlagsToAdd, EWingedFlyingStatus& NewStatus);               // [0xb55b938] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/SunRoseFlyingRuntime.FortWingedFlyingBlueprintLibrary.ClearInputActionDisplayContext
	// void ClearInputActionDisplayContext(class AFortPawn* PlayerPawn, class UFortInputMappingContext* InputMappingContext);   // [0xb55b774] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	SMember(FGameplayTag)                              AscenderTag                                                 OFFSET(getStruct<T>, {0x1510, 4, 0, 0})
	SMember(FGameplayTag)                              GrindRailsTag                                               OFFSET(getStruct<T>, {0x1514, 4, 0, 0})
	SMember(FGameplayTag)                              WingedFlightTag                                             OFFSET(getStruct<T>, {0x1518, 4, 0, 0})
	SMember(FGameplayTag)                              WingsForceCrashTag                                          OFFSET(getStruct<T>, {0x151C, 4, 0, 0})
	SMember(FGameplayTag)                              WingsLeapingTag                                             OFFSET(getStruct<T>, {0x1520, 4, 0, 0})
	DMember(float)                                     CurrentHeightAboveWorld                                     OFFSET(get<float>, {0x1524, 4, 0, 0})
	DMember(float)                                     Fuel                                                        OFFSET(get<float>, {0x1528, 4, 0, 0})
	DMember(float)                                     GlidePitch                                                  OFFSET(get<float>, {0x152C, 4, 0, 0})
	DMember(float)                                     GlidePitchAlpha                                             OFFSET(get<float>, {0x1530, 4, 0, 0})
	DMember(float)                                     GlidePitchInterp                                            OFFSET(get<float>, {0x1534, 4, 0, 0})
	DMember(float)                                     GlidePitchTarget                                            OFFSET(get<float>, {0x1538, 4, 0, 0})
	DMember(float)                                     GlideRoll                                                   OFFSET(get<float>, {0x153C, 4, 0, 0})
	DMember(float)                                     GlideRollCombined                                           OFFSET(get<float>, {0x1540, 4, 0, 0})
	DMember(float)                                     GlideRollCombinedTarget                                     OFFSET(get<float>, {0x1544, 4, 0, 0})
	DMember(float)                                     GlideRollInterp                                             OFFSET(get<float>, {0x1548, 4, 0, 0})
	DMember(float)                                     GroundBlendTime                                             OFFSET(get<float>, {0x154C, 4, 0, 0})
	DMember(float)                                     pelvis                                                      OFFSET(get<float>, {0x1550, 4, 0, 0})
	DMember(float)                                     PitchAlpha                                                  OFFSET(get<float>, {0x1554, 4, 0, 0})
	DMember(float)                                     RollAlpha                                                   OFFSET(get<float>, {0x1558, 4, 0, 0})
	DMember(float)                                     SlowDownOrLandAlpha                                         OFFSET(get<float>, {0x155C, 4, 0, 0})
	DMember(float)                                     SlowDownOrLandTarget                                        OFFSET(get<float>, {0x1560, 4, 0, 0})
	DMember(float)                                     SlowSpeedAlpha                                              OFFSET(get<float>, {0x1564, 4, 0, 0})
	DMember(float)                                     YawAlpha                                                    OFFSET(get<float>, {0x1568, 4, 0, 0})
	DMember(float)                                     YawBlend                                                    OFFSET(get<float>, {0x156C, 4, 0, 0})
	DMember(int32_t)                                   RandomInteger                                               OFFSET(get<int32_t>, {0x1570, 4, 0, 0})
	DMember(bool)                                      bIsAllowWingFlap                                            OFFSET(get<bool>, {0x1574, 1, 1, 0})
	DMember(bool)                                      bIsAscending                                                OFFSET(get<bool>, {0x1574, 1, 1, 1})
	DMember(bool)                                      bIsBoostStartEnd                                            OFFSET(get<bool>, {0x1574, 1, 1, 2})
	DMember(bool)                                      bIsDodgeLeft                                                OFFSET(get<bool>, {0x1574, 1, 1, 3})
	DMember(bool)                                      bIsDodgeRight                                               OFFSET(get<bool>, {0x1574, 1, 1, 4})
	DMember(bool)                                      bIsExtBoostEarly                                            OFFSET(get<bool>, {0x1574, 1, 1, 5})
	DMember(bool)                                      bIsFlyingStart                                              OFFSET(get<bool>, {0x1574, 1, 1, 6})
	DMember(bool)                                      bIsForceDive                                                OFFSET(get<bool>, {0x1574, 1, 1, 7})
	DMember(bool)                                      bIsLeapInterruptible                                        OFFSET(get<bool>, {0x1575, 1, 1, 0})
	DMember(bool)                                      bIsHighWithNoFuel                                           OFFSET(get<bool>, {0x1575, 1, 1, 1})
	DMember(bool)                                      bIsOnAscender                                               OFFSET(get<bool>, {0x1575, 1, 1, 2})
	DMember(bool)                                      bIsOnGrindRail                                              OFFSET(get<bool>, {0x1575, 1, 1, 3})
	DMember(bool)                                      bIsPlayDiveHitToIdle                                        OFFSET(get<bool>, {0x1575, 1, 1, 4})
	DMember(bool)                                      bIsPlayLandAdditive                                         OFFSET(get<bool>, {0x1575, 1, 1, 5})
	DMember(bool)                                      bIsWingLeaping                                              OFFSET(get<bool>, {0x1575, 1, 1, 6})
	DMember(bool)                                      bIsWingReplenish                                            OFFSET(get<bool>, {0x1575, 1, 1, 7})
	DMember(bool)                                      bIsWingsBoosting                                            OFFSET(get<bool>, {0x1576, 1, 1, 0})
	DMember(bool)                                      bIsWingsCrashing                                            OFFSET(get<bool>, {0x1576, 1, 1, 1})
	DMember(bool)                                      bIsWingsFlying                                              OFFSET(get<bool>, {0x1576, 1, 1, 2})
	DMember(bool)                                      bIsDiveStart                                                OFFSET(get<bool>, {0x1576, 1, 1, 3})
	DMember(bool)                                      bToBoosting                                                 OFFSET(get<bool>, {0x1576, 1, 1, 4})
};
...
public:
	...
	// void UpdateTelegraph();                                                                                                  // [0xb55c70c] Final|Native|Public|BlueprintCallable 
	// Function /Script/SunRoseFlyingRuntime.FortGameplayAbility_SunroseWingsCrashBase.EndTelegraph
	// void EndTelegraph();                                                                                                     // [0xb55b924] Final|Native|Public|BlueprintCallable 
	// Function /Script/SunRoseFlyingRuntime.FortGameplayAbility_SunroseWingsCrashBase.BeginTelegraph
	// void BeginTelegraph();                                                                                                   // [0xb55b760] Final|Native|Public|BlueprintCallable 
};
