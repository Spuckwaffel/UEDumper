...
public:
	...
	// bool UseNativeCalculation();                                                                                             // [0xbc13d50] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};

/// Class /Script/HumbleMopGameplayRuntime.HumbleMopPlayerAnimInstance
/// Size: 0x0120 (0x001510 - 0x001630)
...
public:
	SMember(FName)                                     CurveName_UserCurve01                                       OFFSET(getStruct<T>, {0x1510, 4, 0, 0})
	SMember(FName)                                     CurveName_UserCurve02                                       OFFSET(getStruct<T>, {0x1514, 4, 0, 0})
	SMember(FName)                                     BoneName_Root                                               OFFSET(getStruct<T>, {0x1518, 4, 0, 0})
	SMember(FString)                                   MontageString_HumbleMop_SpawnWheel_M                        OFFSET(getStruct<T>, {0x1520, 16, 0, 0})
	SMember(FGameplayTag)                              HumbleMopWheelRollingTag                                    OFFSET(getStruct<T>, {0x1530, 4, 0, 0})
	SMember(FGameplayTag)                              HumbleMopWheelWindingUpTag                                  OFFSET(getStruct<T>, {0x1534, 4, 0, 0})
	SMember(FGameplayTag)                              HumbleMopWheelWindingDownTag                                OFFSET(getStruct<T>, {0x1538, 4, 0, 0})
	SMember(FGameplayTag)                              HumbleMopSuperJumpActiveTag                                 OFFSET(getStruct<T>, {0x153C, 4, 0, 0})
	SMember(FGameplayTag)                              GameplayActionPlayerSprintTag                               OFFSET(getStruct<T>, {0x1540, 4, 0, 0})
	DMember(float)                                     InterpSpeed                                                 OFFSET(get<float>, {0x1544, 4, 0, 0})
	DMember(float)                                     ExitNoiseInterpSpeed                                        OFFSET(get<float>, {0x1548, 4, 0, 0})
	DMember(float)                                     ForwardSpeedRemapOldMin                                     OFFSET(get<float>, {0x154C, 4, 0, 0})
	DMember(float)                                     ForwardSpeedRemapOldMax                                     OFFSET(get<float>, {0x1550, 4, 0, 0})
	DMember(float)                                     ForwardSpeedRemapNewMin                                     OFFSET(get<float>, {0x1554, 4, 0, 0})
	DMember(float)                                     ForwardSpeedRemapNewMax                                     OFFSET(get<float>, {0x1558, 4, 0, 0})
	DMember(float)                                     LateralSpeedRemapOldMin                                     OFFSET(get<float>, {0x155C, 4, 0, 0})
	DMember(float)                                     LateralSpeedRemapOldMax                                     OFFSET(get<float>, {0x1560, 4, 0, 0})
	DMember(float)                                     LateralSpeedRemapNewMin                                     OFFSET(get<float>, {0x1564, 4, 0, 0})
	DMember(float)                                     LateralSpeedRemapNewMax                                     OFFSET(get<float>, {0x1568, 4, 0, 0})
	DMember(float)                                     NoiseAlphaRemapOldMin                                       OFFSET(get<float>, {0x156C, 4, 0, 0})
	DMember(float)                                     NoiseAlphaRemapOldMax                                       OFFSET(get<float>, {0x1570, 4, 0, 0})
	DMember(float)                                     NoiseAlphaRemapNewMin                                       OFFSET(get<float>, {0x1574, 4, 0, 0})
	DMember(float)                                     NoiseAlphaRemapNewMax                                       OFFSET(get<float>, {0x1578, 4, 0, 0})
	DMember(float)                                     ForwardSpeedInterpSpeed                                     OFFSET(get<float>, {0x157C, 4, 0, 0})
	DMember(float)                                     LateralSpeedInterpSpeed                                     OFFSET(get<float>, {0x1580, 4, 0, 0})
	DMember(float)                                     ExitNoiseAlpha                                              OFFSET(get<float>, {0x1584, 4, 0, 0})
	DMember(float)                                     InputLeftRight                                              OFFSET(get<float>, {0x1588, 4, 0, 0})
	DMember(float)                                     InputFrontBack                                              OFFSET(get<float>, {0x158C, 4, 0, 0})
	DMember(float)                                     ForwardSpeedInterp                                          OFFSET(get<float>, {0x1590, 4, 0, 0})
	DMember(float)                                     LateralSpeedInterp                                          OFFSET(get<float>, {0x1594, 4, 0, 0})
	DMember(float)                                     WheelNoiseAlpha                                             OFFSET(get<float>, {0x1598, 4, 0, 0})
	DMember(float)                                     WindUpPlayRate                                              OFFSET(get<float>, {0x159C, 4, 0, 0})
	DMember(bool)                                      bIsWindingDownOver                                          OFFSET(get<bool>, {0x15A0, 1, 1, 0})
	DMember(bool)                                      bIsWheelActive                                              OFFSET(get<bool>, {0x15A0, 1, 1, 1})
	DMember(bool)                                      bIsWindingUp                                                OFFSET(get<bool>, {0x15A0, 1, 1, 2})
	DMember(bool)                                      bIsWindingUpOver                                            OFFSET(get<bool>, {0x15A0, 1, 1, 3})
	DMember(bool)                                      bIsWindingDown                                              OFFSET(get<bool>, {0x15A0, 1, 1, 4})
	DMember(bool)                                      bIsWheelJumping                                             OFFSET(get<bool>, {0x15A0, 1, 1, 5})
	DMember(bool)                                      bIsWheelTacSprint                                           OFFSET(get<bool>, {0x15A0, 1, 1, 6})
	DMember(bool)                                      bIsWheelJumpLand                                            OFFSET(get<bool>, {0x15A0, 1, 1, 7})
	DMember(bool)                                      bIsWindJump                                                 OFFSET(get<bool>, {0x15A1, 1, 1, 0})
	DMember(bool)                                      bIsDolphinWindJump                                          OFFSET(get<bool>, {0x15A1, 1, 1, 1})
	SMember(FRotator)                                  PlayerCurrentRotation                                       OFFSET(getStruct<T>, {0x15A8, 24, 0, 0})
	SMember(FVector)                                   GoalUpVec                                                   OFFSET(getStruct<T>, {0x15C0, 24, 0, 0})
	SMember(FVector)                                   RightVec                                                    OFFSET(getStruct<T>, {0x15D8, 24, 0, 0})
	SMember(FRotator)                                  PlayerGoalRotation                                          OFFSET(getStruct<T>, {0x15F0, 24, 0, 0})
	SMember(FVector)                                   CurrentUpVec                                                OFFSET(getStruct<T>, {0x1608, 24, 0, 0})
};
