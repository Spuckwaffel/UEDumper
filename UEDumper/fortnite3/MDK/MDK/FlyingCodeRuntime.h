...
public:
	...
	// void BP_ProcessViewRotation(FRotator& InViewRotation, FRotator& InDeltaRot, float DeltaTime, bool& bOutShouldOverride, FRotator& OutViewRotation, FRotator& OutDeltaRot); // [0x1340978] Event|Public|HasOutParms|HasDefaults|BlueprintEvent|Const 
};
...
public:
	...
	// bool CanBeginFlying();                                                                                                   // [0x33f2000] Native|Event|Public|BlueprintEvent|Const 
};
