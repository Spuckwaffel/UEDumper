...
public:
	...
	// void OnPresentationModeChanged(EGiftingPresentationMode NewMode);                                                        // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/GiftingUI.AthenaGiftingConfirmationScreen.HandleTokenOfferPurchaseComplete
	// void HandleTokenOfferPurchaseComplete(bool bSuccess, TArray<FPurchasedItemInfo>& PurchasedItems);                        // [0xbc98754] Final|Native|Private|HasOutParms 
	// Function /Script/GiftingUI.AthenaGiftingConfirmationScreen.HandleGiftSent
	// void HandleGiftSent(bool bSuccess, TArray<FString>& IneligibleAccounts, TArray<FString>& ErrorCodes);                    // [0xbc983f0] Final|Native|Private|HasOutParms 
	// Function /Script/GiftingUI.AthenaGiftingConfirmationScreen.Dismiss
	// void Dismiss(bool bGiftConfirmed);                                                                                       // [0xbc98354] Final|Native|Private|BlueprintCallable 
};
...
public:
	...
	// void UpdateGiftEligibility(bool bStillGiftable);                                                                         // [0x1340978] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void SetPresentationMode(EGiftingPricePresentationMode Mode);                                                            // [0x1340978] Event|Protected|BlueprintEvent 
};
...
public:
	CMember(class UAthenaGiftingPriceWidget*)          Widget_Price                                                OFFSET(get<T>, {0x1518, 8, 0, 0})
	CMember(class UCommonTextBlock*)                   Text_Title                                                  OFFSET(get<T>, {0x1520, 8, 0, 0})
};
...
public:
	...
	// void PlayIntroAnimation();                                                                                               // [0x1340978] Event|Public|BlueprintEvent 
};
...
public:
	...
	// void OnShowSearchWarningText(bool bShow);                                                                                // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/GiftingUI.AthenaGiftingScreen.OnShownItemChanged
	// void OnShownItemChanged();                                                                                               // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/GiftingUI.AthenaGiftingScreen.OnSetupFilterTabButton
	// void OnSetupFilterTabButton(class UCommonButtonBase* Button, EFilterType FilterType);                                    // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/GiftingUI.AthenaGiftingScreen.OnPresentationModeChanged
	// void OnPresentationModeChanged(EGiftingScreenPresentationMode Mode);                                                     // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/GiftingUI.AthenaGiftingScreen.OnPartyListUpdated
	// void OnPartyListUpdated(bool bEmpty);                                                                                    // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/GiftingUI.AthenaGiftingScreen.OnHandlePreviewItem
	// void OnHandlePreviewItem(bool bUseWidePreview);                                                                          // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/GiftingUI.AthenaGiftingScreen.OnFriendSelectionChanged
	// void OnFriendSelectionChanged();                                                                                         // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/GiftingUI.AthenaGiftingScreen.OnFilterChanged
	// void OnFilterChanged(EFilterType FilterType);                                                                            // [0x1340978] Event|Protected|BlueprintEvent 
...
public:
	CMember(class UFortSocialAvatarIcon*)              Avatar_MemberIcon                                           OFFSET(get<T>, {0x15A0, 8, 0, 0})
	CMember(class USocialNameTextBlock*)               Text_SocialName                                             OFFSET(get<T>, {0x15A8, 8, 0, 0})
	CMember(class UCommonRichTextBlock*)               RichText_EligibilityStatus                                  OFFSET(get<T>, {0x15B0, 8, 0, 0})
	CMember(class UCommonRichTextBlock*)               RichText_OwnedItems                                         OFFSET(get<T>, {0x15B8, 8, 0, 0})
	CMember(class UAthenaGiftingPriceWidget*)          Widget_Price                                                OFFSET(get<T>, {0x15C0, 8, 0, 0})


	/// Functions
	// Function /Script/GiftingUI.FortGiftingSocialUserListEntry.SetPresentationMode
	// void SetPresentationMode(ERecipientPresentationMode Mode);                                                               // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/GiftingUI.FortGiftingSocialUserListEntry.OnUserItemSet
	// void OnUserItemSet();                                                                                                    // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/GiftingUI.FortGiftingSocialUserListEntry.OnRecipientStatusUpdated
	// void OnRecipientStatusUpdated();                                                                                         // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/GiftingUI.FortGiftingSocialUserListEntry.BP_OnTouchSelectionConfirmed
	// void BP_OnTouchSelectionConfirmed();                                                                                     // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/GiftingUI.FortGiftingSocialUserListEntry.BP_OnHighlightedStateChanged
	// void BP_OnHighlightedStateChanged(bool bInIsHighlighted, bool bPlayAnimation);                                           // [0x1340978] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void OnSearchCommit(bool bSearchStringShort);                                                                            // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/GiftingUI.FortGiftingUserSearchWidget.HandleSearchFriendsTextEntered
	// void HandleSearchFriendsTextEntered(FText& Text, TEnumAsByte<ETextCommit> CommitMethod);                                 // [0xbc985c8] Final|Native|Private|HasOutParms 
	// Function /Script/GiftingUI.FortGiftingUserSearchWidget.HandleSearchFriendsTextChanged
	// void HandleSearchFriendsTextChanged(FText& Text);                                                                        // [0xbc9853c] Final|Native|Private|HasOutParms 
	// Function /Script/GiftingUI.FortGiftingUserSearchWidget.FocusEditableText
	// void FocusEditableText();                                                                                                // [0xbc983d4] Final|Native|Protected|BlueprintCallable 
};
...
public:
	CMember(class UFortGiftBoxItemDefinition*)         GiftBoxDefinition                                           OFFSET(get<T>, {0x14D8, 8, 0, 0})
	CMember(class UCommonLazyImage*)                   Image_Gift                                                  OFFSET(get<T>, {0x14E0, 8, 0, 0})
};
