...
public:
	...
	// void FireEvent_EndJunoFishingSession(class AFortPlayerPawn* PlayerPawn, class UFortWorldItemDefinition* ItemFished, bool bFromHotspot, bool bIsPlayerSpawnedHotspot, FString HotspotTierTag, FString WaterBodyName, FString CatchTypeName, class AActor* ItemUsedToFish); // [0xccc0ccc] Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable 
	// Function /Script/JunoFishing.JunoFishingBlueprintLibrary.FireEvent_BeginJunoFishingSession
	// void FireEvent_BeginJunoFishingSession(class AFortPlayerPawn* PlayerPawn);                                               // [0xccc0c38] Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable 
};
