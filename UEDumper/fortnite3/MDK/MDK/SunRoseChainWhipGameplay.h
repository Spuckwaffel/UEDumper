...
public:
	DMember(bool)                                      bIsMotorcycle                                               OFFSET(get<bool>, {0x1510, 1, 0, 0})
	DMember(bool)                                      bIsHookshot                                                 OFFSET(get<bool>, {0x1511, 1, 0, 0})
	DMember(bool)                                      bIsTechniqueActive                                          OFFSET(get<bool>, {0x1512, 1, 0, 0})
	DMember(bool)                                      bIsHadesAO                                                  OFFSET(get<bool>, {0x1513, 1, 0, 0})
	DMember(bool)                                      bIsUpperBodyReplacement                                     OFFSET(get<bool>, {0x1514, 1, 0, 0})
	SMember(FGameplayTag)                              MotorcycleTag                                               OFFSET(getStruct<T>, {0x1518, 4, 0, 0})
	SMember(FGameplayTag)                              HookshotTag                                                 OFFSET(getStruct<T>, {0x151C, 4, 0, 0})
	SMember(FGameplayTag)                              DisableGrindRailUpperBodyCorrectTag                         OFFSET(getStruct<T>, {0x1520, 4, 0, 0})
};
...
public:
	...
	// void SunRoseSpawnHookShotShooter();                                                                                      // [0x35e6228] Final|Exec|Native|Public 
	// Function /Script/SunRoseChainWhipGameplay.FortCheatManager_SunRoseChainWhip.SunRoseRemoveHookShotShooter
	// void SunRoseRemoveHookShotShooter();                                                                                     // [0xb4158fc] Final|Exec|Native|Public 
	// Function /Script/SunRoseChainWhipGameplay.FortCheatManager_SunRoseChainWhip.SunRoseApplyHookShot
	// void SunRoseApplyHookShot(float Delay);                                                                                  // [0x68f8c0c] Final|Exec|Native|Public 
};
