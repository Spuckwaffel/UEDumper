...
public:
	...
	// FString GetSelectedHostName();                                                                                           // [0x850aa20] Final|Native|Public|BlueprintCallable 
	// Function /Script/EpicMediaCDNHostnames.EpicMediaCDNHostnames.GetHostnames
	// TArray<FString> GetHostnames();                                                                                          // [0x850a9e4] Final|Native|Public|BlueprintCallable 
};
