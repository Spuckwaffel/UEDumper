...
public:
	...
	// void ResetToDefault();                                                                                                   // [0xd2bf9ac] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// bool ExportToGLTF(class UObject* Object, FString FilePath, class UGLTFExportOptions* Options, TSet<AActor*>& SelectedActors, FGLTFExportMessages& OutMessages); // [0xd2bf144] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// void ResetToDefault();                                                                                                   // [0xd2bf9c0] Final|Native|Public|BlueprintCallable 
};
