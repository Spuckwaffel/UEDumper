...
public:
	...
	// void OnRep_TriggeredStrategies();                                                                                        // [0xcc50a3c] Final|Native|Private 
};
...
public:
	...
	// void Server_UntriggerStrategy(class UClass* StrategyClass);                                                              // [0xcc50aec] Net|NetReliableNative|Event|Public|NetServer 
	// Function /Script/JunoLowMemoryFallbackRuntime.JunoLowMemoryFallbackPlayerControllerComponent.Server_TriggerStrategy
	// void Server_TriggerStrategy(class UClass* StrategyClass);                                                                // [0xcc50a50] Net|NetReliableNative|Event|Public|NetServer 
};
