...
public:
	...
	// void QueueExecute();                                                                                                     // [0xbd22d28] Final|Native|Public|BlueprintCallable 
	// Function /Script/ComputeFramework.ComputeGraphComponent.DestroyDataProviders
	// void DestroyDataProviders();                                                                                             // [0xbd22cf8] Final|Native|Public|BlueprintCallable 
	// Function /Script/ComputeFramework.ComputeGraphComponent.CreateDataProviders
	// void CreateDataProviders(int32_t InBindingIndex, class UObject* InBindingObject);                                        // [0xbd22c18] Final|Native|Public|BlueprintCallable 
};
