...
public:
	...
	// void UpdateAudioShape(TArray<APlayerController*>& InLocalControllers);                                                   // [0x8423ea8] Final|Native|Public|HasOutParms 
	// Function /Script/AudioShapes.AudioShapeComponent.Enable
	// void Enable();                                                                                                           // [0x3145fc4] Native|Protected|BlueprintCallable 
	// Function /Script/AudioShapes.AudioShapeComponent.Disable
	// void Disable();                                                                                                          // [0x133f4e8] Native|Protected|BlueprintCallable 
};
...
public:
	...
	// bool GetIsPlayerInside();                                                                                                // [0x8423944] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AudioShapes.AudioShapePrimitiveComponent.GetInsideAudioComponent
	// class UAudioComponent* GetInsideAudioComponent();                                                                        // [0x84238f0] Final|Native|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/AudioShapes.AudioShapePrimitiveComponent.GetEdgeAudioComponent
	// class UAudioComponent* GetEdgeAudioComponent();                                                                          // [0x842389c] Final|Native|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// void SetBoxTransform(FTransform& InTransform);                                                                           // [0x8423ab0] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
};
...
public:
	...
	// void SetRadius(float InRadius);                                                                                          // [0x8423d48] Final|Native|Public|BlueprintCallable 
	// Function /Script/AudioShapes.AudioShapeCylinderComponent.SetHalfHeight
	// void SetHalfHeight(float InHalfHeight);                                                                                  // [0x8423cbc] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void SetStartPoint(FVector& InStartPoint);                                                                               // [0x8423dd4] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/AudioShapes.AudioShapeLineComponent.SetEndPoint
	// void SetEndPoint(FVector& InEndPoint);                                                                                   // [0x8423be8] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
};
...
public:
	...
	// bool UpdatePoint(int32_t InIndex, FVector& InPoint);                                                                     // [0x8423f44] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/AudioShapes.AudioShapeLineListComponent.RemovePoint
	// bool RemovePoint(int32_t InIndex);                                                                                       // [0x8423a00] Final|Native|Public|BlueprintCallable 
	// Function /Script/AudioShapes.AudioShapeLineListComponent.GetPoints
	// void GetPoints(TArray<FVector>& OutPoints);                                                                              // [0x8423960] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AudioShapes.AudioShapeLineListComponent.AddPoint
	// int32_t AddPoint(FVector& InPoint);                                                                                      // [0x842378c] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
};
...
public:
	...
	// void SetRadius(float InRadius);                                                                                          // [0x26bb710] Final|Native|Public|BlueprintCallable 
};
