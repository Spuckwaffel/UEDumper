...
public:
	...
	// class AActor* EntityInteractGetActor(class UObject* WorldContextObject, FHitResult& HitResult);                          // [0xc95f7b8] Final|Native|Static|Public|HasOutParms 
};
...
public:
	...
	// void OnRep_Message();                                                                                                    // [0xc95f8d4] Final|Native|Private 
};
