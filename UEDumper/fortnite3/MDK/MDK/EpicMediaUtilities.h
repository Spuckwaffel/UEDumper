...
public:
	...
	// void ServerRequestServerTime(double requestUtcTime);                                                                     // [0x850a728] Net|NetReliableNative|Event|Public|NetServer|BlueprintCallable 
	// Function /Script/EpicMediaUtilities.EpicMediaServerTime.GetTimeUtc
	// bool GetTimeUtc(FDateTime& OutDateTime);                                                                                 // [0x850a690] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/EpicMediaUtilities.EpicMediaServerTime.ClientReportServerTime
	// void ClientReportServerTime(double requestUtcTime, double serverUtcTime);                                                // [0x850a5b8] Net|NetReliableNative|Event|Public|NetClient 
};
