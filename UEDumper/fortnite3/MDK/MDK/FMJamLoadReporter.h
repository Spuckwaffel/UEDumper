...
public:
	...
	// class UJamLoadReporter* TryGet(class UObject* WorldContext);                                                             // [0xb6f825c] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/FMJamLoadReporter.JamLoadReporter.OnResolveComplete
	// void OnResolveComplete(class UJamContentResolver* Sender, FString LinkCode, bool bSuccess);                              // [0xb6f8a6c] Final|Native|Private 
	// Function /Script/FMJamLoadReporter.JamLoadReporter.OnResolveAndLoadComplete
	// void OnResolveAndLoadComplete(class UJamContentResolver* Sender, FString LinkCode, bool bSuccess, bool bWasAlreadyLoaded); // [0xb6f82dc] Final|Native|Private 
	// Function /Script/FMJamLoadReporter.JamLoadReporter.Get
	// class UJamLoadReporter* Get(class UObject* WorldContext);                                                                // [0xb6f825c] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/FMJamLoadReporter.JamLoadReporter.GenerateFullReport
	// TArray<FString> GenerateFullReport();                                                                                    // [0xb6f8220] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
