...
public:
	...
	// void HandleResolveComplete(bool bSuccess, FString LinkCode, TArray<FString>& PluginURLs);                                // [0xb6ef318] Final|Native|Private|HasOutParms 
	// Function /Script/FMJamContentResolver.JamContentResolver.HandleGameFeatureLoadComplete
	// void HandleGameFeatureLoadComplete(bool bSuccess, FString LinkCode, FString PluginURL);                                  // [0xb6eebb8] Final|Native|Private 
};
