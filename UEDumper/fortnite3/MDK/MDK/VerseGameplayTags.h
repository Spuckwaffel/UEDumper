...
public:
	...
	// bool HasMatchingGameplayTag(FVerseGameplayTag TagToCheck);                                                               // [0x7eceef4] Native|Public|Const  
	// Function /Script/VerseGameplayTags.VerseGameplayTagAssetInterface.HasAnyMatchingGameplayTags
	// bool HasAnyMatchingGameplayTags(FVerseGameplayTagContainer& TagContainer);                                               // [0x7ece804] Native|Public|HasOutParms|Const 
	// Function /Script/VerseGameplayTags.VerseGameplayTagAssetInterface.HasAllMatchingGameplayTags
	// bool HasAllMatchingGameplayTags(FVerseGameplayTagContainer& TagContainer);                                               // [0x7ece114] Native|Public|HasOutParms|Const 
	// Function /Script/VerseGameplayTags.VerseGameplayTagAssetInterface.GetOwnedGameplayTags
	// void GetOwnedGameplayTags(FVerseGameplayTagContainer& TagContainer);                                                     // [0x7ecda2c] Native|Public|HasOutParms|Const 
};
