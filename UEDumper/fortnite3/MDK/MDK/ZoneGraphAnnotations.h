...
public:
	...
	// void Trigger();                                                                                                          // [0xb21eb28] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void TriggerDanger(class UObject* WorldContextObject, class AActor* Instigator, FVector Position, float Radius, float duration); // [0xb21eb84] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
};
