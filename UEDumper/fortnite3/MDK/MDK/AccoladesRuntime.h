...
public:
	...
	// void TriggerAccolade(FString AccoladeName);                                                                              // [0x6d232d0] Final|BlueprintAuthorityOnly|Exec|Native|Private 
	// Function /Script/AccoladesRuntime.FortCheatManager_Accolades.ResetAccoladeData
	// void ResetAccoladeData();                                                                                                // [0x35e6228] Final|BlueprintAuthorityOnly|Exec|Native|Private 
};
...
public:
	...
	// void ServerPinAccolade(FName AccoladeName);                                                                              // [0xb2b5464] Final|Net|NetReliableNative|Event|Private|NetServer 
	// Function /Script/AccoladesRuntime.FortControllerComponent_AccoladeCollection.ServerMarkAccoladesAsSeen
	// void ServerMarkAccoladesAsSeen(TArray<FName> AccoladeNames);                                                             // [0x949acd8] Final|Net|NetReliableNative|Event|Private|NetServer 
	// Function /Script/AccoladesRuntime.FortControllerComponent_AccoladeCollection.HandlePlayerProfileInitialized
	// void HandlePlayerProfileInitialized();                                                                                   // [0xb2b5418] Final|Native|Private 
	// Function /Script/AccoladesRuntime.FortControllerComponent_AccoladeCollection.HandlePinnedQuestChanged
	// void HandlePinnedQuestChanged(FAthenaPinnedQuestData& PinnedQuestData);                                                  // [0xb2b538c] Final|Native|Private|HasOutParms 
	// Function /Script/AccoladesRuntime.FortControllerComponent_AccoladeCollection.ClientResetAccoladeData
	// void ClientResetAccoladeData();                                                                                          // [0x8998b60] Final|Net|NetReliableNative|Event|Private|NetClient 
};
...
public:
	...
	SMember(FText)                                     DisplayDescription                                          OFFSET(getStruct<T>, {0x48, 16, 0, 0})
	DMember(int32_t)                                   DisplayOrder                                                OFFSET(get<int32_t>, {0x58, 4, 0, 0})
	CMember(EFortAccoladeType)                         AccoladeType                                                OFFSET(get<T>, {0x5C, 1, 0, 0})
	CMember(EXPEventPriorityType)                      Priority                                                    OFFSET(get<T>, {0x5D, 1, 0, 0})
	CMember(EFortAccoladeTierType)                     AccoladeTier                                                OFFSET(get<T>, {0x5E, 1, 0, 0})
	CMember(TWeakObjectPtr<USoundCue*>)                AwardedSoundCue                                             OFFSET(get<T>, {0x60, 32, 0, 0})
	CMember(TWeakObjectPtr<UTexture2D*>)               PreviewImage                                                OFFSET(get<T>, {0x80, 32, 0, 0})
	DMember(int32_t)                                   MaxMatchCount                                               OFFSET(get<int32_t>, {0xA0, 4, 0, 0})
	DMember(int32_t)                                   MaxPlayerCount                                              OFFSET(get<int32_t>, {0xA4, 4, 0, 0})
	SMember(FGameplayTagContainer)                     Tags                                                        OFFSET(getStruct<T>, {0xA8, 32, 0, 0})
};
