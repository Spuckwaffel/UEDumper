...
public:
	...
	// void Unregister();                                                                                                       // [0x329b518] Final|Native|Public|BlueprintCallable 
	// Function /Script/GameplayMessages.AsyncAction_RegisterGameplayMessageReceiver.RegisterGameplayMessageReceiver
	// class UAsyncAction_RegisterGameplayMessageReceiver* RegisterGameplayMessageReceiver(class UObject* WorldContextObject, FEventMessageTag Channel, class UScriptStruct* PayloadType, EGameplayMessageMatchType MatchType, class AActor* ActorContext); // [0x7397c54] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/GameplayMessages.AsyncAction_RegisterGameplayMessageReceiver.GetPayload
	// bool GetPayload(int32_t& OutPayload);                                                                                    // [0x7397828] Final|Native|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// void Multicast_ServerMessageTriggered(FEventMessageTag Channel, FReplicatedMessage MessageData);                         // [0x7397b78] Final|Net|NetReliableNative|Event|NetMulticast|Private 
};
...
public:
	...
	// void K2_BroadcastMessage(FEventMessageTag Channel, int32_t& Message, bool bSaveToChannel, class AActor* ActorContext);   // [0x73979fc] Final|Native|Protected|HasOutParms|BlueprintCallable 
	// Function /Script/GameplayMessages.GameplayMessageRouter.HasValidSavedMessage
	// bool HasValidSavedMessage(FEventMessageTag Channel);                                                                     // [0x7397920] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/GameplayMessages.GameplayMessageRouter.ClearSavedMessage
	// void ClearSavedMessage(FEventMessageTag Channel);                                                                        // [0x7397730] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// FEventMessageTag GetEventMessageTagFromGameplayTag(FGameplayTag InTag);                                                  // [0x73977b0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
};
