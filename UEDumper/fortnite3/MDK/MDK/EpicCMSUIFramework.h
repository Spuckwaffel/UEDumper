...
public:
	...
	// void SetMediaURL(FString MediaUrl);                                                                                      // [0x8436ea8] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void Launch();                                                                                                           // [0x8436de8] Final|Native|Protected|BlueprintCallable 
};
...
public:
	...
	// void SetCurrentPageByIndex(int32_t PageIndex);                                                                           // [0x8436e24] Final|Native|Protected|BlueprintCallable 
	// Function /Script/EpicCMSUIFramework.EpicCMSTileCarousel.PreviousPage
	// void PreviousPage();                                                                                                     // [0x8436e10] Final|Native|Protected|BlueprintCallable 
	// Function /Script/EpicCMSUIFramework.EpicCMSTileCarousel.NextPage
	// void NextPage();                                                                                                         // [0x8436dfc] Final|Native|Protected|BlueprintCallable 
	// Function /Script/EpicCMSUIFramework.EpicCMSTileCarousel.NavigationVisibilityChanged
	// void NavigationVisibilityChanged(bool bShowNavigation);                                                                  // [0x1340978] Event|Protected|BlueprintEvent 
	// Function /Script/EpicCMSUIFramework.EpicCMSTileCarousel.HandleTilePageAdded
	// void HandleTilePageAdded(class UWidget* TileWidget);                                                                     // [0x6e87c98] Native|Event|Protected|BlueprintEvent 
	// Function /Script/EpicCMSUIFramework.EpicCMSTileCarousel.GetCurrentPageIndex
	// int32_t GetCurrentPageIndex();                                                                                           // [0x8436dc0] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/EpicCMSUIFramework.EpicCMSTileCarousel.BeginAutoScrolling
	// void BeginAutoScrolling();                                                                                               // [0x8436d8c] Final|Native|Public|BlueprintCallable 
	// Function /Script/EpicCMSUIFramework.EpicCMSTileCarousel.AddTilePage
	// void AddTilePage(class UWidget* TilePageWidget);                                                                         // [0x8436bf8] Final|Native|Public|BlueprintCallable 
};
